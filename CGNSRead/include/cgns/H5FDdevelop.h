...
extern "C"
{
    ...
    H5_DLL herr_t H5FDread_vector(
        ...
        size_t sizes[],
        void* bufs[] /* out */);
    H5_DLL herr_t H5FDwrite_vector(
        H5FD_t* file,
        hid_t dxpl_id,
        uint32_t count,
        H5FD_mem_t types[],
        ...
        size_t sizes[],
        const void* bufs[] /* in */);
    H5_DLL herr_t H5FDread_selection(
        H5FD_t* file,
        H5FD_mem_t type,
        hid_t dxpl_id,
        uint32_t count,
        ...
        size_t element_sizes[],
        void* bufs[] /* out */);
    H5_DLL herr_t H5FDwrite_selection(
        H5FD_t* file,
        H5FD_mem_t type,
        hid_t dxpl_id,
        uint32_t count,
        ...
        size_t element_sizes[],
        const void* bufs[]);
    H5_DLL herr_t H5FDread_vector_from_selection(
        H5FD_t* file,
        H5FD_mem_t type,
        hid_t dxpl_id,
        uint32_t count,
        ...
        size_t element_sizes[],
        void* bufs[] /* out */);
    H5_DLL herr_t H5FDwrite_vector_from_selection(
        H5FD_t* file,
        H5FD_mem_t type,
        hid_t dxpl_id,
        uint32_t count,
        ...
        size_t element_sizes[],
        const void* bufs[] /* in */);
    H5_DLL herr_t H5FDread_from_selection(
        H5FD_t* file,
        H5FD_mem_t type,
        hid_t dxpl_id,
        uint32_t count,
        ...
        size_t element_sizes[],
        void* bufs[] /* out */);
    H5_DLL herr_t H5FDwrite_from_selection(
        H5FD_t* file,
        H5FD_mem_t type,
        hid_t dxpl_id,
        uint32_t count,
