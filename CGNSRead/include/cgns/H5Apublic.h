 ...
 *
 */
typedef herr_t (*H5A_operator2_t)(
...
H5_DLL hid_t H5Acreate_async(
     ...
     *
     */
    H5_DLL hid_t H5Acreate_by_name(
        hid_t loc_id,
        const char* obj_name,
        const char* attr_name,
        hid_t type_id,
...
H5_DLL hid_t H5Acreate_by_name_async(
     ...
     *
     */
    H5_DLL herr_t H5Adelete_by_idx(
        hid_t loc_id,
        const char* obj_name,
        H5_index_t idx_type,
...
H5_DLL herr_t H5Aexists_by_name_async(
     ...
     *
     */
    H5_DLL herr_t H5Aget_info_by_idx(
        hid_t loc_id,
        const char* obj_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
        hsize_t n,
        H5A_info_t* ainfo /*out*/,
        hid_t lapl_id);
    /*-------------------------------------------------------------------------*/
    /**
     * \ingroup H5A
     ...
     *
     */
    H5_DLL herr_t H5Aget_info_by_name(
        hid_t loc_id,
        const char* obj_name,
        const char* attr_name,
        H5A_info_t* ainfo /*out*/,
     ...
     *
     */
    H5_DLL ssize_t H5Aget_name_by_idx(
        hid_t loc_id,
        const char* obj_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
     ...
     *
     */
    H5_DLL herr_t H5Aiterate_by_name(
        hid_t loc_id,
        const char* obj_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
...
H5_DLL herr_t H5Awrite_async(hid_t attr_id, hid_t type_id, const void* buf, hid_t es_id);
     ...
     *
     */
    H5_DLL herr_t H5Arename_by_name(
        hid_t loc_id,
        const char* obj_name,
        const char* old_attr_name,
        const char* new_attr_name,
 ...
 */
     ...
     */
    typedef herr_t (
        *H5A_operator1_t)(hid_t location_id /*in*/, const char* attr_name /*in*/, void* operator_data /*in,out*/);
    //! <!-- [H5A_operator1_t_snip] -->
