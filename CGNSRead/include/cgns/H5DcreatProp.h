...
namespace H5 {
    ...
    */
    ...
    public:
        ...
        void setVirtual(const DataSpace& vspace, const char* src_fname, const char* src_dsname, const DataSpace& sspace)
            const;
        void setVirtual(
        ...
        virtual H5std_string fromClass() const override { return ("DSetCreatPropList"); }
