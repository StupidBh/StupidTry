 ...
 * <a href="\CGNS_ORG/\SIDS_REF/convention.html#structured-grid-notation-and-indexing-conventions">structured grid
...
#undef type
    ...
    CGNSDLL int cg_grid_bounding_box_write(
        int file_number,
        int B,
        int Z,
        int G,
    ...
    CGNSDLL int cg_coord_read(
        ...
        const cgsize_t* rmax,
        void* coord);
    CGNSDLL int cg_coord_general_read(
        int fn,
        int B,
        int Z,
        const char* coordname,
        const cgsize_t* s_rmin,
        const cgsize_t* s_rmax,
    ...
    CGNSDLL int cg_coord_partial_write(
        int fn,
        int B,
        int Z,
        CGNS_ENUMT(DataType_t) type,
        ...
        const void* coord_ptr,
        int* C);
    CGNSDLL int cg_coord_general_write(
        int fn,
        int B,
        int Z,
        const char* coordname,
    ...
    CGNSDLL int cg_poly_elements_read(
        int file_number,
        int B,
        int Z,
        int S,
        cgsize_t* elements,
        cgsize_t* connect_offset,
        cgsize_t* parent_data);
    CGNSDLL int cg_section_write(
        int file_number,
        int B,
        int Z,
        ...
        int* S);
    CGNSDLL int cg_poly_section_write(
        int file_number,
        int B,
        int Z,
        const char* SectionName,
        ...
        int* S);
    CGNSDLL int cg_section_general_write(
        int file_number,
        int B,
        int Z,
        const char* SectionName,
        const CGNS_ENUMT(ElementType_t) type,
        const CGNS_ENUMT(DataType_t) elementDataType,
        cgsize_t start,
        cgsize_t end,
    ...
    CGNSDLL int cg_section_partial_write(
        int file_number,
        int B,
        int Z,
        const char* SectionName,
    ...
    CGNSDLL int cg_elements_general_write(
        int fn,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_poly_elements_partial_write(
        int fn,
        int B,
        int Z,
        int S,
        ...
        const cgsize_t* elements,
        const cgsize_t* connect_offset);
    CGNSDLL int cg_poly_elements_general_write(
        int fn,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_elements_partial_read(
        int file_number,
        int B,
        int Z,
        int S,
        ...
        cgsize_t* elements,
        cgsize_t* parent_data);
    CGNSDLL int cg_poly_elements_partial_read(
        int file_number,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_elements_general_read(
        int file_number,
        int B,
        int Z,
        int S,
        ...
        CGNS_ENUMT(DataType_t) m_type,
        void* elements);
    CGNSDLL int cg_poly_elements_general_read(
        int file_number,
        int B,
        int Z,
        int S,
        ...
        void* elements,
        void* connect_offset);
    CGNSDLL int cg_parent_elements_general_read(
        int file_number,
        int B,
        int Z,
        int S,
        ...
        CGNS_ENUMT(DataType_t) m_type,
        void* parelem);
    CGNSDLL int cg_parent_elements_position_general_read(
        int file_number,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_ElementPartialSize(
        int file_number,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_sol_ptset_write(
        int fn,
        int B,
        int Z,
        const char* solname,
    ...
    CGNSDLL int cg_field_read(
        ...
        const cgsize_t* rmax,
        void* field_ptr);
    CGNSDLL int cg_field_general_read(
        int fn,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_field_partial_write(
        int fn,
        int B,
        int Z,
        int S,
    ...
    CGNSDLL int cg_subreg_ptset_write(
        int fn,
        int B,
        int Z,
        const char* regname,
    ...
    CGNSDLL int cg_conn_write(
        ...
        CGNS_ENUMT(DataType_t) donor_datatype,
        cgsize_t ndata_donor,
        const cgsize_t* donor_data,
        int* Ii);
    CGNSDLL int cg_conn_write_short(
        int file_number,
        int B,
        int Z,
        const char* connectname,
    ...
    CGNSDLL int cg_1to1_read_global(
        int fn,
        int B,
        char** connectname,
        char** zonename,
    ...
    CGNSDLL int cg_boco_write(
        ...
        const cgsize_t* pnts,
        int* BC);
    CGNSDLL int cg_boco_normal_write(
        int file_number,
        int B,
        int Z,
        int BC,
    ...
    CGNSDLL int cg_discrete_ptset_write(
        int fn,
        int B,
        int Z,
        const char* discrete_name,
        CGNS_ENUMT(GridLocation_t) location,
        CGNS_ENUMT(PointSetType_t) ptset_type,
        cgsize_t npnts,
        const cgsize_t* pnts,
    ...
    CGNSDLL int cg_rigid_motion_read(
        int file_number,
        int B,
        int Z,
        int R,
    ...
    CGNSDLL int cg_rigid_motion_write(
        int file_number,
        int B,
        int Z,
        const char* name,
    ...
    CGNSDLL int cg_arbitrary_motion_read(
        int file_number,
        int B,
        int Z,
        int A,
    ...
    CGNSDLL int cg_arbitrary_motion_write(
        int file_number,
        int B,
        int Z,
        const char* amotionname,
        CGNS_ENUMT(ArbitraryGridMotionType_t) type,
        int* A);
    ...
    CGNSDLL int cg_bc_wallfunction_read(
        int file_number,
        int B,
        int Z,
        int BC,
        CGNS_ENUMT(WallFunctionType_t) * WallFunctionType);
    CGNSDLL int cg_bc_wallfunction_write(
        int file_number,
        int B,
        int Z,
        int BC,
    ...
    CGNSDLL int cg_conn_periodic_read(
        int file_number,
        int B,
        int Z,
        int Ii,
        ...
        float* RotationAngle,
        float* Translation);
    CGNSDLL int cg_conn_periodic_write(
        int file_number,
        int B,
        int Z,
        int Ii,
    ...
    CGNSDLL int cg_1to1_periodic_write(
        int file_number,
        int B,
        int Z,
        int Ii,
        ...
        float const* RotationAngle,
        float const* Translation);
    CGNSDLL int cg_1to1_periodic_read(
        int file_number,
        int B,
        int Z,
        int Ii,
    ...
    CGNSDLL int cg_conn_average_read(
        int file_number,
        int B,
        int Z,
        int Ii,
    ...
    CGNSDLL int cg_conn_average_write(
        ...
        int Ii,
        CGNS_ENUMT(AverageInterfaceType_t) AverageInterfaceType);
    CGNSDLL int cg_1to1_average_write(
        int file_number,
        int B,
        int Z,
        int Ii,
    ...
    CGNSDLL int cg_particle_write(int file_number, int B, const char* particlename, const cgsize_t size, int* P);
    ...
    CGNSDLL int
        cg_particle_bounding_box_read(int fn, int B, int P, int C, CGNS_ENUMT(DataType_t) datatype, void* boundingbox);
    CGNSDLL int
        cg_particle_bounding_box_write(int fn, int B, int P, int C, CGNS_ENUMT(DataType_t) datatype, void* boundingbox);
    ...
    CGNSDLL int cg_particle_coord_info(int fn, int B, int P, int C, CGNS_ENUMT(DataType_t) * type, char* coordname);
    CGNSDLL int cg_particle_coord_read(
        int fn,
        int B,
        int P,
        const char* coordname,
        ...
        const cgsize_t* rmax,
        void* coord);
    CGNSDLL int cg_particle_coord_general_read(
        int fn,
        int B,
        int P,
        const char* coordname,
    ...
    CGNSDLL int cg_particle_coord_write(
        int fn,
        int B,
        int P,
        CGNS_ENUMT(DataType_t) type,
    ...
    CGNSDLL int cg_particle_coord_partial_write(
        int fn,
        int B,
        int P,
        CGNS_ENUMT(DataType_t) type,
        ...
        const void* coord_ptr,
        int* C);
    CGNSDLL int cg_particle_coord_general_write(
        int fn,
        int B,
        int P,
        const char* coordname,
    ...
    CGNSDLL int cg_particle_sol_ptset_info(
        int fn,
        int B,
        int P,
        int S,
    ...
    CGNSDLL int cg_particle_sol_ptset_write(
        int fn,
        int B,
        int P,
        const char* solname,
    ...
    CGNSDLL int
        cg_particle_field_info(int fn, int B, int P, int S, int F, CGNS_ENUMT(DataType_t) * type, char* fieldname);
    CGNSDLL int cg_particle_field_read(
        int fn,
        int B,
        int P,
        int S,
        ...
        const cgsize_t* rmax,
        void* field_ptr);
    CGNSDLL int cg_particle_field_general_read(
        int fn,
        int B,
        int P,
        int S,
    ...
    CGNSDLL int cg_particle_field_write(
        int fn,
        int B,
        int P,
        int S,
    ...
    CGNSDLL int cg_particle_field_partial_write(
        int fn,
        int B,
        int P,
        int S,
        ...
        const void* field_ptr,
        int* F);
    CGNSDLL int cg_particle_field_general_write(
        int fn,
        int B,
        int P,
        int S,
    ...
    CGNSDLL int cg_equationset_read(
    ...
    CGNSDLL int cg_particle_equationset_read(
        int* EquationDimension,
        int* ParticleGoverningEquationsFlag,
        int* CollisionModelFlag,
        int* BreakupModelFlag,
        int* ForceModelFlag,
        int* WallInteractionModelFlag,
        int* PhaseChangeModelFlag);
    ...
    CGNSDLL int cg_array_general_read(
        int A,
        const cgsize_t* s_rmin,
        const cgsize_t* s_rmax,
        CGNS_ENUMT(DataType_t) m_type,
        ...
        const cgsize_t* m_rmax,
        void* data);
    CGNSDLL int cg_array_write(
        const char* ArrayName,
        CGNS_ENUMT(DataType_t) DataType,
        int DataDimension,
        const cgsize_t* DimensionVector,
        const void* Data);
    CGNSDLL int cg_array_general_write(
        const char* arrayname,
        CGNS_ENUMT(DataType_t) s_type,
        int s_numdim,
        const cgsize_t* s_dimvals,
        const cgsize_t* s_rmin,
        const cgsize_t* s_rmax,
        CGNS_ENUMT(DataType_t) m_type,
        int m_numdim,
    ...
    CGNSDLL int cg_units_write(
        CGNS_ENUMT(MassUnits_t) mass,
        CGNS_ENUMT(LengthUnits_t) length,
        CGNS_ENUMT(TimeUnits_t) time,
        CGNS_ENUMT(TemperatureUnits_t) temperature,
        CGNS_ENUMT(AngleUnits_t) angle);
    CGNSDLL int cg_unitsfull_read(
        CGNS_ENUMT(MassUnits_t) * mass,
        CGNS_ENUMT(LengthUnits_t) * length,
        CGNS_ENUMT(TimeUnits_t) * time,
        CGNS_ENUMT(TemperatureUnits_t) * temperature,
    ...
    CGNSDLL int cg_unitsfull_write(
        CGNS_ENUMT(MassUnits_t) mass,
        CGNS_ENUMT(LengthUnits_t) length,
        CGNS_ENUMT(TimeUnits_t) time,
        CGNS_ENUMT(TemperatureUnits_t) temperature,
