 ...
 */
    ...
    H5_DLL hid_t H5Gcreate_async(
        ...
        hid_t es_id);
#else
H5_DLL hid_t H5Gcreate_async(hid_t loc_id, const char* name, hid_t lcpl_id, hid_t gcpl_id, hid_t gapl_id, hid_t es_id);
#endif
...
#else
H5_DLL herr_t
    H5Gget_info_by_name_async(hid_t loc_id, const char* name, H5G_info_t* ginfo /*out*/, hid_t lapl_id, hid_t es_id);
#endif
     ...
     *
     */
    H5_DLL herr_t H5Gget_info_by_idx(
        hid_t loc_id,
