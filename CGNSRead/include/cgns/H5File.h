...
namespace H5 {
    ...
    */
    ...
    public:
        ...
        static bool
            isAccessible(const H5std_string& name, const FileAccPropList& access_plist = FileAccPropList::DEFAULT);
        ...
        virtual H5std_string fromClass() const override { return ("H5File"); }
