...
extern "C"
{
    ...
    EXTERN void ADFH_Configure(const int option, const void* value, int* error_return);
    ...
    EXTERN void ADFH_Read_All_Data(const double ID, const char* m_data_type, char* data, int* error_return);
