...
# Features:
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_PROVIDES_HL_LIB          OFF)
set (${HDF5_PACKAGE_NAME}_PROVIDES_SHARED_LIBS     NO)
...
set (${HDF5_PACKAGE_NAME}_PROVIDES_PARALLEL        ON)
...
set (${HDF5_PACKAGE_NAME}_PROVIDES_STATIC_TOOLS    ON)
#-----------------------------------------------------------------------------
...
if (${HDF5_PACKAGE_NAME}_PROVIDES_PARALLEL)
  ...
  set (${HDF5_PACKAGE_NAME}_PROVIDES_PARALLEL_FILTERED_WRITES ON)
  set (${HDF5_PACKAGE_NAME}_PROVIDES_LARGE_PARALLEL_IO        ON)
...
set (${HDF5_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}/share/hdf5")
...
if (${HDF5_PACKAGE_NAME}_PROVIDES_TOOLS)
  ...
  set_and_check (${HDF5_PACKAGE_NAME}_TOOLS_DIR "${PACKAGE_PREFIX_DIR}/tools/hdf5")
endif ()

#-----------------------------------------------------------------------------
# Version Strings
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_VERSION 2.1.1)
set (${HDF5_PACKAGE_NAME}_VERSION_STRING 2.1.1)
set (${HDF5_PACKAGE_NAME}_VERSION_MAJOR  2.1)
...
if (NOT TARGET "hdf5")
  ...
  if (${HDF5_PACKAGE_NAME}_PROVIDES_STATIC_LIBS AND ${HDF5_PACKAGE_NAME}_PROVIDES_SHARED_LIBS)
    include ("${PACKAGE_PREFIX_DIR}/share/hdf5/hdf5_static-targets.cmake" OPTIONAL RESULT_VARIABLE _hdf5_static_loaded)
  ...
  if (${HDF5_PACKAGE_NAME}_PROVIDES_JAVA)
    include ("${PACKAGE_PREFIX_DIR}/share/hdf5/hdf5_java-targets.cmake" OPTIONAL RESULT_VARIABLE _hdf5_java_loaded)
