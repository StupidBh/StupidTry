 ...
 */
typedef int (
    *H5D_chunk_iter_op_t)(const hsize_t* offset, unsigned filter_mask, haddr_t addr, hsize_t size, void* op_data);
//! <!-- [H5D_chunk_iter_op_t_snip] -->
...
H5_DLL hid_t H5Dget_space_async(hid_t dset_id, hid_t es_id);
     ...
     *
     */
    H5_DLL herr_t H5Dget_chunk_info_by_coord(
        hid_t dset_id,
 ...
 */
     ...
     *
     */
    H5_DLL herr_t H5Dread_chunk1(hid_t dset_id, hid_t dxpl_id, const hsize_t* offset, uint32_t* filters, void* buf);
