...
#define H5L_TYPE_UD_MAX H5L_TYPE_MAX
     ...
     */
    H5_DLL herr_t
        H5Lmove(hid_t src_loc, const char* src_name, hid_t dst_loc, const char* dst_name, hid_t lcpl_id, hid_t lapl_id);
    /**
     * \ingroup H5L
     *
     ...
     */
    H5_DLL herr_t
        H5Lcopy(hid_t src_loc, const char* src_name, hid_t dst_loc, const char* dst_name, hid_t lcpl_id, hid_t lapl_id);
    /**
     * \ingroup H5L
     *
...
H5_DLL herr_t H5Lcreate_hard_async(
     ...
     */
    H5_DLL herr_t
        H5Lcreate_soft(const char* link_target, hid_t link_loc_id, const char* link_name, hid_t lcpl_id, hid_t lapl_id);
/**
 * --------------------------------------------------------------------------
 * \ingroup ASYNC
...
H5_DLL herr_t H5Ldelete_async(hid_t loc_id, const char* name, hid_t lapl_id, hid_t es_id);
     ...
     *
     */
    H5_DLL herr_t H5Ldelete_by_idx(
        hid_t loc_id,
...
H5_DLL herr_t H5Ldelete_by_idx_async(
     ...
     *
     */
    H5_DLL herr_t H5Lget_val_by_idx(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
...
H5_DLL herr_t H5Lexists_async(hid_t loc_id, const char* name, bool* exists, hid_t lapl_id, hid_t es_id);
     ...
     *
     */
    H5_DLL herr_t H5Lget_info_by_idx2(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
     ...
     *
     */
    H5_DLL ssize_t H5Lget_name_by_idx(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
...
H5_DLL herr_t H5Literate_async(
     ...
     *
     */
    H5_DLL herr_t H5Literate_by_name2(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
     ...
     *
     */
    H5_DLL herr_t H5Lvisit_by_name2(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
     ...
     *
     */
    H5_DLL herr_t H5Lunpack_elink_val(
        const void* ext_linkval /*in*/,
        size_t link_size,
        unsigned* flags,
     ...
     * \since 1.8.0
     */
    H5_DLL herr_t H5Lcreate_external(
 ...
 */
     ...
     *
     */
    H5_DLL herr_t H5Literate_by_name1(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
     ...
     *
     */
    H5_DLL herr_t H5Lvisit_by_name1(
        hid_t loc_id,
        const char* group_name,
        H5_index_t idx_type,
        H5_iter_order_t order,
