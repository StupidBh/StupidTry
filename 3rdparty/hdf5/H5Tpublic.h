...
extern "C"
{
     ...
     * \since 1.8.0
     */
    typedef H5T_conv_ret_t (*H5T_conv_except_func_t)(
...
/* (And must only defined when included in application code, not the library) */
     ...
     */
    H5_DLL hid_t
        H5Tarray_create1(hid_t base_id, int ndims, const hsize_t dim[/* ndims */], const int perm[/* ndims */]);
    /**
     * \ingroup ARRAY
     *
     * \brief Retrieves sizes of array dimensions
