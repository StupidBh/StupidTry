...
namespace H5 {
    ...
    */
    ...
    public:
        ...
        static void
            vlenReclaim(const DataType& type, const DataSpace& space, const DSetMemXferPropList& xfer_plist, void* buf);
        ...
        virtual H5std_string fromClass() const override { return ("DataSet"); }
