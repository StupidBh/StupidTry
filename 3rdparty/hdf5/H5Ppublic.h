...
#define H5D_SELECTION_IO (0x0004u) /**< Selection I/O was performed */
     ...
     *
     */
    H5_DLL H5Z_filter_t H5Pget_filter2(
        hid_t plist_id,
        unsigned idx,
     ...
     *
     */
    H5_DLL herr_t H5Pget_filter_by_id2(
        hid_t plist_id,
     ...
     *
     */
    H5_DLL herr_t H5Pmodify_filter(
        hid_t plist_id,
        H5Z_filter_t filter,
        unsigned int flags,
        size_t cd_nelmts,
     ...
     */
    H5_DLL herr_t
        H5Pget_file_space_strategy(hid_t plist_id, H5F_fspace_strategy_t* strategy, bool* persist, hsize_t* threshold);
    /**
     * \ingroup FCPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pget_shared_mesg_index(
        hid_t plist_id,
        unsigned index_num,
     ...
     * \since 1.10.0
     */
    H5_DLL herr_t H5Pget_mdc_log_options(
        hid_t plist_id,
        bool* is_enabled,
        char* location,
     ...
     *
     */
    H5_DLL herr_t H5Pset_driver_by_value(hid_t plist_id, H5FD_class_value_t driver_value, const char* driver_config);
    /**
     * \ingroup FAPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pset_mdc_log_options(hid_t plist_id, bool is_enabled, const char* location, bool start_on_access);
    /**
     * \ingroup FAPL
     *
     ...
     */
    H5_DLL herr_t
        H5Pget_append_flush(hid_t dapl_id, unsigned dims, hsize_t boundary[], H5D_append_cb_t* func, void** udata);
    /**
     * \ingroup DAPL
     *
     ...
     *
     */
    H5_DLL herr_t H5Pget_chunk_cache(
        hid_t dapl_id,
        size_t* rdcc_nslots /*out*/,
        size_t* rdcc_nbytes /*out*/,
        double* rdcc_w0 /*out*/);
     ...
     *
     */
    H5_DLL herr_t H5Pget_vlen_mem_manager(
        hid_t plist_id,
     ...
     *
     */
    H5_DLL herr_t H5Pset_vlen_mem_manager(
        hid_t plist_id,
        H5MM_allocate_t alloc_func,
        void* alloc_info,
        H5MM_free_t free_func,
 ...
 */
     ...
     *
     */
    H5_DLL H5Z_filter_t H5Pget_filter1(
        hid_t plist_id,
        unsigned filter,
        unsigned int* flags /*out*/,
        size_t* cd_nelmts /*out*/,
     ...
     *
     */
    H5_DLL herr_t H5Pget_filter_by_id1(
        hid_t plist_id,
        H5Z_filter_t id,
        unsigned int* flags /*out*/,
        size_t* cd_nelmts /*out*/,
