...
extern "C"
{
     ...
     *
     */
    H5HL_DLL herr_t H5TBmake_table(
     ...
     *
     */
    H5HL_DLL herr_t H5TBappend_records(
        hid_t loc_id,
        const char* dset_name,
        hsize_t nrecords,
        size_t type_size,
     ...
     *
     */
    H5HL_DLL herr_t H5TBwrite_records(
        hid_t loc_id,
        const char* dset_name,
        hsize_t start,
        hsize_t nrecords,
     ...
     *
     */
    H5HL_DLL herr_t H5TBwrite_fields_name(
        hid_t loc_id,
        const char* dset_name,
        const char* field_names,
        hsize_t start,
     ...
     *
     */
    H5HL_DLL herr_t H5TBwrite_fields_index(
        hid_t loc_id,
        const char* dset_name,
        hsize_t nfields,
     ...
     *
     */
    H5HL_DLL herr_t H5TBread_table(
        hid_t loc_id,
        const char* dset_name,
        size_t dst_size,
     ...
     *
     */
    H5HL_DLL herr_t H5TBread_fields_name(
        hid_t loc_id,
        const char* dset_name,
        const char* field_names,
        hsize_t start,
     ...
     *
     */
    H5HL_DLL herr_t H5TBread_fields_index(
        hid_t loc_id,
        const char* dset_name,
        hsize_t nfields,
        const int* field_index,
     ...
     *
     */
    H5HL_DLL herr_t H5TBread_records(
        hid_t loc_id,
        const char* dset_name,
        hsize_t start,
        hsize_t nrecords,
     ...
     *
     */
    H5HL_DLL herr_t H5TBget_field_info(
        hid_t loc_id,
        const char* dset_name,
        char* field_names[],
        size_t* field_sizes,
     ...
     *
     */
    H5HL_DLL herr_t H5TBinsert_record(
        hid_t loc_id,
        const char* dset_name,
        hsize_t start,
        hsize_t nrecords,
     ...
     *
     */
    H5HL_DLL herr_t H5TBadd_records_from(
        hid_t loc_id,
     ...
     *
     */
    H5HL_DLL herr_t H5TBcombine_tables(
        hid_t loc_id1,
        const char* dset_name1,
        hid_t loc_id2,
        const char* dset_name2,
     ...
     *
     */
    H5HL_DLL herr_t H5TBinsert_field(
        hid_t loc_id,
        const char* dset_name,
