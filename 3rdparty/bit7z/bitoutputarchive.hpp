...
namespace bit7z {
    ...
    protected:
        ...
        inline auto inputArchive() const -> BitInputArchive* { return mInputArchive.get(); }
        ...
        inline auto inputArchiveItemsCount() const -> uint32_t { return mInputArchiveItemsCount; }

        inline void setDeletedIndex(uint32_t index) { mDeletedItems.insert(index); }
        ...
        inline auto hasDeletedIndexes() const -> bool { return !mDeletedItems.empty(); }

        inline auto hasNewItems() const -> bool { return mNewItemsVector.size() > 0; }
