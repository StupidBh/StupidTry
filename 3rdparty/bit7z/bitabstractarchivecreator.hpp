...
namespace bit7z {
    ...
    enum struct UpdateMode
    {
        ...
        Update, ///< New items whose path already exists in the archive will overwrite the old ones, other will be
                ///< appended.
        BIT7Z_DEPRECATED_ENUMERATOR(
            Overwrite,
            Update,
            "Since v4.0; please use the UpdateMode::Update enumerator.") ///< @deprecated since v4.0; please use the
                                                                         ///< UpdateMode::Update enumerator.
    };
