...
#define BOOST_SIGNALS2_SLOT_N_BINDING_CONSTRUCTOR(z, n, data)                                               \
    ...
    BOOST_SIGNALS2_SLOT_CLASS_NAME(                                                                         \
        BOOST_SIGNALS2_NUM_ARGS)(const Func& func, BOOST_SIGNALS2_PREFIXED_FULL_REF_ARGS(n, const BindArg)) \
    {                                                                                                       \
...
namespace boost {
    namespace signals2 {
        ...
        class slot : public detail::slotN<function_traits<Signature>::arity, Signature, SlotFunction>::type {
        private:
            typedef typename detail::slotN<boost::function_traits<Signature>::arity, Signature, SlotFunction>::type
                base_type;
