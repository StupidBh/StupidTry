...
#define BOOST_SIGNALS2_PREPROCESSED_ARG_TYPE_CLASS_TEMPLATE_SPECIALIZATION(z, n, data)                     \
    ...
    class BOOST_SIGNALS2_PREPROCESSED_ARG_N_TYPE_CLASS_NAME(                                               \
        BOOST_SIGNALS2_NUM_ARGS)<n, BOOST_SIGNALS2_ARGS_TEMPLATE_INSTANTIATION(BOOST_SIGNALS2_NUM_ARGS)> { \
    public:                                                                                                \
        typedef BOOST_PP_CAT(T, BOOST_PP_INC(n)) type;                                                     \
    };
            BOOST_PP_REPEAT(
                BOOST_SIGNALS2_NUM_ARGS,
                BOOST_SIGNALS2_PREPROCESSED_ARG_TYPE_CLASS_TEMPLATE_SPECIALIZATION,
                ~)
