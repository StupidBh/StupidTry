...
namespace boost {
    namespace signals2 {
        namespace detail {
            ...
            public:
                typedef
                    typename unsigned_meta_array_appender<typename make_unsigned_meta_array<n - 1>::type, n - 1>::type
                        type;
            };
            ...
            private:
                ...
                R m_invoke(
                    Func& func,
                    unsigned_meta_array<indices...>,
                    const BOOST_SIGNALS2_TUPLE<Args...>& args,
                    typename boost::disable_if<boost::is_void<typename Func::result_type>>::type* = 0) const
                {
                ...
                R m_invoke(
                    ...
                    unsigned_meta_array<indices...>,
                    const BOOST_SIGNALS2_TUPLE<Args...>& args,
                    typename boost::enable_if<boost::is_void<typename Func::result_type>>::type* = 0) const
                {
            ...
            public:
                ...
                variadic_slot_invoker(Args&... args) :
                    _args(args...)
                {
                }
                ...
                {
                    return call_with_tuple_args<result_type>()(
                        connectionBody->slot().slot_function(),
                        _args,
