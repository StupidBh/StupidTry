    ...
    namespace signals2 {
        template<
            ...
            typename ExtendedSlotFunction =
                typename detail::extended_signature<function_traits<Signature>::arity, Signature>::function_type,
        ...
        class signal :
            public detail::signalN<
                ...
                Mutex>::type {
        private:
            typedef typename detail::signalN<
        ...
        public:
            ...
            signal& operator=(signal&& other) BOOST_NOEXCEPT
            {
