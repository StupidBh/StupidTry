    ...
    namespace signals2 {
        ...
        namespace detail {
            ...
            public:
                ...
                bool blocked() const { return !_weak_blocker.expired(); }
            ...
            public:
                ...
                void nolock_grab_tracked_objects(garbage_collecting_lock<M>& lock_arg, OutputIterator inserter) const
                {
                    if (!m_slot) {
                        return;
                    }
                    ...
                    for (it = slot().tracked_objects().begin(); it != slot().tracked_objects().end(); ++it) {
                        void_shared_ptr_variant locked_object(apply_visitor(detail::lock_weak_ptr_visitor(), *it));
        ...
        public:
            ...
            connection(connection&& other) BOOST_NOEXCEPT :
        ...
        public:
            ...
            scoped_connection(const connection& other) BOOST_NOEXCEPT : connection(other) {}
