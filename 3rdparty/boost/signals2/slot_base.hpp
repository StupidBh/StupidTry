...
namespace boost {
    namespace signals2 {
        namespace detail {
            ...
            typedef boost::
                variant<boost::weak_ptr<trackable_pointee>, boost::weak_ptr<void>, detail::foreign_void_weak_ptr>
            ...
            public:
                ...
                result_type operator()(const weak_ptr<trackable_pointee>&) const { return boost::shared_ptr<void>(); }
            };
