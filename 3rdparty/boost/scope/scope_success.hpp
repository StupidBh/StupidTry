...
namespace boost {
    namespace scope {
        ...
        namespace detail {
            ...
            // Workaround for clang < 5.0 which can't pass scope_success as a template template parameter from within
            // scope_success definition
            template<typename T>
            ...
            public:
                ...
                template<
                    ...
                    typename = typename std::enable_if<detail::conjunction<
                        ...
                        detail::is_not_like_logical_not<F>>::value>::type>
        ...
        class scope_success : public scope_exit<Func, detail::logical_not<Cond>> {
            //! \cond
        private:
        ...
        public:
            ...
            template<
                ...
                typename = typename std::enable_if<detail::conjunction<
                    ...
                    detail::is_not_like_scope_success<F>>::value>::type
                //! \endcond
                >
            explicit scope_success(F&& func, bool active = true) noexcept(
                BOOST_SCOPE_DETAIL_DOC_HIDDEN(std::is_nothrow_constructible<base_type, F, bool>::value)) :
            ...
            template<
                ...
                //! \endcond
                >
            explicit scope_success(F&& func, C&& cond, bool active = true) noexcept(
                BOOST_SCOPE_DETAIL_DOC_HIDDEN(std::is_nothrow_constructible<base_type, F, C, bool>::value)) :
            ...
            template<
                ...
                typename = typename std::enable_if<Requires>::type>
            //! \endcond
            scope_success(scope_success&& that) noexcept(
                BOOST_SCOPE_DETAIL_DOC_HIDDEN(std::is_nothrow_move_constructible<base_type>::value)) :
         ...
         */
        template<typename F>
        inline scope_success<typename std::decay<F>::type> make_scope_success(F&& func, bool active = true) noexcept(
            std::is_nothrow_constructible<scope_success<typename std::decay<F>::type>, F, bool>::value)
        {
        ...
        inline
            ...
            typename std::enable_if<
                ...
                scope_success<typename std::decay<F>::type, typename std::decay<C>::type>>::type
#else
            scope_success<typename std::decay<F>::type, typename std::decay<C>::type>
#endif
            make_scope_success(F&& func, C&& cond, bool active = true) noexcept(
                std::is_nothrow_constructible<
                    ...
                    bool>::value)
        {
            return scope_success<typename std::decay<F>::type, typename std::decay<C>::type>(
                static_cast<F&&>(func),
                static_cast<C&&>(cond),
                active);
        }
