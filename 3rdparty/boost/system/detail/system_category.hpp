...
namespace boost {
    ...
    #pragma GCC diagnostic ignored "-Wnon-virtual-dtor"
            ...
            public:
                ...
                const char* name() const noexcept BOOST_OVERRIDE { return "system"; }
    ...
    #pragma GCC diagnostic pop
        ...
        namespace detail {
            ...
            template<class T>
            struct BOOST_SYMBOL_VISIBLE system_cat_holder
            {
    ...
    // Before C++17 it was mandatory to redeclare all static constexpr
            ...
            template<class T>
            constexpr system_error_category system_cat_holder<T>::instance;
    #endif
        ...
        BOOST_SYSTEM_DEPRECATED("please use system_category()") inline const error_category& get_system_category()
        {
            return system_category();
        }

        BOOST_SYSTEM_DEPRECATED("please use system_category()")
