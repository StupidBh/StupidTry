...
namespace boost {
    ...
    #pragma GCC diagnostic ignored "-Wnon-virtual-dtor"
            ...
            public:
                ...
                const char* name() const noexcept BOOST_OVERRIDE { return "generic"; }
    ...
    #pragma GCC diagnostic pop
        ...
        namespace detail {
            ...
            template<class T>
            struct BOOST_SYMBOL_VISIBLE generic_cat_holder
            {
    ...
    // Before C++17 it was mandatory to redeclare all static constexpr
            ...
            template<class T>
            constexpr generic_error_category generic_cat_holder<T>::instance;
    #endif
        ...
        BOOST_SYSTEM_DEPRECATED("please use generic_category()") inline const error_category& get_generic_category()
        {
            return generic_category();
        }

        BOOST_SYSTEM_DEPRECATED("please use generic_category()") inline const error_category& get_posix_category()
        {
            return generic_category();
        }

        BOOST_SYSTEM_DEPRECATED("please use generic_category()")
