    ...
    namespace system {
        ...
        namespace detail {
            ...
            struct generic_value_tag
            {
                ...
                BOOST_SYSTEM_CONSTEXPR explicit generic_value_tag(int v) :
                    value(v)
                {
                }
            };
        ...
        private:
            boost::ulong_long_type cat_id() const noexcept { return cat_ ? cat_->id_ : detail::generic_category_id; }
        ...
        public:
            ...
            BOOST_SYSTEM_CONSTEXPR error_condition(
                ErrorConditionEnum e,
                typename detail::enable_if<
                    is_error_condition_enum<ErrorConditionEnum>::value &&
                    !boost::system::detail::is_same<ErrorConditionEnum, errc::errc_t>::value>::type* = 0) noexcept
            {
            ...
            BOOST_SYSTEM_CONSTEXPR
                typename detail::enable_if<is_error_condition_enum<ErrorConditionEnum>::value, error_condition>::type&
            ...
            BOOST_SYSTEM_CONSTEXPR int value() const noexcept { return val_; }
            ...
            BOOST_SYSTEM_CONSTEXPR inline friend bool
