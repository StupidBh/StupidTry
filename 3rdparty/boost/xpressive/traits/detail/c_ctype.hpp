        ...
        namespace detail {
            ...
            struct char_class_impl<char>
            {
                ...
                BOOST_MPL_ASSERT_RELATION(
                    0x07FF,
                    ==,
                    (_XB | _XA | _XS | _BB | _CN | _DI | _LO | _PU | _SP | _UP | _XD));
                ...
                static char_class_type lookup_classname(FwdIter begin, FwdIter end, bool icase)
                {
                    ...
                    if (name == "graph") {
                        return _DI | _LO | _PU | _UP | _XA;
                    }
                    if (name == "lower") {
                        return icase ? (_LO | _UP) : _LO;
                    }
                    if (name == "newline") {
                        return char_class_newline;
                    }
                    if (name == "print") {
                    ...
                    if (name == "upper") {
                        return icase ? (_UP | _LO) : _UP;
                    }
                    if (name == "w") {
                        return _DI | _LO | _UP | _XA | char_class_underscore;
                    }
                    if (name == "xdigit") {
                        return _XD;
                    }
                ...
                static bool isctype(char ch, char_class_type mask)
                {
                    ...
                    case '\n':
                    case '\r':
                    case '\f': return 0 != (mask & char_class_newline);
                    default  :;
                    }
            ...
            struct char_class_impl<wchar_t>
            {
                ...
                static char_class_type lookup_classname(FwdIter begin, FwdIter end, bool icase)
                {
                    ...
                    if (name == L"alnum") {
                        return char_class_alpha | char_class_digit;
                    }
                    if (name == L"alpha") {
                    ...
                    if (name == L"graph") {
                        return char_class_punct | char_class_alpha | char_class_digit;
                    }
                    if (name == L"lower") {
                        return icase ? (char_class_lower | char_class_upper) : char_class_lower;
                    }
                    if (name == L"newline") {
                        return char_class_newline;
                    }
                    if (name == L"print") {
                        return char_class_blank | char_class_punct | char_class_alpha | char_class_digit;
                    }
                    if (name == L"punct") {
                    ...
                    if (name == L"upper") {
                        return icase ? (char_class_upper | char_class_lower) : char_class_upper;
                    }
                    if (name == L"w") {
                        return char_class_alpha | char_class_digit | char_class_underscore;
                    }
                    if (name == L"xdigit") {
                        return char_class_xdigit;
                    }
                    return 0;
                }
                ...
                static bool isctype(wchar_t ch, char_class_type mask)
                {
                    ...
                    return ((char_class_alpha & mask) && iswalpha(ch)) ||
                           ...
                           ((char_class_digit & mask) && iswdigit(ch)) || ((char_class_lower & mask) && iswlower(ch)) ||
                           ((char_class_newline & mask) && detail::iswnewline(ch)) ||
                           ((char_class_punct & mask) && iswpunct(ch)) || ((char_class_space & mask) && iswspace(ch)) ||
            ...
            struct char_class_impl<char>
            {
                ...
                BOOST_MPL_ASSERT_RELATION(
                    0x81FF,
                    ==,
                    (_ALPHA | _UPPER | _LOWER | _DIGIT | _SPACE | _PUNCT | _CONTROL | _BLANK | _HEX | _LEADBYTE));
                ...
                static char_class_type lookup_classname(FwdIter begin, FwdIter end, bool icase)
                {
                    ...
                    if (name == "blank") {
                        return _BLANK; // this is ONLY space!!!
                    }
                    if (name == "cntrl") {
                        return _CONTROL;
                    }
                    ...
                    if (name == "lower") {
                        return icase ? (_LOWER | _UPPER) : _LOWER;
                    }
                    if (name == "newline") {
                        return char_class_newline;
                    }
                    ...
                    if (name == "upper") {
                        return icase ? (_UPPER | _LOWER) : _UPPER;
                    }
                    if (name == "w") {
                        return _ALPHA | _DIGIT | char_class_underscore;
                    }
                    if (name == "xdigit") {
                        return _HEX;
                    }
            ...
            struct char_class_impl<wchar_t>
            {
                ...
                static bool isctype(wchar_t ch, char_class_type mask)
                {
                    ...
                    case 0x2028u:
                    case 0x2029u:
                    case 0x85u  : return 0 != (mask & char_class_newline);
                    default     :;
                    }
            ...
            struct char_class_impl<char>
            {
                ...
                static char_class_type lookup_classname(FwdIter begin, FwdIter end, bool icase)
                {
                    ...
                    if (name == "lower") {
                        return icase ? (_L | _U) : _L;
                    }
                    if (name == "newline") {
                        return char_class_newline;
                    }
                    if (name == "print") {
                        return _B | _P | _U | _L | _N;
                    }
                    if (name == "punct") {
                        return _P;
                    }
                    ...
                    if (name == "upper") {
                        return icase ? (_U | _L) : _U;
                    }
                    if (name == "w") {
                        return _U | _L | _N | char_class_underscore;
                    }
                    if (name == "xdigit") {
                        return _X;
                    }
            ...
            struct char_class_impl<char>
            {
                ...
                BOOST_MPL_ASSERT_RELATION(
                    ...
                    (_ISalnum | _ISalpha | _ISblank | _IScntrl | _ISdigit | _ISgraph | _ISlower | _ISprint | _ISpunct |
                     _ISspace | _ISupper | _ISxdigit | 0xffff));
                ...
                static char_class_type lookup_classname(FwdIter begin, FwdIter end, bool icase)
                {
                    ...
                    if (name == "lower") {
                        return icase ? (_ISlower | _ISupper) : _ISlower;
                    }
                    if (name == "print") {
                        return _ISprint;
                    }
                    ...
                    if (name == "upper") {
                        return icase ? (_ISupper | _ISlower) : _ISupper;
                    }
                    if (name == "w") {
                        return _ISalnum | char_class_underscore;
                    }
                    if (name == "xdigit") {
                        return _ISxdigit;
                    }
            ...
            struct char_class_impl<char>
            {
                ...
                static bool isctype(char ch, char_class_type mask)
                {
                    ...
                    return ((char_class_alpha & mask) && isalpha(uch)) ||
                           ...
                           ((char_class_digit & mask) && isdigit(uch)) || ((char_class_lower & mask) && islower(uch)) ||
                           ((char_class_newline & mask) && detail::isnewline(ch)) ||
                           ((char_class_punct & mask) && ispunct(uch)) || ((char_class_space & mask) && isspace(uch)) ||
