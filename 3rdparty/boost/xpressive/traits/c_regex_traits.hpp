...
namespace boost {
    namespace xpressive {
        ...
        template<typename Char>
        struct c_regex_traits : detail::c_regex_traits_base<Char>
        {
            ...
            ///
            /// \return true.
            bool operator==(c_regex_traits<char_type> const&) const { return true; }

            /// Checks two c_regex_traits objects for inequality
            ///
            /// \return false.
            bool operator!=(c_regex_traits<char_type> const&) const { return false; }
            ...
            static char_type translate_nocase(char_type ch) { return detail::c_tolower(ch); }

            /// Converts a character to lower-case using the current global C locale.
            ///
            /// \param ch The source character.
            /// \return std::tolower(ch) if Char is char, std::towlower(ch) if Char is wchar_t.
            static char_type tolower(char_type ch) { return detail::c_tolower(ch); }
            ...
            static char_type toupper(char_type ch) { return detail::c_toupper(ch); }
            ...
            string_type fold_case(char_type ch) const
            {
                ...
                char_type ntcs[] = { detail::c_tolower(ch), detail::c_toupper(ch), 0 };
                if (ntcs[1] == ntcs[0]) {
                    ntcs[1] = 0;
                }
        ...
        template<>
        struct has_fold_case<c_regex_traits<char>> : mpl::true_
        {
        };
