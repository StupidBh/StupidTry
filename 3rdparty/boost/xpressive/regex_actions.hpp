...
namespace boost {
    namespace xpressive {
        ...
        namespace detail {
            ...
            struct action_arg
            {
                ...
                reference cast(void* pv) const { return *static_cast<typename remove_reference<T>::type*>(pv); }
            };

            template<typename T>
            struct value_wrapper : private noncopyable
            {
                value_wrapper() :
                    value()
                {
            ...
            struct BindArgs :
                proto::function<
                    ...
                    proto::vararg<
                        proto::when<proto::assign<proto::_, proto::_>, proto::call<BindArg(proto::_data, proto::_)>>>>
            {
            };

            struct let_domain : boost::proto::domain<boost::proto::pod_generator<let_>>
            {
            };
        ...
        namespace op {
            ...
            /// \brief \c push_front is a PolymorphicFunctionObject for pushing an element into the front of a
            /// container.
            struct push_front
            {
                BOOST_PROTO_CALLABLE()
            ...
            struct front
            {
                ...
                struct result<This(Sequence)>
                {
                    ...
                    typedef typename mpl::if_c<
                        ...
                        typename sequence_type::reference>::type type;
                };
            ...
            struct insert
            {
                ...
                struct detail
                {
                    ...
                    struct result_detail<This(Cont, Value), void>
                    {
                        ...
                        typedef typename mpl::if_c<
                            ...
                            std::pair<typename cont_type::iterator, bool>>::type type;
                    };
                    ...
                    struct result_detail<
                        ...
                        typename disable_if<mpl::or_<
                            ...
                            is_same<
                                ...
                                typename remove_cv<typename remove_reference<Value>::type>::type>>>::type>
                    {
                    ...
                    struct result_detail<
                        This(Cont, Size, T),
                        typename enable_if<
                            is_integral<typename remove_cv<typename remove_reference<Size>::type>::type>>::type>
                    {
                    ...
                    struct result_detail<
                        This(Cont, It, Size, Value),
                        typename disable_if<
                            is_integral<typename remove_cv<typename remove_reference<It>::type>::type>>::type>
                    {
                        typedef void type;
                    };
                ...
                typename result<insert(Cont&, A0 const&)>::type operator()(Cont& cont, A0 const& a0) const
                {
                ...
                ///         \li For the form <tt>insert()(cont, a0, a1, a2)</tt>, return <tt>cont.insert(a0, a1,
                ///         a2)</tt>.
                ///         \li For the form <tt>insert()(cont, a0, a1, a2, a3)</tt>, return <tt>cont.insert(a0, a1, a2,
                ///         a3)</tt>.
            ...
            struct as
            {
                ...
                {
                    return val.matched ? boost::lexical_cast<T>(boost::make_iterator_range(val.first, val.second))
            ...
            private:
                ...
                T impl(sub_match<RandIter> const& val, mpl::true_) const
                {
                    return val.matched
                               ? boost::lexical_cast<T>(
                                     boost::make_iterator_range(&*val.first, &*val.first + (val.second - val.first)))
                               : boost::lexical_cast<T>("");
                }
            ...
            /// \brief \c static_cast_\<\> is a PolymorphicFunctionObject for statically casting a parameter to a
            /// different type.
            ...
            /// \brief \c dynamic_cast_\<\> is a PolymorphicFunctionObject for dynamically casting a parameter to a
            /// different type.
            ...
            /// \brief \c const_cast_\<\> is a PolymorphicFunctionObject for const-casting a parameter to a cv
            /// qualification.
            ...
            struct throw_
            {
                ...
                /// \overload
                void operator()() const { BOOST_THROW_EXCEPTION(Except()); }
            ...
            /// \brief \c unwrap_reference is a PolymorphicFunctionObject for unwrapping a
            /// <tt>boost::reference_wrapper\<\></tt>.
        ...
        */
        ...
        /// \brief \c first is a lazy PolymorphicFunctionObject for accessing the first element of a \c std::pair\<\> in
        /// an xpressive semantic action.
        function<op::first>::type const first = { {} };

        /// \brief \c second is a lazy PolymorphicFunctionObject for accessing the second element of a \c std::pair\<\>
        /// in an xpressive semantic action.
        function<op::second>::type const second = { {} };

        /// \brief \c matched is a lazy PolymorphicFunctionObject for accessing the \c matched member of a \c
        /// xpressive::sub_match\<\> in an xpressive semantic action.
        function<op::matched>::type const matched = { {} };

        /// \brief \c length is a lazy PolymorphicFunctionObject for computing the length of a \c
        /// xpressive::sub_match\<\> in an xpressive semantic action.
        function<op::length>::type const length = { {} };

        /// \brief \c str is a lazy PolymorphicFunctionObject for converting a \c xpressive::sub_match\<\> to a \c
        /// std::basic_string\<\> in an xpressive semantic action.
        function<op::str>::type const str = { {} };

        /// \brief \c insert is a lazy PolymorphicFunctionObject for inserting a value or a range of values into a
        /// sequence in an xpressive semantic action.
        ...
        /// \brief \c unwrap_reference is a lazy PolymorphicFunctionObject for unwrapping a \c
        /// boost::reference_wrapper\<\> in an xpressive semantic action.
        ...
        */
        ...
        template<typename T>
        struct value : proto::extends<typename proto::terminal<T>::type, value<T>>
        {
            /// INTERNAL ONLY
            ...
            /// \overload
            T& get() { return proto::value(*this); }

            /// \brief Fetch the stored value
            T const& get() const { return proto::value(*this); }
        };
        ...
        */
        template<typename T>
        struct reference : proto::extends<typename proto::terminal<reference_wrapper<T>>::type, reference<T>>
        {
            /// INTERNAL ONLY
            ...
            /// \brief Fetch the stored value
            T& get() const { return proto::value(*this).get(); }
        };
        ...
        */
        ...
        template<typename T>
        struct local : detail::value_wrapper<T>, proto::terminal<reference_wrapper<T>>::type
        {
            /// INTERNAL ONLY
        ...
        typename detail::make_function::impl<op::as<T> const, A const&>::result_type const as(A const& a)
        {
        ...
        ///
        /// A \RefSect{user_s_guide.semantic_actions_and_user_defined_assertions.user_defined_assertions,user-defined
        /// assertion} is a kind of semantic action that evaluates a Boolean lambda and, if it evaluates to false,
        /// causes the match to fail at that location in the string. This will cause backtracking, so the match may
        /// ultimately succeed.
        ///
        ...
        */
        ...
        ///
        /// See the section
        /// \RefSect{user_s_guide.semantic_actions_and_user_defined_assertions.referring_to_non_local_variables,
        /// "Referring to Non-Local Variables"} in the Users' Guide for more discussion.
        ///
        /// \em Example:
        ///
        /**
        ...
        */
        ...
        /// \RefSect{user_s_guide.semantic_actions_and_user_defined_assertions.referring_to_non_local_variables,
        /// "Referring to Non-Local Variables"} section in the Users' Guide for more information.
        ///
        /// <em>Example:</em>
        ///
        /**
    ...
    #define BOOST_PROTO_LOCAL_MACRO(N, typename_A, A_const_ref, A_const_ref_a, a)                                \
        ...
        typename detail::make_function::impl<op::construct<X2_0> const BOOST_PP_COMMA_IF(N)                      \
                                                 A_const_ref(N)>::result_type const                              \
            construct(A_const_ref_a(N))                                                                          \
        {                                                                                                        \
            return detail::make_function::impl<op::construct<X2_0> const BOOST_PP_COMMA_IF(N) A_const_ref(N)>()( \
                (op::construct<X2_0>())BOOST_PP_COMMA_IF(N) a(N));                                               \
        }                                                                                                        \
                                                                                                                 \
        template<typename X2_0 BOOST_PP_COMMA_IF(N) typename_A(N)>                                               \
        typename detail::make_function::impl<op::throw_<X2_0> const BOOST_PP_COMMA_IF(N)                         \
                                                 A_const_ref(N)>::result_type const                              \
            throw_(A_const_ref_a(N))                                                                             \
        {                                                                                                        \
            return detail::make_function::impl<op::throw_<X2_0> const BOOST_PP_COMMA_IF(N) A_const_ref(N)>()(    \
    ...
    #include BOOST_PROTO_LOCAL_ITERATE()
        ...
        namespace detail {
            ...
            struct mark_nbr
            {
                ...
                int operator()(mark_placeholder m) const { return m.mark_number_; }
            };
            ...
            struct ReplaceAlgo :
                proto::or_<
                    ...
                    proto::when<proto::terminal<any_matcher>, op::at(proto::_data, proto::size_t<0>)>,
                    proto::when<proto::terminal<reference_wrapper<proto::_>>, op::unwrap_reference(proto::_value)>,
