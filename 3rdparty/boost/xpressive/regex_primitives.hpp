...
// within function types:
    ...
    #define minus_one()    proto::make<minus_one()>
            ...
            struct SubMatchList : proto::or_<SubMatch, proto::comma<SubMatchList, SubMatch>>
            {
            };

            template<typename Subs>
            typename enable_if<mpl::and_<proto::is_expr<Subs>, proto::matches<Subs, SubMatchList>>, std::vector<int>>::
                type
    ...
    #undef minus_one
            ...
            struct skip_primitives : proto::transform<skip_primitives>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    typedef typename proto::shift_right<
                        typename proto::unary_expr<keeper_tag, typename proto::dereference<State>::type>::type,
            ...
            struct skip_directive
            {
                ...
                {
                    typedef SkipGrammar::
                        impl<typename proto::result_of::as_expr<Expr>::type, skip_type const&, mpl::void_&>
                            skip_transform;

                    typedef typename proto::shift_right<
                        typename skip_transform::result_type,
                        typename proto::dereference<skip_type>::type>::type type;
                };

                template<typename Expr>
                typename result<skip_directive(Expr)>::type operator()(Expr const& expr) const
                {
                    mpl::void_ ignore;
        ...
        struct mark_tag : proto::extends<detail::basic_mark_tag, mark_tag, detail::regex_domain>
        {
        private:
        ...
        public:
            ...
            /// INTERNAL ONLY
            operator detail::basic_mark_tag const&() const { return this->proto_base(); }
...
// so that it can serve double-duty as regex_constants::icase, the syntax_option_type.
        ...
        template<typename Expr>
        detail::unspecified icase(Expr const& expr)
        {
            return 0;
        }
#endif
...
/// that is not an 'a'.
        ...
        detail::unspecified as_xpr(Literal const& literal)
        {
            return 0;
        }
#else
        ...
        inline typename proto::terminal<detail::range_placeholder<Char>>::type const range(Char ch_min, Char ch_max)
        {
        ...
        template<typename Expr>
        typename proto::result_of::make_expr<proto::tag::logical_not, proto::default_domain, Expr const&>::type const
            optional(Expr const& expr)
        {
            return proto::make_expr<proto::tag::logical_not, proto::default_domain>(boost::ref(expr));
        }
        ...
        typename proto::result_of::make_expr<detail::generic_quant_tag<Min, Max>, proto::default_domain, Expr const&>::
            type const
            repeat(Expr const& expr)
        {
            return proto::make_expr<detail::generic_quant_tag<Min, Max>, proto::default_domain>(boost::ref(expr));
        }
        ...
        typename proto::result_of::
            make_expr<detail::generic_quant_tag<Count, Count>, proto::default_domain, Expr2 const&>::type const
            repeat(Expr2 const& expr2)
        {
            return proto::make_expr<detail::generic_quant_tag<Count, Count>, proto::default_domain>(boost::ref(expr2));
        }
        ...
        template<typename Expr>
        typename proto::result_of::make_expr<detail::keeper_tag, proto::default_domain, Expr const&>::type const
            keep(Expr const& expr)
        {
            return proto::make_expr<detail::keeper_tag, proto::default_domain>(boost::ref(expr));
        }
        ...
        template<typename Expr>
        typename proto::result_of::make_expr<detail::lookahead_tag, proto::default_domain, Expr const&>::type const
            before(Expr const& expr)
        {
            return proto::make_expr<detail::lookahead_tag, proto::default_domain>(boost::ref(expr));
        }
        ...
        template<typename Expr>
        typename proto::result_of::make_expr<detail::lookbehind_tag, proto::default_domain, Expr const&>::type const
            after(Expr const& expr)
        {
            return proto::make_expr<detail::lookbehind_tag, proto::default_domain>(boost::ref(expr));
        }
        ...
        inline detail::modifier_op<detail::locale_modifier<Locale>> const imbue(Locale const& loc)
        {
            detail::modifier_op<detail::locale_modifier<Locale>> mod = { detail::locale_modifier<Locale>(loc),
