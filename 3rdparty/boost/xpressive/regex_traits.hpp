...
namespace boost {
    namespace xpressive {
        ...
        /// INTERNAL ONLY
        ///
        struct regex_traits_version_1_case_fold_tag : regex_traits_version_1_tag
        {
        };
        ...
        struct has_fold_case : is_convertible<typename Traits::version_tag*, regex_traits_version_1_case_fold_tag*>
        {
        };
