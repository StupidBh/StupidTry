...
namespace boost {
    namespace xpressive {
        ...
        struct regex_error : std::runtime_error, boost::exception
        {
            ...
            /// \throw nothrow
            regex_constants::error_type code() const { return this->code_; }
                ...
                unsigned long line)
            {
                if (!cond) {
                    ...
                    boost::throw_exception(
                        ...
                        << boost::throw_function(fun) << boost::throw_file(file) << boost::throw_line((int)line));
#else
