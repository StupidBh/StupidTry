...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            typedef proto::expr<proto::tag::terminal, proto::term<logical_newline_placeholder>, 0>
            ...
            template<typename Matcher>
            static_xpression<Matcher> const make_static(Matcher const& matcher);

            template<typename Matcher, typename Next>
            static_xpression<Matcher, Next> const make_static(Matcher const& matcher, Next const& next);
