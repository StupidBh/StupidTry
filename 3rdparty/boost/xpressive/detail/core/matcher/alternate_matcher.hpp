...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            //
            template<typename BidiIter, typename Next>
            inline bool alt_match(alternates_vector<BidiIter> const& alts, match_state<BidiIter>& state, Next const&)
            {
            ...
            inline bool alt_match(alternates_list<Head, Tail> const& alts, match_state<BidiIter>& state, Next const&)
            {
            ...
            struct alternate_matcher :
                quant_style<
                    Alternates::width != unknown_width::value && Alternates::pure ? quant_fixed_width
            ...
            private:
                ...
                bool can_match_(char_type ch, Traits const& tr) const { return this->bset_.test(ch, tr); }
            };
