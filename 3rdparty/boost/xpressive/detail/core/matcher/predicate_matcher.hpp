...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            {
                explicit predicate_context(
                    int sub,
                    sub_match_impl<BidiIter> const* sub_matches,
                    action_args_type* action_args) :
                    sub_(sub),
                ...
                struct eval_terminal : proto::default_eval<Expr, predicate_context const>
                {
                };
                ...
                struct eval : proto::default_eval<Expr, predicate_context const>
                {
                };
                ...
                template<typename Expr>
                struct eval<Expr, proto::tag::mem_ptr> : mem_ptr_eval<Expr, predicate_context const>
                {
                };
#endif
            ...
            // AssertionFunctor
            //
            struct AssertionFunctor : proto::function<proto::terminal<check_tag>, proto::terminal<proto::_>>
            {
            };
