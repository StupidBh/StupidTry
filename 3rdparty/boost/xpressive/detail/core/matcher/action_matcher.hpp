    ...
    namespace xpressive {
        namespace detail {
...
#if BOOST_VERSION >= 103500
            struct DataMember : proto::mem_ptr<proto::_, proto::terminal<proto::_>>
            {
            };

            template<typename Expr, long N>
            struct child_ : remove_reference<typename proto::result_of::child_c<Expr&, N>::type>
            {
            };
            ...
            struct mem_ptr_eval
            {
                ...
                typedef typename proto::result_of::value<typename proto::result_of::child_c<right_type, 0>::type>::type
                    function_type;

                typedef fusion::transform_view<
                    typename fusion::result_of::push_front<
                        typename fusion::result_of::pop_front<right_type>::type const,
                        reference_wrapper<left_type>>::type const,
                    proto::eval_fun<Context>>
                    evaluated_args;

                typedef typename fusion::result_of::invoke<function_type, evaluated_args>::type result_type;
            ...
            struct mem_ptr_eval<Expr, Context, true>
            {
                ...
                typedef typename proto::result_of::value<right_type>::type function_type;

                typedef typename boost::result_of<function_type(
                    typename proto::result_of::eval<left_type, Context>::type)>::type result_type;

                result_type operator()(Expr& expr, Context& ctx) const
                {
                    return proto::value(proto::right(expr))(proto::eval(proto::left(expr), ctx));
                }
            };
#endif
            ...
            struct action_context
            {
                ...
                action_args_type const& args() const { return *this->action_args_; }

                // eval_terminal
                template<typename Expr, typename Arg>
                struct eval_terminal : proto::default_eval<Expr, action_context const>
                {
                };
                ...
                struct eval_terminal<Expr, reference_wrapper<Arg>>
                {
                    ...
                    result_type operator()(Expr& expr, action_context const&) const { return proto::value(expr).get(); }
                };
                ...
                struct eval_terminal<Expr, opt<Arg>>
                {
                    ...
                    result_type operator()(Expr& expr, action_context const&) const { return proto::value(expr); }
                };
                    ...
                    result_type operator()(Expr& expr, action_context const& ctx) const
                    {
                        ...
                        if (where_ == ctx.args().end()) {
                            BOOST_THROW_EXCEPTION(
                                regex_error(regex_constants::error_badarg, "An argument to an action was unspecified"));
                        }
                ...
                struct eval : proto::default_eval<Expr, action_context const>
                {
                };
                ...
                struct eval<Expr, attr_with_default_tag>
                {
                    typedef typename proto::result_of::value<
                        typename proto::result_of::left<typename proto::result_of::child<Expr>::type>::type>::type
                        temp_type;
...
#if BOOST_VERSION >= 103500
                template<typename Expr>
                struct eval<Expr, proto::tag::mem_ptr> : mem_ptr_eval<Expr, action_context const>
                {
                };
#endif
            ...
            struct subreg_transform : proto::transform<subreg_transform>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename proto::terminal<sub_match<typename state_type::iterator>>::type result_type;
            ...
            struct opt
            {
                ...
                operator reference() const
                {
                    BOOST_XPR_ENSURE_(
                        0 != this->t_,
                        regex_constants::error_badattr,
                        "Use of uninitialized regex attribute");
                    return *this->t_;
                }
            ...
            struct attr_transform : proto::transform<attr_transform>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename expr_type::proto_child0::matcher_type::value_type::second_type attr_type;

                    typedef typename proto::terminal<opt<attr_type>>::type result_type;
                        ...
                        typename impl::data_param) const
                    {
                        ...
                        attr_type const* attr =
                            static_cast<attr_type const*>(state.attr_context_.attr_slots_[slot - 1]);
            ...
            struct attr_with_default_transform : proto::transform<attr_with_default_transform<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    typedef typename proto::unary_expr<
                        attr_with_default_tag,
                        typename Grammar::template impl<Expr, State, Data>::result_type>::type result_type;
                    ...
                    result_type operator()(
                        ...
                        typename impl::data_param data) const
                    {
                        result_type that = { typename Grammar::template impl<Expr, State, Data>()(expr, state, data) };
                        return that;
                    }
                };
            };
            ...
            struct by_ref_transform : proto::transform<by_ref_transform>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    typedef typename proto::result_of::value<typename impl::expr_param>::type reference;

                    typedef typename proto::terminal<reference>::type result_type;
            ...
            //
            template<typename Actor>
            struct action_matcher : quant_style<quant_none, 0, false>
            {
                int sub_;
                Actor actor_;
                ...
                bool match(match_state<BidiIter>& state, Next const& next) const
                {
                    ...
                    typedef typename boost::result_of<
                        BindActionArgs(Actor const&, match_state<BidiIter>&, int const&)>::type action_type;
