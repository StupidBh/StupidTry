...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct regex_byref_matcher : quant_style<quant_variable_width, unknown_width::value, false>
            {
            ...
            private:
                template<typename Next>
                static xpression_adaptor<reference_wrapper<Next const>, matchable<BidiIter>>
                    wrap_(Next const& next, mpl::true_)
                {
