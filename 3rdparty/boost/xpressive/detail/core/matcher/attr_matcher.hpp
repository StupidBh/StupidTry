    ...
    namespace xpressive {
        namespace detail {
            ...
            struct char_translate
            {
                ...
                char_type operator()(char_type ch1) const { return this->traits_.translate(ch1); }
            ...
            struct char_translate<Traits, true>
            {
                ...
                char_type operator()(char_type ch1) const { return this->traits_.translate_nocase(ch1); }
            ...
            struct attr_matcher : quant_style<quant_none, 0, false>
            {
