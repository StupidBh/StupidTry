    ...
    namespace xpressive {
        namespace detail {
            ...
            struct char_sink
            {
                ...
                void operator()(char_type ch) const { this->bset_.set_char(ch, ICase, this->traits_); }
            ...
            struct xpression_peeker
            {
                ...
                ///////////////////////////////////////////////////////////////////////////////
                // accessors
                peeker_string<Char> const& get_string() const { return this->str_; }

                bool line_start() const { return this->line_start_; }

                bool leading_simple_repeat() const { return 0 < this->leading_simple_repeat_; }

                hash_peek_bitset<Char> const& bitset() const { return this->bset_; }

                ///////////////////////////////////////////////////////////////////////////////
                // modifiers
                void fail() { this->bset_.set_all(); }
