    ...
    namespace xpressive {
        namespace detail {
            ...
            struct core_access
            {
                ...
                static shared_ptr<detail::regex_impl<BidiIter>> const& get_regex_impl(basic_regex<BidiIter> const& rex)
                {
                ...
                static action_args_type& get_action_args(match_results<BidiIter>& what) { return what.args_; }
                ...
                static void reset(match_results<BidiIter>& what) { what.reset_(); }

                static void set_base(match_results<BidiIter>& what, BidiIter base) { what.set_base_(base); }

                static BidiIter get_base(match_results<BidiIter>& what) { return *what.base_; }
            };
