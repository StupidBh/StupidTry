    ...
    namespace xpressive {
        namespace detail {
            ...
            struct sub_match_iterator :
                iterator_adaptor<sub_match_iterator<Value, MainIter>, MainIter, Value, std::random_access_iterator_tag>
            {
            ...
            struct sub_match_vector : private noncopyable
            {
            private:
                struct dummy
                {
            ...
            public:
                ...
                typedef sub_match_iterator<value_type const, sub_match_impl<BidiIter> const*> const_iterator;
                ...
                const_reference operator[](size_type index) const
                {
                    ...
                    return (index >= this->size_) ? s_null
                ...
                const_iterator begin() const { return const_iterator(this->sub_matches_); }

                const_iterator end() const { return const_iterator(this->sub_matches_ + this->size_); }

                operator bool_type() const { return (!this->empty() && (*this)[0].matched) ? &dummy::i_ : 0; }

                bool operator!() const { return this->empty() || !(*this)[0].matched; }
            ...
            private:
                ...
                void
                    init_(sub_match_impl<BidiIter>* sub_matches, size_type size, sub_match_vector<BidiIter> const& that)
                {
