    ...
    namespace xpressive {
        namespace detail {
            ...
            struct icase_modifier
            {
                ...
                template<typename Visitor>
                static typename apply<Visitor>::type call(Visitor& visitor)
                {
            ...
            struct regex_traits_type
            {
                ...
                typedef
                    typename mpl::if_c<is_same<Locale, std::locale>::value, cpp_regex_traits<char_type>, Locale>::type
                        type;
            ...
            struct locale_modifier
            {
                ...
                template<typename Visitor>
                typename apply<Visitor>::type call(Visitor& visitor) const
                {
                    return typename apply<Visitor>::type(this->loc_, visitor.self());
                }

                Locale getloc() const { return this->loc_; }
            ...
            struct xpression_linker
            {
                ...
                void accept(repeat_begin_matcher const&, void const* next) { this->back_stack_.push(next); }
                ...
                // accessors
                bool has_backrefs() const { return this->has_backrefs_; }
            ...
            private:
                ...
                struct alt_link_pred
                {
                    ...
                    alt_link_pred(xpression_linker<Char>* linker, xpression_peeker<Char>* peeker, void const* next) :
                        linker_(linker),
                        peeker_(peeker),
                        next_(next)
                    {
