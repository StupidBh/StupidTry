...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct is_xpr : has_is_boost_xpressive_xpression_<Xpr>
            {
            };
...
#define BOOST_XPR_QUANT_STYLE(Style, Width, Pure)      \
    ...
    /**/
            ...
            struct quant_style_fixed_width : quant_style<quant_fixed_width, Width>
            {
            };
            ...
            struct quant_style_assertion : quant_style<quant_none, 0>
            {
            };
            ...
            struct quant_type : mpl::int_<Matcher::quant>
            {
            };
