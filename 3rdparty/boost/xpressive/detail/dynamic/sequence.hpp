    ...
    namespace xpressive {
        namespace detail {
            ...
            struct sequence
            {
                ...
                sequence(
                    intrusive_ptr<
                        dynamic_xpression<alternate_matcher<alternates_vector<BidiIter>, Traits>, BidiIter>> const&
                        xpr) :
                    pure_(true),
                    width_(0),
                    quant_(quant_none),
                ...
                bool empty() const { return !this->head_; }
                ...
                void repeat(quant_spec const& spec) { this->xpr().matchable()->repeat(spec, *this); }

                shared_matchable<BidiIter> const& xpr() const { return this->head_; }

                detail::width width() const { return this->width_; }

                bool pure() const { return this->pure_; }

                quant_enum quant() const { return this->quant_; }
