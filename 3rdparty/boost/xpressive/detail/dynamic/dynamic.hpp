...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct invalid_xpression : matchable_ex<BidiIter>
            {
                invalid_xpression() :
            ...
            struct dynamic_xpression : Matcher, matchable_ex<BidiIter>
            {
            ...
            private:
                ...
                void peek_next_(mpl::true_, xpression_peeker<char_type>& peeker) const { this->next_.peek(peeker); }
                ...
                void repeat_(quant_spec const& spec, sequence<BidiIter>& seq, mpl::int_<quant_fixed_width>, mpl::false_)
                    const
                {
                ...
                void repeat_(quant_spec const& spec, sequence<BidiIter>& seq, mpl::int_<quant_fixed_width>, mpl::true_)
                    const
                {
            ...
            // alternates_vector
            template<typename BidiIter>
            struct alternates_vector : std::vector<shared_matchable<BidiIter>>
            {
            ...
            struct matcher_wrapper : Matcher
            {
            ...
            inline void make_simple_repeat(quant_spec const& spec, sequence<BidiIter>& seq, Xpr const& xpr)
            {
                if (spec.greedy_) {
            ...
            // make_simple_repeat
            template<typename BidiIter>
            inline void make_simple_repeat(quant_spec const& spec, sequence<BidiIter>& seq)
            {
            ...
            // make_optional
            template<typename BidiIter>
            inline void make_optional(quant_spec const& spec, sequence<BidiIter>& seq)
            {
            ...
            // make_optional
            template<typename BidiIter>
            inline void make_optional(quant_spec const& spec, sequence<BidiIter>& seq, int mark_nbr)
            {
                typedef shared_matchable<BidiIter> xpr_type;
                seq += make_dynamic<BidiIter>(alternate_end_matcher());
                if (spec.greedy_) {
            ...
            // make_repeat
            template<typename BidiIter>
            inline void make_repeat(quant_spec const& spec, sequence<BidiIter>& seq)
            {
            ...
            // make_repeat
            template<typename BidiIter>
            inline void make_repeat(quant_spec const& spec, sequence<BidiIter>& seq, int mark_nbr)
            {
                ...
                if (1 < spec.max_) {
                    ...
                    if (spec.greedy_) {
                        ...
                        seq = make_dynamic<BidiIter>(repeat_begin) + seq + make_dynamic<BidiIter>(repeat_end);
                    }
                    else {
