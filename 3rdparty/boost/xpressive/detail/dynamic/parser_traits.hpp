...
namespace boost {
    namespace xpressive {
        ...
        struct compiler_traits
        {
            ...
            ///////////////////////////////////////////////////////////////////////////////
            // flags
            regex_constants::syntax_option_type flags() const { return this->flags_; }

            ///////////////////////////////////////////////////////////////////////////////
            // flags
            void flags(regex_constants::syntax_option_type flags) { this->flags_ = flags; }

            ///////////////////////////////////////////////////////////////////////////////
            // traits
            regex_traits& traits() { return this->traits_; }
            ...
            ///////////////////////////////////////////////////////////////////////////////
            // getloc
            locale_type getloc() const { return this->traits().getloc(); }
            ...
            regex_constants::compiler_token_type get_token(FwdIter& begin, FwdIter end)
            {
                ...
                case BOOST_XPR_CHAR_(char_type, '+'):
                case BOOST_XPR_CHAR_(char_type, '?'): return token_invalid_quantifier;

                case BOOST_XPR_CHAR_(char_type, ']'):
                case BOOST_XPR_CHAR_(char_type, '{'):
                default                             : return token_literal;
                }
            }
            ...
            bool get_quant_spec(FwdIter& begin, FwdIter end, detail::quant_spec& spec)
            {
                ...
                case BOOST_XPR_CHAR_(char_type, '{'):
                    ...
                    BOOST_XPR_ENSURE_(begin != old_begin && begin != end, error_brace, "invalid quantifier");
                    ...
                    if (*begin == BOOST_XPR_CHAR_(char_type, ',')) {
                        ...
                        if (begin == old_begin) {
                            ...
                            BOOST_XPR_ENSURE_(spec.min_ <= spec.max_, error_badbrace, "invalid quantification range");
                        }
                    }
                    else {
                        BOOST_XPR_ENSURE_(BOOST_XPR_CHAR_(char_type, '}') == *begin, error_brace, "invalid quantifier");
                    }
                    break;
            ...
            regex_constants::compiler_token_type get_group_type(FwdIter& begin, FwdIter end, string_type& name)
            {
                ...
                if (this->eat_ws_(begin, end) != end && BOOST_XPR_CHAR_(char_type, '?') == *begin) {
                    ...
                    case BOOST_XPR_CHAR_(char_type, '<'):
                        ...
                        default                             : BOOST_THROW_EXCEPTION(regex_error(error_badbrace, "unrecognized extension"));
                        }
                    ...
                    case BOOST_XPR_CHAR_(char_type, '-'): return this->parse_mods_(begin, end);
        ...
        private:
            ...
            ///////////////////////////////////////////////////////////////////////////
            // is_space_
            bool is_space_(char_type ch) const { return 0 != this->space_ && this->traits().isctype(ch, this->space_); }

            ///////////////////////////////////////////////////////////////////////////
            // is_alnum_
            bool is_alnum_(char_type ch) const { return 0 != this->alnum_ && this->traits().isctype(ch, this->alnum_); }
