        ...
        namespace grammar_detail {
            ...
            struct as_read_attr : proto::transform<as_read_attr>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename FindAttr<typename expr_type::proto_child0::nbr_type>::
                        template impl<State, mpl::void_, int>::result_type attr_type;

                    typedef typename proto::terminal<
                        detail::read_attr<typename expr_type::proto_child0::nbr_type, BOOST_PROTO_UNCVREF(attr_type)>>::
                        type result_type;
            ...
            struct DeepCopy :
                or_<when<terminal<detail::attribute_placeholder<_>>, as_read_attr>,
            ...
            struct MaxAttr :
                or_<when<terminal<detail::attribute_placeholder<_>>, attr_nbr>,
            ...
            struct max_attr : proto::transform<max_attr>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    typedef typename mpl::max<
                        typename impl::state,
                        typename MaxAttr::template impl<Expr, State, Data>::result_type>::type result_type;
                };
            };
            ...
            struct add_attrs : proto::transform<add_attrs>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    typedef detail::attr_begin_matcher<
                    ...
                    typedef typename shift_right<
                        ...
                        typename shift_right<Expr, terminal<detail::attr_end_matcher>::type>::type>::type result_type;
            ...
            ///////////////////////////////////////////////////////////////////////////////
            // InsertAttrs
            struct InsertAttrs : if_<MaxAttr, add_attrs, _>
            {
            };

            ///////////////////////////////////////////////////////////////////////////////
            // CheckAssertion
            struct CheckAssertion : proto::function<terminal<detail::check_tag>, _>
            {
            };
            ...
            struct as_action : proto::transform<as_action>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename DeepCopy::impl<action_type, expr_type, int>::result_type action_copy_type;

                    typedef typename InsertMark::impl<expr_type, State, Data>::result_type marked_expr_type;

                    typedef typename mpl::if_c<
                        proto::matches<action_type, CheckAssertion>::value,
                        detail::predicate_matcher<action_copy_type>,
                        detail::action_matcher<action_copy_type>>::type matcher_type;

                    typedef typename proto::
                        shift_right<marked_expr_type, typename proto::terminal<matcher_type>::type>::type no_attr_type;

                    typedef typename InsertAttrs::impl<no_attr_type, State, Data>::result_type result_type;
