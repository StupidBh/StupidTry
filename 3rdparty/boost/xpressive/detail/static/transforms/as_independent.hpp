...
namespace boost {
    namespace xpressive {
        namespace grammar_detail {
            ...
            struct NotHasAction : proto::switch_<struct NotHasActionCases>
            {
            };
            ...
            struct NotHasActionCases
            {
                ...
                struct case_ : proto::nary_expr<Tag, proto::vararg<NotHasAction>>
                {
                };
                ...
                struct case_<proto::tag::terminal, Dummy> :
                    not_<
                        or_<proto::terminal<detail::tracking_ptr<detail::regex_impl<_>>>,
                            proto::terminal<reference_wrapper<_>>>>
                {
                };

                template<int Dummy>
                struct case_<proto::tag::comma, Dummy> : proto::_ // because (set='a','b') can't contain an action
                {
                };
                ...
                template<int Dummy>
                struct case_<detail::lookahead_tag, Dummy> : proto::_ // because actions in lookaheads are scoped
                {
                };

                template<int Dummy>
                struct case_<detail::lookbehind_tag, Dummy> : proto::_ // because actions in lookbehinds are scoped
                {
                };

                template<int Dummy>
                struct case_<detail::keeper_tag, Dummy> : proto::_ // because actions in keepers are scoped
                {
                };

                template<int Dummy>
                struct case_<proto::tag::subscript, Dummy> : proto::subscript<detail::set_initializer_type, _>
                {
                }; // only accept set[...], not actions!
            };

            struct IndependentEndXpression :
                or_<when<NotHasAction, detail::true_xpression()>, otherwise<detail::independent_end_xpression()>>
            {
            };
            ...
            struct as_lookahead : proto::transform<as_lookahead<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename IndependentEndXpression::impl<arg_type, int, int>::result_type end_xpr_type;

                    typedef typename Grammar::template impl<arg_type, end_xpr_type, Data>::result_type xpr_type;

                    typedef detail::lookahead_matcher<xpr_type> result_type;
            ...
            struct as_lookbehind : proto::transform<as_lookbehind<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef detail::lookbehind_matcher<xpr_type> result_type;
            ...
            struct as_keeper : proto::transform<as_keeper<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef detail::keeper_matcher<xpr_type> result_type;
