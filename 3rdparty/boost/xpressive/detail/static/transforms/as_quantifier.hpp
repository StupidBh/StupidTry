        ...
        namespace grammar_detail {
            ...
            struct as_simple_quantifier : proto::transform<as_simple_quantifier<Grammar, Greedy, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef
                        typename Grammar::template impl<arg_type, detail::true_xpression, Data>::result_type xpr_type;
            ...
            struct add_hidden_mark : proto::transform<add_hidden_mark>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename shift_right<
                        ...
                        typename shift_right<Expr, terminal<detail::mark_end_matcher>::type>::type>::type result_type;
            ...
            ///////////////////////////////////////////////////////////////////////////////
            // InsertMark
            struct InsertMark : or_<when<proto::assign<detail::basic_mark_tag, _>, _>, otherwise<add_hidden_mark>>
            {
            };
            ...
            struct as_default_quantifier_impl : proto::transform<as_default_quantifier_impl<Greedy, Min, Max>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename InsertMark::impl<xpr_type, State, Data>::result_type marked_sub_type;

                    typedef typename shift_right<
                        terminal<detail::repeat_begin_matcher>::type,
                        typename shift_right<
                            marked_sub_type,
                            typename terminal<detail::repeat_end_matcher<Greedy>>::type>::type>::type result_type;
            ...
            struct as_default_optional : proto::transform<as_default_optional<Grammar, Greedy, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef detail::
                        optional_matcher<typename Grammar::template impl<Expr, end_xpr, Data>::result_type, Greedy>
                            result_type;
            ...
            struct as_mark_optional : proto::transform<as_mark_optional<Grammar, Greedy, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef detail::
                        optional_mark_matcher<typename Grammar::template impl<Expr, end_xpr, Data>::result_type, Greedy>
                            result_type;
            ...
            struct make_optional_ : proto::transform<make_optional_<Greedy, Callable>>
            {
                ...
                {
                    typedef typename impl::expr expr_type;
                    typedef typename unary_expr<optional_tag<Greedy>, Expr>::type result_type;
            ...
            // as_default_quantifier_impl
            template<typename Greedy>
            struct as_default_quantifier_impl<Greedy, 0, 1> : call<make_optional_<Greedy>(_child)>
            {
            };
            ...
            struct as_default_quantifier : proto::transform<as_default_quantifier<Greedy, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename other::template impl<Expr, State, Data>::result_type result_type;
