...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct alternates_list : fusion::cons<Head, Tail>
            {
                BOOST_STATIC_CONSTANT(
                    std::size_t,
                    width = Head::width == Tail::width ? Head::width : detail::unknown_width::value);
            ...
            struct alternates_list<Head, fusion::nil> : fusion::cons<Head, fusion::nil>
            {
            ...
            struct in_alternate_list : proto::transform<in_alternate_list<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    typedef detail::alternates_list<
                        typename Grammar::template impl<Expr, detail::alternate_end_xpression, Data>::result_type,
                        State>
                        result_type;
            ...
            struct as_alternate_matcher : proto::transform<as_alternate_matcher<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    result_type operator()(
                        ...
                        typename impl::data_param data) const
                    {
                        return result_type(typename Grammar::template impl<Expr, State, Data>()(expr, state, data));
                    }
                };
            };
        }
