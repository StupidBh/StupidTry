    ...
    namespace xpressive {
        namespace grammar_detail {
            ...
            struct inverter<detail::literal_matcher<Traits, ICase, Not>>
            {
                ...
                static type call(detail::literal_matcher<Traits, ICase, Not> t) { return type(t.ch_); }
            };
            ...
            struct inverter<detail::logical_newline_matcher<Traits>>
            {
                ...
                static type call(detail::logical_newline_matcher<Traits> t) { return type(t.newline(), true); }
            };
            ...
            struct as_inverse : proto::callable
            {
                ...
                struct result<This(Matcher)> : inverter<UNCVREF(Matcher)>
                {
                };
