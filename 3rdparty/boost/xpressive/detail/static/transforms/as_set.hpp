...
namespace boost {
    namespace xpressive {
        namespace grammar_detail {
            ...
            struct CharLiteral : or_<terminal<char>, terminal<Char>>
            {
            };

            template<>
            struct CharLiteral<char> : terminal<char>
            {
            };
            ...
            struct ListSet :
                or_<when<
                        ...
                        >,
                    when<assign<detail::set_initializer_type, CharLiteral<Char>>, make<mpl::int_<1>>>>
            {
            };
            ...
            struct as_set_matcher : proto::transform<as_set_matcher<Grammar, Callable>>
            {
                ...
                struct impl : proto::transform_impl<Expr, State, Data>
                {
                    ...
                    typedef typename mpl::if_c<
                        ...
                        detail::compound_charset<typename data_type::traits_type>>::type charset_type;

                    typedef detail::
                        charset_matcher<typename data_type::traits_type, typename data_type::icase_type, charset_type>
                            result_type;
