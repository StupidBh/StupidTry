    ...
    namespace xpressive {
        namespace detail {
            ...
            struct use_simple_repeat_terminal :
                mpl::bool_<Expr::quant == quant_fixed_width || (Expr::width != unknown_width::value && Expr::pure)>
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_terminal<Expr, Char, false> : mpl::true_ // char literals, string literals, etc.
            {
            };
            ...
            struct use_simple_repeat_<Expr, Char, proto::tag::shift_right> :
                mpl::and_<
                    use_simple_repeat_<
                        ...
                        Char>,
                    use_simple_repeat_<
                        typename remove_reference<typename Expr::proto_child1>::type::proto_base_expr,
                        Char>>
            {
            };
            ...
            template<>
            struct use_simple_repeat_assign<mark_placeholder> : mpl::false_
            {
            };

            template<>
            struct use_simple_repeat_assign<set_initializer> : mpl::true_
            {
            };

            template<typename Nbr>
            struct use_simple_repeat_assign<attribute_placeholder<Nbr>> : mpl::false_
            {
            };
            ...
            struct use_simple_repeat_<Expr, Char, proto::tag::assign> :
                use_simple_repeat_assign<typename proto::result_of::value<
                    typename remove_reference<typename Expr::proto_child0>::type::proto_base_expr>::type>
            {
            };
            ...
            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, lookahead_tag> : mpl::false_
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, lookbehind_tag> : mpl::false_
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, keeper_tag> : mpl::false_
            {
            };
            ...
            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, proto::tag::comma> : mpl::true_
            {
            };
            ...
            struct use_simple_repeat_subscript : mpl::false_
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_subscript<Expr, Char, set_initializer_type> : mpl::true_
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, proto::tag::subscript> :
                use_simple_repeat_subscript<
                    Expr,
                    Char,
                    typename remove_reference<typename Expr::proto_child0>::type::proto_base_expr>
            {
            ...
            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, proto::tag::unary_plus> : mpl::false_
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, proto::tag::dereference> : mpl::false_
            {
            };

            template<typename Expr, typename Char>
            struct use_simple_repeat_<Expr, Char, proto::tag::logical_not> : mpl::false_
            {
            };

            template<typename Expr, typename Char, uint_t Min, uint_t Max>
            struct use_simple_repeat_<Expr, Char, generic_quant_tag<Min, Max>> : mpl::false_
            {
            };
            ...
            //
            template<typename Expr, typename Char>
            struct use_simple_repeat : use_simple_repeat_<Expr, Char>
            {
            ...
            template<typename Expr, typename Char>
            struct use_simple_repeat<Expr&, Char> : use_simple_repeat_<Expr, Char>
            {
                // should never try to repeat something of 0-width
                BOOST_MPL_ASSERT_RELATION(0, !=, (width_of<Expr, Char>::value));
            };
