...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct add_widths : mpl::size_t<N + M>
            {
            };

            template<std::size_t M>
            struct add_widths<unknown_width::value, M> : unknown_width
            {
            };

            template<std::size_t N>
            struct add_widths<N, unknown_width::value> : unknown_width
            {
            };

            template<>
            struct add_widths<unknown_width::value, unknown_width::value> : unknown_width
            {
            };
            ...
            //
            template<std::size_t N, std::size_t M>
            struct or_widths : unknown_width
            {
            };

            template<std::size_t N>
            struct or_widths<N, N> : mpl::size_t<N>
            {
            };
            ...
            struct width_of_terminal : mpl::size_t<Expr::width> // xpressive literals
            {
            };
            ...
            struct width_of_terminal<Char, Char, false> : mpl::size_t<1> // char literals
            {
            };
            ...
            template<typename Expr, typename Char>
            struct width_of_assign<Expr, Char, set_initializer> : mpl::size_t<1>
            {
            };

            template<typename Expr, typename Char, typename Nbr>
            struct width_of_assign<Expr, Char, attribute_placeholder<Nbr>> : unknown_width
            {
            };
            ...
            template<typename Expr, typename Char>
            struct width_of<Expr, Char, lookahead_tag> : mpl::size_t<0>
            {
            };

            template<typename Expr, typename Char>
            struct width_of<Expr, Char, lookbehind_tag> : mpl::size_t<0>
            {
            };
            ...
            template<typename Expr, typename Char>
            struct width_of<Expr, Char, keeper_tag> : unknown_width
            {
            ...
            template<typename Expr, typename Char>
            struct width_of<Expr, Char, proto::tag::unary_plus> : unknown_width
            {
            };

            template<typename Expr, typename Char>
            struct width_of<Expr, Char, proto::tag::dereference> : unknown_width
            {
            };

            template<typename Expr, typename Char>
            struct width_of<Expr, Char, proto::tag::logical_not> : unknown_width
            {
            };

            template<typename Expr, typename Char, uint_t Min, uint_t Max>
            struct width_of<Expr, Char, generic_quant_tag<Min, Max>> : unknown_width
            {
            };
            ...
            template<typename Expr, typename Char>
            struct width_of<Expr, Char, proto::tag::comma> : mpl::size_t<1>
            {
            };
            ...
            template<typename Expr, typename Char, typename Left>
            struct width_of_subscript : width_of<Left, Char>
            {
            };

            template<typename Expr, typename Char>
            struct width_of_subscript<Expr, Char, set_initializer_type> : mpl::size_t<1>
            {
