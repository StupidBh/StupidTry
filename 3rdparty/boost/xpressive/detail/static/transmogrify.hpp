...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct is_char_literal : mpl::or_<is_same<T, Char>, is_same<T, char>>
            {
            };
            ...
            struct default_transmogrify
            {
                ...
                typedef typename mpl::if_c<
                    ...
                    string_matcher<Traits, ICase>>::type type;
            ...
            struct default_transmogrify<
                ...
                Traits,
                Matcher,
                typename Matcher::is_boost_xpressive_xpression_>
            {
            ...
            template<typename BidiIter, typename ICase, typename Traits, typename Matcher>
            struct transmogrify : default_transmogrify<BidiIter, ICase, Traits, Matcher>
            {
            };
