    ...
    namespace xpressive {
        namespace detail {
            ...
            struct stacked_xpression : Next
            {
                ...
                {
                    return static_cast<Next const*>(this)->BOOST_NESTED_TEMPLATE push_match<Top>(state);
                }
                ...
                {
                    return static_cast<Top const*>(top)->BOOST_NESTED_TEMPLATE push_match<Top>(state);
                }
            ...
            struct static_xpression : Matcher
            {
                ...
                BOOST_STATIC_CONSTANT(
                    std::size_t,
                    width = Matcher::width != unknown_width::value && Next::width != unknown_width::value
                ...
                detail::width get_width() const { return this->get_width_(mpl::size_t<width>()); }
            ...
            inline static_xpression<Matcher> const make_static(Matcher const& matcher)
            {
                return static_xpression<Matcher>(matcher);
            }

            template<typename Matcher, typename Next>
            inline static_xpression<Matcher, Next> const make_static(Matcher const& matcher, Next const& next)
            {
            ...
            struct no_next
            {
                ...
                detail::width get_width() const { return 0; }
            };
