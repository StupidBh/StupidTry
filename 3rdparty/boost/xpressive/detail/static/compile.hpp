    ...
    namespace xpressive {
        namespace detail {
            ...
            struct XpressiveLocaleModifier :
                proto::binary_expr<modifier_tag, proto::terminal<locale_modifier<proto::_>>, proto::_>
            {
            };
                ...
                static_compile_impl1(Xpr const& xpr, shared_ptr<regex_impl<BidiIter>> const& impl)
            {
                ...
                typedef typename proto::result_of::value<typename proto::result_of::left<Xpr>::type>::type::locale_type
                    locale_type;
