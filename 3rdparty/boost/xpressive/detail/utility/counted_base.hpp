...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct counted_base
            {
                long use_count() const { return this->count_; }
            ...
            protected:
                ...
                counted_base& operator=(counted_base<Derived> const&) { return *this; }
            ...
            struct counted_base_access
            {
                static void add_ref(counted_base<Derived> const* that) { ++that->count_; }
