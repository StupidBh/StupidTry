...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            {
                static BOOST_CONSTEXPR char const* pick(char const* cstr, wchar_t const*) { return cstr; }

                static BOOST_CONSTEXPR char pick(char ch, wchar_t) { return ch; }
            };

            template<>
            struct string_literal<wchar_t>
            {
                static BOOST_CONSTEXPR wchar_t const* pick(char const*, wchar_t const* cstr) { return cstr; }

                static BOOST_CONSTEXPR wchar_t pick(char, wchar_t ch) { return ch; }
            };
