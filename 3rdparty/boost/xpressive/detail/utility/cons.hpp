...
namespace boost {
    namespace fusion {
        ...
        namespace cons_detail {
            ...
            struct deref_traits_impl
            {
                ...
                typedef typename mpl::eval_if<
                    ...
                    add_reference<value_type>>::type type;

                static type call(Iterator const& i) { return detail::ref(i.cons.car); }
            };
            ...
            struct next_traits_impl
            {
                ...
                typedef cons_iterator<
                    typename mpl::eval_if<is_const<cons_type>, add_const<cdr_type>, mpl::identity<cdr_type>>::type>
                    type;

                static type call(Iterator const& i) { return type(detail::ref(i.cons.cdr)); }
            };
            ...
            struct begin_traits_impl
            {
                ...
                static type call(Cons& t) { return type(t); }
            };

            template<typename Cons>
            struct end_traits_impl
            {
                typedef cons_iterator<typename mpl::if_<is_const<Cons>, nil const, nil>::type> type;

                static type call(Cons& t) { FUSION_RETURN_DEFAULT_CONSTRUCTED; }
            };
        } // namespace cons_detail
        ...
        inline cons<Car> make_cons(Car const& car)
        {
            return cons<Car>(car);
        }

        template<typename Car, typename Cdr>
        inline cons<Car, Cdr> make_cons(Car const& car, Cdr const& cdr)
        {
...
namespace boost {
    namespace mpl {
        ...
        template<>
        struct begin_impl<fusion::cons_tag> : fusion::meta::begin_impl<fusion::cons_tag>
        {
        };

        template<>
        struct end_impl<fusion::cons_tag> : fusion::meta::end_impl<fusion::cons_tag>
        {
        };
...
namespace boost {
    namespace mpl {
        ...
        template<typename Cons>
        struct next<fusion::cons_iterator<Cons>> : fusion::cons_detail::next_traits_impl<fusion::cons_iterator<Cons>>
        {
        };
        ...
        template<typename Cons>
        struct deref<fusion::cons_iterator<Cons>> : fusion::cons_detail::value_traits_impl<fusion::cons_iterator<Cons>>
        {
        };
