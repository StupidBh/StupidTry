    ...
    namespace xpressive {
        namespace detail {
            ...
            struct weak_iterator :
                iterator_facade<weak_iterator<Derived>, shared_ptr<Derived> const, std::forward_iterator_tag>
            {
            ...
            private:
                ...
                shared_ptr<Derived> const& dereference() const { return this->cur_; }
                ...
                bool equal(weak_iterator<Derived> const& that) const { return this->iter_ == that.iter_; }
            ...
            struct filter_self
            {
                ...
                bool operator()(shared_ptr<Derived> const& that) const { return this->self_ != that.get(); }
            ...
            struct enable_reference_tracking
            {
                ...
                void tracking_clear() { this->raw_copy_(Derived()); }
                ...
                long use_count() const { return this->cnt_; }

                void add_ref() { ++this->cnt_; }
...
//{{AFX_DEBUG
            ...
            protected:
                ...
                void swap(enable_reference_tracking<Derived>& that) { this->refs_.swap(that.refs_); }
            ...
            private:
                ...
                void raw_copy_(Derived that) { detail::adl_swap(this->derived_(), that); }

                bool has_deps_() const { return !this->deps_.empty(); }
...
// smart-pointer operators
                ...
                operator unspecified_bool_type() const { return this->impl_ ? &tracking_ptr::impl_ : 0; }
                ...
                element_type const* operator->() const { return get_pointer(this->impl_); }

                // Since this does not un-share the data, it returns a ref-to-const
                element_type const& operator*() const { return *this->impl_; }
            ...
            private:
                ...
                bool has_deps_() const { return this->impl_ && this->impl_->has_deps_(); }
