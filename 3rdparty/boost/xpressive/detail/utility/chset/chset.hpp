...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            struct compound_charset : private basic_chset<typename Traits::char_type>
            {
                ...
                ///////////////////////////////////////////////////////////////////////////////
                // accessors
                basic_chset<char_type> const& base() const { return *this; }

                bool is_inverted() const { return this->complement_; }

                char_class_type posix_yes() const { return this->posix_yes_; }

                std::vector<char_class_type> const& posix_no() const { return this->posix_no_; }

                ///////////////////////////////////////////////////////////////////////////////
                // complement
                void inverse() { this->complement_ = !this->complement_; }
                ...
                bool test(char_type ch, Traits const& tr, ICase) const
                {
                    return this->complement_ !=
                           (this->base_type::test(ch, tr, ICase()) || (this->has_posix_ && this->test_posix(ch, tr)));
                }
            ...
            template<typename Traits>
            inline void set_class(
                compound_charset<Traits>& chset,
                typename Traits::char_class_type char_class,
                bool no,
                Traits const&)
            {
