...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            // is_narrow_char
            template<typename Char>
            struct is_narrow_char : mpl::false_
            {
            };

            template<>
            struct is_narrow_char<char> : mpl::true_
            {
            };

            template<>
            struct is_narrow_char<signed char> : mpl::true_
            {
            };

            template<>
            struct is_narrow_char<unsigned char> : mpl::true_
            {
            };
