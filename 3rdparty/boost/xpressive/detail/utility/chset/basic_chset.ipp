...
namespace boost {
    namespace xpressive {
        namespace detail {
            ...
            /////////////////////////////////
            template<typename Char>
            inline basic_chset<Char>& basic_chset<Char>::operator|=(basic_chset<Char> const& that)
            {
            ...
            /////////////////////////////////
            template<typename Char>
            inline basic_chset_8bit<Char>& basic_chset_8bit<Char>::operator|=(basic_chset_8bit<Char> const& that)
            {
            ...
            template<typename Char>
            inline std::bitset<256> const& basic_chset_8bit<Char>::base() const
            {
                return this->bset_;
            }
