...
#define BOOST_BINARY_LITERAL_D(d, bit_groupings) \
    BOOST_PP_SEQ_CAT((0)BOOST_DETAIL_CREATE_BINARY_LITERAL_OCTAL_SEQUENCE(d, bit_groupings))
    ...
    #define BOOST_DETAIL_CONVERT_BIT_SEQUENCE_TO_TRIPLE_SEQUENCE(bit_sequence) \
        BOOST_PP_CAT(BOOST_DETAIL_CONVERT_BIT_SEQUENCE_TO_PARENTHETIC_TUPLE_1 bit_sequence, END_BIT)
    ...
    #define BOOST_DETAIL_CREATE_BINARY_LITERAL_BIT_SEQUENCE(d, bit_groupings) \
        ...
        (BOOST_DETAIL_BINARY_LITERAL_PREDICATE, BOOST_DETAIL_BINARY_LITERAL_OPERATION, bit_groupings())
    ...
    #define BOOST_DETAIL_BINARY_LITERAL_OPERATION(d, state) \
        BOOST_DETAIL_SPLIT_AND_SWAP(BOOST_PP_CAT(BOOST_DETAIL_BINARY_LITERAL_ELEMENT_, state))
  ...
  bit ) ) BOOST_DETAIL_CONVERT_BIT_SEQUENCE_TO_PARENTHETIC_TUPLE_1
    ...
    #define BOOST_DETAIL_IS_NULLARY_ARGS(param) \
        BOOST_DETAIL_LEFT_OF_COMMA(BOOST_PP_CAT(BOOST_DETAIL_IS_NULLARY_ARGS_R_, BOOST_DETAIL_IS_NULLARY_ARGS_C param))
