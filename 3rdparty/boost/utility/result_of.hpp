...
namespace boost {
    ...
    struct result_of;
    template<typename F>
    struct tr1_result_of; // a TR1-style implementation of result_of
    ...
    // Work around a nvcc bug by only defining has_result when it's needed.
        ...
        struct result_of_has_template
        {
        };

        template<class T>
        struct result_of_has_result_impl
        {
            template<class U>
            static result_of_yes_type f(result_of_has_template<U::template result>*);
            template<class U>
            static result_of_no_type f(...);
        ...
        template<class T>
        struct result_of_has_result : result_of_has_result_impl<T>::type
        {
        };
        ...
        #ifdef BOOST_MSVC
            #pragma warning(disable: 4913) // user defined binary operator ',' exists but no overload could convert all
        ...
        template<typename F, bool TestCallability = true>
        ...
        struct result_of_pointer : tr1_result_of_impl<typename remove_cv<F>::type, FArgs, false>
        {
        };
        ...
        struct tr1_result_of_impl<F, FArgs, false> :
            conditional<
                is_function_with_no_args<FArgs>::value,
