...
namespace boost {
    ...
    public:
        ...
        basic_string_ref(const charT* str) BOOST_NOEXCEPT : ptr_(str), len_(traits::length(str)) {}
        ...
        basic_string_ref substr() const { return basic_string_ref(data(), size()); }
        ...
        {
            const_iterator iter =
                std::find_if(this->cbegin(), this->cend(), detail::string_ref_traits_eq<charT, traits>(c));
            return iter == this->cend() ? npos : std::distance(this->cbegin(), iter);
        }
        ...
        size_type rfind(basic_string_ref s) const
        {
            ...
            const_reverse_iterator iter =
                std::search(this->crbegin(), this->crend(), s.crbegin(), s.crend(), traits::eq);
        ...
        {
            const_reverse_iterator iter =
                std::find_if(this->crbegin(), this->crend(), detail::string_ref_traits_eq<charT, traits>(c));
        ...
        {
            const_reverse_iterator iter =
                std::find_first_of(this->crbegin(), this->crend(), s.cbegin(), s.cend(), traits::eq);
            return iter == this->crend() ? npos : (this->size() - 1 - std::distance(this->crbegin(), iter));
        }
