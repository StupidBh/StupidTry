...
struct tr1_result_of<F(Args...)> :
    conditional<
        ...
        boost::detail::tr1_result_of_impl<F, F(Args...), (boost::detail::result_of_has_result_type<F>::value)>>::type
{
};

#ifdef BOOST_RESULT_OF_USE_DECLTYPE
template<typename F, typename... Args>
struct result_of<F(Args...)> : detail::cpp0x_result_of<F(Args...)>
{
};
...
namespace detail {
    ...
    struct cpp0x_result_of<F(Args...)> :
        conditional<
            ...
            detail::tr1_result_of_impl<typename remove_cv<F>::type, typename remove_cv<F>::type(Args...), false>,
            detail::cpp0x_result_of_impl<F(Args...)>>::type
    {
    };
    ...
    template<typename F>
    struct result_of_callable_fun : result_of_callable_fun_2<F>
    {
    };

    template<typename F>
    struct result_of_callable_fun<F*> : result_of_callable_fun_2<F>
    {
    };
    ...
    struct result_of_select_call_wrapper_type :
        conditional<
            ...
            type_identity<result_of_callable_fun<typename remove_cv<typename remove_reference<F>::type>::type>>>::type
    {
    };
    ...
    struct cpp0x_result_of_impl<F(Args...), true> :
        lazy_enable_if<result_of_is_callable<F, Args...>, cpp0x_result_of_impl<F(Args...), false>>
    {
    };
    ...
    struct cpp0x_result_of_impl<
        F(Args...),
        typename result_of_always_void<decltype(boost::declval<F>()(boost::declval<Args>()...))>::type>
    {
        typedef decltype(boost::declval<F>()(boost::declval<Args>()...)) type;
    };
