...
namespace boost {
    namespace statechart {
        ...
        class fifo_scheduler : noncopyable {
            typedef processor_container<fifo_scheduler, typename FifoWorker::work_item, Allocator> container;
...
//////////////////////////////////////////////////////////////////////////
            ...
            processor_handle create_processor()
            {
                ...
                work_item item = container_.template create_processor<Processor>(result, *this);
            ...
            {
                processor_handle result;
                work_item item = container_.template create_processor<Processor>(result, *this, arg1);
                worker_.queue_work_item(item);
                return result;
            }
            ...
            {
                processor_handle result;
                work_item item = container_.template create_processor<Processor>(result, *this, arg1, arg2);
                worker_.queue_work_item(item);
                return result;
            }
            ...
            {
                processor_handle result;
                work_item item = container_.template create_processor<Processor>(result, *this, arg1, arg2, arg3);
                worker_.queue_work_item(item);
                return result;
            }
            ...
            {
                processor_handle result;
                work_item item = container_.template create_processor<Processor>(result, *this, arg1, arg2, arg3, arg4);
                worker_.queue_work_item(item);
                return result;
            }
            ...
            processor_handle create_processor(Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            {
                processor_handle result;
                work_item item =
                    container_.template create_processor<Processor>(result, *this, arg1, arg2, arg3, arg4, arg5);
                worker_.queue_work_item(item);
                return result;
            }
            ...
            processor_handle create_processor(Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6)
            {
                processor_handle result;
                work_item item =
                    container_.template create_processor<Processor>(result, *this, arg1, arg2, arg3, arg4, arg5, arg6);
                worker_.queue_work_item(item);
                return result;
            }
            ...
            void queue_work_item(work_item& item) { worker_.queue_work_item(item); }
            ...
            // calls operator().
            bool terminated() const { return worker_.terminated(); }
