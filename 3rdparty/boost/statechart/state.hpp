...
namespace boost {
    namespace statechart {
        ...
        class state : public simple_state<MostDerived, Context, InnerInitial, historyMode> {
        ...
        public:
                ...
                deep_construct(const context_ptr_type& pContext, outermost_context_base_type& outermostContextBase)
            {
                ...
                base_type::template deep_construct_inner<inner_initial_list>(pInnerContext, outermostContextBase);
            }
            ...
            {
                const inner_context_ptr_type pInnerContext(new MostDerived(my_context(pContext)));
