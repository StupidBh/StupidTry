...
namespace boost {
    namespace statechart {
        ...
        class event : public detail::rtti_policy::rtti_derived_type<MostDerived, event_base> {
        public:
            //////////////////////////////////////////////////////////////////////////
            // Compiler-generated copy constructor and copy assignment operator are
            // fine

            void* operator new(std::size_t size) { return detail::allocate<MostDerived, Allocator>(size); }

            void* operator new(std::size_t, void* p) { return p; }

            void operator delete(void* pEvent) { detail::deallocate<MostDerived, Allocator>(pEvent); }
        ...
        private:
            ...
            {
                return intrusive_ptr<const event_base>(
