...
namespace boost {
    namespace statechart {
        namespace detail {
            ...
            struct rtti_policy
            {
                ...
                public:
                    ////////////////////////////////////////////////////////////////////////
                    explicit id_type(const std::type_info& id) :
                        id_(id)
                    {
                    }

                    bool operator==(id_type right) const { return (id_ == right.id_) != 0; }

                    bool operator!=(id_type right) const { return !(*this == right); }

                    bool operator<(id_type right) const { return id_.before(right.id_) != 0; }
                ...
                public:
                    ...
                    {
                        BOOST_ASSERT(
                            (idProvider_->pCustomId_ == 0) || (*idProvider_->pCustomIdType_ == typeid(CustomId)));
    ...
    ////////////////////////////////////////////////////////////////////////
                ...
                private:
                    ...
                    virtual void dummy() {}
#else
                    rtti_base_type(id_provider_type idProvider) :
                ...
                public:
                    ...
                    static const CustomId* custom_static_type_ptr()
                    {
                        BOOST_ASSERT(
                            ...
                            (*id_holder<MostDerived>::idProvider_.pCustomIdType_ == typeid(CustomId)));
                        return static_cast<const CustomId*>(id_holder<MostDerived>::idProvider_.pCustomId_);
                    }
...
#else
                    rtti_derived_type() :
                        Base(&id_holder<MostDerived>::idProvider_)
                    {
                    }
#endif
                };
