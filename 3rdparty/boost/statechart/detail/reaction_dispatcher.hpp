    ...
    namespace statechart {
        namespace detail {
            ...
            private:
                ...
                {
                    static result react(State& stt, const EventBase&) { return Reactions::react_without_action(stt); }
                };
                ...
                struct base
                {
                    static result react(State& stt, const EventBase& evt, const IdType&)
                    {
                        typedef typename mpl::if_<
                            ...
                            without_action,
                            base_with_action>::type reaction;
                ...
                struct derived_with_action
                {
                    static result react(State& stt, const EventBase& evt)
                    {
                        return Reactions::react_with_action(stt, *polymorphic_downcast<const Event*>(&evt));
                    }
                };

                struct derived
                {
                    static result react(State& stt, const EventBase& evt, const IdType& eventType)
                    {
                        if (eventType == Event::static_type()) {
                            typedef typename mpl::if_<
                                is_same<ActionContext, detail::no_context<Event>>,
                                without_action,
                                derived_with_action>::type reaction;
                            return reaction::react(stt, evt);
                        }
                        else {
            ...
            public:
                ...
                {
                    typedef typename mpl::if_<is_same<Event, EventBase>, base, derived>::type reaction;
                    return result_utility::get_result(reaction::react(stt, evt, eventType));
                }
            };
