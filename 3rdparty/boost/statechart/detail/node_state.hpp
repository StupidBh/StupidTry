        ...
        namespace detail {
            ...
            protected:
                ...
                node_state(typename RttiPolicy::id_provider_type idProvider) :
                    base_type(idProvider)
                {
                    for (orthogonal_position_type pos = 0; pos < OrthogonalRegionCount::value; ++pos) {
                        pInnerStates[pos] = 0;
                    }
                }
            ...
            public:
                ...
                void add_inner_state(orthogonal_position_type position, state_base_type* pInnerState)
                {
                    BOOST_ASSERT((position < OrthogonalRegionCount::value) && (pInnerStates[position] == 0));
                ...
                {
                    state_base_type** const pPastEnd = &pInnerStates[OrthogonalRegionCount::value];
                    ...
                    state_base_type** const pFirstNonNull =
                        std::find_if(&pInnerStates[0], pPastEnd, &node_state::is_not_null);
                    ...
                    if (pFirstNonNull == pPastEnd) {
                        ...
                        typename state_base_type::node_state_base_ptr_type pSelf = pOutermostUnstableState;
                        ...
                        for (state_base_type** pState = pPastEnd; pState != pFirstNonNull;) {
                            ...
                            if (*pState != 0) {
                                (*pState)->remove_from_state_list(statesEnd, pOutermostUnstableState, performFullExit);
                            }
                        }
                    }
                }

                typedef typename base_type::direct_state_base_ptr_type direct_state_base_ptr_type;

            private:
                //////////////////////////////////////////////////////////////////////////
                static bool is_not_null(const state_base_type* pInner) { return pInner != 0; }
