...
namespace boost {
    namespace statechart {
        ...
        template<
            ...
            void (ReactionContext::*pAction)(const Event&) = &detail::no_context<Event>::no_function>
        ...
        public:
            ...
            {
                typedef detail::reaction_dispatcher<reactions<State>, State, EventBase, Event, ReactionContext, IdType>
                    dispatcher;
