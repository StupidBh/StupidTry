...
namespace boost {
    namespace statechart {
        ...
        namespace detail {
            ...
            struct result_utility
            {
                static ::boost::statechart::result make_result(reaction_result value) { return value; }

                static reaction_result get_result(::boost::statechart::result value) { return value; }
            };
