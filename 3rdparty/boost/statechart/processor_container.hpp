...
namespace boost {
    namespace statechart {
        namespace detail {
            ...
            struct unwrap
            {
                typedef typename unwrap_impl<is_reference_wrapper<T>::value>::template apply<T>::type type;
            };
        }
...
// are inaccessible from event_processor<>::event_processor
            ...
            WorkItem create_processor(processor_handle& handle, Scheduler& scheduler)
            {
                ...
                handle = pProcessor;
                typedef void (
                    processor_container::*impl_fun_ptr)(const processor_holder_ptr_type&, const processor_context&);
                impl_fun_ptr pImpl = &processor_container::template create_processor_impl0<Processor>;
                return WorkItem(
            ...
            WorkItem create_processor(processor_handle& handle, Scheduler& scheduler, Arg1 arg1)
            {
                ...
                typedef void (processor_container::*impl_fun_ptr)(
                    ...
                    arg1_type);
                impl_fun_ptr pImpl = &processor_container::template create_processor_impl1<Processor, arg1_type>;
                return WorkItem(
                    boost::bind(pImpl, this, pProcessor, processor_context(scheduler, handle), arg1),
                    Allocator());
            }
            ...
            WorkItem create_processor(processor_handle& handle, Scheduler& scheduler, Arg1 arg1, Arg2 arg2)
            {
                ...
                typedef void (processor_container::*impl_fun_ptr)(
                    ...
                    arg2_type);
                impl_fun_ptr pImpl =
                    &processor_container::template create_processor_impl2<Processor, arg1_type, arg2_type>;
                return WorkItem(
                    boost::bind(pImpl, this, pProcessor, processor_context(scheduler, handle), arg1, arg2),
                    Allocator());
            }
            ...
            WorkItem create_processor(processor_handle& handle, Scheduler& scheduler, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            {
                ...
                typedef void (processor_container::*impl_fun_ptr)(
                    ...
                    arg3_type);
                impl_fun_ptr pImpl =
                    &processor_container::template create_processor_impl3<Processor, arg1_type, arg2_type, arg3_type>;
                return WorkItem(
                    boost::bind(pImpl, this, pProcessor, processor_context(scheduler, handle), arg1, arg2, arg3),
                    Allocator());
            }
                ...
                Arg4 arg4)
            {
                ...
                impl_fun_ptr pImpl =
                    &processor_container::
                        template create_processor_impl4<Processor, arg1_type, arg2_type, arg3_type, arg4_type>;
                return WorkItem(
                    boost::bind(pImpl, this, pProcessor, processor_context(scheduler, handle), arg1, arg2, arg3, arg4),
                    Allocator());
            }
                ...
                Arg5 arg5)
            {
                ...
                typedef void (processor_container::*impl_fun_ptr)(
                    ...
                    arg4_type,
                    arg5_type);
                impl_fun_ptr pImpl = &processor_container::template create_processor_impl5<
                    Processor,
                    arg1_type,
                    arg2_type,
                    arg3_type,
                ...
                Arg6 arg6)
            {
                ...
                typedef void (processor_container::*impl_fun_ptr)(
                    ...
                    arg5_type,
                    arg6_type);
                impl_fun_ptr pImpl = &processor_container::template create_processor_impl6<
                    Processor,
                    arg1_type,
                    arg2_type,
                    arg3_type,
            ...
            {
                return WorkItem(
                    boost::bind(&processor_container::initiate_processor_impl, this, processor),
                    Allocator());
            }
            ...
            {
                return WorkItem(
                    boost::bind(&processor_container::terminate_processor_impl, this, processor),
                    Allocator());
            }
            ...
            WorkItem queue_event(const processor_handle& processor, const event_ptr_type& pEvent)
            {
                ...
                return WorkItem(
                    boost::bind(&processor_container::queue_event_impl, this, processor, pEvent),
                    Allocator());
            }
        ...
        private:
            ...
            template<class Processor>
            void create_processor_impl0(const processor_holder_ptr_type& pProcessor, const processor_context& context)
            {
            ...
            void queue_event_impl(const processor_handle& processor, const event_ptr_type& pEvent)
            {
                const processor_holder_ptr_type pProcessor = processor.lock();
            ...
            typedef std::set<
                ...
                typename boost::detail::allocator::rebind_to<Allocator, processor_holder_ptr_type>::type>
