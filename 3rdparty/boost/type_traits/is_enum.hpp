...
namespace boost {
    ...
    namespace detail {
        ...
        struct is_class_or_union
        {
            ...
            BOOST_STATIC_CONSTANT(
                bool,
                value = sizeof(is_class_or_union_tester(0)) == sizeof(::boost::type_traits::yes_type));
                #else
            template<class U>
            static ::boost::type_traits::no_type is_class_or_union_tester(...);
            BOOST_STATIC_CONSTANT(
        ...
        struct is_enum_helper<false>
        {
            ...
            struct type
            {
                static const bool value = ::boost::
                    is_convertible<typename boost::add_reference<T>::type, ::boost::detail::int_convertible>::value;
            };
        };
        ...
        struct is_enum_impl
        {
            ...
            BOOST_STATIC_CONSTANT(
                bool,
                selector = ::boost::is_arithmetic<T>::value || ::boost::is_reference<T>::value ||
                           ::boost::is_function<T>::value || is_class_or_union<T>::value || is_array<T>::value);
            #else
            ...
            BOOST_STATIC_CONSTANT(
                bool,
                selector = ::boost::is_arithmetic<T>::value || ::boost::is_reference<T>::value ||
                           ::boost::is_function<T>::value || is_array<T>::value);
            ...
            BOOST_STATIC_CONSTANT(
                bool,
                selector = ::boost::is_arithmetic<T>::value || ::boost::is_reference<T>::value ||
                           is_class_or_union<T>::value || is_array<T>::value);

        #endif

        #if BOOST_WORKAROUND(BOOST_BORLANDC, < 0x600)
            typedef ::boost::detail::is_enum_helper<::boost::detail::is_enum_impl<T>::selector> se_t;
        #else
    ...
    template<class T>
    struct is_enum : public integral_constant<bool, ::boost::detail::is_enum_impl<T>::value>
    {
    };
    ...
    template<class T>
    struct is_enum : public integral_constant<bool, false>
    {
    };
    ...
    template<class T>
    struct is_enum : public integral_constant<bool, BOOST_IS_ENUM(T)>
    {
    };
