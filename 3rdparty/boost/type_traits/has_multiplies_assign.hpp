...
#define BOOST_TT_FORBIDDEN_IF                                                                                 \
    (                                              /* Lhs==fundamental and Lhs==const and Rhs==fundamental */ \
     (::boost::is_fundamental<Lhs_nocv>::value && ::boost::is_const<Lhs_noref>::value &&                      \
      ::boost::is_fundamental<Rhs_nocv>::value) || /* Lhs==pointer and (Rhs==fundamental or Rhs==pointer) */  \
     (::boost::is_pointer<Lhs_noref>::value &&                                                                \
      (::boost::is_fundamental<Rhs_nocv>::value ||                                                            \
       ::boost::is_pointer<Rhs_noref>::value)) || /* Rhs==pointer and (Lhs==fundamental or Lhs==pointer) */   \
