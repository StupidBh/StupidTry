...
namespace boost {
    ...
    namespace binary_op_detail {
        ...
        template<class T, class U>
        struct has_minus_ret_filter<T, U, boost::binary_op_detail::dont_care> :
            public boost::binary_op_detail::has_minus_dc_imp<T, U>
        {
        };
    ...
    #define BOOST_TT_FORBIDDEN_IF                                                                                 \
        (                                               /* Lhs==pointer and Rhs==fundamental and Rhs!=integral */ \
         (::boost::is_pointer<Lhs_noref>::value && ::boost::is_fundamental<Rhs_nocv>::value &&                    \
          (!::boost::is_integral<Rhs_noref>::value)) || /* Lhs==void* and (Rhs==fundamental or Rhs==pointer) */   \
         (::boost::is_pointer<Lhs_noref>::value && ::boost::is_void<Lhs_noptr>::value &&                          \
          (::boost::is_fundamental<Rhs_nocv>::value ||                                                            \
           ::boost::is_pointer<Rhs_noref>::value)) || /* Rhs==void* and (Lhs==fundamental or Lhs==pointer) */     \
         (::boost::is_pointer<Rhs_noref>::value && ::boost::is_void<Rhs_noptr>::value &&                          \
          (::boost::is_fundamental<Lhs_nocv>::value ||                                                            \
           ::boost::is_pointer<Lhs_noref>::value)) || /* Lhs=fundamental and Rhs=pointer */                       \
         (::boost::is_fundamental<Lhs_nocv>::value &&                                                             \
          ::boost::is_pointer<Rhs_noref>::value) ||   /* two different pointers */                                \
         (::boost::is_pointer<Lhs_noref>::value && ::boost::is_pointer<Rhs_noref>::value &&                       \
          (!::boost::is_same<Lhs_nocv, Rhs_nocv>::value)))

    #define BOOST_TT_FORBIDDEN_IF_NEW                                                                       \
        (boost::is_void<typename remove_pointer<typename boost::remove_reference<T>::type>::type>::value || \
         boost::is_void<typename remove_pointer<typename boost::remove_reference<U>::type>::type>::value)
