...
namespace boost {
    ...
    struct is_assignable :
        public integral_constant<
            bool,
            sizeof(detail::is_assignable_imp::test<T, U>(0)) == sizeof(boost::type_traits::yes_type)>
    {
...
namespace boost {
    ...
    template<class T, class U>
    struct is_assignable : public integral_constant<bool, false>
    {
        BOOST_STATIC_ASSERT_MSG(boost::is_complete<T>::value, "Arguments to is_assignable must be complete types");
    };
    ...
    struct is_assignable<T&, U> :
        public integral_constant<bool, is_pod<T>::value && is_pod<typename remove_reference<U>::type>::value>
    {
    };

    template<class T, class U>
    struct is_assignable<const T&, U> : public integral_constant<bool, false>
    {
    };
    ...
    struct is_assignable<void const volatile, U> : public integral_constant<bool, false>
    {
        ...
        template <> struct is_assignable<void const volatile, void const volatile> : public integral_constant<bool,
        false>{};
        */
#endif
