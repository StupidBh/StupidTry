...
namespace boost {
    ...
    namespace detail {
        ...
        #if !BOOST_WORKAROUND(BOOST_BORLANDC, < 0x600) && !defined(__IBMCPP__) && \
            !BOOST_WORKAROUND(__DMC__, BOOST_TESTED_AT(0x840)) && !defined(__MWERKS__)
        template<class T, std::size_t N>
    ...
    struct extent : public ::boost::integral_constant<std::size_t, ::boost::detail::extent_imp<T, N>::value>
    {
    };
