    ...
    namespace binary_op_detail {
        ...
        struct BOOST_JOIN(BOOST_TT_TRAIT_NAME, _ret_imp)<
            ...
            typename boost::make_void<
                decltype(BOOST_TT_TRAIT_OP std::declval<typename add_reference<T>::type>())>::type> :
            public boost::integral_constant<
                bool,
                ::boost::is_convertible<
                    decltype(BOOST_TT_TRAIT_OP std::declval<typename add_reference<T>::type>()),
                    Ret>::value>
        {
        };
        ...
        struct BOOST_JOIN(BOOST_TT_TRAIT_NAME, _void_imp)<
            ...
            public boost::integral_constant<
                bool,
                ::boost::is_void<decltype(BOOST_TT_TRAIT_OP std::declval<typename add_reference<T>::type>())>::value>
        {
        };
...
namespace boost {
    namespace detail {
        ...
        namespace BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl) {
            ...
            // - operator BOOST_TT_TRAIT_OP returns void   -> (BOOST_TT_TRAIT_OP rhs, returns_void_t()) returns
            // returns_void_t
                ...
                BOOST_STATIC_CONSTANT(
                    ...
                    value =
                        (sizeof(::boost::type_traits::yes_type) ==
                         sizeof(returns_void((BOOST_TT_TRAIT_OP make<Rhs>(), returns_void_t())))));
            };
            ...
            struct operator_exists
            {
                ...
                BOOST_STATIC_CONSTANT(
                    bool,
                    value =
                        (sizeof(s_check(((BOOST_TT_TRAIT_OP make<Rhs>()), make<has_operator>()))) ==
                         sizeof(::boost::type_traits::yes_type)));
            };
    ...
    struct BOOST_TT_TRAIT_NAME :
        public integral_constant<
            bool,
            (::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl)::trait_impl<Rhs, Ret>::value)>
    {
    };
