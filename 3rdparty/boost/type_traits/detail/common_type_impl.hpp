...
namespace boost {
    ...
    namespace type_traits_detail {
        ...
        struct common_type_class :
            public boost::conditional<
                ...
                typename boost::conditional<
                    ...
                    common_type_impl3<T, U>>::type>::type
        {
        };

        template<class T, class U>
        struct common_type_impl :
            public boost::conditional<ct_class<T, U>::value, common_type_class<T, U>, common_type_impl3<T, U>>::type
        {
        };
        ...
        template<class T, class U>
        struct common_type_impl5 : public common_arithmetic_type<T, U>
        {
        };
