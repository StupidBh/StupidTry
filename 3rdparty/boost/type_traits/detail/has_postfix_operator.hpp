...
namespace boost {
    ...
    namespace binary_op_detail {
        ...
        struct BOOST_JOIN(BOOST_TT_TRAIT_NAME, _ret_imp)<
            T,
            Ret,
            typename boost::make_void<decltype(std::declval<typename add_reference<T>::type>()
                                                   BOOST_TT_TRAIT_OP)>::type> :
            public boost::integral_constant<
                bool,
                ::boost::is_convertible<
                    decltype(std::declval<typename add_reference<T>::type>() BOOST_TT_TRAIT_OP),
                    Ret>::value>
        {
        };
        ...
        struct BOOST_JOIN(BOOST_TT_TRAIT_NAME, _void_imp)<
            ...
            public boost::integral_constant<
                bool,
                ::boost::is_void<decltype(std::declval<typename add_reference<T>::type>() BOOST_TT_TRAIT_OP)>::value>
        {
        };
        ...
        struct BOOST_JOIN(BOOST_TT_TRAIT_NAME, _dc_imp)<
            T,
            typename boost::make_void<decltype(std::declval<typename add_reference<T>::type>()
                                                   BOOST_TT_TRAIT_OP)>::type> : public boost::true_type
        {
        };
    ...
    template<class T>
    struct BOOST_TT_TRAIT_NAME<T, boost::binary_op_detail::dont_care> :
        public boost::binary_op_detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME, _dc_imp)<T>
    {
    };
...
namespace boost {
    namespace detail {
        ...
        namespace BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl) {
            ...
            // - operator BOOST_TT_TRAIT_OP returns void   -> (lhs BOOST_TT_TRAIT_OP, returns_void_t()) returns
            // returns_void_t
                ...
                BOOST_STATIC_CONSTANT(
                    ...
                    value =
                        (sizeof(::boost::type_traits::yes_type) ==
                         sizeof(returns_void((make<Lhs>() BOOST_TT_TRAIT_OP, returns_void_t())))));
            };
            ...
            struct operator_returns_Ret<Lhs, Ret, false>
            {
                ...
                BOOST_STATIC_CONSTANT(
                    bool,
                    value =
                        (sizeof(is_convertible_to_Ret(make<Lhs>() BOOST_TT_TRAIT_OP)) ==
                         sizeof(::boost::type_traits::yes_type)));
            };
            ...
            struct operator_exists
            {
                ...
                BOOST_STATIC_CONSTANT(
                    bool,
                    value =
                        (sizeof(s_check(((make<Lhs>() BOOST_TT_TRAIT_OP), make<has_operator>()))) ==
                         sizeof(::boost::type_traits::yes_type)));
            };
    ...
    struct BOOST_TT_TRAIT_NAME :
        public integral_constant<
            bool,
            (::boost::detail::BOOST_JOIN(BOOST_TT_TRAIT_NAME, _impl)::trait_impl<Lhs, Ret>::value)>
    {
    };
