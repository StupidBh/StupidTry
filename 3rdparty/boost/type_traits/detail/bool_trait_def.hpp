...
#define BOOST_TT_AUX_BOOL_TRAIT_DEF1(trait, T, C) \
    template<typename T>                          \
    struct trait BOOST_TT_AUX_BOOL_C_BASE(C)      \
    {                                             \
    public:                                       \
...
#define BOOST_TT_AUX_BOOL_TRAIT_SPEC1(trait, sp, C) \
    template<>                                      \
    struct trait<sp> BOOST_TT_AUX_BOOL_C_BASE(C)    \
    {                                               \
    public:                                         \
        BOOST_TT_AUX_BOOL_TRAIT_VALUE_DECL(C)       \
    };                                              \
...
#define BOOST_TT_AUX_BOOL_TRAIT_SPEC2(trait, sp1, sp2, C) \
    template<>                                            \
    struct trait<sp1, sp2> BOOST_TT_AUX_BOOL_C_BASE(C)    \
    {                                                     \
    public:                                               \
        BOOST_TT_AUX_BOOL_TRAIT_VALUE_DECL(C)             \
    };                                                    \
