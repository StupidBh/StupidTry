...
#include <boost/type_traits/integral_constant.hpp>
    ...
    #include <boost/type_traits/remove_const.hpp>
        ...
        #define SOLARIS_EXTRA_CHECK \
            &&is_assignable<typename remove_const<T>::type&, typename remove_const<T>::type&&>::value
    #endif
#endif
...
#else
            ::boost::is_pod<T>::value && !::boost::is_const<T>::value &&
                !::boost::is_volatile<T>::value SOLARIS_EXTRA_CHECK
#endif
            >
    {};
