...
#define BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(T)                                         \
    template<>                                                                           \
    struct need_promotion<T> : public integral_constant<bool, (sizeof(T) < sizeof(int))> \
    {                                                                                    \
    };
...
// Define BOOST_TT_AUX_PROMOTED_INDEX_TESTER:
    ...
    #define BOOST_TT_AUX_PROMOTED_INDEX_TESTER(I, T) char (&promoted_index_tester(T))[I];
...
#undef BOOST_TT_AUX_PROMOTED_INDEX_TESTER
            ...
            struct integral_promotion_impl
            {
                typedef BOOST_DEDUCED_TYPENAME promote_from_index<
                    ...
                    (boost::is_volatile<T>::value)>::type type;
            };
