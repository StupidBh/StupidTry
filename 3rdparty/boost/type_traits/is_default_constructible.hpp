...
namespace boost {
    ...
    namespace detail {
        ...
        struct is_default_constructible_abstract_filter
        {
            static const bool value =
                sizeof(is_default_constructible_imp::test<T>(0)) == sizeof(boost::type_traits::yes_type);
        };
    ...
    struct is_default_constructible :
        public integral_constant<
            bool,
            detail::is_default_constructible_abstract_filter<T, boost::is_abstract<T>::value>::value>
    {
    ...
    struct is_default_constructible :
        public integral_constant<
            bool,
            sizeof(boost::detail::is_default_constructible_imp::test<T>(0)) == sizeof(boost::type_traits::yes_type)>
    {
        BOOST_STATIC_ASSERT_MSG(
            boost::is_complete<T>::value,
            "Arguments to is_default_constructible must be complete types");
    ...
    struct is_default_constructible<std::pair<T, U>> :
        public integral_constant<bool, is_default_constructible<T>::value && is_default_constructible<U>::value>
    {
    };
    #endif
...
namespace boost {
    ...
    template<class T>
    struct is_default_constructible : public is_pod<T>
    {
    };
