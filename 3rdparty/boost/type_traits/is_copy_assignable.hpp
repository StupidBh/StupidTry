...
#include <boost/type_traits/is_noncopyable.hpp>
    ...
    !defined(BOOST_INTEL_CXX_VERSION) && !(defined(BOOST_MSVC) && _MSC_VER == 1800)
...
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
            ...
            //          ...
            //      };
            BOOST_STATIC_CONSTANT(bool, value = (sizeof(test(produce())) == sizeof(boost::type_traits::yes_type)));
#endif
        };
        ...
        struct is_copy_assignable_impl
        {
            ...
            BOOST_STATIC_CONSTANT(
                bool,
                value =
                    (boost::detail::is_copy_assignable_impl2 < boost::is_noncopyable<T>::value ||
                         boost::is_const<unreferenced_t>::value || boost::is_array<unreferenced_t>::value,
                     T > ::value));
#else
            BOOST_STATIC_CONSTANT(
                bool,
                value = (boost::detail::is_copy_assignable_impl2<boost::is_noncopyable<T>::value, T>::value));
#endif
        };
    ...
    template<class T>
    struct is_copy_assignable : public integral_constant<bool, ::boost::detail::is_copy_assignable_impl<T>::value>
    {
    };

    template<>
    struct is_copy_assignable<void> : public false_type
    {
    };
#ifndef BOOST_NO_CV_VOID_SPECIALIZATIONS
    template<>
    struct is_copy_assignable<void const> : public false_type
    {
    };

    template<>
    struct is_copy_assignable<void const volatile> : public false_type
    {
    };

    template<>
    struct is_copy_assignable<void volatile> : public false_type
    {
    };
#endif
