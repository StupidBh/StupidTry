...
namespace boost {
    ...
    namespace binary_op_detail {
        ...
        struct has_minus_assign_void_imp<
            T,
            U,
            typename boost::make_void<
                decltype(std::declval<typename add_reference<T>::type>() -= std::declval<typename add_reference<U>::type>())>::
        ...
        template<class T, class U>
        struct has_minus_assign_dc_imp<
            T,
            U,
            typename boost::make_void<
                decltype(std::declval<typename add_reference<T>::type>() -= std::declval<typename add_reference<U>::type>())>::
        ...
        template<class T, class U>
        struct has_minus_assign_ret_filter<T, U, boost::binary_op_detail::dont_care> :
            public boost::binary_op_detail::has_minus_assign_dc_imp<T, U>
        {
        };
    ...
    struct has_minus_assign :
        public boost::binary_op_detail::has_minus_assign_void_ptr_filter<
            ...
            boost::is_void<typename remove_pointer<typename remove_reference<T>::type>::type>::value ||
                ...
                (boost::is_pointer<typename remove_reference<T>::type>::value &&
    ...
    #define BOOST_TT_FORBIDDEN_IF                                                                                      \
        (                                               /* Lhs==pointer and Rhs==fundamental and Rhs!=integral */      \
         (::boost::is_pointer<Lhs_noref>::value && ::boost::is_fundamental<Rhs_nocv>::value &&                         \
          (!::boost::is_integral<Rhs_noref>::value)) || /* Lhs==void* and Rhs==fundamental */                          \
         ...
         (::boost::is_pointer<Rhs_noref>::value && ::boost::is_void<Rhs_noptr>::value &&                               \
          ::boost::is_fundamental<Lhs_nocv>::value) ||  /* Lhs=fundamental and Rhs=pointer */                          \
         (::boost::is_fundamental<Lhs_nocv>::value &&                                                                  \
          ::boost::is_pointer<Rhs_noref>::value) ||     /* Lhs==pointer and Rhs==pointer */                            \
         (::boost::is_pointer<Lhs_noref>::value &&                                                                     \
          ::boost::is_pointer<Rhs_noref>::value) ||     /* (Lhs==fundamental or Lhs==pointer) and (Rhs==fundamental or \
                                                           Rhs==pointer) and (Lhs==const) */                           \
