...
namespace boost {
    namespace detail {
        ...
        template<class T>
        struct sp_is_bounded_array : std::false_type
        {
        };

        template<class T, std::size_t N>
        struct sp_is_bounded_array<T[N]> : std::true_type
        {
        };
        ...
        template<class T>
        struct sp_is_unbounded_array : std::false_type
        {
        };

        template<class T>
        struct sp_is_unbounded_array<T[]> : std::true_type
        {
        };
