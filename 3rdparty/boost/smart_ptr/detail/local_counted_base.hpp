...
namespace boost {
    ...
    namespace detail {
        ...
        public:
            constexpr local_counted_base() noexcept :
        ...
        public:
            explicit local_counted_impl(shared_count const& pn) noexcept :
                pn_(pn)
            {
            }

            explicit local_counted_impl(shared_count&& pn) noexcept :
                pn_(std::move(pn))
            {
            }
            ...
            boost::detail::shared_count local_cb_get_shared_count() const noexcept override { return pn_; }
        };
