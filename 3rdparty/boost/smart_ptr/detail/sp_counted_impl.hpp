...
namespace boost {
    ...
    namespace detail {
        ...
        template<class D>
        D* get_local_deleter(D* /*p*/) noexcept
        {
            return 0;
        }
        ...
        template<class X>
        class BOOST_SYMBOL_VISIBLE sp_counted_impl_p : public sp_counted_base {
        private:
            X* px_;
        ...
        class BOOST_SYMBOL_VISIBLE sp_counted_impl_pd : public sp_counted_base {
        private:
        ...
        class BOOST_SYMBOL_VISIBLE sp_counted_impl_pda : public sp_counted_base {
        private:
