...
namespace boost {
    ...
    namespace detail {
        ...
        inline void
            lsp_pointer_construct(boost::local_shared_ptr<E>* /*ppx*/, Y* p, boost::detail::local_counted_base*& pn)
        {
        ...
        inline void
            lsp_pointer_construct(boost::local_shared_ptr<E[N]>* /*ppx*/, Y* p, boost::detail::local_counted_base*& pn)
        {
        ...
        inline void lsp_deleter_construct(
            boost::local_shared_ptr<E>* /*ppx*/,
            P p,
            D const& d,
        ...
        inline void lsp_allocator_construct(
            boost::local_shared_ptr<E>* /*ppx*/,
            P p,
            D const& d,
            A const& a,
    ...
    public:
        ...
        constexpr local_shared_ptr(
            boost::detail::lsp_internal_constructor_tag,
            element_type* px_,
        ...
        template<class Y>
        local_shared_ptr(local_shared_ptr<Y>&& r, element_type* p) noexcept :
            px(p),
            pn(r.pn)
        {
            r.px = 0;
        ...
        template<class Y>
        void reset(local_shared_ptr<Y> const& r, element_type* p) noexcept
        {
            local_shared_ptr(r, p).swap(*this);
        }

        template<class Y>
        void reset(local_shared_ptr<Y>&& r, element_type* p) noexcept
        {
        ...
        template<class Y>
        bool owner_before(local_shared_ptr<Y> const& r) const noexcept
        {
        ...
        template<class Y>
        bool owner_equals(local_shared_ptr<Y> const& r) const noexcept
        {
            return pn == r.pn;
        }
    };
    ...
    template<class T>
    std::size_t hash_value(local_shared_ptr<T> const& p) noexcept
    {
...
namespace std {
    ...
    template<class T>
    struct hash<::boost::local_shared_ptr<T>>
    {
