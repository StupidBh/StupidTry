...
namespace boost {
    ...
    namespace detail {
        namespace variant {
            ...
            public: // metafunction result
                typedef typename mpl::deref<max_it>::type type;
            };
            ...
            struct add_alignment
            {
                ...
                struct apply :
                    mpl::size_t<::boost::integer::static_lcm<
                        BOOST_MPL_AUX_VALUE_WKND(State)::value,
                        ::boost::alignment_of<Item>::value>::value>
                {
                };
            };
            ...
            private: // helpers, for metafunction result (below)
                ...
                typedef typename mpl::iter_fold_if<
                    Types,
                    mpl::int_<0>,
                    mpl::protect<mpl::next<>>,
                    mpl::protect<find_fallback_type_pred>>::type first_result_;
                ...
                typedef typename mpl::iter_fold_if<
                    ...
                    first_result_index,
                    mpl::protect<mpl::next<>>,
                    mpl::protect<mpl::not_same_as<boost::blank>>>::type second_result_;
            ...
            public: // metafunction result
                ...
                typedef typename mpl::eval_if<
                    ...
                    mpl::if_<
                        ...
                        first_result_>,
                    mpl::identity<second_result_>>::type type;
            };
            ...
            struct is_variant_move_noexcept_constructible
            {
                typedef typename boost::mpl::
                    find_if<Types, mpl::not_<boost::is_nothrow_move_constructible<boost::mpl::_1>>>::type iterator_t;

                typedef typename boost::mpl::end<Types>::type end_t;
                typedef typename boost::is_same<iterator_t, end_t>::type type;
            };
            ...
            {
                typedef typename boost::mpl::
                    find_if<Types, mpl::not_<boost::is_nothrow_move_assignable<boost::mpl::_1>>>::type iterator_t;
            ...
            struct is_constructible_ext :
                boost::mpl::or_<
                    boost::is_constructible<T1, T2>,
                    boost::is_constructible<T1, typename boost::add_lvalue_reference<T2>::type>>
            {
            };
            ...
            struct is_variant_constructible_from :
                boost::mpl::not_<boost::is_same<
                    typename boost::mpl::find_if<Types, is_constructible_ext<boost::mpl::_1, T>>::type,
            ...
            struct is_variant_constructible_from<boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types> :
                boost::is_same<
                    typename boost::mpl::find_if<
                        ...
                        mpl::not_<is_variant_constructible_from<boost::mpl::_1, Types>>>::type,
                    typename boost::mpl::end<
                        typename boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types>::type>
            {
            };
            ...
            private: // helpers, for metafunction result (below)
                typedef typename mpl::eval_if<
                    NeverUsesBackupFlag,
                    mpl::identity<Types>,
                    mpl::push_front<Types, backup_holder<void*>>>::type types;
                ...
                typedef typename mpl::fold<types, mpl::size_t<1>, add_alignment>::type max_alignment;
...
#if BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x0551)) || BOOST_WORKAROUND(BOOST_MSVC, BOOST_TESTED_AT(1600))
            ...
            //
            template<typename T>
            class known_get : public static_visitor<T&> {
            public: // visitor interface
                T& operator()(T& operand) const BOOST_NOEXCEPT { return operand; }
            ...
            //
            class copy_into : public static_visitor<> {
            private: // representation
                void* storage_;

            public: // structors
                explicit copy_into(void* storage) BOOST_NOEXCEPT : storage_(storage) {}
            ...
            //
            class move_into : public static_visitor<> {
            private: // representation
                void* storage_;

            public: // structors
                explicit move_into(void* storage) BOOST_NOEXCEPT : storage_(storage) {}
            ...
            public: // internal visitor interface
                ...
                template<typename T>
                void internal_visit(T& operand, int) const
                    BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(boost::declval<T>())))
                {
            ...
            //
            struct assign_storage : public static_visitor<>
            {
            private: // representation
                const void* rhs_storage_;

            public: // structors
                explicit assign_storage(const void* rhs_storage) BOOST_NOEXCEPT : rhs_storage_(rhs_storage) {}

            public: // internal visitor interfaces
                template<typename T>
                void internal_visit(backup_holder<T>& lhs_content, long) const
                {
                    lhs_content.get() = static_cast<const backup_holder<T>*>(rhs_storage_)->get();
                }
            ...
            // constructed value of the same type) to the value it visits.
            //
            struct move_storage : public static_visitor<>
            {
            private: // representation
                void* rhs_storage_;

            public: // structors
                explicit move_storage(void* rhs_storage) BOOST_NOEXCEPT : rhs_storage_(rhs_storage) {}
            ...
            //
            template<typename T>
            class direct_assigner : public static_visitor<bool> {
            private: // representation
                const T& rhs_;

            public: // structors
                explicit direct_assigner(const T& rhs) BOOST_NOEXCEPT : rhs_(rhs) {}
            ...
            //
            template<typename T>
            class direct_mover : public static_visitor<bool> {
            private: // representation
                T& rhs_;

            public: // structors
                explicit direct_mover(T& rhs) BOOST_NOEXCEPT : rhs_(rhs) {}
            ...
            class backup_assigner : public static_visitor<> {
            private: // representation
                Variant& lhs_;
                int rhs_which_;
            ...
            private: // helpers, for visitor interface (below)
                    ...
                    long)
                {
                    ...
                    BOOST_CATCH(...)
                    {
                        ...
                        new (lhs_.storage_.address()) backup_holder<LhsT>(0);                                 // nothrow

                        static_cast<backup_holder<LhsT>*>(lhs_.storage_.address())->swap(backup_lhs_content); // nothrow
                ...
                {
                    // Move lhs content to backup...
                    LhsT backup_lhs_content(::boost::detail::variant::move(lhs_content)); // nothrow
                    ...
                    BOOST_CATCH(...)
                    {
                        ...
                        new (lhs_.storage_.address())
                            LhsT(::boost::detail::variant::move(backup_lhs_content)); // nothrow
                    ...
                    int)
                {
                    ...
                    {
                        // In case of failure, copy backup pointer to lhs storage...
                        new (lhs_.storage_.address()) backup_holder<LhsT>(backup_lhs_ptr); // nothrow
            ...
            public: // visitor interface
                ...
                {
                    typedef typename is_nothrow_move_constructible<LhsT>::type nothrow_move;
            ...
            //
            template<typename Variant>
            struct swap_with : public static_visitor<>
            {
            private: // representation
                Variant& toswap_;

            public: // structors
                explicit swap_with(Variant& toswap) BOOST_NOEXCEPT : toswap_(toswap) {}
            ...
            class reflect : public static_visitor<const boost::typeindex::type_info&> {
            public: // visitor interfaces
                template<typename T>
            ...
            public: // structors
                explicit comparer(const Variant& lhs) BOOST_NOEXCEPT : lhs_(lhs) {}
            ...
            public: // structors
                explicit invoke_visitor(Visitor& visitor) BOOST_NOEXCEPT : visitor_(visitor) {}

            public: // internal visitor interfaces
                // using workaround with is_same<T, T> to prenvent compilation error, because we need to use T in
                // enable_if to make SFINAE work
                template<typename T>
                typename enable_if_c<MoveSemantics && is_same<T, T>::value, result_type>::type
                ...
                // enable_if to make SFINAE work
                template<typename T>
                typename disable_if_c<MoveSemantics && is_same<T, T>::value, result_type>::type
                    internal_visit(T&& operand, int)
                {
    ...
    private: // helpers, for typedefs (below)
        ...
        struct is_recursive_ : detail::variant::is_recursive_flag<T0_>
        {
        };

        typedef typename mpl::eval_if<is_recursive_, T0_, mpl::identity<T0_>>::type unwrapped_T0_;

        struct is_sequence_based_ : detail::variant::is_over_sequence<unwrapped_T0_>
        {
        };
    ...
    private: // helpers, for typedefs (below)
        typedef typename mpl::eval_if<
            ...
            ,
            detail::variant::make_variant_list<unwrapped_T0_, BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)>>::type
            specified_types;

        BOOST_STATIC_ASSERT((::boost::mpl::not_<mpl::empty<specified_types>>::value));

    public: // public typedefs
        typedef typename mpl::eval_if<
            is_recursive_,
            mpl::transform<specified_types, mpl::protect<detail::variant::quoted_enable_recursive<wknd_self_t>>>,
            mpl::identity<specified_types>>::type
            recursive_enabled_types; // used by is_variant_constructible_from<> trait

        typedef typename mpl::transform<recursive_enabled_types, unwrap_recursive<mpl::_1>>::type types;

    private: // internal typedefs
        typedef typename mpl::transform<recursive_enabled_types, mpl::protect<detail::make_reference_content<>>>::type
            internal_types;

        typedef typename mpl::front<internal_types>::type internal_T0;

    private: // helpers, for representation (below)
        typedef typename detail::variant::find_fallback_type<internal_types>::type fallback_type_result_;

        typedef typename fallback_type_result_::first fallback_type_index_;
        typedef typename fallback_type_result_::second fallback_type_;

        struct has_fallback_type_ : mpl::not_<is_same<fallback_type_, detail::variant::no_fallback_type>>
        {
        };

        typedef has_fallback_type_ never_uses_backup_flag;

        typedef typename detail::variant::make_storage<internal_types, never_uses_backup_flag>::type storage_t;

        typedef typename detail::variant::is_variant_move_noexcept_constructible<internal_types>
            variant_move_noexcept_constructible;

        typedef typename detail::variant::is_variant_move_noexcept_assignable<internal_types>
    ...
    private: // helpers, for representation (below)
        ...
        typedef typename mpl::eval_if<
            ...
            mpl::identity<int>,
            mpl::if_<mpl::less<mpl::O1_size<internal_types>, mpl::int_<SCHAR_MAX>>, signed char, int>>::type which_t;
...
// representation -- private when possible
    ...
    public:
        ...
        void indicate_which(int which_arg) BOOST_NOEXCEPT { which_ = static_cast<which_t>(which_arg); }

        void indicate_backup_which(int which_arg) BOOST_NOEXCEPT { which_ = static_cast<which_t>(-(which_arg + 1)); }

    private: // helpers, for queries (below)
        bool using_backup() const BOOST_NOEXCEPT { return which_ < 0; }
    ...
    private: // helpers, for structors (below)
        struct initializer : BOOST_VARIANT_AUX_INITIALIZER_T(recursive_enabled_types, recursive_enabled_T)
        {
        };
    ...
    public: // structors
        ~variant() BOOST_NOEXCEPT { destroy_content(); }
    ...
    private:     // helpers, for structors, cont. (below)
        class convert_copy_into : public static_visitor<int> {
        private: // representation
            void* storage_;

        public: // structors
            explicit convert_copy_into(void* storage) BOOST_NOEXCEPT : storage_(storage) {}
        ...
        class convert_move_into : public static_visitor<int> {
        private: // representation
            void* storage_;

        public: // structors
            explicit convert_move_into(void* storage) BOOST_NOEXCEPT : storage_(storage) {}
    ...
    private: // helpers, for structors, below
        ...
        )
        {
            ...
            //
            indicate_which(initializer::initialize(storage_.address(), operand));
        }
        ...
        )
        {
            ...
            // (or that no conversion exists).
            //
            indicate_which(initializer::initialize(storage_.address(), detail::variant::move(operand)));
        }
        ...
        )
        {
            ...
            indicate_which(operand.internal_apply_visitor(visitor));
        }
        ...
        void convert_construct_variant(Variant& operand)
        {
            ...
            typedef typename mpl::find_if<types, is_same<add_const<mpl::_1>, const Variant>>::type found_it;

            typedef typename mpl::end<types>::type not_found;
            typedef typename is_same<found_it, not_found>::type is_foreign_variant;

            // Convert construct from operand:
            convert_construct(operand, 1L, is_foreign_variant());
        }

        template<typename Variant>
        typename boost::enable_if<boost::is_rvalue_reference<Variant&&>>::type
            convert_construct_variant(Variant&& operand)
        {
            // [Determine if the given variant is itself a bounded type, or if its
            //  content needs to be converted (i.e., it is a 'foreign' variant):]
            //
            ...
            convert_construct(detail::variant::move(operand), 1L, is_foreign_variant());
        }
        ...
        typename boost::enable_if<mpl::or_<
            ...
            boost::detail::variant::
                is_variant_constructible_from<boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>>>::type
            convert_construct(boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand, long)
        {
        ...
        typename boost::enable_if<mpl::or_<
            boost::is_same<boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
            boost::detail::variant::
                is_variant_constructible_from<const boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>>>::
            type
            convert_construct(const boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand, long)
        {
            convert_construct_variant(operand);
        }
    ...
    private: // helpers, for modifiers (below)
        ...
        class assigner : public static_visitor<> {
        protected: // representation
            variant& lhs_;
            const int rhs_which_;

        public: // structors
            assigner(variant& lhs, int rhs_which) BOOST_NOEXCEPT : lhs_(lhs), rhs_which_(rhs_which) {}
        ...
        protected: // helpers, for internal visitor interface (below)
            ...
            void construct_fallback() const BOOST_NOEXCEPT
            {
                ...
                lhs_.indicate_which(BOOST_MPL_AUX_VALUE_WKND(fallback_type_index_)::value); // nothrow
            }
            ...
            {
                detail::variant::backup_assigner<wknd_self_t> visitor(lhs_, rhs_which_, rhs_content);
        ...
        public: // internal visitor interfaces
            ...
            {
                typedef typename has_nothrow_copy<RhsT>::type nothrow_copy;
                typedef typename mpl::
                    or_< // reduces compile-time
                        nothrow_copy,
                        is_nothrow_move_constructible<RhsT>>::type nothrow_move_constructor;
        ...
        public: // structors
            move_assigner(variant& lhs, int rhs_which) BOOST_NOEXCEPT : assigner(lhs, rhs_which) {}
        ...
        private: // helpers, for internal visitor interface (below)
            ...
            ) const BOOST_NOEXCEPT
            {
                ...
                new (assigner::lhs_.storage_.address()) RhsT(detail::variant::move(rhs_content)); // nothrow
            ...
            ) const
            {
                ...
                {
                    // ...and attempt to copy rhs's content into lhs's storage:
                    new (assigner::lhs_.storage_.address()) RhsT(detail::variant::move(rhs_content));
                }
                BOOST_CATCH(...)
                {
        ...
        public: // internal visitor interfaces
            ...
            {
                typedef typename is_nothrow_move_constructible<RhsT>::type nothrow_move_constructor;
                typedef typename mpl::
                    or_< // reduces compile-time
                        nothrow_move_constructor,
                        has_nothrow_copy<RhsT>>::type nothrow_copy;
    ...
    public: // modifiers
        ...
        typename boost::enable_if<
            mpl::or_<
                ...
                boost::detail::variant::is_variant_constructible_from<const T&, internal_types>>,
            variant&>::type operator=(const T& rhs)
        {
            assign(rhs);
            return *this;
        }
    ...
    public: // comparison operators
        ...
        bool operator==(const variant& rhs) const
        {
            ...
            detail::variant::comparer<variant, detail::variant::equal_comp> visitor(*this);
        ...
        bool operator<(const variant& rhs) const
        {
            ...
            detail::variant::comparer<variant, detail::variant::less_comp> visitor(*this);
            return rhs.apply_visitor(visitor);
        }
        ...
        inline bool operator>(const variant& rhs) const { return rhs < *this; }
...
// helpers, for visitation support (below) -- private when possible
    ...
    public:
        ...
        BOOST_FORCEINLINE static typename Visitor::result_type
            internal_apply_visitor_impl(int internal_which, int logical_which, Visitor& visitor, VoidPtrCV storage)
        {
            ...
            return detail::variant::visitation_impl(
                ...
                static_cast<first_which*>(0),
                static_cast<first_step*>(0));
        }

        template<typename Visitor>
        BOOST_FORCEINLINE typename Visitor::result_type internal_apply_visitor(Visitor& visitor)
        {
    ...
    private: // precondition assertions
        ...
        typedef typename boost::mpl::
            insert_range<boost::mpl::list<>, boost::mpl::end<boost::mpl::list<>>::type, Types>::type copied_sequence_t;

    public: // metafunction result
        typedef variant<detail::variant::over_sequence<copied_sequence_t>> type;
    };
    ...
    inline void swap(variant<BOOST_VARIANT_ENUM_PARAMS(T)>& lhs, variant<BOOST_VARIANT_ENUM_PARAMS(T)>& rhs)
    {
        lhs.swap(rhs);
    }
