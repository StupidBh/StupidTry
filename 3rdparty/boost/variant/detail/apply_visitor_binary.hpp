...
namespace boost {
    ...
    namespace detail {
        namespace variant {
            ...
            public: // visitor interfaces
                ...
                {
                    apply_visitor_binary_invoke<Visitor, Value1, !::boost::is_lvalue_reference<Value1>::value> invoker(
                        visitor_,
                        value1);
        ...
        apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2)
    {
        ::boost::detail::variant::
            apply_visitor_binary_unwrap<Visitor, Visitable2, !::boost::is_lvalue_reference<Visitable2>::value>
    ...
    {
        ::boost::detail::variant::
            apply_visitor_binary_unwrap<const Visitor, Visitable2, !::boost::is_lvalue_reference<Visitable2>::value>
                unwrapper(visitor, visitable2);
        ...
        namespace variant {
            ...
            public: // visitor interfaces
                ...
                decltype(auto) operator()(
                    Value2&& value2,
                    typename enable_if_c<MoveSemantics && is_same<Value2, Value2>::value, bool>::type = true)
                {
                    return visitor_(std::move(value1_), std::forward<Value2>(value2));
                }
                ...
                decltype(auto) operator()(
                    Value2&& value2,
                    typename disable_if_c<MoveSemantics && is_same<Value2, Value2>::value, bool>::type = true)
                {
                    return visitor_(value1_, std::forward<Value2>(value2));
                }
            ...
            public: // visitor interfaces
                ...
                decltype(auto) operator()(
                    Value1&& value1,
                    typename enable_if_c<MoveSemantics && is_same<Value1, Value1>::value, bool>::type = true)
                {
                    apply_visitor_binary_invoke_cpp14<Visitor, Value1, !::boost::is_lvalue_reference<Value1>::value>
                ...
                decltype(auto) operator()(
                    Value1&& value1,
                    typename disable_if_c<MoveSemantics && is_same<Value1, Value1>::value, bool>::type = true)
                {
                    apply_visitor_binary_invoke_cpp14<Visitor, Value1, !::boost::is_lvalue_reference<Value1>::value>
                        invoker(visitor_, value1);
    ...
    template<typename Visitor, typename Visitable1, typename Visitable2>
    inline decltype(auto) apply_visitor(
        Visitor& visitor,
        Visitable1&& visitable1,
        Visitable2&& visitable2,
        typename boost::disable_if<boost::detail::variant::has_result_type<Visitor>, bool>::type = true)
    {
        ::boost::detail::variant::
            apply_visitor_binary_unwrap_cpp14<Visitor, Visitable2, !::boost::is_lvalue_reference<Visitable2>::value>
                unwrapper(visitor, visitable2);
        ...
        typename boost::disable_if<boost::detail::variant::has_result_type<Visitor>, bool>::type = true)
    {
        ::boost::detail::variant::apply_visitor_binary_unwrap_cpp14<
            const Visitor,
            Visitable2,
            !::boost::is_lvalue_reference<Visitable2>::value>
            unwrapper(visitor, visitable2);
