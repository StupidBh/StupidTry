...
namespace boost {
    namespace detail {
        namespace variant {
            ...
            public: // structors
                ~backup_holder() BOOST_NOEXCEPT { delete backup_; }

                explicit backup_holder(T* backup) BOOST_NOEXCEPT : backup_(backup) {}
            ...
            public: // queries
                T& get() BOOST_NOEXCEPT { return *backup_; }

                const T& get() const BOOST_NOEXCEPT { return *backup_; }
            };
