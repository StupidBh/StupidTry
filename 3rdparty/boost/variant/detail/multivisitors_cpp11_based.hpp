...
namespace boost {
    ...
    namespace detail {
        namespace variant {
            ...
            MoveableWrapper<Tp, MoveSemantics> wrap(Tp& t)
            {
                return MoveableWrapper<Tp, MoveSemantics> { t };
            }

            template<typename Wrapper>
            typename enable_if_c<Wrapper::MoveSemantics, typename Wrapper::T>::type unwrap(Wrapper& w)
            {
                return std::move(w.v);
            }

            template<typename Wrapper>
            typename disable_if_c<Wrapper::MoveSemantics, typename Wrapper::T>::type& unwrap(Wrapper& w)
            {
                return w.v;
            }
            ...
            {
                return std::tuple<typename std::tuple_element<I + 1, Tuple>::type...>(std::get<I + 1>(tpl)...);
            }
            ...
            public: // structors
                one_by_one_visitor_and_value_referer(
                    Visitor& visitor,
                    Visitables visitables,
                    std::tuple<Values...> values) BOOST_NOEXCEPT :
                    visitor_(visitor),
                    values_(values),
                ...
                result_type operator()(Value&& value) const
                {
                    return ::boost::apply_visitor(
                        make_one_by_one_visitor_and_value_referer(
                            ...
                            std::tuple_cat(
                                values_,
                                std::make_tuple(wrap<Value, !::boost::is_lvalue_reference<Value>::value>(value)))),
    ...
    inline typename Visitor::result_type apply_visitor(const Visitor& visitor, T1&& v1, T2&& v2, T3&& v3, TN&&... vn)
    {
        return ::boost::apply_visitor(
    ...
    template<class Visitor, class T1, class T2, class T3, class... TN>
    inline typename Visitor::result_type apply_visitor(Visitor& visitor, T1&& v1, T2&& v2, T3&& v3, TN&&... vn)
    {
        return ::boost::apply_visitor(
            ::boost::detail::variant::make_one_by_one_visitor_and_value_referer(
                visitor,
