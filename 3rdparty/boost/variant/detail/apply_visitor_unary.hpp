        ...
        namespace variant {
            ...
            struct result_multideduce1
            {
                ...
                typedef typename boost::mpl::
                    advance<begin_it, boost::mpl::int_<boost::mpl::size<types>::type::value - 1>>::type last_it;
                ...
                struct deduce_impl
                {
                    ...
                    typedef decltype(true ? boost::declval<Visitor&>()(boost::declval<copy_cv_ref_t<value_t, Variant>>()) : boost::declval<typename deduce_impl<next_t>::type>())
                        type;
                };
                ...
                struct deduce_impl<last_it, Dummy>
                {
                    ...
                    typedef decltype(boost::declval<Visitor&>()(
                        boost::declval<copy_cv_ref_t<value_t, Variant>>())) type;
                };
            ...
            struct result_wrapper1
            {
                ...
                explicit result_wrapper1(Visitor&& visitor) BOOST_NOEXCEPT : visitor_(std::forward<Visitor>(visitor)) {}
