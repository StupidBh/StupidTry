        ...
        namespace variant {
            ...
            struct make_initializer_node
            {
                ...
                private: // helpers, for metafunction result (below)
                    typedef typename BaseIndexPair::first base;
                    typedef typename BaseIndexPair::second index;

                    class initializer_node : public base {
                    private: // helpers, for static functions (below)
                        typedef typename mpl::deref<Iterator>::type recursive_enabled_T;
                        typedef typename unwrap_recursive<recursive_enabled_T>::type public_T;

                        typedef boost::is_reference<public_T> is_reference_content_t;

                        typedef
                            typename boost::mpl::if_<is_reference_content_t, public_T, const public_T&>::type param_T;
                        ...
                        typedef typename boost::mpl::
                            if_<is_reference_content_t, disable_overload<public_T>, public_T&&>::type param2_T;
                    ...
                    public: // static functions
                        ...
                        {
                            typedef
                                typename boost::detail::make_reference_content<recursive_enabled_T>::type internal_T;
                        ...
                        static int initialize(void* dest, param2_T operand)
                        {
                            ...
                            typedef
                                typename boost::mpl::if_<is_reference_content_t, param2_T, recursive_enabled_T>::type
                                    value_T;
...
#define BOOST_VARIANT_AUX_INITIALIZER_T(mpl_seq, typename_base)                                \
    ::boost::mpl::iter_fold<                                                                   \
        mpl_seq,                                                                               \
        ::boost::mpl::pair<::boost::detail::variant::initializer_root, ::boost::mpl::int_<0>>, \
        ::boost::mpl::protect<::boost::detail::variant::make_initializer_node>>::type::first /**/
