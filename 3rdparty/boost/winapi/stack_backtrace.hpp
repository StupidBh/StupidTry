...
// MinGW does not provide RtlCaptureStackBackTrace
    ...
    // Note: RtlCaptureStackBackTrace is available in WinXP SP1 and later
            ...
            // Windows SDK shipped with MSVC 7.1 and 8 does not declare RtlCaptureStackBackTrace in headers but allows
            // to link with it
            #if !defined(BOOST_USE_WINDOWS_H) || (defined(_MSC_VER) && (_MSC_VER + 0) < 1500)
extern "C"
{
    BOOST_WINAPI_IMPORT boost::winapi::WORD_ BOOST_WINAPI_NTAPI_CC RtlCaptureStackBackTrace(
