...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::VOID_
        BOOST_WINAPI_WINAPI_CC GetSystemInfo(::_SYSTEM_INFO* lpSystemInfo);
    #endif

    #if BOOST_WINAPI_PARTITION_APP || BOOST_WINAPI_PARTITION_SYSTEM
        #if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WINXP
    BOOST_WINAPI_IMPORT boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC GetNativeSystemInfo(::_SYSTEM_INFO* lpSystemInfo);
        #endif
    #endif
}
#endif
