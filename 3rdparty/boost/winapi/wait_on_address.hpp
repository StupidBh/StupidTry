...
extern "C"
{
    ...
    boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC WaitOnAddress(
        volatile boost::winapi::VOID_* addr,
        boost::winapi::PVOID_ compare_addr,
        boost::winapi::SIZE_T_ size,
        boost::winapi::DWORD_ timeout_ms);

    boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC WakeByAddressSingle(boost::winapi::PVOID_ addr);

    boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC WakeByAddressAll(boost::winapi::PVOID_ addr);
...
#endif // BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN8 && (BOOST_WINAPI_PARTITION_APP ||
       // BOOST_WINAPI_PARTITION_SYSTEM)
