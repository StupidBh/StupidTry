...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateFileMappingA(
    ...
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenFileMappingA(
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateFileMappingW(
        boost::winapi::HANDLE_ hFile,
        ::_SECURITY_ATTRIBUTES* lpFileMappingAttributes,
        boost::winapi::DWORD_ flProtect,
        boost::winapi::DWORD_ dwMaximumSizeHigh,
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::LPVOID_ BOOST_WINAPI_WINAPI_CC MapViewOfFile(
    ...
    BOOST_WINAPI_IMPORT boost::winapi::LPVOID_ BOOST_WINAPI_WINAPI_CC MapViewOfFileEx(
        boost::winapi::HANDLE_ hFileMappingObject,
        boost::winapi::DWORD_ dwDesiredAccess,
        boost::winapi::DWORD_ dwFileOffsetHigh,
        boost::winapi::DWORD_ dwFileOffsetLow,
    ...
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenFileMappingW(
        boost::winapi::DWORD_ dwDesiredAccess,
        boost::winapi::BOOL_ bInheritHandle,
        boost::winapi::LPCWSTR_ lpName);
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        FlushViewOfFile(boost::winapi::LPCVOID_ lpBaseAddress, boost::winapi::SIZE_T_ dwNumberOfBytesToFlush);
...
namespace boost {
    namespace winapi {
        ...
        // These constants are not defined in Windows SDK up until the one shipped with MSVC 8 and MinGW (as of
        // 2016-02-14)
        BOOST_CONSTEXPR_OR_CONST DWORD_ SECTION_MAP_EXECUTE_EXPLICIT_ =
            0x00000020;                    // not included in SECTION_ALL_ACCESS
        BOOST_CONSTEXPR_OR_CONST DWORD_ FILE_MAP_EXECUTE_ =
            SECTION_MAP_EXECUTE_EXPLICIT_; // not included in FILE_MAP_ALL_ACCESS
