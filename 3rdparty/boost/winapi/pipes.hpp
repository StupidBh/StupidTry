...
extern "C"
{
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        ImpersonateNamedPipeClient(boost::winapi::HANDLE_ hNamedPipe);
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        ConnectNamedPipe(boost::winapi::HANDLE_ hNamedPipe, _OVERLAPPED* lpOverlapped);

    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        DisconnectNamedPipe(boost::winapi::HANDLE_ hNamedPipe);
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_
        BOOST_WINAPI_WINAPI_CC WaitNamedPipeA(boost::winapi::LPCSTR_ lpNamedPipeName, boost::winapi::DWORD_ nTimeOut);
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        WaitNamedPipeW(boost::winapi::LPCWSTR_ lpNamedPipeName, boost::winapi::DWORD_ nTimeOut);
...
namespace boost {
    namespace winapi {
        ...
        BOOST_FORCEINLINE BOOL_
            CreatePipe(PHANDLE_ hReadPipe, PHANDLE_ hWritePipe, LPSECURITY_ATTRIBUTES_ lpPipeAttributes, DWORD_ nSize)
        {
            return ::CreatePipe(
                hReadPipe,
                hWritePipe,
                reinterpret_cast<::_SECURITY_ATTRIBUTES*>(lpPipeAttributes),
                nSize);
        }
        ...
        BOOST_FORCEINLINE BOOL_ TransactNamedPipe(
            HANDLE_ hNamedPipe,
            LPVOID_ lpInBuffer,
            DWORD_ nInBufferSize,
            LPVOID_ lpOutBuffer,
            DWORD_ nOutBufferSize,
            LPDWORD_ lpBytesRead,
        ...
        #if !defined(BOOST_NO_ANSI_APIS)
        BOOST_FORCEINLINE BOOL_ get_named_pipe_client_computer_name(
            HANDLE_ Pipe,
