...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC SleepConditionVariableCS(
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC SleepConditionVariableSRW(
        boost::winapi::detail::winsdk_condition_variable* ConditionVariable,
