...
#if BOOST_USE_WINAPI_VERSION < BOOST_WINAPI_VERSION_WIN6 || (defined(_MSC_VER) && _MSC_VER < 1600)
...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::VOID_
        BOOST_WINAPI_WINAPI_CC InitializeSRWLock(boost::winapi::detail::winsdk_srwlock* SRWLock);
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOLEAN_
        BOOST_WINAPI_WINAPI_CC TryAcquireSRWLockExclusive(boost::winapi::detail::winsdk_srwlock* SRWLock);
