...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateEventA(
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateEventW(
        ::_SECURITY_ATTRIBUTES* lpEventAttributes,
        boost::winapi::BOOL_ bManualReset,
        boost::winapi::BOOL_ bInitialState,
...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateEventExA(
        ::_SECURITY_ATTRIBUTES* lpEventAttributes,
        boost::winapi::LPCSTR_ lpName,
    ...
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenEventA(
        boost::winapi::DWORD_ dwDesiredAccess,
    ...
    #if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN6
    BOOST_WINAPI_IMPORT boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateEventExW(
        ::_SECURITY_ATTRIBUTES* lpEventAttributes,
        boost::winapi::LPCWSTR_ lpName,
        boost::winapi::DWORD_ dwFlags,
        boost::winapi::DWORD_ dwDesiredAccess);
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenEventW(
        boost::winapi::DWORD_ dwDesiredAccess,
        boost::winapi::BOOL_ bInheritHandle,
        boost::winapi::LPCWSTR_ lpName);
    ...
    #if !defined(UNDER_CE)
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC SetEvent(boost::winapi::HANDLE_ hEvent);
...
namespace boost {
    namespace winapi {
...
#if !defined(BOOST_NO_ANSI_APIS)
        BOOST_FORCEINLINE HANDLE_ CreateEventA(
            SECURITY_ATTRIBUTES_* lpEventAttributes,
            BOOL_ bManualReset,
            BOOL_ bInitialState,
            LPCSTR_ lpName)
        {
            ...
            const DWORD_ flags =
                (bManualReset ? create_event_manual_reset : 0u) | (bInitialState ? create_event_initial_set : 0u);
            return ::CreateEventExA(
                reinterpret_cast<::_SECURITY_ATTRIBUTES*>(lpEventAttributes),
                lpName,
                flags,
                event_all_access);
    #else
    ...
    #if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN6
        BOOST_FORCEINLINE HANDLE_ CreateEventExA(
            SECURITY_ATTRIBUTES_* lpEventAttributes,
            LPCSTR_ lpName,
            DWORD_ dwFlags,
        ...
        BOOST_FORCEINLINE HANDLE_ CreateEventW(
            SECURITY_ATTRIBUTES_* lpEventAttributes,
            BOOL_ bManualReset,
            BOOL_ bInitialState,
            LPCWSTR_ lpName)
...
#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN6
        BOOST_FORCEINLINE HANDLE_ CreateEventExW(
            SECURITY_ATTRIBUTES_* lpEventAttributes,
            LPCWSTR_ lpName,
            DWORD_ dwFlags,
            DWORD_ dwDesiredAccess)
...
#if !defined(BOOST_NO_ANSI_APIS)
        BOOST_FORCEINLINE HANDLE_ create_event(
            SECURITY_ATTRIBUTES_* lpEventAttributes,
            BOOL_ bManualReset,
            BOOL_ bInitialState,
            LPCSTR_ lpName)
        ...
        BOOST_FORCEINLINE HANDLE_
            create_anonymous_event(SECURITY_ATTRIBUTES_* lpEventAttributes, BOOL_ bManualReset, BOOL_ bInitialState)
        {
