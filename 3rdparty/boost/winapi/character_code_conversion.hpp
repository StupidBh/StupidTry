...
extern "C"
{
    BOOST_WINAPI_IMPORT_EXCEPT_WM int BOOST_WINAPI_WINAPI_CC MultiByteToWideChar(
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM int BOOST_WINAPI_WINAPI_CC WideCharToMultiByte(
        boost::winapi::UINT_ CodePage,
        boost::winapi::DWORD_ dwFlags,
