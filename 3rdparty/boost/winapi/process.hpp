...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::BOOL_
        BOOST_WINAPI_WINAPI_CC GetExitCodeProcess(boost::winapi::HANDLE_ hProcess, boost::winapi::LPDWORD_ lpExitCode);
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenProcess(
        ...
        #if defined(_WIN32_WCE)
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::BOOL_
        BOOST_WINAPI_WINAPI_CC TerminateProcess(boost::winapi::HANDLE_ hProcess, boost::winapi::DWORD_ uExitCode);
        #else
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::BOOL_
        BOOST_WINAPI_WINAPI_CC TerminateProcess(boost::winapi::HANDLE_ hProcess, boost::winapi::UINT_ uExitCode);
        #endif
...
namespace boost {
    namespace winapi {
        ...
        BOOST_CONSTEXPR_OR_CONST DWORD_ PROCESS_ALL_ACCESS_ =
            (STANDARD_RIGHTS_REQUIRED_ | SYNCHRONIZE_ |
        ...
        BOOST_FORCEINLINE BOOST_NORETURN boost::winapi::VOID_ exit_process(boost::winapi::UINT_ uExitCode)
        {
    #if !defined(_WIN32_WCE)
