...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC CryptEnumProvidersA(
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC CryptAcquireContextA(
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC CryptEnumProvidersW(
        boost::winapi::DWORD_ dwIndex,
        boost::winapi::DWORD_* pdwReserved,
        boost::winapi::DWORD_ dwFlags,
        boost::winapi::DWORD_* pdwProvType,
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC CryptAcquireContextW(
        boost::winapi::HCRYPTPROV_* phProv,
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        CryptGenRandom(boost::winapi::HCRYPTPROV_ hProv, boost::winapi::DWORD_ dwLen, boost::winapi::BYTE_* pbBuffer);
    #endif // BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM

    #if BOOST_WINAPI_PARTITION_APP_SYSTEM
        #if defined(_MSC_VER) && (_MSC_VER + 0) >= 1500 && (_MSC_VER + 0) < 1900 && \
            BOOST_USE_NTDDI_VERSION < BOOST_WINAPI_NTDDI_WINXP
    // Standalone MS Windows SDK 6.0A and later until 10.0 provide a different declaration of CryptReleaseContext for
    // Windows 2000 and older. This is not the case for (a) MinGW and MinGW-w64, (b) MSVC 7.1 and 8, which are shipped
    // with their own Windows SDK, and (c) MSVC 14.0 and later, which are used with Windows SDK 10.
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        CryptReleaseContext(boost::winapi::HCRYPTPROV_ hProv, boost::winapi::ULONG_PTR_ dwFlags);
        #else
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_
        BOOST_WINAPI_WINAPI_CC CryptReleaseContext(boost::winapi::HCRYPTPROV_ hProv, boost::winapi::DWORD_ dwFlags);
        #endif
