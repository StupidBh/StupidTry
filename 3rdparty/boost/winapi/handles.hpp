...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC DuplicateHandle(
    ...
    (defined(BOOST_WINAPI_IS_MINGW_W64) && (__MINGW64_VERSION_MAJOR >= 6) && (__MINGW64_VERSION_MAJOR < 9))) && \
    (BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN10 &&                                                  \
     (BOOST_WINAPI_PARTITION_APP || BOOST_WINAPI_PARTITION_SYSTEM))
extern "C"
{
    // Older MinGW-w64 do not have this declaration. It is present when __MINGW64_VERSION_MAJOR is 9 or greater, which
    // is the case in 8.0.1 (specifically, not earlier or later 8.x) and 9.0.0 and onwards. Library exports seem to be
    // present since 6.0.0.
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        CompareObjectHandles(boost::winapi::HANDLE_ hFirstObjectHandle, boost::winapi::HANDLE_ hSecondObjectHandle);
} // extern "C"
#endif
