...
extern "C"
{
    ...
    typedef boost::winapi::VOID_(
        BOOST_WINAPI_NTAPI_CC* WAITORTIMERCALLBACKFUNC)(boost::winapi::PVOID_, boost::winapi::BOOLEAN_);
    typedef WAITORTIMERCALLBACKFUNC WAITORTIMERCALLBACK;

    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC RegisterWaitForSingleObject(
    ...
    #if !defined(BOOST_USE_WINDOWS_H) || \
        (defined(BOOST_WINAPI_IS_MINGW) && BOOST_USE_WINAPI_VERSION < BOOST_WINAPI_VERSION_WINXP)
extern "C"
{
        #if BOOST_WINAPI_PARTITION_DESKTOP
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC UnregisterWait(boost::winapi::HANDLE_ WaitHandle);
        #endif

        #if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        UnregisterWaitEx(boost::winapi::HANDLE_ WaitHandle, boost::winapi::HANDLE_ CompletionEvent);
        #endif
} // extern "C"
    #endif
...
namespace boost {
    namespace winapi {
        ...
        BOOST_FORCEINLINE
            BOOST_CONSTEXPR ULONG_ wt_set_max_threadpool_threads(ULONG_ flags, ULONG_ limit) BOOST_NOEXCEPT
        {
