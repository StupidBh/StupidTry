...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC UnDecorateSymbolName(
    ...
    BOOST_WINAPI_IMPORT API_VERSION* BOOST_WINAPI_WINAPI_CC ImagehlpApiVersion(BOOST_WINAPI_DETAIL_VOID);
