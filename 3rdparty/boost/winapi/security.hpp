...
extern "C"
{
    ...
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
        InitializeSecurityDescriptor(PSECURITY_DESCRIPTOR pSecurityDescriptor, boost::winapi::DWORD_ dwRevision);
    BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC SetSecurityDescriptorDacl(
...
namespace boost {
    namespace winapi {
        ...
        BOOST_FORCEINLINE BOOL_
            InitializeSecurityDescriptor(PSECURITY_DESCRIPTOR_ pSecurityDescriptor, DWORD_ dwRevision)
        {
        ...
        BOOST_FORCEINLINE BOOL_ SetSecurityDescriptorDacl(
