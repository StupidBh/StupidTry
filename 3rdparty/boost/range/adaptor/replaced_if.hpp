...
namespace boost {
    namespace range_detail {
        ...
        public:
            ...
            const Value& operator()(const Value& x) const { return m_impl->m_pred(x) ? m_impl->m_to : x; }
        ...
        public:
            ...
            replaced_if_range(R& r, const Pred& pred, value_type to) :
                base_t(
                    make_transform_iterator(boost::begin(r), Fn(pred, to)),
            ...
            operator|(SinglePassRange& r, const replace_if_holder<Pred, Value>& f)
        {
            ...
            return replaced_if_range<Pred, SinglePassRange>(r, f.pred(), f.to());
        }
            ...
            operator|(const SinglePassRange& r, const replace_if_holder<Pred, Value>& f)
        {
            ...
            return replaced_if_range<Pred, const SinglePassRange>(r, f.pred(), f.to());
        }
    } // namespace range_detail
    ...
    namespace adaptors {
        namespace {
            const range_detail::forwarder2TU<range_detail::replace_if_holder> replaced_if =
                range_detail::forwarder2TU<range_detail::replace_if_holder>();
        }

        template<class Pred, class SinglePassRange, class Value>
        inline replaced_if_range<Pred, SinglePassRange> replace_if(SinglePassRange& rng, Pred pred, Value to)
        {
            BOOST_RANGE_CONCEPT_ASSERT((SinglePassRangeConcept<SinglePassRange>));

            return range_detail::replaced_if_range<Pred, SinglePassRange>(rng, pred, to);
        }
            ...
            replace_if(const SinglePassRange& rng, Pred pred, Value to)
        {
            ...
            return range_detail::replaced_if_range<Pred, const SinglePassRange>(rng, pred, to);
        }
    } // namespace adaptors
