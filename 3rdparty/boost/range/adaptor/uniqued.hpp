...
namespace boost {
    ...
    namespace range_detail {
        ...
        template<class ForwardRng>
        inline uniqued_range<ForwardRng> operator|(ForwardRng& r, unique_forwarder)
        {
        ...
        template<class ForwardRng>
        inline uniqued_range<const ForwardRng> operator|(const ForwardRng& r, unique_forwarder)
        {
    ...
    namespace adaptors {
        namespace {
            const range_detail::unique_forwarder uniqued = range_detail::unique_forwarder();
        }

        template<class ForwardRange>
        inline uniqued_range<ForwardRange> unique(ForwardRange& rng)
        {
        ...
        template<class ForwardRange>
        inline uniqued_range<const ForwardRange> unique(const ForwardRange& rng)
        {
