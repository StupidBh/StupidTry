...
namespace boost {
    ...
    namespace range {
        ...
        public:
            ...
            index_value(
                typename tuples::access_traits<Indexable>::parameter_type t0,
            ...
            index_type index() { return boost::tuples::get<0>(*this); }

            const_index_type index() const { return boost::tuples::get<0>(*this); }

            value_type value() { return boost::tuples::get<1>(*this); }

            const_value_type value() const { return boost::tuples::get<1>(*this); }
        };
    ...
    namespace range_detail {
        ...
        {
            typedef ::boost::range::
                index_value<typename iterator_reference<Iter>::type, typename iterator_difference<Iter>::type>
                    type;
        };
        ...
        public:
            typedef typename mpl::if_<
                ...
                typename mpl::if_<
                    ...
                    wrapped_traversal>::type>::type type;
        };
        ...
        private:
            ...
            reference dereference() const { return reference(m_index, *m_it); }

            bool equal(const indexed_iterator& other) const { return m_it == other.m_it; }
            ...
            difference_type distance_to(const indexed_iterator& other) const { return other.m_it - m_it; }
        ...
        struct indexed_range : iterator_range<indexed_iterator<typename range_iterator<SinglePassRange>::type>>
        {
            typedef iterator_range<indexed_iterator<typename range_iterator<SinglePassRange>::type>> base_t;

            BOOST_RANGE_CONCEPT_ASSERT((boost::SinglePassRangeConcept<SinglePassRange>));

        public:
            typedef indexed_iterator<typename range_iterator<SinglePassRange>::type> iterator;
            ...
            // forward iterators.
            indexed_range(typename base_t::difference_type i, SinglePassRange& r, single_pass_traversal_tag) :
                base_t(iterator(boost::begin(r), i), iterator(boost::end(r), i))
            {
            }

            indexed_range(typename base_t::difference_type i, SinglePassRange& r, random_access_traversal_tag) :
                base_t(iterator(boost::begin(r), i), iterator(boost::end(r), i + boost::size(r)))
            {
            }
        };
    ...
    namespace adaptors {
        ...
        inline indexed_range<SinglePassRange> operator|(SinglePassRange& r, indexed e)
        {
            BOOST_RANGE_CONCEPT_ASSERT((boost::SinglePassRangeConcept<SinglePassRange>));
            return indexed_range<SinglePassRange>(e.val, r, typename range_traversal<SinglePassRange>::type());
        }

        template<class SinglePassRange>
        inline indexed_range<const SinglePassRange> operator|(const SinglePassRange& r, indexed e)
        {
        ...
        inline indexed_range<SinglePassRange>
            index(SinglePassRange& rng, typename range_difference<SinglePassRange>::type index_value = 0)
        {
            BOOST_RANGE_CONCEPT_ASSERT((boost::SinglePassRangeConcept<SinglePassRange>));
            return indexed_range<SinglePassRange>(index_value, rng, typename range_traversal<SinglePassRange>::type());
        }
...
namespace std {
    ...
    struct tuple_size<boost::range::index_value<T, Indexable>> : std::integral_constant<std::size_t, 2>
    {
    };
