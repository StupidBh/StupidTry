...
namespace boost {
    namespace range_detail {
        ...
        struct formatted_holder
        {
            typedef typename boost::mpl::
                if_<boost::is_array<Sep>, const typename boost::remove_extent<Sep>::type*, Sep>::type separator_t;

            typedef typename boost::mpl::
                if_<boost::is_array<Prefix>, const typename boost::remove_extent<Prefix>::type*, Prefix>::type prefix_t;

            typedef typename boost::mpl::
                if_<boost::is_array<Postfix>, const typename boost::remove_extent<Postfix>::type*, Postfix>::type
                    postfix_t;
        ...
        class formatted_range : public boost::iterator_range<Iter> {
        ...
        inline range_detail::formatted_range<typename range_iterator<const SinglePassRange>::type, Sep, Prefix, Postfix>
    ...
    namespace adaptors {
        ...
        {
            return range_detail::formatted_holder<Sep, Prefix, Postfix>(sep, prefix, postfix);
        }
        ...
        inline range_detail::formatted_holder<char, char, char> formatted()
        {
        ...
        template<typename SinglePassRange, typename Sep, typename Prefix, typename Postfix>
        inline boost::range_detail::
            formatted_range<typename boost::range_iterator<const SinglePassRange>::type, Sep, Prefix, Postfix>
            format(const SinglePassRange& rng, const Sep& sep, const Prefix& prefix, const Postfix& postfix)
        {
            ...
            typedef boost::range_detail::formatted_range<iterator_t, Sep, Prefix, Postfix> result_t;

            typedef boost::range_detail::formatted_holder<Sep, Prefix, Postfix> holder_t;

            return result_t(boost::begin(rng), boost::end(rng), holder_t(sep, prefix, postfix));
        }

        template<typename SinglePassRange, typename Sep, typename Prefix>
        inline boost::range_detail::
            formatted_range<typename boost::range_iterator<const SinglePassRange>::type, Sep, Prefix, char>
        ...
        inline boost::range_detail::
            formatted_range<typename boost::range_iterator<const SinglePassRange>::type, Sep, char, char>
        ...
        inline boost::range_detail::
            formatted_range<typename boost::range_iterator<const SinglePassRange>::type, char, char, char>
