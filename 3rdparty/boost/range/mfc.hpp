...
namespace boost {
    namespace range_detail_microsoft {
        ...
        template<class ArrayT, class PtrType>
        struct mfc_ptr_array_iterator : mfc_ptr_array_iterator_super<ArrayT, PtrType>::type
        {
        private:
        ...
        template<>
        struct customization<::CByteArray> : array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CDWordArray> : array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CObArray> : mfc_ptr_array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CPtrArray> : mfc_ptr_array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CStringArray> : array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CUIntArray> : array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CWordArray> : array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CObList> : list_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CPtrList> : list_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CStringList> : list_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<class MapT, class KeyT, class MappedT>
        struct mfc_map_iterator : mfc_map_iterator_super<MapT, KeyT, MappedT>::type
        {
        private:
        ...
        {
            typedef iterator_facade<mfc_cpair_map_iterator<MapT, PairT>, PairT, forward_traversal_tag> type;
        };

        template<class MapT, class PairT>
        struct mfc_cpair_map_iterator : mfc_pget_map_iterator_super<MapT, PairT>::type
        {
        private:
        ...
        public:
            ...
            template<class, class>
            friend struct mfc_cpair_map_iterator;
        ...
        template<>
        struct customization<::CMapPtrToWord> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CMapPtrToPtr> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CMapStringToOb> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CMapStringToPtr> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CMapWordToOb> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<>
        struct customization<::CMapWordToPtr> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<class Type, class ArgType>
        struct customization<::CArray<Type, ArgType>> : array_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<class Type, class ArgType>
        struct customization<::CList<Type, ArgType>> : list_functions
        {
            template<class X>
            struct meta
            {
        ...
        struct customization<::CTypedPtrArray<BaseClass, PtrType>>
        {
            ...
            struct fun
            {
                ...
                typedef typename mpl::if_<is_const<X>, val_t const, val_t>::type val_t_;
        ...
        template<class BaseClass, class PtrType>
        struct customization<::CTypedPtrList<BaseClass, PtrType>> : list_functions
        {
            template<class X>
            struct meta
            {
        ...
        template<class BaseClass, class KeyPtrType, class MappedPtrType>
        struct customization<::CTypedPtrMap<BaseClass, KeyPtrType, MappedPtrType>> : mfc_map_functions
        {
            template<class X>
            struct meta
            {
...
// lists
//
BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(boost::range_detail_microsoft::using_type_as_tag, BOOST_PP_NIL, CObList)
...
BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TYPE(boost::range_detail_microsoft::using_type_as_tag, BOOST_PP_NIL, CString)
