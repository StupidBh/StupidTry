    ...
    namespace range {
        ...
        namespace detail {
            ...
            struct wrap_rand
            {
                ...
                static BOOST_CONSTEXPR result_type(max)() { return RAND_MAX; }
            ...
            struct wrap_generator
            {
                ...
                static BOOST_CONSTEXPR result_type(max)() { return max_arg - 1; }

                result_type operator()() { return static_cast<result_type>(g(max_arg)); }
            };
