...
namespace boost {
    namespace range {
        ...
        {
            BOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<ForwardRange>));
            return range_return<ForwardRange, re>::pack(std::lower_bound(boost::begin(rng), boost::end(rng), val), rng);
        }
            ...
            lower_bound(const ForwardRange& rng, const Value& val)
        {
            ...
            return range_return<const ForwardRange, re>::pack(
                std::lower_bound(boost::begin(rng), boost::end(rng), val),
                rng);
        }
            ...
            lower_bound(ForwardRange& rng, const Value& val, SortPredicate pred)
        {
            ...
            return range_return<ForwardRange, re>::pack(
                std::lower_bound(boost::begin(rng), boost::end(rng), val, pred),
                rng);
        }
