...
namespace boost {
    namespace range_detail {
        ...
        inline bool equal_impl(
            SinglePassTraversalReadableIterator1 first1,
        ...
        inline bool equal_impl(
            RandomAccessTraversalReadableIterator1 first1,
        ...
        template<
            class RandomAccessTraversalReadableIterator1,
    ...
    namespace range {
        ...
        inline bool equal(const SinglePassRange1& rng1, const SinglePassRange2& rng2, BinaryPredicate pred)
        {
            BOOST_RANGE_CONCEPT_ASSERT((SinglePassRangeConcept<const SinglePassRange1>));
            BOOST_RANGE_CONCEPT_ASSERT((SinglePassRangeConcept<const SinglePassRange2>));
