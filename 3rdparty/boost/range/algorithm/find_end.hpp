...
namespace boost {
    namespace range {
        ...
        inline BOOST_DEDUCED_TYPENAME
            disable_if<is_const<ForwardRange1>, BOOST_DEDUCED_TYPENAME range_iterator<ForwardRange1>::type>::type
            find_end(ForwardRange1& rng1, const ForwardRange2& rng2)
        {
            ...
            return std::find_end(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2));
        }
            ...
            find_end(ForwardRange1& rng1, const ForwardRange2& rng2, BinaryPredicate pred)
        {
            ...
            return std::find_end(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2), pred);
        }
        ...
        inline BOOST_DEDUCED_TYPENAME
            disable_if<is_const<ForwardRange1>, BOOST_DEDUCED_TYPENAME range_return<ForwardRange1, re>::type>::type
            find_end(ForwardRange1& rng1, const ForwardRange2& rng2)
        {
            BOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<ForwardRange1>));
            BOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<const ForwardRange2>));

            return range_return<ForwardRange1, re>::pack(
                std::find_end(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2)),
                rng1);
        }
            ...
            find_end(const ForwardRange1& rng1, const ForwardRange2& rng2)
        {
            ...
            return range_return<const ForwardRange1, re>::pack(
                std::find_end(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2)),
                rng1);
        }
            ...
            find_end(ForwardRange1& rng1, const ForwardRange2& rng2, BinaryPredicate pred)
        {
            ...
            return range_return<ForwardRange1, re>::pack(
                std::find_end(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2), pred),
                rng1);
        }
