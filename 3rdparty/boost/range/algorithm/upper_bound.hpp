...
namespace boost {
    namespace range {
        ...
        inline BOOST_DEDUCED_TYPENAME
            disable_if<is_const<ForwardRange>, BOOST_DEDUCED_TYPENAME range_iterator<ForwardRange>::type>::type
        ...
        inline BOOST_DEDUCED_TYPENAME
            disable_if<is_const<ForwardRange>, BOOST_DEDUCED_TYPENAME range_return<ForwardRange, re>::type>::type
            upper_bound(ForwardRange& rng, const Value& val)
        {
            BOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<ForwardRange>));
            return range_return<ForwardRange, re>::pack(std::upper_bound(boost::begin(rng), boost::end(rng), val), rng);
        }
            ...
            upper_bound(const ForwardRange& rng, const Value& val)
        {
            ...
            return range_return<const ForwardRange, re>::pack(
                std::upper_bound(boost::begin(rng), boost::end(rng), val),
                rng);
        }
            ...
            upper_bound(ForwardRange& rng, const Value& val, SortPredicate pred)
        {
            ...
            return range_return<ForwardRange, re>::pack(
                std::upper_bound(boost::begin(rng), boost::end(rng), val, pred),
                rng);
        }
