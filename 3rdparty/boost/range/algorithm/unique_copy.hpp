...
namespace boost {
    namespace range {
        ...
        inline OutputIterator unique_copy(const SinglePassRange& rng, OutputIterator out_it)
        {
        ...
        inline OutputIterator unique_copy(const SinglePassRange& rng, OutputIterator out_it, BinaryPredicate pred)
        {
            BOOST_RANGE_CONCEPT_ASSERT((SinglePassRangeConcept<const SinglePassRange>));
