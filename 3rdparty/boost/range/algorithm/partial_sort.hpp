...
namespace boost {
    namespace range {
        ...
        inline RandomAccessRange&
            partial_sort(RandomAccessRange& rng, BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type middle)
        {
        ...
        /// \overload
        template<class RandomAccessRange>
        inline const RandomAccessRange& partial_sort(
        ...
        inline RandomAccessRange& partial_sort(
