...
namespace boost {
    namespace range {
            ...
            search(ForwardRange1& rng1, const ForwardRange2& rng2)
        {
            ...
            return std::search(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2));
        }
            ...
            search(ForwardRange1& rng1, const ForwardRange2& rng2)
        {
            ...
            return range_return<ForwardRange1, re>::pack(
                std::search(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2)),
                rng1);
        }
            ...
            search(ForwardRange1& rng1, const ForwardRange2& rng2, BinaryPredicate pred)
        {
            ...
            BOOST_RANGE_CONCEPT_ASSERT((ForwardRangeConcept<const ForwardRange2>));
            return range_return<ForwardRange1, re>::pack(
                std::search(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2), pred),
                rng1);
        }
