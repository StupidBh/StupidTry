...
namespace boost {
    namespace range_detail {
        ...
        inline std::pair<SinglePassTraversalReadableIterator1, SinglePassTraversalReadableIterator2> mismatch_impl(
            ...
            SinglePassTraversalReadableIterator2 last2)
        {
            ...
            return std::pair<SinglePassTraversalReadableIterator1, SinglePassTraversalReadableIterator2>(
                first1,
                first2);
        }
