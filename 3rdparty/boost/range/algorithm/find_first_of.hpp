...
namespace boost {
    namespace range {
        ...
        inline BOOST_DEDUCED_TYPENAME
            disable_if<is_const<SinglePassRange1>, BOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange1>::type>::type
            find_first_of(SinglePassRange1& rng1, ForwardRange2 const& rng2)
        {
            ...
            return std::find_first_of(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2));
        }
            ...
            find_first_of(SinglePassRange1& rng1, ForwardRange2 const& rng2, BinaryPredicate pred)
        {
            ...
            return std::find_first_of(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2), pred);
        }
        ...
        inline BOOST_DEDUCED_TYPENAME
            disable_if<is_const<SinglePassRange1>, BOOST_DEDUCED_TYPENAME range_return<SinglePassRange1, re>::type>::
                type
            find_first_of(SinglePassRange1& rng1, const ForwardRange2& rng2)
        {
            ...
            return range_return<SinglePassRange1, re>::pack(
                std::find_first_of(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2)),
                rng1);
        }
            ...
            find_first_of(const SinglePassRange1& rng1, const ForwardRange2& rng2)
        {
            ...
            return range_return<const SinglePassRange1, re>::pack(
                std::find_first_of(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2)),
                rng1);
        }
            ...
            find_first_of(SinglePassRange1& rng1, const ForwardRange2& rng2, BinaryPredicate pred)
        {
            ...
            return range_return<SinglePassRange1, re>::pack(
                std::find_first_of(boost::begin(rng1), boost::end(rng1), boost::begin(rng2), boost::end(rng2), pred),
                rng1);
        }
