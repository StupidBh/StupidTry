...
namespace boost {
    namespace range_detail {
        ...
        class joined_type {
        public:
            typedef iterator_range<range_detail::join_iterator<
    ...
    namespace range {
        ...
        template<class SinglePassRange1, class SinglePassRange2>
        class joined_range : public range_detail::joined_type<SinglePassRange1, SinglePassRange2>::type {
            ...
            typedef BOOST_DEDUCED_TYPENAME range_detail::joined_type<SinglePassRange1, SinglePassRange2>::type base_t;
