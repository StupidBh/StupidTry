...
// From boost/dynamic_bitset.hpp; thanks to Matthias Troyer for Cray X1 patch.
    ...
    #if defined(__STL_CONFIG_H) && !defined(__STL_USE_NEW_IOSTREAMS) && !defined(__crayx1)
        /**/
    ...
    */
        ...
        operator<<(std::basic_ostream<Elem, Traits>& Os, const iterator_range<IteratorT>& r)
    {
        std::copy(
            r.begin(),
            r.end(),
            std::ostream_iterator<BOOST_DEDUCED_TYPENAME iterator_value<IteratorT>::type, Elem, Traits>(Os));
        return Os;
    }
