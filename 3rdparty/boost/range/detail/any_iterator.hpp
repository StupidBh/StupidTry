...
namespace boost {
    namespace range_detail {
        ...
        struct is_const_reference
        {
            typedef typename mpl::and_<
                ...
                typename is_const<typename remove_reference<T>::type>::type>::type type;
        };
        ...
        struct is_mutable_reference
        {
            typedef typename mpl::and_<
                typename is_reference<T>::type,
                typename mpl::not_<typename is_const<typename remove_reference<T>::type>::type>::type>::type type;
        };
        ...
        {
            typedef typename mpl::and_<
                typename mpl::not_<typename is_reference<TargetReference>::type>::type,
                typename is_convertible<SourceReference, TargetReference>::type>::type type;
        };
        ...
        struct is_any_iterator : mpl::bool_<false>
        {
        };

        // specialization of is_any_iterator to return true for
        // any_iterator classes regardless of template parameters.
        template<class Value, class Traversal, class Reference, class Difference, class Buffer>
        struct is_any_iterator<any_iterator<Value, Traversal, Reference, Difference, Buffer>> : mpl::bool_<true>
        {
        };
    } // namespace range_detail
    ...
    namespace iterators {
        namespace detail {
            ...
            template<class Value, class Traversal, class Reference, class Difference, class Buffer>
            class postfix_increment_proxy<range_detail::any_iterator<Value, Traversal, Reference, Difference, Buffer>> {
                typedef range_detail::any_iterator<Value, Traversal, Reference, Difference, Buffer> any_iterator_type;
            ...
            public:
                ...
                value_type& operator*() const { return this->stored_value; }
            ...
            class writable_postfix_increment_proxy<
                range_detail::any_iterator<Value, Traversal, Reference, Difference, Buffer>> {
                typedef range_detail::any_iterator<Value, Traversal, Reference, Difference, Buffer> any_iterator_type;
            ...
            public:
                ...
                operator value_type&() const { return stored_value; }
                ...
                // Provides X(r++)
                operator any_iterator_type const&() const { return stored_iterator; }
    ...
    namespace range_detail {
        ...
        class any_iterator :
            public iterator_facade<
                any_iterator<Value, Traversal, Reference, Difference, Buffer>,
                Value,
                Traversal,
                Reference,
                Difference> {
            ...
            typedef typename any_iterator_interface_type_generator<Traversal, Reference, Difference, Buffer>::type
                abstract_base_type;
        ...
        public:
            ...
            any_iterator(const any_iterator& other) :
                base_type(other),
                m_impl(other.m_impl ? other.m_impl->clone(m_buffer) : 0)
            {
            }
            ...
            any_iterator(
                const any_iterator<OtherValue, OtherTraversal, OtherReference, OtherDifference, Buffer>& other,
                typename ::boost::enable_if<
                    typename mpl::and_<
                        typename is_mutable_reference<OtherReference>::type,
                        typename is_const_reference<Reference>::type>::type,
                    enabler>::type* = 0) :
                m_impl(other.m_impl ? other.m_impl->clone_const_ref(m_buffer) : 0)
            {
            }
            ...
            any_iterator(
                ...
                typename ::boost::enable_if<
                    typename mpl::or_<
                        typename mpl::and_<
                            typename is_mutable_reference<OtherReference>::type,
                            typename is_mutable_reference<Reference>::type>::type,
                        typename mpl::and_<
                            typename is_const_reference<OtherReference>::type,
                            typename is_const_reference<Reference>::type>::type>::type,
                    enabler>::type* = 0) :
                m_impl(other.m_impl ? other.m_impl->clone(m_buffer) : 0)
            {
            }
            ...
            any_iterator(
                const any_iterator<OtherValue, OtherTraversal, OtherReference, OtherDifference, Buffer>& other,
                typename ::boost::enable_if<
                    typename is_convertible_to_value_as_reference<OtherReference, Reference>::type,
                    enabler>::type* = 0) :
                m_impl(other.m_impl ? other.m_impl->clone_reference_as_value(m_buffer) : 0)
            {
            }
            ...
            any_iterator<Value, Traversal, typename abstract_base_type::const_reference, Difference, Buffer>
                clone_const_ref() const
            {
                typedef any_iterator<Value, Traversal, typename abstract_base_type::const_reference, Difference, Buffer>
                    result_type;
            ...
            explicit any_iterator(
                ...
                typename disable_if<typename is_any_iterator<WrappedIterator>::type, disabler>::type* = 0)
            {
        ...
        private:
            ...
            {
                return (m_impl == other.m_impl) || (m_impl && other.m_impl && m_impl->equal(*other.m_impl));
            }
            ...
            {
                return m_impl && other.m_impl ? m_impl->distance_to(*other.m_impl) : 0;
            }
