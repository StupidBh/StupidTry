        ...
        namespace detail {
            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef typename ::boost::mpl::if_<::boost::is_const<ContainerT>, const_iterator, iterator>::type
                    result_iterator;
            ...
            public:
                BOOST_STATIC_CONSTANT(bool, value = sizeof(is_pair_impl(t)) == sizeof(yes_type));
            };
            ...
            struct pair_container_traits
            {
                ...
                typedef typename std::iterator_traits<element_type>::value_type value_type;
                typedef std::size_t size_type;
                typedef typename std::iterator_traits<element_type>::difference_type difference_type;
            ...
            */
            ...
            struct array_length_selector
            {
                ...
                struct array_length
                {
                    ...
                    BOOST_STATIC_CONSTANT(size_type, array_size = TraitsT::array_size);
            ...
            public:
                ...
                typedef
                    typename ::boost::mpl::if_<::boost::is_const<T>, const_iterator, iterator>::type result_iterator;

            private:
                // resolve array size
                typedef typename ::boost::remove_cv<value_type>::type char_type;
                typedef typename array_length_selector<char_type>::BOOST_NESTED_TEMPLATE array_length<traits_type>
                    array_length_type;
