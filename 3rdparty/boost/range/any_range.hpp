...
namespace boost {
    namespace range_detail {
        ...
        struct any_range_default_help : mpl::eval_if<is_same<T, use_default>, Default, mpl::identity<T>>
        {
        };
        ...
        struct any_range_value_type
        {
            ...
            typedef typename any_range_default_help<
                ...
                mpl::eval_if<
                    ...
                    range_value<typename remove_const<WrappedRange>::type>,
                    remove_reference<Reference>>>::type type;
#else
            typedef typename any_range_default_help<Value, range_value<typename remove_const<WrappedRange>::type>>::type
                type;
#endif
        };
        ...
        class any_range :
            public iterator_range<any_iterator<
                Value,
                Traversal,
                Reference,
                Difference,
                typename any_range_default_help<Buffer, mpl::identity<any_iterator_default_buffer>>::type>> {
            typedef iterator_range<any_iterator<
                Value,
                Traversal,
                Reference,
                Difference,
        ...
        public:
            ...
            any_range(WrappedRange& wrapped_range) :
                base_type(boost::begin(wrapped_range), boost::end(wrapped_range))
            {
            }
        ...
        struct any_range_type_generator
        {
            ...
            typedef any_range<
                typename any_range_value_type<
                    WrappedRange,
                    Value,
                    typename any_range_default_help<Reference, range_reference<WrappedRange>>::type>::type,
                typename any_range_default_help<
                    Traversal,
                    iterator_traversal<typename range_iterator<WrappedRange>::type>>::type,
                typename any_range_default_help<Reference, range_reference<WrappedRange>>::type,
                typename any_range_default_help<Difference, range_difference<WrappedRange>>::type,
                typename any_range_default_help<Buffer, mpl::identity<any_iterator_default_buffer>>::type>
                type;
        };
    } // namespace range_detail
