...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
        ...
        #define BOOST_VMD_TUPLE_POP_BACK(tuple)                                                                   \
            BOOST_PP_IIF(BOOST_PP_EQUAL(BOOST_PP_TUPLE_SIZE(tuple), 1), BOOST_VMD_EMPTY, BOOST_PP_TUPLE_POP_BACK) \
            (tuple) /**/
    ...
    */
        ...
        #define BOOST_VMD_TUPLE_POP_BACK_Z(z, tuple)                                                                \
            BOOST_PP_IIF(BOOST_PP_EQUAL(BOOST_PP_TUPLE_SIZE(tuple), 1), BOOST_VMD_EMPTY, BOOST_PP_TUPLE_POP_BACK_Z) \
            (z, tuple) /**/
