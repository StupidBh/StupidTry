...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
        ...
        #define BOOST_VMD_TUPLE_REMOVE(tuple, index)                                                      \
            BOOST_PP_IIF(                                                                                 \
                BOOST_PP_BITAND(BOOST_PP_EQUAL(index, 0), BOOST_PP_EQUAL(BOOST_PP_TUPLE_SIZE(tuple), 1)), \
                BOOST_VMD_EMPTY,                                                                          \
    ...
    */
        ...
        #define BOOST_VMD_TUPLE_REMOVE_D(d, tuple, index)                                                           \
            BOOST_PP_IIF(                                                                                           \
                BOOST_PP_BITAND(BOOST_PP_EQUAL_D(d, index, 0), BOOST_PP_EQUAL_D(d, BOOST_PP_TUPLE_SIZE(tuple), 1)), \
                BOOST_VMD_EMPTY,                                                                                    \
