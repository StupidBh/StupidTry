...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_SEQ_STATE_INIT(seq)                                                              \
        BOOST_PP_TUPLE_PUSH_BACK(                                                                             \
            BOOST_PP_TUPLE_PUSH_BACK(BOOST_VMD_DETAIL_PARENS(seq, BOOST_VMD_RETURN_AFTER), BOOST_PP_EMPTY()), \
            BOOST_PP_EMPTY())                                                                                 \
        /**/

    #define BOOST_VMD_DETAIL_SEQ_STATE_INIT_D(d, seq)                                                              \
        BOOST_PP_TUPLE_PUSH_BACK(                                                                                  \
            BOOST_PP_TUPLE_PUSH_BACK(BOOST_VMD_DETAIL_PARENS_D(d, seq, BOOST_VMD_RETURN_AFTER), BOOST_PP_EMPTY()), \
            BOOST_PP_EMPTY())                                                                                      \
        /**/

    #define BOOST_VMD_DETAIL_SEQ_STATE_PRED(d, state)             \
        BOOST_VMD_DETAIL_NOT_EMPTY(BOOST_PP_TUPLE_ELEM(0, state)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQ_STATE_OP_SET_FAILURE(d, state) \
        (BOOST_PP_EMPTY(), BOOST_PP_EMPTY(), BOOST_PP_TUPLE_ELEM(2, state), BOOST_PP_TUPLE_ELEM(3, state)) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQ_STATE_OP_UPGRADE_SEQ(d, state)                                                      \
        BOOST_PP_SEQ_PUSH_BACK(BOOST_PP_TUPLE_ELEM(2, state), BOOST_PP_TUPLE_ELEM(0, BOOST_PP_TUPLE_ELEM(0, state))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQ_STATE_OP_SET_SUCCESS(d, state)    \
        (BOOST_PP_EMPTY(),                                         \
         BOOST_PP_EMPTY(),                                         \
         BOOST_PP_IIF(                                             \
             BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(2, state)),    \
             BOOST_VMD_DETAIL_SEQ_STATE_OP_MAKE_SEQ,               \
             BOOST_VMD_DETAIL_SEQ_STATE_OP_UPGRADE_SEQ)(d, state), \
         BOOST_PP_EMPTY()) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQ_STATE_OP_CHECK_REST(d, state) \
        BOOST_PP_IIF(                                          \
            BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(1, state)), \
    ...
    #define BOOST_VMD_DETAIL_SEQ_STATE_OP(d, state)                                     \
        BOOST_PP_IIF(                                                                   \
            BOOST_PP_EQUAL_D(d, 1, BOOST_PP_TUPLE_SIZE(BOOST_PP_TUPLE_ELEM(0, state))), \
            BOOST_VMD_DETAIL_SEQ_STATE_OP_CHECK_REST,                                   \
            BOOST_VMD_DETAIL_SEQ_STATE_OP_SET_FAILURE)                                  \
        (d, state)                                                                                                  /**/

    #define BOOST_VMD_DETAIL_SEQ_STATE_RESULT(state) (BOOST_PP_TUPLE_ELEM(2, state), BOOST_PP_TUPLE_ELEM(3, state)) /**/

    #define BOOST_VMD_DETAIL_SEQ_PROCESS(seq)             \
        BOOST_VMD_DETAIL_SEQ_STATE_RESULT(BOOST_PP_WHILE( \
    ...
    #define BOOST_VMD_DETAIL_SEQ_SPLIT(seq)                                                                \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(seq), BOOST_VMD_DETAIL_EMPTY_RESULT, BOOST_VMD_DETAIL_SEQ_PROCESS) \
        (seq) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQ_SPLIT_D(d, seq)                                                             \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(seq), BOOST_VMD_DETAIL_EMPTY_RESULT, BOOST_VMD_DETAIL_SEQ_PROCESS_D) \
        (d, seq) /**/
