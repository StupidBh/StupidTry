...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_LIST_CHECK_FOR_LIST(tuple)                                    \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_IS_LIST(BOOST_PP_TUPLE_ELEM(0, tuple)), tuple, (, )) \
        /**/

    #define BOOST_VMD_DETAIL_LIST_CHECK_FOR_LIST_D(d, tuple)                                    \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_IS_LIST_D(d, BOOST_PP_TUPLE_ELEM(0, tuple)), tuple, (, )) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_LIST_TUPLE(param)                                                     \
        BOOST_VMD_DETAIL_LIST_CHECK_RETURN(BOOST_VMD_DETAIL_PARENS(param, BOOST_VMD_RETURN_AFTER)) \
        /**/

    #define BOOST_VMD_DETAIL_LIST_TUPLE_D(d, param)                                                          \
        BOOST_VMD_DETAIL_LIST_CHECK_RETURN_D(d, BOOST_VMD_DETAIL_PARENS_D(d, param, BOOST_VMD_RETURN_AFTER)) \
        /**/

    #define BOOST_VMD_DETAIL_LIST_EMPTY_PROCESS(tuple)                               \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0, tuple)), (, ), tuple) \
        /**/

    #define BOOST_VMD_DETAIL_LIST_EMPTY(list)                                       \
        BOOST_VMD_DETAIL_LIST_EMPTY_PROCESS(BOOST_VMD_DETAIL_LIST_EMPTY_LIST(list)) \
        /**/

    #define BOOST_VMD_DETAIL_LIST_EMPTY_D(d, list)                                       \
        BOOST_VMD_DETAIL_LIST_EMPTY_PROCESS(BOOST_VMD_DETAIL_LIST_EMPTY_LIST_D(d, list)) \
        /**/

    #define BOOST_VMD_DETAIL_LIST_PROCESS(list)                                                                \
        BOOST_PP_IIF(BOOST_PP_IS_BEGIN_PARENS(list), BOOST_VMD_DETAIL_LIST_TUPLE, BOOST_VMD_DETAIL_LIST_EMPTY) \
        (list) /**/

    #define BOOST_VMD_DETAIL_LIST_SPLIT(list)                                                                \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(list), BOOST_VMD_DETAIL_EMPTY_RESULT, BOOST_VMD_DETAIL_LIST_PROCESS) \
        (list) /**/
    ...
    #define BOOST_VMD_DETAIL_LIST_PROCESS_D(d, list)                                                               \
        BOOST_PP_IIF(BOOST_PP_IS_BEGIN_PARENS(list), BOOST_VMD_DETAIL_LIST_TUPLE_D, BOOST_VMD_DETAIL_LIST_EMPTY_D) \
        (d, list) /**/

    #define BOOST_VMD_DETAIL_LIST_SPLIT_D(d, list)                                                             \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(list), BOOST_VMD_DETAIL_EMPTY_RESULT, BOOST_VMD_DETAIL_LIST_PROCESS_D) \
        (d, list) /**/
