...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ_MATCH(tup)      \
        BOOST_VMD_DETAIL_NOT_EMPTY(BOOST_PP_TUPLE_ELEM(0, tup)) \
        /**/

    #define BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ_TUPLE(ptup)                                                           \
        BOOST_VMD_IDENTITY_RESULT(                                                                                    \
            BOOST_PP_IIF(BOOST_VMD_IS_TUPLE(ptup), BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ_MATCH, BOOST_VMD_IDENTITY(0))( \
                ptup))                                                                                                \
        /**/

    #define BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ_ID(vseq)                                         \
        BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ_TUPLE(BOOST_VMD_DETAIL_IDENTIFIER_CONCATENATE(vseq)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ(vseq)                                 \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                       \
            ...
            BOOST_VMD_DETAIL_IS_IDENTIFIER_VSEQ_ID)(vseq))                            \
        /**/
