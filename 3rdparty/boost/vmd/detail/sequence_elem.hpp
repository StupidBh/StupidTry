...
*/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_CHECK_FOR_IDENTIFIERS(nm, type)      \
        BOOST_PP_BITAND(                                                        \
            BOOST_VMD_DETAIL_EQUAL_TYPE(type, BOOST_VMD_TYPE_IDENTIFIER),       \
            BOOST_VMD_DETAIL_NOT_EMPTY(BOOST_VMD_DETAIL_MODS_RESULT_OTHER(nm))) \
        /**/
...
*/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_IS_INDEX_RESULT(nm)                                                 \
        BOOST_PP_BITAND(                                                                                       \
            ...
            BOOST_PP_BITAND(                                                                                   \
                BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_DETAIL_MODS_RESULT_TYPE(nm), BOOST_VMD_TYPE_IDENTIFIER), \
                BOOST_VMD_DETAIL_NOT_EMPTY(BOOST_VMD_DETAIL_MODS_RESULT_OTHER(nm))))                           \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_IS_INDEX_RESULT_D(d, nm)                                                 \
        BOOST_PP_BITAND(                                                                                            \
            BOOST_VMD_DETAIL_MODS_IS_RESULT_INDEX(nm),                                                              \
            BOOST_PP_BITAND(                                                                                        \
                BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_DETAIL_MODS_RESULT_TYPE(nm), BOOST_VMD_TYPE_IDENTIFIER), \
                BOOST_VMD_DETAIL_NOT_EMPTY(BOOST_VMD_DETAIL_MODS_RESULT_OTHER(nm))))                                \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FAILURE_RESULT_INDEX(nm)           \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_MODS_IS_RESULT_AFTER(nm), (, , ), (, )) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FAILURE_RESULT_NO_INDEX(nm)     \
        BOOST_PP_EXPR_IIF(BOOST_VMD_DETAIL_MODS_IS_RESULT_AFTER(nm), (, )) \
        /**/
...
*/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FAILURE_RESULT(nm)                \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_FIN(                               \
            BOOST_PP_IIF(                                                    \
                ...
                BOOST_VMD_DETAIL_SEQUENCE_ELEM_FAILURE_RESULT_NO_INDEX)(nm), \
            nm, )                                                            \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_RESULT_TYPE_TUPLE(res) \
        BOOST_PP_TUPLE_ELEM(0, BOOST_PP_TUPLE_ELEM(0, res))           \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_RESULT_DATA_TUPLE(res) \
        BOOST_PP_TUPLE_ELEM(1, BOOST_PP_TUPLE_ELEM(0, res))           \
        /**/
...
*/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_HAS_FAILED_TUPLE(res) \
        BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0, res))          \
        /**/
...
*/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_ONLY_CHELM(seq, elem)                                    \
        BOOST_PP_IIF(BOOST_PP_GREATER(BOOST_PP_SEQ_SIZE(seq), elem), BOOST_PP_SEQ_ELEM, BOOST_VMD_EMPTY) \
        (elem, seq) /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_ONLY_CHELM_D(d, seq, elem)                                    \
        BOOST_PP_IIF(BOOST_PP_GREATER_D(d, BOOST_PP_SEQ_SIZE(seq), elem), BOOST_PP_SEQ_ELEM, BOOST_VMD_EMPTY) \
        (elem, seq) /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_AFTER_CHELM_RES(data, elem) \
        (BOOST_PP_SEQ_ELEM(elem, BOOST_PP_TUPLE_ELEM(0, data)), BOOST_PP_TUPLE_ELEM(1, data)) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_ONLY(seq, elem)                                                \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(seq), BOOST_VMD_EMPTY, BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_ONLY_CHELM) \
        (seq, elem) /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_ONLY_D(d, seq, elem)                                             \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(seq), BOOST_VMD_EMPTY, BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_ONLY_CHELM_D) \
        (d, seq, elem) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PROCESS(elem, vseq, nm)                         \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ(                                                  \
            BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE(vseq, elem, BOOST_VMD_TYPE_SEQ, nm), \
            elem,                                                                             \
            nm)                                                                               \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PROCESS_D(d, elem, vseq, nm)                         \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_FSEQ_D(                                                     \
            d,                                                                                     \
            BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_D(d, vseq, elem, BOOST_VMD_TYPE_SEQ, nm), \
            elem,                                                                                  \
            nm)                                                                                    \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_EMPTY(elem, vseq, nm)           \
        BOOST_PP_EXPR_IIF(BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_AFTER(nm), (, )) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_EMPTY_D(d, elem, vseq, nm)           \
        BOOST_PP_EXPR_IIF(BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_AFTER_D(d, nm), (, )) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_ID_TUP(data, nm)                 \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_MATCH(                                          \
            data,                                                                            \
            nm,                                                                              \
            BOOST_VMD_DETAIL_MATCH_IDENTIFIER(data, BOOST_VMD_DETAIL_MODS_RESULT_OTHER(nm))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_ID_TUP_D(d, data, nm)                 \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_MATCH(                                               \
            data,                                                                                 \
            nm,                                                                                   \
            BOOST_VMD_DETAIL_MATCH_IDENTIFIER_D(d, data, BOOST_VMD_DETAIL_MODS_RESULT_OTHER(nm))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_ID(data, nm, type) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                \
            ...
            BOOST_VMD_IDENTITY(data))(data, nm))                               \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_ID_D(d, data, nm, type) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                     \
            ...
            BOOST_VMD_IDENTITY(data))(d, data, nm))                                 \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY(res, nm, type)                        \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_ID(BOOST_PP_TUPLE_ELEM(1, res), nm, type) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_D(d, res, nm, type)                        \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_ONLY_ID_D(d, BOOST_PP_TUPLE_ELEM(1, res), nm, type) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_SPLIT_CHANGE(res, nm, type)          \
        BOOST_PP_TUPLE_REPLACE(res, 0, BOOST_PP_TUPLE_ELEM(1, BOOST_PP_TUPLE_ELEM(0, res))) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_PT_CHECK_SPLIT_CHANGE_D(d, res, nm, type)          \
        BOOST_PP_TUPLE_REPLACE_D(d, res, 0, BOOST_PP_TUPLE_ELEM(1, BOOST_PP_TUPLE_ELEM(0, res))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_MATCHING_TYPE_ID(res, nm, type)               \
        BOOST_VMD_IS_IDENTIFIER(BOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_RESULT_DATA(res, nm)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_MATCHING_TYPE_ID_D(d, res, nm, type)                    \
        BOOST_VMD_IS_IDENTIFIER_D(d, BOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_RESULT_DATA_D(d, res, nm)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_MATCHING_TYPE_OTHER(res, nm, type)                      \
        BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_RESULT_TYPE(res, nm), type) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_MATCHING_TYPE_OTHER_D(d, res, nm, type)                           \
        BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_DETAIL_SEQUENCE_ELEM_GET_RESULT_TYPE_D(d, res, nm), type) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_MATCHING_TYPE(res, nm, type)   \
        BOOST_PP_IIF(                                                     \
            BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_TYPE_IDENTIFIER, type), \
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_MATCHING_TYPE_D(d, res, nm, type)   \
        BOOST_PP_IIF(                                                          \
            BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_TYPE_IDENTIFIER, type), \
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_COA(res, nm)                                     \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_TYPE(res, nm, BOOST_VMD_DETAIL_MODS_RESULT_TYPE(nm)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_COA_D(d, res, nm)                                     \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_TYPE_D(d, res, nm, BOOST_VMD_DETAIL_MODS_RESULT_TYPE(nm)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM(elem, vseq, nm)                                           \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_COA(BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_CE(elem, vseq, nm), nm) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_D(d, elem, vseq, nm)                                                \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_COA_D(d, BOOST_VMD_DETAIL_SEQUENCE_ELEM_NM_CE_D(d, elem, vseq, nm), nm) \
        /**/
