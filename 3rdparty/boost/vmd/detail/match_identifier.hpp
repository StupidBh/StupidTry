...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_MATCH_IDENTIFIER_PRED(d, state)                               \
        BOOST_PP_BITAND(                                                                   \
            BOOST_PP_EQUAL_D(d, BOOST_VMD_DETAIL_MATCH_IDENTIFIER_STATE_RESULT(state), 0), \
    ...
    #define BOOST_VMD_DETAIL_MATCH_IDENTIFIER_OP_FOUND(d, state)                                                  \
        BOOST_PP_TUPLE_REPLACE_D(d, state, 4, BOOST_PP_INC(BOOST_VMD_DETAIL_MATCH_IDENTIFIER_STATE_INDEX(state))) \
        /**/

    #define BOOST_VMD_DETAIL_MATCH_IDENTIFIER_OP_CONTINUE(d, state)                                               \
        BOOST_PP_TUPLE_REPLACE_D(d, state, 3, BOOST_PP_INC(BOOST_VMD_DETAIL_MATCH_IDENTIFIER_STATE_INDEX(state))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_MATCH_IDENTIFIER(id, keytuple)           \
        BOOST_PP_TUPLE_ELEM(                                          \
            ...
            BOOST_PP_WHILE(                                           \
                ...
                (id, keytuple, BOOST_PP_TUPLE_SIZE(keytuple), 0, 0))) \
        /**/
