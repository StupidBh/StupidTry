...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_BOTH(dtuple)                                                     \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                                                   \
            BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_TYPE_TUPLE, BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_LIST(dtuple)), \
            BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_ARRAY,                                                           \
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_LIST))(dtuple))                                                     \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_BOTH_D(d, dtuple)       \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                          \
            ...
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_LIST))(d, dtuple))         \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_MORE(dtuple, ...)                                                 \
        BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_MODS(                                                                 \
            dtuple,                                                                                                \
            BOOST_VMD_DETAIL_MODS_RESULT_RETURN_TYPE(BOOST_VMD_DETAIL_NEW_MODS(BOOST_VMD_ALLOW_ALL, __VA_ARGS__))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_UNARY(dtuple, ...)                            \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                                \
            ...
            BOOST_VMD_IDENTITY(BOOST_PP_TUPLE_ELEM(0, dtuple)))(dtuple, __VA_ARGS__))          \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_UNARY_D(d, dtuple, ...)                            \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                                     \
            ...
            BOOST_VMD_IDENTITY(BOOST_PP_TUPLE_ELEM(0, dtuple)))(d, dtuple, __VA_ARGS__))            \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_SEQUENCE(tuple, ...)                                 \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                                       \
            ...
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_SEQUENCE))(BOOST_PP_TUPLE_ELEM(0, tuple), __VA_ARGS__)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_SEQUENCE_D(d, tuple, ...)                               \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                                          \
            ...
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_SEQUENCE))(d, BOOST_PP_TUPLE_ELEM(0, tuple), __VA_ARGS__)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE(tuple, ...)                    \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                 \
            ...
            BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_SEQUENCE)(tuple, __VA_ARGS__)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_D(d, tuple, ...)                    \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                      \
            BOOST_VMD_IS_EMPTY(BOOST_PP_TUPLE_ELEM(0, tuple)),                       \
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_EMPTY),                                \
            BOOST_VMD_DETAIL_SEQUENCE_TYPE_TUPLE_SEQUENCE_D)(d, tuple, __VA_ARGS__)) \
        /**/
