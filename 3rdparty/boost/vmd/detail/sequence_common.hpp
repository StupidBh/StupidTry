...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_RETURN(d, from, number) \
        BOOST_PP_EQUAL_D(d, BOOST_PP_TUPLE_ELEM(0, from), number)      \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_AFTER(from)                               \
        BOOST_PP_EQUAL(BOOST_PP_TUPLE_ELEM(1, from), BOOST_VMD_DETAIL_MODS_RETURN_AFTER) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_AFTER_D(d, from)                               \
        BOOST_PP_EQUAL_D(d, BOOST_PP_TUPLE_ELEM(1, from), BOOST_VMD_DETAIL_MODS_RETURN_AFTER) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_IS_EMPTY(state)        \
        BOOST_VMD_IS_EMPTY(BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT(state)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_FROM_EMPTY(state, data) (data) /**/
...
// Tuple
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_NAME(state)                                            \
        BOOST_PP_CAT(BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_, BOOST_VMD_DETAIL_SEQUENCE_STATE_OUTTYPE(state)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_PROCESS(d, name, state, data) name(d, state, data) /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD_GET_DATA(d, state, tuple)                          \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                                           \
            BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_NO_RETURN(d, BOOST_VMD_DETAIL_SEQUENCE_STATE_FROM(state)), \
            BOOST_PP_TUPLE_ELEM,                                                                          \
            BOOST_VMD_IDENTITY(tuple))(1, tuple))                                                         \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_PROCESSING_ELEM(d, state)              \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                              \
            ...
            BOOST_VMD_DETAIL_SEQUENCE_PROCESSING_ELEM_CHECK)(d, state))      \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_INNER_OP_UNKNOWN(d, state)                      \
        (,                                                                            \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD(                                  \
             d,                                                                       \
             state,                                                                   \
             (BOOST_VMD_TYPE_UNKNOWN, BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state))), \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_ELEM(state),                                 \
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_TYPE_FOUND_PROCESS(d, state, tuple)                                \
        (BOOST_PP_TUPLE_ELEM(1, tuple),                                                                  \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT_ADD(                                                     \
             d,                                                                                          \
             state,                                                                                      \
             (BOOST_VMD_DETAIL_SEQUENCE_GET_FULL_TYPE(d, state, tuple), BOOST_PP_TUPLE_ELEM(0, tuple))), \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_ELEM(state),                                                    \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_OUTTYPE(state),                                                 \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_FROM(state),                                                    \
         BOOST_VMD_DETAIL_SEQUENCE_STATE_TYPES(state),                                                   \
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_INCREMENT_INDEX(d, state, tuple)  \
        BOOST_PP_TUPLE_REPLACE_D(                                       \
            d,                                                          \
            state,                                                      \
            BOOST_VMD_DETAIL_SEQUENCE_STATE_INDEX_ELEM,                 \
            BOOST_PP_INC(BOOST_VMD_DETAIL_SEQUENCE_STATE_INDEX(state))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_GCLRT(state)                                                         \
        BOOST_PP_CAT(BOOST_VMD_DETAIL_, BOOST_PP_CAT(BOOST_VMD_DETAIL_SEQUENCE_STATE_GET_TYPE(state), _D)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_GCLPL(state)                                       \
        BOOST_PP_CAT(BOOST_VMD_DETAIL_, BOOST_VMD_DETAIL_SEQUENCE_STATE_GET_TYPE(state)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_INNER_OP_TEST_GCL(state, rflag)                         \
        BOOST_PP_IIF(rflag, BOOST_VMD_DETAIL_SEQUENCE_GCLRT, BOOST_VMD_DETAIL_SEQUENCE_GCLPL) \
        (state) /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_INNER_OP_TEST_RT_CALL(d, call, state, rflag)                      \
        BOOST_PP_IIF(rflag, BOOST_VMD_DETAIL_SEQUENCE_TEST_TYPE_D, BOOST_VMD_DETAIL_SEQUENCE_TEST_TYPE) \
        (d, call, state) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ELEM(d, state)                                        \
        BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ELEM_FROM(d, BOOST_VMD_DETAIL_SEQUENCE_STATE_FROM(state)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES_ANY(d, state)     \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                              \
            ...
            BOOST_VMD_IDENTITY(((SEQ, 1), (TUPLE, 1))))(d, state))           \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN(d, state)                                                   \
        BOOST_PP_WHILE_##d(                                                                                \
            ...
            BOOST_PP_TUPLE_PUSH_BACK(                                                                      \
                BOOST_PP_TUPLE_PUSH_BACK(state, BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN_TUPLE_TYPES(d, state)), \
                0)) /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_OP_ID_EL(d, state)                                                        \
        (BOOST_PP_TUPLE_ELEM(                                                                                   \
             1,                                                                                                 \
             BOOST_VMD_DETAIL_LIST_D(d, BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state), BOOST_VMD_RETURN_AFTER)), \
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_OP_ID(d, state)                                            \
        BOOST_PP_IIF(                                                                            \
            BOOST_VMD_IS_EMPTY_LIST_D(                                                           \
                d,                                                                               \
                BOOST_VMD_DETAIL_IDENTIFIER_D(d, BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state))), \
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_OP(d, state)                                  \
        BOOST_VMD_DETAIL_SEQUENCE_OP_REDUCE_STATE(BOOST_PP_IIF(                     \
            BOOST_PP_IS_BEGIN_PARENS(BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state)), \
            BOOST_VMD_DETAIL_SEQUENCE_OP_PAREN,                                     \
            BOOST_VMD_DETAIL_SEQUENCE_OP_ID)(d, state))                             \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_PRED_CELEM(d, state)                          \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                     \
            ...
            BOOST_VMD_DETAIL_SEQUENCE_PRED_CELEM_SZ)(d, state))                     \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_PRED(d, state)                          \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                               \
            BOOST_VMD_IS_EMPTY(BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state)), \
            BOOST_VMD_IDENTITY(0),                                            \
            BOOST_VMD_DETAIL_SEQUENCE_PRED_CELEM)(d, state))                  \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_EMPTY_TYPE_CHECK(output)                                         \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_EQUAL_TYPE(output, BOOST_VMD_TYPE_ARRAY), (0, ()), BOOST_PP_NIL) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_EMPTY_TYPE_CHECK_D(d, output)                                         \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, output, BOOST_VMD_TYPE_ARRAY), (0, ()), BOOST_PP_NIL) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_GET(state)                                        \
        BOOST_PP_IIF(                                                                                      \
            BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_AFTER(BOOST_VMD_DETAIL_SEQUENCE_STATE_FROM(state)),         \
            (BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT(state), BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state)), \
            BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT(state))
/**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_GET_D(d, state)                                   \
        BOOST_PP_IIF(                                                                                      \
            BOOST_VMD_DETAIL_SEQUENCE_STATE_IS_AFTER_D(d, BOOST_VMD_DETAIL_SEQUENCE_STATE_FROM(state)),    \
            (BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT(state), BOOST_VMD_DETAIL_SEQUENCE_STATE_INPUT(state)), \
            BOOST_VMD_DETAIL_SEQUENCE_STATE_RESULT(state))
/**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE(vseq, elem, output, from)     \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_GET(BOOST_PP_WHILE(               \
            BOOST_VMD_DETAIL_SEQUENCE_PRED,                                            \
            BOOST_VMD_DETAIL_SEQUENCE_OP,                                              \
            (vseq, BOOST_VMD_DETAIL_SEQUENCE_EMPTY_TYPE(output), elem, output, from))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_D(d, vseq, elem, output, from)         \
        BOOST_VMD_DETAIL_SEQUENCE_ELEM_PROCESS_TUPLE_GET_D(                                     \
            ...
            BOOST_PP_WHILE_##d(                                                                 \
                BOOST_VMD_DETAIL_SEQUENCE_PRED,                                                 \
                BOOST_VMD_DETAIL_SEQUENCE_OP,                                                   \
                (vseq, BOOST_VMD_DETAIL_SEQUENCE_EMPTY_TYPE_D(d, output), elem, output, from))) \
        /**/
