...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_IS_TYPE_IMP_TYPE(vseq)                           \
        BOOST_VMD_DETAIL_IS_TYPE_TYPE(BOOST_VMD_DETAIL_IDENTIFIER_TYPE(vseq)) \
        /**/

    #define BOOST_VMD_DETAIL_IS_TYPE_IMP_TYPE_D(d, vseq)                           \
        BOOST_VMD_DETAIL_IS_TYPE_TYPE(BOOST_VMD_DETAIL_IDENTIFIER_TYPE_D(d, vseq)) \
        /**/
