...
*/
    ...
    #define BOOST_VMD_DETAIL_IS_ARRAY_NUM(x) \
        BOOST_VMD_IS_EMPTY(BOOST_PP_CAT(BOOST_VMD_DETAIL_IS_ARRAY_NUM_HELPER_, x) BOOST_PP_EMPTY())
