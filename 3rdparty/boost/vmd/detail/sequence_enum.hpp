...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_SEQUENCE_ENUM_PROCESS(tuple)                             \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(tuple), BOOST_VMD_EMPTY, BOOST_PP_TUPLE_ENUM) \
        (tuple) /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ENUM(...)                                                 \
        BOOST_VMD_DETAIL_SEQUENCE_ENUM_PROCESS(BOOST_VMD_DETAIL_SEQUENCE_TO_TUPLE(__VA_ARGS__)) \
        /**/

    #define BOOST_VMD_DETAIL_SEQUENCE_ENUM_D(d, ...)                                                 \
        BOOST_VMD_DETAIL_SEQUENCE_ENUM_PROCESS(BOOST_VMD_DETAIL_SEQUENCE_TO_TUPLE_D(d, __VA_ARGS__)) \
        /**/
