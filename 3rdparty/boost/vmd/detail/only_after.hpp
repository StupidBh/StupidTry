...
*/
    ...
    #define BOOST_VMD_DETAIL_ONLY_AFTER(...)                                                                      \
        BOOST_VMD_DETAIL_MODS_IS_RESULT_ONLY_AFTER(BOOST_VMD_DETAIL_NEW_MODS(BOOST_VMD_ALLOW_AFTER, __VA_ARGS__)) \
        /**/

    #define BOOST_VMD_DETAIL_ONLY_AFTER_D(d, ...)                                                                      \
        BOOST_VMD_DETAIL_MODS_IS_RESULT_ONLY_AFTER(BOOST_VMD_DETAIL_NEW_MODS_D(d, BOOST_VMD_ALLOW_AFTER, __VA_ARGS__)) \
        /**/
