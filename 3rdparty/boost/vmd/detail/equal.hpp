...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_EQUAL_SIMPLE_AUTO_REC_D(n)                         \
        BOOST_VMD_DETAIL_EQUAL_IS_1(BOOST_VMD_DETAIL_EQUAL_SIMPLE_D_##n(1, , )) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_VSEQ(vseq1, vseq2, vtype)                                              \
        BOOST_VMD_DETAIL_DATA_EQUAL(BOOST_VMD_TO_SEQ(vseq1), BOOST_VMD_TO_SEQ(vseq2), BOOST_VMD_TYPE_SEQ) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_CNI(vseq1, vseq2, vtype)              \
        BOOST_PP_IIF(                                                    \
            BOOST_VMD_DETAIL_EQUAL_TYPE(vtype, BOOST_VMD_TYPE_SEQUENCE), \
    ...
    #define BOOST_VMD_DETAIL_EQUAL_CNI_D(d, vseq1, vseq2, vtype)              \
        BOOST_PP_IIF(                                                         \
            BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, vtype, BOOST_VMD_TYPE_SEQUENCE), \
    ...
    #define BOOST_VMD_DETAIL_EQUAL_TEST_TYPE_CHECK_TUPLE(vseq1, vtype1, type) \
        BOOST_PP_BITOR(                                                       \
            BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_TYPE_ARRAY, vtype1),        \
            BOOST_PP_BITAND(                                                  \
                BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_TYPE_LIST, vtype1),     \
                BOOST_PP_COMPL(BOOST_VMD_IS_EMPTY_LIST(vseq1))))              \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_TEST_TYPE_CHECK_TUPLE_D(d, vseq1, vtype1, type) \
        BOOST_PP_BITOR(                                                            \
            BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_TYPE_ARRAY, vtype1),        \
            BOOST_PP_BITAND(                                                       \
                BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_TYPE_LIST, vtype1),     \
                BOOST_PP_COMPL(BOOST_VMD_IS_EMPTY_LIST_D(d, vseq1))))              \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_TEST_TYPE(vseq1, vtype1, type)         \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                           \
            BOOST_VMD_DETAIL_EQUAL_TYPE(vtype1, type),                    \
            BOOST_VMD_IDENTITY(1),                                        \
            BOOST_VMD_DETAIL_EQUAL_TEST_TYPE_CHECK)(vseq1, vtype1, type)) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_TEST_TYPE_D(d, vseq1, vtype1, type)         \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                \
            BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, vtype1, type),                    \
            BOOST_VMD_IDENTITY(1),                                             \
            BOOST_VMD_DETAIL_EQUAL_TEST_TYPE_CHECK_D)(d, vseq1, vtype1, type)) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_WT_CHECK(vseq1, vseq2, vtype1, vtype2, type) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                 \
            BOOST_PP_BITAND(                                                    \
                BOOST_VMD_DETAIL_EQUAL_TYPE(vtype1, vtype2),                    \
                BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                         \
                    BOOST_VMD_DETAIL_NOT_EMPTY(type),                           \
                    BOOST_VMD_DETAIL_EQUAL_TEST_TYPE,                           \
                    BOOST_VMD_IDENTITY(1))(vseq1, vtype1, type))),              \
            BOOST_VMD_DETAIL_EQUAL_CNI,                                         \
            BOOST_VMD_IDENTITY(0))(vseq1, vseq2, vtype1))                       \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_WT_CHECK_D(d, vseq1, vseq2, vtype1, vtype2, type) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                      \
            BOOST_PP_BITAND(                                                         \
                BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, vtype1, vtype2),                    \
                BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                              \
                    BOOST_VMD_DETAIL_NOT_EMPTY(type),                                \
                    BOOST_VMD_DETAIL_EQUAL_TEST_TYPE_D,                              \
                    BOOST_VMD_IDENTITY(1))(d, vseq1, vtype1, type))),                \
            BOOST_VMD_DETAIL_EQUAL_CNI_D,                                            \
            BOOST_VMD_IDENTITY(0))(d, vseq1, vseq2, vtype1))                         \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_WT(vseq1, vseq2, vtype1, vtype2, type)           \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                     \
            ...
            BOOST_VMD_DETAIL_EQUAL_WT_CONVERT)(vseq1, vseq2, vtype1, vtype2, type)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_WT_D(d, vseq1, vseq2, vtype1, vtype2, type)           \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                          \
            ...
            BOOST_VMD_IDENTITY(0),                                                       \
            BOOST_VMD_DETAIL_EQUAL_WT_CONVERT_D)(d, vseq1, vseq2, vtype1, vtype2, type)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_EBP(vseq1, vseq2, be1, be2, type)    \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                         \
            ...
            BOOST_VMD_IDENTITY(0))(vseq1, vseq2, type))                 \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_EBP_D(d, vseq1, vseq2, be1, be2, type) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                           \
            ...
            BOOST_VMD_IDENTITY(0))(d, vseq1, vseq2, type))                \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_EMPTY(vseq1, vseq2, be1, be2, type)                                         \
        BOOST_PP_IIF(BOOST_PP_BITAND(be1, be2), BOOST_VMD_DETAIL_EQUAL_BOTH_EMPTY, BOOST_VMD_DETAIL_EQUAL_EBP) \
        (vseq1, vseq2, be1, be2, type) /**/

    #define BOOST_VMD_DETAIL_EQUAL_EMPTY_D(d, vseq1, vseq2, be1, be2, type)                                      \
        BOOST_PP_IIF(BOOST_PP_BITAND(be1, be2), BOOST_VMD_DETAIL_EQUAL_BOTH_EMPTY, BOOST_VMD_DETAIL_EQUAL_EBP_D) \
        (d, vseq1, vseq2, be1, be2, type) /**/

    #define BOOST_VMD_DETAIL_EQUAL_OV0(vseq1, vseq2)                          \
        BOOST_VMD_DETAIL_EQUAL_EMPTY(vseq1, , BOOST_VMD_IS_EMPTY(vseq1), 1, ) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_OV1(vseq1, vseq2)                                                       \
        BOOST_VMD_DETAIL_EQUAL_EMPTY(vseq1, vseq2, BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2), ) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_OV2(vseq1, vseq2, type)                                                     \
        BOOST_VMD_DETAIL_EQUAL_EMPTY(vseq1, vseq2, BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2), type) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_D_OV0(d, vseq1, vseq2)                          \
        BOOST_VMD_DETAIL_EQUAL_EMPTY_D(d, vseq1, , BOOST_VMD_IS_EMPTY(vseq1), 1, ) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_D_OV1(d, vseq1, vseq2)                                                       \
        BOOST_VMD_DETAIL_EQUAL_EMPTY_D(d, vseq1, vseq2, BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2), ) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_D_OV2(d, vseq1, vseq2, type)                                                     \
        BOOST_VMD_DETAIL_EQUAL_EMPTY_D(d, vseq1, vseq2, BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2), type) \
        /**/
