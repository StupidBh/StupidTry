...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_IS_BOTH_COMPOSITE(vseq1, vseq2)                   \
        BOOST_PP_BITAND(BOOST_PP_IS_BEGIN_PARENS(vseq1), BOOST_PP_IS_BEGIN_PARENS(vseq2)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP_INDEX(state)                                                 \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP_EMPTY(state), BOOST_VMD_EMPTY, BOOST_PP_TUPLE_ELEM) \
        (0, BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP(state)) /**/

    #define BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP_POP_NE_EMPTY(d, state) \
        BOOST_PP_TUPLE_REPLACE_D(d, state, 6, )                           \
        /**/

    #define BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP_POP_NE_REMOVE(d, state)                                             \
        BOOST_PP_TUPLE_REPLACE_D(d, state, 6, BOOST_PP_TUPLE_POP_FRONT(BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP(state))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_STATE_COMP_PUSH_CREATE(d, state)                             \
        BOOST_VMD_DETAIL_DATA_EQUAL_OP_SUCCESS(                                                      \
            d,                                                                                       \
            BOOST_PP_TUPLE_REPLACE_D(d, state, 6, (BOOST_VMD_DETAIL_DATA_EQUAL_STATE_INDEX(state)))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_PRED(d, state)                                \
        BOOST_PP_BITAND(                                                              \
            BOOST_PP_EQUAL_D(d, BOOST_VMD_DETAIL_DATA_EQUAL_STATE_RESULT(state), 1),  \
            BOOST_PP_BITOR(                                                           \
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_OP_SUCCESS_NCP(d, state)                                            \
        BOOST_PP_TUPLE_REPLACE_D(d, state, 5, BOOST_PP_INC(BOOST_VMD_DETAIL_DATA_EQUAL_STATE_INDEX(state))) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_OP_FAILURE(d, state) \
        BOOST_PP_TUPLE_REPLACE_D(d, state, 0, 0)             \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_TYPE(emf, ems, vtype)            \
        BOOST_PP_BITAND(                                                 \
            BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_GET_TYPE(emf), vtype), \
            BOOST_VMD_DETAIL_EQUAL_TYPE(BOOST_VMD_GET_TYPE(ems), vtype)) \
        /**/

    #define BOOST_VMD_DETAIL_DATA_EQUAL_TYPE_D(d, emf, ems, vtype)            \
        BOOST_PP_BITAND(                                                      \
            BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_GET_TYPE(emf), vtype), \
            BOOST_VMD_DETAIL_EQUAL_TYPE_D(d, BOOST_VMD_GET_TYPE(ems), vtype)) \
        /**/
