...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_7_OP(d, state)                                                  \
        BOOST_VMD_DETAIL_DATA_EQUAL_OP_RESULT(d, state, BOOST_VMD_DETAIL_DATA_EQUAL_7_OP_TEQ(d, state)) \
        /**/

    #define BOOST_VMD_DETAIL_DATA_EQUAL_7_OP_D(d, state)                                                  \
        BOOST_VMD_DETAIL_DATA_EQUAL_OP_RESULT(d, state, BOOST_VMD_DETAIL_DATA_EQUAL_7_OP_TEQ_D(d, state)) \
        /**/
