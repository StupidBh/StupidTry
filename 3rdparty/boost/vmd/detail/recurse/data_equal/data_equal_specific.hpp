...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_OP_TEQ_CMP_PARENS(d, em1, em2) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                 \
            ...
            BOOST_VMD_DETAIL_EQUAL_SIMPLE_D)(d, em1, em2))                      \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_OP(d, state)                                                  \
        BOOST_VMD_DETAIL_DATA_EQUAL_OP_RESULT(d, state, BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_OP_TEQ(d, state)) \
        /**/

    #define BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_OP_D(d, state)                                                  \
        BOOST_VMD_DETAIL_DATA_EQUAL_OP_RESULT(d, state, BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_OP_TEQ_D(d, state)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_SZ(dataf, datas, szf, szs, vtype) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                    \
            ...
            BOOST_VMD_IDENTITY(0))(dataf, datas, szf, vtype))                      \
        /**/
    ...
    #define BOOST_VMD_DETAIL_DATA_EQUAL_SPECIFIC_SZ_D(d, dataf, datas, szf, szs, vtype) \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                         \
            ...
            BOOST_VMD_IDENTITY(0))(d, dataf, datas, szf, vtype))                        \
        /**/
