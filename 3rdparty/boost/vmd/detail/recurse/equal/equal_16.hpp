...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_EQUAL_16_VSEQ(vseq1, vseq2, vtype)                                              \
        BOOST_VMD_DETAIL_DATA_EQUAL_16(BOOST_VMD_TO_SEQ(vseq1), BOOST_VMD_TO_SEQ(vseq2), BOOST_VMD_TYPE_SEQ) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_16_WT(vseq1, vseq2, vtype1, vtype2)              \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                     \
            ...
            BOOST_VMD_DETAIL_EQUAL_16_WT_CONVERT)(vseq1, vseq2, vtype1, vtype2))    \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_16_WT_D(d, vseq1, vseq2, vtype1, vtype2)              \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                          \
            ...
            BOOST_VMD_IDENTITY(0),                                                       \
            BOOST_VMD_DETAIL_EQUAL_16_WT_CONVERT_D)(d, vseq1, vseq2, vtype1, vtype2))    \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_16_EBP(vseq1, vseq2, be1, be2)       \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                         \
            ...
            BOOST_VMD_IDENTITY(0))(vseq1, vseq2))                       \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_16_EBP_D(d, vseq1, vseq2, be1, be2)  \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                         \
            ...
            BOOST_VMD_IDENTITY(0))(d, vseq1, vseq2))                    \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_16_EMPTY(vseq1, vseq2, be1, be2)                                               \
        BOOST_PP_IIF(BOOST_PP_BITAND(be1, be2), BOOST_VMD_DETAIL_EQUAL_BOTH_EMPTY, BOOST_VMD_DETAIL_EQUAL_16_EBP) \
        (vseq1, vseq2, be1, be2) /**/

    #define BOOST_VMD_DETAIL_EQUAL_16_EMPTY_D(d, vseq1, vseq2, be1, be2)                                            \
        BOOST_PP_IIF(BOOST_PP_BITAND(be1, be2), BOOST_VMD_DETAIL_EQUAL_BOTH_EMPTY, BOOST_VMD_DETAIL_EQUAL_16_EBP_D) \
        (d, vseq1, vseq2, be1, be2) /**/

    #define BOOST_VMD_DETAIL_EQUAL_16(vseq1, vseq2)                                                         \
        BOOST_VMD_DETAIL_EQUAL_16_EMPTY(vseq1, vseq2, BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2)) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_16_D(d, vseq1, vseq2)                                                         \
        BOOST_VMD_DETAIL_EQUAL_16_EMPTY_D(d, vseq1, vseq2, BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2)) \
        /**/
