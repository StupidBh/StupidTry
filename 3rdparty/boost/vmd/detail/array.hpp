...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_ARRAY_CHECK_FOR_ARRAY(tuple)                    \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                              \
            BOOST_VMD_DETAIL_IS_ARRAY_SYNTAX(BOOST_PP_TUPLE_ELEM(0, tuple)), \
            BOOST_VMD_IDENTITY(tuple),                                       \
            BOOST_VMD_DETAIL_EMPTY_RESULT)(tuple))                           \
        /**/

    #define BOOST_VMD_DETAIL_ARRAY_CHECK_FOR_ARRAY_D(d, tuple)                    \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                                   \
            BOOST_VMD_DETAIL_IS_ARRAY_SYNTAX_D(d, BOOST_PP_TUPLE_ELEM(0, tuple)), \
            BOOST_VMD_IDENTITY(tuple),                                            \
            BOOST_VMD_DETAIL_EMPTY_RESULT)(tuple))                                \
        /**/
    ...
    #define BOOST_VMD_DETAIL_ARRAY_SPLIT(param)                                               \
        BOOST_VMD_DETAIL_ARRAY_PROCESS(BOOST_VMD_DETAIL_TUPLE(param, BOOST_VMD_RETURN_AFTER)) \
        /**/

    #define BOOST_VMD_DETAIL_ARRAY_SPLIT_D(d, param)                                                    \
        BOOST_VMD_DETAIL_ARRAY_PROCESS_D(d, BOOST_VMD_DETAIL_TUPLE_D(d, param, BOOST_VMD_RETURN_AFTER)) \
        /**/

    #define BOOST_VMD_DETAIL_ARRAY_BEGIN_CHECK_FOR_ARRAY(tuple)           \
        BOOST_PP_EXPR_IIF(BOOST_VMD_DETAIL_IS_ARRAY_SYNTAX(tuple), tuple) \
        /**/

    #define BOOST_VMD_DETAIL_ARRAY_BEGIN_CHECK_FOR_ARRAY_D(d, tuple)           \
        BOOST_PP_EXPR_IIF(BOOST_VMD_DETAIL_IS_ARRAY_SYNTAX_D(d, tuple), tuple) \
        /**/

    #define BOOST_VMD_DETAIL_ARRAY_BEGIN_TUPLE(tuple)                                                          \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(tuple), BOOST_VMD_EMPTY, BOOST_VMD_DETAIL_ARRAY_BEGIN_CHECK_FOR_ARRAY) \
        (tuple) /**/

    #define BOOST_VMD_DETAIL_ARRAY_BEGIN_TUPLE_D(d, tuple)                                                       \
        BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(tuple), BOOST_VMD_EMPTY, BOOST_VMD_DETAIL_ARRAY_BEGIN_CHECK_FOR_ARRAY_D) \
        (d, tuple) /**/

    #define BOOST_VMD_DETAIL_ARRAY_BEGIN(param)                           \
        BOOST_VMD_DETAIL_ARRAY_BEGIN_TUPLE(BOOST_VMD_DETAIL_TUPLE(param)) \
        /**/

    #define BOOST_VMD_DETAIL_ARRAY_BEGIN_D(d, param)                                \
        BOOST_VMD_DETAIL_ARRAY_BEGIN_TUPLE_D(d, BOOST_VMD_DETAIL_TUPLE_D(d, param)) \
        /**/
