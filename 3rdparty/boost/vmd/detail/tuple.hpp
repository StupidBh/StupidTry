...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_TUPLE_BST(vseq)                                                                          \
        BOOST_VMD_IDENTITY_RESULT(                                                                                    \
            BOOST_PP_IIF(BOOST_PP_IS_BEGIN_PARENS(vseq), BOOST_VMD_DETAIL_TUPLE_BST_CS, BOOST_VMD_IDENTITY(0))(vseq)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_TUPLE_BSEQ(vseq)                                                                       \
        BOOST_VMD_IDENTITY_RESULT(                                                                                  \
            BOOST_PP_IIF(BOOST_VMD_DETAIL_TUPLE_BST(vseq), BOOST_VMD_DETAIL_TUPLE_BSEQ_NXT, BOOST_VMD_IDENTITY(0))( \
                vseq))                                                                                              \
        /**/
    ...
    #define BOOST_VMD_DETAIL_TUPLE_SPLIT_CHK_SEQ(vseq)                                                                \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_TUPLE_BSEQ(vseq), BOOST_VMD_DETAIL_EMPTY_RESULT, BOOST_VMD_DETAIL_SPLIT_PARENS) \
        (vseq) /**/
    ...
    #define BOOST_VMD_DETAIL_TUPLE_PROCESS_CHK_SEQ(vseq)                                                \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_TUPLE_BSEQ(vseq), BOOST_VMD_EMPTY, BOOST_VMD_DETAIL_BEGIN_PARENS) \
        (vseq) /**/

    #define BOOST_VMD_DETAIL_TUPLE_PROCESS_CHK_SEQ_D(d, vseq)                                                \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_TUPLE_BSEQ_D(d, vseq), BOOST_VMD_EMPTY, BOOST_VMD_DETAIL_BEGIN_PARENS) \
        (vseq) /**/

    #define BOOST_VMD_DETAIL_TUPLE_PROCESS(vseq)                                                              \
        BOOST_PP_IIF(BOOST_PP_IS_BEGIN_PARENS(vseq), BOOST_VMD_DETAIL_TUPLE_PROCESS_CHK_SEQ, BOOST_VMD_EMPTY) \
        (vseq) /**/

    #define BOOST_VMD_DETAIL_TUPLE_PROCESS_D(d, vseq)                                                           \
        BOOST_PP_IIF(BOOST_PP_IS_BEGIN_PARENS(vseq), BOOST_VMD_DETAIL_TUPLE_PROCESS_CHK_SEQ_D, BOOST_VMD_EMPTY) \
        (d, vseq) /**/
