...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_IS_LIST_PRED(d, state)            \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                \
            ...
            BOOST_VMD_DETAIL_IS_LIST_NOT_BOOST_PP_NIL)(state)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IS_LIST_PROCESS_IF_BOOST_PP_NIL(d, x)                                      \
        BOOST_PP_IIF(BOOST_VMD_DETAIL_IS_LIST_BOOST_PP_NIL(x), BOOST_PP_NIL, BOOST_VMD_IS_LIST_FAILURE) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IS_LIST_NOT_BOOST_PP_NIL(x)                                                      \
        BOOST_PP_COMPL(                                                                                       \
            BOOST_PP_BITOR(BOOST_VMD_DETAIL_IS_LIST_BOOST_PP_NIL(x), BOOST_VMD_DETAIL_IS_LIST_IS_FAILURE(x))) \
        /**/

    #define BOOST_VMD_DETAIL_IS_LIST_BOOST_PP_NIL(x)                                               \
        BOOST_VMD_IS_EMPTY(BOOST_PP_CAT(BOOST_VMD_DETAIL_IS_LIST_NIL_HELPER_, x) BOOST_PP_EMPTY()) \
        /**/

    #define BOOST_VMD_DETAIL_IS_LIST_NIL_HELPER_BOOST_PP_NIL

    #define BOOST_VMD_DETAIL_IS_LIST_IS_FAILURE(x)                                              \
        BOOST_VMD_IS_EMPTY(BOOST_PP_CAT(BOOST_VMD_DETAIL_IS_LIST_FHELPER_, x) BOOST_PP_EMPTY()) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IS_LIST_RESULT(x)                 \
        BOOST_PP_COMPL(BOOST_VMD_DETAIL_IS_LIST_IS_FAILURE(x)) \
        /**/

    #define BOOST_VMD_DETAIL_IS_LIST_WLOOP(list)                                              \
        BOOST_VMD_DETAIL_IS_LIST_RESULT(                                                      \
            BOOST_PP_WHILE(BOOST_VMD_DETAIL_IS_LIST_PRED, BOOST_VMD_DETAIL_IS_LIST_OP, list)) \
        /**/

    #define BOOST_VMD_DETAIL_IS_LIST_WLOOP_D(d, list)                                             \
        BOOST_VMD_DETAIL_IS_LIST_RESULT(                                                          \
            BOOST_PP_WHILE_##d(BOOST_VMD_DETAIL_IS_LIST_PRED, BOOST_VMD_DETAIL_IS_LIST_OP, list)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IS_LIST(param)                                                                          \
        BOOST_VMD_IDENTITY_RESULT(                                                                                   \
            BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(param), BOOST_VMD_IDENTITY(0), BOOST_VMD_DETAIL_IS_LIST_PROCESS)(param)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IS_LIST_D(d, param)           \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(            \
            ...
            BOOST_VMD_DETAIL_IS_LIST_PROCESS_D)(d, param)) \
        /**/
