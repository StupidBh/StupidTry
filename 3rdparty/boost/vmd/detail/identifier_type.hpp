...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCATENATE(id)                      \
        BOOST_PP_CAT(BOOST_VMD_DETAIL_IDENTIFIER_SUBTYPE_REGISTRATION_PREFIX, id) \
        /**/

    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE_SIZE(cres)              \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                      \
            BOOST_PP_EQUAL(BOOST_PP_TUPLE_SIZE(cres), 2),            \
            BOOST_PP_TUPLE_ELEM,                                     \
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_IDENTIFIER))(0, cres)) \
        /**/

    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE_SIZE_D(d, cres)         \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                      \
            BOOST_PP_EQUAL_D(d, BOOST_PP_TUPLE_SIZE(cres), 2),       \
            BOOST_PP_TUPLE_ELEM,                                     \
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_IDENTIFIER))(0, cres)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCAT(cres)         \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                   \
            ...
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_IDENTIFIER))(cres)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCAT_D(d, cres)       \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                      \
            ...
            BOOST_VMD_IDENTITY(BOOST_VMD_TYPE_IDENTIFIER))(d, cres)) \
        /**/
...
*/
    ...
    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE(id)                                                  \
        BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCAT(BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCATENATE(id)) \
        /**/

    #define BOOST_VMD_DETAIL_IDENTIFIER_TYPE_D(d, id)                                                  \
        BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCAT_D(d, BOOST_VMD_DETAIL_IDENTIFIER_TYPE_CONCATENATE(id)) \
        /**/
