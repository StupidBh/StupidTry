...
/**/
    ...
    #define BOOST_VMD_DETAIL_MODS_OP_CURRENT_UNKNOWN_CTUPLE(d, state, id)                                      \
        BOOST_PP_IIF(                                                                                          \
            BOOST_VMD_IS_EMPTY(BOOST_VMD_DETAIL_MODS_RESULT_OTHER(BOOST_VMD_DETAIL_MODS_STATE_RESULT(state))), \
    ...
    #define BOOST_VMD_DETAIL_MODS_OP_CURRENT_UNKNOWN(d, state, id)                                                \
        BOOST_VMD_DETAIL_MODS_OP_CURRENT_UPDATE(                                                                  \
            ...
            BOOST_PP_TUPLE_REPLACE_D(                                                                             \
                ...
                BOOST_VMD_DETAIL_MODS_DATA_RESULT,                                                                \
                BOOST_PP_IIF(                                                                                     \
                    BOOST_PP_BITAND(BOOST_VMD_DETAIL_MODS_STATE_IS_ALLOW_ALL(state), BOOST_VMD_IS_TYPE_D(d, id)), \
    ...
    #define BOOST_VMD_DETAIL_NEW_MODS_VAR(allow, tuple)                    \
        BOOST_VMD_DETAIL_MODS_LOOP(allow, BOOST_PP_TUPLE_POP_FRONT(tuple)) \
        /**/

    #define BOOST_VMD_DETAIL_NEW_MODS_VAR_D(d, allow, tuple)                    \
        BOOST_VMD_DETAIL_MODS_LOOP_D(d, allow, BOOST_PP_TUPLE_POP_FRONT(tuple)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_NEW_MODS_IR(allow, tuple)     \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(            \
            ...
            BOOST_VMD_DETAIL_NEW_MODS_VAR)(allow, tuple))  \
        /**/
    ...
    #define BOOST_VMD_DETAIL_NEW_MODS_IR_D(d, allow, tuple)     \
        BOOST_VMD_IDENTITY_RESULT(BOOST_PP_IIF(                 \
            ...
            BOOST_VMD_IDENTITY((0, 0, 0, , 0, )),               \
            BOOST_VMD_DETAIL_NEW_MODS_VAR_D)(d, allow, tuple))  \
        /**/
