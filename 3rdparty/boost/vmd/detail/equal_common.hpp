...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_VMD_DETAIL_EQUAL_IS_1(res)                                        \
        BOOST_PP_IS_BEGIN_PARENS(BOOST_PP_CAT(BOOST_VMD_DETAIL_EQUAL_CONCAT_, res)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_IS_TUPLE_MISMATCH_SIZE(vseq1, vseq2)            \
        BOOST_PP_NOT_EQUAL(BOOST_PP_TUPLE_SIZE(vseq1), BOOST_PP_TUPLE_SIZE(vseq2)) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_IS_TUPLE_MISMATCH_SIZE_D(d, vseq1, vseq2)            \
        BOOST_PP_NOT_EQUAL_D(d, BOOST_PP_TUPLE_SIZE(vseq1), BOOST_PP_TUPLE_SIZE(vseq2)) \
        /**/
    ...
    #define BOOST_VMD_DETAIL_EQUAL_CHK_MATCH(bp1, bp2) \
        BOOST_PP_COMPL(BOOST_PP_BITXOR(bp1, bp2))      \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_CHK_PARENS_MATCH(vseq1, vseq2)                                          \
        BOOST_VMD_DETAIL_EQUAL_CHK_MATCH(BOOST_PP_IS_BEGIN_PARENS(vseq1), BOOST_PP_IS_BEGIN_PARENS(vseq2)) \
        /**/

    #define BOOST_VMD_DETAIL_EQUAL_CHK_EMPTY_MATCH(vseq1, vseq2)                               \
        BOOST_VMD_DETAIL_EQUAL_CHK_MATCH(BOOST_VMD_IS_EMPTY(vseq1), BOOST_VMD_IS_EMPTY(vseq2)) \
        /**/
