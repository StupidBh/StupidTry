...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
            ...
            #define BOOST_VMD_ASSERT_IS_IDENTIFIER(...)                                                   \
                BOOST_VMD_ASSERT(BOOST_VMD_IS_IDENTIFIER(__VA_ARGS__), BOOST_VMD_IDENTIFIER_ASSERT_ERROR) \
                /**/

            #define BOOST_VMD_ASSERT_IS_IDENTIFIER_D(d, ...)                                                   \
                BOOST_VMD_ASSERT(BOOST_VMD_IS_IDENTIFIER_D(d, __VA_ARGS__), BOOST_VMD_IDENTIFIER_ASSERT_ERROR) \
                /**/
