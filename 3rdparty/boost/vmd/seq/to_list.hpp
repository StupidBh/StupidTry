...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
            ...
            #define BOOST_VMD_SEQ_TO_LIST(seq)                                                             \
                BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(seq), BOOST_VMD_SEQ_TO_LIST_PE, BOOST_VMD_SEQ_TO_LIST_NPE) \
                (seq) /**/
        ...
        #else
            #define BOOST_VMD_SEQ_TO_LIST(seq)                                                                \
                BOOST_PP_IIF(BOOST_VMD_IS_EMPTY(seq), BOOST_VMD_IDENTITY(BOOST_PP_NIL), BOOST_PP_SEQ_TO_LIST) \
                (seq) /**/
        #endif
