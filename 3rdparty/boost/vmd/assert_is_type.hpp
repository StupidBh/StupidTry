...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
            ...
            #define BOOST_VMD_ASSERT_IS_TYPE(sequence)                                        \
                BOOST_VMD_ASSERT(BOOST_VMD_IS_TYPE(sequence), BOOST_VMD_IS_TYPE_ASSERT_ERROR) \
                /**/

            #define BOOST_VMD_ASSERT_IS_TYPE_D(d, sequence)                                        \
                BOOST_VMD_ASSERT(BOOST_VMD_IS_TYPE_D(d, sequence), BOOST_VMD_IS_TYPE_ASSERT_ERROR) \
                /**/
