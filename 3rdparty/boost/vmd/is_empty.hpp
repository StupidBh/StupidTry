...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
            ...
            #define BOOST_VMD_IS_EMPTY(sequence)                                  \
                BOOST_VMD_DETAIL_IS_EMPTY_IIF(BOOST_PP_IS_BEGIN_PARENS(sequence)) \
                (BOOST_VMD_DETAIL_IS_EMPTY_GEN_ZERO, BOOST_VMD_DETAIL_IS_EMPTY_PROCESS)(sequence) /**/
                ...
                #define BOOST_VMD_IS_EMPTY(...)                                \
                    BOOST_VMD_DETAIL_IS_EMPTY_IIF(BOOST_PP_VARIADIC_HAS_OPT()) \
                    (BOOST_PP_IS_EMPTY_OPT, BOOST_VMD_IS_EMPTY_NO_OPT)(__VA_ARGS__) /**/
            #else
                #define BOOST_VMD_IS_EMPTY(...)            \
            ...
            #define BOOST_VMD_IS_EMPTY_NO_OPT(...)                                   \
                BOOST_VMD_DETAIL_IS_EMPTY_IIF(BOOST_PP_IS_BEGIN_PARENS(__VA_ARGS__)) \
                (BOOST_VMD_DETAIL_IS_EMPTY_GEN_ZERO, BOOST_VMD_DETAIL_IS_EMPTY_PROCESS)(__VA_ARGS__) /**/
