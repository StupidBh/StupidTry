...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
            ...
            #define BOOST_VMD_ASSERT_IS_LIST(sequence)                                        \
                BOOST_VMD_ASSERT(BOOST_VMD_IS_LIST(sequence), BOOST_VMD_ASSERT_IS_LIST_ERROR) \
                /**/

            #define BOOST_VMD_ASSERT_IS_LIST_D(d, sequence)                                        \
                BOOST_VMD_ASSERT(BOOST_VMD_IS_LIST_D(d, sequence), BOOST_VMD_ASSERT_IS_LIST_ERROR) \
                /**/
