...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
                ...
                #define BOOST_VMD_ASSERT_IS_EMPTY(input)                                         \
                    BOOST_VMD_ASSERT(BOOST_VMD_IS_EMPTY(input), BOOST_VMD_IS_EMPTY_ASSERT_ERROR) \
                    /**/
                ...
                #define BOOST_VMD_ASSERT_IS_EMPTY(...)                                                 \
                    BOOST_VMD_ASSERT(BOOST_VMD_IS_EMPTY(__VA_ARGS__), BOOST_VMD_IS_EMPTY_ASSERT_ERROR) \
                    /**/
