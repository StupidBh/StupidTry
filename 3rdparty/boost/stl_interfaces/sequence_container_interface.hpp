...
namespace boost {
    namespace stl_interfaces {
        namespace detail {
            ...
            template<typename T, typename SizeType>
            constexpr auto make_n_iter(T const& x, SizeType n) noexcept(noexcept(n_iter<T, SizeType>(x, n)))
            {
            ...
            template<typename T, typename SizeType>
            constexpr auto make_n_iter_end(T const& x, SizeType n) noexcept(noexcept(n_iter<T, SizeType>(x, n)))
            {
            ...
            template<
                typename Container,
                typename Enable = decltype(std::size_t() = std::declval<Container const&>().capacity())>
            std::size_t fake_capacity(Container const& c)
            {
                return c.capacity();
            }
    ...
    namespace stl_interfaces {
        BOOST_STL_INTERFACES_NAMESPACE_V1
        {
            ...
            template<
                ...
                typename E = std::enable_if_t<
                    std::is_class<Derived>::value && std::is_same<Derived, std::remove_cv_t<Derived>>::value>
#endif
                >
            ...
            namespace v1_dtl {
                ...
                using in_iter = std::
                    is_convertible<typename std::iterator_traits<Iter>::iterator_category, std::input_iterator_tag>;
            ...
            private:
                ...
                constexpr const Derived& derived() const noexcept { return static_cast<Derived const&>(*this); }
            ...
            public:
                ...
                constexpr auto empty() noexcept(noexcept(std::declval<D&>().begin() == std::declval<D&>().end()))
                ...
                constexpr auto empty() const
                    noexcept(noexcept(std::declval<D const&>().begin() == std::declval<D const&>().end()))
                ...
                template<
                    ...
                    element_layout C = Contiguity,
                    typename Enable = std::enable_if_t<C == element_layout::contiguous>>
                constexpr auto data() const noexcept(noexcept(std::declval<D const&>().begin()))
                ...
                constexpr auto size()
#if !BOOST_CLANG
                    noexcept(noexcept(std::declval<D&>().end() - std::declval<D&>().begin()))
#endif
                ...
                constexpr auto size() const
                    noexcept(noexcept(std::declval<D const&>().end() - std::declval<D const&>().begin()))
                        -> decltype(typename D::size_type(
#if !BOOST_CLANG
                            std::declval<D const&>().end() - std::declval<D const&>().begin()
#endif
                                ))
                {
                    return derived().end() - derived().begin();
                ...
                template<typename D = Derived>
                constexpr auto front() const noexcept(noexcept(*std::declval<D const&>().begin()))
        ...
        constexpr auto pop_front() noexcept -> decltype(
            ...
            (void)std::declval<D &>().erase(std::declval<D &>().begin()))
                ...
                constexpr auto back() noexcept(noexcept(*std::prev(std::declval<D&>().end())))
                ...
                template<
                    ...
                    typename Enable =
                        std::enable_if_t<v1_dtl::decrementable_sentinel<D>::value && v1_dtl::common_range<D>::value>>
                constexpr auto back() const noexcept(noexcept(*std::prev(std::declval<D const&>().end())))
        ...
        constexpr auto pop_back() noexcept -> decltype(
            ...
            (void)std::declval<D &>().erase(
                ...
                template<typename D = Derived>
                constexpr auto operator[](typename D::size_type n) noexcept(noexcept(std::declval<D&>().begin()[n]))
                ...
                template<typename D = Derived>
                constexpr auto at(typename D::size_type i) -> decltype(std::declval<D&>().size(), std::declval<D&>()[i])
                {
                    if (derived().size() <= i) {
                ...
                constexpr Iter begin() const noexcept(noexcept(std::declval<D&>().begin()))
                {
                ...
                template<typename D = Derived>
                constexpr auto cbegin() const noexcept(noexcept(std::declval<D const&>().begin()))
                    -> decltype(std::declval<D const&>().begin())
                {
                    return derived().begin();
                }
                ...
                template<typename D = Derived>
                constexpr auto cend() const noexcept(noexcept(std::declval<D const&>().end()))
                    -> decltype(std::declval<D const&>().end())
                {
                    return derived().end();
                }

                template<typename D = Derived, typename Enable = std::enable_if_t<v1_dtl::common_range<D>::value>>
                constexpr auto
                ...
                template<typename D = Derived>
                constexpr auto rbegin() const noexcept(noexcept(std::declval<D&>().rbegin()))
                {
                    return typename D::const_reverse_iterator(mutable_derived().rbegin());
                }
                ...
                template<typename D = Derived>
                constexpr auto crbegin() const noexcept(noexcept(std::declval<D const&>().rbegin()))
                ...
                template<typename D = Derived>
                constexpr auto crend() const noexcept(noexcept(std::declval<D const&>().rend()))
                ...
                template<typename D = Derived>
                constexpr auto insert(typename D::const_iterator pos, typename D::value_type const& x) noexcept(
                    noexcept(std::declval<D&>().emplace(pos, x))) -> decltype(std::declval<D&>().emplace(pos, x))
                {
                    return derived().emplace(pos, x);
                }

                template<typename D = Derived>
                constexpr auto insert(typename D::const_iterator pos, typename D::value_type&& x) noexcept(
                    noexcept(std::declval<D&>().emplace(pos, std::move(x))))
                ...
                template<typename D = Derived>
                constexpr auto
                    insert(typename D::const_iterator pos, typename D::size_type n, typename D::value_type const& x)
                    ...
                    noexcept(noexcept(
                        std::declval<D&>().insert(pos, detail::make_n_iter(x, n), detail::make_n_iter_end(x, n))))
...
#endif
                {
                    return derived().insert(pos, detail::make_n_iter(x, n), detail::make_n_iter_end(x, n));
                }

                template<typename D = Derived>
                constexpr auto
                    insert(typename D::const_iterator pos, std::initializer_list<typename D::value_type> il) noexcept(
                        noexcept(std::declval<D&>().insert(pos, il.begin(), il.end())))
        ...
        constexpr auto assign(
            ...
            -> decltype(
                ...
                template<typename D = Derived>
                constexpr auto assign(std::initializer_list<typename D::value_type> il) noexcept(
                ...
                template<typename D = Derived>
                constexpr auto operator=(std::initializer_list<typename D::value_type> il) noexcept(
                    noexcept(std::declval<D&>().assign(il.begin(), il.end())))
            ...
            constexpr auto swap(ContainerInterface & lhs, ContainerInterface & rhs) noexcept(noexcept(lhs.swap(rhs)))
            ...
            template<typename ContainerInterface>
            constexpr auto operator==(ContainerInterface const& lhs, ContainerInterface const& rhs) noexcept(
    ...
    namespace stl_interfaces {
        ...
        concept range_insert =
            ...
            t.template insert<I>(t_it, it, it);
                ...
                template<typename T>
                using n_iter_t = detail::n_iter<std::ranges::range_value_t<T>, container_size_t<T>>;
            }
...
namespace boost {
    namespace stl_interfaces {
        BOOST_STL_INTERFACES_NAMESPACE_V3
        {
            ...
            template<typename D, element_layout Contiguity = element_layout::discontiguous>
