...
namespace boost {
    ...
    namespace variant2 {
        ...
        public:
            ...
            char const* what() const noexcept { return "bad_variant_access"; }
        };
        ...
        constexpr bool operator<(monostate const&, monostate const&) noexcept
        {
            return false;
        }
        ...
        namespace detail {
            ...
            template<class I, class T, class Q>
            using var_alt_impl = mp11::mp_invoke<Q, variant_alternative_t<I::value, T>>;
        ...
        struct variant_alternative<I, T const> :
            mp11::mp_defer<detail::var_alt_impl, mp11::mp_size_t<I>, T, mp11::mp_quote_trait<std::add_const>>
        {
        };

        template<std::size_t I, class T>
        struct variant_alternative<I, T volatile> :
            mp11::mp_defer<detail::var_alt_impl, mp11::mp_size_t<I>, T, mp11::mp_quote_trait<std::add_volatile>>
        {
        };
        ...
        struct variant_alternative<I, T&> :
            mp11::mp_defer<detail::var_alt_impl, mp11::mp_size_t<I>, T, mp11::mp_quote_trait<std::add_lvalue_reference>>
        {
        };

        template<std::size_t I, class T>
        struct variant_alternative<I, T&&> :
            mp11::mp_defer<detail::var_alt_impl, mp11::mp_size_t<I>, T, mp11::mp_quote_trait<std::add_rvalue_reference>>
        {
        };

        template<std::size_t I, class... T>
        struct variant_alternative<I, variant<T...>> : mp11::mp_defer<mp11::mp_at, variant<T...>, mp11::mp_size_t<I>>
        {
        };
        ...
        constexpr bool holds_alternative(variant<T...> const& v) noexcept
        {
            static_assert(
        ...
        constexpr variant_alternative_t<I, variant<T...>>&& get(variant<T...>&& v)
        {
            ...
            return (v.index() != I ? detail::throw_bad_variant_access() : (void)0),
    ...
    #define BOOST_VARIANT2_CX14_ASSERT(expr)
        ...
        template<std::size_t I, class... T>
        constexpr variant_alternative_t<I, variant<T...>>& unsafe_get(variant<T...>& v)
        {
            static_assert(I < sizeof...(T), "Index out of bounds");
        ...
        template<std::size_t I, class... T>
        constexpr variant_alternative_t<I, variant<T...>> const& unsafe_get(variant<T...> const& v)
        {
            static_assert(I < sizeof...(T), "Index out of bounds");
        ...
        template<class U, class... T>
        constexpr U const& get(variant<T...> const& v)
        {
            static_assert(
                mp11::mp_count<variant<T...>, U>::value == 1,
                "The type must occur exactly once in the list of variant alternatives");
        ...
        template<class U, class... T>
        constexpr typename std::add_pointer<U>::type get_if(variant<T...>* v) noexcept
        {
            static_assert(
                mp11::mp_count<variant<T...>, U>::value == 1,
                "The type must occur exactly once in the list of variant alternatives");
        ...
        template<class U, class... T>
        constexpr typename std::add_pointer<U const>::type get_if(variant<T...> const* v) noexcept
        {
            static_assert(
                mp11::mp_count<variant<T...>, U>::value == 1,
                "The type must occur exactly once in the list of variant alternatives");
        ...
        namespace detail {
            ...
            struct is_trivially_copy_constructible :
                mp11::mp_bool<std::is_copy_constructible<T>::value && std::has_trivial_copy_constructor<T>::value>
            {
            };
            ...
            union variant_storage_impl<mp11::mp_false, T1, T...>
            {
                ...
                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<0>, A&&... a) :
                    first_(std::forward<A>(a)...)
                {
                }

                template<std::size_t I, class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<I>, A&&... a) :
                ...
                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<0>, A&&... a)
                {
                    ::new (&first_) T1(std::forward<A>(a)...);
                }

                template<std::size_t I, class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<I>, A&&... a)
                {
            ...
            union variant_storage_impl<mp11::mp_false, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T...>
            {
                ...
                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<1>, A&&... a) :
                    t1_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<2>, A&&... a) :
                    t2_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<3>, A&&... a) :
                    t3_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<4>, A&&... a) :
                    t4_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<5>, A&&... a) :
                    t5_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<6>, A&&... a) :
                    t6_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<7>, A&&... a) :
                    t7_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<8>, A&&... a) :
                    t8_(std::forward<A>(a)...)
                {
                }

                template<class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<9>, A&&... a) :
                    t9_(std::forward<A>(a)...)
                {
                }
                ...
                template<std::size_t I, class... A>
                constexpr variant_storage_impl(mp11::mp_size_t<I>, A&&... a) :
                    rest_(mp11::mp_size_t<I - 10>(), std::forward<A>(a)...)
                {
                }
                ...
                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<1>, A&&... a)
                {
                    ::new (&t1_) T1(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<2>, A&&... a)
                {
                    ::new (&t2_) T2(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<3>, A&&... a)
                {
                    ::new (&t3_) T3(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<4>, A&&... a)
                {
                    ::new (&t4_) T4(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<5>, A&&... a)
                {
                    ::new (&t5_) T5(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<6>, A&&... a)
                {
                    ::new (&t6_) T6(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<7>, A&&... a)
                {
                    ::new (&t7_) T7(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<8>, A&&... a)
                {
                    ::new (&t8_) T8(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace(mp11::mp_size_t<9>, A&&... a)
                {
                ...
                template<std::size_t I>
                BOOST_CXX14_CONSTEXPR mp11::mp_at_c<mp11::mp_list<T...>, I - 10>& get(mp11::mp_size_t<I>) noexcept
                {
            ...
            union variant_storage_impl<mp11::mp_true, T1, T...>
            {
                ...
                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<0>, A&&... a)
                {
                    ::new (&first_) T1(std::forward<A>(a)...);
                }

                template<std::size_t I, class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<I>, A&&... a)
                {
                    rest_.emplace(mp11::mp_size_t<I - 1>(), std::forward<A>(a)...);
                }

                template<std::size_t I, class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_true, mp11::mp_size_t<I>, A&&... a)
                {
    ...
    #pragma GCC diagnostic pop
            ...
            union variant_storage_impl<mp11::mp_true, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T...>
            {
                ...
                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<1>, A&&... a)
                {
                    ::new (&t1_) T1(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<2>, A&&... a)
                {
                    ::new (&t2_) T2(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<3>, A&&... a)
                {
                    ::new (&t3_) T3(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<4>, A&&... a)
                {
                    ::new (&t4_) T4(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<5>, A&&... a)
                {
                    ::new (&t5_) T5(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<6>, A&&... a)
                {
                    ::new (&t6_) T6(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<7>, A&&... a)
                {
                    ::new (&t7_) T7(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<8>, A&&... a)
                {
                    ::new (&t8_) T8(std::forward<A>(a)...);
                }

                template<class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, mp11::mp_size_t<9>, A&&... a)
                {
                    ::new (&t9_) T9(std::forward<A>(a)...);
                }
            ...
            using get_smallest_unsigned_type = mp11::mp_cond<
                ...
                mp11::mp_bool<N <= (std::numeric_limits<unsigned char>::max)()>,
                unsigned char,
                mp11::mp_bool<N <= (std::numeric_limits<unsigned short>::max)()>,
                unsigned short,
                mp11::mp_true,
                unsigned
            ...
            using get_index_type = unsigned short;
            ...
            using variant_base = variant_base_impl<
                mp11::mp_all<std::is_trivially_destructible<T>...>::value,
                mp11::mp_all<std::is_nothrow_move_constructible<T>...>::value,
                T...>;
            ...
            struct variant_base_impl<true, true, T...>
            {
                ...
                constexpr explicit variant_base_impl(I, A&&... a) :
                    st_(mp11::mp_size_t<I::value + 1>(), std::forward<A>(a)...),
                    ix_(I::value + 1)
                {
                }
                ...
                // requires: ix_ == 0
                template<class I, class... A>
                BOOST_CXX14_CONSTEXPR void _replace(I, A&&... a)
                {
                ...
                constexpr std::size_t index() const noexcept { return ix_ - 1; }
                ...
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_true, A&&... a)
                {
                    static_assert(
                        std::is_nothrow_constructible<U, A&&...>::value,
                        "Logic error: U must be nothrow constructible from A&&...");
                ...
                template<std::size_t J, class U, class... A>
                BOOST_CXX14_CONSTEXPR void emplace_impl(mp11::mp_false, A&&... a)
                {
                    static_assert(
                        std::is_nothrow_move_constructible<U>::value,
                        "Logic error: U must be nothrow move constructible");
                ...
                template<std::size_t I, class... A>
                BOOST_CXX14_CONSTEXPR void emplace(A&&... a)
                {
                    std::size_t const J = I + 1;
            ...
            struct variant_base_impl<true, false, T...>
            {
                ...
                constexpr variant_base_impl() :
                    st_ { { mp11::mp_size_t<0>() }, { mp11::mp_size_t<0>() } },
                    ix_(0)
                {
                }
                ...
                template<class I, class... A>
                constexpr explicit variant_base_impl(I, A&&... a) :
                    st_ { { mp11::mp_size_t<I::value + 1>(), std::forward<A>(a)... }, { mp11::mp_size_t<0>() } },
                    ix_((I::value + 1) * 2)
                {
                }
                ...
                constexpr std::size_t index() const noexcept { return ix_ / 2 - 1; }
            ...
            struct variant_base_impl<false, true, T...>
            {
                ...
                struct _destroy_L1
                {
                    ...
                    template<class I>
                    BOOST_CXX14_CONSTEXPR void operator()(I) const noexcept
                    {
                ...
                BOOST_VARIANT2_CXX20_CONSTEXPR ~variant_base_impl() noexcept { _destroy(); }
            ...
            struct variant_base_impl<false, false, T...>
            {
                ...
                BOOST_CXX14_CONSTEXPR variant_storage<none, T...>& storage(unsigned i2) noexcept { return st_[i2]; }

                constexpr variant_storage<none, T...> const& storage(unsigned i2) const noexcept { return st_[i2]; }
                ...
                BOOST_CXX14_CONSTEXPR void _destroy() noexcept
                {
                    mp11::mp_with_index<1 + sizeof...(T)>(
                        ix_ / 2,
                        _destroy_L1 { this, static_cast<unsigned>(ix_ & 1) });
                }
        ...
        namespace detail {
            ...
            struct is_nothrow_swappable :
                mp11::mp_eval_if<mp11::mp_not<is_swappable<T>>, mp11::mp_false, det2::is_nothrow_swappable_impl, T>
            {
            };
            ...
            private:
                struct L1
                {
                    ...
                    template<class I>
                    BOOST_CXX14_CONSTEXPR void operator()(I i) const
                    {
            ...
            public:
                BOOST_CXX14_CONSTEXPR variant_cc_base_impl(variant_cc_base_impl const& r) noexcept(
                    mp11::mp_all<std::is_nothrow_copy_constructible<T>...>::value) :
                    variant_base()
                {
            ...
            public:
                BOOST_CXX14_CONSTEXPR variant_ca_base_impl& operator=(variant_ca_base_impl const& r) noexcept(
                    mp11::mp_all<std::is_nothrow_copy_constructible<T>...>::value)
                {
            ...
            public:
                BOOST_CXX14_CONSTEXPR variant_mc_base_impl(variant_mc_base_impl&& r) noexcept(
                    mp11::mp_all<std::is_nothrow_move_constructible<T>...>::value)
                {
            ...
            public:
                BOOST_CXX14_CONSTEXPR variant_ma_base_impl& operator=(variant_ma_base_impl&& r) noexcept(
                    mp11::mp_all<std::is_nothrow_move_constructible<T>...>::value)
                {
        ...
        template<class... T>
        class variant : private detail::variant_ma_base<T...> {
        private:
        ...
        public:
            ...
            constexpr variant() noexcept(std::is_nothrow_default_constructible<mp11::mp_first<variant<T...>>>::value) :
            ...
            template<
                ...
                class E1 = typename std::enable_if<
                    !std::is_same<Ud, variant>::value && !std::is_base_of<variant, Ud>::value &&
                    !detail::is_in_place_index<Ud>::value && !detail::is_in_place_type<Ud>::value>::type,
            ...
            template<
                ...
                class I = mp11::mp_find<variant<T...>, U>,
                class E =
                    typename std::enable_if<std::is_constructible<U, std::initializer_list<V>&, A&&...>::value>::type>
            ...
            template<
                ...
                class... A,
                class E = typename std::enable_if<
                    std::is_constructible<mp11::mp_at_c<variant<T...>, I>, std::initializer_list<V>&, A&&...>::value>::
                    type>
            ...
            template<
                ...
                class V = detail::resolve_overload_type<U, T...>,
                class E2 = typename std::enable_if<
                    std::is_assignable<V&, U&&>::value && std::is_constructible<V, U&&>::value>::type>
            BOOST_CXX14_CONSTEXPR variant& operator=(U&& u) noexcept(std::is_nothrow_constructible<V, U&&>::value)
            {
            ...
            template<
                ...
                class... A,
                class E = typename std::enable_if<
                    mp11::mp_count<variant<T...>, U>::value == 1 && std::is_constructible<U, A&&...>::value>::type>
        ...
        public:
            BOOST_CXX14_CONSTEXPR void swap(variant& r) noexcept(
                mp11::mp_all<std::is_nothrow_move_constructible<T>..., detail::is_nothrow_swappable<T>...>::value)
            {
                if (index() == r.index()) {
        ...
        public:
            template<
                class... U,
                class E2 = mp11::mp_if<
                    mp11::mp_all<std::is_copy_constructible<U>..., mp11::mp_contains<mp11::mp_list<T...>, U>...>,
                    void>>
            BOOST_CXX14_CONSTEXPR
                variant(variant<U...> const& r) noexcept(mp11::mp_all<std::is_nothrow_copy_constructible<U>...>::value)
            {
        ...
        public:
            template<
                class... U,
                class E2 = mp11::mp_if<
                    mp11::mp_all<std::is_move_constructible<U>..., mp11::mp_contains<mp11::mp_list<T...>, U>...>,
                    void>>
            BOOST_CXX14_CONSTEXPR
        ...
        private:
            template<class... U, class V, std::size_t J, class E = typename std::enable_if<J != sizeof...(U)>::type>
            static constexpr variant<U...> _subset_impl(mp11::mp_size_t<J>, V&& v)
            {
                return variant<U...>(in_place_index_t<J>(), std::forward<V>(v));
            }

            template<class... U, class V>
            static variant<U...> _subset_impl(mp11::mp_size_t<sizeof...(U)>, V&& /*v*/)
            {
                detail::throw_bad_variant_access();
            }
        ...
        private:
            ...
            struct L8
            {
                ...
                template<class I>
                BOOST_CXX14_CONSTEXPR variant<U...> operator()(I i) const
                {
        ...
        constexpr bool operator<(variant<T...> const& v, variant<T...> const& w)
        {
            return v.index() < w.index() || (v.index() == w.index() &&
        ...
        namespace detail {
            ...
            template<class... T>
            variant<T...> const& extract_variant_base_(variant<T...> const&);

#if BOOST_WORKAROUND(BOOST_MSVC, < 1930)

            template<class V>
            struct extract_vbase_impl
            {
                using type = decltype(extract_variant_base_(std::declval<V>()));
            };

            template<class V>
            using extract_variant_base = remove_cv_ref_t<typename extract_vbase_impl<V>::type>;
            ...
            using Vret = mp11::mp_eval_if_not<
                std::is_same<R, deduced>,
                R,
                front_if_same,
                mp11::mp_product_q<Qret<F>, apply_cv_ref<V>...>>;
            ...
            template<class R, class F, class... V>
            using Vret = typename Vret_impl<R, F, V...>::type;
        ...
        {
            return mp11::mp_with_index<detail::variant_base_size<V1>>(
                v1.index(),
                detail::visit_L1<R, F, V1> { std::forward<F>(f), std::forward<V1>(v1) });
        }
        ...
        namespace detail {
            ...
            struct bind_front_
            {
                ...
                template<class... T>
                auto operator()(T&&... t) -> decltype(std::forward<F>(f)(std::forward<A>(a), std::forward<T>(t)...))
                {
            ...
            template<class F, class A>
            bind_front_<F, A> bind_front(F&& f, A&& a)
            {
                return bind_front_<F, A> { std::forward<F>(f), std::forward<A>(a) };
            }

            template<class R, class F, class V1, class V2>
            struct visit_L2
            {
                F&& f;
                ...
                template<class I>
                auto operator()(I) const -> Vret<R, F, V1, V2>
                {
        ...
        template<class R = detail::deduced, class F, class V1, class V2>
        constexpr auto visit(F&& f, V1&& v1, V2&& v2) -> detail::Vret<R, F, V1, V2>
        {
            return mp11::mp_with_index<detail::variant_base_size<V1>>(
                v1.index(),
                detail::visit_L2<R, F, V1, V2> { std::forward<F>(f), std::forward<V1>(v1), std::forward<V2>(v2) });
        }

        namespace detail {

            template<class R, class F, class V1, class V2, class V3>
            struct visit_L3
            {
                F&& f;
                ...
                template<class I>
                auto operator()(I) const -> Vret<R, F, V1, V2, V3>
                {
                    auto f2 = bind_front(std::forward<F>(f), unsafe_get<I::value>(std::forward<V1>(v1)));
        ...
        template<class R = detail::deduced, class F, class V1, class V2, class V3>
        constexpr auto visit(F&& f, V1&& v1, V2&& v2, V3&& v3) -> detail::Vret<R, F, V1, V2, V3>
        {
            return mp11::mp_with_index<detail::variant_base_size<V1>>(
                v1.index(),
                detail::visit_L3<R, F, V1, V2, V3> { std::forward<F>(f),
                                                     std::forward<V1>(v1),
                                                     std::forward<V2>(v2),
                                                     std::forward<V3>(v3) });
        }
        ...
        namespace detail {
            ...
            template<class R, class F, class V1, class V2, class V3, class V4>
            struct visit_L4
            {
                F&& f;
                ...
                template<class I>
                auto operator()(I) const -> Vret<R, F, V1, V2, V3, V4>
                {
                    auto f2 = bind_front(std::forward<F>(f), unsafe_get<I::value>(std::forward<V1>(v1)));
        ...
        template<class R = detail::deduced, class F, class V1, class V2, class V3, class V4>
        constexpr auto visit(F&& f, V1&& v1, V2&& v2, V3&& v3, V4&& v4) -> detail::Vret<R, F, V1, V2, V3, V4>
        {
            return mp11::mp_with_index<detail::variant_base_size<V1>>(
                v1.index(),
                detail::visit_L4<R, F, V1, V2, V3, V4> { std::forward<F>(f),
                                                         std::forward<V1>(v1),
                                                         std::forward<V2>(v2),
                                                         std::forward<V3>(v3),
                                                         std::forward<V4>(v4) });
            ...
            return mp11::mp_with_index<detail::variant_base_size<V1>>(v1.index(), [&](auto I) {
                auto f2 = [&](auto&&... a) {
                    return std::forward<F>(
                        f)(unsafe_get<I.value>(std::forward<V1>(v1)), std::forward<decltype(a)>(a)...);
                };
        ...
        template<
            class... T,
            class E = typename std::enable_if<
                mp11::mp_all<std::is_move_constructible<T>..., detail::is_swappable<T>...>::value>::type>
        BOOST_CXX14_CONSTEXPR void swap(variant<T...>& v, variant<T...>& w) noexcept(noexcept(v.swap(w)))
        {
            v.swap(w);
        }
        ...
        namespace detail {
            ...
            using Vret2 = mp11::mp_eval_if_not<
                std::is_same<R, deduced>,
                R,
                front_if_same,
                mp11::mp_transform<mp11::mp_invoke_q, mp11::mp_list<Qret<F>...>, apply_cv_ref<V>>>;
        ...
        constexpr auto visit_by_index(V&& v, F&&... f) -> detail::Vret2<R, V, F...>
        {
            ...
            return mp11::mp_with_index<variant_size<V>::value>(
                v.index(),
        ...
        namespace detail {
            ...
            struct is_output_streamable<Os, T, decltype(std::declval<Os&>() << std::declval<T const&>(), (void)0)> :
                std::true_type
            {
            };
        ...
        template<
            ...
            class... T,
            class E = typename std::enable_if<
                mp11::mp_all<detail::is_output_streamable<std::basic_ostream<Ch, Tr>, T>...>::value>::type>
        std::basic_ostream<Ch, Tr>& operator<<(std::basic_ostream<Ch, Tr>& os, variant<T1, T...> const& v)
        {
            return mp11::mp_with_index<1 + sizeof...(T)>(
                v.index(),
        ...
        namespace detail {
            ...
            template<class... T>
            std::size_t hash_value_std(variant<T...> const& v)
            {
                return mp11::mp_with_index<sizeof...(T)>(
                    v.index(),
                    detail::hash_value_L<std::hash, variant<T...>> { v });
            }
        ...
        template<class... T>
        std::size_t hash_value(variant<T...> const& v)
        {
        ...
        namespace detail {
            ...
            {
                std::size_t operator()(V const& v) const { return detail::hash_value_std(v); }
            };
...
namespace std {
    ...
    template<class... T>
    struct hash<::boost::variant2::variant<T...>> :
        public ::boost::variant2::detail::std_hash_impl<::boost::variant2::variant<T...>>
    {
    };

    template<>
    struct hash<::boost::variant2::monostate>
    {
        std::size_t operator()(::boost::variant2::monostate const& v) const { return hash_value(v); }
    };
...
namespace boost {
    namespace json {
        ...
        template<class T>
        typename result_for<T, value>::type result_from_errno(int e, boost::source_location const* loc) noexcept;

        template<class T>
        struct is_null_like;

        template<>
        struct is_null_like<variant2::monostate> : std::true_type
        {
        };
    ...
    namespace variant2 {
        ...
        namespace detail {
            ...
            struct tag_invoke_L1
            {
                ...
                explicit tag_invoke_L1(boost::json::value& v_) :
                    v(v_)
                {
                }
#endif
