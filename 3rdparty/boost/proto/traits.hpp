...
namespace boost {
    namespace proto {
        namespace detail {
            ...
            template<typename T>
            struct if_vararg<T, typename T::proto_is_vararg_> : T
            {
            };

            template<typename T, typename Void = void>
            struct is_callable2_ : mpl::false_
            {
            };

            template<typename T>
            struct is_callable2_<T, typename T::proto_is_callable_> : mpl::true_
            {
            };

            template<typename T BOOST_PROTO_TEMPLATE_ARITY_PARAM(
                long Arity = boost::proto::detail::template_arity<T>::value)>
            struct is_callable_ : is_callable2_<T>
            {
            };
        ...
        template<typename T>
        struct is_callable : proto::detail::is_callable_<T>
        {
        };
        ...
        ///
        template<>
        struct is_callable<proto::_> : mpl::true_
        {
        };
        ...
        ///
        template<>
        struct is_callable<proto::callable> : mpl::false_
        {
        };
        ...
        struct is_callable<proto::transform<PrimitiveTransform, X>> : mpl::false_
        {
        };
        ...
        struct is_callable<proto::expr<Tag, Args, N>> : mpl::false_
        {
        };

        // work around GCC bug
        template<typename Tag, typename Args, long N>
        struct is_callable<proto::basic_expr<Tag, Args, N>> : mpl::false_
        {
        };
#endif
        ...
        namespace detail {
            template<typename T, typename Void /*= void*/>
            struct is_transform_ : mpl::false_
            {
            };

            template<typename T>
            struct is_transform_<T, typename T::proto_is_transform_> : mpl::true_
            {
            };
        }
        ...
        template<typename T>
        struct is_transform : proto::detail::is_transform_<T>
        {
        };

        namespace detail {
            template<typename T, typename Void /*= void*/>
            struct is_aggregate_ : is_pod<T>
            {
            };

            template<typename Tag, typename Args, long N>
            struct is_aggregate_<proto::expr<Tag, Args, N>, void> : mpl::true_
            {
            };

            template<typename Tag, typename Args, long N>
            struct is_aggregate_<proto::basic_expr<Tag, Args, N>, void> : mpl::true_
            {
            };

            template<typename T>
            struct is_aggregate_<T, typename T::proto_is_aggregate_> : mpl::true_
            {
            };
        }
        ...
        template<typename T>
        struct is_aggregate : proto::detail::is_aggregate_<T>
        {
        };
        ...
        /// <tt>is_expr\<T\>::value</tt> is \c false.
        template<typename T>
        struct is_expr<T, typename T::proto_is_expr_> : mpl::true_
        {
        };

        template<typename T>
        struct is_expr<T&, void> : is_expr<T>
        {
        };
        ...
        template<typename Expr>
        struct arity_of<Expr&> : Expr::proto_arity
        {
        };
        ...
        namespace result_of {
            ...
            struct child : child_c<Expr, N::value>
            {
            };
        ...
        template<typename T>
        struct terminal : proto::transform<terminal<T>, int>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                ...
                operator()(typename impl::expr_param e, typename impl::state_param, typename impl::data_param) const
                {
                    return e;
                }
            };
        ...
        struct if_else_ : proto::transform<if_else_<T, U, V>, int>
        {
            ...
            template<typename Expr, typename State, typename Data>
            struct impl : detail::pass_through_impl<if_else_, deduce_domain, Expr, State, Data>
            {
            };
        ...
        struct nullary_expr : proto::transform<nullary_expr<Tag, T>, int>
        {
        ...
        /// unary expression.
        template<typename Tag, typename T>
        struct unary_expr : proto::transform<unary_expr<Tag, T>, int>
        {
            typedef proto::expr<Tag, list1<T>, 1> type;
            typedef proto::basic_expr<Tag, list1<T>, 1> proto_grammar;

            template<typename Expr, typename State, typename Data>
            struct impl : detail::pass_through_impl<unary_expr, deduce_domain, Expr, State, Data>
            {
            };
        ...
        struct binary_expr : proto::transform<binary_expr<Tag, T, U>, int>
        {
            typedef proto::expr<Tag, list2<T, U>, 2> type;
            typedef proto::basic_expr<Tag, list2<T, U>, 2> proto_grammar;

            template<typename Expr, typename State, typename Data>
            struct impl : detail::pass_through_impl<binary_expr, deduce_domain, Expr, State, Data>
            {
            };
...
#define BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(Op)                                    \
    ...
    struct Op : proto::transform<Op<T, U>, int>                                       \
    {                                                                                 \
...
#include <boost/proto/detail/traits.hpp>
        ...
        namespace functional {
            ...
            struct as_expr
            {
                ...
                template<typename T>
                BOOST_FORCEINLINE typename add_const<typename result<as_expr(T&)>::type>::type operator()(T& t) const
                {
                ...
                ///
                template<typename T>
                BOOST_FORCEINLINE typename add_const<typename result<as_expr(T const&)>::type>::type
                ...
                BOOST_FORCEINLINE
                    typename add_const<typename result<as_expr(T (&)[N_])>::type>::type operator()(T (&t)[N_]) const
                {
                    return typename Domain::template as_expr<T[N_]>()(t);
                }

                template<typename T, std::size_t N_>
                BOOST_FORCEINLINE typename add_const<typename result<as_expr(T const (&)[N_])>::type>::type
            ...
            struct as_child
            {
                ...
                template<typename T>
                BOOST_FORCEINLINE typename add_const<typename result<as_child(T&)>::type>::type operator()(T& t) const
                {
                ...
                ///
                template<typename T>
                BOOST_FORCEINLINE typename add_const<typename result<as_child(T const&)>::type>::type
                    operator()(T const& t) const
                {
            ...
            struct child_c
            {
                ...
                /// \throw nothrow
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::child_c<Expr&, N>::type operator()(Expr& e) const
                {
                ...
                ///
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::child_c<Expr const&, N>::type operator()(Expr const& e) const
                {
            ...
            struct child
            {
                ...
                /// \throw nothrow
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::child<Expr&, N>::type operator()(Expr& e) const
                {
                ...
                ///
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::child<Expr const&, N>::type operator()(Expr const& e) const
                {
            ...
            struct value
            {
                ...
                /// \throw nothrow
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::value<Expr&>::type operator()(Expr& e) const
                {
                ...
                ///
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::value<Expr const&>::type operator()(Expr const& e) const
                {
                    return e.proto_base().child0;
                }
            };
            ...
            struct left
            {
                ...
                /// \throw nothrow
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::left<Expr&>::type operator()(Expr& e) const
                {
                    return e.proto_base().child0;
                }
                ...
                ///
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::left<Expr const&>::type operator()(Expr const& e) const
                {
                    return e.proto_base().child0;
                }
            };
            ...
            struct right
            {
                ...
                /// \throw nothrow
                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::right<Expr&>::type operator()(Expr& e) const
                {
                    return e.proto_base().child1;
                }

                template<typename Expr>
                BOOST_FORCEINLINE typename result_of::right<Expr const&>::type operator()(Expr const& e) const
                {
                    return e.proto_base().child1;
                }
            };
        ...
        /// \param t The object to wrap.
        template<typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_expr<T, default_domain>::type>::type
        ...
        ///
        template<typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_expr<T const, default_domain>::type>::type
            as_expr(T const& t)
        {
        ...
        BOOST_FORCEINLINE typename add_const<typename result_of::as_expr<T, Domain>::type>::type
            as_expr(T& t BOOST_PROTO_DISABLE_IF_IS_CONST(T) BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
        {
            return typename Domain::template as_expr<T>()(t);
        }
        ...
        ///
        template<typename Domain, typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_expr<T const, Domain>::type>::type
            as_expr(T const& t)
        {
            return typename Domain::template as_expr<T const>()(t);
        }
        ...
        /// \param t The object to wrap.
        template<typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_child<T, default_domain>::type>::type
        ...
        ///
        template<typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_child<T const, default_domain>::type>::type
            as_child(T const& t)
        {
        ...
        ///
        template<typename Domain, typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_child<T, Domain>::type>::type
            as_child(T& t BOOST_PROTO_DISABLE_IF_IS_CONST(T) BOOST_PROTO_DISABLE_IF_IS_FUNCTION(T))
        {
            return typename Domain::template as_child<T>()(t);
        }
        ...
        ///
        template<typename Domain, typename T>
        BOOST_FORCEINLINE typename add_const<typename result_of::as_child<T const, Domain>::type>::type
            as_child(T const& t)
        {
            return typename Domain::template as_child<T const>()(t);
        }
        ...
        BOOST_FORCEINLINE typename result_of::child<Expr&, N>::type child(Expr& e BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return result_of::child<Expr&, N>::call(e);
        }
        ...
        ///
        template<typename N, typename Expr>
        BOOST_FORCEINLINE typename result_of::child<Expr const&, N>::type child(Expr const& e)
        {
            return result_of::child<Expr const&, N>::call(e);
        }
        ...
        BOOST_FORCEINLINE typename detail::expr_traits<typename Expr2::proto_base_expr::proto_child0>::reference
        ...
        ///
        template<typename Expr2>
        BOOST_FORCEINLINE typename detail::expr_traits<typename Expr2::proto_base_expr::proto_child0>::const_reference
        ...
        BOOST_FORCEINLINE typename result_of::child_c<Expr&, N>::type
        ...
        ///
        template<long N, typename Expr>
        BOOST_FORCEINLINE typename result_of::child_c<Expr const&, N>::type child_c(Expr const& e)
        {
            return result_of::child_c<Expr const&, N>::call(e);
        }
        ...
        template<typename Expr>
        BOOST_FORCEINLINE typename result_of::value<Expr&>::type value(Expr& e BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return e.proto_base().child0;
        }
        ...
        ///
        template<typename Expr>
        BOOST_FORCEINLINE typename result_of::value<Expr const&>::type value(Expr const& e)
        {
            return e.proto_base().child0;
        }
        ...
        template<typename Expr>
        BOOST_FORCEINLINE typename result_of::left<Expr&>::type left(Expr& e BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return e.proto_base().child0;
        }
        ...
        ///
        template<typename Expr>
        BOOST_FORCEINLINE typename result_of::left<Expr const&>::type left(Expr const& e)
        {
            return e.proto_base().child0;
        }
        ...
        template<typename Expr>
        BOOST_FORCEINLINE typename result_of::right<Expr&>::type right(Expr& e BOOST_PROTO_DISABLE_IF_IS_CONST(Expr))
        {
            return e.proto_base().child1;
        }
        ...
        ///
        template<typename Expr>
        BOOST_FORCEINLINE typename result_of::right<Expr const&>::type right(Expr const& e)
        {
            return e.proto_base().child1;
        }
        ...
        struct is_callable<functional::as_expr<Domain>> : mpl::true_
        {
        };
        ...
        ///
        template<typename Domain>
        struct is_callable<functional::as_child<Domain>> : mpl::true_
        {
        };
        ...
        ///
        template<long N>
        struct is_callable<functional::child_c<N>> : mpl::true_
        {
        };
        ...
        ///
        template<typename N>
        struct is_callable<functional::child<N>> : mpl::true_
        {
        };
