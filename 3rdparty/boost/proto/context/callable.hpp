...
namespace boost {
    namespace proto {
        namespace detail {
            ...
            struct callable_context_wrapper : remove_cv<Context>::type
            {
            ...
            struct is_expr_handled<Expr, Context, 0>
            {
                ...
                static const bool value =
                    sizeof(yes_type) == sizeof(detail::check_is_expr_handled((sctx_(stag_, proto::value(sexpr_)), 0)));
        ...
        namespace context {
            ...
            struct callable_eval<Expr, Context, 0>
            {
                ...
                typedef typename BOOST_PROTO_RESULT_OF<Context(typename Expr::proto_tag, value_type)>::type result_type;
