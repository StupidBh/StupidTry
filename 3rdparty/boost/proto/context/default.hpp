...
#define UNREF(x) typename boost::remove_reference<x>::type
        ...
        namespace context {
            ...
            struct default_eval<Expr, Context, tag::terminal, 0>
            {
                ...
                result_type operator()(Expr& expr, Context&) const { return proto::value(expr); }
            };
...
#define BOOST_PROTO_BINARY_DEFAULT_EVAL(OP, TAG, LMAKE, RMAKE)                                             \
    ...
    public:                                                                                                \
        ...
        result_type operator()(Expr& expr, Context& ctx) const                                             \
        {                                                                                                  \
            return proto::eval(proto::child_c<0>(expr), ctx) OP proto::eval(proto::child_c<1>(expr), ctx); \
        }                                                                                                  \
    };                                                                                                     \
    /**/
...
#undef BOOST_PROTO_BINARY_DEFAULT_EVAL
            ...
            struct is_member_function_eval :
                is_member_function_pointer<typename detail::uncvref<typename proto::result_of::eval<
                    typename remove_reference<typename proto::result_of::child_c<Expr, 1>::type>::type,
                    Context>::type>::type>
            {
            };
...
#define BOOST_PROTO_DEFAULT_EVAL_TYPE(Z, N, DATA) \
    typename proto::result_of::                   \
        eval<typename remove_reference<typename proto::result_of::child_c<DATA, N>::type>::type, Context>::type /**/
...
#define BOOST_PROTO_DEFAULT_EVAL(Z, N, DATA) proto::eval(proto::child_c<N>(DATA), context)                      /**/
            ...
            {
                typedef typename proto::detail::result_of_fixup<BOOST_PROTO_DEFAULT_EVAL_TYPE(~, 0, Expr)>::type
                    function_type;
            ...
            struct default_eval<Expr, Context, proto::tag::function, 2>
            {
                ...
                typedef typename detail::result_of_<function_type(BOOST_PROTO_DEFAULT_EVAL_TYPE(~, 1, Expr))>::type
                    result_type;
...
#undef BOOST_PROTO_DEFAULT_EVAL
            ...
            struct default_context
            {
                ...
                struct eval : default_eval<Expr, ThisContext>
                {
                };
            };
