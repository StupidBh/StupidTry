    ...
    namespace proto {
        ...
        namespace domainns_ {
            ...
            struct domain : Generator
            {
                ...
                struct as_expr :
                    detail::
                        as_expr<T, typename detail::base_generator<Generator>::type, wants_basic_expr<Generator>::value>
                {
                ...
                struct as_expr<T, typename T::proto_is_expr_, proto::callable>
                {
                    ...
                    BOOST_FORCEINLINE
                    result_type operator()(T& e) const { return e; }
                };
            ...
            ///
            struct basic_default_domain : domain<basic_default_generator>
            {
            };
            ...
            ///
            struct deduce_domain : domain<detail::not_a_generator, detail::not_a_grammar, detail::not_a_domain>
            {
            };
        ...
        ///
        template<typename T>
        struct is_domain<T, typename T::proto_is_domain_> : mpl::true_
        {
        };
        ...
        struct is_sub_domain_of : is_sub_domain_of<typename SubDomain::proto_super_domain, SuperDomain>
        {
        };
        ...
        struct is_sub_domain_of<proto::no_super_domain, SuperDomain> : mpl::false_
        {
        };
        ...
        ///
        template<typename SuperDomain>
        struct is_sub_domain_of<SuperDomain, SuperDomain> : mpl::true_
        {
        };
