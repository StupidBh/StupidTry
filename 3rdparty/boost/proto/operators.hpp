...
namespace boost {
    namespace proto {
        namespace detail {
            ...
            struct lazy_matches : proto::matches<typename MakeExpr::type, Grammar>
            {
            };
            ...
            struct enable_unary :
                boost::lazy_enable_if_c<
                    boost::mpl::
                        and_<Trait, lazy_matches<result_of::make_expr<Tag, basic_default_domain, Arg>, Grammar>>::value,
            ...
            struct enable_binary :
                boost::lazy_enable_if_c<
                    boost::mpl::and_<
                        Trait,
                        lazy_matches<result_of::make_expr<Tag, basic_default_domain, Left, Right>, Grammar>>::value,
...
#define BOOST_PROTO_UNARY_OP_IS_POSTFIX_1 , int
    ...
    #define BOOST_PROTO_DEFINE_UNARY_OPERATOR(OP, TAG, TRAIT, DOMAIN, POST)                                          \
        ...
        BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE typename boost::proto::detail::                             \
            enable_unary<DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_UNARY_(TRAIT, Arg), TAG, Arg&>::type const \
        ...
        template<typename Arg>                                                                                       \
        BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE typename boost::proto::detail::                             \
            enable_unary<DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_UNARY_(TRAIT, Arg), TAG, Arg const&>::     \
                type const                                                                                           \
    ...
    #define BOOST_PROTO_DEFINE_BINARY_OPERATOR(OP, TAG, TRAIT, DOMAIN)                                      \
        ...
        BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE typename boost::proto::detail::enable_binary<      \
            DOMAIN,                                                                                         \
    ...
    #define BOOST_PROTO_DEFINE_UNARY_OPERATOR(OP, TAG, TRAIT, DOMAIN, POST)                                        \
        template<typename Arg>                                                                                     \
        BOOST_PROTO_PUSH_WARNINGS BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE typename boost::proto::detail:: \
            enable_unary<DOMAIN, DOMAIN::proto_grammar, BOOST_PROTO_APPLY_UNARY_(TRAIT, Arg), TAG, Arg const&>::   \
                type const                                                                                         \
            operator OP(Arg&& arg BOOST_PROTO_UNARY_OP_IS_POSTFIX_##POST)                                          \
        {                                                                                                          \
    ...
    #define BOOST_PROTO_DEFINE_BINARY_OPERATOR(OP, TAG, TRAIT, DOMAIN)                                      \
        template<typename Left, typename Right>                                                             \
        BOOST_PROTO_PUSH_WARNINGS BOOST_PROTO_DISABLE_MSVC_C4714 BOOST_FORCEINLINE                          \
...
#define BOOST_PROTO_DEFINE_OPERATORS(TRAIT, DOMAIN)                                               \
    ...
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(^=, boost::proto::tag::bitwise_xor_assign, TRAIT, DOMAIN)
        ...
        template<typename T>
        struct is_extension<T&> : is_expr<T>
        {
        };
...
#define BOOST_PROTO_APPLY_BINARY_(TRAIT, LEFT, RIGHT) boost::mpl::or_<TRAIT<LEFT>, TRAIT<RIGHT>>
        ...
        namespace exprns_ {
            ...
            {
                return proto::detail::make_expr_<tag::if_else_, deduce_domain, A0 const&, A1 const&, A2 const&>()(
                    a0,
                    a1,
                    a2);
            }
...
#undef BOOST_PROTO_APPLY_BINARY_
    ...
    #define BOOST_PROTO_APPLY_BINARY_(TRAIT, LEFT, RIGHT) \
        boost::mpl::and_<                                 \
            ...
            boost::mpl::not_<                             \
                boost::mpl::or_<boost::proto::is_extension<LEFT>, boost::proto::is_extension<RIGHT>>>> /**/

#else

    #define BOOST_PROTO_APPLY_UNARY_(TRAIT, ARG) \
        boost::mpl::and_<TRAIT<BOOST_PROTO_UNCVREF(ARG)>, boost::mpl::not_<boost::proto::is_extension<ARG>>> /**/
