...
namespace boost {
    namespace proto {
        namespace detail {
            ...
            struct as_element
            {
                ...
                struct result<This(Expr&)> :
                    mpl::
                        if_c<is_same<Tag, typename Expr::proto_tag>::value, flat_view<Expr>, fusion::single_view<Expr&>>
                {
                };
                ...
                template<typename Expr>
                typename result<as_element(Expr const&)>::type const operator()(Expr const& e) const
                {
            ...
            struct flat_view : fusion::sequence_base<flat_view<Expr>>
            {
                ...
                typedef typename fusion::result_of::as_list<
                    typename fusion::result_of::transform<Expr, as_element<typename Expr::proto_tag>>::type>::type
                    segments_type;
        ...
        namespace result_of {
            template<typename Expr>
            struct flatten : flatten<Expr const&>
            {
            };
        ...
        struct eval_fun : proto::callable
        {
            ...
            template<typename Expr>
            typename proto::result_of::eval<Expr, Context>::type operator()(Expr& e) const
            {
                return proto::eval(e, this->ctx_);
            }

            template<typename Expr>
            typename proto::result_of::eval<Expr const, Context>::type operator()(Expr const& e) const
            {
                return proto::eval(e, this->ctx_);
            }
    ...
    namespace fusion {
        namespace extension {
            ...
            struct value_of_impl<proto::tag::proto_expr_iterator<Tag, Domain>>
            {
                ...
                {
                    typedef
                        typename proto::result_of::child_c<typename Iterator::expr_type, Iterator::index>::value_type
                            type;
                };
                ...
                {
                    typedef typename proto::result_of::value<typename Iterator::expr_type>::value_type type;
                };
            };
            ...
            struct deref_impl<proto::tag::proto_expr_iterator<Tag, Domain>>
            {
                ...
                {
                    typedef
                        typename proto::result_of::child_c<typename Iterator::expr_type&, Iterator::index>::type type;

                    static type call(Iterator const& iter) { return proto::child_c<Iterator::index>(iter.expr); }
                };

                template<typename Iterator>
                struct apply<Iterator, 0>
                {
                    typedef typename proto::result_of::value<typename Iterator::expr_type&>::type type;
            ...
            struct advance_impl<proto::tag::proto_expr_iterator<Tag, Domain>>
            {
                ...
                struct apply
                {
                    typedef proto::detail::expr_iterator<typename Iterator::expr_type, Iterator::index + N::value> type;
            ...
            {
                template<typename Sequence>
                struct apply : mpl::long_<0 == Sequence::proto_arity_c ? 1 : Sequence::proto_arity_c>
                {
                };
            };
            ...
            struct end_impl<proto::tag::proto_expr<Tag, Domain>>
            {
                ...
                struct apply
                {
                    typedef proto::detail::
                        expr_iterator<Sequence, 0 == Sequence::proto_arity_c ? 1 : Sequence::proto_arity_c>
                            type;
            ...
            struct value_at_impl<proto::tag::proto_expr<Tag, Domain>>
            {
                ...
                struct apply
                {
                    typedef typename proto::result_of::child_c<Sequence, Index::value>::value_type type;
                };
            ...
            struct at_impl<proto::tag::proto_expr<Tag, Domain>>
            {
                ...
                struct apply
                {
                    typedef typename proto::result_of::child_c<Sequence&, Index::value>::type type;

                    static type call(Sequence& seq) { return proto::child_c<Index::value>(seq); }
                };
            ...
            struct convert_impl<proto::tag::proto_expr<Tag, Domain>>
            {
                ...
                struct apply
                {
                    typedef typename proto::result_of::unpack_expr<Tag, Domain, Sequence>::type type;
        ...
        namespace traits {
            ...
            struct enable_equality<
                Seq1,
                Seq2,
                typename enable_if_c<mpl::or_<proto::is_expr<Seq1>, proto::is_expr<Seq2>>::value>::type> : mpl::false_
            {
            };
