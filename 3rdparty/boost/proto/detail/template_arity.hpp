...
namespace boost {
    ...
    #include <boost/proto/detail/template_arity_helper.hpp>
            ...
            struct template_arity_impl2 : mpl::int_<Size - 1>
            {
            };

            template<typename F, int N = BOOST_PROTO_MAX_ARITY>
            struct template_arity :
                template_arity_impl2<F, N, sizeof(detail::template_arity_helper((F**)0, (mpl::int_<N>*)0))>
            {
            };
            ...
            template<typename F>
            struct template_arity_impl2<F, 0, 1> : mpl::int_<-1>
            {
            };
