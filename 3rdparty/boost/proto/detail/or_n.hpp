...
//  LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (2, BOOST_PROTO_MAX_LOGICAL_ARITY, <boost / proto / detail / or_n.hpp>))
...
struct BOOST_PP_CAT(or_, N)<true, Expr, BasicExpr, BOOST_PP_ENUM_PARAMS(N, G)> : mpl::true_
{
    typedef G0 which;
};
