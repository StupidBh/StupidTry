...
struct basic_expr<Tag, term<Arg0>, 0>
{
    ...
    BOOST_FORCEINLINE
    basic_expr const& proto_base() const { return *this; }

    BOOST_FORCEINLINE
    basic_expr& proto_base() { return *this; }

    template<typename A0>
    BOOST_FORCEINLINE static basic_expr const make(A0& a0)
    {
        return detail::make_terminal(a0, static_cast<basic_expr*>(0), static_cast<proto_args*>(0));
    }

    template<typename A0>
    BOOST_FORCEINLINE static basic_expr const make(A0 const& a0)
    {
        return detail::make_terminal(a0, static_cast<basic_expr*>(0), static_cast<proto_args*>(0));
    }
...
struct basic_expr<Tag, list2<Arg0, Arg1>, 2>
{
    ...
    BOOST_FORCEINLINE static basic_expr const make(A0 const& a0, A1 const& a1)
    {
...
struct basic_expr<Tag, list3<Arg0, Arg1, Arg2>, 3>
{
    ...
    BOOST_FORCEINLINE static basic_expr const make(A0 const& a0, A1 const& a1, A2 const& a2)
    {
...
struct basic_expr<Tag, list4<Arg0, Arg1, Arg2, Arg3>, 4>
{
    ...
    BOOST_FORCEINLINE static basic_expr const make(A0 const& a0, A1 const& a1, A2 const& a2, A3 const& a3)
    {
...
struct basic_expr<Tag, list5<Arg0, Arg1, Arg2, Arg3, Arg4>, 5>
{
    ...
    BOOST_FORCEINLINE static basic_expr const make(A0 const& a0, A1 const& a1, A2 const& a2, A3 const& a3, A4 const& a4)
    {
...
struct basic_expr<Tag, list6<Arg0, Arg1, Arg2, Arg3, Arg4, Arg5>, 6>
{
    ...
    BOOST_FORCEINLINE static basic_expr const
...
struct basic_expr<Tag, list8<Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6, Arg7>, 8>
{
    ...
    BOOST_FORCEINLINE static basic_expr const make(
        A0 const& a0,
        A1 const& a1,
        A2 const& a2,
        A3 const& a3,
