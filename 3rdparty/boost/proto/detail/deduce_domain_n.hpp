    ...
    #define BOOST_PROTO_COMMON_DOMAIN2(Z, N, DATA)                                                    \
        typedef typename common_domain2<common##N, A##N>::type BOOST_PP_CAT(common, BOOST_PP_INC(N)); \
        /**/
...
//  LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (3, BOOST_PROTO_MAX_ARITY, <boost / proto / detail / deduce_domain_n.hpp>))
...
struct BOOST_PP_CAT(deduce_domain, N) :
    BOOST_PP_CAT(common_domain, N)<BOOST_PP_ENUM_BINARY_PARAMS(N, typename domain_of<E, >::type BOOST_PP_INTERCEPT)>
{
};
