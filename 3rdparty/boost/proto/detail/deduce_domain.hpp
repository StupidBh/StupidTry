...
#include <boost/proto/proto_fwd.hpp>
    ...
    #define BOOST_PROTO_ASSERT_VALID_DOMAIN(DOM) \
        BOOST_MPL_ASSERT_NOT((boost::is_same<DOM, boost::proto::detail::not_a_domain>))
#endif
...
namespace boost {
    namespace proto {
        namespace detail {
            ...
            struct domain_ : domain_<typename Domain::proto_super_domain>
            {
                typedef Domain type;
            ...
            template<>
            struct domain_<default_domain> : domain_<not_a_domain>
            {
            };

            template<>
            struct domain_<basic_default_domain> : domain_<not_a_domain>
            {
            };
            ...
            struct nth_domain : nth_domain<N - 1, typename Domain::base>
            {
            };

            template<typename Domain>
            struct nth_domain<0, Domain> : Domain
            {
            };
#endif
            ...
            struct deduce_domain1 : domain_of<E0>
            {
            };
            ...
            struct deduce_domain2 : common_domain2<typename domain_of<E0>::type, typename domain_of<E1>::type>
            {
            };
