    ...
    namespace proto {
        namespace detail {
            ...
            struct as_callable
            {
                ...
                {
                    typedef typename when<_, Transform>::template impl<Expr, State, Data>::result_type type;
                };
...
#include <boost/proto/transform/detail/fold_impl.hpp>
        ...
        struct fold : transform<fold<Sequence, State0, Fun>>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                ...
                typedef typename remove_reference<
                    typename when<_, Sequence>::template impl<Expr, State, Data>::result_type>::type sequence;

                /// \brief An initial state for the fold.
                typedef typename remove_reference<
                    typename when<_, State0>::template impl<Expr, State, Data>::result_type>::type state0;

                /// \brief <tt>fun(d)(e,s) == when\<_,Fun\>()(e,s,d)</tt>
                typedef detail::as_callable<Fun, Data> fun;

                typedef typename fusion::result_of::fold<sequence, state0, fun>::type result_type;
        ...
        struct reverse_fold : transform<reverse_fold<Sequence, State0, Fun>>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                ...
                typedef typename fusion::result_of::reverse_fold<sequence, state0, fun>::type result_type;
        ...
        {
            template<typename Expr, typename State, typename Data>
            struct impl : detail::fold_impl<State0, Fun, Expr, State, Data>
            {
            };
        };
        ...
        {
            template<typename Expr, typename State, typename Data>
            struct impl : detail::reverse_fold_impl<State0, Fun, Expr, State, Data>
            {
            };
        };
        ...
        struct is_callable<fold<Sequence, State, Fun>> : mpl::true_
        {
        };
        ...
        ///
        template<typename Sequence, typename State, typename Fun>
        struct is_callable<reverse_fold<Sequence, State, Fun>> : mpl::true_
        {
        };
