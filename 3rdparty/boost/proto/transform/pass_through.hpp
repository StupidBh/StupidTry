...
#include <boost/proto/transform/detail/pass_through_impl.hpp>
            ...
            struct pass_through_impl<Grammar, Domain, Expr, State, Data, 0> : transform_impl<Expr, State, Data>
            {
                ...
                operator()(
                    ...
                    typename pass_through_impl::data_param) const
                {
                    return e;
                }
            };
        ...
        struct pass_through : transform<pass_through<Grammar, Domain>>
        {
            template<typename Expr, typename State, typename Data>
            struct impl : detail::pass_through_impl<Grammar, Domain, Expr, State, Data>
            {
            };
        };
        ...
        struct is_callable<pass_through<Grammar, Domain>> : mpl::true_
        {
        };
