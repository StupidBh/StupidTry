    ...
    namespace proto {
        ...
        struct _state : transform<_state>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                ...
                operator()(typename impl::expr_param, typename impl::state_param s, typename impl::data_param) const
                {
                    return s;
                }
            };
        ...
        struct _data : transform<_data>
        {
            template<typename Expr, typename State, typename Data>
            struct impl :
                mpl::if_c<is_env<Data>::value, _env_var<data_type>, _env>::type::template impl<Expr, State, Data>
            {
            };
        };
        ...
        struct _child_c : transform<_child_c<N>>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                typedef typename result_of::child_c<Expr, N>::type result_type;
...
/// \throw nothrow
        ...
        struct _value : transform<_value>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                typedef typename result_of::value<Expr>::type result_type;
...
/// \throw nothrow
        ...
        ///
        template<>
        struct is_callable<_expr> : mpl::true_
        {
        };
        ...
        ///
        template<>
        struct is_callable<_state> : mpl::true_
        {
        };
        ...
        ///
        template<>
        struct is_callable<_data> : mpl::true_
        {
        };
        ...
        ///
        template<int N>
        struct is_callable<_child_c<N>> : mpl::true_
        {
        };
        ...
        ///
        template<>
        struct is_callable<_value> : mpl::true_
        {
        };
        ...
        ///
        template<>
        struct is_callable<_byref> : mpl::true_
        {
        };
        ...
        ///
        template<>
        struct is_callable<_byval> : mpl::true_
        {
        };
