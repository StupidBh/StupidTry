...
namespace boost {
    namespace proto {
        namespace detail {
            template<typename T>
            struct is_applyable : mpl::and_<is_callable<T>, is_transform<T>>
            {
            };
            ...
            template<
                ...
                typename Expr,
                typename State,
                typename Data BOOST_PROTO_TEMPLATE_ARITY_PARAM(long Arity = detail::template_arity<R>::value)>
            struct make_
            {
                typedef R type;
                static bool const applied = false;
...
#include <boost/proto/transform/detail/construct_pod_funop.hpp>
        ...
        struct make : transform<make<Object>>
        {
            ...
            struct impl : transform_impl<Expr, State, Data>
            {
                ...
                BOOST_FORCEINLINE
                result_type
                    operator()(typename impl::expr_param, typename impl::state_param, typename impl::data_param) const
                {
                    return result_type();
                }
            };
        ...
        struct make<detail::msvc_fun_workaround<Fun>> : make<Fun>
        {
        };
...
#include <boost/proto/transform/detail/make_gcc_workaround.hpp>
        ...
        ///
        template<typename Object>
        struct is_callable<make<Object>> : mpl::true_
        {
        };
        ...
        ///
        template<typename PrimitiveTransform>
        struct is_callable<protect<PrimitiveTransform>> : mpl::true_
        {
        };
