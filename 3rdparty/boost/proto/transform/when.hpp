...
namespace boost {
    namespace proto {
        namespace detail {
            ...
            struct when_impl : transform<when<Grammar, Fun>>
            {
        ...
        struct when<Grammar, Fun*> : when<Grammar, Fun>
        {
        };
        ...
        struct when<Grammar, external_transform> : proto::transform<when<Grammar, external_transform>>
        {
            typedef Grammar first;
            ...
            template<typename Expr, typename State, typename Data>
            struct impl :
                remove_reference<typename mpl::eval_if_c<
                    proto::result_of::has_env_var<Data, transforms_type>::value,
                    proto::result_of::env_var<Data, transforms_type>,
                    proto::result_of::env_var<Data, data_type>>::type>::type::template when<Grammar>::
        ...
        struct external_transforms
        {
            ...
            struct when : proto::when<_, typename mpl::at<map_type, Rule>::type>
            {
            };
        };
...
#include <boost/proto/transform/detail/when.hpp>
        ...
        struct is_callable<when<Grammar, Transform>> : mpl::true_
        {
        };
