...
namespace boost {
    namespace proto {
        ...
        struct call<Fun*> : call<Fun>
        {
        };

        /// INTERNAL ONLY
        template<typename Fun>
        struct call<detail::msvc_fun_workaround<Fun>> : call<Fun>
        {
        };
        ...
        struct call<Fun()> : transform<call<Fun()>>
        {
            ...
            struct impl2 : transform_impl<Expr, State, Data>
            {
                ...
                result_type operator()(
                    ...
                    typename impl2::data_param) const
                {
                    return Fun()();
                }
            };
            ...
            struct impl2<Expr, State, Data, true> : Fun::template impl<Expr, State, Data>
            {
            };
            ...
            template<typename Expr, typename State, typename Data>
            struct impl : impl2<Expr, State, Data, detail::is_transform_<Fun>::value>
            {
            };
        };
        ...
        struct call<Fun(A0)> : transform<call<Fun(A0)>>
        {
            ...
            struct impl2 : transform_impl<Expr, State, Data>
            {
                ...
                result_type operator()(
                    ...
                    typename impl2::data_param d) const
                {
            ...
            template<typename Expr, typename State, typename Data>
            struct impl2<Expr, State, Data, true> : transform_impl<Expr, State, Data>
            {
                typedef typename when<_, A0>::template impl<Expr, State, Data>::result_type a0;
...
#include <boost/proto/transform/detail/call.hpp>
        ...
        ///
        template<typename Fun>
        struct is_callable<call<Fun>> : mpl::true_
        {
        };
