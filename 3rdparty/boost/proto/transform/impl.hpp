...
namespace boost {
    namespace proto {
        namespace envns_ {
            ...
            struct empty_env
            {
                ...
                struct lookup
                {
                    ...
                    typedef typename add_reference<typename add_const<OtherValue>::type>::type const_reference;
                };

                key_not_found operator[](detail::any) const { return key_not_found(); }
        ...
        struct is_env : mpl::false_
        {
        };

        template<typename T>
        struct is_env<T, typename T::proto_environment_> : mpl::true_
        {
        };

        template<typename T>
        struct is_env<T&, void> : is_env<T>
        {
        };
    ...
    #define BOOST_PROTO_TRANSFORM_(PrimitiveTransform, X)                                                              \
        ...
        BOOST_FORCEINLINE typename boost::proto::detail::apply_transform<transform_type(Expr&)>::result_type           \
        ...
        {                                                                                                              \
            ...
            return boost::proto::detail::apply_transform<transform_type(Expr&)>()(e, s, d);                            \
                                                                                                                       ...
                                                                                                                       \
        template<typename Expr>                                                                                        \
        BOOST_FORCEINLINE typename boost::proto::detail::apply_transform<transform_type(Expr const&)>::result_type     \
        ...
        BOOST_FORCEINLINE typename boost::proto::detail::apply_transform<transform_type(Expr&, State&)>::result_type   \
        ...
        {                                                                                                              \
            return boost::proto::detail::apply_transform<transform_type(Expr&, State const&, Data&)>()(e, s, d);       \
                                                                                                                       ...
                                                                                                                       \
        template<typename Expr, typename State, typename Data>                                                         \
        BOOST_FORCEINLINE typename boost::proto::detail::apply_transform<                                              \
            transform_type(Expr const&, State const&, Data&)>::result_type                                             \
    ...
    #define BOOST_PROTO_TRANSFORM_(PrimitiveTransform, X)                                                           \
        ...
        template<typename Expr, typename State, typename Data>                                                      \
        BOOST_FORCEINLINE typename boost::proto::detail::apply_transform<                                           \
            transform_type(Expr const&, State const&, Data const&)>::result_type                                    \
            operator()(Expr&& e, State&& s, Data&& d) const                                                         \
        {                                                                                                           \
            return boost::proto::detail::apply_transform<transform_type(Expr const&, State const&, Data const&)>()( \
                e,                                                                                                  \
                s,                                                                                                  \
                d);                                                                                                 \
        }                                                                                                           \
