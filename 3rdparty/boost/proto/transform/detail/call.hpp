    ...
    #define BOOST_PROTO_NTH_RESULT_TYPE(Z, M, DATA)                                                        \
        typedef typename when<_, BOOST_PP_CAT(A, M)>::template impl<Expr, State, Data> BOOST_PP_CAT(a, M); \
        typedef typename BOOST_PP_CAT(a, M)::result_type BOOST_PP_CAT(b, M);                               \
        /**/

    #define BOOST_PROTO_NTH_RESULT(Z, M, DATA) detail::as_lvalue(BOOST_PP_CAT(a, M)()(e, s, d)) /**/
...
//  LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (3, (1, BOOST_PROTO_MAX_ARITY, <boost / proto / transform / detail / call.hpp>))
    ...
    template<typename Expr, typename State, typename Data>
        ...
        call<typename detail::expand_pattern<
            ...
            detail::BOOST_PP_CAT(expand_pattern_rest_, BOOST_PP_DEC(N)) <
                Fun BOOST_PP_ENUM_TRAILING_PARAMS(BOOST_PP_DEC(N), A)>>::type > ::template impl<Expr, State, Data>
    {
    };
};
    #endif
