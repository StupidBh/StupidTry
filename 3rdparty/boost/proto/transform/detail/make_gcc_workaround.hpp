    ...
    transform<make<proto::expr<Tag, Args, Arity>(BOOST_PP_ENUM_PARAMS(N, A))>>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        {
            return proto::expr<Tag, Args, Arity>::make(BOOST_PP_ENUM(N, BOOST_PROTO_EXPR_MAKE_ARG, DATA));
        }
    };
};
    ...
    transform<make<proto::basic_expr<Tag, Args, Arity>(BOOST_PP_ENUM_PARAMS(N, A))>>
{
    ...
    struct impl : transform_impl<Expr, State, Data>
    {
        ...
        result_type
            operator()(typename impl::expr_param e, typename impl::state_param s, typename impl::data_param d) const
        {
            return proto::basic_expr<Tag, Args, Arity>::make(BOOST_PP_ENUM(N, BOOST_PROTO_EXPR_MAKE_ARG, DATA));
        }
    };
};
