...
struct when<Grammar, R()> : detail::when_impl<Grammar, R, R()>
{
};

template<typename Grammar, typename R, typename A0>
struct when<Grammar, R(A0)> : detail::when_impl<Grammar, R, R(A0)>
{
};
...
struct when<Grammar, R(A0, A1)> : detail::when_impl<Grammar, R, R(A0, A1)>
{
};
...
struct when<Grammar, R(A0, A1, A2)> : detail::when_impl<Grammar, R, R(A0, A1, A2)>
{
};
...
struct when<Grammar, R(A0, A1, A2, A3)> : detail::when_impl<Grammar, R, R(A0, A1, A2, A3)>
{
};
...
struct when<Grammar, R(A0, A1, A2, A3, A4)> : detail::when_impl<Grammar, R, R(A0, A1, A2, A3, A4)>
{
};
...
struct when<Grammar, R(A0, A1, A2, A3, A4, A5)> : detail::when_impl<Grammar, R, R(A0, A1, A2, A3, A4, A5)>
{
};
...
template<
    ...
    typename A5,
    typename A6>
struct when<Grammar, R(A0, A1, A2, A3, A4, A5, A6)> : detail::when_impl<Grammar, R, R(A0, A1, A2, A3, A4, A5, A6)>
{
};
