...
namespace boost {
    namespace proto {
        ...
        ///
        template<char I>
        struct char_ : integral_c<char, I>
        {
        };
        ...
        ///
        template<long I>
        struct long_ : integral_c<long, I>
        {
        };
        ...
        struct size_t : integral_c<std::size_t, I>
        {
        };
        ...
        ///
        template<typename T, T I>
        struct is_callable<integral_c<T, I>> : mpl::true_
        {
        };
        ...
        ///
        template<char I>
        struct is_callable<char_<I>> : mpl::true_
        {
        };
        ...
        ///
        template<int I>
        struct is_callable<int_<I>> : mpl::true_
        {
        };
        ...
        ///
        template<long I>
        struct is_callable<long_<I>> : mpl::true_
        {
        };
        ...
        ///
        template<std::size_t I>
        struct is_callable<size_t<I>> : mpl::true_
        {
        };
