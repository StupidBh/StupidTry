...
namespace boost {
    namespace property_tree {
        ...
        {
            static void insert(std::basic_ostream<Ch, Traits>& s, const E& e) { s << e; }
        ...
        {
            static void insert(std::basic_ostream<Ch, Traits>& s, Ch e) { s << e; }
        ...
        namespace detail {
            ...
            struct is_inexact_impl<true>
            {
                ...
                struct test
                {
                    typedef boost::integral_constant<bool, !std::numeric_limits<T>::is_exact> type;
                };
            };
            ...
            struct is_inexact
            {
                ...
                typedef typename is_inexact_impl<std::numeric_limits<decayed>::is_specialized>::BOOST_NESTED_TEMPLATE
                    test<decayed>::type type;
        ...
        {
            static void insert(std::basic_ostream<Ch, Traits>& s, signed char e) { s << (int)e; }
        ...
        {
            static void insert(std::basic_ostream<Ch, Traits>& s, unsigned char e) { s << (unsigned)e; }
