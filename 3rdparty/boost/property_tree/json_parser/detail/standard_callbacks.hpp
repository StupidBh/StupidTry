        ...
        namespace json_parser {
            namespace detail {
                ...
                namespace constants {
                    ...
                    template<>
                    inline const char* null_value()
                    {
                        return "null";
                    }

                    template<>
                    inline const wchar_t* null_value()
                    {
                        return L"null";
                    }
                    ...
                    template<>
                    inline const char* true_value()
                    {
                        return "true";
                    }

                    template<>
                    inline const wchar_t* true_value()
                    {
                        return L"true";
                    }
                    ...
                    template<>
                    inline const char* false_value()
                    {
                        return "false";
                    }

                    template<>
                    inline const wchar_t* false_value()
                    {
                        return L"false";
                    }
                }
                ...
                public:
                    ...
                    {
                        new_value() = b ? constants::true_value<char_type>() : constants::false_value<char_type>();
                    }
                    ...
                    void on_begin_number() { new_value(); }

                    void on_digit(char_type d) { current_value() += d; }

                    void on_end_number() {}

                    void on_begin_string() { new_value(); }
                    ...
                    void on_code_unit(char_type c) { current_value() += c; }
                ...
                protected:
                    bool is_key() const { return stack.back().k == key; }
                ...
                private:
                    ...
                    Ptree& new_tree()
                    {
                        ...
                        case object: BOOST_ASSERT(false); // must start with string, i.e. call new_value
                        case key   : {
                    ...
                    string& new_value()
                    {
                        ...
                        layer& l = stack.back();
                        switch (l.k) {
                        case leaf: stack.pop_back(); return new_value();
                        case object:
                            l.k = key;
                            key_buffer.clear();
                            return key_buffer;
                        default: return new_tree().data();
                        }
                    }
                };
