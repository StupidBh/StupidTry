...
namespace boost {
    namespace parallel {
        namespace detail {
            ...
            template<typename T, typename U>
            inline untracked_pair<T, U> make_untracked_pair(const T& t, const U& u)
            {
...
namespace boost {
    namespace mpi {
        ...
        template<typename T, typename U>
        struct is_mpi_datatype<boost::parallel::detail::untracked_pair<T, U>> : is_mpi_datatype<std::pair<T, U>>
        {
        };
...
namespace boost {
    namespace serialization {
        ...
        template<typename T, typename U>
        struct is_bitwise_serializable<boost::parallel::detail::untracked_pair<T, U>> :
            is_bitwise_serializable<std::pair<T, U>>
        {
        };

        template<typename T, typename U>
        struct implementation_level<boost::parallel::detail::untracked_pair<T, U>> : mpl::int_<object_serializable>
        {
        };

        template<typename T, typename U>
        struct tracking_level<boost::parallel::detail::untracked_pair<T, U>> : mpl::int_<track_never>
        {
        };
