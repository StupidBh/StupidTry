...
namespace boost {
    ...
    template<class PA>
    struct is_property_map : boost::mpl::and_<has_key_type<PA>, has_value_type<PA>, has_reference<PA>, has_category<PA>>
    {
    };
    ...
    struct property_traits :
        boost::mpl::if_<is_property_map<PA>, default_property_traits<PA>, null_property_traits>::type
    {
    };
...
namespace boost {
    ...
    template<typename K, typename V>
    void
        put(const writable_property_map_archetype<K, V>&,
    ...
    struct LvaluePropertyMapConcept
    {
        ...
        void constraints()
        {
            ...
            BOOST_MPL_ASSERT((
                boost::mpl::or_<boost::is_same<const value_type&, reference>, boost::is_same<value_type&, reference>>));
    ...
    template<typename KeyArchetype, typename ValueArchetype>
    struct lvalue_property_map_archetype : public readable_property_map_archetype<KeyArchetype, ValueArchetype>
    {
        typedef KeyArchetype key_type;
        typedef ValueArchetype value_type;
        ...
        const value_type& operator[](const key_type&) const { return static_object<value_type>::get(); }
    };
        ...
        public writable_property_map_archetype<KeyArchetype, ValueArchetype>
    {
        ...
        value_type& operator[](const key_type&) const { return static_object<value_type>::get(); }
    };
    ...
    class iterator_property_map :
        public boost::put_get_helper<R, iterator_property_map<RandomAccessIterator, IndexMap, T, R>> {
    public:
    ...
    inline iterator_property_map<
        ...
        typename std::iterator_traits<RAIter>::reference> make_iterator_property_map(RAIter iter, ID id)
    {
    ...
    inline iterator_property_map<RAIter, ID, Value, Value&> make_iterator_property_map(RAIter iter, ID id, Value)
    {
        BOOST_CONCEPT_ASSERT((RandomAccessIteratorConcept<RAIter>));
    ...
    class safe_iterator_property_map :
        public boost::put_get_helper<R, safe_iterator_property_map<RandomAccessIterator, IndexMap, T, R>> {
    public:
        typedef typename property_traits<IndexMap>::key_type key_type;
        typedef T value_type;
        typedef R reference;
    ...
    public:
        ...
        reference operator[](const key_type& k) const { return (*m_c)[k]; }
    ...
    public:
        ...
        reference operator[](const key_type& k) const { return m_c->find(k)->second; }
    ...
    class static_property_map : public boost::put_get_helper<ValueType, static_property_map<ValueType>> {
        ValueType value;
    ...
    template<typename T>
    struct typed_identity_property_map : public boost::put_get_helper<T, typed_identity_property_map<T>>
    {
        typedef T key_type;
        typedef T value_type;
        typedef T reference;
    ...
    class dummy_property_map : public boost::put_get_helper<detail::dummy_pmap_reference, dummy_property_map> {
    public:
        ...
        inline dummy_property_map() :
            c(0)
        {
        }

        inline dummy_property_map(value_type cc) :
            c(cc)
        {
        }
        ...
        inline reference operator[](Vertex) const
        {
            return reference();
        }
    ...
    public:
        explicit property_map_function(const PropMap& pm) :
            pm(pm)
        {
        }
