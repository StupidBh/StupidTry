...
namespace boost {
    ...
    namespace detail {
        ...
        public:
            ...
            lvalue_pmap_iter(Iterator const& it, LvaluePropertyMap m) :
                super_t(it),
                m_map(m)
            {
            }
        ...
        private:
            typename super_t::reference dereference() const { return m_map[*(this->base_reference())]; }
        ...
        class readable_pmap_iter :
            public iterator_adaptor<
                readable_pmap_iter<Iterator, ReadablePropertyMap>,
                Iterator,
        ...
        public:
            ...
            readable_pmap_iter(Iterator const& it, ReadablePropertyMap m) :
                super_t(it),
                m_map(m)
            {
            }
        ...
        private:
            typename super_t::reference dereference() const { return get(m_map, *(this->base_reference())); }
    ...
    struct property_map_iterator_generator :
        mpl::if_<
            is_same<typename property_traits<PropertyMap>::category, lvalue_property_map_tag>,
    ...
    {
        typedef typename property_map_iterator_generator<PropertyMap, Iterator>::type Iter;
