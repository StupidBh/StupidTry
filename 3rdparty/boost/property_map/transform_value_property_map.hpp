...
namespace boost {
    ...
    template<
        typename Func,
        typename PM,
        typename Ret = typename boost::result_of<const Func(typename property_traits<PM>::reference)>::type>
    ...
    public:
        ...
        typedef typename boost::mpl::if_<
            boost::mpl::and_<boost::is_reference<Ret>, boost::mpl::not_<boost::is_const<Ret>>>,
        ...
        reference operator[](const key_type& k) const { return f(get(pm, k)); }
