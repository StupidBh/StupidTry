...
#include <boost/type_index/detail/config.hpp>
    ...
    #include BOOST_TYPE_INDEX_USER_TYPEINDEX
        ...
        #pragma detect_mismatch(      \
            ...
            "user defined type_index class is used: " BOOST_STRINGIZE(BOOST_TYPE_INDEX_USER_TYPEINDEX))
    #endif
...
namespace boost {
    namespace typeindex {
        ...
        /// for `boost::typeindex::ctti_type_index::type_id<int>().pretty_name()` and \code "short>::n() [T = short"
        /// \endcode for `boost::typeindex::ctti_type_index::type_id<short>().pretty_name()`.
        ///
