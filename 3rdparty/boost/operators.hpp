...
namespace boost {
    namespace operators_impl {
        ...
        struct equality_comparable2 : B
        {
            ...
            friend BOOST_OPERATORS_CONSTEXPR bool operator!=(const U& y, const T& x)
            {
                return !static_cast<bool>(x == y);
            }

            friend BOOST_OPERATORS_CONSTEXPR bool operator!=(const T& y, const U& x)
            {
                return !static_cast<bool>(y == x);
            }
        };
    ...
    #undef BOOST_OPERATOR2_LEFT
        ...
        {
            P operator->() const { return ::boost::addressof(*static_cast<const T&>(*this)); }
        };
    ...
    #define BOOST_OPERATOR_TEMPLATE(template_name)                                                  \
        ...
        struct template_name;                                                                       \
                                                                                                    \
        template<class T, class U, class B>                                                         \
            struct template_name<T, U, B, operators_detail::false_t> : template_name##2 < T,        \
            U, B >                                                                                  \
        {                                                                                           \
        };                                                                                          \
                                                                                                    \
        ...
        {                                                                                           \
                                                                                                    ...
                                                                                                    \
        template<class T, class B>                                                                  \
            struct template_name<T, T, B, operators_detail::false_t> : template_name##1 < T,        \
            B >                                                                                     \
        {                                                                                           \
        };                                                                                          \
                                                                                                    \
    ...
    #undef BOOST_OPERATOR_TEMPLATE1
        ...
        struct input_iterator_helper : input_iteratable<T, P, iterator_helper<std::input_iterator_tag, V, D, P, R>>
        {
        };
