    ...
    namespace wave {
        ...
        namespace util {
            ...
            inline char const* get_severity(int level)
            {
                ...
                BOOST_ASSERT(severity_remark <= level && level <= last_severity_code);
        ...
        class BOOST_SYMBOL_VISIBLE cpp_exception : public std::exception {
        public:
        ...
        ///////////////////////////////////////////////////////////////////////////////
        // preprocessor error
        class BOOST_SYMBOL_VISIBLE preprocess_exception : public cpp_exception {
        public:
            enum error_code
            {
                no_error = 0,
            ...
            char const* what() const throw() BOOST_OVERRIDE { return "boost::wave::preprocess_exception"; }

            char const* description() const throw() BOOST_OVERRIDE { return buffer; }

            int get_severity() const throw() BOOST_OVERRIDE { return severity_level(code); }

            int get_errorcode() const throw() BOOST_OVERRIDE { return code; }

            char const* get_related_name() const throw() BOOST_OVERRIDE { return "<unknown>"; }
            ...
            bool is_recoverable() const throw() BOOST_OVERRIDE
            {
                ...
                case preprocess_exception::pragma_message_directive           : return true;
                ...
                case preprocess_exception::could_not_open_output_file : break;
                }
                return false;
            }
            ...
            static char const* severity_text(int code) { return util::get_severity(severity_level(code)); }
        ...
        class BOOST_SYMBOL_VISIBLE macro_handling_exception : public preprocess_exception {
        public:
            ...
            char const* what() const throw() BOOST_OVERRIDE { return "boost::wave::macro_handling_exception"; }

            char const* get_related_name() const throw() BOOST_OVERRIDE { return name; }
