...
namespace boost {
    namespace wave {
        ...
        {
            return static_cast<token_id>(static_cast<std::uint32_t>(a) & static_cast<std::uint32_t>(b));
        }
        ...
        #define ID_FROM_TOKEN(tok) \
            boost::wave::token_id((tok) & ~(boost::wave::TokenTypeMask | boost::wave::PPTokenFlag)) /**/

        #undef BASEID_FROM_TOKEN
        #define BASEID_FROM_TOKEN(tok) \
            boost::wave::token_id((tok) & ~(boost::wave::ExtTokenTypeMask | boost::wave::PPTokenFlag)) /**/
