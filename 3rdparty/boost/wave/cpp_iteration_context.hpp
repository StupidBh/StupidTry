...
namespace boost {
    namespace wave {
        namespace iteration_context_policies {
            ...
            struct load_file_to_string
            {
                ...
                public:
                    ...
                    static void
                        init_iterators(IterContextT& iter_ctx, PositionT const& act_pos, language_support language)
                    {
        ...
        struct iteration_context :
            ...
            public InputPolicyT::template inner<iteration_context<ContextT, IteratorT, InputPolicyT>>
        {
