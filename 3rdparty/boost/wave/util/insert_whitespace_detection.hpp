    ...
    namespace wave {
        namespace util {
            ...
            namespace impl {
                ...
                template<typename StringT>
                inline bool
                    handle_identifier(boost::wave::token_id prev, boost::wave::token_id before, StringT const& value)
                {
                    ...
                    case T_NOTEQUAL_ALT:
                    case T_FIXEDPOINTLIT           : return true;
                    ...
                    case T_UNKNOWN_UNIVERSALCHAR: return would_form_universal_char(value);
                ...
                // T_INTLIT
                inline bool handle_intlit(boost::wave::token_id prev, boost::wave::token_id /*before*/)
                {
                    using namespace boost::wave;
                    switch (prev) {
                    case T_IDENTIFIER:
                ...
                // T_FLOATLIT
                inline bool handle_floatlit(boost::wave::token_id prev, boost::wave::token_id /*before*/)
                {
                    using namespace boost::wave;
                    switch (prev) {
                    case T_IDENTIFIER:
                ...
                // <% T_LEFTBRACE
                inline bool handle_alt_leftbrace(boost::wave::token_id prev, boost::wave::token_id /*before*/)
                {
                    using namespace boost::wave;
                    switch (prev) {
                    case T_LESS:      // <<%
                ...
                // <: T_LEFTBRACKET
                inline bool handle_alt_leftbracket(boost::wave::token_id prev, boost::wave::token_id /*before*/)
                {
                    using namespace boost::wave;
                    switch (prev) {
                    case T_LESS:      // <<:
                ...
                // T_FIXEDPOINTLIT
                inline bool handle_fixedpointlit(boost::wave::token_id prev, boost::wave::token_id /*before*/)
                {
                    using namespace boost::wave;
                    switch (prev) {
                    case T_IDENTIFIER:
                ...
                // T_QUESTION_MARK
                inline bool handle_questionmark(boost::wave::token_id prev, boost::wave::token_id /*before*/)
                {
                    using namespace boost::wave;
                    switch (prev) {
            ...
            public:
                insert_whitespace_detection(bool insert_whitespace_ = true) :
                    ...
                    prev(boost::wave::T_EOF),
                    beforeprev(boost::wave::T_EOF)
                {
                }
                ...
                bool must_insert(boost::wave::token_id current, StringT const& value)
                {
                    ...
                    switch (current) {
                    case T_NONREPLACABLE_IDENTIFIER:
                    case T_IDENTIFIER              : return impl::handle_identifier(prev, beforeprev, value);
                    case T_PP_NUMBER               :
                    case T_INTLIT                  : return impl::handle_intlit(prev, beforeprev);
                    ...
                    case T_COLON:
                        ...
                        case T_RIGHTBRACKET:
                        case T_LEFTBRACE:
                        case T_RIGHTBRACE  : return false; // no insertion between parens/brackets/braces
                    ...
                    case T_RIGHTBRACE:
                        ...
                        case T_SEMICOLON:
                        case T_COMMA:
                        case T_COLON       : return false; // no insertion between parens/brackets/braces
                    ...
                    case T_NOTEQUAL_ALT:
                        ...
                        case T_IDENTIFIER:
                            if (T_NONREPLACABLE_IDENTIFIER == prev || IS_CATEGORY(prev, KeywordTokenType)) {
                                return true;
                            }
                            break;
