        ...
        namespace util {
            ...
            struct macro_definition
            {
                ...
                macro_definition(TokenT const& token_, bool has_parameters, bool is_predefined_, long uid_) :
                    macroname(token_),
                    uid(uid_),
                    is_functionlike(has_parameters),
                    ...
                    if (!replaced_parameters) {
                        ...
                        for (/**/; it != end; ++it) {
                            ...
                            if (T_IDENTIFIER == id || IS_CATEGORY(id, KeywordTokenType) ||
                                ...
                                for (typename parameter_container_type::size_type i = 0; cit != cend; ++cit, ++i) {
                                    if ((*it).get_value() == (*cit).get_value()) {
                                        ...
                                        need_variadics(ctx.get_language()) && T_ELLIPSIS == token_id(*cit) &&
                                        ...
                                        need_va_opt(ctx.get_language()) && T_ELLIPSIS == token_id(*cit) &&
