    ...
    namespace wave {
        namespace util {
            ...
            public:
                ...
                explicit file_position(string_type const& file_, std::size_t line_ = 1, std::size_t column_ = 1) :
                    file(file_),
                    line(line_),
                    column(column_)
                {
            ...
            {
                return lhs.get_column() == rhs.get_column() && lhs.get_line() == rhs.get_line() &&
            ...
            struct position_iterator : boost::spirit::classic::position_iterator<IteratorT, PositionT>
            {
                ...
                position_iterator(IteratorT const& begin, IteratorT const& end, PositionT const& pos) :
    ...
    namespace spirit {
        namespace classic {
            ...
            public:
                ...
                void set_tab_chars(unsigned int chars) { m_CharsPerTab = chars; }

                void next_char(boost::wave::util::file_position_type& pos) { pos.set_column(pos.get_column() + 1); }
