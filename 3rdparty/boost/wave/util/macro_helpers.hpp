        ...
        namespace util {
            ...
            namespace impl {
                    ...
                    as_stringlit(ContainerT const& token_sequence, PositionT const& pos)
                {
                    ...
                    for (typename ContainerT::const_iterator it = token_sequence.begin(); it != end; ++it) {
                    ...
                    boost::wave::cpplexer::impl::validate_literal(
                        result,
                        pos.get_line(),
                        pos.get_column(),
                        pos.get_file());
                ...
                // return the string representation of a token sequence
                template<typename ContainerT, typename PositionT>
                inline typename ContainerT::value_type::string_type as_stringlit(
                    std::vector<ContainerT> const& arguments,
                    typename std::vector<ContainerT>::size_type i,
                    PositionT const& pos)
                {
                    using namespace boost::wave;
                    typedef typename ContainerT::value_type::string_type string_type;
                    ...
                    for (/**/; i < arguments.size(); ++i) {
                        ...
                        for (typename ContainerT::const_iterator it = arguments[i].begin(); it != end; ++it) {
                            token_id id = token_id(*it);
                ...
                bool find_va_opt_args(
                    ...
                    MDefIterT mdend)
                {
                    if ((std::distance(mdit, mdend) < 3) || (T_LEFTPAREN != next_token<MDefIterT>::peek(mdit, mdend))) {
                        return false;
                    }
                    ...
                    for (; (mdit != mdend) && !((scope == 1) && (T_RIGHTPAREN == token_id(*mdit))); ++mdit) {
