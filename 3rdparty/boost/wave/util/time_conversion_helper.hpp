...
namespace boost {
    ...
    #define TRACE_CPP_TIME_CONVERSION (BOOST_SPIRIT_DEBUG_FLAGS_CPP & BOOST_SPIRIT_DEBUG_FLAGS_TIME_CONVERSION) /**/
                ...
                public:
                    time_conversion_grammar() :
                        fYearIsCorrected(false)
                    {
                        using namespace std; // some systems have memset in std
                        memset(&time_stamp, 0, sizeof(tm));
                        BOOST_SPIRIT_DEBUG_TRACE_RULE_NAME(*this, "time_conversion_grammar", TRACE_CPP_TIME_CONVERSION);
                    }
                    ...
                    struct definition
                    {
                        definition(time_conversion_grammar const& self)
                        {
                            ...
                            char const* m[] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun",
                        ...
                        boost::spirit::classic::rule<ScannerT> const& start() const { return time_rule; }
                    };
                ...
                public:
                    time_conversion_helper(char const* act_time) :
                        compile_time(0)
                    {
