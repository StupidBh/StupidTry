...
=============================================================================*/
    ...
    //
        ...
        #if BOOST_WORKAROUND(__MWERKS__, < 0x3200) || (defined(__DECCXX) && defined(__alpha)) || \
    ...
    #endif
    #if BOOST_WAVE_DUMP_CONDITIONAL_EXPRESSIONS != 0 && !defined(BOOST_WAVE_DUMP_CONDITIONAL_EXPRESSIONS_OUT)
...
namespace boost {
    namespace wave {
    #if defined(BOOST_HAS_LONG_LONG) && BOOST_WAVE_SUPPORT_LONGLONG_INTEGER_LITERALS != 0
...
//  The default is to use std::numeric_limits<wchar_t>::is_signed.
    ...
    //  Wave needs at least 4 parameters for phoenix actors
        ...
        #error \
            "Boost.Wave: the constant PHOENIX_LIMIT must be at least defined to 6" \
" to compile the library."
    #endif

    ///////////////////////////////////////////////////////////////////////////////
    //  Set up dll import/export options
    #if (defined(BOOST_WAVE_DYN_LINK) || defined(BOOST_ALL_DYN_LINK)) && !defined(BOOST_WAVE_STATIC_LINK)
    ...
    //  Auto library naming
        ...
        #if !defined(BOOST_WAVE_SOURCE) && !defined(BOOST_ALL_NO_LIB) && !defined(BOOST_WAVE_NO_LIB)
...
///////////////////////////////////////////////////////////////////////////////
        ...
        defined(BOOST_NO_CXX11_HDR_THREAD) || defined(BOOST_NO_CXX11_HDR_MUTEX) ||                 \
        defined(BOOST_NO_CXX11_HDR_REGEX) || defined(BOOST_NO_CXX11_CONSTEXPR)
    ...
    //
    #if defined(BOOST_WAVE_USE_DEPRECIATED_PREPROCESSING_HOOKS) && BOOST_WAVE_USE_DEPRECIATED_PREPROCESSING_HOOKS != 0
