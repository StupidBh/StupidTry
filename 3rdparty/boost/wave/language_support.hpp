...
namespace boost {
    namespace wave {
        ...
        enum language_support
        {
            ...
            support_cpp0x =
                support_option_variadics | support_option_long_long | support_option_no_newline_at_end_of_file | 0x10,
    ...
    ///////////////////////////////////////////////////////////////////////////////
        ...
        inline bool need_cpp0x(language_support language)
        {
    ...
    ///////////////////////////////////////////////////////////////////////////////
        ...
        inline bool need_cpp2a(language_support language)
        {
    ...
    #define BOOST_WAVE_ENABLE_OPTION(option)                                                   \
        inline language_support enable_##option(language_support language, bool enable = true) \
        {                                                                                      \
            if (enable)                                                                        \
