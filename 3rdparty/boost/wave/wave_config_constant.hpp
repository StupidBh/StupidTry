...
=============================================================================*/
    ...
    #define BOOST_WAVE_CONFIG                                                                       \
        (BOOST_WAVE_SUPPORT_VARIADICS_PLACEMARKERS_CONFIG | BOOST_WAVE_SUPPORT_PRAGMA_ONCE_CONFIG | \
         BOOST_WAVE_SUPPORT_MS_EXTENSIONS_CONFIG | BOOST_WAVE_PREPROCESS_PRAGMA_BODY_CONFIG |       \
         BOOST_WAVE_USE_STRICT_LEXER_CONFIG | BOOST_WAVE_SUPPORT_IMPORT_KEYWORD_CONFIG) /**/
...
namespace boost {
    namespace wave {
        ...
        BOOST_WAVE_DECL bool
            test_configuration(unsigned int config, char const* pragma_keyword, char const* string_type);
