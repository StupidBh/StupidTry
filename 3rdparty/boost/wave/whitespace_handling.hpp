...
namespace boost {
    namespace wave {
        namespace context_policies {
            ...
            protected:
                bool skip_cppcomment(boost::wave::token_id id) { return !preserve_comments && T_CPPCOMMENT == id; }
            ...
            template<typename TokenT>
            inline eat_whitespace<TokenT>::eat_whitespace() :
            ...
            template<typename ContextT>
            inline bool
                eat_whitespace<TokenT>::may_skip_whitespace(ContextT const& ctx, TokenT& token, bool& skipped_newline)
            {
            ...
            template<typename TokenT>
            template<typename ContextT>
            inline bool eat_whitespace<TokenT>::may_skip_whitespace(
                ContextT const& ctx,
                TokenT& token,
                bool preserve_comments_,
                bool preserve_bol_whitespace_,
            ...
            template<typename TokenT>
            inline bool eat_whitespace<TokenT>::bol_whitespace(TokenT& token, bool& skipped_newline)
            {
                using namespace boost::wave;
