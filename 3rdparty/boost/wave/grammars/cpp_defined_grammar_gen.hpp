    ...
    namespace wave {
        namespace grammars {
            ...
            struct BOOST_WAVE_DECL defined_grammar_gen
            {
                ...
                static boost::spirit::classic::parse_info<iterator1_type> parse_operator_defined(
                    iterator1_type const& first,
                    iterator1_type const& last,
                    token_sequence_type& found_qualified_name);

                static boost::spirit::classic::parse_info<iterator2_type> parse_operator_defined(
