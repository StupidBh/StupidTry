...
namespace boost {
    ...
    #define TRACE_PREDEF_MACROS_GRAMMAR \
        bool(BOOST_SPIRIT_DEBUG_FLAGS_CPP & BOOST_SPIRIT_DEBUG_FLAGS_PREDEF_MACROS_GRAMMAR) /**/
            ...
            struct predefined_macros_grammar : public boost::spirit::classic::grammar<predefined_macros_grammar>
            {
                ...
                struct definition
                {
                    ...
                    definition(predefined_macros_grammar const& /*self*/)
                    {
                        ...
                        plain_define = (ch_p(T_IDENTIFIER) | pattern_p(KeywordTokenType, TokenTypeMask | PPTokenFlag) |
                                        pattern_p(
                                       ...
                                       !macro_parameters >> !macro_definition;
                        ...
                        macro_parameters = confix_p(
                            ...
                            !list_p(
                                ...
                                no_node_d[*ch_p(T_SPACE) >> ch_p(T_COMMA) >> *ch_p(T_SPACE)]),
                            no_node_d[*ch_p(T_SPACE) >> ch_p(T_RIGHTPAREN)]);

                        // macro body (anything left until eol)
                        macro_definition = no_node_d[ch_p(T_ASSIGN)] >> *anychar_p;
                    ...
                    rule_type const& start() const { return plain_define; }
                };
    ...
    #undef TRACE_PREDEF_MACROS_GRAMMAR
        ...
        #define BOOST_WAVE_PREDEF_MACROS_GRAMMAR_GEN_INLINE inline
            ...
            BOOST_WAVE_PREDEF_MACROS_GRAMMAR_GEN_INLINE boost::spirit::classic::tree_parse_info<LexIteratorT>
