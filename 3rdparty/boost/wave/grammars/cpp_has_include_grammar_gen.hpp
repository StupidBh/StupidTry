        ...
        namespace grammars {
            ...
            struct BOOST_WAVE_DECL has_include_grammar_gen
            {
                ...
                typedef boost::wave::util::
                    unput_queue_iterator<typename token_sequence_type::iterator, token_type, token_sequence_type>
                        iterator1_type;

                typedef boost::wave::util::unput_queue_iterator<LexIteratorT, token_type, token_sequence_type>
                    iterator2_type;

                //  parse the operator has_include and return the found qualified name
                static boost::spirit::classic::parse_info<iterator1_type> parse_operator_has_include(
                ...
                static boost::spirit::classic::parse_info<iterator2_type> parse_operator_has_include(
