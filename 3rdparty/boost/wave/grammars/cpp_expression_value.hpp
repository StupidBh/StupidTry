...
namespace boost {
            ...
            namespace closures {
                ...
                public:
                    ...
                    closure_value& operator+=(closure_value const& rhs)
                    {
                        ...
                        case is_bool: value.i = value.b + as_bool(rhs); type = is_int;
                        }
                    ...
                    closure_value& operator*=(closure_value const& rhs)
                    {
                        ...
                        case is_int:
                            ...
                            case is_int : {
                                ...
                                bool ovflw = (value.i > 0) ? ((rhs.value.i > 0) ? (value.i > (mx / rhs.value.i))
                                                                                : (rhs.value.i < (mn / value.i)))
                                                           : ((rhs.value.i > 0)
                                                                  ? (value.i < (mn / rhs.value.i))
                            ...
                            case is_uint: {
                                ...
                                if (0 != value.ui && 0 != rhs.value.ui &&
                                    (result / value.ui != rhs.value.ui || result / rhs.value.ui != value.ui)) {
                                    valid = error_integer_overflow;
                                }
                                else {
                                    value.ui = result;
                        ...
                        case is_uint: {
                            ...
                            if (0 != value.ui && 0 != rhs_val &&
                                (result / value.ui != rhs_val || result / rhs_val != value.ui)) {
                                valid = error_integer_overflow;
                            }
                            else {
                                value.ui = result;
                        ...
                        case is_bool:
                            ...
                            case is_bool: value.b = 0 != ((value.b ? 1 : 0) * (rhs.value.b ? 1 : 0)); break;
                            }
                        }
                        valid = (value_error)(valid | rhs.valid);
                        return *this;
                    ...
                    closure_value& operator/=(closure_value const& rhs)
                    {
                        ...
                        case is_int:
                            ...
                            case is_int:
                                if (as_long(rhs) != 0) {
                                    if (std::numeric_limits<int_literal_type>::min() == value.i && -1 == rhs.value.i) {
                    ...
                    friend closure_value operator-(closure_value const& rhs)
                    {
                        switch (rhs.type) {
                        case is_int: {
                    ...
                    // comparison
                    friend closure_value operator==(closure_value const& lhs, closure_value const& rhs)
                    {
                        bool cmp = false;
                        switch (lhs.type) {
                        case is_int:
                    ...
                    // handle the ?: operator
                    closure_value& handle_questionmark(closure_value const& cond, closure_value const& val2)
                    {
                        switch (type) {
                        case is_int:
                            switch (val2.type) {
    ...
    #if defined(BOOST_SPIRIT_DEBUG)
                    friend std::ostream& operator<<(std::ostream& o, closure_value const& val)
                    {
                        switch (val.type) {
