...
namespace boost {
    ...
    #define TRACE_CPP_DEFINED_GRAMMAR bool(BOOST_SPIRIT_DEBUG_FLAGS_CPP & BOOST_SPIRIT_DEBUG_FLAGS_DEFINED_GRAMMAR) /**/

            template<typename ContainerT>
            struct defined_grammar : public boost::spirit::classic::grammar<defined_grammar<ContainerT>>
            {
                defined_grammar(ContainerT& result_seq_) :
                    result_seq(result_seq_)
                {
                    BOOST_SPIRIT_DEBUG_TRACE_GRAMMAR_NAME(*this, "defined_grammar", TRACE_CPP_DEFINED_GRAMMAR);
                }
                ...
                struct definition
                {
                    ...
                    definition(defined_grammar const& self)
                    {
                        ...
                        defined_op               // parens not required, see C++ standard 16.1.1
                            = ch_p(T_IDENTIFIER) // token contains 'defined'
                              >> ((ch_p(T_LEFTPAREN) >> identifier >> ch_p(T_RIGHTPAREN)) | identifier);

                        identifier = ch_p(T_IDENTIFIER)[spirit_append_actor(self.result_seq)] |
                                     pattern_p(
                                         KeywordTokenType,
                                         TokenTypeMask | PPTokenFlag)[spirit_append_actor(self.result_seq)] |
                                     pattern_p(
                                         OperatorTokenType | AltExtTokenType,
                                         ExtTokenTypeMask | PPTokenFlag)[spirit_append_actor(self.result_seq)] |
                                     pattern_p(
                    ...
                    rule_t const& start() const { return defined_op; }
                };
    ...
    #undef TRACE_CPP_DEFINED_GRAMMAR
        ...
        #define BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE inline
            ...
            BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE
                boost::spirit::classic::parse_info<typename defined_grammar_gen<LexIteratorT>::iterator1_type>
            ...
            template<typename LexIteratorT>
            BOOST_WAVE_DEFINED_GRAMMAR_GEN_INLINE
                boost::spirit::classic::parse_info<typename defined_grammar_gen<LexIteratorT>::iterator2_type>
                defined_grammar_gen<LexIteratorT>::parse_operator_defined(
