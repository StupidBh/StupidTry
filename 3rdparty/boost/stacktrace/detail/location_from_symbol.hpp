        ...
        namespace detail {
            ...
            int dladdr(const void* address_raw, Dl_info* info) noexcept
            {
                ...
                try {
                    ...
                    pld_info_storage.resize((dl_buff_size + sizeof(struct ld_info) - 1) / sizeof(struct ld_info));
    ...
    namespace stacktrace {
        namespace detail {
            ...
            public:
                ...
                bool empty() const noexcept { return !dli_.dli_fname; }

                const char* name() const noexcept { return dli_.dli_fname; }
            };
            ...
            public:
                ...
                bool empty() const noexcept { return file_name_[0] == '\0'; }

                const char* name() const noexcept { return file_name_; }
            };
            ...
            public:
                ...
                const char* name() const noexcept { return file_name_[0] ? file_name_ : 0; }
            };
#endif
