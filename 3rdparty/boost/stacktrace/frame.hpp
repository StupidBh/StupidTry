...
extern "C"
{
    ...
    #endif
    void* boost_stacktrace_impl_return_nullptr()
    {
        return nullptr;
    }
}
...
namespace boost {
    namespace stacktrace {
        ...
        /// Comparison operators that provide platform dependant ordering and have O(1) complexity; are
        /// Async-Handler-Safe.
        constexpr inline bool operator<(const frame& lhs, const frame& rhs) noexcept
        {
