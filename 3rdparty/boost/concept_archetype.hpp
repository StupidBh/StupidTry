...
namespace boost {
    ...
    public:
        ...
        default_constructible_archetype(detail::dummy_constructor x) :
            Base(x)
        {
        }
    };
    ...
    public:
        assignable_archetype& operator=(const assignable_archetype&) { return *this; }

        assignable_archetype(detail::dummy_constructor x) :
            Base(x)
        {
        }
    };
    ...
    public:
        ...
        sgi_assignable_archetype& operator=(const sgi_assignable_archetype&) { return *this; }

        sgi_assignable_archetype(const detail::dummy_constructor& x) :
            Base(x)
        {
        }
    };
    ...
    private:
        ...
        convertible_to_archetype& operator=(const convertible_to_archetype&) { return *this; }
    ...
    private:
        ...
        convertible_from_archetype& operator=(const convertible_from_archetype&) { return *this; }
    ...
    public:
        ...
        convertible_from_archetype& operator=(const T&) { return *this; }
    };
    ...
    public:
        equality_comparable_archetype(detail::dummy_constructor x) :
            Base(x)
        {
        }
    };
    ...
    boolean_archetype operator==(
        const equality_comparable2_first_archetype<Base1>&,
    ...
    public:
        less_than_comparable_archetype(detail::dummy_constructor x) :
            Base(x)
        {
        }
    };
    ...
    template<class Base>
    boolean_archetype
        operator<(const less_than_comparable_archetype<Base>&, const less_than_comparable_archetype<Base>&)
    {
        return boolean_archetype(static_object<detail::dummy_constructor>::get());
    }
    ...
    public:
        comparable_archetype(detail::dummy_constructor x) :
            Base(x)
        {
        }
    };
...
#define BOOST_DEFINE_BINARY_PREDICATE_ARCHETYPE(OP, NAME)                          \
    ...
    public:                                                                        \
        NAME##_first_archetype(detail::dummy_constructor x) :                      \
            Base(x)                                                                \
        {                                                                          \
        }                                                                          \
    };                                                                             \
    ...
    public:                                                                        \
        NAME##_second_archetype(detail::dummy_constructor x) :                     \
            Base(x)                                                                \
        {                                                                          \
        }                                                                          \
    };                                                                             \
    ...
    boolean_archetype operator OP(                                                 \
        const NAME##_first_archetype<BaseFirst, Tag>&,                             \
...
#define BOOST_DEFINE_OPERATOR_ARCHETYPE(OP, NAME)                                                    \
    ...
    public:                                                                                          \
        NAME##_archetype(detail::dummy_constructor x) :                                              \
            Base(x)                                                                                  \
        {                                                                                            \
        }                                                                                            \
    ...
    template<class Base>                                                                             \
    NAME##_archetype<Base> operator OP(const NAME##_archetype<Base>&, const NAME##_archetype<Base>&) \
    {                                                                                                \
        return NAME##_archetype<Base>(static_object<detail::dummy_constructor>::get());              \
    }
...
#define BOOST_DEFINE_BINARY_OPERATOR_ARCHETYPE(OP, NAME)                \
    ...
    Return operator OP(                                                 \
        const NAME##_first_archetype<Return, BaseFirst>&,               \
    ...
    public:
        const Return& operator()() { return static_object<Return>::get(); }
    };
    ...
    public:
        ...
        const Return& operator()(const Arg&) const { return static_object<Return>::get(); }
    };
    ...
    public:
        ...
        const Return& operator()(const Arg1&, const Arg2&) const { return static_object<Return>::get(); }
    };
    ...
    public:
        ...
        reference operator[](difference_type) const { return static_object<T>::get(); }

        self& operator+=(difference_type) { return *this; }

        self& operator-=(difference_type) { return *this; }

        difference_type operator-(const self&) const { return difference_type(); }
    ...
    template<class T>
    random_access_iterator_archetype<T> operator+(
        typename random_access_iterator_archetype<T>::difference_type,
    ...
    template<class T>
    mutable_random_access_iterator_archetype<T> operator+(
