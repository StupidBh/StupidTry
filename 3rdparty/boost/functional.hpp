...
namespace boost {
    ...
    public:
        ...
        bool operator()(
            typename call_traits<typename binary_traits<Predicate>::first_argument_type>::param_type x,
    ...
    public:
        ...
        typename binary_traits<Operation>::result_type operator()(
            typename call_traits<typename binary_traits<Operation>::second_argument_type>::param_type x) const
        {
            return op(value, x);
        }
    ...
    public:
        ...
        S operator()(T* p) const { return (p->*ptr)(); }
    ...
    public:
        ...
        S operator()(T* p, typename call_traits<A>::param_type x) const { return (p->*ptr)(x); }
    ...
    public:
        ...
        S operator()(const T* p) const { return (p->*ptr)(); }
    ...
    public:
        ...
        S operator()(const T* p, typename call_traits<A>::param_type x) const { return (p->*ptr)(x); }
    ...
    public:
        ...
        Result operator()(typename call_traits<Arg>::param_type x) const { return func(x); }
