...
#define BOOST_CLASS_REQUIRE4(tv1, tv2, tv3, tv4, ns, concept) BOOST_CONCEPT_ASSERT((ns::concept<tv1, tv2, tv3, tv4>))
    ...
    BOOST_concept(DefaultConstructible, (TT)) {
        BOOST_CONCEPT_USAGE(DefaultConstructible) { TT a; // require default constructor
...
#if (BOOST_WORKAROUND(__GNUC__, BOOST_TESTED_AT(4) && BOOST_WORKAROUND(__GNUC__, > 3)))
    ...
    InputIterator<TT>
{
    BOOST_CONCEPT_USAGE(ForwardIterator)
    {
        BOOST_CONCEPT_ASSERT(
            (Convertible<BOOST_DEDUCED_TYPENAME ForwardIterator::iterator_category, std::forward_iterator_tag>));
    ...
    Comparable<TT>
{
    BOOST_CONCEPT_USAGE(RandomAccessIterator)
    {
        ...
        i = i + n;
        i = n + i;  // require addition with difference type
    ...
    Container<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((Assignable<typename Mutable_Container::value_type>));
...
BOOST_concept(ForwardContainer, (C)) :
    Container<C> { BOOST_CONCEPT_USAGE(ForwardContainer) {
        BOOST_CONCEPT_ASSERT((ForwardIterator<typename ForwardContainer::const_iterator>));
}
}
;
...
BOOST_concept(Mutable_ForwardContainer, (C)) :
    ForwardContainer<C>,
    Mutable_Container<C> { BOOST_CONCEPT_USAGE(Mutable_ForwardContainer) {
        BOOST_CONCEPT_ASSERT((Mutable_ForwardIterator<typename Mutable_ForwardContainer::iterator>));
}
}
;
    ...
    ForwardContainer<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((BidirectionalIterator<typename ReversibleContainer::const_iterator>));
    ...
    ReversibleContainer<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((RandomAccessIterator<typename RandomAccessContainer::const_iterator>));
...
BOOST_concept(SimpleAssociativeContainer, (C)) :
    AssociativeContainer<C> { BOOST_CONCEPT_USAGE(SimpleAssociativeContainer) { typedef typename C::key_type key_type;
typedef typename C::value_type value_type;
...
BOOST_concept(PairAssociativeContainer, (C)) :
    AssociativeContainer<C> { BOOST_CONCEPT_USAGE(PairAssociativeContainer) { typedef typename C::key_type key_type;
typedef typename C::value_type value_type;
