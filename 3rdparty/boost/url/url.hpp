    ...
    namespace urls {
        ...
        /** A modifiable container for a URL.
            ...
            @see
                ...
                @ref resolve.
        */
        class BOOST_URL_DECL url : public url_base {
            friend std::hash<url>;
        ...
        public:
            ...
            */
            ...
            /** Constructor
                ...
                @li <a href="https://datatracker.ietf.org/doc/html/rfc3986#section-4.1"
                    >4.1. URI Reference</a>
            */
            explicit url(core::string_view s);
            ...
            */
            url(url_view_base const& u) { copy(u); }
            ...
            */
            url(url const& u) :
                url(static_cast<url_view_base const&>(u))
            {
            }
            ...
            */
            ...
            /** Assignment
                ...
                @return A reference to this object.
            */
            url& operator=(url_view_base const& u)
            {
                copy(u);
                return *this;
            }
            ...
            /** Assignment
                ...
                @return A reference to this object.
            */
            url& operator=(url const& u) { return (*this) = static_cast<url_view_base const&>(u); }
            ...
            */
            ...
            /** Swap
                ...
                @see
                    @ref url::swap
            */
            friend void swap(url& v0, url& v1) noexcept { v0.swap(v1); }
            ...
            url& set_scheme(core::string_view s)
            {
            ...
            url& set_scheme_id(urls::scheme id)
            {
            ...
            url& set_password(core::string_view s)
            {
            ...
            url& set_host(core::string_view s)
            {
                url_base::set_host(s);
                return *this;
            }
            ...
            url& set_host_address(core::string_view s)
            {
            ...
            url& set_host_ipv4(ipv4_address const& addr)
            {
            ...
            url& set_host_ipv6(ipv6_address const& addr)
            {
            ...
            url& set_zone_id(core::string_view s)
            {
            ...
            url& set_encoded_zone_id(pct_string_view const& s)
            {
            ...
            url& set_host_ipvfuture(core::string_view s)
            {
            ...
            url& set_port_number(std::uint16_t n)
            {
            ...
            url& set_port(core::string_view s)
            {
                url_base::set_port(s);
                return *this;
            }
            ...
            url& set_query(core::string_view s)
            {
            ...
            url& set_params(std::initializer_list<param_view> ps, encoding_opts opts = {})
            {
            ...
            {
                url_base::set_encoded_params(ps);
                return *this;
            }
...
namespace std {
    ...
    struct hash<::boost::urls::url>
    {
        ...
        std::size_t operator()(::boost::urls::url const& u) const noexcept { return u.digest(salt_); }
