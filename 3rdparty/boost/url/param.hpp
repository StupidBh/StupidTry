    ...
    namespace urls {
        ...
        */
        struct param
        {
            ...
            */
            ...
            param(core::string_view key, OptionalString const& value) :
            ...
            /** Assignment
                ...
                @return A reference to this object.
            */
            param& operator=(param_view const& other);
            ...
            */
             ...
             */
            param const* operator->() const noexcept { return this; }
             ...
             */
            param(core::string_view key, core::string_view value, bool has_value) noexcept :
                key(key),
                value(has_value ? value : core::string_view()),
                has_value(has_value)
            {
            }

        private:
            param(core::string_view key, detail::optional_string const& value) :
        ...
        */
        struct param_view
        {
            ...
            */
            template<class OptionalString>
            param_view(core::string_view key, OptionalString const& value) noexcept :
            ...
            */
            param_view(param const& other) noexcept :
                param_view(other.key, other.value, other.has_value)
            {
            }
            ...
            */
            explicit operator param() { return { key, value, has_value }; }
            ...
            /** Arrow support
                ...
                @return A pointer to the object.
             */
            param_view const* operator->() const noexcept { return this; }
             ...
             */
            param_view(core::string_view key_, core::string_view value_, bool has_value_) noexcept :
                key(key_),
                value(has_value_ ? value_ : core::string_view()),
                has_value(has_value_)
            {
            }

        private:
            param_view(core::string_view key, detail::optional_string const& value) :
        ...
        */
        struct param_pct_view
        {
            ...
            */
            ...
            /** Constructor
                ...
                @param value The value to set.
            */
            param_pct_view(pct_string_view key, pct_string_view value) noexcept :
                key(key),
                value(value),
                has_value(true)
            {
            ...
            */
            template<class OptionalString>
            param_pct_view(pct_string_view key, OptionalString const& value) :
            ...
            */
            explicit param_pct_view(param_view const& p) :
                key(p.key),
                value(p.has_value ? pct_string_view(p.value) : pct_string_view()),
            ...
            /** Conversion
                ...
                @return A param object
            */
            explicit operator param() const
            {
                return param(static_cast<std::string>(key), static_cast<std::string>(value), has_value);
            }
            ...
            */
            operator param_view() const noexcept { return param_view(key, value, has_value); }
             ...
             */
            param_pct_view const* operator->() const noexcept { return this; }
            ...
            /** Aggregate construction
                ...
                @param has_value True if a value is present
             */
            param_pct_view(pct_string_view key, pct_string_view value, bool has_value) noexcept :
                key(key),
                value(has_value ? value : pct_string_view()),
                has_value(has_value)
            {
            }

        private:
            param_pct_view(pct_string_view key, detail::optional_string const& value) :
        ...
        inline param& param::operator=(param_view const& other)
        {
            ...
            // preserve capacity
            key.assign(other.key.data(), other.key.size());
            value.assign(other.value.data(), other.value.size());
            has_value = other.has_value;
            return *this;
        }

        inline param& param::operator=(param_pct_view const& other)
        {
            // preserve capacity
            key.assign(other.key.data(), other.key.size());
            value.assign(other.value.data(), other.value.size());
