    ...
    namespace urls {
        ...
        */
        class segments_encoded_base {
            ...
            segments_encoded_base(detail::path_ref const& ref) noexcept;
            segments_encoded_base() = default;
            segments_encoded_base(segments_encoded_base const&) = default;
            segments_encoded_base& operator=(segments_encoded_base const&) = default;
        ...
        public:
            ...
            */
            ...
            /** Return the first segment
                ...
                @return The first segment.
            */
            pct_string_view front() const noexcept;
        ...
        */
        BOOST_URL_DECL
        std::ostream& operator<<(std::ostream& os, segments_encoded_base const& ps);
