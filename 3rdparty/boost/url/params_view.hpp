    ...
    namespace urls {
        ...
        */
        class params_view : public params_base {
            ...
            params_view(detail::query_ref const& ref, encoding_opts opt) noexcept;
        ...
        public:
            ...
            */
            params_view(params_view const& other, encoding_opts opt) noexcept;
            ...
            */
            params_view& operator=(params_view const& other) = default;
        };
