    ...
    namespace urls {
        namespace implementation_defined {
            ...
            struct pct_encoded_rule_t
            {
                ...
                constexpr pct_encoded_rule_t(CharSet const& cs) noexcept :
                    cs_(cs)
                {
                }
        ...
        */
        ...
        constexpr auto pct_encoded_rule(CS const& cs) noexcept -> implementation_defined::pct_encoded_rule_t<CS>
        {
            // If an error occurs here it means that
            // the value of your type does not meet
            // the requirements. Please check the
            // documentation!
            static_assert(grammar::is_charset<CS>::value, "CharSet requirements not met");
