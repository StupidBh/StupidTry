    ...
    namespace urls {
        namespace implementation_defined {
            struct ipv6_address_rule_t
            {
                ...
                BOOST_URL_DECL
                auto parse(char const*& it, char const* end) const noexcept -> system::result<ipv6_address>;
            };
        } // namespace implementation_defined
        ...
        /** Rule for An IP version 6 style address
            ...
            @code
            system::result< ipv6_address > rv = grammar::parse( "2001:0db8:85a3:0000:0000:8a2e:0370:7334",
           ipv6_address_rule );
            @endcode
