    ...
    namespace urls {
        ...
        */
        ...
        public:
            ...
            */
            bytes_type to_bytes() const noexcept { return addr_; }
            ...
            */
            ...
            BOOST_URL_STRTOK_RETURN to_string(BOOST_URL_STRTOK_ARG(token)) const
            {
            ...
            */
            friend bool operator==(ipv6_address const& a1, ipv6_address const& a2) noexcept
            {
            ...
            */
            friend bool operator!=(ipv6_address const& a1, ipv6_address const& a2) noexcept { return !(a1 == a2); }
            ...
            */
            friend std::ostream& operator<<(std::ostream& os, ipv6_address const& addr)
            {
        ...
        */
        BOOST_URL_DECL
        system::result<ipv6_address> parse_ipv6_address(core::string_view s) noexcept;
