    ...
    namespace urls {
        ...
        */
        class segments_encoded_ref : public segments_encoded_base {
            ...
            segments_encoded_ref(url_base& u) noexcept;
        ...
        public:
            ...
            */
            ...
            BOOST_URL_DECL
            segments_encoded_ref& operator=(segments_encoded_view const& other);
            ...
            */
            BOOST_URL_DECL
            segments_encoded_ref& operator=(std::initializer_list<pct_string_view> init);
            ...
            */
            BOOST_URL_DECL
            void assign(std::initializer_list<pct_string_view> init);
            ...
            */
            BOOST_URL_DECL
            iterator replace(iterator from, iterator to, std::initializer_list<pct_string_view> init);
