...
namespace boost {
    namespace urls {
        ...
        */
        class BOOST_URL_DECL url_base : public url_view_base {
            char* s_ = nullptr;
            std::size_t cap_ = 0;
            ...
            {
                ~op_t();
                op_t(url_base&, core::string_view* = nullptr, core::string_view* = nullptr) noexcept;
                void move(char*, char const*, std::size_t) noexcept;
            ...
            virtual void reserve_impl(std::size_t, op_t&) = 0;
        ...
        public:
            ...
            /** Return the url as a null-terminated string
                ...
                Throws nothing.
            */
            char const* c_str() const noexcept { return pi_->cs_; }
            ...
            */
            void reserve(std::size_t n) { reserve_impl(n); }
            ...
            */
            ...
            /** Set the scheme
                ...
                @par Example
                @code
                assert( url( "http://example.com/echo.cgi" ).set_scheme_id( scheme::wss ).buffer() ==
               "wss://example.com/echo.cgi" );
                @endcode
                ...
                @li <a href="https://datatracker.ietf.org/doc/html/rfc3986#section-3.1">
                    3.1. Scheme (rfc3986)</a>
            */
            url_base& set_scheme_id(urls::scheme id);
            ...
            /** Remove the scheme
                ...
                @par Example
                @code
                assert( url("http://www.example.com/index.htm" ).remove_scheme().buffer() ==
            ...
            */
            url_base& set_userinfo(core::string_view s);
            ...
            */
            ...
            /** Set the user
                ...
                @see
                    ...
                    @ref set_password.
            */
            url_base& set_user(core::string_view s);
            ...
            */
            ...
            /** Remove the password
                ...
                @par Example
                @code
                assert( url( "http://user:pass@example.com" ).remove_password().authority().buffer() ==
               "user@example.com" );
                @endcode
            ...
            */
            ...
            /** Set the host to an address
                ...
                @see
                    ...
                    @ref set_host_name.
            */
            url_base& set_host_address(core::string_view s);
            ...
            */
            ...
            /** Set the host to an address
                ...
                @par Example
                @code
                assert( url("http://www.example.com").set_host_ipv4( ipv4_address( "127.0.0.1" ) ).buffer() ==
               "http://127.0.0.1" );
                @endcode
                ...
                @par Postconditions
                @code
                this->has_authority() == true && this->host_ipv4_address() == addr && this->host_type() ==
               host_type::ipv4
                @endcode
                ...
                @see
                    ...
                    @ref set_host_name.
            */
            url_base& set_host_ipv4(ipv4_address const& addr);
            ...
            /** Set the host to an address
                ...
                @par Postconditions
                @code
                this->has_authority() == true && this->host_ipv6_address() == addr && this->host_type() ==
               host_type::ipv6
                @endcode
            ...
            */
            ...
            /** Set the zone ID for an IPv6 address.
                ...
                @par Example
                @code
                assert( u.set_host_ipv6( ipv6_address( "fe80::1" ) ).set_zone_id( "eth0" ).buffer() ==
               "https://[fe80::1%25eth0]" );
                @endcode
            ...
            */
            url_base& set_zone_id(core::string_view s);
            ...
            /** Set the zone ID for an IPv6 address (percent-encoded).
                ...
                @par Example
                @code
                assert( u.set_host_ipv6( ipv6_address( "fe80::1" ) ).set_encoded_zone_id( "eth0" ).buffer() ==
               "https://[fe80::1%25eth0]" );
                @endcode
            ...
            */
            url_base& set_encoded_zone_id(pct_string_view s);
            ...
            /** Set the host to an address
                ...
                @see
                    ...
                    @ref set_host_name.
            */
            url_base& set_host_ipvfuture(core::string_view s);
            ...
            /** Set the host to a name
                ...
                @par Example
                @code
                assert( url( "http://www.example.com/index.htm").set_host_name( "localhost" ).host_address() ==
               "localhost" );
                @endcode
               ...
               host_type::name
                ...
                @see
                    ...
                    @ref set_host_ipvfuture.
            */
            url_base& set_host_name(core::string_view s);
            ...
            /** Set the host to a name
                ...
                @par Example
                @code
                assert( url( "http://www.example.com/index.htm").set_encoded_host_name( "localhost" ).host_address() ==
               "localhost" );
                @endcode
            ...
            */
            ...
            /** Set the port
                ...
                @par Example
                @code
                assert( url( "http://www.example.com" ).set_port_number( 8080 ).authority().buffer() ==
            ...
            */
            ...
            /** Set the port
                ...
                @par Example
                @code
                assert( url( "http://www.example.com" ).set_port( "8080" ).authority().buffer() ==
               "www.example.com:8080" );
                @endcode
                ...
                @see
                    ...
                    @ref set_port.
            */
            url_base& set_port(core::string_view s);
            ...
            */
            ...
            /** Return the path as a container of segments
                ...
                @see
                    ...
                    @ref set_path_absolute.
            */
            urls::segments_ref segments() noexcept;

            /// @copydoc url_view_base::segments
            segments_view segments() const noexcept { return url_view_base::segments(); }
            ...
            */
            ...
            segments_encoded_view encoded_segments() const noexcept { return url_view_base::encoded_segments(); }
            ...
            */
            url_base& set_query(core::string_view s);
            ...
            */
            ...
            params_view params() const noexcept { return url_view_base::params(); }
            ...
            */
            ...
            params_encoded_view encoded_params() const noexcept { return url_view_base::encoded_params(); }
            ...
            */
            ...
            /** Set the query params
                ...
                @see
                    ...
                    @ref set_query.
            */
            url_base& set_params(std::initializer_list<param_view> ps, encoding_opts opts = {}) noexcept;
            ...
            /** Set the query params
                ...
                @see
                    ...
                    @ref set_query.
            */
            url_base& set_encoded_params(std::initializer_list<param_pct_view> ps) noexcept;
            ...
            */
            ...
            /** Set the fragment.
                ...
                @par Example
                @code
                assert( url("?first=john&last=doe" ).set_encoded_fragment( "john doe" ).encoded_fragment() ==
               "john%20doe" );
                @endcode
            ...
            */
            ...
            friend system::result<void> resolve(url_view_base const& base, url_view_base const& ref, url_base& dest);
        ...
        private:
            ...
            void set_host_ipv6_and_zone_id(ipv6_address const& addr, core::string_view zone_id);

            void set_host_ipv6_and_encoded_zone_id(ipv6_address const& addr, pct_string_view zone_id);

            core::string_view first_segment() const noexcept;

            detail::segments_iter_impl edit_segments(
            ...
            auto
                edit_params(detail::params_iter_impl const&, detail::params_iter_impl const&, detail::any_params_iter&&)
            ...
            // preserved.
            template<class AllowedCharSet, class IgnoredCharSet>
            void normalize_octets_impl(
                int,
            ...
            void normalize_octets_impl(int, CharSet const& allowed, op_t&) noexcept;
        ...
        /** Resolve a URL reference against a base URL
            ...
            @see
                ...
                @ref url_view.
        */
        inline system::result<void> resolve(url_view_base const& base, url_view_base const& ref, url_base& dest)
        {
            if (&dest != &base) {
                dest.copy(base);
            }
