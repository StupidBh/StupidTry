...
// Set up SSE2
#if !defined(BOOST_URL_NO_SSE2) && !defined(BOOST_URL_USE_SSE2)
...
// constexpr
#if BOOST_WORKAROUND(BOOST_GCC_VERSION, <= 72000) || BOOST_WORKAROUND(BOOST_CLANG_VERSION, <= 35000)
...
// String token parameters
    ...
    #define BOOST_URL_STRTOK_TPARAM \
        BOOST_URL_CONSTRAINT(string_token::StringToken) StringToken = string_token::return_string
#endif
...
// Move
#if BOOST_WORKAROUND(BOOST_GCC_VERSION, < 80000) || BOOST_WORKAROUND(BOOST_CLANG_VERSION, < 30900)
...
// libstdcxx copy-on-write strings
        ...
        (BOOST_LIBSTDCXX_VERSION < 60000 || (defined(_GLIBCXX_USE_CXX11_ABI) && _GLIBCXX_USE_CXX11_ABI == 0))
