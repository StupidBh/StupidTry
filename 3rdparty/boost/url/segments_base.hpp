    ...
    namespace urls {
        ...
        */
        class segments_base {
            ...
            segments_base(detail::path_ref const& ref) noexcept;
            segments_base() = default;
            segments_base(segments_base const&) = default;
            segments_base& operator=(segments_base const&) = default;
        ...
        */
        BOOST_URL_DECL
        std::ostream& operator<<(std::ostream& os, segments_base const& ps);
