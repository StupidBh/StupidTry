    ...
    namespace urls {
        ...
        namespace error_types {
            ...
            using error_category
                BOOST_URL_DEPRECATED("Use system::error_category instead") = boost::system::error_category;
             ...
             */
            using error_code BOOST_URL_DEPRECATED("Use system::error_code instead") = boost::system::error_code;
            ...
            using error_condition
                BOOST_URL_DEPRECATED("Use system::error_condition instead") = boost::system::error_condition;
             ...
             */
            using system_error BOOST_URL_DEPRECATED("Use system::system_error instead") = boost::system::system_error;
            ...
            */
            template<class T>
            using result
                BOOST_URL_DEPRECATED("Use system::result<T> instead") = boost::system::result<T, system::error_code>;
