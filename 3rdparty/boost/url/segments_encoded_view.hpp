    ...
    namespace urls {
        ...
        */
        class segments_encoded_view : public segments_encoded_base {
            ...
            segments_encoded_view(detail::path_ref const& ref) noexcept;
        ...
        public:
            ...
            */
            segments_encoded_view& operator=(segments_encoded_view const& other) = default;
            ...
            */
            ...
            BOOST_URL_DECL
            friend system::result<segments_encoded_view> parse_path(core::string_view s) noexcept;
        };
