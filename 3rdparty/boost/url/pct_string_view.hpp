...
namespace boost {
    namespace urls {
        ...
        pct_string_view make_pct_string_view_unsafe(char const*, std::size_t, std::size_t) noexcept;

        namespace detail {
            core::string_view& ref(pct_string_view& s) noexcept;
        } // namespace detail
#endif
        ...
        */
        class pct_string_view final : public grammar::string_view_base {
            std::size_t dn_ = 0;

#ifndef BOOST_URL_DOCS
            friend pct_string_view make_pct_string_view_unsafe(char const*, std::size_t, std::size_t) noexcept;

            friend core::string_view& detail::ref(pct_string_view&) noexcept;
#endif

            // unsafe
            BOOST_CXX14_CONSTEXPR
            pct_string_view(char const* data, std::size_t size, std::size_t dn) noexcept :
            ...
            BOOST_URL_DECL
            void decode_impl(string_token::arg& dest, encoding_opts opt) const;
        ...
        public:
...
#ifndef BOOST_URL_DOCS
                ,
                class = typename std::enable_if<std::is_convertible<String, core::string_view>::value>::type
#endif
                >
            BOOST_CXX14_CONSTEXPR pct_string_view(String const& s) :
                pct_string_view(detail::to_sv(s))
            {
            }
            ...
            */
            pct_string_view(char const* s, std::size_t len) :
                pct_string_view(core::string_view(s, len))
            {
            }
            ...
            */
            pct_string_view& operator=(pct_string_view const& other) = default;

            friend BOOST_URL_DECL system::result<pct_string_view> make_pct_string_view(core::string_view s) noexcept;
            ...
            */
            BOOST_CXX14_CONSTEXPR
            std::size_t decoded_size() const noexcept { return dn_; }
            ...
            */
            decode_view operator*() const noexcept;
            ...
            */
            ...
            BOOST_URL_STRTOK_RETURN decode(encoding_opts opt = {}, BOOST_URL_STRTOK_ARG(token)) const
            {
                ...
                */
                static_assert(string_token::is_token<StringToken>::value, "Type requirements not met");
            ...
            */
            pct_string_view const* operator->() const noexcept { return this; }
#endif
            ...
            */
            /*BOOST_CXX14_CONSTEXPR*/ void swap(pct_string_view& s) noexcept
            {
        ...
        namespace detail {
            ...
            inline core::string_view& ref(pct_string_view& s) noexcept
            {
                return s.s_;
            }
        ...
        */
        BOOST_URL_DECL
        system::result<pct_string_view> make_pct_string_view(core::string_view s) noexcept;

#ifndef BOOST_URL_DOCS
        // VFALCO semi-private for now
        inline pct_string_view
            make_pct_string_view_unsafe(char const* data, std::size_t size, std::size_t decoded_size) noexcept
        {
    #if 0
    BOOST_ASSERT(! make_pct_string_view(
        core::string_view(data, size)).has_error());
    #endif
            return pct_string_view(data, size, decoded_size);
        }
#endif
        ...
        namespace detail {
            template<>
            inline BOOST_CXX14_CONSTEXPR core::string_view to_sv(pct_string_view const& s) noexcept
            {
                return s.substr();
            }
        } // namespace detail
