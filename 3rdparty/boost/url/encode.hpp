...
namespace boost {
    namespace urls {
        ...
        */
        template<BOOST_URL_CONSTRAINT(grammar::CharSet) CS>
        std::size_t
            encode(char* dest, std::size_t size, core::string_view s, CS const& allowed, encoding_opts opt = {});
        ...
        /** Return a percent-encoded string
            ...
            @see
                ...
                @ref encoding_opts,
        */
        template<BOOST_URL_STRTOK_TPARAM, BOOST_URL_CONSTRAINT(grammar::CharSet) CS>
