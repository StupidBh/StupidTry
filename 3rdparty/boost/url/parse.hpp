...
namespace boost {
    namespace urls {
        ...
        */
        BOOST_URL_DECL
        system::result<url_view> parse_absolute_uri(core::string_view s);
        ...
        */
        BOOST_URL_DECL
        system::result<url_view> parse_origin_form(core::string_view s);
        ...
        */
        BOOST_URL_DECL
        system::result<url_view> parse_relative_ref(core::string_view s);
        ...
        */
        BOOST_URL_DECL
        system::result<url_view> parse_uri(core::string_view s);
        ...
        */
        BOOST_URL_DECL
        system::result<url_view> parse_uri_reference(core::string_view s);
