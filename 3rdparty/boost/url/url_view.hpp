...
namespace boost {
    namespace urls {
        ...
        */
        class BOOST_URL_DECL url_view : public url_view_base {
            ...
            explicit url_view(detail::url_impl const& impl) noexcept :
                url_view_base(impl)
            {
            }
        ...
        public:
            ...
            */
            ...
            template<
                ...
                class = typename std::enable_if<
                    ...
                    !std::is_convertible<String*, url_view_base*>::value>::type
#endif
                >
            url_view(String const& s) :
                url_view(detail::to_sv(s))
            {
            }
            ...
            */
            url_view(url_view const& other) noexcept :
                url_view(static_cast<url_view_base const&>(other))
            {
            }
            ...
            */
            url_view& operator=(url_view const& other) noexcept
            {
                if (this != &other) {
                    *this = static_cast<url_view_base const&>(other);
                }
                return *this;
            }
...
namespace std {
    ...
    struct hash<::boost::urls::url_view>
    {
        ...
        std::size_t operator()(::boost::urls::url_view const& u) const noexcept { return u.digest(salt_); }
