...
#ifdef BOOST_MSVC
    #pragma warning(push)
            // "struct 'boost::urls::encoding_opts' needs to have dll-interface to be used by clients of class
            // 'boost::urls::params_base'" but encoding_opts should not be BOOST_URL_DECL and params_base should be
            // BOOST_URL_DECL.
    #pragma warning(disable: 4251)
        ...
        */
        class BOOST_URL_DECL params_base {
            ...
            params_base(detail::query_ref const& ref, encoding_opts opt) noexcept;
            params_base(params_base const&) = default;
            params_base& operator=(params_base const&) = default;
        ...
        public:
            ...
            */
            ...
            /** Return true if a matching key exists
                ...
                @return `true` if a matching key exists.
            */
            bool contains(core::string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Return the number of matching keys
                ...
                @return The number of matching keys.
            */
            std::size_t count(core::string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find(core::string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find(iterator from, core::string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find_last(core::string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find_last(iterator before, core::string_view key, ignore_case_param ic = {}) const noexcept;

        private:
            detail::params_iter_impl
                find_impl(detail::params_iter_impl, core::string_view, ignore_case_param) const noexcept;

            detail::params_iter_impl
                find_last_impl(detail::params_iter_impl, core::string_view, ignore_case_param) const noexcept;
        };
        ...
        */
        BOOST_URL_DECL
        std::ostream& operator<<(std::ostream& os, params_base const& qp);
