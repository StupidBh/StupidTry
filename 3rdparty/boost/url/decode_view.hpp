...
namespace boost {
    namespace urls {
        ...
        namespace detail {
            ...
            // unchecked
            template<class... Args>
            decode_view make_decode_view(Args&&... args) noexcept;
        ...
        */
        class decode_view {
            ...
            template<class... Args>
            friend decode_view detail::make_decode_view(Args&&... args) noexcept;

            // unchecked
            BOOST_CXX14_CONSTEXPR
            explicit decode_view(core::string_view s, std::size_t n, encoding_opts opt) noexcept :
                p_(s.data()),
                n_(s.size()),
                dn_(n),
        ...
        public:
            ...
            */
            BOOST_CXX14_CONSTEXPR
            explicit decode_view(pct_string_view s, encoding_opts opt = {}) noexcept :
                decode_view(detail::to_sv(s), s.decoded_size(), opt)
            {
            }
            ...
            */
            ...
            /** Return the number of decoded characters
                ...
                @return The number of decoded characters
            */
            size_type size() const noexcept { return dn_; }
            ...
            */
            BOOST_URL_DECL
            bool ends_with(core::string_view s) const noexcept;
            ...
            */
            BOOST_URL_DECL
            const_iterator find(char ch) const noexcept;
            ...
            */
            BOOST_URL_DECL
            const_iterator rfind(char ch) const noexcept;
            ...
            */
             ...
             */
            encoding_opts options() const noexcept
            {
                encoding_opts opt;
        ...
        private:
            ...
            BOOST_CXX14_CONSTEXPR
            static int decode_compare(decode_view s0, decode_view s1) noexcept { return s0.compare(s1); }

            template<class S>
            BOOST_CXX14_CONSTEXPR static int decode_compare(decode_view s0, S const& s1) noexcept
            {
                return s0.compare(s1);
            }

            template<class S>
            BOOST_CXX14_CONSTEXPR static int decode_compare(S const& s0, decode_view s1) noexcept
            {
        ...
        public:
             ...
             */
            template<class S0, class S1>
            BOOST_CXX14_CONSTEXPR friend auto operator==(S0 const& lhs, S1 const& rhs) noexcept ->
             ...
             */
            BOOST_CXX14_CONSTEXPR
            friend bool operator==(decode_view const& lhs, decode_view const& rhs) noexcept
            {
                return decode_compare(lhs, rhs) == 0;
            }
            ...
            BOOST_CXX14_CONSTEXPR friend bool operator==(decode_view const& lhs, S const& rhs) noexcept
            {
                return decode_compare(lhs, rhs) == 0;
            }
             ...
             */
            template<std::convertible_to<core::string_view> S>
            BOOST_CXX14_CONSTEXPR friend bool operator==(S const& lhs, decode_view const& rhs) noexcept
            {
                return decode_compare(lhs, rhs) == 0;
            }
#endif
        ...
        /** Format the string with percent-decoding applied to the output stream
            ...
            @param s The decoded view to write
        */
        inline std::ostream& operator<<(std::ostream& os, decode_view const& s);

        //------------------------------------------------

        inline decode_view pct_string_view::operator*() const noexcept
        {
        ...
        namespace detail {
            ...
            decode_view make_decode_view(Args&&... args) noexcept
            {
                return decode_view(std::forward<Args>(args)...);
            }
        } // namespace detail
