...
namespace boost {
    namespace urls {
        ...
        */
        class BOOST_URL_DECL params_encoded_view : public params_encoded_base {
            friend class url_view_base;
            friend class params_view;
            friend class params_encoded_ref;
            friend struct implementation_defined::query_rule_t;

            params_encoded_view(detail::query_ref const& ref) noexcept;
        ...
        public:
            ...
            */
            ...
            /** Assignment
                ...
                @return `*this`
            */
            params_encoded_view& operator=(params_encoded_view const& other) = default;
            ...
            */
            ...
            friend BOOST_URL_DECL system::result<params_encoded_view> parse_query(core::string_view s) noexcept;
        };
