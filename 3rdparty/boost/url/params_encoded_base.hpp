    ...
    namespace urls {
        ...
        */
        class BOOST_URL_DECL params_encoded_base {
            ...
            params_encoded_base(params_encoded_base const&) = default;
            params_encoded_base& operator=(params_encoded_base const&) = default;
            params_encoded_base(detail::query_ref const& ref) noexcept;
        ...
        public:
            ...
            */
            ...
            /** Return true if a matching key exists
                ...
                @return `true` if a matching key exists.
            */
            bool contains(pct_string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Return the number of matching keys
                ...
                @return The number of matching keys.
            */
            std::size_t count(pct_string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                @par Example
                @code
                assert( url_view( "?first=John&last=Doe" ).encoded_params().find( "First", ignore_case )->value ==
               "John" );
                @endcode
                ...
                case-insensitive.
            */
            iterator find(pct_string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find(iterator from, pct_string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find_last(pct_string_view key, ignore_case_param ic = {}) const noexcept;
            ...
            /** Find a matching key
                ...
                case-insensitive.
            */
            iterator find_last(iterator before, pct_string_view key, ignore_case_param ic = {}) const noexcept;

        private:
            detail::params_iter_impl
                find_impl(detail::params_iter_impl, pct_string_view, ignore_case_param) const noexcept;

            detail::params_iter_impl
                find_last_impl(detail::params_iter_impl, pct_string_view, ignore_case_param) const noexcept;
        };
        ...
        */
        BOOST_URL_DECL
        std::ostream& operator<<(std::ostream& os, params_encoded_base const& qp);
