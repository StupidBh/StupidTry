    ...
    namespace urls {
        ...
        */
        ...
        public:
            ...
            */
            BOOST_URL_DECL
            segments_ref& operator=(segments_ref const& other);

            /// @copydoc segments_ref::operator=(segments_ref const&)
            BOOST_URL_DECL
            segments_ref& operator=(segments_view const& other);
            ...
            */
            BOOST_URL_DECL
            segments_ref& operator=(std::initializer_list<core::string_view> init);
            ...
            */
            BOOST_URL_DECL
            void assign(std::initializer_list<core::string_view> init);
            ...
            /** Assign segments
                ...
                @par Complexity
                Linear in `std::distance( first, last ) + this->url().encoded_query().size() +
               this->url().encoded_fragment().size()`.
            ...
            */
            BOOST_URL_DECL
            iterator insert(iterator before, core::string_view s);
            ...
            */
            BOOST_URL_DECL
            iterator insert(iterator before, std::initializer_list<core::string_view> init);
            ...
            */
            BOOST_URL_DECL
            iterator replace(iterator from, iterator to, core::string_view s);
            ...
            */
            BOOST_URL_DECL
            iterator replace(iterator from, iterator to, std::initializer_list<core::string_view> init);
