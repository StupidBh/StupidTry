...
namespace boost {
    namespace urls {
        ...
        */
        class BOOST_URL_DECL url_view_base : private detail::parts_base {
            ...
            explicit url_view_base(detail::url_impl const&) noexcept;

            ~url_view_base() = default;

            url_view_base(url_view_base const& o) noexcept :
                impl_(o.impl_),
                pi_(o.pi_)
            {
                if (pi_ == &o.impl_) {
            ...
            url_view_base& operator=(url_view_base const&) = delete;
        ...
        protected:
            ...
            */
            std::size_t digest(std::size_t salt = 0) const noexcept;
        ...
        public:
            ...
            */
            static constexpr std::size_t max_size() noexcept { return BOOST_URL_MAX_SIZE; }
            ...
            /** Return the number of characters in the url
                ...
                @return The number of characters in the url.
            */
            std::size_t size() const noexcept { return pi_->offset(id_end); }
            ...
            /** Return true if the url is empty
                ...
                @par Specification
                @li <a href="https://datatracker.ietf.org/doc/html/rfc3986#section-4.2">4.2.  Relative Reference
               (rfc3986)</a>

                @return `true` if the url is empty.
            */
            bool empty() const noexcept { return pi_->offset(id_end) == 0; }
            ...
            */
            char const* data() const noexcept { return pi_->cs_; }
            ...
            */
            core::string_view buffer() const noexcept { return core::string_view(data(), size()); }
            ...
            */
            operator core::string_view() const noexcept { return buffer(); }
            ...
            */
            urls::scheme scheme_id() const noexcept;
            ...
            */
            bool has_authority() const noexcept { return pi_->len(id_user) > 0; }
            ...
            */
            authority_view authority() const noexcept;
            ...
            */
            pct_string_view encoded_authority() const noexcept;
            ...
            /** Return true if a userinfo is present
                ...
                @par Specification
                @li <a href="https://datatracker.ietf.org/doc/html/rfc3986#section-3.2.1">3.2.1. User Information
               (rfc3986)</a>
            ...
            */
            ...
            BOOST_URL_STRTOK_RETURN userinfo(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_userinfo().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the userinfo
               ...
               (rfc3986)</a>
                ...
                @return The userinfo as a string.
            */
            pct_string_view encoded_userinfo() const noexcept;
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN user(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_user().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the user
               ...
               (rfc3986)</a>
                ...
                @return The user as a string.
            */
            pct_string_view encoded_user() const noexcept;
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN password(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_password().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the password
               ...
               (rfc3986)</a>
                ...
                @return The password as a string.
            */
            pct_string_view encoded_password() const noexcept;
            ...
            */
            urls::host_type host_type() const noexcept { return pi_->host_type_; }
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN host(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_host().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the host
                ...
                @return The host address as a string.
            */
            pct_string_view encoded_host() const noexcept;
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN host_address(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_host_address().decode(opt, std::forward<StringToken>(token));
            }
            ...
            */
            ...
            /** Return the host IPv4 address
                ...
                @par Example
                @code
                assert( url_view( "http://127.0.0.1/index.htm?user=win95" ).host_ipv4_address() == ipv4_address(
               "127.0.0.1" ) );
                @endcode
            ...
            */
            ipv4_address host_ipv4_address() const noexcept;
            ...
            */
            ipv6_address host_ipv6_address() const noexcept;
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN host_name(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_host_name().decode(opt, std::forward<StringToken>(token));
            }
            ...
            */
            pct_string_view encoded_host_name() const noexcept;
            ...
            /** Return the IPv6 Zone ID
                ...
                @par Specification
                @li <a href="https://datatracker.ietf.org/doc/html/rfc6874">Representing IPv6 Zone Identifiers in
               Address Literals and Uniform Resource Identifiers</a>

                @param token A string token customization.
                @return The Zone ID as a string.
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN zone_id(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_zone_id().decode(opt, std::forward<StringToken>(token));
            }
            ...
            */
            pct_string_view encoded_zone_id() const noexcept;
            ...
            */
            std::uint16_t port_number() const noexcept;
            ...
            */
            bool is_path_absolute() const noexcept
            {
                return pi_->len(id_path) > 0 && pi_->cs_[pi_->offset(id_path)] == '/';
            }
            ...
            /** Return the path
                ...
                @par Example
                @code
                assert( url_view( "file:///Program%20Files/Games/config.ini" ).path() == "/Program
               Files/Games/config.ini" );
                @endcode
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN path(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_path().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the path
                ...
                @par Example
                @code
                assert( url_view( "file:///Program%20Files/Games/config.ini" ).encoded_path() ==
               "/Program%20Files/Games/config.ini" );
                @endcode
                ...
                @return The path as a string.
            */
            pct_string_view encoded_path() const noexcept;
            ...
            */
            segments_view segments() const noexcept;
            ...
            */
            segments_encoded_view encoded_segments() const noexcept;
            ...
            */
            ...
            /** Return the query
                ...
                @par Example
                @code
                assert( url_view( "/sql?id=42&name=jane%2Ddoe&page+size=20" ).query() == "id=42&name=jane-doe&page
               size=20" );
                @endcode
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN query(StringToken&& token = {}) const
            {
                ...
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_query().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the query
                ...
                @par Example
                @code
                assert( url_view( "/sql?id=42&name=jane%2Ddoe&page+size=20" ).encoded_query() ==
               "id=42&name=jane%2Ddoe&page+size=20" );
                @endcode
                ...
                @return The query as a string.
            */
            pct_string_view encoded_query() const noexcept;
            ...
            */
            params_view params() const noexcept;

            params_view params(encoding_opts opt) const noexcept;
            ...
            /** Return the query as a container of parameters
                ...
                @return A bidirectional view of key/value pairs.
            */
            params_encoded_view encoded_params() const noexcept;
            ...
            */
            template<BOOST_URL_STRTOK_TPARAM>
            BOOST_URL_STRTOK_RETURN fragment(StringToken&& token = {}) const
            {
                encoding_opts opt;
                opt.space_as_plus = false;
                return encoded_fragment().decode(opt, std::forward<StringToken>(token));
            }
            ...
            /** Return the fragment
                ...
                @return The fragment portion of the url.
            */
            pct_string_view encoded_fragment() const noexcept;
            ...
            /** Return the host and port
                ...
                @par Example
                @code
                assert( url_view( "http://www.example.com:8080/index.htm" ).encoded_host_and_port() ==
            ...
            */
            pct_string_view encoded_host_and_port() const noexcept;
            ...
            /** Return the origin
                ...
                @par Example
                @code
                assert( url_view( "http://www.example.com:8080/index.htm?text=none#h1" ).encoded_origin() ==
            ...
            */
            pct_string_view encoded_origin() const noexcept;
            ...
            /** Return the resource
                ...
                @par Example
                @code
                assert( url_view( "http://www.example.com/index.html?query#frag" ).encoded_resource() ==
               "/index.html?query#frag" );
                @endcode
            ...
            */
            pct_string_view encoded_resource() const noexcept;
            ...
            /** Return the target
                ...
                @par Example
                @code
                assert( url_view( "http://www.example.com/index.html?query#frag" ).encoded_target() ==
               "/index.html?query" );
                @endcode
            ...
            */
            pct_string_view encoded_target() const noexcept;
            ...
            /** Return the result of comparing this with another url
                ...
                @par Specification
                @li <a href="https://datatracker.ietf.org/doc/html/rfc3986#section-6.2.2">6.2.2 Syntax-Based
               Normalization (rfc3986)</a>
            ...
            */
            ...
            /** Return the result of comparing two URLs
               ...
               Normalization (rfc3986)</a>
            */
            friend bool operator==(url_view_base const& u0, url_view_base const& u1) noexcept
            {
            ...
            /** Return the result of comparing two URLs
               ...
               Normalization (rfc3986)</a>
            */
            friend bool operator!=(url_view_base const& u0, url_view_base const& u1) noexcept { return !(u0 == u1); }
            ...
            */
            friend std::ostream& operator<<(std::ostream& os, url_view_base const& u) { return os << u.buffer(); }
        ...
        private:
            ...
            //
            //--------------------------------------------
            static int segments_compare(segments_encoded_view seg0, segments_encoded_view seg1) noexcept;
        };
        ...
        /** Format the url to the output stream
            ...
            @param u The url to write.
        */
        std::ostream& operator<<(std::ostream& os, url_view_base const& u);
