...
namespace boost {
    namespace urls {
        ...
        */
        ...
        url format(core::string_view fmt, Args&&... args)
        {
            return detail::vformat(fmt, detail::make_format_args(std::forward<Args>(args)...));
        }
        ...
        */
        template<BOOST_URL_CONSTRAINT(std::convertible_to<format_arg>)... Args>
        void format_to(url_base& u, core::string_view fmt, Args&&... args)
        {
            detail::vformat_to(u, fmt, detail::make_format_args(std::forward<Args>(args)...));
        }
        ...
        */
        inline url format(core::string_view fmt, std::initializer_list<format_arg> args)
        {
            return detail::vformat(fmt, detail::format_args(args.begin(), args.end()));
        }
        ...
        */
        inline void format_to(url_base& u, core::string_view fmt, std::initializer_list<format_arg> args)
        {
            detail::vformat_to(u, fmt, detail::format_args(args.begin(), args.end()));
        }
        ...
        */
        template<class T>
        named_arg<T> arg(core::string_view name, T const& arg)
        {
            return { name, arg };
        }
