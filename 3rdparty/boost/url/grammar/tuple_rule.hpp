    ...
    namespace urls {
        namespace grammar {
            ...
            namespace implementation_defined {
                ...
                class tuple_rule_t : empty_value<detail::tuple<R0, Rn...>> {
                    using T = mp11::mp_remove<std::tuple<typename R0::value_type, typename Rn::value_type...>, void>;
                    static constexpr bool IsList = mp11::mp_size<T>::value != 1;

                public:
                    using value_type = mp11::mp_eval_if_c<IsList, T, mp11::mp_first, T>;

                    constexpr tuple_rule_t(R0 const& r0, Rn const&... rn) noexcept :
                        empty_value<detail::tuple<R0, Rn...>>(empty_init, r0, rn...)
                    {
                    }
            ...
            */
            ...
            constexpr auto tuple_rule(R0 const& r0, Rn const&... rn) noexcept
            ...
            namespace implementation_defined {
                ...
                template<class Rule>
                struct squelch_rule_t : empty_value<Rule>
                {
                    using value_type = void;

                    constexpr squelch_rule_t(Rule const& r) noexcept :
                        empty_value<Rule>(empty_init, r)
                    {
                    }
            ...
            */
            ...
            constexpr BOOST_URL_IMPLEMENTATION_DEFINED(implementation_defined::squelch_rule_t<R>)
