    ...
    namespace urls {
        namespace grammar {
            ...
            namespace implementation_defined {
                template<class Rule>
                struct optional_rule_t : private empty_value<Rule>
                {
                    using value_type = boost::optional<typename Rule::value_type>;

                    system::result<value_type> parse(char const*& it, char const* end) const;

                    constexpr optional_rule_t(Rule const& r) noexcept :
            ...
            */
            ...
            auto constexpr optional_rule(R const& r) -> implementation_defined::optional_rule_t<R>
            {
