...
namespace boost {
    namespace urls {
        namespace grammar {
            ...
            */
            BOOST_URL_DECL
            int ci_compare(core::string_view s0, core::string_view s1) noexcept;
            ...
            */
            ...
            /** Return true if s0 equals s1 using case-insensitive comparison
                ...
                @see
                    ...
                    @ref ci_is_less.
            */
            template<class String0, class String1>
            auto ci_is_equal(String0 const& s0, String1 const& s1) -> typename std::enable_if<
                !std::is_convertible<String0, core::string_view>::value ||
                    !std::is_convertible<String1, core::string_view>::value,
                bool>::type
            {
                // this overload supports forward iterators and
                // does not assume the existence core::string_view::size
                if (detail::type_id<String0>() > detail::type_id<String1>()) {
            ...
            /** Return true if s0 equals s1 using case-insensitive comparison
                ...
                @see
                    ...
                    @ref ci_is_less.
            */
            inline bool ci_is_equal(core::string_view s0, core::string_view s1) noexcept
            {
            ...
            /** Return true if s0 is less than s1 using case-insensitive comparison
                ...
                @see
                    ...
                    @ref ci_is_equal.
            */
            inline bool ci_is_less(core::string_view s0, core::string_view s1) noexcept
            {
                if (s0.size() != s1.size()) {
            ...
            namespace implementation_defined {
                struct ci_hash
                {
                    ...
                    std::size_t operator()(core::string_view s) const noexcept { return ci_digest(s); }
                };
            }
            ...
            */
            ...
            namespace implementation_defined {
                struct ci_equal
                {
                    ...
                    template<class String0, class String1>
                    bool operator()(String0 s0, String1 s1) const noexcept
                    {
            ...
            */
            ...
            namespace implementation_defined {
                struct ci_less
                {
                    ...
                    std::size_t operator()(core::string_view s0, core::string_view s1) const noexcept
                    {
