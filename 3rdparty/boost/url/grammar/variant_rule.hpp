    ...
    namespace urls {
        namespace grammar {
            ...
            namespace implementation_defined {
                ...
                public:
                    using value_type = variant2::variant<typename R0::value_type, typename Rn::value_type...>;

                    auto parse(char const*& it, char const* end) const -> system::result<value_type>;

                    constexpr variant_rule_t(R0 const& r0, Rn const&... rn) noexcept :
                        rn_(r0, rn...)
                    {
                    }
            ...
            */
            ...
            constexpr auto variant_rule(R0 const& r0, Rn const&... rn) noexcept
