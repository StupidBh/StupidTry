...
namespace boost {
    namespace urls {
        namespace grammar {
             ...
             */
            template<class T>
            using aligned_storage = implementation_defined::aligned_storage_impl<
                implementation_defined::nearest_pow2(sizeof(T), 64),
                (alignof(::max_align_t) > alignof(T)) ? alignof(::max_align_t) : alignof(T)>;
            ...
            */
            ...
            public:
                ...
                */
                ...
                /** Constructor
                    ...
                    @see
                        @ref recycled.
                */
                explicit recycled_ptr(recycled<T>& bin);
                ...
                /** Constructor
                    ...
                    @see
                        ...
                        @ref release.
                */
                recycled_ptr(recycled<T>& bin, std::nullptr_t) noexcept;
                ...
                */
                recycled<T>& bin() const noexcept { return *bin_; }
                ...
                */
                T* get() const noexcept { return &p_->t; }
