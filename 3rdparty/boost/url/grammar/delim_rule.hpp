        ...
        namespace grammar {
            ...
            namespace implementation_defined {
                struct ch_delim_rule
                {
                    ...
                    constexpr ch_delim_rule(char ch) noexcept :
                        ch_(ch)
                    {
                    }
            ...
            /** Match a character literal
                ...
                @see
                    ...
                    @ref squelch.
            */
            constexpr implementation_defined::ch_delim_rule delim_rule(char ch) noexcept
            {
                return { ch };
            }
            ...
            namespace implementation_defined {
                ...
                struct cs_delim_rule
                {
                    ...
                    constexpr cs_delim_rule(CharSet const& cs) noexcept :
                        cs_(cs)
                    {
                    }
                    ...
                    system::result<value_type> parse(char const*& it, char const* end) const noexcept
                    {
                        if (it == end) {
                            // end
                            BOOST_URL_RETURN_EC(error::need_more);
                        }
                        if (!cs_(*it)) {
                            // wrong character
            ...
            */
            ...
            constexpr typename std::
                enable_if<!std::is_convertible<CS, char>::value, implementation_defined::cs_delim_rule<CS>>::type
