    ...
    namespace urls {
        namespace grammar {
            ...
            */
            ...
            system::result<typename R::value_type> parse(char const*& it, char const* end, R const& r);
            ...
            */
            template<BOOST_URL_CONSTRAINT(Rule) R>
            system::result<typename R::value_type> parse(core::string_view s, R const& r);
            ...
            */
            ...
            constexpr typename std::enable_if<
                is_rule<R>::value && !std::is_same<R, implementation_defined::rule_ref<R>>::value,
