        ...
        namespace grammar {
            ...
            namespace implementation_defined {
                ...
                struct token_rule_t
                {
                    ...
                    static_assert(is_charset<CharSet>::value, "CharSet requirements not met");

                    auto parse(char const*& it, char const* end) const noexcept -> system::result<value_type>;

                    constexpr token_rule_t(CharSet const& cs) noexcept :
                        cs_(cs)
                    {
                    }
            ...
            */
            ...
            constexpr auto token_rule(CS const& cs) noexcept -> implementation_defined::token_rule_t<CS>
            {
                return { cs };
            }
