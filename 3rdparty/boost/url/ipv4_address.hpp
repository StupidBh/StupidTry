    ...
    namespace urls {
        ...
        */
        ...
        public:
            ...
            */
            ipv4_address& operator=(ipv4_address const& other) = default;
            ...
            */
            BOOST_URL_DECL
            explicit ipv4_address(core::string_view s);
            ...
            */
            ...
            BOOST_URL_STRTOK_RETURN to_string(StringToken&& token = {}) const
            {
            ...
            */
            BOOST_URL_DECL
            core::string_view to_buffer(char* dest, std::size_t dest_size) const;
            ...
            */
            friend bool operator==(ipv4_address const& a1, ipv4_address const& a2) noexcept
            {
            ...
            */
            static ipv4_address any() noexcept { return ipv4_address(); }

            /** Return an address object that represents the loopback address

                @return The loopback address.
            */
            static ipv4_address loopback() noexcept { return ipv4_address(0x7F000001); }

            /** Return an address object that represents the broadcast address

                @return The broadcast address.
            */
            static ipv4_address broadcast() noexcept { return ipv4_address(0xFFFFFFFF); }
        ...
        private:
            ...
            BOOST_URL_DECL
            void to_string_impl(string_token::arg& t) const;
