...
namespace boost {
    namespace urls {
        ...
        */
        class BOOST_URL_DECL static_url_base : public url_base {
            template<std::size_t>
            friend class static_url;

            ~static_url_base() = default;
            static_url_base(char* buf, std::size_t cap) noexcept;
            static_url_base(char* buf, std::size_t cap, core::string_view s);
            void clear_impl() noexcept override;
            void reserve_impl(std::size_t, op_t&) override;
            void cleanup(op_t&) override;

            void copy(url_view_base const& u) { this->url_base::copy(u); }
        };
        ...
        */
        ...
        public:
            ...
            */
            static_url() noexcept :
                static_url_base(buf_, sizeof(buf_))
            {
            }
            ...
            /** Constructor
                ...
                @li <a href="https://datatracker.ietf.org/doc/html/rfc3986#section-4.1"
                    >4.1. URI Reference</a>
            */
            explicit static_url(core::string_view s) :
                static_url_base(buf_, sizeof(buf_), s)
            {
            }
            ...
            */
            static_url& operator=(static_url const& u) noexcept
            {
                if (this != &u) {
                    copy(u);
                }
            ...
            /** Assignment
                ...
                @return A reference to this object.
            */
            static_url& operator=(url_view_base const& u)
            {
                copy(u);
                return *this;
            }
            ...
            {
                url_base::set_scheme(s);
                return *this;
            }

            /// @copydoc url_base::set_scheme_id
            static_url& set_scheme_id(urls::scheme id)
            {
                url_base::set_scheme_id(id);
                return *this;
            }
            ...
            {
                url_base::set_encoded_authority(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_userinfo(s);
                return *this;
            }
            ...
            {
                url_base::remove_userinfo();
                return *this;
            }

            /// @copydoc url_base::set_user
            static_url& set_user(core::string_view s)
            {
                url_base::set_user(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_user(s);
                return *this;
            }

            /// @copydoc url_base::set_password
            static_url& set_password(core::string_view s)
            {
                url_base::set_password(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_password(s);
                return *this;
            }
            ...
            static_url& set_host(core::string_view s)
            {
                url_base::set_host(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_host(s);
                return *this;
            }

            /// @copydoc url_base::set_host_address
            static_url& set_host_address(core::string_view s)
            {
                url_base::set_host_address(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_host_address(s);
                return *this;
            }
            ...
            {
                url_base::set_host_ipv4(addr);
                return *this;
            }

            /// @copydoc url_base::set_host_ipv6
            static_url& set_host_ipv6(ipv6_address const& addr)
            {
                url_base::set_host_ipv6(addr);
                return *this;
            }

            /// @copydoc url_base::set_zone_id
            static_url& set_zone_id(core::string_view s)
            {
                url_base::set_zone_id(s);
                return *this;
            }

            /// @copydoc url_base::set_encoded_zone_id
            static_url& set_encoded_zone_id(pct_string_view const& s)
            {
                url_base::set_encoded_zone_id(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_host_name(s);
                return *this;
            }
            ...
            static_url& set_path(core::string_view s)
            {
                url_base::set_path(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_path(s);
                return *this;
            }

            /// @copydoc url_base::set_query
            static_url& set_query(core::string_view s)
            {
                url_base::set_query(s);
                return *this;
            }
            ...
            {
                url_base::set_encoded_query(s);
                return *this;
            }

            /// @copydoc url_base::set_params
            static_url& set_params(std::initializer_list<param_view> ps, encoding_opts opts = {})
            {
                url_base::set_params(ps, opts);
                return *this;
            }
            ...
            {
                url_base::set_encoded_fragment(s);
                return *this;
            }
...
namespace std {
    ...
    struct hash<::boost::urls::static_url<N>>
    {
        ...
        explicit hash(std::size_t salt) noexcept :
            salt_(salt)
        {
        }

        std::size_t operator()(::boost::urls::static_url<N> const& u) const noexcept { return u.digest(salt_); }
