...
namespace boost {
    namespace crc_detail {
        ...
        template<>
        struct remap_long_long<unsigned long long>
        {
            ...
            std::conditional<
                ...
                typename std::conditional<
                    ...
                    typename std::conditional<
                        (Bits <= 32),
                        uint_t_32,
                        typename std::conditional<(Bits <= 64), uint_t_64, uint_t_none>::type>::type>::type>::type
        {
        };
...
namespace boost {
    ...
    template<
        std::size_t Bits,
        BOOST_CRC_PARM_TYPE TruncPoly = 0u,
        BOOST_CRC_PARM_TYPE InitRem = 0u,
        BOOST_CRC_PARM_TYPE FinalXor = 0u,
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    typename crc_detail::uint_t<Bits>::fast crc(void const* buffer, std::size_t byte_count);

    //! Compute the CRC of a memory block, with any augmentation provided by user
    template<std::size_t Bits, BOOST_CRC_PARM_TYPE TruncPoly>
    typename crc_detail::uint_t<Bits>::fast augmented_crc(
        void const* buffer,
    ...
    namespace detail {
        ...
        template<int Order, std::uintmax_t TruncatedPolynomial, bool Reflect, int Id = 0>
        class crc_driver;
    ...
    private:
        ...
        typedef detail::possible_reflector<Bits, ReflectRem != ReflectIn> reflect_o_type;
    ...
    namespace detail {
        ...
        struct high_bit_mask_c :
            std::integral_constant<typename boost::crc_detail::uint_t<BitIndex + 1>::fast, (UINTMAX_C(1) << BitIndex)>
        {
        };
        ...
        struct low_bits_mask_c :
            std::integral_constant<
                typename boost::crc_detail::uint_t<BitCount>::fast,
                (BitCount ? ((((UINTMAX_C(1) << (BitCount - 1)) - 1u) << 1) | UINTMAX_C(1)) : 0u)>
        {
        };
        ...
        Unsigned reflect_unsigned(Unsigned x, int word_length = std::numeric_limits<Unsigned>::digits)
        {
            for (Unsigned l = 1u, h = static_cast<Unsigned>(l << (word_length - 1)); h > l; h >>= 1, l <<= 1) {
         ...
         */
        std::array<unsigned char, (UINTMAX_C(1) << CHAR_BIT)> inline make_byte_reflection_table()
        {
        ...
        {
            static std::array<unsigned char, (UINTMAX_C(1) << CHAR_BIT)> const table = make_byte_reflection_table();
        ...
        template<typename Unsigned>
        inline Unsigned
            reflect_optionally(Unsigned x, bool reflect, int word_length = std::numeric_limits<Unsigned>::digits)
        {
        ...
        /** \brief  Possibly reflects the bits of a single byte
            ...
            \return  <code><var>reflect</var> ? reflect_byte(<var>x</var>) :
              <var>x</var></code>
         */
        inline unsigned char reflect_byte_optionally(unsigned char x, bool reflect)
        {
        ...
        void crc_modulo_word_update(
            int register_length,
            Register& remainder,
            Word new_dividend_bits,
            ...
            bool reflect)
        {
            ...
            remainder &=
                (std::numeric_limits<Register>::max)() >> (std::numeric_limits<Register>::digits - register_length);
        }
        ...
        inline void crc_modulo_update(
            int register_length,
            Register& remainder,
            bool new_dividend_bit,
            Register truncated_divisor)
        {
            crc_modulo_word_update(
                register_length,
                remainder,
                static_cast<unsigned>(new_dividend_bit),
                truncated_divisor,
                1,
                false);
        }
         ...
         */
        template<typename Register, typename Word>
        void augmented_crc_modulo_word_update(
            int register_length,
            Register& remainder,
            Word new_dividend_bits,
            Register truncated_divisor,
         ...
         */
        template<typename Register>
        inline void augmented_crc_modulo_update(
            int register_length,
            Register& remainder,
            bool new_dividend_bit,
            Register truncated_divisor)
        ...
        public:
            ...
            /** \brief  Does nothing
                ...
                \return  \a x
             */
            inline static value_type reflect_q(value_type x) { return x; }
        };
        ...
        public:
            ...
            /** \brief  Reflect (part of) the given value
                ...
                \return  ( <var>x</var> &amp;
                  ...
                  1) )
             */
            inline static value_type reflect_q(value_type x) { return reflect_unsigned(x, width_c::value); }
        };
        ...
        public:
            ...
            /** \brief  Reflect (part of) the given value
                ...
                \return  ( <var>x</var> &amp;
                  ...
                  1) )
             */
            inline static value_type reflect_q(value_type x) { return reflect_sub_byte(x, width_c::value); }
        };
        ...
        class reflector :
            public std::conditional<
                (BitLength > CHAR_BIT),
                super_byte_reflector<BitLength>,
                sub_type_reflector<BitLength>>::type {};
        ...
        class possible_reflector : public std::conditional<DoIt, reflector<BitLength>, non_reflector<BitLength>>::type {
        public:
        ...
        std::array<Register, (UINTMAX_C(1) << SubOrder)>
            make_partial_xor_products_table(int register_length, Register truncated_divisor, bool reflect)
        {
            std::array<Register, (UINTMAX_C(1) << SubOrder)> result = { 0 };

            // Loop over every possible dividend value
            for (typename boost::crc_detail::uint_t<SubOrder + 1>::fast dividend = 0u; dividend < result.size();
                 ++dividend) {
                Register remainder = 0u;

                crc_modulo_word_update(register_length, remainder, dividend, truncated_divisor, SubOrder, false);
        ...
        /** \brief  A mix-in class for the table of table-driven CRC algorithms
            ...
            \tparam Reflect  If \c false, read from the highest-order marked
              ...
              proceed from the lowest-order bit and go up.
         */
        template<int Order, int SubOrder, std::uintmax_t TruncatedPolynomial, bool Reflect>
        class crc_table_t {
        public:
            /** \brief  The type to check for register bit length
            ...
            /** \brief  The type to check the divisor
                ...
                divisor.
             */
            typedef std::integral_constant<value_type, TruncatedPolynomial> poly_c;
            ...
            static array_type const& get_table()
            {
                static array_type const table =
                    make_partial_xor_products_table<unit_width_c::value>(width_c::value, poly_c::value, refin_c::value);
        ...
        class direct_byte_table_driven_crcs : public crc_table_t<Order, CHAR_BIT, TruncatedPolynomial, false> {
            typedef crc_table_t<Order, CHAR_BIT, TruncatedPolynomial, false> base_type;
        ...
        public:
             ...
             */
            static value_type augmented_crc_update(
                value_type remainder,
                unsigned char const* new_dividend_bytes,
                std::size_t new_dividend_byte_count)
            {
                ...
                while (new_dividend_byte_count--) {
                    ...
                    unsigned char const index = (remainder >> (Order - CHAR_BIT)) & UCHAR_MAX;
                ...
                std::size_t new_dividend_byte_count)
            {
                ...
                while (new_dividend_byte_count--) {
                    ...
                    unsigned char const index = ((remainder >> (Order - CHAR_BIT)) & UCHAR_MAX) ^ *new_dividend_bytes++;
         ...
         */
        template<int Order, std::uintmax_t TruncatedPolynomial>
        class reflected_byte_table_driven_crcs : public crc_table_t<Order, CHAR_BIT, TruncatedPolynomial, true> {
            typedef crc_table_t<Order, CHAR_BIT, TruncatedPolynomial, true> base_type;
        ...
        public:
                ...
                std::size_t new_dividend_byte_count)
            {
                ...
                while (new_dividend_byte_count--) {
                    ...
                    remainder >>= CHAR_BIT;
                    remainder |= static_cast<value_type>(*new_dividend_bytes++) << (Order - CHAR_BIT);
                    remainder ^= table[index];
                }
                ...
                std::size_t new_dividend_byte_count)
            {
                ...
                while (new_dividend_byte_count--) {
                    // Locates the merged partial product based on comparing the
                    // leading and incoming bytes
                    unsigned char const index = (remainder & UCHAR_MAX) ^ *new_dividend_bytes++;
         ...
         */
        template<int Order, std::uintmax_t TruncatedPolynomial>
        class direct_sub_byte_crcs : public crc_table_t<Order, Order, TruncatedPolynomial, false> {
            typedef crc_table_t<Order, Order, TruncatedPolynomial, false> base_type;
         ...
         */
        template<int Order, std::uintmax_t TruncatedPolynomial>
        class reflected_sub_byte_crcs : public crc_table_t<Order, Order, TruncatedPolynomial, true> {
            typedef crc_table_t<Order, Order, TruncatedPolynomial, true> base_type;
        ...
        /** This class template adds member functions #augmented_crc_update and
            ...
            \tparam Id  An extra differentiator if multiple copies of this class
              template are mixed-in as base classes.  Defaults to 0 if omitted.
         */
        template<int Order, std::uintmax_t TruncatedPolynomial, bool Reflect, int Id>
        class crc_driver :
            public std::conditional<
                (Order < CHAR_BIT),
                sub_byte_crcs<Order, TruncatedPolynomial, Reflect>,
                byte_table_driven_crcs<Order, TruncatedPolynomial, Reflect>>::type {
        public:
            /** \brief  The type to check for ID
     ...
     */
    template<std::size_t Bits>
    inline crc_basic<Bits>::crc_basic(
        value_type truncated_polynomial,
        value_type initial_remainder, // = 0
        value_type final_xor_value,   // = 0
        bool reflect_input,           // = false
     ...
     */
    template<std::size_t Bits>
    inline typename crc_basic<Bits>::value_type crc_basic<Bits>::get_truncated_polynominal() const
    {
        return poly_;
    }
     ...
     */
    template<std::size_t Bits>
    inline typename crc_basic<Bits>::value_type crc_basic<Bits>::get_initial_remainder() const
    {
        return init_;
    }
     ...
     */
    template<std::size_t Bits>
    inline typename crc_basic<Bits>::value_type crc_basic<Bits>::get_final_xor_value() const
    {
        return final_;
    }
     ...
     */
    template<std::size_t Bits>
    inline bool crc_basic<Bits>::get_reflect_input() const
    {
        return rft_in_;
    }
     ...
     */
    template<std::size_t Bits>
    inline bool crc_basic<Bits>::get_reflect_remainder() const
    {
        return rft_out_;
    }
     ...
     */
    template<std::size_t Bits>
    inline typename crc_basic<Bits>::value_type crc_basic<Bits>::get_interim_remainder() const
    {
     ...
     */
    template<std::size_t Bits>
    inline void crc_basic<Bits>::reset(value_type new_rem)
    {
        rem_ = new_rem;
    }
     ...
     */
    template<std::size_t Bits>
    inline void crc_basic<Bits>::reset()
    {
     ...
     */
    template<std::size_t Bits>
    inline void crc_basic<Bits>::process_bit(bool bit)
    {
     ...
     */
    template<std::size_t Bits>
    void crc_basic<Bits>::process_bits(unsigned char bits, std::size_t bit_length)
    {
     ...
     */
    template<std::size_t Bits>
    inline void crc_basic<Bits>::process_byte(unsigned char byte)
    {
     ...
     */
    template<std::size_t Bits>
    void crc_basic<Bits>::process_block(void const* bytes_begin, void const* bytes_end)
    {
     ...
     */
    template<std::size_t Bits>
    inline void crc_basic<Bits>::process_bytes(void const* buffer, std::size_t byte_count)
    {
     ...
     */
    template<std::size_t Bits>
    inline typename crc_basic<Bits>::value_type crc_basic<Bits>::checksum() const
    {
        return ((rft_out_ ? detail::reflect_unsigned(rem_, bit_count) : rem_) ^ final_) &
...
#define BOOST_CRC_OPTIMAL_NAME crc_optimal<Bits, TruncPoly, InitRem, FinalXor, ReflectIn, ReflectRem>
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline BOOST_CRC_OPTIMAL_NAME::crc_optimal(
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename BOOST_CRC_OPTIMAL_NAME::value_type BOOST_CRC_OPTIMAL_NAME::get_truncated_polynominal() const
    {
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename BOOST_CRC_OPTIMAL_NAME::value_type BOOST_CRC_OPTIMAL_NAME::get_initial_remainder() const
    {
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename BOOST_CRC_OPTIMAL_NAME::value_type BOOST_CRC_OPTIMAL_NAME::get_final_xor_value() const
    {
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline bool BOOST_CRC_OPTIMAL_NAME::get_reflect_input() const
    {
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline bool BOOST_CRC_OPTIMAL_NAME::get_reflect_remainder() const
    {
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename BOOST_CRC_OPTIMAL_NAME::value_type BOOST_CRC_OPTIMAL_NAME::get_interim_remainder() const
    {
        // Interim remainder should be _un_-reflected, so we have to undo it.
        return reflect_i_type::reflect_q(rem_) & detail::low_bits_mask_c<bit_count>::value;
    }
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline void BOOST_CRC_OPTIMAL_NAME::reset(
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline void BOOST_CRC_OPTIMAL_NAME::process_byte(unsigned char byte)
    {
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline void BOOST_CRC_OPTIMAL_NAME::process_block(void const* bytes_begin, void const* bytes_end)
    {
        process_bytes(
            bytes_begin,
            static_cast<unsigned char const*>(bytes_end) - static_cast<unsigned char const*>(bytes_begin));
    }
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline void BOOST_CRC_OPTIMAL_NAME::process_bytes(void const* buffer, std::size_t byte_count)
    {
        rem_ = crc_table_type::crc_update(rem_, static_cast<unsigned char const*>(buffer), byte_count);
    }
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename BOOST_CRC_OPTIMAL_NAME::value_type BOOST_CRC_OPTIMAL_NAME::checksum() const
    {
        return (reflect_o_type::reflect_q(rem_) ^ get_final_xor_value()) & detail::low_bits_mask_c<bit_count>::value;
    }
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline void BOOST_CRC_OPTIMAL_NAME::operator()(unsigned char byte)
    {
        process_byte(byte);
    }
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename BOOST_CRC_OPTIMAL_NAME::value_type BOOST_CRC_OPTIMAL_NAME::operator()() const
    {
        return checksum();
    }
    ...
    template<
        ...
        bool ReflectIn,
        bool ReflectRem>
    inline typename crc_detail::uint_t<Bits>::fast crc(void const* buffer, std::size_t byte_count)
    {
    ...
    )
    {
        return detail::low_bits_mask_c<Bits>::value &
               detail::byte_table_driven_crcs<Bits, TruncPoly, false>::augmented_crc_update(
                   initial_remainder,
