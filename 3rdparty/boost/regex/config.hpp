...
#define BOOST_REGEX_DO_JOIN2(X, Y) X##Y
    ...
    #define BOOST_REGEX_FALLTHROUGH BOOST_FALLTHROUGH
        ...
        #endif
    #endif
    #if !defined(BOOST_REGEX_FALLTHROUGH) && defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 1800) && \
        (__cplusplus >= 201703)
...
#if defined(_WIN32) && !defined(BOOST_REGEX_USE_WIN32_LOCALE) && !defined(BOOST_REGEX_USE_C_LOCALE) && \
    !defined(BOOST_REGEX_USE_CPP_LOCALE) && !defined(BOOST_REGEX_NO_W32) && !defined(BOOST_REGEX_NO_WIN32_LOCALE)
    #define BOOST_REGEX_USE_WIN32_LOCALE
#endif
/* otherwise use C++ locale if supported: */
#if !defined(BOOST_REGEX_USE_WIN32_LOCALE) && !defined(BOOST_REGEX_USE_C_LOCALE) && \
    !defined(BOOST_REGEX_USE_CPP_LOCALE) && !defined(BOOST_NO_STD_LOCALE)
    #define BOOST_REGEX_USE_CPP_LOCALE
#endif
/* otherwise use C locale: */
    ...
    #define BOOST_REGEX_MAX_STATE_COUNT 100'000'000
#endif
 ...
 ****************************************************************************/
        ...
        !(defined(__BORLANDC__) && (__BORLANDC__ >= 0x600)) && !(defined(__MWERKS__) && (__MWERKS__ <= 0x3003))
