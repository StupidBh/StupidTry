...
#define SIMPLE_STRING_ARG_LIST B, b
    ...
    inline basic_regex<B> make_regex(
        const ATL::CSimpleStringT<B, b>& s,
    ...
    {
        return ::boost::regex_match(s.GetString(), s.GetString() + s.GetLength(), what, e, f);
    }
    ...
    inline bool regex_match(
        ...
        boost::regex_constants::match_flag_type f = boost::regex_constants::match_default)
    {
        return ::boost::regex_match(s.GetString(), s.GetString() + s.GetLength(), e, f);
    }
    ...
    inline bool regex_search(
        ...
        boost::regex_constants::match_flag_type f = boost::regex_constants::match_default)
    {
        return ::boost::regex_search(s.GetString(), s.GetString() + s.GetLength(), what, e, f);
    }
    ...
    inline bool regex_search(
        ...
        boost::regex_constants::match_flag_type f = boost::regex_constants::match_default)
    {
        return ::boost::regex_search(s.GetString(), s.GetString() + s.GetLength(), e, f);
    }
    ...
    //
    template<class B, bool b>
    inline regex_iterator<B const*> make_regex_iterator(
        const ATL::CSimpleStringT<B, b>& s,
    ...
    template<class B, bool b>
    inline regex_token_iterator<B const*> make_regex_token_iterator(
        const ATL::CSimpleStringT<B, b>& s,
        const basic_regex<B>& e,
        int sub = 0,
        ::boost::regex_constants::match_flag_type f = boost::regex_constants::match_default)
    ...
    ATL::CSimpleStringT<B, b> regex_replace(
        const ATL::CSimpleStringT<B, b>& s,
        const basic_regex<B, traits>& e,
        const ATL::CSimpleStringT<B, b>& fmt,
        match_flag_type flags = match_default)
