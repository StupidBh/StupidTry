...
namespace boost {
    ...
    public:
        ...
        bool operator!=(const u32_to_u16_iterator& that) const { return !(*this == that); }
        ...
        BaseIterator base() const { return m_position; }
        ...
        u32_to_u16_iterator(BaseIterator b) :
            m_position(b),
            m_current(2)
        {
            m_values[0] = 0;
    ...
    public:
        ...
        bool operator==(const u16_to_u32_iterator& that) const { return m_position == that.m_position; }

        bool operator!=(const u16_to_u32_iterator& that) const { return !(*this == that); }
        ...
        u16_to_u32_iterator(BaseIterator b) :
            m_position(b)
        {
            m_value = pending_read;
        }
        ...
        //
        u16_to_u32_iterator(BaseIterator b, BaseIterator start, BaseIterator end) :
            m_position(b)
        {
            m_value = pending_read;
            //
    ...
    public:
        ...
        bool operator!=(const u32_to_u8_iterator& that) const { return !(*this == that); }
        ...
        u32_to_u8_iterator(BaseIterator b) :
            m_position(b),
            m_current(4)
        {
            m_values[0] = 0;
    ...
    public:
        ...
        bool operator==(const u8_to_u32_iterator& that) const { return m_position == that.m_position; }

        bool operator!=(const u8_to_u32_iterator& that) const { return !(*this == that); }
        ...
        u8_to_u32_iterator(BaseIterator b) :
            m_position(b)
        {
            m_value = pending_read;
        }
        ...
        // Checked constructor:
        //
        u8_to_u32_iterator(BaseIterator b, BaseIterator start, BaseIterator end) :
            m_position(b)
        {
            m_value = pending_read;
            //
    ...
    public:
        ...
        const utf16_output_iterator& operator*() const { return *this; }

        void operator=(std::uint32_t val) const { push(val); }

        utf16_output_iterator& operator++() { return *this; }

        utf16_output_iterator& operator++(int) { return *this; }
    ...
    public:
        ...
        const utf8_output_iterator& operator*() const { return *this; }

        void operator=(std::uint32_t val) const { push(val); }

        utf8_output_iterator& operator++() { return *this; }

        utf8_output_iterator& operator++(int) { return *this; }
