...
namespace boost {
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        public:
            ...
            ~raw_storage() { ::operator delete(start); }
            ...
            size_type capacity() { return size_type(last - start); }

            void* data() const { return start; }

            size_type index(void* ptr) { return size_type(static_cast<pointer>(ptr) - static_cast<pointer>(data())); }
