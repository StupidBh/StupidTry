...
namespace boost {
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        {
            static const charT expression_text[4] = {
                '\\',
                's',
                '+',
                '\00',
        ...
        template<class OutputIterator, class charT, class Traits1, class Alloc1>
        bool split_pred<OutputIterator, charT, Traits1, Alloc1>::operator()(const match_results<iterator_type>& what)
        {
    ...
    inline std::size_t regex_split(OutputIterator out, std::basic_string<charT, Traits1, Alloc1>& s)
    {
