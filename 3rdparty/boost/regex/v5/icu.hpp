...
namespace boost {
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        public:
            ...
            U_NAMESPACE_QUALIFIER Locale getloc() const { return m_locale; }

            string_type do_transform(
                const char_type* p1,
                const char_type* p2,
                const U_NAMESPACE_QUALIFIER Collator* pcoll) const
            {
                ...
                if (!t.empty()) {
                    ...
                    len = pcoll->getSortKey(
                        static_cast<UChar const*>(0),
                ...
                if (std::size_t(len) > sizeof(result)) {
                    ...
                    if (!t.empty()) {
                        len =
                            pcoll->getSortKey(&*t.begin(), static_cast<std::int32_t>(t.size()), presult.get(), len + 1);
                    }
                    else {
                        len = pcoll->getSortKey(
                            static_cast<UChar const*>(0),
        ...
        inline std::shared_ptr<icu_regex_traits_implementation>
    ...
    public:
        ...
        {
            return ((c < 0x7f) && (c > 0)) ? BOOST_REGEX_DETAIL_NS::get_default_syntax_type(static_cast<char>(c))
                                           : regex_constants::syntax_char;
        }

        ::boost::regex_constants::escape_syntax_type escape_syntax_type(char_type c) const
        {
            return ((c < 0x7f) && (c > 0)) ? BOOST_REGEX_DETAIL_NS::get_default_escape_syntax_type(static_cast<char>(c))
                                           : regex_constants::syntax_char;
        }
        ...
        char_type translate(char_type c, bool icase) const { return icase ? translate_nocase(c) : translate(c); }

        char_type tolower(char_type c) const { return ::u_tolower(c); }

        char_type toupper(char_type c) const { return ::u_toupper(c); }

        string_type transform(const char_type* p1, const char_type* p2) const { return m_pimpl->transform(p1, p2); }
        ...
        bool isctype(char_type c, char_class_type f) const
        {
            ...
            if (((f & mask_vertical) != 0) &&
                (::boost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == static_cast<char_type>('\v')) ||
                 (m == U_GC_ZL_MASK) || (m == U_GC_ZP_MASK))) {
                return true;
            }
            if (((f & mask_horizontal) != 0) && !::boost::BOOST_REGEX_DETAIL_NS::is_separator(c) && u_isspace(c) &&
                (c != static_cast<char_type>('\v'))) {
                return true;
            }
            return false;
        }
        ...
        int value(char_type c, int radix) const { return u_digit(c, static_cast<std::int8_t>(radix)); }
    ...
    private:
        ...
        static char_class_type lookup_icu_mask(const ::UChar32* p1, const ::UChar32* p2)
        {
            ...
            const BOOST_REGEX_DETAIL_NS::character_pointer_range<::UChar32>* ranges_end =
                range_data + (sizeof(range_data) / sizeof(range_data[0]));

            BOOST_REGEX_DETAIL_NS::character_pointer_range<::UChar32> t = {
                p1,
                p2,
            };
            const BOOST_REGEX_DETAIL_NS::character_pointer_range<::UChar32>* p =
                std::lower_bound(ranges_begin, ranges_end, t);
            if ((p != ranges_end) && (t == *p)) {
...
namespace boost {
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        inline u32regex do_make_u32regex(
            InputIterator i,
            InputIterator j,
...
#define BOOST_REGEX_UCHAR_IS_WCHAR_T (U_ICU_VERSION_MAJOR_NUM < 59 && U_SIZEOF_WCHAR_T == 2)
    ...
    //
    template<class InputIterator>
    inline u32regex make_u32regex(InputIterator i, InputIterator j, boost::regex_constants::syntax_option_type opt)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            i,
            j,
            opt,
            static_cast<std::integral_constant<int, sizeof(*i)> const*>(0));
    }
    ...
    //
    inline u32regex
        make_u32regex(const char* p, boost::regex_constants::syntax_option_type opt = boost::regex_constants::perl)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            p,
            p + std::strlen(p),
            opt,
            static_cast<std::integral_constant<int, 1> const*>(0));
    }

    inline u32regex make_u32regex(
        const unsigned char* p,
        boost::regex_constants::syntax_option_type opt = boost::regex_constants::perl)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            p,
            p + std::strlen(reinterpret_cast<const char*>(p)),
            opt,
            static_cast<std::integral_constant<int, 1> const*>(0));
    }
...
//
    ...
    inline u32regex
        make_u32regex(const wchar_t* p, boost::regex_constants::syntax_option_type opt = boost::regex_constants::perl)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            p,
            p + std::wcslen(p),
            opt,
            static_cast<std::integral_constant<int, sizeof(wchar_t)> const*>(0));
    }
#endif
#if !BOOST_REGEX_UCHAR_IS_WCHAR_T
    inline u32regex
        make_u32regex(const UChar* p, boost::regex_constants::syntax_option_type opt = boost::regex_constants::perl)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            p,
            p + u_strlen(p),
            opt,
            static_cast<std::integral_constant<int, 2> const*>(0));
    }
#endif
    //
        ...
        boost::regex_constants::syntax_option_type opt = boost::regex_constants::perl)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            ...
            s.end(),
            opt,
            static_cast<std::integral_constant<int, sizeof(C)> const*>(0));
    }
    ...
    //
    inline u32regex make_u32regex(
        const U_NAMESPACE_QUALIFIER UnicodeString& s,
        boost::regex_constants::syntax_option_type opt = boost::regex_constants::perl)
    {
        return BOOST_REGEX_DETAIL_NS::do_make_u32regex(
            s.getBuffer(),
            s.getBuffer() + s.length(),
            opt,
            static_cast<std::integral_constant<int, 2> const*>(0));
    }
    ...
    namespace BOOST_REGEX_DETAIL_NS {
            ...
            std::integral_constant<int, 2> const*)
        {
            ...
            match_type what;
            bool result =
                ::boost::regex_match(conv_type(first, first, last), conv_type(last, first, last), what, e, flags);
            // copy results across to m:
            if (result) {
                copy_results(m, what, e.get_named_subs());
            }
            return result;
        }
    ...
    {
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            first,
            last,
            m,
            e,
            flags,
            static_cast<std::integral_constant<int, sizeof(*first)> const*>(0));
    }

    BOOST_REGEX_MODULE_EXPORT inline bool u32regex_match(
        const UChar* p,
    ...
    inline bool
        u32regex_match(BidiIterator first, BidiIterator last, const u32regex& e, match_flag_type flags = match_default)
    {
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_match(const UChar* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const UChar*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            p,
...
#if !BOOST_REGEX_UCHAR_IS_WCHAR_T && !defined(BOOST_NO_WREGEX)
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_match(const wchar_t* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const wchar_t*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            p,
...
#endif
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_match(const char* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const char*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            p,
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_match(const unsigned char* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const unsigned char*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            p,
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_match(const std::string& s, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<std::string::const_iterator> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            s.begin(),
...
#ifndef BOOST_NO_STD_WSTRING
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_match(const std::wstring& s, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<std::wstring::const_iterator> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_match(
            s.begin(),
    ...
    namespace BOOST_REGEX_DETAIL_NS {
            ...
            std::integral_constant<int, 2> const*)
        {
            ...
            // typedef typename match_type::allocator_type        alloc_type;
            match_type what;
            bool result = ::boost::regex_search(
                conv_type(first, first, last),
                conv_type(last, first, last),
                what,
                e,
                flags,
                conv_type(base));
    ...
    inline bool u32regex_search(
        ...
        match_flag_type flags = match_default)
    {
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            first,
            last,
            m,
            e,
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool u32regex_search(
        const UChar* p,
        match_results<const UChar*>& m,
        const u32regex& e,
        match_flag_type flags = match_default)
    ...
    BOOST_REGEX_MODULE_EXPORT template<class BidiIterator>
    inline bool
        u32regex_search(BidiIterator first, BidiIterator last, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<BidiIterator> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            first,
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_search(const UChar* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const UChar*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            p,
...
#if !BOOST_REGEX_UCHAR_IS_WCHAR_T && !defined(BOOST_NO_WREGEX)
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_search(const wchar_t* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const wchar_t*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            p,
...
#endif
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_search(const char* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const char*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            p,
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_search(const unsigned char* p, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<const unsigned char*> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            p,
    ...
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_search(const std::string& s, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<std::string::const_iterator> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            s.begin(),
...
#ifndef BOOST_NO_STD_WSTRING
    BOOST_REGEX_MODULE_EXPORT inline bool
        u32regex_search(const std::wstring& s, const u32regex& e, match_flag_type flags = match_default)
    {
        match_results<std::wstring::const_iterator> m;
        return BOOST_REGEX_DETAIL_NS::do_regex_search(
            s.begin(),
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        {
            return std::pair<boost::u8_to_u32_iterator<I>, boost::u8_to_u32_iterator<I>>(
                boost::u8_to_u32_iterator<I>(i, i, j),
                boost::u8_to_u32_iterator<I>(j, i, j));
        }
        ...
        {
            return std::pair<boost::u16_to_u32_iterator<I>, boost::u16_to_u32_iterator<I>>(
                boost::u16_to_u32_iterator<I>(i, i, j),
                boost::u16_to_u32_iterator<I>(j, i, j));
        }

        template<class I>
        inline std::pair<I, I> make_utf32_seq(I i, I j, std::integral_constant<int, 4> const*)
        {
            ...
            make_utf32_seq(const charT* p, std::integral_constant<int, 1> const*)
        {
            ...
            return std::pair<boost::u8_to_u32_iterator<const charT*>, boost::u8_to_u32_iterator<const charT*>>(
                boost::u8_to_u32_iterator<const charT*>(p, p, p + len),
                boost::u8_to_u32_iterator<const charT*>(p + len, p, p + len));
        }
            ...
            make_utf32_seq(const charT* p, std::integral_constant<int, 2> const*)
        {
            ...
            return std::pair<boost::u16_to_u32_iterator<const charT*>, boost::u16_to_u32_iterator<const charT*>>(
                boost::u16_to_u32_iterator<const charT*>(p, p, p + len),
                boost::u16_to_u32_iterator<const charT*>(p + len, p, p + len));
        }
        ...
        template<class OutputIterator>
        inline utf16_output_iterator<OutputIterator>
            make_utf32_out(OutputIterator o, std::integral_constant<int, 2> const*)
        {
            return o;
        }

        template<class OutputIterator>
        inline utf8_output_iterator<OutputIterator>
            make_utf32_out(OutputIterator o, std::integral_constant<int, 1> const*)
        {
            return o;
        }

        template<class OutputIterator, class I1, class I2>
        OutputIterator do_regex_replace(
            OutputIterator out,
            ...
            match_flag_type flags)
        {
            ...
            if (i == j) {
                ...
                while (i != j) {
                    ...
                    if (!f.empty()) {
                        out = ::boost::BOOST_REGEX_DETAIL_NS::regex_format_imp(
                            out,
                            *i,
                            &*f.begin(),
                            &*f.begin() + f.size(),
    ...
    inline OutputIterator u32regex_replace(
        OutputIterator out,
        ...
        match_flag_type flags = match_default)
    {
        return BOOST_REGEX_DETAIL_NS::extract_output_base(
            BOOST_REGEX_DETAIL_NS::do_regex_replace(
                BOOST_REGEX_DETAIL_NS::make_utf32_out(
                    out,
                    static_cast<std::integral_constant<int, sizeof(*first)> const*>(0)),
                BOOST_REGEX_DETAIL_NS::make_utf32_seq(
                    first,
                    last,
                    static_cast<std::integral_constant<int, sizeof(*first)> const*>(0)),
                e,
                BOOST_REGEX_DETAIL_NS::make_utf32_seq(
                    fmt,
                    static_cast<std::integral_constant<int, sizeof(*fmt)> const*>(0)),
                flags));
    }
        ...
        return BOOST_REGEX_DETAIL_NS::extract_output_base(
            BOOST_REGEX_DETAIL_NS::do_regex_replace(
                ...
                BOOST_REGEX_DETAIL_NS::make_utf32_seq(
                    fmt.begin(),
                    fmt.end(),
                    static_cast<std::integral_constant<int, sizeof(charT)> const*>(0)),
                flags));
    }
        ...
        match_flag_type flags = match_default)
    {
        return BOOST_REGEX_DETAIL_NS::extract_output_base(
            BOOST_REGEX_DETAIL_NS::do_regex_replace(
                ...
                BOOST_REGEX_DETAIL_NS::make_utf32_seq(
                    fmt.getBuffer(),
                    fmt.getBuffer() + fmt.length(),
                    static_cast<std::integral_constant<int, 2> const*>(0)),
                flags));
    }

    BOOST_REGEX_MODULE_EXPORT template<class charT>
    std::basic_string<charT> u32regex_replace(
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        public:
            unicode_string_out_iterator(U_NAMESPACE_QUALIFIER UnicodeString& s) :
                out(&s)
            {
            }
    ...
    inline U_NAMESPACE_QUALIFIER UnicodeString u32regex_replace(
        const U_NAMESPACE_QUALIFIER UnicodeString& s,
        const u32regex& e,
        const UChar* fmt,
        match_flag_type flags = match_default)
