...
#define BOOST_W32_REGEX_TRAITS_HPP_INCLUDED
    ...
    #include <boost/regex/v5/object_cache.hpp>
        ...
        #if defined(STRICT)
            #define BOOST_RE_DETAIL_DECLARE_HANDLE(x) \
                struct x##__;                         \
                typedef struct x##__* x
        #else
...
namespace boost {
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        extern "C"
        {
            ...
            BOOST_RE_IMPORT int BOOST_RE_STDCALL LCMapStringA(
                lcid_type Locale,
                dword dwMapFlags,
                const char* lpSrcStr,
                int cchSrc,
                char* lpDestStr,
                int cchDest);
            BOOST_RE_IMPORT int BOOST_RE_STDCALL LCMapStringW(
                lcid_type Locale,
                dword dwMapFlags,
                ...
                wchar_t* lpDestStr,
                int cchDest);
            BOOST_RE_IMPORT int BOOST_RE_STDCALL MultiByteToWideChar(
            ...
            BOOST_RE_IMPORT int BOOST_RE_STDCALL LCMapStringW(
                ...
                wchar_t* lpDestStr,
                int cchDest);
            BOOST_RE_IMPORT int BOOST_RE_STDCALL WideCharToMultiByte(
                unsigned int CodePage,
                dword dwFlags,
            ...
            BOOST_RE_IMPORT int BOOST_RE_STDCALL GetStringTypeExA(
                lcid_type Locale,
                dword dwInfoType,
                const char* lpSrcStr,
                int cchSrc,
            ...
            BOOST_RE_IMPORT int BOOST_RE_STDCALL
                LoadStringW(HINSTANCE hInstance, unsigned int uID, wchar_t* lpBuffer, int cchBufferMax);
            BOOST_RE_IMPORT int BOOST_RE_STDCALL
                LoadStringA(HINSTANCE hInstance, unsigned int uID, char* lpBuffer, int cchBufferMax);
            BOOST_RE_IMPORT int BOOST_RE_STDCALL
                GetLocaleInfoW(lcid_type Locale, lctype LCType, wchar_t* lpLCData, int cchData);
        }
        ...
        {
            w32_regex_traits_base(lcid_type l) { imbue(l); }
        ...
        public:
            ...
            regex_constants::escape_syntax_type escape_syntax_type(charT c) const
            {
                map_iterator_type i = m_char_map.find(c);
                if (i == m_char_map.end()) {
                    if (::boost::BOOST_REGEX_DETAIL_NS::w32_is_lower(c, this->m_locale)) {
                        return regex_constants::escape_type_class;
                    }
                    if (::boost::BOOST_REGEX_DETAIL_NS::w32_is_upper(c, this->m_locale)) {
            ...
            charT tolower(charT c) const { return ::boost::BOOST_REGEX_DETAIL_NS::w32_tolower(c, this->m_locale); }
            ...
            w32_regex_traits_base<charT>(l)
        {
            ...
            if (cat) {
                for (regex_constants::syntax_type i = 1; i < regex_constants::syntax_max; ++i) {
                    string_type mss =
                        ::boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, i, get_default_message(i));
        ...
        public:
            ...
            regex_constants::syntax_type syntax_type(char c) const { return m_char_map[static_cast<unsigned char>(c)]; }
            ...
            char tolower(char c) const { return m_lower_map[static_cast<unsigned char>(c)]; }

            bool isctype(std::uint32_t mask, char c) const { return m_type_map[static_cast<unsigned char>(c)] & mask; }
        ...
        template<class charT>
        w32_regex_traits_implementation<charT>::w32_regex_traits_implementation(
            ::boost::BOOST_REGEX_DETAIL_NS::lcid_type l) :
            w32_regex_traits_char_layer<charT>(l)
        {
            ...
            if (cat) {
                ...
                for (boost::regex_constants::error_type i = static_cast<boost::regex_constants::error_type>(0);
                    ...
                    string_type s =
                        ::boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, i + 200, default_message);
                    std::string result;
                ...
                for (unsigned int j = 0; j <= 13; ++j) {
                    string_type s(
                        ::boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, j + 300, null_string));
                    if (s.size()) {
        ...
        template<class charT>
        std::shared_ptr<const w32_regex_traits_implementation<charT>>
            create_w32_regex_traits(::boost::BOOST_REGEX_DETAIL_NS::lcid_type l)
        {
            // TODO: create a cache for previously constructed objects.
            return boost::object_cache<
                ::boost::BOOST_REGEX_DETAIL_NS::lcid_type,
                w32_regex_traits_implementation<charT>>::get(l, 5);
        }
    ...
    public:
        ...
        w32_regex_traits() :
            m_pimpl(
                BOOST_REGEX_DETAIL_NS::create_w32_regex_traits<charT>(
                    ::boost::BOOST_REGEX_DETAIL_NS::w32_get_default_locale()))
        {
        }

        static size_type length(const char_type* p) { return std::char_traits<charT>::length(p); }

        regex_constants::syntax_type syntax_type(charT c) const { return m_pimpl->syntax_type(c); }

        regex_constants::escape_syntax_type escape_syntax_type(charT c) const { return m_pimpl->escape_syntax_type(c); }

        charT translate(charT c) const { return c; }

        charT translate_nocase(charT c) const { return this->m_pimpl->tolower(c); }

        charT translate(charT c, bool icase) const { return icase ? this->m_pimpl->tolower(c) : c; }

        charT tolower(charT c) const { return this->m_pimpl->tolower(c); }

        charT toupper(charT c) const { return ::boost::BOOST_REGEX_DETAIL_NS::w32_toupper(c, this->m_pimpl->m_locale); }
        ...
        bool isctype(charT c, char_class_type f) const
        {
            if ((f & BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT>::mask_base) &&
                (this->m_pimpl->isctype(
                    f & BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT>::mask_base,
                    c))) {
                return true;
            }
            else if (
                (f & BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT>::mask_unicode) &&
                BOOST_REGEX_DETAIL_NS::is_extended(c)) {
                return true;
            }
                ...
                (f & BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT>::mask_vertical) &&
                (::boost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v'))) {
                return true;
            }
            else if (
                (f & BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT>::mask_horizontal) &&
                this->isctype(c, 0x0008u) &&
                !this->isctype(c, BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT>::mask_vertical)) {
                return true;
            }
            return false;
        }
        ...
        locale_type getloc() const { return m_pimpl->m_locale; }

        std::string error_string(regex_constants::error_type n) const { return m_pimpl->error_string(n); }
    ...
    namespace BOOST_REGEX_DETAIL_NS {
        ...
        inline unsigned int get_code_page_for_locale_id(lcid_type idx)
        {
            ...
            if (boost::BOOST_REGEX_DETAIL_NS::GetLocaleInfoW(idx, locale_idefaultansicodepage, code_page_string, 7) ==
                0) {
                return 0;
            }
        ...
        inline void w32_regex_traits_char_layer<char>::init()
        {
            ...
            if (cat) {
                for (regex_constants::syntax_type i = 1; i < regex_constants::syntax_max; ++i) {
                    string_type mss =
                        ::boost::BOOST_REGEX_DETAIL_NS::w32_cat_get(cat, this->m_locale, i, get_default_syntax(i));
            ...
            int r = boost::BOOST_REGEX_DETAIL_NS::LCMapStringA(
                this->m_locale,
                lcmap_lowercase,
                char_map,
                1 << CHAR_BIT,
            ...
            int conv_r = boost::BOOST_REGEX_DETAIL_NS::MultiByteToWideChar(
                code_page,
                0,
                char_map,
                1 << CHAR_BIT,
            ...
            int r = boost::BOOST_REGEX_DETAIL_NS::LCMapStringW(
                this->m_locale,
                lcmap_lowercase,
                wide_char_map,
                1 << CHAR_BIT,
            ...
            conv_r = boost::BOOST_REGEX_DETAIL_NS::WideCharToMultiByte(
                code_page,
                0,
                wide_lower_map,
                r,
    ...
    #ifndef BOOST_NO_ANSI_APIS
            r = boost::BOOST_REGEX_DETAIL_NS::GetStringTypeExA(
                this->m_locale,
                ct_ctype1,
                char_map,
                1 << CHAR_BIT,
                this->m_type_map);
    #else
            r = boost::BOOST_REGEX_DETAIL_NS::GetStringTypeExW(
                this->m_locale,
                ct_ctype1,
                wide_char_map,
                1 << CHAR_BIT,
        ...
        inline bool w32_is_lower(char c, lcid_type idx)
        {
            ...
            word mask;
            if (boost::BOOST_REGEX_DETAIL_NS::GetStringTypeExW(idx, ct_ctype1, &wide_c, 1, &mask) &&
                (mask & c1_lower)) {
                return true;
            }
            return false;
        ...
        inline cat_type w32_cat_open(const std::string& name)
        {
            ...
            if (boost::BOOST_REGEX_DETAIL_NS::MultiByteToWideChar(
                    cp_acp,
                    0,
                    name.c_str(),
                    (int)name.size(),
    ...
    #ifndef BOOST_NO_ANSI_APIS
            char buf[256];
            if (0 == boost::BOOST_REGEX_DETAIL_NS::LoadStringA(static_cast<HMODULE>(cat.get()), i, buf, 256)) {
                return def;
            }
    #else
            wchar_t wbuf[256];
            int r = boost::BOOST_REGEX_DETAIL_NS::LoadStringW(static_cast<HMODULE>(cat.get()), i, wbuf, 256);
            if (r == 0) {
                return def;
            }

            int buf_size =
                1 + boost::BOOST_REGEX_DETAIL_NS::WideCharToMultiByte(cp_acp, 0, wbuf, r, NULL, 0, NULL, NULL);
        ...
        inline std::string w32_transform(lcid_type idx, const char* p1, const char* p2)
        {
            ...
            if (boost::BOOST_REGEX_DETAIL_NS::MultiByteToWideChar(code_page, 0, p1, src_len, wide_p1, src_len + 1) ==
                0) {
                return std::string(p1, p2);
            }
        ...
        inline char w32_tolower(char c, lcid_type idx)
        {
            ...
            if (boost::BOOST_REGEX_DETAIL_NS::WideCharToMultiByte(
                    code_page,
                    0,
                    &wide_result,
                    1,
        ...
        inline bool w32_is(lcid_type idx, std::uint32_t m, char c)
        {
            word mask;
    #ifndef BOOST_NO_ANSI_APIS
            if (boost::BOOST_REGEX_DETAIL_NS::GetStringTypeExA(idx, ct_ctype1, &c, 1, &mask) &&
                (mask & m & w32_regex_traits_implementation<char>::mask_base)) {
                return true;
            }
    #else
            unsigned int code_page = get_code_page_for_locale_id(idx);
        ...
        {
            word mask;
            if (boost::BOOST_REGEX_DETAIL_NS::GetStringTypeExW(idx, ct_ctype1, &c, 1, &mask) &&
                (mask & m & w32_regex_traits_implementation<wchar_t>::mask_base)) {
                return true;
            }
