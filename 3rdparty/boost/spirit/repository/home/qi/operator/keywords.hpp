    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                template<typename Subject, typename Action>
                struct is_complex_kwd_parser<spirit::qi::action<Subject, Action>> :
                    detail::has_complex_kwd_parser_id<Subject>
                {
                };

                template<typename Subject>
                struct is_complex_kwd_parser<spirit::qi::hold_directive<Subject>> :
                    detail::has_complex_kwd_parser_id<Subject>
                {
                };
                ...
                struct keywords : spirit::qi::nary_parser<keywords<Elements, Modifiers>>
                {
                    ...
                    struct attribute
                    {
                        ...
                        typedef typename traits::build_attribute_sequence<
                            ...
                            Iterator,
                            spirit::qi::domain>::type all_attributes;

                        // Now, build a fusion vector over the attributes. Note
                        // that build_fusion_vector 1) removes all unused attributes
                        // and 2) may return unused_type if all elements have
                        // unused_type(s).
                        typedef typename traits::build_fusion_vector<all_attributes>::type type;
                    };

                    /// Make sure that all subjects are of the kwd type
                    typedef typename mpl::
                        count_if<Elements, mpl::not_<mpl::or_<is_kwd_parser<mpl::_1>, is_complex_kwd_parser<mpl::_1>>>>
                    ...
                    typedef typename mpl::filter_view<parser_index_vector, is_kwd_parser_filter<mpl::_>>::type
                        string_keyword_indexes;
                    // filter out the complex keywords
                    typedef typename mpl::filter_view<parser_index_vector, is_complex_kwd_parser_filter<mpl::_>>::type
                        complex_keywords_indexes;

                    // typedef typename fusion::filter_view< Elements, is_complex_kwd_parser< mpl::_ > >
                    // complex_keywords_view;

                    typedef typename mpl::if_<
                        typename mpl::empty<complex_keywords_indexes>::type,
                        detail::empty_keywords_list,
                        detail::complex_keywords<complex_keywords_indexes>>::type complex_keywords_type;
                    ...
                    typedef typename mpl::if_<
                        ...
                        detail::empty_keywords_list,
                        detail::
                            string_keywords<Elements, string_keywords, string_keyword_indexes, flags_type, Modifiers>>::
                        ...
                        mpl::true_ /* one pass */) const
                    {
                        ...
                        typedef repository::qi::detail::parse_dispatcher<
                            Elements,
                            Iterator,
                            Context,
                            Skipper,
                        ...
                        parser_visitor_type
                            parse_visitor(elements, first, last, context, skipper, flags, counters, attr);

                        typedef repository::qi::detail::complex_kwd_function<parser_visitor_type>
                            complex_kwd_function_type;

                        complex_kwd_function_type complex_function(first, last, context, skipper, parse_visitor);
                        ...
                        mpl::false_ /* two passes */) const
                    {
                        ...
                        typedef detail::parse_dispatcher<
                            Elements,
                            Iterator,
                            Context,
                            Skipper,
                        ...
                        typedef detail::parse_dispatcher<
                            ...
                            typename traits::wrap_if_not_tuple<Attribute>::type,
                            mpl::true_>
                            no_case_parser_visitor_type;

                        parser_visitor_type
                            parse_visitor(elements, first, last, context, skipper, flags, counters, attr);
                        no_case_parser_visitor_type
                            no_case_parse_visitor(elements, first, last, context, skipper, flags, counters, attr);
                        ...
                        for (;;) {
                            ...
                            if (string_keywords_inst
                                    .parse(first, last, parse_visitor, no_case_parse_visitor, skipper)) {
                                save = first;
                            }
                            else {
                                first = save;
    ...
    namespace spirit {
        namespace qi {
            ...
            struct make_composite<proto::tag::divides, Elements, Modifiers>
            {
                ...
                result_type operator()(Elements ref, unused_type) const { return result_type(ref); }
            };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename Elements, typename Attribute, typename Context, typename Iterator, typename Modifiers>
