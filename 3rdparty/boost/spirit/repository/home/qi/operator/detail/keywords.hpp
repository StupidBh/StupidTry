...
namespace boost {
            ...
            namespace qi {
                namespace detail {
                    ...
                    template<
                        ...
                        typename Attribute,
                        typename NoCasePass>
                    struct parse_dispatcher : public boost::static_visitor<bool>
                    {
                    ...
                    public:
                        ...
                        {
                            Iterator save = first;
                            skipper_keyword_marker<Skipper, NoCasePass> marked_skipper(
                                skipper,
                                flags[Index::value],
                            ...
                            Index& /*idx*/) const
                        {
                            ...
                            skipper_keyword_marker<Skipper, NoCasePass> marked_skipper(
                                ...
                                flags[Index::value],
                                counters[Index::value]);
                            typename fusion::result_of::at_c<typename remove_reference<Attribute>::type, Index::value>::
                                type attr_ = fusion::at_c<Index::value>(attr);
    ...
    #pragma warning(disable: 4127) // conditional expression is constant
                        ...
                        template<typename T>
                        bool call(T& idx, mpl::true_) const
                        {
                            typedef typename mpl::at<Elements, T>::type ElementType;
                            if ((!is_distinct<ElementType>::value) ||
                                skipper.parse(first, last, unused, unused, unused)) {
    ...
    #pragma warning(pop)
                    ...
                    struct string_keywords
                    {
                        ...
                        typedef typename spirit::detail::as_variant<IndexList>::type parser_index_type;
                        ...
                        struct build_char_type_sequence
                        {
                            struct element_char_type
                            {
                                ...
                                typename result<element_char_type(Element)>::type operator()(Element&&) const;
#endif
                            };

                            // Compute the list of character types of the child kwd directives
                            typedef typename fusion::result_of::transform<Sequence, element_char_type>::type type;
                        };
                        ...
                        struct get_keyword_char_type
                        {
                            ...
                            typedef typename mpl::fold<
                                Sequence,
                                mpl::vector<>,
                                mpl::if_<mpl::contains<mpl::_1, mpl::_2>, mpl::_1, mpl::push_back<mpl::_1, mpl::_2>>>::
                                type no_duplicate_char_types;
                        ...
                        typedef typename get_keyword_char_type<typename mpl::if_<
                            mpl::equal_to<typename mpl::size<char_types>::type, mpl::int_<0>>,
                            mpl::vector<boost::spirit::standard::char_type>,
                            char_types>::type>::type char_type;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
                                template<typename Element>
                                typename result<element_case_type(Element)>::type operator()(Element&&) const;
#endif
                            };

                            // Compute the list of character types of the child kwd directives
                            typedef typename fusion::result_of::transform<Sequence, element_case_type>::type type;
                        };
                        ...
                        {
                            // Make sure each of the types occur only once in the type list
                            typedef typename mpl::count_if<Sequence, mpl::equal_to<mpl::_, CaseType>>::type type;
                        };
                        ...
                        typedef typename mpl::and_<
                            ...
                            typename mpl::equal_to<ikwd_count, nb_elements>::type>::type all_ikwd;

                        typedef typename mpl::and_<
                            typename mpl::greater<nb_elements, mpl::int_<0>>::type,
                            typename mpl::equal_to<kwd_count, nb_elements>::type>::type all_kwd;

                        typedef typename mpl::or_<all_kwd, all_ikwd>::type all_directives_of_same_type;

                        // Do we have a no case modifier
                        typedef has_modifier<Modifiers, spirit::tag::char_code_base<spirit::tag::no_case>>
                            no_case_modifier;

                        // Should the no_case filter always be used ?
                        typedef
                            typename mpl::or_<no_case_modifier, mpl::and_<all_directives_of_same_type, all_ikwd>>::type
                                no_case;

                        typedef no_case_filter<
                            typename spirit::detail::
                                get_encoding_with_case<Modifiers, char_encoding::standard, no_case::value>::type>
                            nc_filter;
                        // Determine the standard case filter type
                        typedef typename mpl::if_<no_case, nc_filter, spirit::qi::tst_pass_through>::type
                            first_pass_filter_type;

                        typedef
                            typename mpl::or_<all_directives_of_same_type, no_case_modifier>::type requires_one_pass;
                        ...
                        struct keyword_entry_adder
                        {
                            ...
                            const String
                                get_string(const boost::spirit::qi::literal_string<String, no_attribute>& parser) const
                            {
                                return parser.str;
                            }
                            ...
                            const typename boost::spirit::qi::no_case_literal_string<String, no_attribute>::string_type&
                                get_string(
                                    const boost::spirit::qi::no_case_literal_string<String, no_attribute>& parser) const
                            {
                        ...
                        string_keywords(Elements& elements, FlagsType& flags_init) :
                        ...
                        {
                            if (parser_index_type* val_ptr = lookup->find(first, last, first_pass_filter_type())) {
                        ...
                        template<
                            typename Iterator,
                            typename ParseVisitor,
                            typename NoCaseParseVisitor,
                            typename Skipper>
                        bool parse(
                            Iterator& first,
                            const Iterator& last,
                            ...
                            const Skipper& /*skipper*/) const
                        {
                            ...
                            if (parser_index_type* val_ptr = lookup->find(saved_first, last, nc_filter())) {
                                first = saved_first;
    ...
    #pragma warning(disable: 4512) // assignment operator could not be generated.
                    ...
                    struct complex_kwd_function
                    {
                        ...
                        {
                            Iterator save = first;
                            if (extract_keyword::call(
                                    fusion::at_c<Component::value, typename ParseDispatcher::elements_type>(
                                        dispatcher.elements))
                                    .keyword.parse(first, last, context, skipper, unused)) {
