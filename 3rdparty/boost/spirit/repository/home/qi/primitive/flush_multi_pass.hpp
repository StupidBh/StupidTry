...
namespace boost {
    namespace spirit {
        ...
        template<>
        struct use_terminal<qi::domain, repository::tag::flush_multi_pass> : mpl::true_
        {
        };
    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct flush_multi_pass_parser : spirit::qi::primitive_parser<flush_multi_pass_parser>
                {
