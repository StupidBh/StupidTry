...
namespace boost {
    namespace spirit {
        ...
        template<>
        struct use_lazy_terminal<qi::domain, repository::qi::tag::advance, 1> : mpl::true_
        {
        };
    }
}
    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct advance_parser : boost::spirit::qi::primitive_parser<advance_parser<Int>>
                {
                ...
                private:
                    ...
                    bool advance(Iterator& first, Iterator const& last, IteratorCategory) const
                    {
                        Int n = dist;
                        Iterator i = first;
                        while (n) {
                    ...
                    bool advance(Iterator& first, Iterator const& last, std::random_access_iterator_tag) const
                    {
