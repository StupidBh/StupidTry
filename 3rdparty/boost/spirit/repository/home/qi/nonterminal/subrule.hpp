...
namespace boost {
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct subrule_group_parser : spirit::qi::parser<subrule_group_parser<Defs>>
                {
                    ...
                    {
                        // Forward to first subrule.
                        return parse_subrule(fusion::front(defs).second, first, last, context, skipper, attr);
                    }
                    ...
                    {
                        // Forward to first subrule.
                        return parse_subrule(fusion::front(defs).second, first, last, context, skipper, attr, params);
                    }

                    template<int ID, typename Iterator, typename Context, typename Skipper, typename Attribute>
                    bool parse_subrule_id(
                        Iterator& first,
                        Iterator const& last,
                        Context& context,
                        Skipper const& skipper,
                        Attribute& attr) const
                    {
                        return parse_subrule(def<ID>(), first, last, context, skipper, attr);
                    }
                    ...
                    bool parse_subrule_id(
                        ...
                        Params const& params) const
                    {
                        return parse_subrule(def<ID>(), first, last, context, skipper, attr, params);
                    }
                        ...
                        Attribute& attr) const
                    {
                        ...
                        // rhs parser
                        typedef traits::transform_attribute<Attribute, subrule_attr_type, spirit::qi::domain> transform;
                ...
                struct subrule_group :
                    proto::extends<typename proto::terminal<subrule_group_parser<Defs>>::type, subrule_group<Defs>>
                {
    ...
    #include <boost/spirit/home/qi/nonterminal/detail/fcall.hpp>
                ...
                struct subrule_definition
                {
                    ...
                    typedef spirit::qi::detail::parser_binder<Subject, auto_type> binder_type;
                ...
                struct subrule :
                    proto::extends<
                        typename proto::terminal<spirit::qi::reference<subrule<ID_, T1, T2> const>>::type,
                        subrule<ID_, T1, T2>>,
                    spirit::qi::parser<subrule<ID_, T1, T2>>
                {
                    ...
                    typedef
                        typename spirit::detail::extract_sig<template_params, encoding_type, spirit::qi::domain>::type
                            sig_type;
                    ...
                    struct def_type_helper
                    {
                        ...
                        typedef typename result_of::compile<spirit::qi::domain, Expr>::type subject_type;
                    ...
                    typename group_type_helper<Expr, false>::type operator=(Expr const& expr) const
                    {
                        ...
                        return result_type(
                            fusion::make_map<id_type>(def_type(compile<spirit::qi::domain>(expr), name_)));
                    }
    ...
    #define BOOST_SPIRIT_SUBRULE_MODULUS_ASSIGN_OPERATOR(lhs_ref, rhs_ref)                                        \
        ...
        {                                                                                                         \
            ...
            typedef typename helper::def_type def_type;                                                           \
            typedef typename helper::type result_type;                                                            \
            return result_type(fusion::make_map<id_type>(def_type(compile<spirit::qi::domain>(expr), sr.name_))); \
        }                                                                                                         \
                    /**/
    ...
    #undef BOOST_SPIRIT_SUBRULE_MODULUS_ASSIGN_OPERATOR
                    ...
                    bool parse(
                        ...
                        Attribute& attr) const
                    {
                        return context.group.template parse_subrule_id<ID_>(first, last, context, skipper, attr);
                    }
                        ...
                        Attribute& /*attr*/) const
                    {
                        ...
                        BOOST_SPIRIT_ASSERT_FAIL(Iterator, subrule_used_outside_subrule_group, (id_type));
                        ...
                        Params const& params) const
                    {
                        return context.group
                            .template parse_subrule_id<ID_>(first, last, context, skipper, attr, params);
                    }
