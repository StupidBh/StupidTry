...
namespace boost {
    namespace spirit {
        ...
        // enables *lazy* confix(..., ...)[]
        template<>
        struct use_lazy_directive<qi::domain, repository::tag::confix, 2> : mpl::true_
        {
        };
    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct confix_parser : spirit::qi::unary_parser<confix_parser<Subject, Prefix, Suffix>>
                {
                    ...
                    confix_parser(Subject const& subject, Prefix const& prefix, Suffix const& suffix) :
                        subject(subject),
                        prefix(prefix),
                        suffix(suffix)
                    {
    ...
    namespace spirit {
        namespace qi {
            ...
            struct make_directive<
                ...
                Modifiers>
            {
                typedef typename result_of::compile<qi::domain, Prefix, Modifiers>::type prefix_type;
                typedef typename result_of::compile<qi::domain, Suffix, Modifiers>::type suffix_type;

                typedef repository::qi::confix_parser<Subject, prefix_type, suffix_type> result_type;
