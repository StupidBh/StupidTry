...
namespace boost {
    namespace spirit {
        ...
        struct use_directive<qi::domain, terminal_ex<repository::tag::distinct, fusion::vector1<Tail>>> : mpl::true_
        {
        };

        // enables *lazy* distinct(...)[...]
        template<>
        struct use_lazy_directive<qi::domain, repository::tag::distinct, 1> : mpl::true_
        {
        };
    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct distinct_parser : spirit::qi::unary_parser<distinct_parser<Subject, Tail, Modifier>>
                {
                        ...
                        Attribute& attr) const
                    {
                        ...
                        if (!subject.parse(
                                ...
                                last,
                                context,
                                spirit::qi::detail::unused_skipper<Skipper>(skipper),
                                attr)) {
                            return false;
                        }
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            {
                typedef typename result_of::compile<qi::domain, Tail, Modifiers>::type tail_type;
