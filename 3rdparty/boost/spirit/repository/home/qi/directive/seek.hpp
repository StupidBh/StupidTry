...
namespace boost {
    namespace spirit {
        ...
        // enables seek[...]
        template<>
        struct use_directive<qi::domain, repository::tag::seek> : mpl::true_
        {
        };
    }
} // namespace boost
    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct seek_directive : spirit::qi::unary_parser<seek_directive<Subject>>
                {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject>
            struct has_semantic_action<repository::qi::seek_directive<Subject>> : unary_has_semantic_action<Subject>
            {
            };
