...
namespace boost {
    namespace spirit {
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::kwd // enables kwd(key)[p]
                ,
                fusion::vector1<T>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::ikwd // enables ikwd(key)[p]
                ,
                fusion::vector1<T>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::dkwd // enables dkwd(key)[p]
                ,
                fusion::vector1<T>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::idkwd // enables idkwd(key)[p]
                ,
                fusion::vector1<T>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::kwd // enables kwd(key,exact)[p]
                ,
                fusion::vector2<T1, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::ikwd // enables ikwd(key,exact)[p]
                ,
                fusion::vector2<T1, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::dkwd // enables dkwd(key,exact)[p]
                ,
                fusion::vector2<T1, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::idkwd // enables idkwd(key,exact)[p]
                ,
                fusion::vector2<T1, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::kwd // enables kwd(min, max)[p]
                ,
                fusion::vector3<T1, T2, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::ikwd // enables ikwd(min, max)[p]
                ,
                fusion::vector3<T1, T2, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::dkwd // enables dkwd(min, max)[p]
                ,
                fusion::vector3<T1, T2, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::idkwd // enables idkwd(min, max)[p]
                ,
                fusion::vector3<T1, T2, T2>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::kwd // enables kwd(min, inf)[p]
                ,
                fusion::vector3<T1, T2, inf_type>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::ikwd // enables ikwd(min, inf)[p]
                ,
                fusion::vector3<T1, T2, inf_type>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::dkwd // enables dkwd(min, inf)[p]
                ,
                fusion::vector3<T1, T2, inf_type>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            qi::domain,
            terminal_ex<
                repository::tag::idkwd // enables idkwd(min, inf)[p]
                ,
                fusion::vector3<T1, T2, inf_type>>> : mpl::true_
        {
        };
    ...
    namespace spirit {
        namespace repository {
            namespace qi {
                ...
                struct kwd_parser :
                    spirit::qi::unary_parser<kwd_parser<Subject, KeywordType, LoopIter, NoCase, Distinct>>
                {
                    ...
                    typedef typename remove_const<typename traits::char_type_of<KeywordType>::type>::type char_type;
                    ...
                    struct attribute
                    {
                        typedef typename traits::build_std_vector<
                            typename traits::attribute_of<Subject, Context, Iterator>::type>::type type;
                    };
                    ...
                    {
                        typedef typename traits::attribute_of<Subject, Context, Iterator>::type subject_attribute;

                        typedef typename mpl::and_<
                            traits::is_container<Attribute>,
                            mpl::not_<traits::is_weak_substitute<subject_attribute, Attribute>>>::type predicate;
                ...
                struct complex_kwd_parser :
                    spirit::qi::unary_parser<complex_kwd_parser<Subject, KeywordType, LoopIter, Distinct>>
                {
    ...
    namespace spirit {
        namespace qi {
            ...
            struct make_directive_internal_2_args
            {
                ...
                typedef
                    typename mpl::if_<is_string_kwd_type, T1, typename result_of::compile<qi::domain, T1>::type>::type
                        keyword_type;
                ...
                typedef typename mpl::if_<
                    ...
                    repository::qi::complex_kwd_parser<Subject, const_keyword, iterator_type, Distinct>>::type
                    result_type;
                ...
                {
                    typename spirit::detail::get_encoding<Modifiers, spirit::char_encoding::standard>::type encoding;
                    return result_type(subject, MakeDirectiveHelper::make_iterator(term.args), encoding);
                }
            ...
            struct make_directive_internal
            {
                ...
                typedef typename mpl::
                    if_<is_string_kwd_type, T1, typename result_of::compile<qi::domain, T1, Modifiers>::type>::type
                        keyword_type;
                ...
                result_type create_kwd_string(Terminal const& term, Subject const& subject, boost::mpl::true_) const
                {
                    ...
                    return result_type(subject, fusion::at_c<0>(term.args), iterator_type(), encoding);
                }

                template<typename Terminal>
                result_type create_kwd_string(Terminal const& term, Subject const& subject, boost::mpl::false_) const
                {
                    return result_type(subject, fusion::at_c<0>(term.args), iterator_type());
                }
            ...
            struct make_directive<terminal_ex<repository::tag::ikwd, fusion::vector1<T1>>, Subject, Modifiers>
            {
                ...
                typedef repository::qi::kwd_parser<Subject, const_keyword, iterator_type, mpl::true_, mpl::false_>
                    result_type;
            ...
            struct make_directive<terminal_ex<repository::tag::idkwd, fusion::vector1<T1>>, Subject, Modifiers>
            {
                ...
                typedef repository::qi::kwd_parser<Subject, const_keyword, iterator_type, mpl::true_, mpl::true_>
                    result_type;
            ...
            {
                typedef make_directive_internal_2_args<T1, T2, Subject, Modifiers, mpl::false_, make_exact_helper<T2>>
                    make_directive_type;
                typedef typename make_directive_type::result_type result_type;
            ...
            {
                typedef make_directive_internal_2_args<T1, T2, Subject, Modifiers, mpl::true_, make_exact_helper<T2>>
                    make_directive_type;
            ...
            struct make_directive<terminal_ex<repository::tag::ikwd, fusion::vector2<T1, T2>>, Subject, Modifiers>
            {
                ...
                template<typename Terminal>
                result_type
                    operator()(Terminal const& term, Subject const& subject, Modifiers const& /*modifiers*/) const
                {
                    typename spirit::detail::get_encoding<Modifiers, spirit::char_encoding::standard>::type encoding;
                    return result_type(subject, fusion::at_c<0>(term.args), fusion::at_c<1>(term.args), encoding);
                }
            };
            ...
            {
                typedef make_directive_internal_2_args<T1, T2, Subject, Modifiers, mpl::false_, make_finite_helper<T2>>
                    make_directive_type;
            ...
            {
                typedef make_directive_internal_2_args<T1, T2, Subject, Modifiers, mpl::true_, make_finite_helper<T2>>
                    make_directive_type;
            ...
            struct make_directive<terminal_ex<repository::tag::ikwd, fusion::vector3<T1, T2, T2>>, Subject, Modifiers>
            {
                ...
                result_type operator()(Terminal const& term, Subject const& subject, unused_type) const
                {
                    ...
                    return result_type(
                        subject,
                        fusion::at_c<0>(term.args),
                        iterator_type(fusion::at_c<1>(term.args), fusion::at_c<2>(term.args), encoding));
                }
            };
            ...
            struct make_directive<
                terminal_ex<repository::tag::kwd, fusion::vector3<T1, T2, inf_type>>,
                Subject,
                Modifiers>
            {
                typedef make_directive_internal_2_args<
                    T1,
                    T2,
                    Subject,
                    Modifiers,
            ...
            template<typename T1, typename T2, typename Subject, typename Modifiers>
            struct make_directive<
                terminal_ex<repository::tag::dkwd, fusion::vector3<T1, T2, inf_type>>,
                Subject,
                Modifiers>
            {
                typedef make_directive_internal_2_args<
            ...
            template<typename T1, typename T2, typename Subject, typename Modifiers>
            struct make_directive<
                terminal_ex<repository::tag::ikwd, fusion::vector3<T1, T2, inf_type>>,
                Subject,
                Modifiers>
            {
                typedef typename add_const<T1>::type const_keyword;
            ...
            template<typename T1, typename T2, typename Subject, typename Modifiers>
            struct make_directive<
                terminal_ex<repository::tag::idkwd, fusion::vector3<T1, T2, inf_type>>,
                Subject,
                Modifiers>
            {
                typedef typename add_const<T1>::type const_keyword;
    ...
    namespace spirit {
        namespace traits {
            ...
            struct handles_container<
                ...
                Attribute,
                Context,
                Iterator> : unary_handles_container<Subject, Attribute, Context, Iterator>
            {
            };
