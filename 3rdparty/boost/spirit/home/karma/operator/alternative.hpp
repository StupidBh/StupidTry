...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            {
                typedef typename traits::alternative_properties<Elements>::type properties;
                ...
                {
                    typedef detail::alternative_generate_function<OutputIterator, Context, Delimiter, Attribute, Strict>
                        functor;
            ...
            template<typename Elements>
            struct alternative : base_alternative<Elements, mpl::false_, alternative<Elements>>
            {
            ...
            template<typename Elements>
            struct strict_alternative : base_alternative<Elements, mpl::true_, strict_alternative<Elements>>
            {
            ...
            namespace detail {
                ...
                struct make_alternative : make_nary_composite<Elements, alternative>
                {
                };

                template<typename Elements>
                struct make_alternative<Elements, true> : make_nary_composite<Elements, strict_alternative>
                {
                };
            }
            ...
            struct make_composite<proto::tag::bitwise_or, Elements, Modifiers> :
                detail::make_alternative<Elements, detail::get_stricttag<Modifiers>::value>
            {
            };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Elements>
            struct has_semantic_action<karma::alternative<Elements>> : nary_has_semantic_action<Elements>
            {
            };

            template<typename Elements>
            struct has_semantic_action<karma::strict_alternative<Elements>> : nary_has_semantic_action<Elements>
            {
            };
