    ...
    namespace spirit {
        namespace karma {
            ...
            public:
                ...
                typedef mpl::int_<
                    left_type::properties::value | right_type::properties::value | generator_properties::buffering |
                ...
                struct attribute :
                    traits::build_std_vector<typename traits::attribute_of<Left, Context, Iterator>::type>
                {
                };
                ...
                {
                    return info("list", std::make_pair(left.what(context), right.what(context)));
                }
            ...
            struct list : base_list<Left, Right, mpl::false_, list<Left, Right>>
            {
            ...
            template<typename Left, typename Right>
            struct strict_list : base_list<Left, Right, mpl::true_, strict_list<Left, Right>>
            {
            ...
            namespace detail {
                ...
                struct make_list : make_binary_composite<Subject, list>
                {
                };

                template<typename Subject>
                struct make_list<Subject, true> : make_binary_composite<Subject, strict_list>
                {
                };
            }
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Left, typename Right>
            struct has_semantic_action<karma::list<Left, Right>> : binary_has_semantic_action<Left, Right>
            {
            };

            template<typename Left, typename Right>
            struct has_semantic_action<karma::strict_list<Left, Right>> : binary_has_semantic_action<Left, Right>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Left, typename Right, typename Attribute, typename Context, typename Iterator>
            struct handles_container<karma::list<Left, Right>, Attribute, Context, Iterator> : mpl::true_
            {
            };

            template<typename Left, typename Right, typename Attribute, typename Context, typename Iterator>
            struct handles_container<karma::strict_list<Left, Right>, Attribute, Context, Iterator> : mpl::true_
            {
            };
        }
    }
