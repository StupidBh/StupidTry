...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<karma::domain, tag::char_code<tag::string, CharEncoding>> // enables string
            : mpl::true_
        {
        };

        template<typename T>
        struct use_terminal<karma::domain, T, typename enable_if<traits::is_string<T>>::type> // enables string literals
            : mpl::true_
        {
        };
        ...
        struct use_terminal<
            ...
            terminal_ex<
                ...
                ,
                fusion::vector1<A0>>> : traits::is_string<A0>
        {
        };
        ...
        struct use_terminal<
            ...
            typename enable_if<traits::is_string<A0>>::type> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct any_string : primitive_generator<any_string<CharEncoding, Tag>>
            {
            ...
            struct literal_string : primitive_generator<literal_string<String, CharEncoding, Tag, no_attribute>>
            {
                typedef CharEncoding char_encoding;
                typedef typename remove_const<typename traits::char_type_of<String>::type>::type char_type;
                typedef std::basic_string<char_type> string_type;

                template<typename Context, typename Unused = unused_type>
                struct attribute : mpl::if_c<no_attribute, unused_type, string_type>
                {
                };
            ...
            struct make_primitive<
                terminal_ex<tag::char_code<tag::string, CharEncoding>, fusion::vector1<A0>>,
                Modifiers> : detail::make_string_direct<CharEncoding, Modifiers, A0, false>
            {
            };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename CharEncoding, typename Tag, typename Attribute, typename Context, typename Iterator>
            struct handles_container<karma::any_string<CharEncoding, Tag>, Attribute, Context, Iterator> : mpl::false_
            {
            };
