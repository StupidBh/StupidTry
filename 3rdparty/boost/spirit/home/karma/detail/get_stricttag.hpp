    ...
    namespace spirit {
        namespace karma {
            namespace detail {
                ...
                template<
                    typename Modifiers,
                    typename StrictModifier = typename mpl::
                        or_<has_modifier<Modifiers, tag::strict>, has_modifier<Modifiers, tag::relaxed>>::type>
                ...
                struct get_stricttag<Modifiers, mpl::true_> : has_modifier<Modifiers, tag::strict>
                {
                };
            }
        }
