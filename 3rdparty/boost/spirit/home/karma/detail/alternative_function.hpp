...
namespace boost {
    namespace spirit {
        namespace karma {
            namespace detail {
                ...
                //  the generator
                template<typename Component, typename Attribute, typename Expected, typename Enable = void>
                ...
                struct alternative_generate<
                    ...
                    Attribute,
                    Expected,
                    typename enable_if<traits::compute_compatible_component<Expected, Attribute, karma::domain>>::type>
                {
                    template<typename OutputIterator, typename Context, typename Delimiter>
                    static bool call(
                        Component const& component,
                        ...
                        mpl::false_)
                    {
                        ...
                        (void)component; // suppresses warning: C4100: 'component' : unreferenced formal parameter
#endif
                        typedef traits::compute_compatible_component<Expected, Attribute, domain> component_type;
                        ...
                        return component.generate(sink, ctx, d, boost::get<compatible_type>(attr_));
                    }
                };
    ...
    #pragma warning(disable: 4512) // assignment operator could not be generated.
                ...
                struct alternative_generate_function
                {
                    ...
                    {
                        typedef typename traits::attribute_of<Component, Context>::type expected_type;
                        typedef alternative_generate<Component, Attribute, expected_type> generate;
                    ...
                    {
                        typedef typename traits::attribute_of<Component, Context>::type expected_type;
                        typedef alternative_generate<buffer_directive<Component>, Attribute, expected_type> generate;
                ...
                struct alternative_generate_function<OutputIterator, Context, Delimiter, Attribute, mpl::true_>
                {
                    alternative_generate_function(
                        OutputIterator& sink_,
                        Context& ctx_,
