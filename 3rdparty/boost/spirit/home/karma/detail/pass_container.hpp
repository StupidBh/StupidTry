    ...
    namespace spirit {
        namespace karma {
            namespace detail {
                ...
                struct pass_through_container_base : negate_weak_substitute_if_not<Sequence, ValueType, Attribute>
                {
                };
                ...
                struct pass_through_container<
                    ...
                    Sequence> : mpl::not_<traits::is_weak_substitute<ValueType, Attribute>>
                {
                };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename Container, typename ValueType, typename Attribute, typename Sequence>
            struct pass_through_container<Container, ValueType, Attribute, Sequence, karma::domain> :
                karma::detail::pass_through_container<Container, ValueType, Attribute, Sequence>
            {
            };
        }
    }
...
namespace boost {
    ...
    #pragma warning(disable: 4512) // assignment operator could not be generated.
                ...
                struct pass_container : pass_container_base<Iterator>
                {
                    ...
                    bool is_at_end() const { return traits::compare(this->iter, this->end); }

                    void next() { traits::next(this->iter); }
                    ...
                    bool dispatch_attribute(Component const& component, mpl::true_) const
                    {
                        ...
                        typedef typename traits::attribute_of<Component, context_type>::type lhs_attribute;
                        ...
                        typedef mpl::and_<
                            ...
                            traits::pass_through_container<Attr, value_type, lhs_attribute, Sequence, karma::domain>>
                            predicate;
                    ...
                    bool operator()(Component const& component) const
                    {
                        ...
                        // instead
                        typedef traits::not_is_unused<typename traits::attribute_of<Component, context_type>::type>
                            predicate;
