...
namespace boost {
    namespace spirit {
        ...
        #pragma warning(pop)
                ...
                inline Delimiter const& get_delimiter(unused_delimiter<Delimiter> const& u, Default const&)
                {
                    return u.delimiter;
                }
                ...
                template<typename Delimiter, typename Default>
                inline Default const& get_delimiter(Delimiter const&, Default const& d)
                {
                    return d;
                }
