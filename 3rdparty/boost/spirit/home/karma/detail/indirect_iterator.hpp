        ...
        namespace karma {
            namespace detail {
                ...
                class indirect_iterator :
                    ...
                    typedef typename std::iterator_traits<Iterator>::reference base_reference_type;
                ...
                private:
                    ...
                    bool equal(indirect_iterator const& other) const { return *iter_ == *other.iter_; }

                    base_reference_type dereference() const { return **iter_; }
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename Iterator>
            struct make_indirect_iterator<Iterator const&> : make_indirect_iterator<Iterator const>
            {
            };
        }
    }
