    ...
    namespace spirit {
        namespace karma {
            ...
            struct debug_handler
            {
                ...
                typedef function<bool(output_iterator&, Context&, Delimiter const&)> function_type;
            ...
            void debug(rule<OutputIterator, T1, T2, T3, T4>& r)
            {
                ...
                typedef debug_handler<
                    ...
                    simple_trace>
                    debug_handler;
                typedef typename karma::detail::get_simple_trace<OutputIterator>::type trace;
