...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct parameterized_nonterminal : generator<parameterized_nonterminal<Subject, Params>>
            {
                ...
                bool generate(OutputIterator& sink, Context& context, Delimiter const& delim, Attribute const& attr)
                    const
                {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename Params, typename Attribute, typename Context, typename Iterator>
            struct handles_container<karma::parameterized_nonterminal<Subject, Params>, Attribute, Context, Iterator> :
