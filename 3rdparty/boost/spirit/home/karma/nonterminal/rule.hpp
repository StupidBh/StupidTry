...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct rule :
                proto::extends<
                    typename proto::terminal<reference<rule<OutputIterator, T1, T2, T3, T4> const>>::type,
                ...
                generator<rule<OutputIterator, T1, T2, T3, T4>>
            {
                ...
                typedef detail::output_iterator<OutputIterator, properties> output_iterator;

                // locals_type is a sequence of types to be used as local variables
                typedef typename spirit::detail::extract_locals<template_params>::type locals_type;

                // The delimiter-generator type
                typedef typename spirit::detail::extract_component<karma::domain, template_params>::type delimiter_type;
                ...
                typedef
                    typename spirit::detail::extract_sig<template_params, encoding_type, karma::domain>::type sig_type;
                ...
                typedef function<bool(output_iterator&, context_type&, delimiter_type const&)> function_type;
                ...
                {
                    lhs.f = detail::bind_generator<Auto>(compile<karma::domain>(expr, encoding_modifier_type()));
                }
    ...
    #include <boost/spirit/home/karma/nonterminal/detail/fcall.hpp>
                ...
                operator%=(rule<OutputIterator_, T1_, T2_, T3_, T4_>& r, Expr const& expr)
            {
                ...
                r.f = detail::bind_generator<mpl::true_>(compile<karma::domain>(expr, encoding_modifier_type()));
                return r;
            }
        ...
        namespace traits {
            namespace detail {
                ...
                struct nonterminal_handles_container :
                    mpl::and_<traits::is_container<RuleAttribute>, is_convertible<Attribute, RuleAttribute>>
                {
                };
            }
