...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            inline typename detail::format<Expr>::type format(Expr const& expr)
            {
                ...
                format(Expr const& expr, Attribute const& attr)
            {
                ...
                return format_manip<Expr, mpl::false_, mpl::false_, unused_type, Attribute>(expr, unused, attr);
            }

            ///////////////////////////////////////////////////////////////////////////
            template<typename Expr, typename Delimiter>
            inline typename detail::format_delimited<Expr, Delimiter>::type format_delimited(
                Expr const& expr,
                Delimiter const& d,
            ...
            inline detail::format_manip<Expr, mpl::false_, mpl::false_, Delimiter, Attribute> format_delimited(
                Expr const& xpr,
                Delimiter const& d,
                ...
                Attribute const& attr)
            {
                ...
                return format_manip<Expr, mpl::false_, mpl::false_, Delimiter, Attribute>(xpr, d, pre_delimit, attr);
            }
            ...
            {
                typedef traits::properties_of<typename result_of::compile<karma::domain, Derived>::type> properties;
