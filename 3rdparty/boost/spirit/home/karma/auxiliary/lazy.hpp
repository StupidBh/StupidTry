    ...
    namespace spirit {
        namespace karma {
            ...
            struct lazy_generator : generator<lazy_generator<Function, Modifiers>>
            {
                ...
                struct attribute
                {
                    typedef typename boost::result_of<karma_modify(tag::lazy_eval, Modifiers)>::type modifier;
                    ...
                    typedef typename result_of::compile<karma::domain, expr_type, modifier>::type generator_type;

                    typedef typename traits::attribute_of<generator_type, Context, Iterator>::type type;
                };
                ...
                bool generate(OutputIterator& sink, Context& context, Delimiter const& d, Attribute const& attr) const
                {
                    return detail::lazy_generate_impl_main(
                        compile<karma::domain>(func(unused, context), karma_modify()(tag::lazy_eval(), modifiers)),
                        sink,
                        context,
                        d,
                        attr);
            ...
            struct lazy_directive : unary_generator<lazy_directive<Function, Subject, Modifiers>>
            {
                typedef mpl::int_<generator_properties::all_properties> properties;
                ...
                lazy_directive(Function const& function, Subject const& subject, Modifiers const& modifiers) :
                    function(function),
                    subject(subject),
                    modifiers(modifiers)
                {
                ...
                bool generate(OutputIterator& sink, Context& ctx, Delimiter const& d, Attribute const& attr) const
                {
                    return detail::lazy_generate_impl_main(
                        compile<karma::domain>(
                            proto::make_expr<proto::tag::subscript>(function(unused, ctx), subject),
