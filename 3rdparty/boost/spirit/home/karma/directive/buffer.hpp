    ...
    namespace spirit {
        namespace karma {
            ...
            struct buffer_directive : unary_generator<buffer_directive<Subject>>
            {
                ...
                typedef mpl::int_<subject_type::properties::value | generator_properties::countingbuffer> properties;
            ...
            struct make_directive<tag::buffer, buffer_directive<Subject>, Modifiers>
            {
                ...
                result_type operator()(unused_type, buffer_directive<Subject> const& subject, unused_type) const
                {
                    return subject;
                }
            };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject>
            struct has_semantic_action<karma::buffer_directive<Subject>> : unary_has_semantic_action<Subject>
            {
            };
