    ...
    namespace spirit {
        namespace karma {
            ...
            struct omit_directive : unary_generator<omit_directive<Subject, Execute>>
            {
                ...
                typedef mpl::int_<generator_properties::disabling | subject_type::properties::value> properties;
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, bool Execute>
            struct has_semantic_action<karma::omit_directive<Subject, Execute>> : unary_has_semantic_action<Subject>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, bool Execute, typename Attribute, typename Context, typename Iterator>
