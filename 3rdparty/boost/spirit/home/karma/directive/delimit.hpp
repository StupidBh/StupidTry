...
namespace boost {
    namespace spirit {
        ...
        template<>
        struct use_lazy_directive<karma::domain, tag::delimit, 1> : mpl::true_
        {
        };
        ...
        namespace karma {
            ...
            struct redelimit_generator : unary_generator<redelimit_generator<Subject>>
            {
                ...
                bool generate(OutputIterator& sink, Context& ctx, Delimiter const& d, Attribute const& attr) const
                {
                    ...
                    //  was specified).
                    return subject.generate(sink, ctx, detail::get_delimiter(d, compile<karma::domain>(' ')), attr);
                }
            ...
            struct delimit_generator : unary_generator<delimit_generator<Subject, Delimiter>>
            {
                typedef Subject subject_type;
                ...
                bool generate(OutputIterator& sink, Context& ctx, Delimiter_ const&, Attribute const& attr) const
                {
            ...
            {
                typedef typename result_of::compile<karma::domain, Delimiter, Modifiers>::type delimiter_type;
                ...
                {
                    return result_type(subject, compile<karma::domain>(fusion::at_c<0>(term.args)));
                }
            };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject>
            struct has_semantic_action<karma::redelimit_generator<Subject>> : unary_has_semantic_action<Subject>
            {
            };
            ...
            template<typename Subject, typename Delimiter, typename Attribute, typename Context, typename Iterator>
