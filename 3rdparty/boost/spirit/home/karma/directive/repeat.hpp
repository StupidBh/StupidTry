...
namespace boost {
    namespace spirit {
        ...
        struct use_directive<
            karma::domain,
            terminal_ex<
                tag::repeat // enables repeat(exact)[p]
                ,
        ...
        struct use_directive<
            karma::domain,
            terminal_ex<
                tag::repeat // enables repeat(min, max)[p]
                ,
                fusion::vector2<T, T>>> : mpl::true_
        {
        };
        ...
        struct use_directive<
            karma::domain,
            terminal_ex<
                tag::repeat // enables repeat(min, inf)[p]
                ,
                fusion::vector2<T, inf_type>>> : mpl::true_
        {
        };
...
namespace boost {
    ...
    #pragma warning(pop)
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename LoopIter, typename Strict, typename Derived>
            ...
            public:
                ...
                struct attribute :
                    traits::build_std_vector<typename traits::attribute_of<Subject, Context, Iterator>::type>
                {
                };
                ...
                bool generate(OutputIterator& sink, Context& ctx, Delimiter const& d, Attribute const& attr) const
                {
                    ...
                    typedef detail::pass_container<fail_function, Attribute, indirect_iterator_type, mpl::false_>
                        pass_container;
            ...
            struct repeat_generator :
                base_repeat_generator<Subject, LoopIter, mpl::false_, repeat_generator<Subject, LoopIter>>
            {
                typedef base_repeat_generator<Subject, LoopIter, mpl::false_, repeat_generator> base_repeat_generator_;
            ...
            struct strict_repeat_generator :
                base_repeat_generator<Subject, LoopIter, mpl::true_, strict_repeat_generator<Subject, LoopIter>>
            {
                typedef base_repeat_generator<Subject, LoopIter, mpl::true_, strict_repeat_generator>
            ...
            {
                typedef
                    typename mpl::if_<detail::get_stricttag<Modifiers>, strict_kleene<Subject>, kleene<Subject>>::type
                        result_type;
            ...
            struct make_directive<terminal_ex<tag::repeat, fusion::vector1<T>>, Subject, Modifiers>
            {
                ...
                typedef typename mpl::if_<
                    ...
                    repeat_generator<Subject, iterator_type>>::type result_type;
            ...
            struct make_directive<terminal_ex<tag::repeat, fusion::vector2<T, T>>, Subject, Modifiers>
            {
                ...
                result_type operator()(Terminal const& term, Subject const& subject, unused_type) const
                {
                    return result_type(subject, iterator_type(fusion::at_c<0>(term.args), fusion::at_c<1>(term.args)));
                }
            };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename LoopIter>
            struct has_semantic_action<karma::repeat_generator<Subject, LoopIter>> : unary_has_semantic_action<Subject>
            {
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename LoopIter, typename Attribute, typename Context, typename Iterator>
