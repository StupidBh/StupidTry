...
namespace boost {
    namespace spirit {
        ...
        // enables left_align[]
        template<>
        struct use_directive<karma::domain, tag::left_align> : mpl::true_
        {
        };
        ...
        template<typename T>
        struct use_directive<karma::domain, terminal_ex<tag::left_align, fusion::vector1<T>>> : mpl::true_
        {
        };

        // enables *lazy* left_align(d)[g], where d provides a generator
        template<>
        struct use_lazy_directive<karma::domain, tag::left_align, 1> : mpl::true_
        {
        };
        ...
        // is a maximum width
        template<>
        struct use_lazy_directive<karma::domain, tag::left_align, 2> : mpl::true_
        {
        };
        ...
        namespace karma {
            ...
            namespace detail {
                ...
                template<
                    ...
                    typename Embedded,
                    typename Padding>
                inline static bool left_align_generate(
                    OutputIterator& sink,
                    Context& ctx,
                    Delimiter const& d,
            ...
            struct simple_left_alignment : unary_generator<simple_left_alignment<Subject, Width>>
            {
                typedef Subject subject_type;

                typedef mpl::int_<generator_properties::counting | subject_type::properties::value> properties;
                ...
                {
                    return detail::left_align_generate(sink, ctx, d, attr, subject, width, compile<karma::domain>(' '));
                }
            ...
            struct padding_left_alignment : unary_generator<padding_left_alignment<Subject, Padding, Width>>
            {
                typedef Subject subject_type;
                typedef Padding padding_type;

                typedef mpl::int_<
                    generator_properties::counting | subject_type::properties::value | padding_type::properties::value>
                    properties;
                ...
                padding_left_alignment(Subject const& subject, Padding const& padding, Width width = Width()) :
                    subject(subject),
                    padding(padding),
                    width(width)
                {
                ...
                bool generate(OutputIterator& sink, Context& ctx, Delimiter const& d, Attribute const& attr) const
                {
                    return detail::left_align_generate(sink, ctx, d, attr, subject, width, padding);
                }
            ...
            struct make_directive<
                ...
                typename enable_if<mpl::and_<
                    spirit::traits::matches<karma::domain, Padding>,
                    mpl::not_<mpl::bool_<integer_traits<Padding>::is_integral>>>>::type>
            {
                typedef typename result_of::compile<karma::domain, Padding, Modifiers>::type padding_type;
                ...
                {
                    return result_type(subject, compile<karma::domain>(fusion::at_c<0>(term.args), modifiers));
                }
            };

            // creates left_align(width, pad)[] directive generator
            template<typename Width, typename Padding, typename Subject, typename Modifiers>
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename Width, typename Attribute, typename Context, typename Iterator>
