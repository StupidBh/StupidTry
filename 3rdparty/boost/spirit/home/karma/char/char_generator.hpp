...
namespace boost {
    namespace spirit {
        namespace traits // classification
        {
            namespace detail {
    ...
    namespace spirit {
        namespace karma {
            ...
            template<
                ...
                typename Tag,
                typename Char = typename CharEncoding::char_type,
                typename Attr = Char>
            ...
            struct negated_char_generator :
                char_generator<
                    negated_char_generator<Positive>,
                    typename Positive::char_encoding,
                    typename Positive::tag>
            {
            ...
            namespace detail {
                ...
                struct make_negated_char_generator
                {
                    ...
                    result_type operator()(Positive const& positive) const { return result_type(positive); }
                };
                ...
                struct make_negated_char_generator<negated_char_generator<Positive>>
                {
                    ...
                    result_type operator()(negated_char_generator<Positive> const& ncg) const { return ncg.positive; }
                };
            }
            ...
            {
                typedef typename fusion::result_of::value_at_c<Elements, 0>::type subject;
                ...
                typedef typename detail::make_negated_char_generator<subject>::result_type result_type;

                result_type operator()(Elements const& elements, unused_type) const
                {
                    return detail::make_negated_char_generator<subject>()(fusion::at_c<0>(elements));
                }
            };
