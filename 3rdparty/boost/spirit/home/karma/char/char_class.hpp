...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<karma::domain, tag::char_code<CharClass, CharEncoding>> : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct char_class : char_generator<char_class<Tag, CharEncoding, CharClass>, CharEncoding, CharClass>
            {
                ...
                bool test(unused_type, CharParam&, Context&) const
                {
                    ...
                    BOOST_SPIRIT_ASSERT_FAIL(CharParam, char_class_not_usable_without_attribute, ());
                    return false;
                }
            ...
            struct any_space : char_generator<any_space<CharEncoding>, CharEncoding, tag::space>
            {
            ...
            namespace detail {
                ...
                template<>
                struct make_char_class<tag::alpha, true, false> : mpl::identity<tag::lower>
                {
                };

                template<>
                struct make_char_class<tag::alpha, false, true> : mpl::identity<tag::upper>
                {
                };

                template<>
                struct make_char_class<tag::alnum, true, false> : mpl::identity<tag::lowernum>
                {
                };

                template<>
                struct make_char_class<tag::alnum, false, true> : mpl::identity<tag::uppernum>
                {
                };
            }
            ...
            struct make_primitive<tag::char_code<CharClass, CharEncoding>, Modifiers>
            {
                ...
                typedef tag::char_code<typename detail::make_char_class<CharClass, lower, upper>::type, CharEncoding>
                    tag_type;
