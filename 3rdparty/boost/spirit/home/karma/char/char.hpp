...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<
            ...
            ,
            typename enable_if<traits::is_char<A0>>::type> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            ...
            terminal_ex<
                ...
                ,
                fusion::vector2<A0, A1>>> : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct any_char : char_generator<any_char<CharEncoding, Tag>, CharEncoding, Tag>
            {
            ...
            struct literal_char : char_generator<literal_char<CharEncoding, Tag, no_attribute>, CharEncoding, Tag>
            {
                typedef typename CharEncoding::char_type char_type;
                typedef CharEncoding char_encoding;
                ...
                template<typename Context, typename Unused>
                struct attribute : mpl::if_c<no_attribute, unused_type, char_type>
                {
                };
            ...
            template<typename CharEncoding, typename Tag>
            struct char_range : char_generator<char_range<CharEncoding, Tag>, CharEncoding, Tag>
            {
                typedef typename CharEncoding::char_type char_type;
                typedef CharEncoding char_encoding;
                ...
                bool test(unused_type, CharParam&, Context&) const
                {
                    ...
                    BOOST_SPIRIT_ASSERT_FAIL(CharParam, char_range_not_usable_without_attribute, ());
                    return false;
                }
            ...
            template<typename CharEncoding, typename Tag, bool no_attribute>
            struct char_set : char_generator<char_set<CharEncoding, Tag, no_attribute>, CharEncoding, Tag>
            {
                typedef typename CharEncoding::char_type char_type;
                typedef CharEncoding char_encoding;
                ...
                char_set(String const& str)
                {
                    ...
                    BOOST_SPIRIT_ASSERT_MSG(((sizeof(char_type) == sizeof(in_type))), cannot_convert_string, (String));

                    typedef spirit::char_class::convert<char_encoding> convert_type;

                    char_type const* definition = (char_type const*)traits::get_c_string(str);
                ...
                bool test(unused_type, CharParam&, Context&) const
                {
                    ...
                    // what to output. The following assertion fires if this situation
                    // is detected in your code.
                    BOOST_SPIRIT_ASSERT_FAIL(CharParam, char_set_not_usable_without_attribute, ());
                    return false;
                }
            ...
            namespace detail {
                ...
                struct basic_literal
                {
                    ...
                    typedef literal_char<
                        typename spirit::detail::get_encoding_with_case<Modifiers, Encoding, lower || upper>::type,
            ...
            struct make_primitive<char, Modifiers> : detail::basic_literal<Modifiers, char_encoding::standard>
            {
            };
            ...
            // literals: L'x', L"x"
            template<typename Modifiers>
            struct make_primitive<wchar_t, Modifiers> : detail::basic_literal<Modifiers, char_encoding::standard_wide>
            {
            };
            ...
            struct make_primitive<tag::char_code<tag::char_, CharEncoding>, Modifiers>
            {
                ...
                typedef any_char<
                    typename spirit::detail::get_encoding_with_case<Modifiers, CharEncoding, lower || upper>::type,
            ...
            namespace detail {
                ...
                struct make_char_direct
                {
                    ...
                    typedef
                        typename spirit::detail::get_encoding_with_case<Modifiers, CharEncoding, lower || upper>::type
                            encoding;
                    typedef typename detail::get_casetag<Modifiers, lower || upper>::type tag;

                    typedef typename mpl::if_<
                        traits::is_string<A0>,
                        char_set<encoding, tag, no_attribute>,
                        literal_char<encoding, tag, no_attribute>>::type result_type;
            ...
            struct make_primitive<
                terminal_ex<tag::char_code<tag::char_, CharEncoding>, fusion::vector1<A0>>,
                Modifiers> : detail::make_char_direct<CharEncoding, Modifiers, A0, false>
            {
            };
            ...
            struct make_primitive<
                ...
                detail::make_char_direct<
                    typename traits::char_encoding_from_char<typename traits::char_type_of<A0>::type>::type,
                    Modifiers,
                    A0,
                    true>
            {
            ...
            struct make_primitive<
                terminal_ex<tag::char_code<tag::char_, CharEncoding>, fusion::vector1<Char (&)[2]>> // For single char
                                                                                                    // strings
                ,
                Modifiers>
            {
            ...
            struct make_primitive<
                terminal_ex<tag::char_code<tag::char_, CharEncoding>, fusion::vector2<A0, A1>>,
                Modifiers>
            {
                static bool const lower = has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
                static bool const upper = has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
                ...
                Modifiers>
            {
                ...
                result_type operator()(Terminal const& term, unused_type) const
                {
                    return result_type(fusion::at_c<0>(term.args)[0], fusion::at_c<1>(term.args)[0]);
                }
            };
        }
    }
