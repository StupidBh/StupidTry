    ...
    namespace spirit {
        namespace karma {
            ...
            struct reference : generator<reference<Subject>>
            {
                ...
                bool generate(OutputIterator& sink, Context& context, Delimiter const& delim, unused_type) const
                {
                ...
                bool generate(OutputIterator& sink, unused_type, Delimiter const& delim, unused_type) const
                {
