...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            {
                typedef make_unary_proto_expr<typename Container::value_type, proto::tag::dereference, karma::domain>
                    make_proto_expr;

                typedef typename make_proto_expr::type type;

                static type call() { return make_proto_expr::call(); }
            };
            ...
            struct meta_create_sequence
            {
                ...
                typedef typename mpl::fold<
                    ...
                    mpl::vector<>,
                    mpl::push_back<mpl::_, mpl::_>>::type sequence_type;

                typedef make_nary_proto_expr<sequence_type, proto::tag::shift_left, karma::domain> make_proto_expr;
            ...
            struct meta_create_impl<
                ...
                typename enable_if<mpl::and_<
                    ...
                    mpl::not_<fusion::traits::is_sequence<T>>>>::type> : meta_create_container<T>
            {
            };

            template<typename T>
            struct meta_create_impl<T, typename enable_if<traits::is_string<T>>::type> : meta_create_string<T>
            {
            };
            ...
            struct meta_create_impl<
                T,
                typename enable_if<spirit::detail::is_fusion_sequence_but_not_proto_expr<T>>::type> :
            ...
            {
                typedef make_unary_proto_expr<T, proto::tag::negate, karma::domain> make_proto_expr;
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename T>
            struct meta_create<karma::domain, T> : create_generator<typename spirit::detail::remove_const_ref<T>::type>
            {
            };
            ...
            struct meta_create_exists<karma::domain, T> :
                mpl::not_<is_same<karma::no_auto_mapping_exists, typename meta_create<karma::domain, T>::type>>
            {
            };
        }
    }
