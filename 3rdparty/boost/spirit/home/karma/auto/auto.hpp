...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<
            karma::domain // enables auto_(...)
            ,
            terminal_ex<tag::auto_, fusion::vector1<A0>>> : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct auto_generator : generator<auto_generator<Modifiers>>
            {
            ...
            struct lit_auto_generator : generator<lit_auto_generator<T, Modifiers>>
            {
                typedef mpl::int_<generator_properties::all_properties> properties;
                ...
                // auto_generator has an attached attribute
                template<typename OutputIterator, typename Context, typename Delimiter, typename Attribute>
                bool generate(OutputIterator& sink, Context& context, Delimiter const& d, Attribute const&) const
                {
                ...
                typedef typename spirit::result_of::create_generator<T>::type generator_type;

                typedef typename spirit::result_of::compile<karma::domain, generator_type, Modifiers>::type
                    generator_impl_type;
            ...
            struct make_primitive<tag::auto_, Modifiers>
            {
                ...
                result_type operator()(unused_type, Modifiers const& modifiers) const { return result_type(modifiers); }
            };
