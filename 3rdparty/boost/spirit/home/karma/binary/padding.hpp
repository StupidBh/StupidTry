...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<karma::domain, terminal_ex<tag::pad, fusion::vector1<A0>>> : mpl::true_
        {
        };

        // enables lazy pad(...)
        template<>
        struct use_lazy_terminal<karma::domain, tag::pad, 1> : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct binary_padding_generator : primitive_generator<binary_padding_generator>
            {
