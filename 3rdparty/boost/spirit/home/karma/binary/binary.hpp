...
//  file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
    ...
    #define BOOST_SPIRIT_ENABLE_BINARY(name)                                              \
        ...
        struct use_terminal<karma::domain, terminal_ex<tag::name, fusion::vector1<A0>>> : \
    ...
    #define BOOST_SPIRIT_ENABLE_BINARY_IEEE754(name)                                                            \
        ...
        {                                                                                                       \
                                                                                                                ...
                                                                                                                \
        template<typename A0>                                                                                   \
        struct use_terminal<karma::domain, terminal_ex<tag::name, fusion::vector1<A0>>> : is_floating_point<A0> \
        {                                                                                                       \
        };                                                                                                      \
                                                                                                                \
        template<>                                                                                              \
...
namespace boost {
    namespace spirit {
            ...
            namespace detail {
                ...
                struct integer
                {
                    ...
                    BOOST_SPIRIT_ASSERT_MSG(
                        ...
                        ());
    #else
                    BOOST_SPIRIT_ASSERT_MSG(bits == 8 || bits == 16 || bits == 32, not_supported_binary_size, ());
    #endif
                };
                ...
                {
                    BOOST_SPIRIT_ASSERT_MSG(bits == 32 || bits == 64, not_supported_binary_size, ());
                };
                ...
                {
                    static info is() { return info("little-endian binary"); }
                };

                template<>
                struct what<boost::endian::order::big>
                {
                    static info is() { return info("big-endian binary"); }
                };
            }

            ///////////////////////////////////////////////////////////////////////////
            template<typename T, BOOST_SCOPED_ENUM(boost::endian::order) endian, int bits>
            struct any_binary_generator : primitive_generator<any_binary_generator<T, endian, bits>>
            {
        ...
        #pragma warning(pop)
                ...
                static bool generate(OutputIterator&, Context&, Delimiter const&, unused_type)
                {
                    ...
                    BOOST_SPIRIT_ASSERT_FAIL(OutputIterator, binary_generator_not_usable_without_attribute, ());
                    return false;
                }
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename T, BOOST_SCOPED_ENUM(boost::endian::order) endian, int bits>
            struct literal_binary_generator : primitive_generator<literal_binary_generator<T, endian, bits>>
            {
        ...
        #pragma warning(pop)
                ...
                typedef boost::endian::endian_arithmetic<endian, typename T::type, bits> data_type;
            ...
            namespace detail {
                ...
                template<typename Modifiers, typename T, BOOST_SCOPED_ENUM(boost::endian::order) endian, int bits>
    ...
    #define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)                                             \
        ...
        struct make_primitive<tag::name, Modifiers> :                                                              \
            detail::basic_binary<detail::integer<bits>, boost::endian::order::endiantype, bits>                    \
        {                                                                                                          \
        };                                                                                                         \
                                                                                                                   \
        template<typename Modifiers, typename A0>                                                                  \
        struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0>>, Modifiers> :                            \
            detail::basic_binary_literal<Modifiers, detail::integer<bits>, boost::endian::order::endiantype, bits> \
        {                                                                                                          \
        };                                                                                                         \
                                                                                                                   \
        /***/
    ...
    #define BOOST_SPIRIT_MAKE_BINARY_IEEE754_PRIMITIVE(name, endiantype, bits)                                        \
        template<typename Modifiers>                                                                                  \
        struct make_primitive<tag::name, Modifiers> :                                                                 \
            detail::basic_binary<detail::floating_point<bits>, boost::endian::order::endiantype, bits>                \
        {                                                                                                             \
        };                                                                                                            \
                                                                                                                      \
        template<typename Modifiers, typename A0>                                                                     \
        struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0>>, Modifiers> :                               \
            detail::                                                                                                  \
                basic_binary_literal<Modifiers, detail::floating_point<bits>, boost::endian::order::endiantype, bits> \
        {                                                                                                             \
        };                                                                                                            \
                                                                                                                      \
        /***/
