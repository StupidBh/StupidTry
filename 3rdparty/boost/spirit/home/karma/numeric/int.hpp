...
namespace boost {
    namespace spirit {
        ...
        namespace karma {
            ...
            struct int_generator : spirit::terminal<tag::int_generator<T, Radix, force_sign>>
            {
            };
        }
        ...
        struct use_terminal<
            karma::domain // enables short_(...)
            ,
            terminal_ex<tag::short_, fusion::vector1<A0>>> : mpl::true_
        {
        };

        template<typename A0>
        struct use_terminal<
            karma::domain // enables int_(...)
            ,
            terminal_ex<tag::int_, fusion::vector1<A0>>> : mpl::true_
        {
        };

        template<typename A0>
        struct use_terminal<
            karma::domain // enables long_(...)
            ,
            terminal_ex<tag::long_, fusion::vector1<A0>>> : mpl::true_
        {
        };
        ...
        template<typename A0>
        struct use_terminal<
            karma::domain // enables long_long(...)
            ,
            terminal_ex<tag::long_long, fusion::vector1<A0>>> : mpl::true_
        {
        };
    #endif
        ...
        struct use_lazy_terminal<karma::domain, tag::short_, 1> : mpl::true_
        {
        };

        template<> // enables *lazy* int_(...)
        struct use_lazy_terminal<karma::domain, tag::int_, 1> : mpl::true_
        {
        };

        template<> // enables *lazy* long_(...)
        struct use_lazy_terminal<karma::domain, tag::long_, 1> : mpl::true_
        {
        };

    #ifdef BOOST_HAS_LONG_LONG
        template<> // enables *lazy* long_long(...)
        struct use_lazy_terminal<karma::domain, tag::long_long, 1> : mpl::true_
        {
        };
    #endif
        ...
        template<typename T, unsigned Radix, bool force_sign>
        struct use_terminal<karma::domain, tag::int_generator<T, Radix, force_sign>> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            ...
            typename enable_if<traits::is_int<A0>>::type> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename T, typename CharEncoding, typename Tag, unsigned Radix, bool force_sign>
            struct any_int_generator : primitive_generator<any_int_generator<T, CharEncoding, Tag, Radix, force_sign>>
            {
            private:
                ...
                static bool insert_int(OutputIterator& sink, Attribute const& attr)
                {
                    return sign_inserter::call(
                               sink,
                               traits::test_zero(attr),
                               traits::test_negative(attr),
                               force_sign) &&
            ...
            public:
                ...
                BOOST_SPIRIT_ASSERT_MSG(std::numeric_limits<T>::is_signed, signed_unsigned_mismatch, ());
            ...
            struct literal_int_generator :
                primitive_generator<literal_int_generator<T, CharEncoding, Tag, Radix, force_sign, no_attribute>>
            {
            private:
                template<typename OutputIterator, typename Attribute>
                static bool insert_int(OutputIterator& sink, Attribute const& attr)
            ...
            struct make_primitive<tag::short_, Modifiers> : detail::make_int<short, Modifiers>
            {
            };

            template<typename Modifiers>
            struct make_primitive<tag::int_, Modifiers> : detail::make_int<int, Modifiers>
            {
            };

            template<typename Modifiers>
            struct make_primitive<tag::long_, Modifiers> : detail::make_int<long, Modifiers>
            {
            };

    #ifdef BOOST_HAS_LONG_LONG
            template<typename Modifiers>
            struct make_primitive<tag::long_long, Modifiers> : detail::make_int<boost::long_long_type, Modifiers>
            {
            };
    #endif
            ...
            struct make_primitive<tag::int_generator<T, Radix, force_sign>, Modifiers> :
                detail::make_int<typename remove_const<T>::type, Modifiers, Radix, force_sign>
            {
            };
            ...
            template<typename T, unsigned Radix, bool force_sign, typename A0, typename Modifiers>
            struct make_primitive<
                terminal_ex<tag::int_generator<T, Radix, force_sign>, fusion::vector1<A0>>,
                Modifiers> : detail::make_int_direct<typename remove_const<T>::type, Modifiers, Radix, force_sign>
            {
            };
            ...
            template<typename Modifiers>
            struct make_primitive<short, Modifiers> : detail::basic_int_literal<short, Modifiers>
            {
            };

            template<typename Modifiers>
            struct make_primitive<int, Modifiers> : detail::basic_int_literal<int, Modifiers>
            {
            };

            template<typename Modifiers>
            struct make_primitive<long, Modifiers> : detail::basic_int_literal<long, Modifiers>
            {
            };
