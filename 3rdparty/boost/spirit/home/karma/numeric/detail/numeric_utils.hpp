...
namespace boost {
    ...
    #define BOOST_SPIRIT_ABSOLUTE_VALUE(signedtype, unsignedtype)               \
        ...
        {                                                                       \
            ...
            {                                                                   \
                ...
                return (n >= 0) ? static_cast<type>(n) : -static_cast<type>(n); \
            }                                                                   \
        } /**/
    #define BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsignedtype) \
        ...
        {                                                      \
            typedef unsignedtype type;                         \
            static type call(unsignedtype n) { return n; }     \
        } /**/
    ...
    #undef BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED
            ...
            struct absolute_value<float>
            {
                ...
                static type call(float n) { return (std::fabs)(n); }
            };
            ...
            struct absolute_value<double>
            {
                ...
                static type call(double n) { return (std::fabs)(n); }
            };
            ...
            struct absolute_value<long double>
            {
                ...
                static type call(long double n) { return (std::fabs)(n); }
            };
            ...
            struct absolute_value<T*>
            {
                ...
                static type call(T* p) { return std::size_t(p); }
            };

            template<typename T>
            inline typename absolute_value<T>::type get_absolute_value(T n)
            {
            ...
            struct is_negative
            {
                static bool call(T n) { return (n < 0) ? true : false; }
            };

            template<>
            struct is_negative<float>
            {
                static bool call(float n) { return (core::signbit)(n) ? true : false; }
            };

            template<>
            struct is_negative<double>
            {
                static bool call(double n) { return (core::signbit)(n) ? true : false; }
            };

            template<>
            struct is_negative<long double>
            {
                static bool call(long double n) { return (core::signbit)(n) ? true : false; }
            };
            ...
            {
                static bool call(float n) { return (core::fpclassify)(n) == core::fp_zero; }
            };

            template<>
            struct is_zero<double>
            {
                static bool call(double n) { return (core::fpclassify)(n) == core::fp_zero; }
            };

            template<>
            struct is_zero<long double>
            {
                static bool call(long double n) { return (core::fpclassify)(n) == core::fp_zero; }
            };
            ...
            struct is_nan<float>
            {
                static bool call(float n) { return (core::fpclassify)(n) == core::fp_nan; }
            };

            template<>
            struct is_nan<double>
            {
                static bool call(double n) { return (core::fpclassify)(n) == core::fp_nan; }
            };

            template<>
            struct is_nan<long double>
            {
                static bool call(long double n) { return (core::fpclassify)(n) == core::fp_nan; }
            };
            ...
            struct is_infinite
            {
                static bool call(T n)
                {
                    return std::numeric_limits<T>::has_infinity && n == std::numeric_limits<T>::infinity();
                }
            };
            ...
            {
                static bool call(float n) { return (core::fpclassify)(n) == core::fp_infinite; }
            };

            template<>
            struct is_infinite<double>
            {
                static bool call(double n) { return (core::fpclassify)(n) == core::fp_infinite; }
            };

            template<>
            struct is_infinite<long double>
            {
                static bool call(long double n) { return (core::fpclassify)(n) == core::fp_infinite; }
            };
            ...
            struct cast_to_long
            {
                static long call(float n, mpl::false_) { return static_cast<long>(std::floor(n)); }

                static long call(double n, mpl::false_) { return static_cast<long>(std::floor(n)); }

                static long call(long double n, mpl::false_) { return static_cast<long>(std::floor(n)); }
            ...
            struct truncate_to_long
            {
                ...
                {
                    return test_negative(n) ? static_cast<long>(std::ceil(n)) : static_cast<long>(std::floor(n));
                }
            ...
            namespace detail {
                ...
                {
                    static int call(unsigned n) { return n + '0'; }
                };
            }

            template<unsigned Radix, typename CharEncoding, typename Tag>
            struct convert_digit : detail::convert_digit<CharEncoding, Tag, (Radix <= 10) ? true : false>
            {
            };
...
namespace boost {
    ...
    #define BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX(z, x, n_rolls_sub1)  \
        *sink = char(BOOST_PP_CAT(ch_, BOOST_PP_SUB(n_rolls_sub1, x))); \
        ++sink;                                                         \
            ...
            template<unsigned Radix, typename CharEncoding = unused_type, typename Tag = unused_type>
            struct int_inserter
            {
                ...
                static bool call(OutputIterator& sink, T n, T& num, int exp)
                {
                    ...
                    BOOST_PP_REPEAT(BOOST_KARMA_NUMERICS_LOOP_UNROLL, BOOST_KARMA_NUMERICS_INNER_LOOP_PREFIX, _);
                ...
                template<typename OutputIterator, typename T>
                static bool call(OutputIterator& sink, T n)
                {
            ...
            private:
                ...
                static biggest_long_type max_long() { return (std::numeric_limits<biggest_long_type>::max)(); }
            ...
            public:
                ...
                static bool call(OutputIterator& sink, long double n)
                {
                ...
                template<typename OutputIterator>
                static bool call(OutputIterator& sink, double n)
                {
                    if (std::fabs(n) < max_long()) {
                        biggest_long_type l((biggest_long_type)n);
                        return call(sink, l, l, 0);
                ...
                template<typename OutputIterator>
                static bool call(OutputIterator& sink, float n)
                {
                    if (std::fabs(n) < max_long()) {
                        biggest_long_type l((biggest_long_type)n);
                        return call(sink, l, l, 0);
    ...
    #undef BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX
            ...
            struct uint_inserter : int_inserter<Radix, CharEncoding, Tag>
            {
                ...
                //  Common code for integer string representations
                template<typename OutputIterator, typename T>
                static bool call(OutputIterator& sink, T const& n)
                {
            ...
            {
                template<typename OutputIterator>
                static bool call_noforce(OutputIterator& sink, bool is_zero, bool is_negative, bool sign_if_zero)
                {
                ...
                template<typename OutputIterator>
                static bool call_force(OutputIterator& sink, bool is_zero, bool is_negative, bool sign_if_zero)
                {
                ...
                static bool call(
                    ...
                    bool is_negative,
                    bool forcesign,
                    bool sign_if_zero = false)
                {
                    return forcesign ? call_force(sink, is_zero, is_negative, sign_if_zero)
