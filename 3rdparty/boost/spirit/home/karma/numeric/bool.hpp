...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct bool_generator : spirit::terminal<tag::stateful_tag<Policies, tag::bool_, T>>
            {
        ...
        struct use_terminal<
            karma::domain // enables bool_(...)
            ,
            terminal_ex<tag::bool_, fusion::vector1<A0>>> : mpl::true_
        {
        };

        template<> // enables *lazy* bool_(...)
        struct use_lazy_terminal<karma::domain, tag::bool_, 1> : mpl::true_
        {
        };
        ...
        struct use_terminal<karma::domain, tag::stateful_tag<Policies, tag::bool_, T>> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            karma::domain,
            terminal_ex<tag::stateful_tag<Policies, tag::bool_, T>, fusion::vector1<A0>>> : mpl::true_
        {
        };

        // enables *lazy* custom bool_generator
        template<typename Policies, typename T>
        struct use_lazy_terminal<karma::domain, tag::stateful_tag<Policies, tag::bool_, T>, 1> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            ...
            typename enable_if<traits::is_bool<A0>>::type> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace karma {
            ...
            struct any_bool_generator : primitive_generator<any_bool_generator<T, CharEncoding, Tag, Policies>>
            {
            public:
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename T, typename CharEncoding, typename Tag, typename Policies, bool no_attribute>
            struct literal_bool_generator :
                primitive_generator<literal_bool_generator<T, CharEncoding, Tag, Policies, no_attribute>>
            {
            public:
                typedef typename Policies::properties properties;
                ...
                literal_bool_generator(typename add_const<T>::type n, Policies const& p = Policies()) :
                    n_(n),
                    p_(p)
                {
                }
                ...
                bool generate(OutputIterator& sink, Context& context, Delimiter const& d, Attribute const& attr) const
                {
                    ...
                    return bool_inserter<T, Policies, CharEncoding, Tag>::call(sink, n_, p_) && delimit_out(sink, d);
                }
                ...
                {
                    return bool_inserter<T, Policies, CharEncoding, Tag>::call(sink, n_) && delimit_out(sink, d);
                }
            ...
            ///////////////////////////////////////////////////////////////////////////
            namespace detail {
                template<typename Modifiers, typename T = bool, typename Policies = bool_policies<T>>
                struct make_bool
                {
                ...
                struct make_bool_literal
                {
                    ...
                    result_type operator()(unused_type, unused_type) const { return result_type(b); }
                };
            }

            ///////////////////////////////////////////////////////////////////////////
            template<typename Modifiers>
            struct make_primitive<tag::bool_, Modifiers> : detail::make_bool<Modifiers>
            {
            };

            template<typename Modifiers>
            struct make_primitive<tag::true_, Modifiers> : detail::make_bool_literal<Modifiers, true>
            {
            };

            template<typename Modifiers>
            struct make_primitive<tag::false_, Modifiers> : detail::make_bool_literal<Modifiers, false>
            {
            };
            ...
            struct make_primitive<tag::stateful_tag<Policies, tag::bool_, T>, Modifiers> :
                detail::make_bool<Modifiers, typename remove_const<T>::type, Policies>
            {
            };
            ...
            namespace detail {
                ...
                struct make_bool_direct
                {
                    ...
                    result_type operator()(Terminal const& term, unused_type) const
                    {
                        typedef tag::stateful_tag<Policies, tag::bool_, T> tag_type;
                        using spirit::detail::get_stateful_data;
                        return result_type(fusion::at_c<0>(term.args), get_stateful_data<tag_type>::call(term.term));
                    }
                };
            }
            ...
            struct make_primitive<
                terminal_ex<tag::stateful_tag<Policies, tag::bool_, T>, fusion::vector1<A0>>,
                Modifiers> : detail::make_bool_direct<Modifiers, typename remove_const<T>::type, Policies>
            {
            };
            ...
            template<typename Modifiers>
            struct make_primitive<bool, Modifiers> : detail::basic_bool_literal<Modifiers>
            {
            };
            ...
            struct make_primitive<
                terminal_ex<tag::lit, fusion::vector1<A0>>,
                Modifiers,
                typename enable_if<traits::is_bool<A0>>::type> : detail::basic_bool_literal<Modifiers>
            {
                static bool const lower = has_modifier<Modifiers, tag::char_code_base<tag::lower>>::value;
                static bool const upper = has_modifier<Modifiers, tag::char_code_base<tag::upper>>::value;
