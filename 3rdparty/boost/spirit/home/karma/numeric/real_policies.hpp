    ...
    namespace spirit {
        namespace karma {
            ...
            struct real_policies
            {
                ...
                //            this number.
                ///////////////////////////////////////////////////////////////////////
                static bool force_sign(T) { return false; }
                ...
                static int floatfield(T n)
                {
                    ...
                    return (abs_n >= 1e5 || abs_n < 1e-3) ? fmtflags::scientific : fmtflags::fixed;
                }
                ...
                {
                    return sign_inserter::call(sink, traits::test_zero(n), sign, force_sign, force_sign) &&
                ...
                static bool exponent(OutputIterator& sink, long n)
                {
                    ...
                    bool r = char_inserter<CharEncoding, Tag>::call(sink, 'e') &&
                             sign_inserter::call(sink, traits::test_zero(n), traits::test_negative(n), false);
                ...
                {
                    return sign_inserter::call(sink, false, traits::test_negative(n), force_sign) &&
