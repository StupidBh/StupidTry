...
namespace boost {
    namespace spirit {
        template<typename T>
        struct use_terminal<karma::domain, T, typename enable_if<traits::is_generator<T>>::type> // enables generators
            : mpl::true_
        {
        };
        ...
        namespace karma {
            ...
            template<typename Tag, typename Elements, typename Modifiers, typename Enable = void>
            struct make_composite;

            template<typename Directive, typename Body, typename Modifiers, typename Enable = void>
        ...
        struct make_component<karma::domain, proto::tag::terminal>
        {
            ...
            struct result<This(Elements, Modifiers)>
            {
                typedef typename karma::make_primitive<
                    ...
                    typename remove_reference<Modifiers>::type>::result_type type;
            };
        ...
        struct make_component<karma::domain, Tag>
        {
            ...
            struct result<This(Elements, Modifiers)>
            {
                typedef typename karma::make_composite<Tag, Elements, typename remove_reference<Modifiers>::type>::
                    result_type type;
            };
            ...
            typename result<make_component(Elements, Modifiers)>::type
                operator()(Elements const& elements, Modifiers const& modifiers) const
            {
                return karma::make_composite<Tag, Elements, Modifiers>()(elements, modifiers);
            }
        };
        ...
        struct make_component<karma::domain, proto::tag::function>
        {
            ...
            struct result<This(Elements, Modifiers)>
            {
                typedef typename karma::make_composite<
                    typename remove_const<typename Elements::car_type>::type,
        ...
        struct make_component<karma::domain, tag::directive>
        {
            ...
            struct result<This(Elements, Modifiers)>
            {
                typedef typename karma::make_directive<
                    typename remove_const<typename Elements::car_type>::type,
