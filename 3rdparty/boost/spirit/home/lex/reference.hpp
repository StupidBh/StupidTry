...
namespace boost {
    namespace spirit {
        namespace lex {
            ...
            struct reference<Subject, unused_type> : qi::reference<Subject>, lexer_type<reference<Subject>>
            {
            ...
            struct reference : reference<Subject>
            {
                ...
                IdType id() const { return this->ref.get().id(); }

                std::size_t unique_id() const { return this->ref.get().unique_id(); }

                std::size_t state() const { return this->ref.get().state(); }
            };
        }
    }
}
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename IdType, typename Attribute, typename Context, typename Iterator>
