...
namespace boost {
    namespace spirit {
        namespace lex {
            ...
            struct less_type
            {
                ...
                struct result
                {
                    typedef typename remove_reference<
                        typename remove_const<typename mpl::at_c<typename Env::args_type, 4>::type>::type>::type
                        context_type;
            ...
            template<typename T>
            inline typename expression::less<typename phoenix::as_actor<T>::type>::type const less(T const& v)
            {
            ...
            struct lookahead_type
            {
                ...
                {
                    return fusion::at_c<4>(env.args()).lookahead(id_actor_(), state_actor_());
                }

                lookahead_type(IdActor const& id_actor, StateActor const& state_actor) :
                    id_actor_(id_actor),
                    state_actor_(state_actor)
                {
                }
            ...
            inline typename expression::lookahead<
                ...
                typename phoenix::as_actor<std::size_t>::type>::type const
                ...
                lookahead(token_def<Attribute, Char, Idtype> const& tok)
            {
                ...
                // lexer.
                BOOST_ASSERT(std::size_t(~0) != state && "token_def instance not associated with lexer yet");
