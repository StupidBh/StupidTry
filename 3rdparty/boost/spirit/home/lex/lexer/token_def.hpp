...
namespace boost {
    namespace spirit {
        namespace lex {
            ...
            struct token_def :
                proto::extends<
                    typename proto::terminal<lex::reference<token_def<Attribute, Char, Idtype> const, Idtype>>::type,
            ...
            public:
                ...
                struct attribute
                {
                    ...
                    typedef typename mpl::if_<
                        ...
                        typename mpl::if_<is_same<Attribute, lex::omit>, unused_type, Attribute>::type,
                        iterator_range<iterator_type>>::type type;
                };
            ...
            public:
                    ...
                    Attribute_& attr) const
                {
                    ...
                    if (first != last) {
                        ...
                        if (token_id_ == t.id() && (all_states_id == token_state_ || token_state_ == t.state())) {
                ...
                void collect(LexerDef& lexdef, String const& state, String const& targetstate) const
                {
                    ...
                    if (0 == def_.which()) {
                        unique_id_ = lexdef.add_token(state.c_str(), boost::get<string_type>(def_), token_id_, target);
                    }
                    else {
                        unique_id_ = lexdef.add_token(state.c_str(), boost::get<char_type>(def_), token_id_, target);
                    }
                }
            ...
            public:
                ...
                {
                    return (0 == def_.which()) ? boost::get<string_type>(def_)
    ...
    namespace spirit {
        namespace traits {
            ...
            struct handles_container<lex::token_def<Attribute, Char, Idtype>, Attr, Context, Iterator> :
                traits::is_container<
                    typename attribute_of<lex::token_def<Attribute, Char, Idtype>, Context, Iterator>::type>
            {
            };
        }
    }
