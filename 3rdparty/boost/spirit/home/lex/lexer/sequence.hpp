    ...
    namespace spirit {
        namespace lex {
            ...
            struct sequence : nary_lexer<sequence<Elements>>
            {
                ...
                {
                    typedef detail::sequence_collect_function<LexerDef, String> collect_function_type;
            ...
            struct make_composite<proto::tag::bitwise_or, Elements, Modifiers> : make_nary_composite<Elements, sequence>
            {
            };
