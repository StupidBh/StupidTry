...
namespace boost {
    namespace spirit {
        ...
        // enables strings
        template<typename T>
        struct use_terminal<lex::domain, T, typename enable_if<traits::is_string<T>>::type> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            lex::domain,
            terminal_ex<tag::char_code<tag::string, CharEncoding>, fusion::vector2<A0, A1>>> : traits::is_string<A0>
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace lex {
            ...
            struct string_token_def : primitive_lexer<string_token_def<String, IdType, CharEncoding>>
            {
                ...
                Modifiers>
            {
                ...
                typedef string_token_def<const_string, std::size_t, CharEncoding> result_type;
            ...
            struct make_primitive<
                terminal_ex<tag::char_code<tag::string, CharEncoding>, fusion::vector2<A0, A1>>,
                Modifiers>
            {
                typedef typename add_const<A0>::type const_string;
