        ...
        namespace lex {
            namespace lexertl {
                namespace detail {
                    ...
                    inline std::size_t get_state_id(Char const* state, F f, std::size_t numstates)
                    {
                    ...
                    ///////////////////////////////////////////////////////////////////////
                    template<typename Iterator, typename HasActors, typename HasState, typename TokenValue>
                    ...
                    public:
                        ...
                        typedef detail::wrap_action<unused_type, Iterator, static_data, std::size_t> wrap_action_type;

                        typedef std::size_t (
                            *next_token_functor)(std::size_t&, bool&, Iterator&, Iterator const&, std::size_t&);
                        ...
                        void set_state_name(Char const*)
                        {
                            ...
                            BOOST_SPIRIT_ASSERT_FAIL(Char, tried_to_set_state_of_stateless_token, ());
                        }

                        char_type const* get_state_name() const { return get_state_name_(0); }

                        std::size_t get_state_id(char_type const*) const { return 0; }
                        ...
                        invoke_actions(std::size_t, std::size_t, std::size_t, Iterator const&)
                        {
                        ...
                        iterator_range<Iterator> get_value() const { return iterator_range<Iterator>(first_, last_); }
                    ...
                    public:
                        ...
                        typedef typename base_type::semantic_actions_type semantic_actions_type;
                        ...
                        {
                            std::size_t state_id =
                                lexertl::detail::get_state_id(new_state, this->get_state_name_, num_states_);
                        ...
                        char_type const* get_state_name() const { return this->get_state_name_(state_); }

                        std::size_t get_state_id(char_type const* state) const
                        {
                            return lexertl::detail::get_state_id(state, this->get_state_name_, num_states_);
                        }
                        ...
                        {
                            prev_bol = this->bol_;
                            return this->next_token_(state_, this->bol_, end, this->last_, unique_id);
                        }
                    ...
                    public:
                        typedef semantic_actions<Iterator, HasState, static_data> semantic_actions_type;

                    protected:
                        typedef static_data<Iterator, mpl::false_, HasState, TokenValue> base_type;
                        typedef typename base_type::char_type char_type;
                        typedef typename semantic_actions_type::functor_wrapper_type functor_wrapper_type;
                    ...
                    public:
                        ...
                        typedef detail::wrap_action<functor_wrapper_type, Iterator, static_data, std::size_t>
                            wrap_action_type;

                        template<typename IterData>
                        static_data(IterData const& data, Iterator& first, Iterator const& last) :
                            base_type(data, first, last),
                            actions_(data.actions_),
                            hold_(),
                        ...
                        BOOST_SCOPED_ENUM(pass_flags)
                        invoke_actions(std::size_t state, std::size_t& id, std::size_t unique_id, Iterator& end)
                        {
                        ...
                        bool lookahead(std::size_t id, std::size_t state = std::size_t(~0))
                        {
                            ...
                            return id == this->next_token_(state, bol, end, this->get_eoi(), unique_id);
                        }
                        ...
                        void set_end(Iterator const& it) { end_ = it; }
