                ...
                public:
                    ...
                    void add_action(std::size_t unique_id, std::size_t state, F act)
                    {
                        ...
                        if (state == all_states_id) {
                            ...
                            typedef typename basic_rules_type::string_size_t_map::const_iterator state_iterator;

                            std::size_t states = rules_.statemap().size();
                            for (state_iterator it = rules_.statemap().begin(), end = rules_.statemap().end();
                                 it != end;
                                 ++it) {
