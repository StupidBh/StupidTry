...
namespace boost {
        ...
        namespace lex {
            namespace lexertl {
                ...
                struct token<Iterator, lex::omit, mpl::false_, Idtype>
                {
    ...
    #if defined(BOOST_SPIRIT_DEBUG)
                    token(id_type id, std::size_t, Iterator const& first, Iterator const& last) :
                        matched_(first, last),
                        id_(id)
                    {
                    }
                    ...
                    bool is_valid() const { return 0 != id_ && boost::lexer::npos != id_; }
                ...
                ///////////////////////////////////////////////////////////////////////////
                template<typename Iterator, typename Idtype>
                struct token<Iterator, lex::omit, mpl::true_, Idtype> : token<Iterator, lex::omit, mpl::false_, Idtype>
                {
                private:
                ...
                public:
                    typedef typename base_type::id_type id_type;
                    typedef typename detail::token_value_type<iterpair_type, AttributeTypes>::type token_value_type;
                ...
                inline bool operator==(
                    token<Iterator, AttributeTypes, HasState, Idtype> const& lhs,
                ...
                ///////////////////////////////////////////////////////////////////////////
                template<typename Iterator, typename AttributeTypes, typename HasState, typename Idtype>
                inline bool token_is_valid(token<Iterator, AttributeTypes, HasState, Idtype> const& t)
                {
                    return t.is_valid();
                }
            }
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            {
                static void
                    call(lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype> const& t, Attribute& attr)
                {
                    ...
                    if (0 == t.value().which()) {
                        ...
                        typedef lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype> token_type;
            ...
            struct assign_to_container_from_value<
                utree,
                lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>> :
                assign_to_attribute_from_value<utree, lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype>>
            {
            };
            ...
            {
                static void call(iterator_range<Iterator> const& val, iterator_range<Iterator>& attr) { attr = val; }
            };
            ...
            {
                static void
                    call(lex::lexertl::token<Iterator, mpl::vector0<>, HasState, Idtype> const& t, Attribute& attr)
                {
            ...
            {
                static void
                    call(lex::lexertl::token<Iterator, mpl::vector<>, HasState, Idtype> const& t, Attribute& attr)
                {
                    //  The default type returned by the token_def parser component (if
                    //  it has no token value type assigned) is the pair of iterators
                    //  to the matched character sequence.
            ...
            {
                static void call(lex::lexertl::token<Iterator, lex::omit, HasState, Idtype> const&, Attribute&)
                {
                    // do nothing
                }
            };
            ...
            struct assign_to_container_from_value<
                ...
                assign_to_attribute_from_value<Attribute, lex::lexertl::token<Iterator, lex::omit, HasState, Idtype>>
            {
            };
            ...
            {
                static void call(
                    lex::lexertl::token<Iterator, AttributeTypes, HasState, Idtype> const& t,
