            ...
            namespace lexertl {
                namespace detail {
                    ...
                    public:
                        ...
                        typedef detail::wrap_action<unused_type, Iterator, data, std::size_t> wrap_action_type;
                        ...
                        std::size_t next(Iterator& end, std::size_t& unique_id, bool& prev_bol)
                        {
                            ...
                            return tokenizer::next(state_machine_, bol_, end, last_, unique_id);
                        }
                    ...
                    public:
                        ...
                        char_type const* get_state_name() const { return this->rules_.state(state_); }

                        std::size_t get_state_id(char_type const* state) const { return this->rules_.state(state); }
                    ...
                    public:
                        typedef semantic_actions<Iterator, HasState, data> semantic_actions_type;
                    ...
                    public:
                        ...
                        typedef detail::wrap_action<functor_wrapper_type, Iterator, data, std::size_t> wrap_action_type;
                        ...
                        bool lookahead(std::size_t id, std::size_t state = std::size_t(~0))
                        {
                            ...
                            typedef basic_iterator_tokeniser<Iterator> tokenizer;
                            return id ==
                                   tokenizer::next(this->state_machine_, state, bol, end, this->get_eoi(), unique_id);
                        }
