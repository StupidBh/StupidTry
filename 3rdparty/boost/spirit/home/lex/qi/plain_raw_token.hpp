...
namespace boost {
    namespace spirit {
        ...
        // enables raw_token
        template<>
        struct use_terminal<qi::domain, tag::raw_token> : mpl::true_
        {
        };
        ...
        template<>
        struct use_lazy_terminal<qi::domain, tag::raw_token, 1> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct plain_raw_token : primitive_parser<plain_raw_token<TokenId>>
            {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct handles_container<qi::plain_raw_token<Idtype>, Attr, Context, Iterator> : mpl::true_
            {
            };
        }
    }
