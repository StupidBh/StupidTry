...
namespace boost {
    namespace spirit {
        ...
        template<>
        struct use_lazy_terminal<qi::domain, tag::tokenid_mask, 1> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct plain_tokenid_mask : primitive_parser<plain_tokenid_mask<Mask>>
            {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct handles_container<qi::plain_tokenid_mask<Mask>, Attr, Context, Iterator> : mpl::true_
            {
            };
        }
    }
