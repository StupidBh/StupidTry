...
namespace boost {
    namespace spirit {
        ...
        // enables token
        template<>
        struct use_terminal<qi::domain, tag::token> : mpl::true_
        {
        };
        ...
        template<>
        struct use_lazy_terminal<qi::domain, tag::token, 1> : mpl::true_
        {
        };

        // enables *lazy* token(idmin, idmax)
        template<>
        struct use_lazy_terminal<qi::domain, tag::token, 2> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename TokenId>
            struct plain_token_range : primitive_parser<plain_token_range<TokenId>>
            {
                template<typename Context, typename Iterator>
                struct attribute
                {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct handles_container<qi::plain_token<Idtype>, Attr, Context, Iterator> : mpl::true_
            {
            };

            template<typename Idtype, typename Attr, typename Context, typename Iterator>
            struct handles_container<qi::plain_token_range<Idtype>, Attr, Context, Iterator> : mpl::true_
            {
            };
        }
    }
