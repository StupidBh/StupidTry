...
==============================================================================*/
    ...
    #define BOOST_SPIRIT_X3_MARCH_04_2007_0852PM
    ...
    #if !defined BOOST_SPIRIT_X3_HIDE_CXX17_WARNING &&                                                              \
        !(true && defined __cpp_if_constexpr && __cpp_if_constexpr >= 201606 && defined __cpp_inline_variables &&   \
          __cpp_inline_variables >= 201606 && defined __cpp_fold_expressions && __cpp_fold_expressions >= 201603 && \
        ...
        #define BOOST_SPIRIT_X3_STRINGIZE(x)      BOOST_SPIRIT_X3_STRINGIZE_IMPL(x)
            ...
            #warning "Minimal supported compiler versions: Clang 4 / GCC 7 / MSC 1915 (VS 2017 v15.8)"
                ...
                #pragma message "This compiler seems to be Clang " BOOST_SPIRIT_X3_STRINGIZE( \
                    __clang_major__) " (__cplusplus=" BOOST_SPIRIT_X3_STRINGIZE(__cplusplus) ")"
            #else
                #pragma message "This compiler seems to be GCC " BOOST_SPIRIT_X3_STRINGIZE( \
                    __GNUC__) " (__cplusplus=" BOOST_SPIRIT_X3_STRINGIZE(__cplusplus) ")"
            #endif
            #warning "Define BOOST_SPIRIT_X3_HIDE_CXX17_WARNING to hide the warning"
        #elif defined _MSC_VER
            #pragma message(                            \
                __FILE__ "(" BOOST_SPIRIT_X3_STRINGIZE( \
                    __LINE__) "): warning: Spirit X3 will soon use C++17 features which your compiler does not support")
            #ifdef _MSVC_LANG
                #if _MSC_VER >= 1915 && _MSVC_LANG < 201703L
                    #pragma message(                            \
                        __FILE__ "(" BOOST_SPIRIT_X3_STRINGIZE( \
                            __LINE__) "): warning: Use /std:c++17 compiler flag to enable C++17 mode")
                #endif
            ...
            #pragma message(                            \
                __FILE__ "(" BOOST_SPIRIT_X3_STRINGIZE( \
                    __LINE__) "): warning: Define BOOST_SPIRIT_X3_HIDE_CXX17_WARNING to hide the warning")
        #else
