    ...
    namespace spirit {
        namespace traits {
            ...
            struct not_is_variant<fusion::extension::adt_attribute_proxy<T, N, Const>, Domain> :
                not_is_variant<typename fusion::extension::adt_attribute_proxy<T, N, Const>::type, Domain>
            {
            };

            template<typename T, int N, bool Const, typename Domain>
            struct not_is_optional<fusion::extension::adt_attribute_proxy<T, N, Const>, Domain> :
                not_is_optional<typename fusion::extension::adt_attribute_proxy<T, N, Const>::type, Domain>
            {
            };
            ...
            struct is_container<fusion::extension::adt_attribute_proxy<T, N, Const>> :
                is_container<typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>
            {
            };
            ...
            struct container_value<fusion::extension::adt_attribute_proxy<T, N, Const>> :
                container_value<
                    typename remove_reference<typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>
            {
            };

            template<typename T, int N, bool Const>
            struct container_value<fusion::extension::adt_attribute_proxy<T, N, Const> const> :
                container_value<typename add_const<typename remove_reference<
                    typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>::type>
            {
            };
            ...
            struct push_back_container<
                ...
                Val,
                typename enable_if<
                    is_reference<typename fusion::extension::adt_attribute_proxy<T, N, false>::type>>::type>
            {
                static bool call(fusion::extension::adt_attribute_proxy<T, N, false>& p, Val const& val)
                {
                    typedef typename fusion::extension::adt_attribute_proxy<T, N, false>::type type;
            ...
            struct container_iterator<fusion::extension::adt_attribute_proxy<T, N, Const> const> :
                container_iterator<typename add_const<typename remove_reference<
                    typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>::type>
            {
            };
            ...
            {
                typedef typename add_const<typename remove_reference<
                    typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>::type container_type;
            ...
            {
                static void call(Val const& val, fusion::extension::adt_attribute_proxy<T, N, false>& attr)
                {
                    attr = val;
                }
            };
            ...
            {
                typedef typename fusion::extension::adt_attribute_proxy<T, N, Const>::type get_return_type;
                typedef typename remove_const<typename remove_reference<get_return_type>::type>::type embedded_type;
                typedef typename spirit::result_of::extract_from<Exposed, embedded_type>::type extracted_type;
                ...
                typedef typename mpl::if_c<
                    is_reference<get_return_type>::value,
                    extracted_type,
                    typename remove_reference<extracted_type>::type>::type type;
            ...
            {
                typedef typename result_of::optional_value<typename remove_reference<
                    typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>::type type;
                    ...
                    is_reference<typename fusion::extension::adt_attribute_proxy<T, N, false>::type>>::type>
            {
                ...
                static Attribute pre(fusion::extension::adt_attribute_proxy<T, N, false>& val) { return val; }
            ...
            struct transform_attribute<
                ...
                Domain,
                typename enable_if<
                    is_reference<typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>>::type>
            {
                typedef Attribute& type;

                static Attribute& pre(fusion::extension::adt_attribute_proxy<T, N, Const>& val) { return val; }
            ...
            {
                static void call(fusion::extension::adt_attribute_proxy<T, N, Const>& val)
                {
                    typedef typename fusion::extension::adt_attribute_proxy<T, N, Const>::type type;
                    clear(type(val));
                }
            };
            ...
            struct attribute_size<fusion::extension::adt_attribute_proxy<T, N, Const>>
            {
                typedef typename remove_const<typename remove_reference<
                    typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>::type embedded_type;
            ...
            {
                static bool call(fusion::extension::adt_attribute_proxy<T, N, Const> const& val)
                {
    ...
    namespace spirit {
        namespace result_of {
            ...
            struct optional_value<fusion::extension::adt_attribute_proxy<T, N, Const>> :
                result_of::optional_value<typename remove_const<typename remove_reference<
                    typename fusion::extension::adt_attribute_proxy<T, N, Const>::type>::type>::type>
            {
            };
        }
