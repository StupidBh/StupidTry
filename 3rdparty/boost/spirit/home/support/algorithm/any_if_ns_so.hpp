...
namespace boost {
    namespace spirit {
        ...
        namespace detail {
            ...
            inline bool any_if_ns_so(First1 const&, First2 const&, Last1 const&, Last2 const&, F const&, mpl::true_)
            {
                return false;
            }

            template<typename Pred, typename First1, typename Last1, typename First2, typename Last2, typename F>
            inline bool any_if_ns_so(
                First1 const& first1,
                First2 const& first2,
                Last1 const& last1,
                Last2 const& last2,
                ...
                mpl::false_)
            {
                ...
                bool tail = detail::any_if_ns_so<Pred>(
                    fusion::next(first1),
        ...
        inline bool any_if_ns_so(Sequence1 const& seq1, Sequence2& seq2, F f, Pred)
        {
        ...
        inline bool any_if_ns_so(Sequence const& seq, unused_type const, F f, Pred)
        {
