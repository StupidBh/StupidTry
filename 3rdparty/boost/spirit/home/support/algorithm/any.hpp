...
namespace boost {
    namespace spirit {
        ...
        namespace detail {
            ...
            inline bool any(First1 const&, First2 const&, Last const&, F const&, mpl::true_)
            {
                return false;
            }

            template<typename First1, typename Last, typename First2, typename F>
            inline bool any(First1 const& first1, First2 const& first2, Last const& last, F& f, mpl::false_)
            {
        ...
        inline bool any(Sequence1 const& seq1, Sequence2& seq2, F f)
        {
            return detail::any(
                fusion::begin(seq1),
                fusion::begin(seq2),
        ...
        inline bool any(Sequence const& seq, unused_type, F f)
        {
