...
namespace boost {
    namespace spirit {
        namespace tag {
            ...
            struct gunjala_gondi
            {
                BOOST_SPIRIT_IS_TAG()
            };

            struct masaram_gondi
            {
                BOOST_SPIRIT_IS_TAG()
            };
            ...
            struct mende_kikakui
            {
                BOOST_SPIRIT_IS_TAG()
            };

            struct meroitic_cursive
            {
                BOOST_SPIRIT_IS_TAG()
            };

            struct meroitic_hieroglyphs
            {
                BOOST_SPIRIT_IS_TAG()
            };
            ...
            struct char_code : char_code_base<CharClass>, char_encoding_base<CharEncoding>
            {
                BOOST_SPIRIT_IS_TAG()
...
namespace boost {
    ...
    #define BOOST_SPIRIT_CLASSIFY(name, isname)                                                             \
        ...
        static bool is(tag::name, Char ch)                                                                  \
        {                                                                                                   \
            return CharEncoding::isname BOOST_PREVENT_MACRO_SUBSTITUTION(detail::cast_char<char_type>(ch)); \
        }                                                                                                   \
        /***/
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct ischar
            {
                static bool call(CharParam const& ch) { return CharEncoding::ischar(int(ch)); }
            };
        }
    }
}
