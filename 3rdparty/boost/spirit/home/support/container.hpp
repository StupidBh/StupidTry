...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct is_container :
                mpl::bool_<
                    detail::has_value_type<T>::value && detail::has_iterator<T>::value &&
                    detail::has_size_type<T>::value && detail::has_reference<T>::value>
            {
            };
            ...
            template<typename T>
            struct is_container<boost::optional<T>> : is_container<T>
            {
            };
            ...
            struct is_container<boost::variant<T0, T1, TN...>> :
                mpl::bool_<is_container<T0>::value || is_container<boost::variant<T1, TN...>>::value>
            {
            };

    #else
        #define BOOST_SPIRIT_IS_CONTAINER(z, N, data) is_container<BOOST_PP_CAT(T, N)>::value || /***/

            // make sure unused variant parameters do not affect the outcome
            template<>
            struct is_container<boost::detail::variant::void_> : mpl::false_
            {
            };

            template<BOOST_VARIANT_ENUM_PARAMS(typename T)>
            struct is_container<variant<BOOST_VARIANT_ENUM_PARAMS(T)>> :
                mpl::bool_<BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES, BOOST_SPIRIT_IS_CONTAINER, _) false>
            {
            };
        ...
        #undef BOOST_SPIRIT_IS_CONTAINER
            ...
            struct container_value : detail::remove_value_const<typename Container::value_type>
            {
            };
            ...
            template<typename T>
            struct container_value<T&> : container_value<T>
            {
            };

            // this will be instantiated if the optional holds a container
            template<typename T>
            struct container_value<boost::optional<T>> : container_value<T>
            {
            };
            ...
            {
                typedef typename variant<BOOST_VARIANT_ENUM_PARAMS(T)>::types types;
                typedef typename mpl::find_if<types, is_container<mpl::_1>>::type iter;

                typedef typename container_value<typename mpl::if_<
                    is_same<iter, typename mpl::end<types>::type>,
                    unused_type,
                    typename mpl::deref<iter>::type>::type>::type type;
            };
            ...
            struct container_iterator<Container&> : container_iterator<Container>
            {
            };
            ...
            template<typename T>
            struct container_iterator<optional<T>> : container_iterator<T>
            {
            };

            template<typename T>
            struct container_iterator<optional<T> const> : container_iterator<T const>
            {
            };
            ...
            struct optional_attribute
            {
                ...
                static type call(T const& val) { return val; }

                static bool is_valid(T const&) { return true; }
            };
            ...
            struct optional_attribute<boost::optional<T>>
            {
                ...
                static type call(boost::optional<T> const& val) { return boost::get<T>(val); }

                static bool is_valid(boost::optional<T> const& val) { return !!val; }
            };

            template<typename T>
            typename optional_attribute<T>::type optional_value(T const& val)
            {
            ...
            {
                static bool call(Container const& c) { return c.empty(); }
            };
            ...
            {
                static typename container_iterator<Container>::type call(Container& c) { return c.begin(); }
            };
            ...
            inline unused_type const* begin(unused_type)
            {
                return &unused;
            }
            ...
            {
                static typename container_iterator<Container>::type call(Container& c) { return c.end(); }
            };
            ...
            inline unused_type const* end(unused_type)
            {
                return &unused;
            }
            ...
            struct deref_iterator
            {
                ...
                static type call(Iterator& it) { return *it; }
            };

            template<typename Iterator>
            typename deref_iterator<Iterator>::type deref(Iterator& it)
            {
                return deref_iterator<Iterator>::call(it);
            }

            inline unused_type deref(unused_type const*)
            {
                return unused;
            }
            ...
            {
                static void call(Iterator& it) { ++it; }
            };
            ...
            {
                static bool call(Iterator const& it1, Iterator const& it2) { return it1 == it2; }
            };
...
namespace boost {
    namespace spirit {
        namespace result_of {
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Container>
            struct begin : traits::container_iterator<Container>
            {
            };

            template<typename Container>
            struct end : traits::container_iterator<Container>
            {
            };

            template<typename Iterator>
            struct deref : traits::deref_iterator<Iterator>
            {
            };
