        ...
        namespace char_encoding {
            ...
            struct standard_wide
            {
                ...
                static bool ischar(int ch)
                {
                    ...
                    // mismatch)
                    return (std::size_t(0) == std::size_t(ch & ~traits::wchar_t_size<sizeof(wchar_t)>::mask) ||
                            std::size_t(~0) == std::size_t(ch | traits::wchar_t_size<sizeof(wchar_t)>::mask)) !=
                ...
                static bool isblank BOOST_PREVENT_MACRO_SUBSTITUTION(wchar_t ch) { return (ch == L' ' || ch == L'\t'); }
                ...
                static ::boost::uint32_t toucs4(wchar_t ch) { return static_cast<make_unsigned<wchar_t>::type>(ch); }
            };
        }
    }
}
