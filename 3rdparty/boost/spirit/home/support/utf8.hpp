...
namespace boost {
    namespace spirit {
        ...
        inline utf8_string to_utf8(std::basic_string<Char, Traits, Allocator> const& str)
        {
            utf8_string result;
            typedef typename make_unsigned<Char>::type UChar;
            for (Char const *ptr = str.data(), *end = ptr + str.size(); ptr < end; ++ptr) {
        ...
        inline utf8_string to_utf8(std::basic_string<wchar_t, Traits, Allocator> const& str)
        {
