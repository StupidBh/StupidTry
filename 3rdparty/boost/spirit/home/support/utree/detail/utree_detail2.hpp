    ...
    namespace spirit {
        namespace detail {
            ...
            class list::node_iterator :
                public boost::iterator_facade<node_iterator<Value>, Value, boost::bidirectional_traversal_tag> {
            public:
                node_iterator() :
                    node(0),
                    prev(0)
            ...
            private:
                ...
                bool equal(node_iterator const& other) const { return node == other.node; }

                typename node_iterator::reference dereference() const { return node->val; }
            ...
            private:
                ...
                typename node_iterator::reference dereference() const { return curr; }
            ...
            inline void list::insert(T const& val, Iterator pos)
            {
                ...
                detail::list::node* new_node = new detail::list::node(val, pos.node, pos.node->prev);
            ...
            inline void list::push_back(T const& val)
            {
                if (last == 0) {
                    ...
                    detail::list::node* new_node = new detail::list::node(val, last->next, last);
                    last->next = new_node;
                    last = new_node;
                    ++size;
                }
            ...
            {
                template<typename F>
                typename F::result_type static apply(UTreeX& x, F f) // single dispatch
                {
                    typedef typename boost::mpl::
                        if_<boost::is_const<UTreeX>, typename UTreeX::const_iterator, typename UTreeX::iterator>::type
                            iterator;
                    ...
                    switch (x.get_type()) {
                    default: BOOST_THROW_EXCEPTION(bad_type_exception("corrupt utree type", x.get_type())); break;

                    case type::invalid_type: return f(invalid);

                    case type::nil_type: return f(nil);

                    case type::bool_type: return f(x.b);

                    case type::int_type: return f(x.i);

                    case type::double_type: return f(x.d);

                    case type::list_type: return f(list_range(iterator(x.l.first, 0), iterator(0, x.l.last)));

                    case type::range_type: return f(list_range(iterator(x.r.first, 0), iterator(0, x.r.last)));

                    case type::string_type: return f(utf8_string_range_type(x.s.str(), x.s.size()));

                    case type::string_range_type: return f(utf8_string_range_type(x.sr.first, x.sr.last));

                    case type::symbol_type: return f(utf8_symbol_range_type(x.s.str(), x.s.size()));

                    case type::binary_type: return f(binary_range_type(x.s.str(), x.s.size()));

                    case type::reference_type: return apply(*x.p, f);

                    case type::any_type: return f(any_ptr(x.v.p, x.v.i));

                    case type::function_type: return f(*x.pf);
                    }
                }

                template<typename F>
                typename F::result_type static apply(UTreeX& x, UTreeY& y, F f) // double dispatch
                {
                    typedef typename boost::mpl::
                        if_<boost::is_const<UTreeX>, typename UTreeX::const_iterator, typename UTreeX::iterator>::type
                            iterator;
                    ...
                    case type::invalid_type: return visit_impl::apply(y, detail::bind(f, invalid));

                    case type::nil_type: return visit_impl::apply(y, detail::bind(f, nil));

                    case type::bool_type: return visit_impl::apply(y, detail::bind(f, x.b));

                    case type::int_type: return visit_impl::apply(y, detail::bind(f, x.i));

                    case type::double_type: return visit_impl::apply(y, detail::bind(f, x.d));

                    case type::list_type:
                        return visit_impl::apply(
                            y,
                            detail::bind<F, list_range>(f, list_range(iterator(x.l.first, 0), iterator(0, x.l.last))));

                    case type::range_type:
                        return visit_impl::apply(
                            y,
                            detail::bind<F, list_range>(f, list_range(iterator(x.r.first, 0), iterator(0, x.r.last))));

                    case type::string_type:
                        return visit_impl::apply(y, detail::bind(f, utf8_string_range_type(x.s.str(), x.s.size())));

                    case type::string_range_type:
                        return visit_impl::apply(y, detail::bind(f, utf8_string_range_type(x.sr.first, x.sr.last)));

                    case type::symbol_type:
                        return visit_impl::apply(y, detail::bind(f, utf8_symbol_range_type(x.s.str(), x.s.size())));

                    case type::binary_type:
                        return visit_impl::apply(y, detail::bind(f, binary_range_type(x.s.str(), x.s.size())));

                    case type::reference_type: return apply(*x.p, y, f);

                    case type::any_type: return visit_impl::apply(y, detail::bind(f, any_ptr(x.v.p, x.v.i)));

                    case type::function_type: return visit_impl::apply(y, detail::bind(f, *x.pf));
                    }
                }
            };
            ...
            struct index_impl
            {
                ...
                {
                    switch (ut.get_type()) {
                    case utree_type::reference_type: return apply(ut.deref(), i);
                    case utree_type::range_type    : return apply(ut.r.first, i);
                    case utree_type::list_type     : return apply(ut.l.first, i);
                    default:
                        BOOST_THROW_EXCEPTION(
                            bad_type_exception("index operation performed on non-list utree type", ut.get_type()));
                    }
                }
...
namespace boost {
    namespace spirit {
        ...
        template<typename F>
        function_base* stored_function<F>::clone() const
        {
        ...
        template<typename F>
        function_base* referenced_function<F>::clone() const
        {
        ...
        template<typename F>
        typename boost::result_of<F(utree const&)>::type inline utree::visit(utree const& x, F f)
        {
            return detail::visit_impl<utree const>::apply(x, f);
        }

        template<typename F>
        typename boost::result_of<F(utree&)>::type inline utree::visit(utree& x, F f)
        {
            return detail::visit_impl<utree>::apply(x, f);
        }

        template<typename F>
        typename boost::result_of<F(utree const&, utree const&)>::type inline utree::visit(
            utree const& x,
            utree const& y,
            F f)
        {
        ...
        template<typename F>
        typename boost::result_of<F(utree const&, utree&)>::type inline utree::visit(utree const& x, utree& y, F f)
        {
            return detail::visit_impl<utree const, utree>::apply(x, y, f);
        }

        template<typename F>
        typename boost::result_of<F(utree&, utree const&)>::type inline utree::visit(utree& x, utree const& y, F f)
        {
            return detail::visit_impl<utree, utree const>::apply(x, y, f);
        }

        template<typename F>
        typename boost::result_of<F(utree&, utree&)>::type inline utree::visit(utree& x, utree& y, F f)
        {
        ...
        inline utree::const_reference get(utree::const_reference ut, utree::size_type i)
        {
            return detail::index_impl::apply(ut, i);
        }
        ...
        inline void utree::pop_front()
        {
            ...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("pop_front() called on non-list utree type", get_type()));
            }
        ...
        inline void utree::pop_back()
        {
            ...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("pop_back() called on non-list utree type", get_type()));
            }
        ...
        inline utree::iterator utree::erase(iterator pos)
        {
            ...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("erase() called on non-list utree type", get_type()));
            }
        ...
        inline utree::const_iterator utree::begin() const
        {
            ...
            // otherwise...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("begin() called on non-list utree type", get_type()));
            }
        ...
        inline utree::const_iterator utree::end() const
        {
            ...
            // otherwise...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("end() called on non-list utree type", get_type()));
            }
        ...
        inline std::size_t utree::size() const
        {
            ...
            if (t != type::nil_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("size() called on non-list and non-string utree type", get_type()));
            }
        ...
        inline utree& utree::front()
        {
            ...
            if (get_type() == type::range_type) {
                if (!r.first) {
                    BOOST_THROW_EXCEPTION(empty_exception("front() called on empty utree range"));
                }
                return r.first->val;
            }
            ...
            // otherwise...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("front() called on non-list utree type", get_type()));
            }
            else if (!l.first) {
                BOOST_THROW_EXCEPTION(empty_exception("front() called on empty utree list"));
            }
        ...
        inline utree& utree::back()
        {
            ...
            if (get_type() == type::range_type) {
                if (!r.last) {
                    BOOST_THROW_EXCEPTION(empty_exception("back() called on empty utree range"));
                }
                return r.last->val;
            }
            ...
            // otherwise...
            if (get_type() != type::list_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("back() called on non-list utree type", get_type()));
            }
            else if (!l.last) {
                BOOST_THROW_EXCEPTION(empty_exception("back() called on empty utree list"));
            }
        ...
        inline void utree::free()
        {
            ...
            case type::binary_type:
            case type::symbol_type:
            case type::string_type  : s.free(); break;
            case type::list_type    : l.free(); break;
            case type::function_type: delete pf; break;
            default                 : break;
            };
            s.initialize();
        }
        ...
        inline void utree::copy(utree const& other)
        {
            ...
            default                : BOOST_THROW_EXCEPTION(bad_type_exception("corrupt utree type", other.get_type())); break;
            case type::invalid_type:
            case type::nil_type    : s.tag(other.s.tag()); break;
            case type::bool_type:
                b = other.b;
                s.tag(other.s.tag());
                break;
        ...
        template<typename T>
        struct is_iterator_range : boost::mpl::false_
        {
        };

        template<typename Iterator>
        struct is_iterator_range<boost::iterator_range<Iterator>> : boost::mpl::true_
        {
        };
        ...
        struct utree_cast
        {
            ...
            To operator()(From const& val) const
            {
                ...
                typedef typename boost::mpl::
                    eval_if<is_iterator_range<To>, boost::is_same<From, To>, boost::is_convertible<From, To>>::type
                        is_convertible;
        ...
        struct utree_cast<T*>
        {
            ...
            T* operator()(any_ptr const& p) const { return p.get<T*>(); }
        };
        ...
        inline utree utree::eval(utree const& env) const
        {
            ...
            if (get_type() != type::function_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("eval() called on non-function utree type", get_type()));
            }
            return (*pf)(env);
        }
