        ...
        namespace traits {
            namespace detail {
                inline bool is_list(utree const& ut)
                {
                    ...
                    case utree_type::reference_type: return is_list(ut.deref());

                    case utree_type::list_type:
                    case utree_type::range_type: return true;
            ...
            struct alternative_attribute_transform<utree::list_type, Domain> : mpl::identity<utree>
            {
            };
            ...
            // actually expose a utree::list_type
            template<typename Domain>
            struct sequence_attribute_transform<utree::list_type, Domain> : mpl::identity<utree>
            {
            };
            ...
            struct char_type_of<spirit::basic_string<iterator_range<T>, I>> : char_type_of<T>
            {
            };

            template<utree_type::info I>
            struct char_type_of<spirit::basic_string<std::string, I>> : mpl::identity<char>
            {
            };
            ...
            struct extract_c_string<spirit::basic_string<iterator_range<T const*>, I>>
            {
                ...
                static T const* call(string& s) { return s.begin(); }
            ...
            struct extract_c_string<spirit::basic_string<std::string, I>>
            {
                ...
                static char const* call(string& s) { return s.c_str(); }

                static char const* call(string const& s) { return s.c_str(); }
            };

            ///////////////////////////////////////////////////////////////////////////
            // these specializations are needed because utree::value_type == utree
            template<>
            struct is_substitute<utree, utree> : mpl::true_
            {
            };

            template<>
            struct is_weak_substitute<utree, utree> : mpl::true_
            {
            };

            template<>
            struct is_substitute<utree::list_type, utree::list_type> : mpl::true_
            {
            };

            template<>
            struct is_weak_substitute<utree::list_type, utree::list_type> : mpl::true_
            {
            };
            ...
            {
                static void call(variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& val, utree& attr)
                {
            ...
            struct assign_to_container_from_value<utree, Attribute>
            {
                ...
                {
                    typedef typename traits::container_iterator<Attribute const>::type iterator_type;
                ...
                static void call(Attribute const& val, utree& attr) { call(val, attr, is_container<Attribute>()); }
            };
            ...
            {
                static void call(utree const& val, utree& attr) { push_back(attr, val); }
            };
            ...
            {
                static void call(Iterator const& first, Iterator const& last, utree& attr)
                {
                    if (attr.empty()) {
            ...
            namespace detail {
                struct attribute_as_string_type
                {
                    ...
                    static type call(utree const& attr) { return boost::get<utf8_string_range_type>(attr); }

                    static bool is_valid(utree const& attr)
                    {
                        switch (traits::which(attr)) {
                        case utree_type::reference_type: return is_valid(attr.deref());

                        case utree_type::string_range_type:
                        case utree_type::string_type      : return true;
            ...
            template<>
            struct attribute_as<std::string, utree> : detail::attribute_as_string_type
            {
            };

            template<>
            struct attribute_as<utf8_string_type, utree> : detail::attribute_as_string_type
            {
            };

            template<>
            struct attribute_as<utf8_string_range_type, utree> : detail::attribute_as_string_type
            {
            };
            ...
            namespace detail {
                struct attribute_as_symbol_type
                {
                    ...
                    static type call(utree const& attr) { return boost::get<utf8_symbol_range_type>(attr); }
                    ...
                    static bool is_valid(utree const& attr)
                    {
                        ...
                        case utree_type::symbol_type: return true;
            ...
            template<>
            struct attribute_as<utf8_symbol_type, utree> : detail::attribute_as_symbol_type
            {
            };

            template<>
            struct attribute_as<utf8_symbol_range_type, utree> : detail::attribute_as_symbol_type
            {
            };

            template<typename Attribute>
            struct attribute_as<Attribute, utree::list_type> : attribute_as<Attribute, utree>
            {
            };
            ...
            namespace detail {
                struct attribute_as_binary_string_type
                {
                    ...
                    static type call(utree const& attr) { return boost::get<binary_range_type>(attr); }
                    ...
                    static bool is_valid(utree const& attr)
                    {
                        ...
                        case utree_type::binary_type: return true;
            ...
            template<>
            struct attribute_as<binary_string_type, utree> : detail::attribute_as_binary_string_type
            {
            };

            template<>
            struct attribute_as<binary_range_type, utree> : detail::attribute_as_binary_string_type
            {
            };
            ...
            struct push_back_container<utree, T>
            {
                static bool call(utree& c, T const& val)
                {
                    ...
                    case utree_type::list_type   : c.push_back(val); break;
            ...
            template<typename T>
            struct push_back_container<utree::list_type, T> : push_back_container<utree, T>
            {
            };
            ...
            template<>
            struct make_container_attribute<utree::list_type> : make_container_attribute<utree>
            {
            };
            ...
            {
                static void call(Out& out, utree const& val) { out << val; }
            };
            ...
            namespace detail {
                ...
                struct handles_utree_list_container :
                    mpl::and_<mpl::not_<is_same<utree::list_type, Attribute>>, traits::is_container<Attribute>>
                {
                };
                ...
                struct handles_utree_list_container<
                    Attribute,
                    typename enable_if<fusion::traits::is_sequence<Attribute>>::type> : mpl::true_
                {
                };

                template<typename Attribute>
                struct handles_utree_list_container<boost::optional<Attribute>> : mpl::true_
                {
                };

                template<BOOST_VARIANT_ENUM_PARAMS(typename T)>
                struct handles_utree_list_container<boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>> : mpl::true_
                {
                };
            }
            ...
            struct handles_container<qi::rule<IteratorA, T1, T2, T3, T4>, utree, Context, IteratorB> :
                detail::handles_utree_list_container<
                    typename attribute_of<qi::rule<IteratorA, T1, T2, T3, T4>, Context, IteratorB>::type>
            {
            };
            ...
            struct handles_container<qi::grammar<IteratorA, T1, T2, T3, T4>, utree, Context, IteratorB> :
                detail::handles_utree_list_container<
                    typename attribute_of<qi::grammar<IteratorA, T1, T2, T3, T4>, Context, IteratorB>::type>
            {
            };
            ...
            namespace detail {
                ...
                struct handles_utree_container :
                    mpl::and_<mpl::not_<is_same<utree, Attribute>>, traits::is_container<Attribute>>
                {
                };
                ...
                template<typename Attribute>
                struct handles_utree_container<boost::optional<Attribute>> : mpl::true_
                {
                };

                template<BOOST_VARIANT_ENUM_PARAMS(typename T)>
                struct handles_utree_container<boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>> : mpl::true_
                {
                };
            }
            ...
            struct handles_container<karma::rule<IteratorA, T1, T2, T3, T4>, utree, Context, IteratorB> :
                detail::handles_utree_container<
                    typename attribute_of<karma::rule<IteratorA, T1, T2, T3, T4>, Context, IteratorB>::type>
            {
            };
            ...
            struct handles_container<karma::grammar<IteratorA, T1, T2, T3, T4>, utree, Context, IteratorB> :
                detail::handles_utree_container<
                    typename attribute_of<karma::grammar<IteratorA, T1, T2, T3, T4>, Context, IteratorB>::type>
            {
            };
            ...
            struct optional_attribute<utree>
            {
                ...
                static type call(utree const& val) { return val; }

                // only 'invalid_type' utree nodes are not valid
                static bool is_valid(utree const& val) { return !detail::is_uninitialized(val); }
            };
            ...
            template<>
            struct not_is_optional<utree, qi::domain> : mpl::false_
            {
            };

            template<>
            struct not_is_optional<utree::list_type, qi::domain> : mpl::false_
            {
            };

            template<>
            struct not_is_optional<utree, karma::domain> : mpl::false_
            {
            };

            template<>
            struct not_is_optional<utree::list_type, karma::domain> : mpl::false_
            {
            };
            ...
            template<>
            struct not_is_variant<utree, karma::domain> : mpl::false_
            {
            };

            template<>
            struct not_is_variant<utree::list_type, karma::domain> : mpl::false_
            {
            };
            ...
            template<>
            struct compute_compatible_component_variant<utree, iterator_range<utree::iterator>> : mpl::true_
            {
            ...
            template<>
            struct compute_compatible_component_variant<utree, iterator_range<utree::const_iterator>> : mpl::true_
            {
            ...
            template<>
            struct compute_compatible_component_variant<utree, utree::invalid_type> : mpl::true_
            {
                typedef utree::invalid_type compatible_type;

                static bool is_compatible(int d) { return d == utree_type::invalid_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, utree::nil_type> : mpl::true_
            {
                typedef utree::nil_type compatible_type;

                static bool is_compatible(int d) { return d == utree_type::nil_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, bool> : mpl::true_
            {
                typedef bool compatible_type;

                static bool is_compatible(int d) { return d == utree_type::bool_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, int> : mpl::true_
            {
                typedef int compatible_type;

                static bool is_compatible(int d) { return d == utree_type::int_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, double> : mpl::true_
            {
                typedef double compatible_type;

                static bool is_compatible(int d) { return d == utree_type::double_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, utf8_string_range_type> : mpl::true_
            {
                typedef utf8_string_range_type compatible_type;

                static bool is_compatible(int d) { return d == utree_type::string_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, utf8_string_type> : mpl::true_
            {
            ...
            template<>
            struct compute_compatible_component_variant<utree, utf8_symbol_range_type> : mpl::true_
            {
                typedef utf8_symbol_range_type compatible_type;

                static bool is_compatible(int d) { return d == utree_type::symbol_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, utf8_symbol_type> : mpl::true_
            {
            ...
            template<>
            struct compute_compatible_component_variant<utree, binary_range_type> : mpl::true_
            {
                typedef binary_range_type compatible_type;

                static bool is_compatible(int d) { return d == utree_type::binary_type; }
            };

            template<>
            struct compute_compatible_component_variant<utree, binary_string_type> : mpl::true_
            {
            ...
            template<>
            struct compute_compatible_component_variant<utree, utree> : mpl::true_
            {
                typedef utree compatible_type;

                static bool is_compatible(int d)
                {
                    return d >= utree_type::invalid_type && d <= utree_type::reference_type;
                }
            };

            template<>
            struct compute_compatible_component_variant<utree, std::vector<utree>> : mpl::true_
            {
                typedef utree compatible_type;
            ...
            struct compute_compatible_component_variant<
                ...
                Sequence,
                mpl::false_,
                typename enable_if<fusion::traits::is_sequence<Sequence>>::type> : mpl::true_
            {
                typedef iterator_range<utree::const_iterator> compatible_type;
            ...
            struct symbols_lookup<utf8_symbol_type, utf8_symbol_type>
            {
                ...
                static type call(utf8_symbol_type const& t) { return t; }
            };
            ...
            struct transform_attribute<utree const, utree::nil_type, karma::domain>
            {
                ...
                static type pre(utree const&) { return nil; }
            };
            ...
            struct transform_attribute<utree const, bool, karma::domain>
            {
                ...
                static type pre(utree const& t) { return detail::get_or_deref<bool>(t); }
            };
            ...
            struct transform_attribute<utree const, int, karma::domain>
            {
                ...
                static type pre(utree const& t) { return detail::get_or_deref<int>(t); }
            };
            ...
            struct transform_attribute<utree const, double, karma::domain>
            {
                ...
                static type pre(utree const& t) { return detail::get_or_deref<double>(t); }
            };
