...
namespace boost {
    namespace spirit {
        ...
        struct utree_is_equal
        {
            ...
            {
                return dispatch(a, b, boost::mpl::and_<boost::is_arithmetic<A>, boost::is_arithmetic<B>>());
            }
            ...
            bool operator()(utree::invalid_type, utree::invalid_type) const { return true; }

            bool operator()(utree::nil_type, utree::nil_type) const { return true; }
        ...
        struct utree_is_less_than
        {
            ...
            bool operator()(utree::invalid_type, utree::invalid_type) const
            {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("no less-than comparison for this utree type", utree_type::invalid_type));
            ...
            {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("no less-than comparison for this utree type", utree_type::nil_type));
                BOOST_UNREACHABLE_RETURN(false) // no less than comparison for nil
            }
            ...
            {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("no less-than comparison for this utree type", utree_type::any_type));
            ...
            {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("no less-than comparison for this utree type", utree_type::function_type));
        ...
        struct utree_print
        {
            ...
            void operator()(utree::invalid_type) const { out << "<invalid> "; }

            void operator()(utree::nil_type) const { out << "<nil> "; }
            ...
            void operator()(any_ptr const&) const { return (*this)("<pointer>"); }

            void operator()(function_base const&) const { return (*this)("<function>"); }
        };
    #endif
        ...
        struct logical_function
        {
            ...
            {
                return dispatch(a, b, boost::is_arithmetic<A>(), boost::is_arithmetic<B>());
            }
        ...
        struct integral_function
        {
            ...
            utree operator()(A const& a, B const& b) const
            {
                return dispatch(a, b, boost::mpl::and_<boost::is_integral<A>, boost::is_integral<B>>());
            }
    ...
    #define BOOST_SPIRIT_UTREE_CREATE_FUNCTION(arity, name, expr, base)                                \
        ...
        {                                                                                              \
            BOOST_SPIRIT_UTREE_CREATE_FUNCTION_##arity { return utree(expr); }                         \
        };                                                                                             \
        base<BOOST_PP_CAT(function_impl_, name)> const BOOST_PP_CAT(base, BOOST_PP_CAT(_, name)) = {}; \
        /***/
    ...
    #define BOOST_SPIRIT_UTREE_CREATE_LOGICAL_FUNCTION(arity, name, expr) \
        ...
        template<>
        inline utree function_impl_invert::eval<bool>(bool const& a)
        {
            return utree(!a);
        }
    ...
    #undef BOOST_SPIRIT_UTREE_CREATE_ARITHMETIC_FUNCTION
        ...
        inline utree operator+(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("addition performed on non-arithmetic utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator-(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("subtraction performed on non-arithmetic utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator*(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("multiplication performed on non-arithmetic utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator/(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("division performed on non-arithmetic utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator%(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("modulos performed on non-integral utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator-(utree const& a)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("negation performed on non-arithmetic utree type", a.which()));
            }
            return r;
        }
        ...
        inline utree operator&(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("bitwise and performed on non-integral utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator|(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("bitwise or performed on non-integral utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator^(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("bitwise xor performed on non-integral utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator<<(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("left shift performed on non-integral utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator>>(utree const& a, utree const& b)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(
                    bad_type_exception("right shift performed on non-integral utree types", a.which(), b.which()));
            }
            return r;
        }
        ...
        inline utree operator~(utree const& a)
        {
            ...
            if (r.which() == utree_type::invalid_type) {
                BOOST_THROW_EXCEPTION(bad_type_exception("inversion performed on non-integral utree type", a.which()));
            }
            return r;
        }
    }
