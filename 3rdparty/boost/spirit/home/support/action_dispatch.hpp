    ...
    namespace spirit {
        ...
        #define BOOST_SPIRIT_FAKE_CALL(T) (*(T*)0)
                ...
                struct fwd_attrib_context
                {
                    ...
                    auto operator()(F&& f, A&& a, B&& b, Rest&&...) -> decltype(f(a, b))
                    {
                        return f(a, b);
                    }
                };
                ...
                {
                    template<typename F, typename A, typename B, typename C, typename... Rest>
                    auto operator()(F&& f, A&& a, B&& b, C&& c, Rest&&...) -> decltype(f(a, b, c))
                    {
                        return f(a, b, c);
                    }
                };
                ...
                // steady
                template<typename F>
                static auto do_call(F&& f, ...) -> typename fwd_storage<decltype(f()), fwd_none>::type
                {
                    return {};
                }
                ...
                static auto do_call(F&& f, fwd_tag<A>, ...) ->
                    typename fwd_storage<decltype(f(BOOST_SPIRIT_FAKE_CALL(A))), fwd_attrib>::type
                {
                    return {};
                }

                template<typename F, typename A, typename B>
                static auto do_call(F&& f, fwd_tag<A>, fwd_tag<B>, ...) -> typename fwd_storage<
                ...
                static auto do_call(F&& f, fwd_tag<A>, fwd_tag<B>, fwd_tag<C>, ...) -> typename fwd_storage<
                    decltype(f(BOOST_SPIRIT_FAKE_CALL(A), BOOST_SPIRIT_FAKE_CALL(B), BOOST_SPIRIT_FAKE_CALL(C))),
