            ...
            struct expand_arg
            {
                ...
                struct result_type
                {
                    ...
                    typedef typename mpl::eval_if<
                        ...
                        boost::result_of<T(unused_type, Context)>>::type type;
                };
                ...
                struct result<F(A0)> : result_type<A0>
                {
                };
                ...
                template<typename T>
                typename result_type<T>::type call(T const& f, mpl::false_) const
                {
                    return f(unused, context);
                }

                template<typename T>
                typename result_type<T>::type call(T const& val, mpl::true_) const
                {
                    return val;
                }

                template<typename T>
                typename result_type<T>::type operator()(T const& x) const
                {
