        ...
        namespace detail {
            ...
            struct extract_param
            {
                ...
                typedef typename mpl::
                    eval_if<is_same<pos, typename mpl::end<Types>::type>, mpl::identity<Default>, mpl::deref<pos>>::type
                        type;
            };
            ...
            struct extract_locals :
                fusion::result_of::as_vector<typename extract_param<Types, is_locals<mpl::_>, locals<>>::type>
            {
            };
            ...
            struct extract_component :
                spirit::result_of::
                    compile<Domain, typename extract_param<Types, traits::matches<Domain, mpl::_>, unused_type>::type>
            {
            };
            ...
            struct extract_sig
            {
                typedef typename extract_param<
                    Types,
                    mpl::or_<
            ...
            struct attr_from_sig
            {
                ...
                typedef typename mpl::if_<is_same<attr, void>, unused_type, attr>::type type;
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Types>
            struct extract_encoding : extract_param<Types, is_char_encoding<mpl::_>, unused_type>
            {
            };
        }
    }
