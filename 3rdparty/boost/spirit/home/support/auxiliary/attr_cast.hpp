...
namespace boost {
    namespace spirit {
        ...
        typename enable_if<proto::is_expr<Expr>, stateful_tag_type<Expr, tag::attr_cast>>::type
        ...
        typename enable_if<proto::is_expr<Expr>, stateful_tag_type<Expr, tag::attr_cast, Exposed>>::type
            attr_cast(Expr const& expr)
        {
        ...
        typename enable_if<proto::is_expr<Expr>, stateful_tag_type<Expr, tag::attr_cast, Exposed, Transformed>>::type
            attr_cast(Expr const& expr)
        {
