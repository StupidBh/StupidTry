    ...
    // object has been changed)
        ...
        // problems with the following template specialization
                ...
                struct result<nary_proto_expr_function(T1, T2)>
                {
                    ...
                    typedef typename spirit::traits::meta_create<Domain, T1>::type right_type;

                    typedef typename mpl::eval_if<
                        traits::not_is_unused<left_type>,
                        proto::result_of::make_expr<OpTag, left_type, right_type>,
                        mpl::identity<right_type>>::type type;
                };
                ...
                template<typename T1, typename T2>
                typename result<nary_proto_expr_function(T1, T2)>::type operator()(T1, T2 const& t2) const
                {
        ...
        // problems with the following template specialization
                ...
                struct result<nary_proto_expr_function(T1, T2)>
                {
                    ...
                    typedef typename spirit::traits::meta_create<Domain, T2>::type right_type;
                ...
                template<typename T1, typename T2>
                typename result<nary_proto_expr_function(T1, T2)>::type operator()(T1 const& t1, T2) const
                {
                    // we variants to the alternative operator
        ...
        struct make_unary_proto_expr
        {
            ...
            typedef typename proto::result_of::make_expr<OpTag, typename subject_type::type>::type type;

            static type call() { return proto::make_expr<OpTag>(subject_type::call()); }
        };
        ...
        struct make_nary_proto_expr
        {
            ...
            typedef typename fusion::result_of::fold<Sequence, unused_type, make_proto_expr>::type type;

            static type call() { return fusion::fold(Sequence(), unused, make_proto_expr()); }
        };
        ...
        namespace detail {
            ...
            struct is_fusion_sequence_but_not_proto_expr :
                mpl::and_<fusion::traits::is_sequence<T>, mpl::not_<proto::is_expr<T>>>
            {
            };
        }
    }
