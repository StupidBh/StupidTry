    ...
    namespace spirit {
        namespace detail {
            ...
            struct as_meta_element :
                mpl::eval_if_c<is_abstract<T>::value || is_function<T>::value, add_reference<T>, remove_const<T>>
            {
            };
            ...
            fusion::cons<typename as_meta_element<Car>::type, Cdr> make_cons(Car const& car, Cdr const& cdr)
            {
                typedef typename as_meta_element<Car>::type car_type;
            ...
            fusion::cons<typename as_meta_element<Car>::type> make_cons(Car const& car)
            {
                typedef typename as_meta_element<Car>::type car_type;
