        ...
        namespace detail {
            ...
            struct get_implicit_encoding
            {
                ...
                typedef typename mpl::
                    find_if<char_encodings, has_modifier<Modifiers, tag::char_encoding_base<mpl::_1>>>::type iter;

                typedef typename mpl::eval_if<
                    is_same<iter, typename mpl::end<char_encodings>::type>,
                    mpl::identity<Encoding>,
                    mpl::deref<iter>>::type type;
            };
            ...
            struct get_encoding
            {
                ...
                typedef typename mpl::
                    find_if<char_encodings, has_modifier<Modifiers, tag::char_code<tag::encoding, mpl::_1>>>::type iter;
            ...
            template<typename Modifiers, typename Encoding>
            struct get_encoding_with_case<Modifiers, Encoding, true> : get_encoding<Modifiers, Encoding>
            {
            };
        }
    }
