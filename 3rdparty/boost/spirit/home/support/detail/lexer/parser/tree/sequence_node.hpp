        ...
        namespace detail {
            ...
            public:
                    ...
                    _right(right_)
                {
                    ...
                    for (node_vector::iterator iter_ = lastpos_.begin(), end_ = lastpos_.end(); iter_ != end_;
                         ++iter_) {
                ...
                virtual type what_type() const { return SEQUENCE; }
                ...
                virtual bool traverse(const_node_stack& node_stack_, bool_stack& perform_op_stack_) const
                {
                    ...
                    case SEQUENCE:
                    case SELECTION:
                    case ITERATION: perform_op_stack_.push(false); break;
                    default       : break;
                    }
