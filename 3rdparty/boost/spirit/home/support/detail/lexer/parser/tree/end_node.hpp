...
namespace boost {
    namespace lexer {
        namespace detail {
            ...
            public:
                end_node(const std::size_t id_, const std::size_t unique_id_, const std::size_t lexer_state_) :
                    node(false),
                    _id(id_),
                ...
                virtual type what_type() const { return END; }
                ...
                virtual bool end_state() const { return true; }

                virtual std::size_t id() const { return _id; }

                virtual std::size_t unique_id() const { return _unique_id; }

                virtual std::size_t lexer_state() const { return _lexer_state; }
