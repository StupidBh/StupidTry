        ...
        namespace detail {
            ...
            public:
                ...
                static void charset(state& state_, string& chars_, bool& negated_)
                {
                    ...
                    while (ch_ != ']') {
                        if (ch_ == '\\') {
                            ...
                            if (chset_) {
                                state temp_state_(str_ + 1, str_ + str_len_, state_._flags, state_._locale);
                                string temp_chars_;
                        ...
                        */
                        ...
                        if (ch_ == '-') {
                            ...
                            if ((state_._flags & icase) &&
                                (std::isupper(prev_, state_._locale) || std::islower(prev_, state_._locale))) {
                ...
                static CharT chr(state& state_)
                {
                    ...
                    case '5':
                    case '6':
                    case '7': ch_ = decode_octal(state_); break;
                    case 'a':
                        ch_ = '\a';
                        state_.increment();
                        break;
                    case 'b':
                        ...
                        state_.increment();
                        break;
                    case 'c': ch_ = decode_control_char(state_); break;
                    case 'e':
                    ...
                    case 'v':
                        ...
                        state_.increment();
                        break;
                    case 'x': ch_ = decode_hex(state_); break;
                    default:
                        ch_ = *state_._curr;
                        state_.increment();
                        break;
            ...
            private:
                ...
                static const wchar_t* charset_shortcut(const wchar_t ch_, std::size_t& str_len_)
                {
                    ...
                    case 's': str_ = L"[ \t\n\r\f\v]"; break;
                    case 'S': str_ = L"[^ \t\n\r\f\v]"; break;
                    case 'w': str_ = L"[_0-9A-Za-z]"; break;
                    case 'W': str_ = L"[^_0-9A-Za-z]"; break;
                    }
                    ...
                    string& chars_)
                {
                    ...
                    */
                    ...
                    if (end_ < start_) {
                        ...
                        ss_ << "Invalid range in charset preceding index " << state_.index() - 1 << '.';
                        throw runtime_error(ss_.str().c_str());
                    }
                    ...
                    for (; start_ <= end_; ++start_) {
                        ...
                        if ((state_._flags & icase) &&
                            (std::isupper(ch_i, state_._locale) || std::islower(ch_i, state_._locale))) {
