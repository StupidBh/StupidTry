            ...
            struct equivset
            {
                ...
                void intersect(equivset& rhs_, equivset& overlap_)
                {
                    ...
                    if (!overlap_._index_vector.empty()) {
                        ...
                        node_vector::const_iterator overlap_begin_ = overlap_._followpos.begin();
                        node_vector::const_iterator overlap_end_ = overlap_._followpos.end();
                        node_vector::const_iterator rhs_iter_ = rhs_._followpos.begin();
                        node_vector::const_iterator rhs_end_ = rhs_._followpos.end();
