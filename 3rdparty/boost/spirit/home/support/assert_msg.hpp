...
//  file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
    ...
    // BOOST_SPIRIT_DONT_USE_MPL_ASSERT_MSG can also be defined by user.
        ...
        #define BOOST_SPIRIT_ASSERT_MSG(Cond, Msg, Types) BOOST_MPL_ASSERT_MSG(Cond, Msg, Types)
    #endif

    #define BOOST_SPIRIT_ASSERT_MATCH(Domain, Expr) \
        BOOST_SPIRIT_ASSERT_MSG((boost::spirit::traits::matches<Domain, Expr>::value), error_invalid_expression, (Expr))
    ...
    #define BOOST_SPIRIT_ASSERT_FAIL(TemplateParam, Msg, Types) \
        BOOST_SPIRIT_ASSERT_MSG((!boost::is_same<TemplateParam, TemplateParam>::value), Msg, Types)
