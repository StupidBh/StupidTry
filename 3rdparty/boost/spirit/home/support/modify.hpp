...
namespace boost {
    namespace spirit {
        ...
        struct has_modifier : is_base_of<T, Modifiers>
        {
        };
        ...
        struct compound_modifier<Current, New, typename enable_if<has_modifier<Current, New>>::type> : Current
        {
            compound_modifier() :
                Current()
            {
        ...
        struct modify
        {
            ...
            {
                typedef typename remove_const<typename remove_reference<Tag>::type>::type tag_type;
                typedef typename remove_const<typename remove_reference<Modifiers>::type>::type modifiers_type;
            ...
            typename result<modify(Tag, Modifiers)>::type operator()(Tag tag, Modifiers modifiers) const
            {
                return op(tag, modifiers, is_modifier_directive<Domain, Tag>());
            }

            template<typename Tag, typename Modifiers>
            Modifiers op(Tag /*tag*/, Modifiers modifiers, mpl::false_) const
            {
                return modifiers;
            }
