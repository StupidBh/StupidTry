    ...
    namespace spirit {
        ...
        struct meta_compiler
        {
            ...
            struct cases
            {
                ...
                struct case_<proto::tag::terminal, Enable> :
                    proto::when<proto::if_<use_terminal<Domain, proto::_value>()>, detail::make_terminal<Domain>>
                {
                };
                ...
                struct case_<Tag, typename enable_if<use_operator<Domain, Tag>>::type> :
                    proto::or_<
                        ...
                        ///////////////////////////////////////////////////////////////////
                        proto::when<
                            proto::binary_expr<Tag, meta_grammar, meta_grammar>,
                            detail::make_binary<Domain, Tag, meta_grammar>>,
                        ///////////////////////////////////////////////////////////////////
                        // unary operators
                        ///////////////////////////////////////////////////////////////////
                        proto::
                            when<proto::unary_expr<Tag, meta_grammar>, detail::make_unary<Domain, Tag, meta_grammar>>>
                {
                };
                    ...
                    proto::or_<
                        ...
                        proto::when<
                            proto::binary_expr<
                                proto::tag::subscript,
                                proto::
                                    and_<proto::terminal<proto::_>, proto::if_<use_directive<Domain, proto::_value>()>>,
                                meta_grammar>,
                        ...
                        ///////////////////////////////////////////////////////////////////
                        proto::when<
                            proto::binary_expr<proto::tag::subscript, meta_grammar, proto::_>,
            ...
            struct cases
            {
                ...
                struct case_<Tag> :
                    proto::or_<
                        ...
                        ///////////////////////////////////////////////////////////////////
                        proto::when<
                            proto::unary_expr<typename enable_if<use_operator<Domain, Tag>, Tag>::type, meta_grammar>,
            ...
            struct meta_grammar : proto::switch_<cases>
            {
            };
        };
        ...
        namespace result_of {
            ...
            struct compile
            {
                ...
                typedef typename meta_grammar::template result<meta_grammar(Expr, mpl::void_, Modifiers)>::type type;
            };

            // If Expr is not a proto expression, make it a terminal
            template<typename Domain, typename Expr, typename Modifiers>
            struct compile<Domain, Expr, Modifiers, typename disable_if<proto::is_expr<Expr>>::type> :
        ...
        namespace traits {
            ...
            struct matches :
                proto::matches<
                    typename proto::result_of::as_expr<typename remove_reference<Expr>::type>::type,
        ...
        template<typename Domain, typename Expr>
        inline typename result_of::compile<Domain, Expr, unused_type>::type compile(Expr const& expr)
        {
        ...
        template<typename Domain, typename Expr, typename Modifiers>
        inline typename result_of::compile<Domain, Expr, Modifiers>::type compile(Expr const& expr, Modifiers modifiers)
        {
            typedef typename proto::is_expr<Expr>::type is_expr;
        ...
        {
            typedef typename fusion::result_of::value_at_c<Elements, 0>::type element_type;
        ...
        struct make_binary_composite
        {
            ...
            typedef typename fusion::result_of::value_at_c<Elements, 1>::type right_type;
            typedef generator<left_type, right_type> result_type;

            result_type operator()(Elements const& elements, unused_type) const
            {
                return result_type(fusion::at_c<0>(elements), fusion::at_c<1>(elements));
            }
        };
        ...
        struct make_nary_composite
        {
            ...
            result_type operator()(Elements const& elements, unused_type) const { return result_type(elements); }
        };
