...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            typename spirit::result_of::extract_from<Exposed, Attribute>::type extract_from(
            ...
            template<typename T, typename Attribute>
            typename spirit::result_of::attribute_as<T, Attribute>::type as(Attribute const& attr);
