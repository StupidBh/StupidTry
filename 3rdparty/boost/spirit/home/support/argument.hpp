...
==============================================================================*/
    ...
    #include <boost/proto/proto_fwd.hpp> // for transform placeholders
        ...
        #define SPIRIT_DECLARE_ARG(z, n, data)                                                         \
            typedef phoenix::actor<argument<n>> BOOST_PP_CAT(BOOST_PP_CAT(_, BOOST_PP_INC(n)), _type); \
            phoenix::actor<argument<n>> const BOOST_PP_CAT(_, BOOST_PP_INC(n)) =                       \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    ...
    mpl::false_ // is not nullary
    ,
    v2_eval(proto::make<boost::spirit::attribute_context<Dummy>()>, proto::call<functional::env(proto::_state)>))
...
namespace boost {
    namespace spirit {
        namespace result_of {
            ...
            struct get_arg
            {
                typedef typename fusion::result_of::size<Sequence>::type sequence_size;

                // report invalid argument not found (N is out of bounds)
                BOOST_SPIRIT_ASSERT_MSG((N < sequence_size::value), index_is_out_of_bounds, ());

                typedef typename fusion::result_of::at_c<Sequence, N>::type type;

                static type call(Sequence& seq) { return fusion::at_c<N>(seq); }
            };
        ...
        typename result_of::get_arg<T, N>::type get_arg(T& val)
        {
        ...
        struct attribute_context
        {
            ...
            struct result
            {
                ...
                typedef typename remove_const<typename mpl::at_c<typename Env::args_type, 0>::type>::type type;
            };
        ...
        struct argument
        {
            ...
            struct result
            {
                typedef typename mpl::at_c<typename Env::args_type, 0>::type arg_type;
        ...
        BOOST_PP_REPEAT_FROM_TO(3, SPIRIT_ARGUMENTS_LIMIT, SPIRIT_DECLARE_ARG, _)
