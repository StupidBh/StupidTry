        ...
        namespace iterator_policies {
            ...
            struct fixed_size_queue
            {
                ...
                protected:
                    ...
                    void swap(unique& x) { boost::core::invoke_swap(queued_position, x.queued_position); }
                    ...
                    static void increment(MultiPass& mp)
                    {
                        ...
                        if (mp.queued_position == mp.shared()->queued_elements.end()) {
                            ...
                            mp.shared()->queued_elements.push_back(MultiPass::get_input(mp));
                    ...
                    {
                        return mp.queued_position == mp.shared()->queued_elements.end() && MultiPass::input_at_eof(mp);
                    }
