...
namespace boost {
    namespace spirit {
        ...
        class multi_pass :
            private boost::base_from_member<typename Policies::BOOST_NESTED_TEMPLATE shared<T>*>,
            public Policies::BOOST_NESTED_TEMPLATE unique<T> {
        private:
            // unique and shared data types
            typedef typename Policies::BOOST_NESTED_TEMPLATE unique<T> policies_base_type;
            typedef typename Policies::BOOST_NESTED_TEMPLATE shared<T> shared_data_type;
        ...
        public:
            ...
            multi_pass() :
                member_base(static_cast<shared_data_type*>(0))
            {
            }
            ...
            bool inhibit_clear_queue() const { return this->member->inhibit_clear_queue_; }

            void inhibit_clear_queue(bool flag) { this->member->inhibit_clear_queue_ = flag; }
            ...
            bool operator<(multi_pass const& y) const { return policies_base_type::less_than(*this, y); }

            bool operator!=(multi_pass const& y) const { return !(*this == y); }

            bool operator>(multi_pass const& y) const { return y < *this; }
        ...
        private: // helper functions
            bool is_eof() const { return (0 == this->member) || policies_base_type::is_eof(*this); }
        };
        ...
        inline multi_pass<T, Policies> make_multi_pass(T& i)
        {
        ...
        ///////////////////////////////////////////////////////////////////////////
        template<typename T>
        inline multi_pass<T> make_default_multi_pass(T& i)
        {
