...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<Domain, terminal<Terminal>> : use_terminal<Domain, Terminal>
        {
        };

        template<typename Domain, typename Terminal, int Arity, typename Actor>
        struct use_terminal<Domain, lazy_terminal<Terminal, Actor, Arity>> : use_lazy_terminal<Domain, Terminal, Arity>
        {
        };
        ...
        {
            typedef typename proto::terminal<lazy_terminal<
            ...
            result_type operator()(F f, A0 const& _0_) const
            {
                ...
                return result_type::make(
                    child_type(phoenix::detail::expression::function_eval<F, A0>::make(f, _0_), f.proto_base().child0));
            }
        };
        ...
        struct make_lazy<F, A0, A1>
        {
            ...
            result_type operator()(F f, A0 const& _0_, A1 const& _1_) const
            {
                typedef typename result_type::proto_child0 child_type;
        ...
        struct make_lazy<F, A0, A1, A2>
        {
            ...
            result_type operator()(F f, A0 const& _0_, A1 const& _1_, A2 const& _2_) const
            {
                typedef typename result_type::proto_child0 child_type;
                return result_type::make(child_type(
        ...
        namespace detail {
            ...
            template<typename A0, typename A1 = unused_type, typename A2 = unused_type>
            struct contains_actor :
                bool_<phoenix::is_actor<A0>::value || phoenix::is_actor<A1>::value || phoenix::is_actor<A2>::value>
            {
            };

            // to_lazy_arg: convert a terminal arg type to the type make_lazy needs
            template<typename A>
            struct to_lazy_arg : phoenix::as_actor<A> // wrap A in a Phoenix actor if not already one
            {
            };

            template<typename A>
            struct to_lazy_arg<const A> : to_lazy_arg<A>
            {
            };

            template<typename A>
            struct to_lazy_arg<A&> : to_lazy_arg<A>
            {
            };
            ...
            template<typename A>
            struct to_nonlazy_arg<const A> : to_nonlazy_arg<A>
            {
            };

            template<typename A>
            struct to_nonlazy_arg<A&> : to_nonlazy_arg<A>
            {
            };
        ...
        template<typename Terminal>
        struct terminal : proto::extends<typename proto::terminal<Terminal>::type, terminal<Terminal>>
        {
            typedef terminal<Terminal> this_type;
            typedef Terminal terminal_type;

            typedef proto::extends<typename proto::terminal<Terminal>::type, terminal<Terminal>> base_type;
        ...
        #pragma warning(push)
        // warning C4348: 'boost::spirit::terminal<...>::result_helper': redefinition of default parameter: parameter 3,
        // 4
        #pragma warning(disable: 4348)
    #endif

            template<bool Lazy, typename A0, typename A1 = unused_type, typename A2 = unused_type>
        ...
        #pragma warning(pop)
            ...
            {
                typedef typename proto::terminal<terminal_ex<
                    Terminal,
                    typename detail::result_of::make_vector<typename detail::to_nonlazy_arg<A0>::type>::type>>::type
                    type;
            };
            ...
            struct result_helper<false, A0, A1>
            {
                typedef typename proto::terminal<terminal_ex<
                    ...
                    typename detail::result_of::make_vector<
                        ...
                        typename detail::to_nonlazy_arg<A1>::type>::type>>::type type;
            };
            ...
            struct result_helper<false, A0, A1, A2>
            {
                typedef typename proto::terminal<terminal_ex<
                    ...
                    typename detail::result_of::make_vector<
                        ...
                        typename detail::to_nonlazy_arg<A2>::type>::type>>::type type;
            };

            template<typename A0, typename A1, typename A2>
            struct result_helper<true, A0, A1, A2>
            {
                typedef typename make_lazy<
                    this_type,
                    typename detail::to_lazy_arg<A0>::type,
                    typename detail::to_lazy_arg<A1>::type,
                    typename detail::to_lazy_arg<A2>::type>::type type;
            };
            ...
            struct result
            {
                typedef typename result_helper<detail::contains_actor<A0, A1, A2>::value, A0, A1, A2>::type type;
            };

            template<typename This, typename A0>
            struct result<This(A0)>
            {
                typedef typename result_helper<
                    detail::contains_actor<A0, unused_type, unused_type>::value,
                    A0,
                    unused_type,
                    unused_type>::type type;
            };
            ...
            {
                typedef
                    typename result_helper<detail::contains_actor<A0, A1, unused_type>::value, A0, A1, unused_type>::
                        type type;
            };
            ...
            template<typename A0>
            typename result<A0>::type operator()(A0 const& _0_, typename detail::contains_actor<A0>::is_false = 0) const
            {
                typedef typename result<A0>::type result_type;
                typedef typename result_type::proto_child0 child_type;
                return result_type::make(child_type(detail::make_vector(_0_), this->proto_base().child0));
            }

            template<typename A0, typename A1>
            typename result<A0, A1>::type
                operator()(A0 const& _0_, A1 const& _1_, typename detail::contains_actor<A0, A1>::is_false = 0) const
            {
                typedef typename result<A0, A1>::type result_type;
                typedef typename result_type::proto_child0 child_type;
                return result_type::make(child_type(detail::make_vector(_0_, _1_), this->proto_base().child0));
            }

            template<typename A0, typename A1, typename A2>
            typename result<A0, A1, A2>::type operator()(
                A0 const& _0_,
                A1 const& _1_,
                A2 const& _2_,
                typename detail::contains_actor<A0, A1, A2>::is_false = 0) const
            {
                ...
                typedef typename result_type::proto_child0 child_type;
                return result_type::make(child_type(detail::make_vector(_0_, _1_, _2_), this->proto_base().child0));
            }

            // Lazy overloads. Enabled when at
            // least one arg is a Phoenix actor.
            template<typename A0>
            typename result<A0>::type operator()(A0 const& _0_, typename detail::contains_actor<A0>::is_true = 0) const
            {
                return make_lazy<this_type, typename phoenix::as_actor<A0>::type>()(
                    *this,
            ...
            template<typename A0, typename A1>
            typename result<A0, A1>::type
                operator()(A0 const& _0_, A1 const& _1_, typename detail::contains_actor<A0, A1>::is_true = 0) const
            {
                return make_lazy<
                    this_type,
                ...
                typename detail::contains_actor<A0, A1, A2>::is_true = 0) const
            {
                return make_lazy<
                    ...
                    typename phoenix::as_actor<A0>::type,
                    typename phoenix::as_actor<A1>::type,
                    typename phoenix::as_actor<A2>::type>()(
                    *this,
                    phoenix::as_actor<A0>::convert(_0_),
                    phoenix::as_actor<A1>::convert(_1_),
        ...
        namespace result_of {
            ...
            {
                typedef typename spirit::terminal<Tag>::template result<A0>::type type;
            };

            template<typename Tag, typename A0, typename A1>
            struct terminal<Tag(A0, A1)>
            {
                typedef typename spirit::terminal<Tag>::template result<A0, A1>::type type;
            };

            template<typename Tag, typename A0, typename A1, typename A2>
            struct terminal<Tag(A0, A1, A2)>
            {
                typedef typename spirit::terminal<Tag>::template result<A0, A1, A2>::type type;
            };
        }
        ...
        namespace tag {
            template<typename Data, typename Tag, typename DataTag1 = unused_type, typename DataTag2 = unused_type>
            struct stateful_tag
            {
                BOOST_SPIRIT_IS_TAG()
                ...
                stateful_tag(data_type const& data) :
                    data_(data)
                {
                }
        ...
        template<typename Data, typename Tag, typename DataTag1 = unused_type, typename DataTag2 = unused_type>
        struct stateful_tag_type : spirit::terminal<tag::stateful_tag<Data, Tag, DataTag1, DataTag2>>
        {
...
namespace boost {
    namespace phoenix {
        template<typename Tag>
        struct is_custom_terminal<Tag, typename Tag::is_spirit_tag> : mpl::true_
        {
        };
...
// (see common_terminals.hpp)
    ...
    #define BOOST_SPIRIT_TERMINAL_Y0
        ...
        #define BOOST_SPIRIT_TERMINAL_NAME(name, type_name)            \
            ...
            inline void BOOST_PP_CAT(silence_unused_warnings_, name)() \
            {                                                          \
                (void)name;                                            \
            }                                                          \
            /***/
    ...
    #define BOOST_SPIRIT_DEFINE_TERMINALS_NAME_A(r, _, names)                                          \
        BOOST_SPIRIT_TERMINAL_NAME(BOOST_PP_TUPLE_ELEM(2, 0, names), BOOST_PP_TUPLE_ELEM(2, 1, names)) \
        /***/

    #define BOOST_SPIRIT_DEFINE_TERMINALS_NAME(seq)                                                                  \
        BOOST_PP_SEQ_FOR_EACH(BOOST_SPIRIT_DEFINE_TERMINALS_NAME_A, _, BOOST_PP_CAT(BOOST_SPIRIT_TERMINAL_X seq, 0)) \
        /***/
...
// (see common_terminals.hpp)
    ...
    #define BOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX_A(r, _, names)                                          \
        BOOST_SPIRIT_TERMINAL_NAME_EX(BOOST_PP_TUPLE_ELEM(2, 0, names), BOOST_PP_TUPLE_ELEM(2, 1, names)) \
        /***/

    #define BOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX(seq)    \
        BOOST_PP_SEQ_FOR_EACH(                            \
            BOOST_SPIRIT_DEFINE_TERMINALS_NAME_EX_A,      \
            _,                                            \
