...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            namespace detail {
                ...
                struct value_type_is_substitute :
                    is_substitute<typename container_value<T>::type, typename container_value<Expected>::type>
                {
                };
                ...
                struct is_substitute_impl<
                    ...
                    typename enable_if<mpl::and_<
                        ...
                        mpl::equal<T, Expected, is_substitute<mpl::_1, mpl::_2>>>>::type> : mpl::true_
                {
                };
                ...
                struct is_substitute_impl<
                    ...
                    typename enable_if<mpl::and_<
                        ...
                        detail::value_type_is_substitute<T, Expected>>>::type> : mpl::true_
                {
                };
            }

            template<typename T, typename Expected, typename Enable /*= void*/>
            struct is_substitute : detail::is_substitute_impl<T, Expected>
            {
            };

            template<typename T, typename Expected>
            struct is_substitute<optional<T>, optional<Expected>> : is_substitute<T, Expected>
            {
            };

            template<typename T>
            struct is_substitute<T, T, typename enable_if<not_is_optional<T>>::type> : mpl::true_
            {
            };
            ...
            namespace detail {
                ...
                struct value_type_is_weak_substitute :
                    is_weak_substitute<typename container_value<T>::type, typename container_value<Expected>::type>
                {
                };
                ...
                struct is_weak_substitute_impl<
                    ...
                    typename enable_if<mpl::and_<
                        is_container<T>,
                        is_container<Expected>,
                        value_type_is_weak_substitute<T, Expected>>>::type> : mpl::true_
                {
                };
                ...
                struct is_weak_substitute_impl<
                    ...
                    typename enable_if<mpl::and_<
                        fusion::traits::is_sequence<T>,
                        fusion::traits::is_sequence<Expected>,
                        mpl::equal<T, Expected, is_weak_substitute<mpl::_1, mpl::_2>>>>::type> : mpl::true_
                {
                };
                ...
                struct is_weak_substitute_impl<
                    ...
                    Expected,
                    typename enable_if<
                        mpl::and_<mpl::not_<fusion::traits::is_sequence<T>>, fusion::traits::is_sequence<Expected>>>::
                        type> : mpl::false_
                {
                };
            }
            ...
            template<typename T, typename Expected, typename Enable /*= void*/>
            struct is_weak_substitute : detail::is_weak_substitute_impl<T, Expected>
            {
            };

            template<typename T, typename Expected>
            struct is_weak_substitute<optional<T>, optional<Expected>> : is_weak_substitute<T, Expected>
            {
            };

            template<typename T, typename Expected>
            struct is_weak_substitute<optional<T>, Expected> : is_weak_substitute<T, Expected>
            {
            };

            template<typename T, typename Expected>
            struct is_weak_substitute<T, optional<Expected>> : is_weak_substitute<T, Expected>
            {
            };

    #if !defined(BOOST_VARIANT_DO_NOT_USE_VARIADIC_TEMPLATES)
            template<typename T, typename Expected>
            struct is_weak_substitute<boost::variant<T>, Expected> : is_weak_substitute<T, Expected>
            {
            };
        ...
        #define BOOST_SPIRIT_IS_WEAK_SUBSTITUTE(z, N, _) \
            ...
            struct is_weak_substitute<boost::detail::variant::void_, Expected> : mpl::true_
            {
            };

            template<BOOST_VARIANT_ENUM_PARAMS(typename T), typename Expected>
            struct is_weak_substitute<boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Expected> :
                mpl::bool_<BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES, BOOST_SPIRIT_IS_WEAK_SUBSTITUTE, _) true>
            {
            };
        ...
        #undef BOOST_SPIRIT_IS_WEAK_SUBSTITUTE
            ...
            struct is_weak_substitute<
                T,
                T,
                typename enable_if<mpl::and_<not_is_optional<T>, not_is_variant<T>>>::type> : mpl::true_
            {
            };
            ...
            struct is_proxy<
                T,
                typename enable_if<mpl::and_<fusion::traits::is_sequence<T>, fusion::traits::is_view<T>>>::type> :
                mpl::true_
            {
            };
            ...
            struct not_is_variant : mpl::not_<detail::has_adapted_variant_tag<T>>
            {
            };

            template<BOOST_VARIANT_ENUM_PARAMS(typename T), typename Domain>
            struct not_is_variant<boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Domain> : mpl::false_
            {
            };
            ...
            template<typename T>
            struct variant_type : mpl::identity<T>
            {
            };

            template<typename T>
            struct variant_type<boost::optional<T>> : variant_type<T>
            {
            };

            template<typename T, typename Domain>
            struct not_is_variant_or_variant_in_optional : not_is_variant<typename variant_type<T>::type, Domain>
            {
            };
            ...
            namespace detail {
                ...
                struct attribute_is_compatible : is_convertible<Attribute, Expected>
                {
                };
                ...
                struct is_hold_any_container : traits::is_hold_any<typename traits::container_value<Container>::type>
                {
                };
            }

            template<typename Attribute, typename Expected, typename IsNotVariant = mpl::false_, typename Enable = void>
            struct compute_compatible_component_variant :
                mpl::or_<
                    traits::detail::attribute_is_compatible<Expected, Attribute>,
                    traits::is_hold_any<Expected>,
                    mpl::eval_if<is_container<Expected>, traits::detail::is_hold_any_container<Expected>, mpl::false_>>
            {
            };
                ...
                typename enable_if<detail::has_types<typename variant_type<Variant>::type>>::type>
            {
                ...
                typedef typename mpl::find_if<types, is_same<Expected, mpl::_1>>::type iter;

                typedef typename mpl::distance<typename mpl::begin<types>::type, iter>::type distance;
                ...
                typedef typename mpl::eval_if<type, mpl::deref<iter>, mpl::identity<unused_type>>::type compatible_type;

                // return whether the given type is compatible with the Expected type
                static bool is_compatible(int which) { return which == distance::value; }
            };

            template<typename Expected, typename Attribute, typename Domain>
            struct compute_compatible_component :
                compute_compatible_component_variant<
                    Attribute,
                    Expected,
            ...
            struct compute_compatible_component<Expected, unused_type, Domain> : mpl::false_
            {
            };

            template<typename Attribute, typename Domain>
            struct compute_compatible_component<unused_type, Attribute, Domain> : mpl::false_
            {
            };

            template<typename Domain>
            struct compute_compatible_component<unused_type, unused_type, Domain> : mpl::false_
            {
            };
            ...
            {
                static int call(boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& v) { return v.which(); }
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename T, typename Domain, typename Enable /* = void*/>
            struct not_is_optional : mpl::true_
            {
            };

            template<typename T, typename Domain>
            struct not_is_optional<boost::optional<T>, Domain> : mpl::false_
            {
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Component, typename Context = unused_type, typename Iterator = unused_type>
            struct attribute_of
            {
                typedef typename Component::template attribute<Context, Iterator>::type type;
            };
            ...
            struct attribute_not_unused
            {
                ...
                struct apply : not_is_unused<typename attribute_of<Component, Context, Iterator>::type>
                {
                };
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename T>
            struct sequence_size : fusion::result_of::size<T>
            {
            };

            template<>
            struct sequence_size<unused_type> : mpl::int_<0>
            {
            };
            ...
            namespace detail {
                ...
                struct attribute_size_impl
                {
                    ...
                    static type call(Attribute const&) { return 1; }
                };
                ...
                struct attribute_size_impl<
                    Attribute,
                    typename enable_if<
                        mpl::and_<fusion::traits::is_sequence<Attribute>, mpl::not_<traits::is_container<Attribute>>>>::
                        type>
                {
                    typedef typename fusion::result_of::size<Attribute>::value_type type;

                    static type call(Attribute const& attr) { return fusion::size(attr); }
                };
                ...
                struct attribute_size_impl<
                    Attribute,
                    typename enable_if<
                        mpl::and_<traits::is_container<Attribute>, mpl::not_<traits::is_iterator_range<Attribute>>>>::
                        type>
                {
                    typedef typename Attribute::size_type type;

                    static type call(Attribute const& attr) { return attr.size(); }
                };
            }

            template<typename Attribute, typename Enable /* = void*/>
            struct attribute_size : detail::attribute_size_impl<Attribute>
            {
            };
            ...
            struct attribute_size<iterator_range<Iterator>>
            {
                ...
                static type call(iterator_range<Iterator> const& r) { return std::distance(r.begin(), r.end()); }
            };
            ...
            struct attribute_size<unused_type>
            {
                ...
                static type call(unused_type) { return 0; }
            };

            template<typename Attribute>
            typename attribute_size<Attribute>::type size(Attribute const& attr)
            {
            ...
            struct wrap_if_not_tuple :
                mpl::if_<fusion::traits::is_sequence<Attribute>, Attribute&, fusion::vector1<Attribute&>>
            {
            };
            ...
            struct filter_unused_attributes : fusion::result_of::filter_if<Sequence, not_is_unused<mpl::_>>
            {
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Attribute, typename Domain>
            struct sequence_attribute_transform : mpl::identity<Attribute>
            {
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Attribute, typename Domain>
            struct permutation_attribute_transform : traits::build_optional<Attribute>
            {
            };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Attribute, typename Domain>
            struct sequential_or_attribute_transform : traits::build_optional<Attribute>
            {
            };
            ...
            struct build_fusion_vector
            {
                ...
                typedef typename filter_unused_attributes<Sequence>::type filtered_attributes;
                ...
                typedef typename mpl::eval_if<
                    ...
                    fusion::result_of::as_vector<filtered_attributes>>::type type;
            };
            ...
            struct build_attribute_sequence
            {
                struct element_attribute
                {
                    ...
                    {
                        typedef
                            typename Transform<typename attribute_of<Element, Context, Iterator>::type, Domain>::type
                                type;
                    };
                    ...
                    typename result<element_attribute(Element)>::type operator()(Element&&) const;
    #endif
                };

                // Compute the list of attributes of all sub-components
                typedef typename fusion::result_of::transform<Sequence, element_attribute>::type type;
            };
            ...
            namespace detail {
                template<typename Sequence, bool no_unused, int size = mpl::size<Sequence>::value>
                struct build_collapsed_variant;

                // N element case, no unused
                template<typename Sequence, int size>
                struct build_collapsed_variant<Sequence, true, size> : spirit::detail::as_variant<Sequence>
                {
                };
                ...
                {
                    typedef boost::optional<typename spirit::detail::as_variant<
                        typename fusion::result_of::pop_front<Sequence>::type>::type>
                        type;
                };

                // 1 element case, no unused
                template<typename Sequence>
                struct build_collapsed_variant<Sequence, true, 1> : mpl::front<Sequence>
                {
                };

                // 1 element case, with unused
                template<typename Sequence>
                struct build_collapsed_variant<Sequence, false, 1> : mpl::front<Sequence>
                {
                };

                // 2 element case, no unused
                template<typename Sequence>
                struct build_collapsed_variant<Sequence, true, 2> : spirit::detail::as_variant<Sequence>
                {
                };
                ...
                struct build_collapsed_variant<Sequence, false, 2>
                {
                    typedef boost::optional<
                        typename mpl::deref<typename mpl::next<typename mpl::begin<Sequence>::type>::type>::type>
                        type;
                };
            }
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Attribute, typename Domain>
            struct alternative_attribute_transform : mpl::identity<Attribute>
            {
            };
            ...
            struct build_variant
            {
                ...
                typedef typename mpl::eval_if<
                    ...
                    fusion::result_of::push_front<filtered_attributes, unused_type>>::type attribute_sequence;

                // Make sure each of the types occur only once in the type list
                typedef typename mpl::fold<
                    attribute_sequence,
                    mpl::vector<>,
                    mpl::if_<mpl::contains<mpl::_1, mpl::_2>, mpl::_1, mpl::push_back<mpl::_1, mpl::_2>>>::type
                    no_duplicates;
                ...
                typedef typename traits::detail::build_collapsed_variant<no_duplicates, no_unused::value>::type type;
            };
            ...
            //
            ///////////////////////////////////////////////////////////////////////////
            template<typename Exposed, typename Transformed, typename Domain, typename Enable /* = void*/>
            struct transform_attribute : detail::transform_attribute_base<Exposed, Transformed, Domain>
            {
                BOOST_STATIC_ASSERT_MSG(!is_reference<Exposed>::value, "Exposed cannot be a reference type");
                BOOST_STATIC_ASSERT_MSG(!is_reference<Transformed>::value, "Transformed cannot be a reference type");
            };

            template<typename Transformed, typename Domain>
            struct transform_attribute<unused_type, Transformed, Domain> : detail::synthesize_attribute<Transformed>
            {
            };
            ...
            template<typename T>
            struct one_element_sequence<T, true, false> : mpl::bool_<mpl::size<T>::value == 1>
            {
            };
            ...
            struct clear_value
            {
                static void call(T& val) { detail::clear_impl(val, typename is_container<T>::type()); }
            };
            ...
            {
                static void call(iterator_range<T>& val) { val = iterator_range<T>(val.end(), val.end()); }
            };
            ...
            struct print_attribute_debug
            {
                ...
                // main entry point
                static void call(Out& out, T const& val) { call_impl(out, val, not_is_variant<T>()); }
            };
            ...
            struct token_printer_debug :
                mpl::if_<
                    mpl::and_<is_convertible<T, char>, is_convertible<char, T>>,
