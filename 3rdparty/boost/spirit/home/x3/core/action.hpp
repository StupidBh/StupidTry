        ...
        namespace x3 {
            ...
            struct action : unary_parser<Subject, action<Subject, Action>>
            {
                ...
                bool parse(
                    ...
                    unused_type) const
                {
                    typedef typename traits::attribute_of<action<Subject, Action>, Context>::type attribute_type;
            ...
            constexpr action<typename extension::as_parser<P>::value_type, Action> operator/(P const& p, Action f)
            {
