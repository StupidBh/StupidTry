        ...
        namespace x3 {
            namespace detail {
                ...
                struct parser_accepts_container :
                    traits::is_substitute<typename traits::attribute_of<Parser, Context>::type, Container>
                {
                };
                ...
                private:
                    ...
                    static bool call_synthesize(
                        ...
                        Attribute& attr)
                    {
                        typedef parser_accepts_container<Parser, Attribute, Context> parser_accepts_container;

                        return call_synthesize_x(
                            parser,
                            first,
                            last,
                            context,
                    ...
                    static bool call_synthesize_into_fusion_seq(
                        ...
                        RContext& rcontext,
                        Attribute& attr,
                        mpl::false_ /* is_associative */)
                    {
                        static_assert(
                            traits::has_size<Attribute, 1>::value,
                            "Expecting a single element fusion sequence");
                        return call_synthesize(parser, first, last, context, rcontext, fusion::front(attr));
                    }
                    ...
                    template<typename Iterator, typename Context, typename RContext, typename Attribute>
                    static bool call_synthesize_dispatch_by_seq(
                        Parser const& parser,
                        Iterator& first,
                        Iterator const& last,
                        Context const& context,
                    ...
                    static bool call(
                        ...
                        mpl::true_)
                    {
                        return call_synthesize_dispatch_by_seq(
                            parser,
                            first,
                            last,
                            context,
                ...
                struct parser_attr_is_substitute_for_container_value :
                    traits::is_substitute<
                        typename traits::
                            pseudo_attribute<Context, typename traits::attribute_of<Parser, Context>::type, Iterator>::
                                type,
                    ...
                    typename enable_if<traits::handles_container<Parser, Context>>::type>
                {
                        ...
                        Attribute& attr)
                    {
                        ...
                        typedef parser_attr_is_substitute_for_container_value<Parser, Iterator, Attribute, Context>
                            parser_attr_is_substitute_for_container_value;

                        typedef mpl::
                            or_<parser_accepts_container, mpl::not_<parser_attr_is_substitute_for_container_value>>
                                pass_attibute_as_is;

                        return call(parser, first, last, context, rcontext, attr, pass_attibute_as_is());
                    }
                };
