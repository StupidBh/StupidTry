...
namespace boost {
    namespace spirit {
        namespace x3 {
            ...
            namespace standard {
                constexpr literal_string<char const*, char_encoding::standard> string(char const* s)
                {
                    return { s };
                }
                ...
                inline constexpr literal_string<char const*, char_encoding::standard, unused_type> lit(char const* s)
                {
                    return { s };
                }
            ...
            namespace standard_wide {
                constexpr literal_string<wchar_t const*, char_encoding::standard_wide> string(wchar_t const* s)
                {
                    return { s };
                }
            ...
            namespace unicode {
                constexpr literal_string<char32_t const*, char_encoding::unicode> string(char32_t const* s)
                {
                    return { s };
                }
                ...
                constexpr literal_string<char32_t const*, char_encoding::unicode, unused_type> lit(char32_t const* s)
                {
                    return { s };
                }
            ...
            namespace ascii {
                constexpr literal_string<wchar_t const*, char_encoding::ascii> string(wchar_t const* s)
                {
                    return { s };
                }
                ...
                constexpr literal_string<char const*, char_encoding::ascii, unused_type> lit(char const* s)
                {
                    return { s };
                }
            ...
            namespace iso8859_1 {
                constexpr literal_string<wchar_t const*, char_encoding::iso8859_1> string(wchar_t const* s)
                {
                    return { s };
                }
                ...
                constexpr literal_string<char const*, char_encoding::iso8859_1, unused_type> lit(char const* s)
                {
                    return { s };
                }
            ...
            namespace extension {
                ...
                struct as_parser<char[N]>
                {
                    ...
                    static constexpr type call(char const* s) { return type(s); }
                };
                ...
                struct as_parser<wchar_t[N]>
                {
                    ...
                    static constexpr type call(wchar_t const* s) { return type(s); }
                };
