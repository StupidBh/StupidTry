...
namespace boost {
    ...
    #define BOOST_SPIRIT_X3_CLASSIFY(name)                                                                \
        ...
        static bool is(name##_tag, Char ch)                                                               \
        {                                                                                                 \
            return Encoding::is##name BOOST_PREVENT_MACRO_SUBSTITUTION(detail::cast_char<char_type>(ch)); \
        }                                                                                                 \
        /***/
    ...
    #undef BOOST_SPIRIT_X3_CLASSIFY
            ...
            struct char_class : char_parser<char_class<Encoding, Tag>>
            {
                ...
                {
                    return encoding::ischar(ch) && char_class_base<Encoding>::is(
                                                       get_case_compare<Encoding>(context).get_char_class_tag(tag()),
                                                       ch);
                }
            };
