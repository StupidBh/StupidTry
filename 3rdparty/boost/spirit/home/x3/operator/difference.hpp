    ...
    namespace spirit {
        namespace x3 {
            ...
            struct difference : binary_parser<Left, Right, difference<Left, Right>>
            {
                ...
                constexpr difference<Left_, Right_> make(Left_ const& left, Right_ const& right) const
                {
                    return { left, right };
                }
            };
    ...
    namespace spirit {
        namespace x3 {
            namespace traits {
                ...
                struct attribute_of<x3::difference<Left, Right>, Context> : attribute_of<Left, Context>
                {
                };

                template<typename Left, typename Right, typename Context>
                struct has_attribute<x3::difference<Left, Right>, Context> : has_attribute<Left, Context>
                {
                };
            }
        }
