    ...
    namespace spirit {
        namespace x3 {
            namespace detail {
                ...
                struct sequence_size_subject : sequence_size<typename Parser::subject_type, Context>
                {
                };

                template<typename Parser, typename Context>
                struct sequence_size<Parser, Context, typename enable_if_c<(Parser::is_pass_through_unary)>::type> :
                ...
                {
                    static int const value = sequence_size<L, Context>::value + sequence_size<R, Context>::value;
                };
                ...
                {
                    typedef typename fusion::result_of::deref<typename fusion::result_of::begin<Attribute>::type>::type
                        type;

                    static type call(Attribute& attribute) { return fusion::deref(fusion::begin(attribute)); }
                };
                ...
                struct pass_through_sequence_attribute
                {
                    ...
                    static Attribute_& call(Attribute_& attribute)
                    {
                        return attribute;
                    }
                };
                ...
                struct pass_sequence_attribute<sequence<L, R>, Attribute> : pass_through_sequence_attribute<Attribute>
                {
                };
                ...
                template<typename L, typename R, typename Attribute, typename Context, typename Enable = void>
                struct partition_attribute
                {
                    using attr_category = typename traits::attribute_category<Attribute>::type;
                    static_assert(
                        is_same<traits::tuple_attribute, attr_category>::value,
                    ...
                    static_assert(actual_size >= expected_size, "Size of the passed attribute is less than expected.");
                    static_assert(
                    ...
                    {
                        return r_part(fusion::advance_c<l_size>(fusion::begin(s)), fusion::end(s));
                    }
                };
                ...
                struct partition_attribute<
                    ...
                    typename enable_if_c<(
                        !traits::has_attribute<L, Context>::value && traits::has_attribute<R, Context>::value)>::type>
                {
                    ...
                    static unused_type left(Attribute&) { return unused; }

                    static Attribute& right(Attribute& s) { return s; }
                };
                        ...
                        traits::has_attribute<L, Context>::value && !traits::has_attribute<R, Context>::value)>::type>
                {
                    ...
                    static Attribute& left(Attribute& s) { return s; }

                    static unused_type right(Attribute&) { return unused; }
                };
                ...
                template<typename Parser, typename Iterator, typename Context, typename RContext, typename Attribute>
                    ...
                    traits::associative_attribute)
                {
                    ...
                    typedef typename traits::attribute_of<decltype(parser.left), Context>::type l_attr_type;
                    typedef typename traits::attribute_of<decltype(parser.right), Context>::type r_attr_type;

                    typedef typename mpl::or_<is_same<l_attr_type, unused_type>, is_same<r_attr_type, unused_type>>
                        should_split;

                    return parse_sequence_assoc(parser, first, last, context, rcontext, attr, should_split());
                }
                ...
                struct parse_into_container_impl<sequence<Left, Right>, Context, RContext>
                {
                    ...
                    static bool call(
                        ...
                        Attribute& attr)
                    {
                        typedef typename traits::attribute_of<parser_type, Context>::type attribute_type;
