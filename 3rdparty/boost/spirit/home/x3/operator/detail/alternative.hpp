        ...
        namespace x3 {
            namespace detail {
                ...
                struct pass_parser_attribute
                {
                    ...
                    typedef
                        typename mpl::if_<is_same<Attribute, substitute_type>, Attribute&, substitute_type>::type type;

                    template<typename Attribute_>
                    static Attribute_& call(Attribute_& attribute, mpl::true_)
                    {
                        return attribute;
                    }

                    template<typename Attribute_>
                    static type call(Attribute_&, mpl::false_)
                    {
                        return type();
                    }

                    template<typename Attribute_>
                    static type call(Attribute_& attribute)
                    {
                ...
                struct pass_non_variant_attribute
                {
                    ...
                    static Attribute& call(Attribute& attribute) { return attribute; }
                };
                ...
                {
                    typedef
                        typename remove_reference<typename fusion::result_of::front<Attribute>::type>::type attr_type;

                    typedef pass_parser_attribute<Parser, attr_type, Context> pass;
                    typedef typename pass::type type;

                    template<typename Attribute_>
                    static type call(Attribute_& attr)
                    {
                ...
                struct pass_parser_attribute<Parser, unused_type, Context> : pass_variant_unused
                {
                };
                ...
                struct parse_into_container_impl<alternative<Left, Right>, Context, RContext>
                {
                    ...
                    static bool call(
                        ...
                        mpl::true_)
                    {
                        return detail::parse_into_container(
                                   alternative_helper<Left> { parser.left },
                                   first,
                                   last,
                                   context,
                                   rcontext,
                               ...
                               detail::parse_into_container(
                                   alternative_helper<Right> { parser.right },
                                   first,
                                   last,
                                   context,
                                   rcontext,
