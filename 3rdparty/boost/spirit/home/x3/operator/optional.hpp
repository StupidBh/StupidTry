    ...
    namespace spirit {
        namespace x3 {
            ...
            struct optional : proxy<Subject, optional<Subject>>
            {
                ...
                {
                    detail::parse_into_container(this->subject, first, last, context, rcontext, attr);
                ...
                {
                    typedef typename x3::traits::optional_value<Attribute>::type value_type;
            ...
            template<typename Subject>
            constexpr optional<typename extension::as_parser<Subject>::value_type> operator-(Subject const& subject)
            {
        ...
        namespace x3 {
            namespace traits {
                ...
                struct attribute_of<x3::optional<Subject>, Context> :
                    build_optional<typename attribute_of<Subject, Context>::type>
                {
                };
            }
        }
