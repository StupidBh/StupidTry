            ...
            namespace traits {
                ...
                namespace detail {
                    ...
                    struct value_type_is_substitute :
                        is_substitute<typename container_value<T>::type, typename container_value<Attribute>::type>
                    {
                    };
                    ...
                    struct is_substitute_impl<
                        ...
                        typename enable_if<mpl::and_<
                            ...
                            mpl::equal<T, Attribute, is_substitute<mpl::_1, mpl::_2>>>>::type> : mpl::true_
                    {
                    };
                    ...
                    struct is_substitute_impl<
                        ...
                        typename enable_if<mpl::and_<
                            ...
                            value_type_is_substitute<T, Attribute>>>::type> : mpl::true_
                    {
                    };
                ...
                template<typename T, typename Attribute, typename Enable /*= void*/>
                struct is_substitute : mpl::or_<is_same<T, Attribute>, detail::is_substitute_impl<T, Attribute>>
                {
                };

                // for reference T
                template<typename T, typename Attribute, typename Enable>
                struct is_substitute<T&, Attribute, Enable> : is_substitute<T, Attribute, Enable>
                {
                };
                ...
                struct is_substitute<
                    ...
                    typename enable_if<typename mpl::eval_if<
                        mpl::and_<fusion::traits::is_sequence<T>, fusion::traits::is_sequence<Attribute>>,
                        mpl::and_<traits::has_size<T, 2>, fusion::traits::is_associative<Attribute>>,
...

                {
                    ...
                    struct has_kv_in_map :
                        mpl::eval_if<
                            ...
                            mpl::apply<is_substitute<fusion::result_of::value_at_key<mpl::_1, Key>, Value>, Map>,
                            mpl::false_>
                    {
                    };
                    ...
                    struct variant_kv :
                        mpl::equal_to<
                            ...
                            mpl::size<
                                mpl::filter_view<typename Variant::types, has_kv_in_map<mpl::_1, p_value, Attribute>>>>
                    {
                    };

                    typedef typename mpl::
                        eval_if<is_variant<p_key>, variant_kv<p_key>, has_kv_in_map<p_key, p_value, Attribute>>::type
                            type;
                };

                template<typename T, typename Attribute>
                struct is_substitute<optional<T>, optional<Attribute>> : is_substitute<T, Attribute>
                {
                };
            }
        }
