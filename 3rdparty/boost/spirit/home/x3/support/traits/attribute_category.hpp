    ...
    namespace spirit {
        namespace x3 {
            namespace traits {
                ...
                struct attribute_category : mpl::identity<plain_attribute>
                {
                };

                template<>
                struct attribute_category<unused_type> : mpl::identity<unused_attribute>
                {
                };

                template<>
                struct attribute_category<unused_type const> : mpl::identity<unused_attribute>
                {
                };
                ...
                struct attribute_category<
                    ...
                    typename enable_if<typename mpl::eval_if<
                        ...
                        mpl::false_>::type>::type> : mpl::identity<associative_attribute>
                {
                };
                ...
                struct attribute_category<
                    T,
                    typename enable_if<
                        mpl::and_<fusion::traits::is_sequence<T>, mpl::not_<fusion::traits::is_associative<T>>>>::
                        type> : mpl::identity<tuple_attribute>
                {
                };
                ...
                template<typename T>
                struct attribute_category<T, typename enable_if<traits::is_optional<T>>::type> :
                    mpl::identity<optional_attribute>
                {
                };

                template<typename T>
                struct attribute_category<T, typename enable_if<traits::is_range<T>>::type> :
                ...
                struct attribute_category<
                    ...
                    typename enable_if<mpl::and_<
                        ...
                        mpl::not_<traits::is_range<T>>>>::type> : mpl::identity<container_attribute>
                {
                };
