            ...
            namespace traits {
                ...
                namespace detail {
                    ...
                    struct is_container_impl<
                        ...
                        void_t<
                            ...
                            typename T::reference>> : mpl::true_
                    {
                    };
                    ...
                    template<typename T>
                    struct is_associative_impl<T, void_t<typename T::key_type>> : mpl::true_
                    {
                    };
                }
                ...
                struct container_value<
                    ...
                    typename enable_if<typename mpl::eval_if<
                        ...
                        mpl::false_>::type>::type> : mpl::identity<T>
                {
                };
                ...
                ///////////////////////////////////////////////////////////////////////////
                template<typename Container, typename Enable = void>
                struct container_iterator : mpl::identity<typename Container::iterator>
                {
                };

                template<typename Container>
                struct container_iterator<Container const> : mpl::identity<typename Container::const_iterator>
                {
                };

                template<>
                struct container_iterator<unused_type> : mpl::identity<unused_type const*>
                {
                };

                template<>
                struct container_iterator<unused_type const> : mpl::identity<unused_type const*>
                {
                };
