...
namespace boost {
    namespace spirit {
        namespace x3 {
            ...
            inline bool extract_sign(Iterator& first, Iterator const& last)
            {
            ...
            struct extract_uint
            {
                ...
                static_assert((Radix >= 2 && Radix <= 36), "Error Unsupported Radix");
                ...
                inline static bool call(Iterator& first, Iterator const& last, T& attr)
                {
                    ...
                    typedef detail::
                        extract_int<T, Radix, MinDigits, MaxDigits, detail::positive_accumulator<Radix>, Accumulate>
                            extract_type;
            ...
            {
                // check template parameter 'Radix' for validity
                static_assert((Radix == 2 || Radix == 8 || Radix == 10 || Radix == 16), "Error Unsupported Radix");
                ...
                inline static bool call(Iterator& first, Iterator const& last, T& attr)
                {
                    ...
                    typedef detail::extract_int<T, Radix, MinDigits, MaxDigits> extract_pos_type;

                    typedef detail::extract_int<T, Radix, MinDigits, MaxDigits, detail::negative_accumulator<Radix>>
                        extract_neg_type;
