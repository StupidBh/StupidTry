...
namespace boost {
    ...
    #define BOOST_SPIRIT_X3_LOG2                                                                                  \
        (#error)(#error)(1'000'000)(1'584'960)(2'000'000)(2'321'920)(2'584'960)(2'807'350)(3'000'000)(3'169'920)( \
            3'321'920)(3'459'430)(3'584'960)(3'700'430)(3'807'350)(3'906'890)(4'000'000)(4'087'460)(4'169'920)(   \
            4'247'920)(4'321'920)(4'392'310)(4'459'430)(4'523'560)(4'584'960)(4'643'850)(4'700'430)(4'754'880)(   \
            4'807'350)(4'857'980)(4'906'890)(4'954'190)(5'000'000)(5'044'390)(5'087'460)(5'129'280)(5'169'925) /***/

    #define BOOST_PP_LOCAL_MACRO(Radix)                                                                           \
        template<int Digits>                                                                                      \
        struct digits2_to_n<Digits, Radix>                                                                        \
        {                                                                                                         \
            BOOST_STATIC_CONSTANT(                                                                                \
                int,                                                                                              \
                value = static_cast<int>((Digits * 1'000'000) / BOOST_PP_SEQ_ELEM(Radix, BOOST_SPIRIT_X3_LOG2))); \
        };                                                                                                        \
        /***/
    ...
    #undef BOOST_SPIRIT_X3_LOG2
                ...
                struct radix_traits
                {
                    ...
                    {
                        return (Radix <= 10 || (ch >= '0' && ch <= '9')) ? ch - '0'
                ...
                struct int_extractor
                {
                    ...
                    inline static bool call(Char ch, std::size_t count, T& n, mpl::true_)
                    {
                        std::size_t constexpr overflow_free = digits_traits<T, Radix>::value - 1;
                    ...
                    template<typename Char, typename T>
                    inline static bool call(Char ch, std::size_t /*count*/, T& n, mpl::false_)
                    {
                    ...
                    template<typename Char>
                    inline static bool call(Char /*ch*/, std::size_t /*count*/, unused_type, mpl::false_)
                    {
                        return true;
                    }

                    template<typename Char, typename T>
                    inline static bool call(Char ch, std::size_t count, T& n)
                    {
                        return call(
                            ch,
                            count,
                            n,
                            mpl::bool_<
                                ((MaxDigits < 0) || (MaxDigits > digits_traits<T, Radix>::value)) &&
                ...
                {
                    inline static bool call(std::size_t count)
                    {
    ...
    #define SPIRIT_NUMERIC_INNER_LOOP(z, x, data)                                    \
        ...
        #pragma warning(disable: 4459) // declaration hides global declaration
                    ...
                    inline static bool parse_main(Iterator& first, Iterator const& last, Attribute& attr)
                    {
                        ...
                        typedef typename traits::attribute_type<Attribute>::type attribute_type;
                        ...
                        while (true) {
                            BOOST_PP_REPEAT(SPIRIT_NUMERICS_LOOP_UNROLL, SPIRIT_NUMERIC_INNER_LOOP, _)
                        }
        ...
        #pragma warning(pop)
                    ...
                    inline static bool parse(Iterator& first, Iterator const& last, unused_type)
                    {
                    ...
                    template<typename Iterator, typename Attribute>
                    inline static bool parse(Iterator& first, Iterator const& last, Attribute& attr)
                    {
