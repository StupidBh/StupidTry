    ...
    namespace spirit {
        namespace x3 {
            ...
            public:
                ...
                position_cache<std::vector<Iterator>> const& get_position_cache() const { return pos_cache; }
            ...
            template<typename Iterator>
            void error_handler<Iterator>::operator()(Iterator err_pos, std::string const& error_message) const
            {
