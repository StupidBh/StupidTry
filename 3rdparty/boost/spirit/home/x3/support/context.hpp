    ...
    namespace spirit {
        namespace x3 {
            ...
            struct context
            {
                ...
                T& get(mpl::identity<ID>) const { return val; }
            ...
            namespace detail {
                ...
                inline Next const& make_unique_context(T& /* val */, Next const& next, FoundVal&)
                {
                    return next;
                }

                template<typename ID, typename T, typename Next>
                inline context<ID, T, Next> make_unique_context(T& val, Next const& next, unused_type)
                {
                    return { val, next };
                }
            }
            ...
            template<typename ID, typename T, typename Next>
            inline auto make_unique_context(T& val, Next const& next)
            {
