...
namespace boost {
    namespace spirit {
        ...
        inline ref_const_ref_value_actor<T, ValueT, insert_key_action> insert_key_a(T& ref_, ValueT const& value_)
        {
            return ref_const_ref_value_actor<T, ValueT, insert_key_action>(ref_, value_);
        }
