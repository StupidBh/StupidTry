...
namespace phoenix {
    ...
    struct composite4_result<new_l<T>, TupleT, A, B, C, D>
    {
        typedef T* type;
    };
    ...
    struct composite5_result<new_l<T>, TupleT, A, B, C, D, E>
    {
        typedef T* type;
    };
    ...
    struct composite6_result<new_l<T>, TupleT, A, B, C, D, E, F>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename F,
        typename G>
    struct composite7_result<new_l<T>, TupleT, A, B, C, D, E, F, G>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename G,
        typename H>
    struct composite8_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename H,
        typename I>
    struct composite9_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename I,
        typename J>
    struct composite10_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename J,
        typename K>
    struct composite11_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename K,
        typename L>
    struct composite12_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename L,
        typename M>
    struct composite13_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename M,
        typename N>
    struct composite14_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M, N>
    {
        typedef T* type;
    };
    ...
    template<
        ...
        typename N,
        typename O>
    struct composite15_result<new_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>
    {
        typedef T* type;
    };
    ...
    //////////////////////////////////
    template<typename T>
    inline typename impl::make_composite<new_l_0<T>>::type new_()
    {
    ...
    inline typename impl::make_composite<new_1<T>, A>::type new_(A const& a)
    {
        typedef impl::make_composite<new_1<T>, A> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;

        return type_t(composite_type_t(new_1<T>(), as_actor<A>::convert(a)));
    }

    //////////////////////////////////
    template<typename T, typename A, typename B>
    inline typename impl::make_composite<new_2<T>, A, B>::type new_(A const& a, B const& b)
    {
        typedef impl::make_composite<new_2<T>, A, B> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;

        return type_t(composite_type_t(new_2<T>(), as_actor<A>::convert(a), as_actor<B>::convert(b)));
    }

    //////////////////////////////////
    template<typename T, typename A, typename B, typename C>
    inline typename impl::make_composite<new_3<T>, A, B, C>::type new_(A const& a, B const& b, C const& c)
    {
        ...
        return type_t(
            composite_type_t(new_3<T>(), as_actor<A>::convert(a), as_actor<B>::convert(b), as_actor<C>::convert(c)));
    }
    ...
    inline typename impl::make_composite<new_4<T>, A, B, C, D>::type
        new_(A const& a, B const& b, C const& c, D const& d)
    {
        typedef impl::make_composite<new_4<T>, A, B, C, D> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<new_5<T>, A, B, C, D, E>::type
        new_(A const& a, B const& b, C const& c, D const& d, E const& e)
    {
        typedef impl::make_composite<new_5<T>, A, B, C, D, E> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<new_6<T>, A, B, C, D, E, F>::type
        new_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f)
    {
        typedef impl::make_composite<new_6<T>, A, B, C, D, E, F> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<new_7<T>, A, B, C, D, E, F, G>::type
        new_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g)
    {
        typedef impl::make_composite<new_7<T>, A, B, C, D, E, F, G> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<new_8<T>, A, B, C, D, E, F, G, H>::type
        new_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g, H const& h)
    {
        typedef impl::make_composite<new_8<T>, A, B, C, D, E, F, G, H> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<new_9<T>, A, B, C, D, E, F, G, H, I>::type
        new_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g, H const& h, I const& i)
    {
        typedef impl::make_composite<new_9<T>, A, B, C, D, E, F, G, H, I> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename I,
        typename J>
    inline typename impl::make_composite<new_10<T>, A, B, C, D, E, F, G, H, I, J>::type new_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        J const& j)
    {
        typedef impl::make_composite<new_10<T>, A, B, C, D, E, F, G, H, I, J> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename J,
        typename K>
    inline typename impl::make_composite<new_11<T>, A, B, C, D, E, F, G, H, I, J, K>::type new_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        K const& k)
    {
        typedef impl::make_composite<new_11<T>, A, B, C, D, E, F, G, H, I, J, K> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename K,
        typename L>
    inline typename impl::make_composite<new_12<T>, A, B, C, D, E, F, G, H, I, J, K, L>::type new_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        L const& l)
    {
        typedef impl::make_composite<new_12<T>, A, B, C, D, E, F, G, H, I, J, K, L> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename L,
        typename M>
    inline typename impl::make_composite<new_13<T>, A, B, C, D, E, F, G, H, I, J, K, L, M>::type new_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        M const& m)
    {
        typedef impl::make_composite<new_13<T>, A, B, C, D, E, F, G, H, I, J, K, L, M> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename M,
        typename N>
    inline typename impl::make_composite<new_14<T>, A, B, C, D, E, F, G, H, I, J, K, L, M>::type new_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        N const& n)
    {
        typedef impl::make_composite<new_14<T>, A, B, C, D, E, F, G, H, I, J, K, L, M, N> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename N,
        typename O>
    inline typename impl::make_composite<new_15<T>, A, B, C, D, E, F, G, H, I, J, K, L, M, O>::type new_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        O const& o)
    {
        typedef impl::make_composite<new_15<T>, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
