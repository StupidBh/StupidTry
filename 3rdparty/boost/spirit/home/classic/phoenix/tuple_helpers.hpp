...
namespace phoenix {
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename A, typename B, typename C, typename AppendT>
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename A, typename B, typename C, typename D, typename AppendT>
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename A, typename B, typename C, typename D, typename E, typename AppendT>
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename A, typename B, typename C, typename D, typename E, typename F, typename AppendT>
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename AppendT>
    ...
    {
        typedef typename concat_tuple_element<
            typename concat_tuple<TupleT1, AppendT>::type,
            TupleT2,
            N + 1,
            typename tuple_element<N + 1, TupleT2>::type>::type type;
    };
    ...
    {
        typedef typename concat_tuple_element<TupleT1, TupleT2, 0, typename tuple_element<0, TupleT2>::type>::type type;
    };
    ...
    TupleResultT convert_actors(ActorTupleT const& actor_tuple)
    {
        ...
        return impl::convert_actors_<length>::template apply<TupleResultT, ActorTupleT>::do_(actor_tuple);
    }
    ...
    namespace impl {
        ...
        struct convert_actor
        {
            ...
            static type actor_element(ActorTupleT const& /*actor_tuple*/, is_default)
            {
            ...
            {
                return actor_element(actor_tuple, is_default_t<(N >= ActorTupleT::length)>());
            }
        };
        ...
        struct convert_actors_<1>
        {
            ...
            struct apply
            {
                static TupleResultT do_(ActorTupleT const& actor_tuple)
                {
                    typedef impl::convert_actor<0, TupleResultT, ActorTupleT> converter0;

                    return TupleResultT(converter0::do_(actor_tuple));
                }
            };
        };
        ...
        struct convert_actors_<2>
        {
            ...
            struct apply
            {
                static TupleResultT do_(ActorTupleT const& actor_tuple)
                {
                    ...
                    return TupleResultT(converter0::do_(actor_tuple), converter1::do_(actor_tuple));
                }
            };
        };
