...
namespace phoenix {
    ...
    struct static_cast_l
    {
        ...
        template<typename TupleT>
        T eval(TupleT const& args) const
        {
    ...
    inline actor<static_cast_l<T, BaseAT>> static_cast_(actor<BaseAT> const& a)
    {
    ...
    //////////////////////////////////
    template<typename T, typename BaseAT>
    inline actor<dynamic_cast_l<T, BaseAT>> dynamic_cast_(actor<BaseAT> const& a)
    {
    ...
    //////////////////////////////////
    template<typename T, typename BaseAT>
    inline actor<reinterpret_cast_l<T, BaseAT>> reinterpret_cast_(actor<BaseAT> const& a)
    {
    ...
    //////////////////////////////////
    template<typename T, typename BaseAT>
    inline actor<const_cast_l<T, BaseAT>> const_cast_(actor<BaseAT> const& a)
    {
    ...
    struct construct_l
    {
        ...
        T operator()(A const& a, B const& b, C const& c, D const& d) const
        {
            T t(a, b, c, d);
            return t;
        }
        ...
        T operator()(A const& a, B const& b, C const& c, D const& d, E const& e) const
        {
            T t(a, b, c, d, e);
            return t;
        }
        ...
        T operator()(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f) const
        {
            T t(a, b, c, d, e, f);
            return t;
        }
        ...
        T operator()(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g) const
        {
            T t(a, b, c, d, e, f, g);
            return t;
        }
        ...
        T operator()(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g, H const& h)
            const
        {
            T t(a, b, c, d, e, f, g, h);
            return t;
    ...
    //////////////////////////////////
    template<typename T, typename TupleT, typename A>
    ...
    //////////////////////////////////
    template<typename T, typename TupleT, typename A, typename B>
    ...
    //////////////////////////////////
    template<typename T, typename TupleT, typename A, typename B, typename C>
    ...
    #if PHOENIX_LIMIT > 3
    //////////////////////////////////
    template<typename T, typename TupleT, typename A, typename B, typename C, typename D>
    struct composite4_result<construct_l<T>, TupleT, A, B, C, D>
    {
        typedef T type;
    };

    //////////////////////////////////
    template<typename T, typename TupleT, typename A, typename B, typename C, typename D, typename E>
    struct composite5_result<construct_l<T>, TupleT, A, B, C, D, E>
    {
        typedef T type;
    };

    //////////////////////////////////
    template<typename T, typename TupleT, typename A, typename B, typename C, typename D, typename E, typename F>
    struct composite6_result<construct_l<T>, TupleT, A, B, C, D, E, F>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename F,
        typename G>
    struct composite7_result<construct_l<T>, TupleT, A, B, C, D, E, F, G>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename G,
        typename H>
    struct composite8_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename H,
        typename I>
    struct composite9_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename I,
        typename J>
    struct composite10_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename J,
        typename K>
    struct composite11_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename K,
        typename L>
    struct composite12_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename L,
        typename M>
    struct composite13_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename M,
        typename N>
    struct composite14_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M, N>
    {
        typedef T type;
    };
    ...
    template<
        ...
        typename N,
        typename O>
    struct composite15_result<construct_l<T>, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>
    {
        typedef T type;
    };
    ...
    //////////////////////////////////
    template<typename T>
    inline typename impl::make_composite<construct_l_0<T>>::type construct_()
    {
    ...
    //////////////////////////////////
    template<typename T, typename A>
    inline typename impl::make_composite<construct_1<T>, A>::type construct_(A const& a)
    {
        typedef impl::make_composite<construct_1<T>, A> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;

        return type_t(composite_type_t(construct_1<T>(), as_actor<A>::convert(a)));
    }

    //////////////////////////////////
    template<typename T, typename A, typename B>
    inline typename impl::make_composite<construct_2<T>, A, B>::type construct_(A const& a, B const& b)
    {
        typedef impl::make_composite<construct_2<T>, A, B> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;

        return type_t(composite_type_t(construct_2<T>(), as_actor<A>::convert(a), as_actor<B>::convert(b)));
    }

    //////////////////////////////////
    template<typename T, typename A, typename B, typename C>
    inline typename impl::make_composite<construct_3<T>, A, B, C>::type construct_(A const& a, B const& b, C const& c)
    {
    ...
    inline typename impl::make_composite<construct_4<T>, A, B, C, D>::type
        construct_(A const& a, B const& b, C const& c, D const& d)
    {
        typedef impl::make_composite<construct_4<T>, A, B, C, D> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<construct_5<T>, A, B, C, D, E>::type
        construct_(A const& a, B const& b, C const& c, D const& d, E const& e)
    {
        typedef impl::make_composite<construct_5<T>, A, B, C, D, E> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<construct_6<T>, A, B, C, D, E, F>::type
        construct_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f)
    {
        typedef impl::make_composite<construct_6<T>, A, B, C, D, E, F> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<construct_7<T>, A, B, C, D, E, F, G>::type
        construct_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g)
    {
        typedef impl::make_composite<construct_7<T>, A, B, C, D, E, F, G> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    inline typename impl::make_composite<construct_8<T>, A, B, C, D, E, F, G, H>::type
        construct_(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g, H const& h)
    {
        typedef impl::make_composite<construct_8<T>, A, B, C, D, E, F, G, H> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename H,
        typename I>
    inline typename impl::make_composite<construct_9<T>, A, B, C, D, E, F, G, H, I>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        I const& i)
    {
        typedef impl::make_composite<construct_9<T>, A, B, C, D, E, F, G, H, I> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename I,
        typename J>
    inline typename impl::make_composite<construct_10<T>, A, B, C, D, E, F, G, H, I, J>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        J const& j)
    {
        typedef impl::make_composite<construct_10<T>, A, B, C, D, E, F, G, H, I, J> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename J,
        typename K>
    inline typename impl::make_composite<construct_11<T>, A, B, C, D, E, F, G, H, I, J, K>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        K const& k)
    {
        typedef impl::make_composite<construct_11<T>, A, B, C, D, E, F, G, H, I, J, K> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename K,
        typename L>
    inline typename impl::make_composite<construct_12<T>, A, B, C, D, E, F, G, H, I, J, K, L>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        L const& l)
    {
        typedef impl::make_composite<construct_12<T>, A, B, C, D, E, F, G, H, I, J, K, L> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename L,
        typename M>
    inline typename impl::make_composite<construct_13<T>, A, B, C, D, E, F, G, H, I, J, K, L, M>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        M const& m)
    {
        typedef impl::make_composite<construct_13<T>, A, B, C, D, E, F, G, H, I, J, K, L, M> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename M,
        typename N>
    inline typename impl::make_composite<construct_14<T>, A, B, C, D, E, F, G, H, I, J, K, L, M>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        N const& n)
    {
        typedef impl::make_composite<construct_14<T>, A, B, C, D, E, F, G, H, I, J, K, L, M, N> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
    ...
    template<
        ...
        typename N,
        typename O>
    inline typename impl::make_composite<construct_15<T>, A, B, C, D, E, F, G, H, I, J, K, L, M, O>::type construct_(
        A const& a,
        B const& b,
        C const& c,
        D const& d,
        ...
        O const& o)
    {
        typedef impl::make_composite<construct_15<T>, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> make_composite_t;
        typedef typename make_composite_t::type type_t;
        typedef typename make_composite_t::composite_type composite_type_t;
