...
namespace phoenix {
    ...
    struct argument
    {
        ...
        template<typename TupleT>
        typename tuple_element<N, TupleT>::type eval(TupleT const& args) const
        {
    ...
    struct value
    {
        ...
        template<typename TupleT>
        plain_t const eval(TupleT const& /*args*/) const
        {
            return val;
        }
    ...
    //////////////////////////////////
    template<typename T>
    inline actor<value<T>> const val(T v)
    {
        return value<T>(v);
    }
    ...
    void val(actor<BaseT> const& v); //  This is undefined and not allowed.
...
///////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////
    template<typename T>
    inline actor<variable<T>> const var(T& v)
    {
        return variable<T>(v);
    }
    ...
    //////////////////////////////////
    template<typename T>
    inline actor<variable<T const>> const const_(T const& v)
    {
    ...
    //////////////////////////////////
    template<typename BaseT>
    void var(actor<BaseT> const& v); //  This is undefined and not allowed.

    //////////////////////////////////
    template<typename BaseT>
    void const_(actor<BaseT> const& v); //  This is undefined and not allowed.
