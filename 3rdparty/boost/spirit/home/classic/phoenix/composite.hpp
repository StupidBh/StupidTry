...
namespace phoenix {
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite0_result<OperationT, TupleT>::type type;
        };
        ...
        template<typename TupleT>
        typename OperationT::result_type eval(TupleT const& /*args*/) const
        {
            return op();
        }
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename OperationT, typename TupleT, typename A>
    struct composite1_result
    {
        typedef typename OperationT::template result<typename actor_result<A, TupleT>::plain_type>::type type;
    };
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite1_result<OperationT, TupleT, A>::type type;
        };
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename OperationT, typename TupleT, typename A, typename B>
    struct composite2_result
    {
        typedef typename OperationT::template result<
            typename actor_result<A, TupleT>::plain_type,
            typename actor_result<B, TupleT>::plain_type>::type type;
    };
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite2_result<OperationT, TupleT, A, B>::type type;
        };
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename OperationT, typename TupleT, typename A, typename B, typename C>
    struct composite3_result
    {
        typedef typename OperationT::template result<
            typename actor_result<A, TupleT>::plain_type,
            typename actor_result<B, TupleT>::plain_type,
            typename actor_result<C, TupleT>::plain_type>::type type;
    };

    //////////////////////////////////
    template<typename OperationT, typename A, typename B, typename C>
    struct composite<
        OperationT,
        A,
        B,
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite3_result<OperationT, TupleT, A, B, C>::type type;
        };

        composite(OperationT const& op_, A const& a_, B const& b_, C const& c_) :
            op(op_),
            a(a_),
            b(b_),
            c(c_)
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename OperationT, typename TupleT, typename A, typename B, typename C, typename D>
    struct composite4_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<D, TupleT>::plain_type>::type type;
    };

    //////////////////////////////////
    template<typename OperationT, typename A, typename B, typename C, typename D>
    struct composite<
        OperationT,
        A,
        B,
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite4_result<OperationT, TupleT, A, B, C, D>::type type;
        };

        composite(OperationT const& op_, A const& a_, B const& b_, C const& c_, D const& d_) :
            op(op_),
            a(a_),
            b(b_),
            c(c_),
    ...
    //
    ///////////////////////////////////////////////////////////////////////////////
    template<typename OperationT, typename TupleT, typename A, typename B, typename C, typename D, typename E>
    struct composite5_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<E, TupleT>::plain_type>::type type;
    };

    //////////////////////////////////
    template<typename OperationT, typename A, typename B, typename C, typename D, typename E>
    struct composite<
        OperationT,
        A,
        B,
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite5_result<OperationT, TupleT, A, B, C, D, E>::type type;
        };

        composite(OperationT const& op_, A const& a_, B const& b_, C const& c_, D const& d_, E const& e_) :
            op(op_),
            a(a_),
            b(b_),
            c(c_),
    ...
    struct composite6_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<F, TupleT>::plain_type>::type type;
    };

    //////////////////////////////////
    template<typename OperationT, typename A, typename B, typename C, typename D, typename E, typename F>
    struct composite<
        OperationT,
        A,
        B,
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite6_result<OperationT, TupleT, A, B, C, D, E, F>::type type;
        };

        composite(OperationT const& op_, A const& a_, B const& b_, C const& c_, D const& d_, E const& e_, F const& f_) :
            op(op_),
            a(a_),
            b(b_),
            c(c_),
    ...
    struct composite7_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<G, TupleT>::plain_type>::type type;
    };

    //////////////////////////////////
    template<typename OperationT, typename A, typename B, typename C, typename D, typename E, typename F, typename G>
    struct composite<
        OperationT,
        A,
        B,
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite7_result<OperationT, TupleT, A, B, C, D, E, F, G>::type type;
        };

        composite(
            OperationT const& op_,
            A const& a_,
            B const& b_,
            C const& c_,
            D const& d_,
    ...
    struct composite8_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<H, TupleT>::plain_type>::type type;
    };
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite8_result<OperationT, TupleT, A, B, C, D, E, F, G, H>::type type;
        };
    ...
    struct composite9_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<I, TupleT>::plain_type>::type type;
    };
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite9_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I>::type type;
        };
    ...
    struct composite10_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<J, TupleT>::plain_type>::type type;
    };
        ...
        >
    {
        ...
        struct result
        {
            typedef typename composite10_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I, J>::type type;
        };
    ...
    struct composite11_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<K, TupleT>::plain_type>::type type;
    };
    ...
    struct composite<
        ...
        >
    {
        typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K> self_t;

        template<typename TupleT>
        struct result
        {
            typedef typename composite11_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I, J, K>::type type;
        };
    ...
    struct composite12_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<L, TupleT>::plain_type>::type type;
    };
    ...
    struct composite<
        ...
        >
    {
        typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L> self_t;

        template<typename TupleT>
        struct result
        {
            typedef typename composite12_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I, J, K, L>::type type;
        };
    ...
    struct composite13_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<M, TupleT>::plain_type>::type type;
    };
    ...
    template<
        ...
        typename L,
        typename M>
    struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, nil_t, nil_t, nil_t>
    {
        typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M> self_t;

        template<typename TupleT>
        struct result
        {
            typedef typename composite13_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M>::type type;
        };
    ...
    struct composite14_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<N, TupleT>::plain_type>::type type;
    };
    ...
    template<
        ...
        typename M,
        typename N>
    struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, nil_t, nil_t>
    {
        typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N> self_t;

        template<typename TupleT>
        struct result
        {
            typedef
                typename composite14_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M, N>::type type;
        };
    ...
    struct composite15_result
    {
        typedef typename OperationT::template result<
            ...
            typename actor_result<O, TupleT>::plain_type>::type type;
    };
    ...
    template<
        ...
        typename N,
        typename O>
    struct composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, nil_t>
    {
        typedef composite<OperationT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O> self_t;

        template<typename TupleT>
        struct result
        {
            typedef
                typename composite15_result<OperationT, TupleT, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>::type type;
        };
    ...
    namespace impl {
        ...
        struct make_unary
        {
            typedef typename make_composite<OperationT, actor<BaseT>>::type type;

            static type construct(actor<BaseT> const& _0)
            {
                typedef typename make_composite<OperationT, actor<BaseT>>::composite_type ret_t;
        ...
        struct make_binary1
        {
            typedef typename make_composite<OperationT, actor<BaseT>, B>::type type;

            static type construct(actor<BaseT> const& _0_, B const& _1_)
            {
                typedef typename make_composite<OperationT, actor<BaseT>, B>::composite_type ret_t;
        ...
        struct make_binary2
        {
            typedef typename make_composite<OperationT, A, actor<BaseT>>::type type;

            static type construct(A const& _0_, actor<BaseT> const& _1_)
            {
                typedef typename make_composite<OperationT, A, actor<BaseT>>::composite_type ret_t;
        ...
        struct make_binary3
        {
            typedef typename make_composite<OperationT, actor<BaseA>, actor<BaseB>>::type type;

            static type construct(actor<BaseA> const& _0_, actor<BaseB> const& _1_)
            {
                typedef typename make_composite<OperationT, actor<BaseA>, actor<BaseB>>::composite_type ret_t;
