...
namespace phoenix {
    ...
    ///////////////////////////////////////////////////////////////////////////////
    template<typename T>
    struct rank<PHOENIX_STD::complex<T>>
    {
    ...
    struct binary_operator<shift_r_op, PHOENIX_STD::istream, T1>
    {
        ...
        static result_type eval(PHOENIX_STD::istream& out, T1& rhs) { return out >> rhs; }
    };

    //////////////////////////////////
    template<typename BaseT>
    inline typename impl::make_binary3<shift_r_op, variable<PHOENIX_STD::istream>, BaseT>::type
        operator>>(PHOENIX_STD::istream& _0, actor<BaseT> const& _1)
    {
        return impl::make_binary3<shift_r_op, variable<PHOENIX_STD::istream>, BaseT>::construct(var(_0), _1);
    }
    ...
    struct binary_operator<shift_l_op, PHOENIX_STD::ostream, T1>
    {
        ...
        static result_type eval(PHOENIX_STD::ostream& out, T1 const& rhs) { return out << rhs; }
    };

    //////////////////////////////////
    template<typename BaseT>
    inline typename impl::make_binary3<shift_l_op, variable<PHOENIX_STD::ostream>, BaseT>::type
        operator<<(PHOENIX_STD::ostream& _0, actor<BaseT> const& _1)
    {
        return impl::make_binary3<shift_l_op, variable<PHOENIX_STD::ostream>, BaseT>::construct(var(_0), _1);
    }
    ...
    //////////////////////////////////
    template<typename BaseT>
    inline typename impl::make_binary3<shift_r_op, variable<PHOENIX_STD::PHOENIX_SSTREAM>, BaseT>::type
        operator>>(PHOENIX_STD::PHOENIX_SSTREAM& _0, actor<BaseT> const& _1)
    {
        return impl::make_binary3<shift_r_op, variable<PHOENIX_STD::PHOENIX_SSTREAM>, BaseT>::construct(var(_0), _1);
    }
    ...
    //////////////////////////////////
    template<typename BaseT>
    inline typename impl::make_binary3<shift_l_op, variable<PHOENIX_STD::PHOENIX_SSTREAM>, BaseT>::type
        operator<<(PHOENIX_STD::PHOENIX_SSTREAM& _0, actor<BaseT> const& _1)
    {
        return impl::make_binary3<shift_l_op, variable<PHOENIX_STD::PHOENIX_SSTREAM>, BaseT>::construct(var(_0), _1);
    }
    ...
    struct unary_operator<dereference_op, T>
    {
        ...
        static result_type eval(T const& iter) { return *iter; }
    };
    ...
    struct binary_operator<index_op, T0, T1>
    {
        ...
        static result_type eval(T0& container, T1 const& index) { return container[index]; }
    };
    ...
    struct binary_operator<index_op, T0 const, T1>
    {
        ...
        static result_type eval(T0 const& container, T1 const& index) { return container[index]; }
    };
