...
namespace phoenix {
    ...
    struct tuple_base
    {
        ...
        template<int N>
        typename tuple_element<N, DerivedT>::crtype operator[](tuple_index<N>) const
        {
            return tuple_element<N, DerivedT>::get(*static_cast<DerivedT const*>(this));
        }

        template<int N>
        typename tuple_element<N, DerivedT>::rtype operator[](tuple_index<N>)
        {
            return tuple_element<N, DerivedT>::get(*static_cast<DerivedT*>(this));
        }
    };
    ...
    struct tuple<A, B, C, D, E, F, G, H, I, J, K, L, M, nil_t, nil_t, nil_t> :
        public tuple_base<tuple<A, B, C, D, E, F, G, H, I, J, K, L, M>>
    {
    ...
    struct tuple<A, B, C, D, E, F, G, H, I, J, K, L, M, N, nil_t, nil_t> :
        public tuple_base<tuple<A, B, C, D, E, F, G, H, I, J, K, L, M, N>>
    {
    ...
    struct tuple<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, nil_t> :
        public tuple_base<tuple<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>>
    {
