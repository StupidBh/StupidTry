...
namespace boost {
    namespace spirit {
        ...
        struct escape_char_action : public unary<ParserT, parser<escape_char_action<ParserT, ActionT, Flags, CharT>>>
        {
            typedef escape_char_action<ParserT, ActionT, Flags, CharT> self_t;
            ...
            {
                return impl::escape_char_action_parse<Flags, CharT>::parse(scan, *this);
            }
        ...
        template<unsigned long Flags, typename CharT>
        struct escape_char_parser : public parser<escape_char_parser<Flags, CharT>>
        {
            ...
            typedef escape_char_action_parser_gen<Flags, CharT> action_parser_generator_t;
            ...
            escape_char_action<self_t, ActionT, Flags, CharT> operator[](ActionT const& actor) const
            {
        ...
        struct escape_char_action_parser_gen
        {
            ...
            static escape_char_action<ParserT, ActionT, Flags, CharT> generate(ParserT const& p, ActionT const& actor)
            {
                typedef escape_char_action<ParserT, ActionT, Flags, CharT> action_parser_t;
        ...
        //
        ///////////////////////////////////////////////////////////////////////////////
        const escape_char_parser<lex_escapes> lex_escape_ch_p = escape_char_parser<lex_escapes>();

        const escape_char_parser<c_escapes> c_escape_ch_p = escape_char_parser<c_escapes>();
