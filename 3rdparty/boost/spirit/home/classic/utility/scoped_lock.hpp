...
namespace boost {
    namespace spirit {
        ...
        struct scoped_lock_parser : public unary<ParserT, parser<scoped_lock_parser<MutexT, ParserT>>>
        {
        ...
        struct scoped_lock_parser_gen
        {
            ...
            explicit scoped_lock_parser_gen(mutex_t& m) :
                mutex(m)
            {
            }
            ...
            scoped_lock_parser<MutexT, typename as_parser<ParserT>::type> operator[](ParserT const& p) const
            {
                ...
                return scoped_lock_parser<mutex_t, parser_t>(mutex, as_parser_t::convert(p));
            }
