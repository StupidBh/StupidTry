...
namespace boost {
    namespace spirit {
        ...
        public:
            typedef contiguous<sequence<chseq<CharT const*>, negated_empty_match_parser<TailT>>> result_t;
            ...
            result_t operator()(CharT const* str) const { return lexeme_d[chseq_p(str) >> ~epsilon_p(tail)]; }
        ...
        public:
            ...
            struct result
            {
                typedef contiguous<sequence<ParserT, negated_empty_match_parser<TailT>>> type;
            };
            ...
            template<typename ParserT>
            typename result<typename as_parser<ParserT>::type>::type operator[](ParserT const& subject) const
            {
                return lexeme_d[as_parser<ParserT>::convert(subject) >> ~epsilon_p(tail)];
            }
        ...
        public:
            ...
            result_t operator()(char_t const* str) const { return lexeme_d[chseq_p(str) >> ~epsilon_p(tail)]; }
        ...
        public:
            ...
            struct result
            {
                typedef contiguous<sequence<ParserT, negated_empty_match_parser<tail_t>>> type;
            };
