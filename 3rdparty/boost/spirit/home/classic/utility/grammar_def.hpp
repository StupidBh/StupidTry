...
namespace boost {
    namespace spirit {
        ...
        namespace impl {
            ...
            private:
                ...
                typedef typename boost::mpl::if_c<boost::is_same<T, same>::value, T0 const*, T const*>::type ptr_type;
            ...
            public:
                ...
                typedef typename boost::mpl::
                    if_c<boost::is_same<T, ::phoenix::nil_t>::value, ::phoenix::nil_t, ptr_type>::type type;
            };
            ...
            struct init_tuple_member
            {
                ...
                {
                    typedef typename boost::mpl::
                        eval_if_c<(N < TupleT::length), ::phoenix::tuple_element<N, TupleT>, phoenix_nil_type>::type
                            element_type;
        ...
        template<
            typename T,
            BOOST_PP_ENUM_PARAMS(BOOST_PP_DEC(BOOST_SPIRIT_GRAMMAR_STARTRULE_TYPE_LIMIT_A), typename T)>
        class grammar_def {
        private:
    ///////////////////////////////////////////////////////////////////////////
    //
    ...
    #define BOOST_SPIRIT_GRAMMARDEF_ENUM_START(z, N, _)                                                \
        ...
        void start_parsers(BOOST_PP_ENUM_##z(BOOST_PP_INC(N), BOOST_SPIRIT_GRAMMARDEF_ENUM_PARAMS, _)) \
        {                                                                                              \
            BOOST_PP_REPEAT_##z(BOOST_PP_INC(N), BOOST_SPIRIT_GRAMMARDEF_ENUM_ASSIGN, _)               \
        }                                                                                              \
        /**/

            BOOST_PP_REPEAT(BOOST_SPIRIT_GRAMMAR_STARTRULE_TYPE_LIMIT_A, BOOST_SPIRIT_GRAMMARDEF_ENUM_START, _)
    ...
    #define BOOST_SPIRIT_GRAMMARDEF_ENUM_INIT(z, N, _) impl::init_tuple_member<N>::do_(t);
            ...
            grammar_def()
            {
                ...
                BOOST_PP_REPEAT_FROM_TO(
                    ...
                    BOOST_SPIRIT_GRAMMARDEF_ENUM_INIT,
                    _)
            }
    ...
    #undef BOOST_SPIRIT_GRAMMARDEF_ENUM_INIT
        ...
        public:
            ...
            template<int N>
            typename ::phoenix::tuple_element<N, tuple_t>::crtype get_start_parser() const
            {
