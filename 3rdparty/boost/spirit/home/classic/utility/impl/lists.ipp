...
namespace boost {
    namespace spirit {
        ...
        {
            typedef no_list_endtoken embed_t;
        };
        ...
        namespace impl {
            ...
            {
                template<typename ParserT, typename ScannerT, typename ItemT, typename DelimT>
                    ...
                    EndT const& end)
                {
                    ...
                    return (refactor_item_d[item - (end | delim)] >>
                            *(delim >> refactor_item_d[item - (end | delim)]) >> !(delim >> end))
                        .parse(scan);
                }
            };
            ...
            struct select_list_parse_refactor<no_list_endtoken>
            {
                ...
                static typename parser_result<ParserT, ScannerT>::type parse(
                    ...
                    ItemT const& item,
                    DelimT const& delim,
                    no_list_endtoken const&)
                {
                    typedef refactor_action_gen<refactor_unary_gen<>> refactor_t;
                    const refactor_t refactor_item_d = refactor_t(refactor_unary_d);

                    return (refactor_item_d[item - delim] >> *(delim >> refactor_item_d[item - delim])).parse(scan);
                }
            };
            ...
            struct select_list_parse_no_refactor
            {
                ...
                static typename parser_result<ParserT, ScannerT>::type parse(
                    ...
                    EndT const& end)
                {
                    return ((item - (end | delim)) >> *(delim >> (item - (end | delim))) >> !(delim >> end))
                        .parse(scan);
                }
            };
            ...
            struct select_list_parse_no_refactor<no_list_endtoken>
            {
                ...
                static typename parser_result<ParserT, ScannerT>::type parse(
                    ...
                    no_list_endtoken const&)
                {
                    return ((item - delim) >> *(delim >> (item - delim))).parse(scan);
                }
            };
            ...
            {
                template<typename ParserT, typename ScannerT, typename ItemT, typename DelimT, typename EndT>
                static typename parser_result<ParserT, ScannerT>::type parse(
                    ScannerT const& scan,
                    ParserT const& p,
                    ItemT const& item,
                    ...
                    EndT const& end)
                {
                    return select_list_parse_refactor<EndT>::parse(scan, p, item, delim, end);
                }
            };
            ...
            struct list_parser_type<plain_parser_category>
            {
                ...
                static typename parser_result<ParserT, ScannerT>::type parse(
                    ...
                    EndT const& end)
                {
                    return select_list_parse_no_refactor<EndT>::parse(scan, p, item, delim, end);
                }
            };
