...
namespace boost {
    namespace spirit {
        ...
        namespace impl {
            ...
            ///////////////////////////////////////////////////////////////////////////////
            //
            inline const char* rx_prefix(char)
            {
                return "\\A";
            }

            inline const wchar_t* rx_prefix(wchar_t)
            {
                return L"\\A";
            }
            ...
            public:
                ...
                {
                    rxstr = string_t(rx_prefix(CharT())) + string_t(first, impl::get_last(first));
                }
                ...
                typename parser_result<self_t, ScannerT>::type parse(ScannerT const& scan) const
                {
                    ...
                    boost::regex_search(scan.first, scan.last, what, rxstr, boost::match_default);
                    ...
                    return scan.create_match(what[0].length(), nil_t(), what[0].first, scan.first);
                }
