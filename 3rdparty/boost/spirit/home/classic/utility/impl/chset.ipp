    ...
    namespace spirit {
        ...
        namespace utility {
            namespace impl {
                ...
                inline void detach(boost::shared_ptr<basic_chset<CharT>>& ptr)
                {
                    if (!ptr.unique()) {
                        ptr = boost::shared_ptr<basic_chset<CharT>>(new basic_chset<CharT>(*ptr));
                    }
                }

                template<typename CharT>
                inline void detach_clear(boost::shared_ptr<basic_chset<CharT>>& ptr)
                {
                    if (ptr.unique()) {
                        ptr->clear();
                    }
        ...
        inline chset<CharT>::chset(anychar_parser /*arg*/) :
            ptr(new basic_chset<CharT>())
        {
            ptr->set((std::numeric_limits<CharT>::min)(), (std::numeric_limits<CharT>::max)());
        }
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(chset const& rhs)
        {
            ptr = rhs.ptr;
            return *this;
        }
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(CharT rhs)
        {
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(anychar_parser /*rhs*/)
        {
            utility::impl::detach_clear(ptr);
            ptr->set((std::numeric_limits<CharT>::min)(), (std::numeric_limits<CharT>::max)());
            return *this;
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(nothing_parser /*rhs*/)
        {
            utility::impl::detach_clear(ptr);
            return *this;
        }
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(chlit<CharT> const& rhs)
        {
            utility::impl::detach_clear(ptr);
            ptr->set(rhs.ch);
            return *this;
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(range<CharT> const& rhs)
        {
            utility::impl::detach_clear(ptr);
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(negated_char_parser<chlit<CharT>> const& rhs)
        {
            utility::impl::detach_clear(ptr);
            set(rhs);
            return *this;
        ...
        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator=(negated_char_parser<range<CharT>> const& rhs)
        {
            utility::impl::detach_clear(ptr);
            set(rhs);
            return *this;
        ...
        template<typename CharT>
        inline void chset<CharT>::set(range<CharT> const& arg_)
        {
        ...
        template<typename CharT>
        inline void chset<CharT>::set(negated_char_parser<chlit<CharT>> const& arg_)
        {
            utility::impl::detach(ptr);
        ...
        template<typename CharT>
        inline void chset<CharT>::set(negated_char_parser<range<CharT>> const& arg_)
        {
            utility::impl::detach(ptr);
        ...
        template<typename CharT>
        inline void chset<CharT>::clear(range<CharT> const& arg_)
        {
            utility::impl::detach(ptr);
        ...
        template<typename CharT>
        inline void chset<CharT>::clear(negated_char_parser<range<CharT>> const& arg_)
        {
            utility::impl::detach(ptr);
        ...
        template<typename CharT>
        inline bool chset<CharT>::test(CharT ch) const
        {
            return ptr->test(ch);
        }

        template<typename CharT>
        inline chset<CharT>& chset<CharT>::inverse()
        {
            utility::impl::detach(ptr);
            ptr->inverse();
            return *this;
        ...
        template<typename CharT>
        inline void chset<CharT>::swap(chset& x)
        {
            ptr.swap(x.ptr);
        }

        template<typename CharT>
        inline chset<CharT>& chset<CharT>::operator|=(chset const& x)
        {
            utility::impl::detach(ptr);
            *ptr |= *x.ptr;
            return *this;
