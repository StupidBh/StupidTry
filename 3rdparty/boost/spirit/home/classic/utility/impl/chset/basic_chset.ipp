...
namespace boost {
    namespace spirit {
        ...
        //////////////////////////////////
        template<typename CharT>
        inline bool basic_chset<CharT>::test(CharT v) const
        {
            return rr.test(v);
        }
        ...
        /////////////////////////////////
        template<typename CharT>
        inline void basic_chset<CharT>::swap(basic_chset& x)
        {
            rr.swap(x.rr);
        }
        ...
        /////////////////////////////////
        template<typename CharT>
        inline basic_chset<CharT>& basic_chset<CharT>::operator|=(basic_chset<CharT> const& x)
        {
        ...
        /////////////////////////////////
        template<typename CharT>
        inline bool basic_chset_8bit<CharT>::test(CharT v) const
        {
        ...
        /////////////////////////////////
        template<typename CharT>
        inline void basic_chset_8bit<CharT>::swap(basic_chset_8bit& x)
        {
        ...
        /////////////////////////////////
        template<typename CharT>
        inline basic_chset_8bit<CharT>& basic_chset_8bit<CharT>::operator|=(basic_chset_8bit const& x)
        {
            bset |= x.bset;
            return *this;
        }
