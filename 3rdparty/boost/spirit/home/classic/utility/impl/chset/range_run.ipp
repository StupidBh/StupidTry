    ...
    namespace spirit {
        ...
        namespace utility {
            namespace impl {
                ...
                //////////////////////////////////
                template<typename CharT>
                inline bool range<CharT>::includes(range const& r) const
                {
                ...
                //////////////////////////////////
                template<typename CharT>
                inline bool range<CharT>::overlaps(range const& r) const
                {
                ...
                //////////////////////////////////
                template<typename CharT>
                inline void range<CharT>::merge(range const& r)
                {
                ...
                {
                    if (!run.empty()) {
                        const_iterator iter = std::lower_bound(run.begin(), run.end(), v, range_char_compare<CharT>());
                ...
                //////////////////////////////////
                template<typename CharT>
                inline void range_run<CharT>::swap(range_run& rr)
                {
                    run.swap(rr.run);
                }
                ...
                void range_run<CharT>::set(range<CharT> const& r)
                {
                    ...
                    if (!run.empty()) {
                        iterator iter = std::lower_bound(run.begin(), run.end(), r, range_compare<CharT>());
