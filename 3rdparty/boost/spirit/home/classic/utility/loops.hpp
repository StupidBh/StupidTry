...
namespace boost {
    namespace spirit {
        ...
        class fixed_loop : public unary<ParserT, parser<fixed_loop<ParserT, ExactT>>> {
        public:
        ...
        class finite_loop : public unary<ParserT, parser<finite_loop<ParserT, MinT, MaxT>>> {
        public:
        ...
        class infinite_loop : public unary<ParserT, parser<infinite_loop<ParserT, MinT>>> {
        public:
            typedef infinite_loop<ParserT, MinT> self_t;
            typedef unary<ParserT, parser<self_t>> base_t;

            infinite_loop(ParserT const& subject_, MinT const& min, more_t const&) :
                base_t(subject_),
                m_min(min)
            {
            }
        ...
        namespace impl {
            ...
            struct loop_traits
            {
                typedef typename mpl::if_<
                    ...
                    finite_loop<ParserT, MinT, MaxT>>::type type;
            };
        ...
        struct nonfixed_loop_gen
        {
            ...
            template<typename ParserT>
            typename impl::loop_traits<ParserT, MinT, MaxT>::type operator[](parser<ParserT> const& subject_) const
            {
                typedef typename impl::loop_traits<ParserT, MinT, MaxT>::type ret_t;
                return ret_t(subject_.derived(), m_min, m_max);
            }
