...
namespace boost {
    namespace spirit {
        ...
        //
        ///////////////////////////////////////////////////////////////////////////////
        template<typename ItemT, typename DelimT, typename EndT, typename CategoryT>
        struct list_parser : public parser<list_parser<ItemT, DelimT, EndT, CategoryT>>
        {
            ...
            list_parser(ItemT const& item_, DelimT const& delim_, EndT const& end_ = no_list_endtoken()) :
                item(item_),
                delim(delim_),
                end(end_)
            {
        ...
        struct list_parser_gen : public list_parser<kleene_star<anychar_parser>, chlit<CharT>>
        {
                ...
                operator()(DelimT const& delim_) const
            {
                ...
                typedef list_parser<item_t, delim_t, no_list_endtoken, unary_parser_category> return_t;
                ...
                operator()(ItemT const& item_, DelimT const& delim_) const
            {
                ...
                typedef typename as_parser<DelimT>::type delim_t;
                typedef list_parser<item_t, delim_t, no_list_endtoken, BOOST_DEDUCED_TYPENAME item_t::parser_category_t>
                    return_t;

                return return_t(as_parser<ItemT>::convert(item_), as_parser<DelimT>::convert(delim_));
            }
                ...
                operator()(ItemT const& item_, DelimT const& delim_, EndT const& end_) const
            {
                ...
                typedef list_parser<item_t, delim_t, end_t, BOOST_DEDUCED_TYPENAME item_t::parser_category_t> return_t;
                ...
                direct(ItemT const& item_, DelimT const& delim_) const
            {
                typedef typename as_parser<ItemT>::type item_t;
                typedef typename as_parser<DelimT>::type delim_t;
                typedef list_parser<item_t, delim_t, no_list_endtoken, plain_parser_category> return_t;
                ...
                direct(ItemT const& item_, DelimT const& delim_, EndT const& end_) const
            {
                ...
                typedef list_parser<item_t, delim_t, end_t, plain_parser_category> return_t;
