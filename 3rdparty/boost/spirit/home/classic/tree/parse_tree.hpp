    ...
    namespace spirit {
        ...
        struct pt_match_policy :
            public common_tree_match_policy<
                ...
                IteratorT,
                NodeFactoryT,
                pt_tree_policy<pt_match_policy<IteratorT, NodeFactoryT, T>, NodeFactoryT, T>,
                T>
        {
        ...
        inline tree_parse_info<IteratorT, NodeFactoryT> pt_parse(
            ...
            NodeFactoryT const& /*dummy_*/ = NodeFactoryT())
        {
            ...
            typedef scanner_policies<it_policy_t, pt_match_policy_t> scan_policies_t;
        ...
        inline tree_parse_info<IteratorT>
            pt_parse(IteratorT const& first, IteratorT const& last, parser<ParserT> const& p, SkipT const& skip)
        {
        ...
        inline tree_parse_info<IteratorT>
            pt_parse(IteratorT const& first_, IteratorT const& last, parser<ParserT> const& parser)
        {
