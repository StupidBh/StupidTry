...
namespace boost {
    namespace spirit {
        ...
        inline void tree_to_xml(
            ...
            GetValueT const& get_token_value)
        {
            basic_tree_to_xml<char>(ostrm, tree, input_line, id_to_name, get_token_id, get_token_value);
        }
        ...
        inline void tree_to_xml(std::ostream& ostrm, TreeNodeT const& tree, std::string const& input_line = "")
        {
