    ...
    namespace spirit {
        ...
        namespace impl {
            ...
            struct for_parser :
                ...
                public unary<typename as_parser<ParsableT>::type, parser<for_parser<InitF, CondT, StepF, ParsableT>>>
            {
                ...
                {
                    typedef typename parser_result<parser_t, ScannerT>::type body_result_t;
                    ...
                    return scan.create_match(length, attr, save, scan.first);
                }
            };
            ...
            struct for_parser_gen
            {
                ...
                for_parser<InitF, CondT, StepF, ParsableT> operator[](ParsableT const& p) const
                {
                    return for_parser<InitF, CondT, StepF, ParsableT>(init, condition, step, p);
                }
        ...
        {
            return impl::for_parser_gen<InitF, ConditionT, StepF>(init_f, condition, step_f);
        }
