...
namespace boost {
    namespace spirit {
        ...
        namespace impl {
            ...
            {
                typedef typename mpl::if_<is_parser<ConditionT>, ConditionT, condition_parser<ConditionT>>::type type;
            ...
            struct condition_evaluator
            {
                ...
                typedef typename boost::call_traits<cond_embed_t>::param_type param_t;

                condition_evaluator(param_t s) :
                    cond(s)
                {
                }
                ...
                std::ptrdiff_t evaluate(ScannerT const& scan) const
                {
