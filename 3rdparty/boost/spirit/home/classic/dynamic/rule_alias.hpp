...
namespace boost {
    namespace spirit {
        ...
        class rule_alias : public parser<rule_alias<ParserT>> {
        public:
            ...
            rule_alias& operator=(ParserT const& p)
            {
                ptr = &p;
                return *this;
            }
            ...
            template<typename ScannerT>
            typename parser_result<ParserT, ScannerT>::type parse(ScannerT const& scan) const
            {
                if (ptr) {
