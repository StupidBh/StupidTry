    ...
    namespace spirit {
        ...
        namespace impl {
            ...
            struct while_parser :
                ...
                <typename as_parser<ParsableT>::type, parser<while_parser<ParsableT, CondT, is_do_parser>>>
            {
            ...
            struct while_parser_gen
            {
                ...
                while_parser<ParsableT, CondT, false> operator[](ParsableT const& subject) const
                {
            ...
            struct do_while_parser_gen
            {
                ...
                template<typename CondT>
                while_parser<ParsableT, CondT, true> while_p(CondT cond) const
                {
            ...
            struct do_parser_gen
            {
                ...
                template<typename ParsableT>
                impl::do_while_parser_gen<ParsableT> operator[](ParsableT const& body) const
                {
