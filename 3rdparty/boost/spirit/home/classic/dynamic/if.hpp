        ...
        namespace impl {
                    ...
                    parser<if_else_parser<ParsableTrueT, ParsableFalseT, CondT>>>
            {
                ...
                if_else_parser(ParsableTrueT const& p_true, ParsableFalseT const& p_false, CondT const& cond_) :
                    ...
                    base_t(as_parser_true_t::convert(p_true), as_parser_false_t::convert(p_false))
                {
                }
                ...
                {
                    typedef typename parser_result<parser_true_t, ScannerT>::type then_result_t;
                    typedef typename parser_result<parser_false_t, ScannerT>::type else_result_t;
            ...
            struct if_else_parser_gen
            {
                ...
                if_else_parser<ParsableTrueT, ParsableFalseT, CondT> operator[](ParsableFalseT const& p_false) const
                {
                    return if_else_parser<ParsableTrueT, ParsableFalseT, CondT>(p_true, p_false, cond);
                }
            ...
            struct if_parser :
                public condition_evaluator<typename as_parser<CondT>::type>,
                public unary<typename as_parser<ParsableT>::type, parser<if_parser<ParsableT, CondT>>>
            {
