    ...
    namespace spirit {
        ...
        namespace multi_pass_policies {
            ...
            protected:
                ...
                void swap(ref_counted& x) { impl::mp_swap(count, x.count); }
            ...
            public:
                ...
                protected:
                    ...
                    // called by operator==
                    bool equal_to(inner const& x) const { return queuePosition == x.queuePosition; }

                    // called by operator<
                    bool less_than(inner const& x) const { return queuePosition < x.queuePosition; }
                }; // class inner
            ...
            public:
                ...
                class inner {
                private:
                    typedef typename std::iterator_traits<InputT>::value_type result_type;
                ...
                public:
                    typedef typename std::iterator_traits<InputT>::difference_type difference_type;
                ...
                protected:
                    ...
                    bool same_input(inner const& x) const { return data == x.data; }

                    typedef typename std::iterator_traits<InputT>::value_type value_t;

                    void swap(inner& x) { impl::mp_swap(data, x.data); }
                ...
                public:
                    ...
                    bool input_at_eof() const { return !data || data->input == InputT(); }
            ...
            public:
                ...
                protected:
                    ...
                    bool same_input(inner const& x) const { return curtok == x.curtok; }

                    void swap(inner& x) { impl::mp_swap(curtok, x.curtok); }

                public:
                    reference get_input() const { return *curtok; }
                    ...
                    bool input_at_eof() const { return *curtok == 0; }
            ...
            public:
                ...
                protected:
                    ...
                    bool same_input(inner const& x) const { return ftor == x.ftor; }
                ...
                public:
                    ...
                    bool input_at_eof() const { return !curtok || *curtok == ftor->eof; }

                    FunctorT& get_functor() const { return *ftor; }
...
#if BOOST_WORKAROUND(__GLIBCPP__, == 20'020'514)
            multi_pass(int);
        ...
        template<
            ...
            typename CheckingPolicy,
            typename StoragePolicy>
        inline multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::multi_pass(int) :
            OP(),
            CHP(),
            SP(),
            IP()
        ...
        inline multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>&
            multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::operator=(
                multi_pass const& x)
        {
            multi_pass temp(x);
            temp.swap(*this);
        ...
        template<
            ...
            typename CheckingPolicy,
            typename StoragePolicy>
        inline typename multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::reference
            multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::operator*() const
        {
            CHP::check_if_valid();
        ...
        template<
            ...
            typename CheckingPolicy,
            typename StoragePolicy>
        inline typename multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::pointer
            multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::operator->() const
        {
            return &(operator*());
        }
        ...
        template<
            ...
            typename StoragePolicy>
        inline multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>
            multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::operator++(int)
        {
        ...
        template<
            ...
            typename CheckingPolicy,
            typename StoragePolicy>
        inline bool multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>::operator==(
            const multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>& y) const
        {
        ...
        inline bool operator!=(
            const multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>& x,
            ...
            make_multi_pass(InputT i)
        {
            return multi_pass<
                ...
                multi_pass_policies::ref_counted,
                multi_pass_policies::buf_id_check,
                multi_pass_policies::std_deque>(i);
        }
        ...
        template<
            ...
            typename StoragePolicy>
        void swap(
            multi_pass<InputT, InputPolicy, OwnershipPolicy, CheckingPolicy, StoragePolicy>& x,
