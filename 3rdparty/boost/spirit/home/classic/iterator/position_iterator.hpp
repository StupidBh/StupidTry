...
namespace boost {
    namespace spirit {
        ...
        struct file_position_without_column_base
        {
            ...
            file_position_without_column_base(String const& file_ = String(), int line_ = 1) :
                file(file_),
                line(line_)
            {
            }
        ...
        struct file_position_base : public file_position_without_column_base<String>
        {
            ...
            file_position_base(String const& file_ = String(), int line_ = 1, int column_ = 1) :
...
namespace boost {
    ...
    #error "Please use at least Boost V1.31.0 while compiling the position_iterator class!"
        ...
        class position_iterator :
            public iterator_::impl::position_iterator_base_generator<SelfT, ForwardIteratorT, PositionT>::type,
            public position_policy<PositionT> {
        private:
            typedef position_policy<PositionT> position_policy_t;
            typedef typename iterator_::impl::position_iterator_base_generator<SelfT, ForwardIteratorT, PositionT>::type
                base_t;
            typedef typename iterator_::impl::position_iterator_base_generator<SelfT, ForwardIteratorT, PositionT>::
        ...
        public:
            ...
            position_iterator(const ForwardIteratorT& begin, const ForwardIteratorT& end) :
                base_t(begin),
                _end(end),
                _pos(PositionT()),
                _isend(begin == end)
            ...
            position_iterator(const ForwardIteratorT& begin, const ForwardIteratorT& end, FileNameT fileName) :
                base_t(begin),
                _end(end),
            ...
            position_iterator(const ForwardIteratorT& begin, const ForwardIteratorT& end, const PositionT& pos) :
                base_t(begin),
                _end(end),
                _pos(pos),
                _isend(begin == end)
        ...
        class position_iterator2 :
            public position_iterator<ForwardIteratorT, PositionT, position_iterator2<ForwardIteratorT, PositionT>> {
        ...
        public:
            ...
            ForwardIteratorT get_currentline_begin() const { return _startline; }

            ForwardIteratorT get_currentline_end() const { return get_endline(); }
        ...
        protected:
            ...
            void newline() { _startline = this->base(); }
        };
