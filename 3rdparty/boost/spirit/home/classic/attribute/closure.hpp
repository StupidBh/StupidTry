...
namespace boost {
    namespace spirit {
        ...
        public:
            typedef typename ::phoenix::tuple_element<0, typename ClosureT::tuple_t>::type attr_t;
            typedef ClosureT base_t;
            typedef closure_context_linker<closure_context<ClosureT>> context_linker_t;
            ...
            {
                hit.value(frame[::phoenix::tuple_index_names::_1]);
                return hit;
            }
        ...
        struct init_closure_parser : public unary<ParserT, parser<init_closure_parser<ParserT, ActorTupleT>>>
        {
                ...
                >
        {
            ...
            struct aux
            {
                ...
                template<typename A>
                init_closure_parser<DerivedT2, ::phoenix::tuple<typename ::phoenix::as_actor<A>::type>>
                    operator()(A const& a) const
                {
                    ...
                    return init_closure_parser<DerivedT2, actor_tuple_t>(
                        aux_derived(),
                        actor_tuple_t(::phoenix::as_actor<A>::convert(a)));
                }

                template<typename A, typename B>
                init_closure_parser<
                    DerivedT2,
                    ::phoenix::tuple<typename ::phoenix::as_actor<A>::type, typename ::phoenix::as_actor<B>::type>>
                    operator()(A const& a, B const& b) const
                {
                    ...
                    return init_closure_parser<DerivedT2, actor_tuple_t>(
                        aux_derived(),
                        actor_tuple_t(::phoenix::as_actor<A>::convert(a), ::phoenix::as_actor<B>::convert(b)));
                }
                    ...
                    operator()(A const& a, B const& b, C const& c, D const& d) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t> actor_tuple_t;
                    ...
                    operator()(A const& a, B const& b, C const& c, D const& d, E const& e) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t> actor_tuple_t;
                    ...
                    operator()(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t> actor_tuple_t;
                    ...
                    operator()(A const& a, B const& b, C const& c, D const& d, E const& e, F const& f, G const& g) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t> actor_tuple_t;
                        ...
                        H const& h) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t> actor_tuple_t;
                        ...
                        I const& i) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t> actor_tuple_t;
                        ...
                        J const& j) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t> actor_tuple_t;
                        ...
                        K const& k) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t, k_t> actor_tuple_t;
                        ...
                        L const& l) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t, k_t, l_t> actor_tuple_t;
                        ...
                        M const& m) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t, k_t, l_t, m_t>
                        actor_tuple_t;
                        ...
                        N const& n) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t, k_t, l_t, m_t, n_t>
                        actor_tuple_t;
                        ...
                        O const& o) const
                {
                    ...
                    typedef ::phoenix::tuple<a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t, k_t, l_t, m_t, n_t, o_t>
                        actor_tuple_t;
        ...
        struct container_begin
        {
            ...
            struct result
            {
                typedef typename ::phoenix::actor_result<ActorT, TupleT>::plain_type::iterator type;
            };
            ...
            template<typename TupleT>
            typename ::phoenix::actor_result<self_t, TupleT>::type eval(TupleT const& /*args*/) const
            {
                return actor().begin();
            }
        ...
        {
            typedef ::phoenix::actor<container_begin<::phoenix::actor<BaseT>>> container_begin_t;
            typedef ::phoenix::actor<container_end<::phoenix::actor<BaseT>>> container_end_t;
