...
namespace boost {
    ...
    #pragma warning(disable: 4512) // assignment operator could not be generated
        ...
        public:
            ...
            //  parser
            BOOST_STATIC_ASSERT(
                (boost::is_convertible<typename BinaryT::parser_category_t, binary_parser_category>::value));
        ...
        public:
            ...
            //  parser
            BOOST_STATIC_ASSERT(
                (boost::is_convertible<typename ActionT::parser_category_t, action_parser_category>::value));
