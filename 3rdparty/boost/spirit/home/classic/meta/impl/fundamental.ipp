        ...
        namespace impl {
            ...
            struct nodes<unary_parser_category>
            {
                ...
                struct count
                {
                    ...
                    BOOST_STATIC_CONSTANT(
                        int,
                        value = (nodes<subject_category_t>::template count<subject_t, LeafCountT>::value + 1));
                };
            };
            ...
            struct nodes<binary_parser_category>
            {
                ...
                struct count
                {
                    ...
                    BOOST_STATIC_CONSTANT(
                        int,
                        leftcount = (nodes<left_category_t>::template count<left_t, LeafCountT>::value));
                    BOOST_STATIC_CONSTANT(
                        int,
                        rightcount = (nodes<right_category_t>::template count<right_t, LeafCountT>::value));
                    BOOST_STATIC_CONSTANT(int, value = ((self_t::leftcount) + (self_t::rightcount) + 1));
                };
            };
            ...
            struct leafs<unary_parser_category>
            {
                ...
                struct count
                {
                    ...
                    BOOST_STATIC_CONSTANT(
                        int,
                        value = (leafs<subject_category_t>::template count<subject_t, LeafCountT>::value));
                };
            };
            ...
            struct leafs<binary_parser_category>
            {
                ...
                struct count
                {
                    ...
                    BOOST_STATIC_CONSTANT(
                        int,
                        leftcount = (leafs<left_category_t>::template count<left_t, LeafCountT>::value));
                    BOOST_STATIC_CONSTANT(
                        int,
                        rightcount = (leafs<right_category_t>::template count<right_t, LeafCountT>::value));
                    BOOST_STATIC_CONSTANT(int, value = (self_t::leftcount + self_t::rightcount));
                };
            };
