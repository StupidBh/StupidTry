        ...
        namespace impl {
            ...
            struct refactor_unary_nested
            {
                ...
                static typename parser_result<ParserT, ScannerT>::type
                    parse(ParserT const&, ScannerT const& scan, BinaryT const& binary, NestedT const& /*nested_d*/)
                {
            ...
            struct refactor_unary_nested<unary_parser_category>
            {
                    ...
                    parse(ParserT const&, ScannerT const& scan, BinaryT const& binary, NestedT const& nested_d)
                {
                    ...
                    return unary_t::generate(nested_d[op_t::generate(binary.left().subject(), binary.right())])
                        .parse(scan);
                }
            };
            ...
            struct refactor_unary_type
            {
                template<typename ParserT, typename ScannerT, typename BinaryT>
                static typename parser_result<ParserT, ScannerT>::type
                    parse(ParserT const& p, ScannerT const& scan, BinaryT const& binary, NestedT const& nested_d)
                {
            ...
            struct refactor_unary_type<non_nested_refactoring>
            {
                template<typename ParserT, typename ScannerT, typename BinaryT>
                static typename parser_result<ParserT, ScannerT>::type
                    parse(ParserT const& p, ScannerT const& scan, BinaryT const& binary, non_nested_refactoring const&)
                {
                    typedef typename BinaryT::left_t::parser_category_t parser_category_t;
            ...
            struct refactor_action_nested<action_parser_category>
            {
                    ...
                    parse(ParserT const&, ScannerT const& scan, BinaryT const& binary, NestedT const& nested_d)
                {
                    ...
                    return (nested_d[binary_gen_t::generate(binary.left().subject(), binary.right())]
            ...
            struct refactor_action_non_nested<action_parser_category>
            {
                    ...
                    parse(ParserT const&, ScannerT const& scan, BinaryT const& binary)
                {
                    ...
                    return (binary_gen_t::generate(binary.left().subject(), binary.right())[binary.left().predicate()])
                        .parse(scan);
                }
            };
            ...
            struct attach_action_nested
            {
                ...
                static typename parser_result<ParserT, ScannerT>::type
                    parse(ParserT const&, ScannerT const& scan, ActionT const& action, NestedT const& /*nested_d*/)
                {
            ...
            struct attach_action_type
            {
                template<typename ParserT, typename ScannerT, typename ActionT>
                static typename parser_result<ParserT, ScannerT>::type
                    parse(ParserT const& p, ScannerT const& scan, ActionT const& action, NestedT const& nested_d)
                {
            ...
            struct attach_action_type<non_nested_refactoring>
            {
                template<typename ParserT, typename ScannerT, typename ActionT>
                static typename parser_result<ParserT, ScannerT>::type
                    parse(ParserT const& p, ScannerT const& scan, ActionT const& action, non_nested_refactoring const&)
                {
                    typedef typename ActionT::subject_t::parser_category_t parser_category_t;
