...
namespace boost {
    namespace spirit {
        ...
        struct is_parser
        {
            BOOST_STATIC_CONSTANT(bool, value = (::boost::is_base_and_derived<parser<T>, T>::value));
        ...
        struct is_unary_composite
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::boost::is_convertible<typename UnaryT::parser_category_t, unary_parser_category>::value));
        };
        ...
        struct is_action_parser
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::boost::is_convertible<typename ActionT::parser_category_t, action_parser_category>::value));
        };
        ...
        struct is_binary_composite
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::boost::is_convertible<typename BinaryT::parser_category_t, binary_parser_category>::value));
        };
        ...
        struct is_alternative
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_alternative));
        };
        ...
        struct is_sequence
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_sequence));
        };
        ...
        struct is_sequential_or
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_sequential_or));
        };
        ...
        struct is_intersection
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_intersection));
        };
        ...
        struct is_difference
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_difference));
        };
        ...
        struct is_exclusive_or
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_exclusive_or));
        };
        ...
        struct is_optional
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_optional));
        };
        ...
        struct is_kleene_star
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_kleene_star));
        };
        ...
        struct is_positive
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = (::BOOST_SPIRIT_CLASSIC_NS::impl::parser_type_traits<ParserT>::is_positive));
        };
