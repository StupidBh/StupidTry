...
=============================================================================*/
    ...
    //
    /////////////////////////////////////////////////////////////////////////////////
    #if (defined(BOOST_MSVC) && (BOOST_MSVC < 1310)) || (defined(BOOST_BORLANDC) && (BOOST_BORLANDC <= 0x570)) || \
        (defined(__GNUC__) && (__GNUC__ < 3)) || (defined(__GNUC__) && (__GNUC__ == 3) && (__GNUC_MINOR__ < 1))
