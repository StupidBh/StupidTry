    ...
    namespace spirit {
        ...
        namespace impl {
            ...
            struct char_type_char_traits_helper
            {
                ...
                static int_type to_int_type(CharT c) { return std::char_traits<CharT>::to_int_type(c); }

                static char_type to_char_type(int_type i) { return std::char_traits<CharT>::to_char_type(i); }
            };
            ...
            struct char_traits_helper
            {
                ...
                static CharT& to_int_type(CharT& c) { return c; }

                static CharT& to_char_type(CharT& c) { return c; }
            };
