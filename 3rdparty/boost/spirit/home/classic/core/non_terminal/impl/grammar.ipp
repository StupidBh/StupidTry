    ...
    namespace spirit {
        ...
        namespace impl {
            ...
            struct grammar_helper_list
            {
                ...
                void push_back(helper_t* helper) { helpers.push_back(helper); }

                void pop_back() { helpers.pop_back(); }

                typename vector_t::size_type size() const { return helpers.size(); }

                typename vector_t::reverse_iterator rbegin() { return helpers.rbegin(); }

                typename vector_t::reverse_iterator rend() { return helpers.rend(); }
            ...
            struct grammar_helper : private grammar_helper_base<GrammarT>
            {
                ...
                grammar_helper* this_() { return this; }
                ...
                int undefine(grammar_t* target_grammar) BOOST_OVERRIDE
                {
                    typename grammar_t::object_id id = target_grammar->get_object_id();
                ...
                get_definition(grammar<DerivedT, ContextT> const* self)
            {
                ...
                boost::thread_specific_ptr<ptr_t>& tld_helper =
                    static_<boost::thread_specific_ptr<ptr_t>, get_definition_static_data_tag>(
                        get_definition_static_data_tag());
            ...
            inline typename parser_result<grammar<DerivedT, ContextT>, ScannerT>::type
                grammar_parser_parse(grammar<DerivedT, ContextT> const* self, ScannerT const& scan)
            {
            ...
            public:
                ...
                entry_grammar(DerivedT const& p) :
                    target_grammar(p)
                {
                }
                ...
                typename parser_result<self_t, ScannerT>::type parse(ScannerT const& scan) const
                {
                    ...
                    BOOST_SPIRIT_CONTEXT_PARSE(scan, target_grammar, scanner_t, context_t, result_t)
                }
