...
namespace boost {
    namespace spirit {
    ...
    #if defined(BOOST_SPIRIT_DEBUG)
        inline std::ostream& operator<<(std::ostream& out, parser_id const& rid)
        {
        ...
        {
            parser_id id() const { return parser_id(reinterpret_cast<std::size_t>(this)); }
        };
        ...
        {
            static parser_id id() { return parser_id(std::size_t(N)); }
        };
        ...
        public:
            ...
            parser_id id() const { return tag.to_long() ? tag : parser_id(reinterpret_cast<std::size_t>(this)); }
