...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename T>
            struct max_digits10<T, typename enable_if_c<(is_floating_point<T>::value)>::type>
            {
    ...
    namespace spirit {
        namespace qi {
            ...
            struct ureal_policies
            {
                ...
                template<typename Iterator, typename Attribute>
                static bool parse_frac_n(Iterator& first, Iterator const& last, Attribute& attr_, int& frac_digits)
                {
