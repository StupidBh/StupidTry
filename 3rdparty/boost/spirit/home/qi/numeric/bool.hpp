...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct bool_parser : spirit::terminal<tag::stateful_tag<BoolPolicies, tag::bool_, T>>
            {
        ...
        struct use_terminal<qi::domain, tag::bool_> : mpl::true_
        {
        };

        template<> // enables true_
        struct use_terminal<qi::domain, tag::true_> : mpl::true_
        {
        };

        template<> // enables false_
        struct use_terminal<qi::domain, tag::false_> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            ...
            typename enable_if<is_same<A0, bool>>::type> : mpl::true_
        {
        };

        ///////////////////////////////////////////////////////////////////////////
        template<typename A0> // enables bool_(...)
        struct use_terminal<qi::domain, terminal_ex<tag::bool_, fusion::vector1<A0>>> : mpl::true_
        {
        };

        template<> // enables *lazy* bool_(...)
        struct use_lazy_terminal<qi::domain, tag::bool_, 1> : mpl::true_
        {
        };
        ...
        struct use_terminal<qi::domain, tag::stateful_tag<BoolPolicies, tag::bool_, T>> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            qi::domain,
            terminal_ex<tag::stateful_tag<BoolPolicies, tag::bool_, T>, fusion::vector1<A0>>> : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename T, typename BoolPolicies = bool_policies<T>>
            struct any_bool_parser : primitive_parser<any_bool_parser<T, BoolPolicies>>
            {
            ...
            template<typename T, typename BoolPolicies = bool_policies<T>, bool no_attribute = true>
            struct literal_bool_parser : primitive_parser<literal_bool_parser<T, BoolPolicies, no_attribute>>
            {
            ...
            struct make_bool
            {
                ...
                typedef typename mpl::if_<
                    mpl::and_<no_case, is_same<bool_policies<T>, Policies>>,
                    any_bool_parser<T, no_case_bool_policies<T>>,
                    any_bool_parser<T, Policies>>::type result_type;
            ...
            struct make_direct_bool
            {
                ...
                typedef typename mpl::if_<
                    ...
                    literal_bool_parser<T, Policies, false>>::type result_type;
            ...
            struct make_literal_bool
            {
                ...
                typedef typename mpl::if_<
                    ...
                    literal_bool_parser<T, Policies>>::type result_type;
            ...
            struct make_primitive<
                terminal_ex<tag::lit, fusion::vector1<A0>>,
                Modifiers,
                typename enable_if<is_same<A0, bool>>::type> : make_literal_bool<bool, Modifiers>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Modifiers>
            struct make_primitive<tag::false_, Modifiers> : make_predefined_direct_bool<bool, Modifiers, false>
            {
            };

            template<typename Modifiers>
            struct make_primitive<tag::true_, Modifiers> : make_predefined_direct_bool<bool, Modifiers, true>
            {
            };
            ...
            struct make_primitive<
                ...
                Modifiers> : make_direct_bool<T, Modifiers, Policies>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Modifiers>
            struct make_primitive<tag::bool_, Modifiers> : make_bool<bool, Modifiers>
            {
            };
