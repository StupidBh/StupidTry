...
#define BOOST_SPIRIT_LOG2                                                                                              \
    (#error)(#error)(1'000'000)(1'584'960)(2'000'000)(2'321'920)(2'584'960)(2'807'350)(3'000'000)(3'169'920)(          \
        3'321'920)(3'459'430)(3'584'960)(3'700'430)(3'807'350)(3'906'890)(4'000'000)(4'087'460)(4'169'920)(4'247'920)( \
        4'321'920)(4'392'310)(4'459'430)(4'523'560)(4'584'960)(4'643'850)(4'700'430)(4'754'880)(4'807'350)(4'857'980)( \
        4'906'890)(4'954'190)(5'000'000)(5'044'390)(5'087'460)(5'129'280)(5'169'925) /***/
...
#define BOOST_PP_LOCAL_MACRO(Radix)                                                                        \
    ...
    {                                                                                                      \
        BOOST_STATIC_CONSTANT(                                                                             \
            int,                                                                                           \
            value = static_cast<int>((Digits * 1'000'000) / BOOST_PP_SEQ_ELEM(Radix, BOOST_SPIRIT_LOG2))); \
    };                                                                                                     \
    /***/
    ...
    #pragma warning(disable: 4127) // conditional expression is constant
                    ...
                    inline static bool parse_main(Iterator& first, Iterator const& last, Attribute& attr)
                    {
                        ...
                        if (!Accumulate) {
                            // skip leading zeros
                            while (it != last && *it == '0' &&
                                   (MaxDigits < 0 || leading_zeros < static_cast<std::size_t>(MaxDigits))) {
                                ++it;
                                ++leading_zeros;
                            }
                        }
