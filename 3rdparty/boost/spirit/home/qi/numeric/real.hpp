...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct real_parser : spirit::terminal<tag::stateful_tag<Policies, tag::double_, T>>
            {
        ...
        struct use_terminal<qi::domain, tag::float_> : mpl::true_
        {
        };

        template<> // enables double_
        struct use_terminal<qi::domain, tag::double_> : mpl::true_
        {
        };

        template<> // enables long_double
        struct use_terminal<qi::domain, tag::long_double> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            ...
            typename enable_if<is_same<A0, float>>::type> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            qi::domain,
            terminal_ex<tag::lit, fusion::vector1<A0>>,
            typename enable_if<is_same<A0, double>>::type> : mpl::true_
        {
        };
        ...
        struct use_terminal<
            qi::domain,
            terminal_ex<tag::lit, fusion::vector1<A0>>,
            typename enable_if<is_same<A0, long double>>::type> : mpl::true_
        {
        };

        ///////////////////////////////////////////////////////////////////////////
        template<typename A0> // enables float_(...)
        struct use_terminal<qi::domain, terminal_ex<tag::float_, fusion::vector1<A0>>> : mpl::true_
        {
        };

        template<typename A0> // enables double_(...)
        struct use_terminal<qi::domain, terminal_ex<tag::double_, fusion::vector1<A0>>> : mpl::true_
        {
        };

        template<typename A0> // enables long_double(...)
        struct use_terminal<qi::domain, terminal_ex<tag::long_double, fusion::vector1<A0>>> : mpl::true_
        {
        };
        ...
        struct use_terminal<qi::domain, tag::stateful_tag<Policies, tag::double_, T>> : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct any_real_parser : primitive_parser<any_real_parser<T, RealPolicies>>
            {
                ...
                bool
                    parse(Iterator& first, Iterator const& last, Context& /*context*/, Skipper const& skipper, T& attr_)
                        const
                {
            ...
            template<typename T, typename RealPolicies = real_policies<T>, bool no_attribute = true>
            struct literal_real_parser : primitive_parser<literal_real_parser<T, RealPolicies, no_attribute>>
            {
                template<typename Value>
                literal_real_parser(Value const& n) :
                    n_(n)
                {
                }
                    ...
                    Attribute& attr_param) const
                {
                    ...
                    if (extract::parse(first, last, attr_, RealPolicies()) && (attr_ == n_)) {
                        traits::assign_to(attr_, attr_param);
                        return true;
                    }
            ...
            struct make_primitive<
                terminal_ex<tag::lit, fusion::vector1<A0>>,
                Modifiers,
                typename enable_if<is_same<A0, float>>::type> : make_literal_real<float>
            {
            };
            ...
            struct make_primitive<
                terminal_ex<tag::lit, fusion::vector1<A0>>,
                Modifiers,
                typename enable_if<is_same<A0, double>>::type> : make_literal_real<double>
            {
            };
            ...
            struct make_primitive<
                terminal_ex<tag::lit, fusion::vector1<A0>>,
                Modifiers,
                typename enable_if<is_same<A0, long double>>::type> : make_literal_real<long double>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename T, typename Policies, typename Modifiers>
            struct make_primitive<tag::stateful_tag<Policies, tag::double_, T>, Modifiers> : make_real<T, Policies>
            {
            };
            ...
            struct make_primitive<
                ...
                Modifiers> : make_direct_real<T, Policies>
            {
            };
            ...
            template<typename Modifiers, typename A0>
            struct make_primitive<terminal_ex<tag::float_, fusion::vector1<A0>>, Modifiers> : make_direct_real<float>
            {
            };
            ...
            template<typename Modifiers, typename A0>
            struct make_primitive<terminal_ex<tag::double_, fusion::vector1<A0>>, Modifiers> : make_direct_real<double>
            {
            };
