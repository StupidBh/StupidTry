...
==============================================================================*/
    ...
    #define BOOST_SPIRIT_ENABLE_BINARY(name)                                           \
        ...
        struct use_terminal<qi::domain, terminal_ex<tag::name, fusion::vector1<A0>>> : \
    ...
    #define BOOST_SPIRIT_ENABLE_BINARY_IEEE754(name)                                                         \
        ...
        {                                                                                                    \
                                                                                                             ...
                                                                                                             \
        template<typename A0>                                                                                \
        struct use_terminal<qi::domain, terminal_ex<tag::name, fusion::vector1<A0>>> : is_floating_point<A0> \
        {                                                                                                    \
        };                                                                                                   \
                                                                                                             \
        template<>                                                                                           \
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            namespace detail {
                ...
                {
                    static char const* is() { return "little-endian binary"; }
                };

                template<>
                struct what<boost::endian::order::big>
                {
                    static char const* is() { return "big-endian binary"; }
                };
            }
            ...
            struct any_binary_parser : primitive_parser<any_binary_parser<T, endian, bits>>
            {
                ...
                struct attribute
                {
                    typedef boost::endian::endian_arithmetic<endian, typename T::type, bits> type;
                };
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename V, typename T, BOOST_SCOPED_ENUM(boost::endian::order) endian, int bits>
            struct binary_lit_parser : primitive_parser<binary_lit_parser<V, T, endian, bits>>
            {
                template<typename Context, typename Iterator>
                struct attribute
                {
    ...
    #define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)                                \
        ...
        struct make_primitive<tag::name, Modifiers> :                                                 \
            make_binary_parser<detail::integer<bits>, boost::endian::order::endiantype, bits>         \
        {                                                                                             \
        };                                                                                            \
                                                                                                      \
        template<typename Modifiers, typename A0>                                                     \
        struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0>>, Modifiers> :               \
            make_binary_lit_parser<A0, detail::integer<bits>, boost::endian::order::endiantype, bits> \
        {                                                                                             \
        };                                                                                            \
                                                                                                      \
        /***/
    ...
    #define BOOST_SPIRIT_MAKE_BINARY_IEEE754_PRIMITIVE(name, endiantype, bits)                               \
        template<typename Modifiers>                                                                         \
        struct make_primitive<tag::name, Modifiers> :                                                        \
            make_binary_parser<detail::floating_point<bits>, boost::endian::order::endiantype, bits>         \
        {                                                                                                    \
        };                                                                                                   \
                                                                                                             \
        template<typename Modifiers, typename A0>                                                            \
        struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0>>, Modifiers> :                      \
            make_binary_lit_parser<A0, detail::floating_point<bits>, boost::endian::order::endiantype, bits> \
        {                                                                                                    \
        };                                                                                                   \
                                                                                                             \
        /***/
