...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct parameterized_nonterminal : parser<parameterized_nonterminal<Subject, Params>>
            {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct handles_container<qi::parameterized_nonterminal<Subject, Params>, Attribute, Context, Iterator> :
