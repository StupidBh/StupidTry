...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            {
                typedef function<bool(Iterator& first, Iterator const& last, Context& context, Skipper const& skipper)>
                    function_type;
                ...
                {
                    typedef qi::detail::reset_on_exit<
                        Iterator,
                        traits::is_multi_pass<Iterator>::value && (action == retry || action == fail)>
                        on_exit_type;
                    ...
                    for (;;) {
                        try {
                            ...
                            typedef fusion::vector<Iterator&, Iterator const&, Iterator const&, info const&> params;
