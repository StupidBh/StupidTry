        ...
        namespace qi {
            ...
            struct success_handler
            {
                ...
                bool operator()(Iterator& first, Iterator const& last, Context& context, Skipper const& skipper) const
                {
                    ...
                    if (r) {
                        typedef fusion::vector<Iterator&, Iterator const&, Iterator const&> params;
            ...
            void on_success(rule<Iterator, T0, T1, T2>& r, F f)
            {
                ...
                typedef success_handler<Iterator, typename rule_type::context_type, typename rule_type::skipper_type, F>
                    success_handler;
