...
namespace boost {
    namespace spirit {
        namespace qi {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Iterator, typename Expr, BOOST_PP_ENUM_PARAMS(N, typename A)>
            inline bool
                parse(Iterator& first, Iterator last, Expr const& expr, BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
            {
            ...
            template<typename Iterator, typename Expr, BOOST_PP_ENUM_PARAMS(N, typename A)>
            inline bool
                parse(Iterator const& first_, Iterator last, Expr const& expr, BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
            {
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Iterator, typename Expr, typename Skipper, BOOST_PP_ENUM_PARAMS(N, typename A)>
                ...
                BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
            {
                ...
                vector_type lattr(BOOST_PP_ENUM_PARAMS(N, attr));
                if (!compile<qi::domain>(expr).parse(first, last, unused, skipper_, lattr)) {
                    return false;
                }
            ...
            {
                Iterator first = first_;
                return qi::phrase_parse(first, last, expr, skipper, post_skip, BOOST_PP_ENUM_PARAMS(N, attr));
            }
            ...
            inline bool phrase_parse(
                ...
                BOOST_PP_ENUM_BINARY_PARAMS(N, A, &attr))
            {
                return qi::phrase_parse(first, last, expr, skipper, skip_flag::postskip, BOOST_PP_ENUM_PARAMS(N, attr));
            }
