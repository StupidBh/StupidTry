            ...
            struct sequential_or : nary_parser<sequential_or<Elements>>
            {
                ...
                struct attribute
                {
                    ...
                    typedef typename traits::build_attribute_sequence<
                        Elements,
                        Context,
                        traits::sequential_or_attribute_transform,
                        Iterator,
                    ...
                    Attribute& attr_) const
                {
                    ...
                    detail::pass_function<Iterator, Context, Skipper> f(first, last, context, skipper);
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct pass_attribute<qi::sequential_or<Elements>, Attribute> : wrap_if_not_tuple<Attribute>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Elements>
            struct has_semantic_action<qi::sequential_or<Elements>> : nary_has_semantic_action<Elements>
            {
            };
