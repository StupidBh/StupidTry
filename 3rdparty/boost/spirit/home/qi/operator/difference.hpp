    ...
    namespace spirit {
        namespace qi {
            ...
            struct difference : binary_parser<difference<Left, Right>>
            {
                ...
                struct attribute
                {
                    typedef typename traits::attribute_of<left_type, Context, Iterator>::type type;
                };
                ...
                {
                    return info("difference", std::make_pair(left.what(context), right.what(context)));
                }
            ...
            struct make_composite<proto::tag::minus, Elements, Modifiers> : make_binary_composite<Elements, difference>
            {
            };
        }
    }
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Left, typename Right>
            struct has_semantic_action<qi::difference<Left, Right>> : binary_has_semantic_action<Left, Right>
            {
            };
