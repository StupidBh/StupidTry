        ...
        namespace qi {
            ...
            struct permutation : nary_parser<permutation<Elements>>
            {
                    ...
                    Attribute& attr_) const
                {
                    ...
                    detail::permute_function<Iterator, Context, Skipper> f(first, last, context, skipper);
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            struct pass_attribute<qi::permutation<Elements>, Attribute> : wrap_if_not_tuple<Attribute>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Elements>
            struct has_semantic_action<qi::permutation<Elements>> : nary_has_semantic_action<Elements>
            {
            };
