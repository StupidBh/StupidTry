    ...
    namespace spirit {
        namespace qi {
                ...
                : nary_parser<Derived>
            {
                    ...
                    mpl::false_) const
                {
                    ...
                    typename traits::wrap_if_not_tuple<
                        ...
                        typename mpl::and_<
                            ...
                            mpl::not_<traits::one_element_sequence<Attribute>>>::type>::type attr_local(attr_);

                    // return false if *any* of the parsers fail
                    if (spirit::any_if(
                            elements,
                            attr_local,
                            Derived::fail_function(iter, last, context, skipper),
                            predicate())) {
                        return false;
                    }
                    first = iter;
                ...
                {
                    return parse_impl(first, last, context, skipper, attr_, traits::is_container<Attribute>());
                }
