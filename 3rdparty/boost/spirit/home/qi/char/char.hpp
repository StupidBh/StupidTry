...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<
            qi::domain,
            terminal<tag::char_code<tag::char_, CharEncoding> // enables char_
                     >> : mpl::true_
        {
        };
        ...
        namespace qi {
            ...
            struct literal_char :
                char_parser<
                    ...
                    typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
            {
                ...
                struct attribute
                {
                    typedef typename mpl::if_c<no_attribute, unused_type, char_type>::type type;
                };

                template<typename CharParam, typename Context>
                bool test(CharParam ch_, Context&) const
                {
                    return traits::ischar<CharParam, char_encoding>::call(ch_) && ch == char_type(ch_);
                }
            ...
            struct char_range : char_parser<char_range<CharEncoding, false>, typename CharEncoding::char_type>
            {
                typedef typename CharEncoding::char_type char_type;
                typedef CharEncoding char_encoding;
                ...
                : char_parser<char_range<CharEncoding, true>, typename CharEncoding::char_type>
            {
                ...
                bool test(CharParam ch_, Context&) const
                {
                    ...
                    char_type ch = char_type(ch_); // optimize for token based parsing
                    return (!(ch < from_lo) && !(to_lo < ch)) || (!(ch < from_hi) && !(to_hi < ch));
                }
            ...
            struct char_set :
                char_parser<
                    char_set<CharEncoding, no_attribute, false>,
                    typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
            {
                typedef typename CharEncoding::char_type char_type;
                typedef CharEncoding char_encoding;
                ...
                char_set(String const& str)
                {
                    ...
                    in_type const* definition = (in_type const*)traits::get_c_string(str);
                ...
                {
                    return traits::ischar<CharParam, char_encoding>::call(ch) && chset.test(char_type(ch));
                }
            ...
            struct char_set<CharEncoding, no_attribute, true> // case insensitive
                :
                char_parser<
                    char_set<CharEncoding, no_attribute, true>,
                    typename mpl::if_c<no_attribute, unused_type, typename CharEncoding::char_type>::type>
            {
                typedef typename CharEncoding::char_type char_type;
                typedef CharEncoding char_encoding;
                ...
                char_set(String const& str)
                {
                    ...
                    while (ch) {
                        ...
                        if (next == '-') {
                            ...
                            chset.set(
                                static_cast<char_type>(CharEncoding::tolower(ch)),
                                static_cast<char_type>(CharEncoding::tolower(next)));
                            chset.set(
                                static_cast<char_type>(CharEncoding::toupper(ch)),
            ...
            namespace detail {
                ...
                {
                    static bool const no_case = has_modifier<Modifiers, tag::char_code_base<tag::no_case>>::value;

                    static bool const no_attr = !has_modifier<Modifiers, tag::lazy_eval>::value;

                    typedef literal_char<
                        typename spirit::detail::get_encoding_with_case<Modifiers, Encoding, no_case>::type,
                        no_attr,
                        no_case>
                        result_type;
            ...
            {
                typedef typename spirit::detail::get_encoding<Modifiers, CharEncoding>::type char_encoding;
            ...
            struct make_primitive<terminal_ex<tag::char_code<tag::char_, CharEncoding>, fusion::vector1<A0>>, Modifiers>
            {
                ...
                typedef typename mpl::if_<
                    ...
                    literal_char<char_encoding, false, no_case>>::type result_type;
                ...
                typename enable_if<traits::is_char<A0>>::type>
            {
                ...
                typedef
                    typename traits::char_encoding_from_char<typename traits::char_type_of<A0>::type>::type encoding;
