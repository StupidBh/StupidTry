        ...
        namespace qi {
            ...
            namespace detail {
                ...
                struct make_negated_char_parser<negated_char_parser<Positive>>
                {
                    ...
                    result_type operator()(negated_char_parser<Positive> const& ncp) const { return ncp.positive; }
                };
            }
            ...
            struct make_composite<proto::tag::complement, Elements, Modifiers>
            {
                ...
                typedef typename detail::make_negated_char_parser<subject>::result_type result_type;

                result_type operator()(Elements const& elements, unused_type) const
                {
                    return detail::make_negated_char_parser<subject>()(fusion::at_c<0>(elements));
                }
            };
        }
    }
