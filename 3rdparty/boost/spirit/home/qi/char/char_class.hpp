...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<qi::domain, tag::char_code<CharClass, CharEncoding>> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct char_class : char_parser<char_class<Tag>, typename Tag::char_encoding::char_type>
            {
            ...
            struct make_primitive<tag::char_code<CharClass, CharEncoding>, Modifiers>
            {
                ...
                typedef tag::char_code<typename detail::make_char_class<CharClass, no_case>::type, char_encoding> tag;
