    ...
    namespace spirit {
        namespace qi {
            ...
            struct expect_directive : unary_parser<expect_directive<Subject>>
            {
                ...
                struct attribute
                {
                    typedef traits::attribute_of<subject_type, Context, Iterator> type;
                };

                expect_directive(Subject const& subject_) :
                    subject(subject_)
                {
                }
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject>
            struct has_semantic_action<qi::expect_directive<Subject>> : unary_has_semantic_action<Subject>
            {
            };

            ///////////////////////////////////////////////////////////////////////////
            template<typename Subject, typename Attribute, typename Context, typename Iterator>
            struct handles_container<qi::expect_directive<Subject>, Attribute, Context, Iterator> :
