        ...
        namespace qi {
            namespace detail {
                ...
                struct tst_node
                {
                    ...
                    static T* find(tst_node* start, Iterator& first, Iterator last, Filter filter)
                    {
                        if (first == last) {
                            return 0;
                        }
                        ...
                        while (p && i != last) {
                            typename std::iterator_traits<Iterator>::value_type c = filter(*i); // filter only the input
                            ...
                            Alloc* alloc)
                    {
                        ...
                        tst_node** pp = &start;
                        for (;;) {
                            typename std::iterator_traits<Iterator>::value_type c = *first;
                    ...
                    template<typename Iterator, typename Alloc>
                    static void remove(tst_node*& p, Iterator first, Iterator last, Alloc* alloc)
                    {
                        if (p == 0 || first == last) {
                            return;
                        }
