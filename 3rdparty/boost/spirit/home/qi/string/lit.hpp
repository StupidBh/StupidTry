...
namespace boost {
    namespace spirit {
        ...
        ///////////////////////////////////////////////////////////////////////////
        template<typename T>
        struct use_terminal<qi::domain, T, typename enable_if<traits::is_string<T>>::type> // enables strings
            : mpl::true_
        {
        };
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct literal_string : primitive_parser<literal_string<String, no_attribute>>
            {
                ...
                struct attribute
                {
                    typedef typename mpl::if_c<no_attribute, unused_type, string_type>::type type;
                };
            ...
            template<typename String, bool no_attribute>
            struct no_case_literal_string : primitive_parser<no_case_literal_string<String, no_attribute>>
            {
                typedef typename remove_const<typename traits::char_type_of<String>::type>::type char_type;
                typedef std::basic_string<char_type> string_type;
            ...
            struct make_primitive<T, Modifiers, typename enable_if<traits::is_string<T>>::type>
            {
                ...
                typedef typename mpl::
                    if_<no_case, no_case_literal_string<const_string, true>, literal_string<const_string, true>>::type
                        result_type;
                ...
                typename enable_if<traits::is_string<A0>>::type>
            {
                ...
                result_type op(String const& str, mpl::true_) const
                {
                    typedef typename traits::char_encoding_from_char<typename traits::char_type_of<A0>::type>::type
                        encoding_type;
                    typename spirit::detail::get_encoding<Modifiers, encoding_type>::type encoding;
                    return result_type(traits::get_c_string(str), encoding);
                }
            };
                ...
                Modifiers>
            {
                ...
                typedef typename add_const<A0>::type const_string;
                typedef typename mpl::
                    if_<no_case, no_case_literal_string<const_string, false>, literal_string<const_string, false>>::type
                        result_type;
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename String, bool no_attribute, typename Attribute, typename Context, typename Iterator>
