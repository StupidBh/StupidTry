            ...
            namespace detail {
                ...
                struct parse_impl<
                    ...
                    typename enable_if<mpl::and_<
                        ...
                        mpl::not_<traits::matches<qi::domain, Expr>>>>::type>
                {
                    ...
                    {
                        return qi::parse(first, last, create_parser<Expr>(), const_cast<Expr&>(expr));
                    }
                };
                        ...
                        mpl::not_<traits::matches<qi::domain, Expr>>>>::type>
                {
                    ...
                    {
                        return qi::phrase_parse(first, last, create_parser<Expr>(), skipper, post_skip, expr);
                    }
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            inline bool parse(Iterator& first, Iterator last, Expr& expr)
            {
