    ...
    namespace spirit {
        namespace qi {
            namespace detail {
                ...
                struct parse_impl<Expr, typename enable_if<traits::matches<qi::domain, Expr>>::type>
                {
                ...
                template<typename Expr>
                struct phrase_parse_impl<Expr, typename enable_if<traits::matches<qi::domain, Expr>>::type>
                {
                        ...
                        BOOST_SCOPED_ENUM(skip_flag) post_skip)
                    {
                        ...
                        if (!compile<qi::domain>(expr).parse(first, last, unused, skipper_, unused)) {
                            return false;
                        }
