    ...
    namespace spirit {
        namespace qi {
            namespace detail {
                ...
                struct pass_through_container_base : negate_weak_substitute_if_not<Sequence, Attribute, ValueType>
                {
                };
                ...
                template<typename Container, typename ValueType, typename Attribute, typename Sequence = mpl::true_>
                ...
                {
                    typedef
                        typename mpl::find_if<Attribute, not_compatible_element<Container, ValueType, mpl::_1>>::type
                            iter;
                ...
                template<typename Container, typename ValueType, typename Attribute, typename Sequence>
                struct pass_through_container_fusion_sequence<Container, ValueType, Attribute, Sequence, true>
                {
                    typedef typename mpl::
                        find_if<Attribute, not_compatible_element<Container, ValueType, mpl::_1, Sequence>>::type iter;
                    typedef typename mpl::end<Attribute>::type end;
                ...
                struct pass_through_container_base<
                    ...
                    pass_through_container_fusion_sequence<Container, ValueType, Attribute, Sequence>
                {
                };
                ...
                struct pass_through_container_container<
                    ...
                    Sequence,
                    AttributeValueType,
                    true> : pass_through_container_fusion_sequence<Container, ValueType, AttributeValueType, Sequence>
                {
                };
                ...
                // sequence, we use the already existing logic for those.
                template<typename Container, typename ValueType, typename Attribute, typename Sequence>
                struct pass_through_container_optional<Container, ValueType, Attribute, Sequence, true> :
                    pass_through_container_fusion_sequence<Container, ValueType, Attribute, Sequence>
                {
                };
                ...
                ///////////////////////////////////////////////////////////////////////////
                template<typename Container, typename ValueType, typename Attribute, typename Sequence>
                struct pass_through_container : pass_through_container_base<Container, ValueType, Attribute, Sequence>
                {
                };

                // Handle optional attributes
                template<typename Container, typename ValueType, typename Attribute, typename Sequence>
                struct pass_through_container<Container, ValueType, boost::optional<Attribute>, Sequence> :
                    pass_through_container_optional<Container, ValueType, Attribute, Sequence>
                {
                };
                ...
                struct pass_through_container<
                    ...
                    Sequence> : mpl::not_<traits::is_weak_substitute<Attribute, ValueType>>
                {
                };
                ...
                template<typename Container, typename ValueType, typename Sequence, typename T>
                struct pass_through_container<Container, ValueType, boost::variant<T>, Sequence> :
                    pass_through_container<Container, ValueType, T, Sequence>
                {
                };

                template<typename Container, typename ValueType, typename Sequence, typename T0, typename... TN>
                struct pass_through_container<Container, ValueType, boost::variant<T0, TN...>, Sequence> :
                    mpl::bool_<
                        pass_through_container<Container, ValueType, T0, Sequence>::type::value ||
                        pass_through_container<Container, ValueType, boost::variant<TN...>, Sequence>::type::value>
                {
                };
#else
    #define BOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _) \
        pass_through_container<Container, ValueType, BOOST_PP_CAT(T, N), Sequence>::type::value || /***/
                ...
                struct pass_through_container<Container, ValueType, boost::detail::variant::void_, Sequence> :
                    mpl::false_
                {
                };
                ...
                struct pass_through_container<
                    ...
                    Sequence> :
                    mpl::bool_<BOOST_PP_REPEAT(BOOST_VARIANT_LIMIT_TYPES, BOOST_SPIRIT_PASS_THROUGH_CONTAINER, _) false>
                {
                };
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename Container, typename ValueType, typename Attribute, typename Sequence>
            struct pass_through_container<Container, ValueType, Attribute, Sequence, qi::domain> :
                qi::detail::pass_through_container<Container, ValueType, Attribute, Sequence>
            {
            };
        }
    }
...
namespace boost {
    ...
    #pragma warning(disable: 4512) // assignment operator could not be generated.
                ...
                struct pass_container
                {
                    ...
                    bool dispatch_attribute(Component const& component, mpl::true_) const
                    {
                        ...
                        typedef
                            typename traits::attribute_of<Component, context_type, iterator_type>::type rhs_attribute;

                        // this predicate detects, whether the attribute of the current
                        // element is a substitute for the value type of the container
                        // attribute
                        typedef mpl::and_<
                            traits::handles_container<Component, Attr, context_type, iterator_type>,
                            traits::pass_through_container<Attr, value_type, rhs_attribute, Sequence, qi::domain>>
                            predicate;
                    ...
                    bool operator()(Component const& component) const
                    {
                        ...
                        typedef typename traits::not_is_unused<
                            typename traits::attribute_of<Component, context_type, iterator_type>::type>::type
                            predicate;
    ...
    #pragma warning(pop)
                ...
                inline pass_container<F, Attr, mpl::false_> make_pass_container(F const& f, Attr& attr)
                {
                ...
                template<typename F, typename Attr>
                inline pass_container<F, Attr, mpl::true_> make_sequence_pass_container(F const& f, Attr& attr)
                {
