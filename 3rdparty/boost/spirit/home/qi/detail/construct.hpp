...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            {
                static void call(Iterator const& first, Iterator const&, char& attr) { attr = *first; }
            };

            template<typename Iterator>
            struct assign_to_attribute_from_iterators<signed char, Iterator>
            {
                static void call(Iterator const& first, Iterator const&, signed char& attr) { attr = *first; }
            };

            template<typename Iterator>
            struct assign_to_attribute_from_iterators<unsigned char, Iterator>
            {
                static void call(Iterator const& first, Iterator const&, unsigned char& attr) { attr = *first; }
            };
            ...
            {
                static void call(Iterator const& first, Iterator const&, wchar_t& attr) { attr = *first; }
            };
            ...
            {
                static void call(Iterator const& first, Iterator const&, unsigned short& attr) { attr = *first; }
            };
    #endif
            ...
            {
                static void call(Iterator const& first, Iterator const& last, bool& attr)
                {
            ...
            {
                static void call(Iterator const& first, Iterator const& last, short& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, int& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, unsigned int& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, long& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, unsigned long& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, boost::long_long_type& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, boost::ulong_long_type& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, float& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, double& attr)
                {
                    Iterator first_ = first;
            ...
            {
                static void call(Iterator const& first, Iterator const& last, long double& attr)
                {
                    Iterator first_ = first;
