    ...
    namespace spirit {
        namespace qi {
            ...
            struct default_transform_attribute
            {
                ...
                static void post(Exposed& val, Transformed const& attr) { traits::assign_to(attr, val); }
            ...
            struct transform_attribute :
                mpl::if_<
                    ...
                    default_transform_attribute<Exposed, Transformed>>::type
            {
            };

            template<typename Exposed, typename Transformed>
            struct transform_attribute<
                boost::optional<Exposed>,
                Transformed,
