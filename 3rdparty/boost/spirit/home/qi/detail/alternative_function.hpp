        ...
        namespace qi {
            namespace detail {
                ...
                struct find_substitute
                {
                    ...
                    typedef typename mpl::eval_if<is_same<iter, end>, mpl::identity<T>, mpl::deref<iter>>::type type;
                };
    ...
    #pragma warning(disable: 4512) // assignment operator could not be generated.
                ...
                struct alternative_function
                {
                    ...
                    bool call_optional_or_variant(Component const& component, mpl::true_) const
                    {
                        ...
                        // use it instead.
                        typedef typename traits::attribute_of<Component, Context, Iterator>::type expected_type;

                        typename mpl::
                            if_<is_same<expected_type, unused_type>, unused_type, typename Attribute::value_type>::type
                                val;
                    ...
                    bool call_variant(Component const& component, mpl::false_) const
                    {
                        ...
                        typename find_substitute<
                            Attribute,
                            typename traits::attribute_of<Component, Context, Iterator>::type>::type val;
                    ...
                    bool call_optional_or_variant(Component const& component, mpl::false_) const
                    {
                        ...
                        typedef typename traits::attribute_of<Component, Context, Iterator>::type expected;
                        return call_variant(component, is_same<Attribute, expected>());
                    }
                    ...
                    bool operator()(Component const& component) const
                    {
                        ...
                        typedef typename traits::not_is_unused<
                            typename traits::attribute_of<Component, Context, Iterator>::type>::type predicate;
