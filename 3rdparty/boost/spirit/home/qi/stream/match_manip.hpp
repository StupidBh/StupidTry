...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            inline typename detail::match<Expr>::type match(Expr const& expr)
            {
                return detail::match<Expr>::call(expr);
            }

            template<typename Expr, typename Attribute>
            inline detail::match_manip<Expr, mpl::false_, mpl::false_, unused_type, Attribute>
                match(Expr const& xpr, Attribute& p)
            {
                ...
                return match_manip<Expr, mpl::false_, mpl::false_, unused_type, Attribute>(xpr, unused, p);
            }

            ///////////////////////////////////////////////////////////////////////////
            template<typename Expr, typename Skipper>
            inline typename detail::phrase_match<Expr, Skipper>::type phrase_match(
                Expr const& expr,
                Skipper const& s,
            ...
            inline detail::match_manip<Expr, mpl::false_, mpl::false_, Skipper, Attribute>
                phrase_match(Expr const& xpr, Skipper const& s, BOOST_SCOPED_ENUM(skip_flag) post_skip, Attribute& p)
            {
                ...
                return match_manip<Expr, mpl::false_, mpl::false_, Skipper, Attribute>(xpr, s, post_skip, p);
            }
                ...
                phrase_match(Expr const& xpr, Skipper const& s, Attribute& p)
            {
                ...
                BOOST_SPIRIT_ASSERT_MATCH(qi::domain, Expr);
                BOOST_SPIRIT_ASSERT_MATCH(qi::domain, Skipper);
                return match_manip<Expr, mpl::false_, mpl::false_, Skipper, Attribute>(xpr, s, p);
            }
