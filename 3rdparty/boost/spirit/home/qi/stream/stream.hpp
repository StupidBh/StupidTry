...
namespace boost {
    namespace spirit {
        ...
        #pragma warning(disable: 4512) // assignment operator could not be generated.
                ...
                struct psbuf : std::basic_streambuf<typename std::iterator_traits<Iterator>::value_type>
                {
                ...
                protected:
                    ...
                    {
                        return first == last ? psbuf::traits_type::eof() : psbuf::traits_type::to_int_type(*first);
                    }
        ...
        #pragma warning(pop)
            ...
            struct stream_parser : primitive_parser<stream_parser<Char, T>>
            {
            ...
            struct typed_stream : proto::terminal<stream_parser<Char, T>>::type
            {
            };
