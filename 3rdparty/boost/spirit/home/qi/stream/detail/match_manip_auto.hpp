    ...
    namespace spirit {
        namespace qi {
            namespace detail {
                ...
                struct match<Expr, typename enable_if<traits::meta_create_exists<qi::domain, Expr>>::type>
                {
                    typedef typename result_of::create_parser<Expr>::type expr_type;
                    typedef match_manip<expr_type, mpl::true_, mpl::false_, unused_type, Expr> type;
                ...
                {
                    typedef typename result_of::create_parser<Expr>::type expr_type;
                    typedef match_manip<expr_type, mpl::true_, mpl::false_, Skipper, Expr> type;
                    ...
                    static type call(Expr const& expr, Skipper const& skipper, BOOST_SCOPED_ENUM(skip_flag) post_skip)
                    {
                        ...
                        return type(create_parser<Expr>(), skipper, post_skip, const_cast<Expr&>(expr));
                    }
                };
