...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            {
                typedef make_unary_proto_expr<typename Container::value_type, proto::tag::dereference, qi::domain>
                    make_proto_expr;
            ...
            struct meta_create_sequence
            {
                ...
                typedef make_nary_proto_expr<sequence_type, proto::tag::shift_right, qi::domain> make_proto_expr;
            ...
            struct meta_create_impl<
                T,
                typename enable_if<mpl::and_<traits::is_container<T>, mpl::not_<traits::is_string<T>>>>::type> :
            ...
            {
                typedef make_unary_proto_expr<T, proto::tag::negate, qi::domain> make_proto_expr;
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename T>
            struct meta_create<qi::domain, T> : create_parser<typename spirit::detail::remove_const_ref<T>::type>
            {
            };
            ...
            struct meta_create_exists<qi::domain, T> :
                mpl::not_<is_same<qi::no_auto_mapping_exists, typename meta_create<qi::domain, T>::type>>
            {
            };
        }
    }
