...
namespace boost {
    namespace spirit {
        namespace result_of {
            template<typename T>
            struct create_parser : spirit::traits::meta_create<qi::domain, T>
            {
            };
        }
    }
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            template<typename T>
            typename result_of::create_parser<T>::type create_parser()
            {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ...
            template<typename T>
            struct create_parser_exists : meta_create_exists<qi::domain, T>
            {
            };
        }
    }
