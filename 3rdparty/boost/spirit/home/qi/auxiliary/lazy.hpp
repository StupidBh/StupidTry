    ...
    namespace spirit {
        namespace qi {
            ...
            struct lazy_parser : parser<lazy_parser<Function, Modifiers>>
            {
                ...
                struct attribute
                {
                    typedef typename boost::result_of<qi_modify(tag::lazy_eval, Modifiers)>::type modifier;

                    typedef
                        typename remove_reference<typename boost::result_of<Function(unused_type, Context)>::type>::type
                            expr_type;
                    ...
                    typedef typename result_of::compile<qi::domain, expr_type, modifier>::type parser_type;

                    typedef typename traits::attribute_of<parser_type, Context, Iterator>::type type;
                };
                    ...
                    Attribute& attr) const
                {
                    return detail::lazy_parse_impl_main(
                        compile<qi::domain>(function(unused, context), qi_modify()(tag::lazy_eval(), modifiers)),
                        first,
                        last,
                        context,
                        skipper,
            ...
            struct lazy_directive : unary_parser<lazy_directive<Function, Subject, Modifiers>>
            {
                ...
                struct attribute
                {
                    ...
                    typedef
                        typename proto::result_of::make_expr<proto::tag::subscript, directive_expr_type, Subject>::type
                            expr_type;
                ...
                lazy_directive(Function const& function_, Subject const& subject_, Modifiers const& modifiers_) :
                    function(function_),
                    subject(subject_),
                    modifiers(modifiers_)
                {
                    ...
                    Attribute& attr) const
                {
                    return detail::lazy_parse_impl_main(
                        compile<qi::domain>(
                            proto::make_expr<proto::tag::subscript>(function(unused, context), subject),
            ...
            struct make_primitive<phoenix::actor<Eval>, Modifiers>
            {
                ...
                result_type operator()(phoenix::actor<Eval> const& f, Modifiers const& modifiers) const
                {
            ...
            struct make_primitive<lazy_terminal<Terminal, Actor, Arity>, Modifiers>
            {
                ...
                result_type
                    operator()(lazy_terminal<Terminal, Actor, Arity> const& lt, Modifiers const& modifiers) const
                {
...
namespace boost {
    namespace spirit {
        namespace traits {
            ///////////////////////////////////////////////////////////////////////////
            template<typename Actor, typename Modifiers, typename Attribute, typename Context, typename Iterator>
            struct handles_container<qi::lazy_parser<Actor, Modifiers>, Attribute, Context, Iterator> :
                handles_container<
                    typename qi::lazy_parser<Actor, Modifiers>::template attribute<Context, Iterator>::parser_type,
                    Attribute,
                    Context,
                    Iterator>
            {
            ...
            struct handles_container<qi::lazy_directive<Actor, Subject, Modifiers>, Attribute, Context, Iterator> :
                handles_container<
                    typename qi::lazy_directive<Actor, Subject, Modifiers>::template attribute<Context, Iterator>::
                        parser_type,
                    Attribute,
                    Context,
                    Iterator>
