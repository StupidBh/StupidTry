...
namespace boost {
    namespace spirit {
        ...
        struct use_terminal<qi::domain, tag::stateful_tag<Expr, tag::attr_cast, Exposed, Transformed>> : mpl::true_
        {
        };
    }
}
...
namespace boost {
    namespace spirit {
        namespace qi {
            ...
            struct attr_cast_parser : unary_parser<attr_cast_parser<Exposed, Transformed, Subject>>
            {
                typedef typename result_of::compile<qi::domain, Subject>::type subject_type;

                typedef typename mpl::eval_if<
                    traits::not_is_unused<Transformed>,
                    mpl::identity<Transformed>,
                    traits::attribute_of<subject_type>>::type transformed_attribute_type;
                ...
                struct attribute : mpl::if_<traits::not_is_unused<Exposed>, Exposed, transformed_attribute_type>
                {
                };
                    ...
                    Attribute& attr_param) const
                {
                    ...
                    typedef typename mpl::if_<traits::not_is_unused<Exposed>, Exposed, Attribute>::type
                        exposed_attribute_type;

                    // do down-stream transformation, provides attribute for embedded
                    // parser
                    typedef traits::transform_attribute<exposed_attribute_type, transformed_attribute_type, domain>
                        transform;

                    typename transform::type attr_ = transform::pre(attr_param);

                    if (!compile<qi::domain>(subject).parse(first, last, context, skipper, attr_)) {
                ...
                {
                    return info("attr_cast", compile<qi::domain>(subject).what(context));
                }
            ...
            ///////////////////////////////////////////////////////////////////////////
            template<typename Expr, typename Exposed, typename Transformed, typename Modifiers>
            struct make_primitive<tag::stateful_tag<Expr, tag::attr_cast, Exposed, Transformed>, Modifiers>
            {
                ...
                {
                    typedef tag::stateful_tag<Expr, tag::attr_cast, Exposed, Transformed> tag_type;
