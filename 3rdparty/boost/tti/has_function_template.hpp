...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #include <boost/tti/detail/dfunction_template.hpp>
        ...
        */
        ...
        /// A macro which expands to a metafunction which tests whether an inner member function template or static
        /// member function template with a particular name exists.
        /**

            BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE is a macro which expands to a metafunction.
            The metafunction tests whether an inner member function template or static member function template with a
          particular name exists. The macro takes the form of BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE(trait,name,...)
          where
            ...
            BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE generates a metafunction called "trait" where 'trait' is the first
          macro parameter.
          ...
          @code
                    ...
                    The metafunction types and return:
                      ...
                      BOOST_TTI_TP_FS  = (optional) the parameters of the function template as a boost::mpl forward
          sequence if the function template parameters are not empty. These parameters are a single instantiation of the
          function template.
        ...
        */
        #define BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE(trait, name, ...)                                         \
            ...
            template<                                                                                           \
                ...
                class BOOST_TTI_TP_R,                                                                           \
                class BOOST_TTI_TP_FS = boost::mpl::vector<>,                                                   \
                class BOOST_TTI_TP_TAG = boost::function_types::null_tag>                                       \
            struct trait                                                                                        \
            {                                                                                                   \
                typedef typename BOOST_PP_CAT(                                                                  \
                    trait,                                                                                      \
                    _detail_hft)<BOOST_TTI_TP_T, BOOST_TTI_TP_R, BOOST_TTI_TP_FS, BOOST_TTI_TP_TAG>::type type; \
        ...
        /**
            ...
            The metafunction tests whether an inner member function template or static member function template with a
          particular name exists. The macro takes the form of BOOST_TTI_HAS_FUNCTION_TEMPLATE(name,...) where
            ...
            BOOST_TTI_HAS_FUNCTION_TEMPLATE generates a metafunction called "has_function_template_'name'" where 'name'
          is the first macro parameter.
        ...
        */
        #define BOOST_TTI_HAS_FUNCTION_TEMPLATE(name, ...)                                                      \
            BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE(BOOST_TTI_HAS_FUNCTION_TEMPLATE_GEN(name), name, __VA_ARGS__) \
            /**/
        ...
        */
        ...
        /**
            ...
            BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE is a macro which expands to a metafunction.
            The metafunction tests whether an inner member function template or static member function template with a
          particular name exists. The macro takes the form of BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE(trait,name,pparray)
          where
        ...
        */
        ...
        /**
            ...
            The metafunction tests whether an inner member function template or static member function template with a
          particular name exists. The macro takes the form of BOOST_TTI_HAS_FUNCTION_TEMPLATE(name,pparray) where
        ...
        */
        #define BOOST_TTI_HAS_FUNCTION_TEMPLATE(name, pparray)                                              \
            BOOST_TTI_TRAIT_HAS_FUNCTION_TEMPLATE(BOOST_TTI_HAS_FUNCTION_TEMPLATE_GEN(name), name, pparray) \
            /**/
