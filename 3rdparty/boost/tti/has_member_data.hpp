...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    #define BOOST_TTI_TRAIT_HAS_MEMBER_DATA(trait, name)                                                      \
        ...
        struct trait                                                                                          \
        {                                                                                                     \
            typedef typename BOOST_PP_CAT(trait, _detail_hmd)<BOOST_TTI_TP_ET, BOOST_TTI_TP_TYPE>::type type; \
            BOOST_STATIC_CONSTANT(bool, value = type::value);                                                 \
        };                                                                                                    \
    /**/

    /// A macro which expands to a metafunction which tests whether a member data with a particular name and type
    /// exists.
    /**
        ...
        BOOST_TTI_HAS_MEMBER_DATA generates a metafunction called "has_member_data_name" where 'name' is the macro
      parameter.
    ...
    */
    #define BOOST_TTI_HAS_MEMBER_DATA(name)                                        \
        BOOST_TTI_TRAIT_HAS_MEMBER_DATA(BOOST_TTI_HAS_MEMBER_DATA_GEN(name), name) \
        /**/
