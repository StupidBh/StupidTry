...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    ...
    /// A macro which expands to a metafunction which tests whether a static member function with a particular name and
    /// signature exists.
    /**
        ...
        BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION generates a metafunction called "trait" where 'trait' is the macro
      parameter.
      ...
      @code
                  ...
                  The metafunction types and return:
                    ...
                    BOOST_TTI_TP_FS  = (optional) the parameters of the static member function as a boost::mpl forward
      sequence if the second parameter is a return type and the function parameters exist.
    ...
    */
    #define BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION(trait, name)                                          \
        ...
        {                                                                                                    \
            typedef typename BOOST_PP_CAT(                                                                   \
                trait,                                                                                       \
                _detail_hsmf)<BOOST_TTI_TP_T, BOOST_TTI_TP_R, BOOST_TTI_TP_FS, BOOST_TTI_TP_TAG>::type type; \
    ...
    /**
        ...
        BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION generates a metafunction called "has_static_member_function_name" where
      'name' is the macro parameter.
    ...
    */
    #define BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION(name)                                                   \
        BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION(BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION_GEN(name), name) \
        /**/
