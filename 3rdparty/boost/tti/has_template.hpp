 ...
 */
    ...
    #include <boost/preprocessor/control/iif.hpp>
        ...
        /// A macro which expands to a metafunction which tests whether an inner class template with a particular name
        /// exists.
        /**
            ...
            BOOST_TTI_TRAIT_HAS_TEMPLATE generates a metafunction called "trait" where 'trait' is the first macro
          parameter.
          ...
          @code
            ...
            2) Search for an inner class template called 'MyTemplate', with template parameters
               ...
               BOOST_TTI_TRAIT_HAS_TEMPLATE(MyMeta,MyTemplate,(3,(class,int,template<class> class))) // Non-variadic
          macro form
        ...
        */
        ...
        /**
            ...
            BOOST_TTI_HAS_TEMPLATE generates a metafunction called "has_template_'name'" where 'name' is the first
          variadic parameter.
        ...
        */
        #define BOOST_TTI_HAS_TEMPLATE(...)                                         \
            BOOST_TTI_TRAIT_HAS_TEMPLATE(                                           \
                BOOST_TTI_HAS_TEMPLATE_GEN(BOOST_PP_VARIADIC_ELEM(0, __VA_ARGS__)), \
                __VA_ARGS__)                                                        \
            /**/
        ...
        */
        ...
        /**
            ...
            BOOST_TTI_HAS_TEMPLATE generates a metafunction called "has_template_'name'" where 'name' is the first macro
          parameter.
        ...
        */
        #define BOOST_TTI_HAS_TEMPLATE(name, params)                                     \
            BOOST_TTI_TRAIT_HAS_TEMPLATE(BOOST_TTI_HAS_TEMPLATE_GEN(name), name, params) \
            /**/
