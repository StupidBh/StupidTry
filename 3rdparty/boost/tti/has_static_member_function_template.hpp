...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #include <boost/tti/detail/dstatic_mem_fun_template.hpp>
        ...
        */
        ...
        /// A macro which expands to a metafunction which tests whether an inner static member function template with a
        ...
        /**
            ...
            BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION_TEMPLATE generates a metafunction called "trait" where 'trait' is
          the first macro parameter.
          ...
          @code
                    ...
                    The metafunction types and return:
                      ...
                      BOOST_TTI_TP_FS  = (optional) the parameters of the static member function template as a
          boost::mpl forward sequence if the second parameter is the enclosing type and the static member function
          template parameters are not empty. These parameters are a single instantiation of the static member function
          template.

                      BOOST_TTI_TP_TAG = (optional) a boost::function_types tag to apply to the static member function
          template if the second parameter is the enclosing type and a tag is needed.
        ...
        */
        #define BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION_TEMPLATE(trait, name, ...)                             \
            ...
            {                                                                                                     \
                typedef typename BOOST_PP_CAT(                                                                    \
                    trait,                                                                                        \
                    _detail_hsmft)<BOOST_TTI_TP_T, BOOST_TTI_TP_R, BOOST_TTI_TP_FS, BOOST_TTI_TP_TAG>::type type; \
        ...
        /**
            ...
            BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION_TEMPLATE generates a metafunction called
          "has_static_member_function_template_'name'" where 'name' is the first macro parameter.
