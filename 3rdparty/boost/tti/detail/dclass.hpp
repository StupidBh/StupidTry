    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_CLASS_OP_CHOOSE(trait, name)                                            \
        ...
        template<class BOOST_TTI_DETAIL_TP_T, class BOOST_TTI_DETAIL_TP_U, class BOOST_TTI_DETAIL_TP_B>        \
            ...
            boost::mpl::and_<                                                                                  \
                ...
                BOOST_PP_CAT(trait, _detail_class_invoke) < BOOST_TTI_DETAIL_TP_T,                             \
        ...
        struct BOOST_PP_CAT(                                                                                   \
            trait,                                                                                             \
            _detail_class_op_choose)<BOOST_TTI_DETAIL_TP_T, BOOST_TTI_DETAIL_TP_U, boost::mpl::false_::type> : \
            boost::mpl::false_                                                                                 \
        {                                                                                                      \
        };                                                                                                     \
                                                                                                               \
        ...
        struct BOOST_PP_CAT(trait, _detail_class_op_choose)<                                                   \
            ...
            boost::mpl::true_::type> : boost::is_class<typename BOOST_TTI_DETAIL_TP_T::name>                   \
        {                                                                                                      \
        };                                                                                                     \
        /**/
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_CLASS(trait, name)                           \
        ...
        struct BOOST_PP_CAT(trait, _detail_class) :                                 \
            boost::mpl::eval_if<                                                    \
                ...
                BOOST_PP_CAT(trait, _detail_class_op) < BOOST_TTI_DETAIL_TP_T,      \
                BOOST_TTI_DETAIL_TP_U>,                                             \
            boost::mpl::false_ >                                                    \
        {                                                                           \
        };                                                                          \
