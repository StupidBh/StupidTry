    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_TYPE_OP_CHOOSE(trait, name)                                            \
        ...
        {                                                                                                     \
            ...
            typedef typename BOOST_PP_CAT(                                                                    \
                trait,                                                                                        \
                _detail_type_invoke)<BOOST_TTI_DETAIL_TP_T, BOOST_TTI_DETAIL_TP_U>::type type;                \
        };                                                                                                    \
                                                                                                              \
        template<class BOOST_TTI_DETAIL_TP_T, class BOOST_TTI_DETAIL_TP_U>                                    \
        struct BOOST_PP_CAT(                                                                                  \
            trait,                                                                                            \
            _detail_type_op_choose)<BOOST_TTI_DETAIL_TP_T, BOOST_TTI_DETAIL_TP_U, boost::mpl::false_::type> : \
            boost::mpl::false_                                                                                \
        {                                                                                                     \
        };                                                                                                    \
                                                                                                              \
        ...
        struct BOOST_PP_CAT(trait, _detail_type_op_choose)<                                                   \
            ...
            boost::mpl::true_::type> : boost::mpl::true_                                                      \
        {                                                                                                     \
        };                                                                                                    \
        /**/
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_TYPE(trait, name)                            \
        ...
        struct BOOST_PP_CAT(trait, _detail_type) :                                  \
            boost::mpl::eval_if<                                                    \
                ...
                BOOST_PP_CAT(trait, _detail_type_op) < BOOST_TTI_DETAIL_TP_T,       \
                BOOST_TTI_DETAIL_TP_U>,                                             \
            boost::mpl::false_ >                                                    \
        {                                                                           \
        };                                                                          \
