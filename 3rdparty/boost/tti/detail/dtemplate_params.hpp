    ...
    #include <boost/tti/gen/namespace_gen.hpp>
        ...
        #define BOOST_TTI_DETAIL_HAS_MEMBER_IMPLEMENTATION(args, introspect_macro)                                     \
            template<                                                                                                  \
                ...
                typename BOOST_TTI_DETAIL_TP_FALLBACK_ = boost::mpl::bool_<BOOST_PP_ARRAY_ELEM(3, args)>>              \
            struct BOOST_PP_ARRAY_ELEM(0, args)                                                                        \
            {                                                                                                          \
            private:                                                                                                   \
            introspect_macro(args) public :                                                                            \
                static const bool value = BOOST_MPL_HAS_MEMBER_INTROSPECTION_NAME(args)<BOOST_TTI_DETAIL_TP_T>::value; \
                typedef typename BOOST_MPL_HAS_MEMBER_INTROSPECTION_NAME(args)<BOOST_TTI_DETAIL_TP_T>::type type;      \
            };                                                                                                         \
            /**/
            ...
            #define BOOST_TTI_DETAIL_HAS_MEMBER_MULTI_SUBSTITUTE(z, n, args)       \
                template<template<BOOST_PP_ENUM_##z(                               \
                    BOOST_PP_SUB(BOOST_PP_ARRAY_SIZE(args), 4),                    \
                    BOOST_TTI_DETAIL_TEMPLATE_PARAMETERS,                          \
                    args)> class BOOST_TTI_DETAIL_TM_V>                            \
            ...
            #define BOOST_TTI_DETAIL_HAS_MEMBER_SUBSTITUTE(args)                                                  \
                BOOST_PP_REPEAT(BOOST_PP_ARRAY_ELEM(2, args), BOOST_TTI_DETAIL_HAS_MEMBER_MULTI_SUBSTITUTE, args) \
                /**/
            ...
            #define BOOST_TTI_DETAIL_HAS_MEMBER_INTROSPECT(args)                          \
                ...
                {                                                                         \
                    ...
                    BOOST_STATIC_CONSTANT(bool, value = BOOST_MPL_HAS_MEMBER_TEST(args)); \
                    typedef boost::mpl::bool_<value> type;                                \
                };                                                                        \
                /**/

            #define BOOST_TTI_DETAIL_HAS_MEMBER_WITH_FUNCTION_SFINAE(args)                               \
                BOOST_TTI_DETAIL_HAS_MEMBER_IMPLEMENTATION(args, BOOST_TTI_DETAIL_HAS_MEMBER_INTROSPECT) \
                /**/
            ...
            #define BOOST_TTI_DETAIL_HAS_MEMBER_MULTI_SUBSTITUTE_WITH_TEMPLATE_SFINAE(z, n, args)       \
                template<template<BOOST_PP_ENUM_##z(                                                    \
                    BOOST_PP_SUB(BOOST_PP_ARRAY_SIZE(args), 4),                                         \
                    BOOST_TTI_DETAIL_TEMPLATE_PARAMETERS,                                               \
                    args)> class BOOST_TTI_DETAIL_TM_U>                                                 \
                struct BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_NAME_WITH_TEMPLATE_SFINAE(args, n) \
                {                                                                                       \
                    typedef BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(args) type;          \
                };                                                                                      \
                /**/

            #define BOOST_TTI_DETAIL_HAS_MEMBER_SUBSTITUTE_WITH_TEMPLATE_SFINAE(args)      \
                typedef void BOOST_MPL_HAS_MEMBER_INTROSPECTION_SUBSTITUTE_TAG_NAME(args); \
                BOOST_PP_REPEAT(                                                           \
            ...
            #define BOOST_TTI_DETAIL_HAS_MEMBER_WITH_TEMPLATE_SFINAE(args)        \
                BOOST_TTI_DETAIL_HAS_MEMBER_SUBSTITUTE_WITH_TEMPLATE_SFINAE(args) \
        ...
        /**/
            ...
            #define BOOST_TTI_DETAIL_TRAIT_CALL_HAS_TEMPLATE_CHECK_PARAMS(trait, name, tpArray) \
                BOOST_TTI_DETAIL_HAS_MEMBER_WITH_FUNCTION_SFINAE(                               \
                    (BOOST_PP_ADD(BOOST_PP_ARRAY_SIZE(tpArray), 4),                             \
                     (trait, name, 1, false, BOOST_PP_ARRAY_ENUM(tpArray))))                    \
                /**/
