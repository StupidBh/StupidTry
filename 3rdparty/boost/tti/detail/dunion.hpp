...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_TTI_DETAIL_TRAIT_INVOKE_HAS_UNION(trait, name)                                                      \
        ...
        {                                                                                                             \
            ...
            typedef                                                                                                   \
                typename boost::mpl::apply<BOOST_TTI_DETAIL_TP_MFC, typename BOOST_TTI_DETAIL_TP_T::name>::type type; \
        };                                                                                                            \
        /**/
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_UNION_OP_CHOOSE(trait, name)                                            \
        ...
        template<class BOOST_TTI_DETAIL_TP_T, class BOOST_TTI_DETAIL_TP_U, class BOOST_TTI_DETAIL_TP_B>        \
            ...
            boost::mpl::and_<                                                                                  \
                ...
                BOOST_PP_CAT(trait, _detail_union_invoke) < BOOST_TTI_DETAIL_TP_T,                             \
        ...
        struct BOOST_PP_CAT(                                                                                   \
            trait,                                                                                             \
            _detail_union_op_choose)<BOOST_TTI_DETAIL_TP_T, BOOST_TTI_DETAIL_TP_U, boost::mpl::false_::type> : \
            boost::mpl::false_                                                                                 \
        {                                                                                                      \
        };                                                                                                     \
                                                                                                               \
        ...
        struct BOOST_PP_CAT(trait, _detail_union_op_choose)<                                                   \
            ...
            BOOST_TTI_NAMESPACE::detail::deftype,                                                              \
            boost::mpl::true_::type> : boost::is_union<typename BOOST_TTI_DETAIL_TP_T::name>                   \
        {                                                                                                      \
        };                                                                                                     \
        /**/
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_UNION(trait, name)                           \
        ...
        struct BOOST_PP_CAT(trait, _detail_union) :                                 \
            boost::mpl::eval_if<                                                    \
                ...
                BOOST_PP_CAT(trait, _detail_union_op) < BOOST_TTI_DETAIL_TP_T,      \
                BOOST_TTI_DETAIL_TP_U>,                                             \
            boost::mpl::false_ >                                                    \
        {                                                                           \
        };                                                                          \
