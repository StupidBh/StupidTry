            ...
            {                                                                                                     \
                ...
                {                                                                                                 \
                    typedef boost::mpl::bool_<                                                                    \
                        sizeof(has_matching_member<BOOST_TTI_DETAIL_TP_V, BOOST_TTI_DETAIL_TP_U>(0)) ==           \
                        sizeof(::boost::type_traits::yes_type)>                                                   \
                        type;                                                                                     \
                };                                                                                                \
                                                                                                                  \
        ...
        #define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_MEMBER_DATA_OP(trait, name)                      \
            ...
            {                                                                                      \
                ...
                static ::boost::type_traits::no_type chkt(...);                                    \
                                                                                                   \
                typedef boost::mpl::bool_<                                                         \
                    (!boost::function_types::is_function<BOOST_TTI_DETAIL_TP_TYPE>::value) &&      \
        ...
        #define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_MEMBER_DATA(trait, name)        \
            ...
            struct BOOST_PP_CAT(trait, _detail_hsd) :                             \
                boost::mpl::eval_if<                                              \
                    ...
                    BOOST_PP_CAT(trait, _detail_hsd_op) < BOOST_TTI_DETAIL_TP_T,  \
