...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_COMP_MEMBER_FUNCTION_TEMPLATE(trait, name, tparray)                         \
        ...
        {                                                                                                          \
            ...
            struct cl_type :                                                                                       \
                boost::remove_const<typename BOOST_TTI_NAMESPACE::detail::class_type<BOOST_TTI_DETAIL_TP_F>::type> \
            {                                                                                                      \
            };                                                                                                     \
                                                                                                                   \
            ...
            static ::boost::type_traits::yes_type                                                                  \
                check(helper<&BOOST_TTI_DETAIL_TP_U::template name<BOOST_PP_ARRAY_ENUM(tparray)>>*);               \
                                                                                                                   \
            template<class BOOST_TTI_DETAIL_TP_U>                                                                  \
            static ::boost::type_traits::no_type check(...);                                                       \
                                                                                                                   \
            typedef boost::mpl::bool_<                                                                             \
                sizeof(check<typename cl_type<BOOST_TTI_DETAIL_TP_T>::type>(BOOST_TTI_DETAIL_NULLPTR)) ==          \
