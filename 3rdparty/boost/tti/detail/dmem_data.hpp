...
//  http://www.boost.org/LICENSE_1_0.txt).
        ...
        #define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA_OP(trait, name)                                            \
            ...
            {                                                                                                     \
                ...
                static ::boost::type_traits::no_type check2(BOOST_TTI_DETAIL_TP_U);                               \
                                                                                                                  \
                template<typename BOOST_TTI_DETAIL_TP_U, typename BOOST_TTI_DETAIL_TP_V>                          \
                static typename menable_if<                                                                       \
                    sizeof(check2<BOOST_TTI_DETAIL_TP_U, BOOST_TTI_DETAIL_TP_V>(&BOOST_TTI_DETAIL_TP_U::name)) == \
                        sizeof(::boost::type_traits::yes_type),                                                   \
                    ::boost::type_traits::yes_type>::type                                                         \
                ...
                {                                                                                                 \
                    typedef boost::mpl::bool_<                                                                    \
                        sizeof(has_matching_member<                                                               \
                               BOOST_TTI_DETAIL_TP_V,                                                             \
                               typename return_of<BOOST_TTI_DETAIL_TP_U>::type>(0)) ==                            \
                        sizeof(::boost::type_traits::yes_type)>                                                   \
                        type;                                                                                     \
                };                                                                                                \
                                                                                                                  \
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA_INVOKE_PT_MEMBER(trait)                             \
        ...
        struct BOOST_PP_CAT(trait, _detail_hmd_invoke_pt_member) :                                     \
            BOOST_PP_CAT(trait, _detail_hmd_op)<                                                       \
                typename BOOST_TTI_NAMESPACE::detail::                                                 \
                    dmem_get_type<BOOST_TTI_DETAIL_TP_ET, BOOST_TTI_DETAIL_TP_TYPE>::type,             \
                typename boost::remove_const<typename BOOST_TTI_NAMESPACE::detail::dmem_get_enclosing< \
                    BOOST_TTI_DETAIL_TP_ET,                                                            \
                    BOOST_TTI_DETAIL_TP_TYPE>::type>::type>                                            \
        {                                                                                              \
        };                                                                                             \
        /**/
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA_WITH_ENCLOSING_CLASS(trait)                    \
        ...
        struct BOOST_PP_CAT(trait, _detail_hmd_with_enclosing_class) :                            \
            boost::mpl::eval_if<                                                                  \
                ...
                BOOST_PP_CAT(trait, _detail_hmd_invoke_enclosing_class) < BOOST_TTI_DETAIL_TP_ET, \
    ...
    #define BOOST_TTI_DETAIL_TRAIT_HAS_MEMBER_DATA(trait, name)                                                       \
        ...
        struct BOOST_PP_CAT(trait, _detail_hmd) :                                                                     \
            boost::mpl::eval_if<                                                                                      \
                ...
                BOOST_PP_CAT(trait, _detail_hmd_invoke_pt_member) < BOOST_TTI_DETAIL_TP_ET,                           \
                BOOST_TTI_DETAIL_TP_TYPE>,                                                                            \
            BOOST_PP_CAT(trait, _detail_hmd_with_enclosing_class)<BOOST_TTI_DETAIL_TP_ET, BOOST_TTI_DETAIL_TP_TYPE> > \
        {                                                                                                             \
        };
...
namespace boost {
    namespace tti {
        namespace detail {
            ...
            struct dmem_check_ptmd : boost::mpl::identity<BOOST_TTI_DETAIL_TP_T>
            {
                BOOST_MPL_ASSERT((boost::function_types::is_member_object_pointer<BOOST_TTI_DETAIL_TP_T>));
            };

            template<class BOOST_TTI_DETAIL_TP_T>
            struct dmem_check_ptec : BOOST_TTI_NAMESPACE::detail::class_type<BOOST_TTI_DETAIL_TP_T>
            {
                BOOST_MPL_ASSERT((boost::function_types::is_member_object_pointer<BOOST_TTI_DETAIL_TP_T>));
            };
