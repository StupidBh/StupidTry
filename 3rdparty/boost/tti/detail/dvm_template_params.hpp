...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #include <boost/preprocessor/config/config.hpp>
        ...
        #define BOOST_TTI_DETAIL_VM_TRAIT_CHOOSE_FROM_TWO(trait, ...)       \
            BOOST_PP_IIF(                                                   \
                BOOST_PP_IS_BINARY(BOOST_PP_VARIADIC_ELEM(1, __VA_ARGS__)), \
                BOOST_TTI_DETAIL_TRAIT_HAS_TEMPLATE_CHECK_PARAMS,           \
                BOOST_TTI_DETAIL_VM_TRAIT_CHOOSE_IF_NIL)                    \
            (trait, BOOST_PP_VARIADIC_ELEM(0, __VA_ARGS__), BOOST_PP_VARIADIC_ELEM(1, __VA_ARGS__)) /**/

        #define BOOST_TTI_DETAIL_VM_IS_NIL(param)                               \
            BOOST_PP_IS_EMPTY(BOOST_PP_CAT(BOOST_TTI_DETAIL_IS_HELPER_, param)) \
            /**/
        ...
        #define BOOST_TTI_DETAIL_VM_TRAIT_HAS_TEMPLATE(trait, ...)                                           \
            BOOST_TTI_DETAIL_TRAIT_HAS_TEMPLATE(trait, BOOST_PP_VARIADIC_ELEM(0, __VA_ARGS__), BOOST_PP_NIL) \
            /**/
