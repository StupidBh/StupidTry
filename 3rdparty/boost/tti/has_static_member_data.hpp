...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    ...
    /// A macro which expands to a metafunction which tests whether a static member data with a particular name and type
    /// exists.
    /**
        ...
        BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_DATA generates a metafunction called "trait" where 'trait' is the macro
      parameter.
    ...
    */
    #define BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_DATA(trait, name)                                              \
        ...
        struct trait                                                                                         \
        {                                                                                                    \
            typedef typename BOOST_PP_CAT(trait, _detail_hsd)<BOOST_TTI_TP_T, BOOST_TTI_TP_TYPE>::type type; \
    ...
    /**
        ...
        BOOST_TTI_HAS_STATIC_MEMBER_DATA generates a metafunction called "has_static_member_data_name" where 'name' is
      the macro parameter.
    ...
    */
    #define BOOST_TTI_HAS_STATIC_MEMBER_DATA(name)                                               \
        BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_DATA(BOOST_TTI_HAS_STATIC_MEMBER_DATA_GEN(name), name) \
        /**/
