...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    ...
    /// A macro which expands to a metafunction which tests whether member data or static member data with a particular
    ...
    #define BOOST_TTI_TRAIT_HAS_DATA(trait, name)                                                              \
        ...
        {                                                                                                      \
            typedef typename BOOST_PP_CAT(                                                                     \
                trait,                                                                                         \
                _detail_hd)<typename boost::remove_const<BOOST_TTI_TP_T>::type, BOOST_TTI_TP_TYPE>::type type; \
    ...
    */
    #define BOOST_TTI_HAS_DATA(name)                                 \
        BOOST_TTI_TRAIT_HAS_DATA(BOOST_TTI_HAS_DATA_GEN(name), name) \
        /**/
