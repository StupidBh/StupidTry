...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    #include <boost/tti/gen/namespace_gen.hpp>
        ...
        */
        ...
        /// A macro which expands to a metafunction which tests whether an inner member function template with a
        ...
        /**
            ...
            BOOST_TTI_TRAIT_HAS_MEMBER_FUNCTION_TEMPLATE generates a metafunction called "trait" where 'trait' is the
          first macro parameter.
          ...
          @code
                    ...
                    The metafunction types and return:
                      ...
                      BOOST_TTI_TP_FS  = (optional) the parameters of the member function template as a boost::mpl
          forward sequence if the first parameter is the enclosing type and the member function template parameters are
          not empty. These parameters are a single instantiation of the member function template.
        ...
        */
        #define BOOST_TTI_TRAIT_HAS_MEMBER_FUNCTION_TEMPLATE(trait, name, ...)                                   \
            ...
            template<                                                                                            \
                ...
                class BOOST_TTI_TP_R = BOOST_TTI_NAMESPACE::detail::deftype,                                     \
            ...
            {                                                                                                    \
                typedef typename BOOST_PP_CAT(                                                                   \
                    trait,                                                                                       \
                    _detail_hmft)<BOOST_TTI_TP_T, BOOST_TTI_TP_R, BOOST_TTI_TP_FS, BOOST_TTI_TP_TAG>::type type; \
        ...
        /**
            ...
            BOOST_TTI_HAS_MEMBER_FUNCTION_TEMPLATE generates a metafunction called "has_member_function_template_'name'"
          where 'name' is the first macro parameter.
