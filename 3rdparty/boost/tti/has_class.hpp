...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    #define BOOST_TTI_TRAIT_HAS_CLASS(trait, name)                                                          \
        ...
        template<class BOOST_TTI_TP_T, class BOOST_TTI_TP_U = BOOST_TTI_NAMESPACE::detail::deftype>         \
        struct trait                                                                                        \
        {                                                                                                   \
            typedef typename BOOST_PP_CAT(trait, _detail_class)<BOOST_TTI_TP_T, BOOST_TTI_TP_U>::type type; \
    ...
    /**
      ...
      has_class_MyType<EnclosingType>::value is true if MyType is an inner class/struct of EnclosingType, otherwise
      false.

      has_class_MyType<EnclosingType,ALambdaExpression>::value is true if MyType is an inner class/struct of
      EnclosingType and invoking ALambdaExpression with the inner class/struct returns a value of true, otherwise false.
    ...
    */
    #define BOOST_TTI_HAS_CLASS(name)                                  \
        BOOST_TTI_TRAIT_HAS_CLASS(BOOST_TTI_HAS_CLASS_GEN(name), name) \
        /**/
