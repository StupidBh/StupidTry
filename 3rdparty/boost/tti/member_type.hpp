...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    #define BOOST_TTI_TRAIT_MEMBER_TYPE(trait, name)                                                         \
        ...
        struct trait :                                                                                       \
            boost::mpl::eval_if<BOOST_PP_CAT(trait, _detail_has_type_member_type) < BOOST_TTI_TP_T>,         \
    ...
    */
    #define BOOST_TTI_MEMBER_TYPE(name) BOOST_TTI_TRAIT_MEMBER_TYPE(BOOST_TTI_MEMBER_TYPE_GEN(name), name)
...
namespace boost {
    namespace tti {
        ...
        /// A metafunction which checks whether the member 'type' returned from invoking the macro metafunction
        /// generated by BOOST_TTI_MEMBER_TYPE ( BOOST_TTI_TRAIT_MEMBER_TYPE ) is a valid type.
        /**
      ...
      @code
            ...
            The metafunction types and return:
              ...
              BOOST_TTI_TP_T           = returned inner 'type' from invoking the macro metafunction generated by
      BOOST_TTI_MEMBER_TYPE ( BOOST_TTI_TRAIT_MEMBER_TYPE ).
      ...
      @endcode
        ...
        */
        template<class BOOST_TTI_TP_T, class BOOST_TTI_TP_MARKER_TYPE = BOOST_TTI_NAMESPACE::detail::notype>
        struct valid_member_type : boost::mpl::not_<boost::is_same<BOOST_TTI_TP_T, BOOST_TTI_TP_MARKER_TYPE>>
        {
        };

        /// A metafunction which checks whether the invoked macro metafunction generated by BOOST_TTI_MEMBER_TYPE (
        /// BOOST_TTI_TRAIT_MEMBER_TYPE ) hold a valid type.
        /**
      ...
      @code
            ...
            The metafunction types and return:
              ...
              BOOST_TTI_METAFUNCTION = The invoked macro metafunction generated by BOOST_TTI_MEMBER_TYPE (
      BOOST_TTI_TRAIT_MEMBER_TYPE ).

              returns          = 'value' is true if the nested type of the invoked metafunction is valid, otherwise
      'value' is false. A valid type means that the invoked metafunction's inner 'type' is not the marker type.
        ...
        */
        ...
        struct valid_member_metafunction :
            boost::mpl::not_<boost::is_same<
                typename BOOST_TTI_METAFUNCTION::type,
                typename BOOST_TTI_METAFUNCTION::boost_tti_marker_type>>
        {
        };
    }
}
