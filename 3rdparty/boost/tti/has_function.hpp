...
//  http://www.boost.org/LICENSE_1_0.txt).
    ...
    */
    ...
    /// A macro which expands to a metafunction which tests whether a member function or a static member function with a
    /// particular name and signature exists.
    /**
    ...
    #define BOOST_TTI_TRAIT_HAS_FUNCTION(trait, name)                                                      \
        ...
        {                                                                                                  \
            typedef typename BOOST_PP_CAT(                                                                 \
                trait,                                                                                     \
                _detail_hf)<BOOST_TTI_TP_T, BOOST_TTI_TP_R, BOOST_TTI_TP_FS, BOOST_TTI_TP_TAG>::type type; \
    ...
    */
    #define BOOST_TTI_HAS_FUNCTION(name)                                     \
        BOOST_TTI_TRAIT_HAS_FUNCTION(BOOST_TTI_HAS_FUNCTION_GEN(name), name) \
        /**/
