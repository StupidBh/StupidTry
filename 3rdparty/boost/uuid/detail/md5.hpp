    ...
    namespace uuids {
        namespace detail {
            ...
            public:
                ...
                void process_byte(unsigned char byte) { MD5_Update(&ctx_, &byte, 1); }
                ...
                void get_digest(digest_type& digest) { MD5_Final(digest, &ctx_); }
    ...
    #define BOOST_UUID_DETAIL_MD5_GET(n) (ctx->block[(n)])
                ...
                const void* body(MD5_CTX* ctx, const void* data, unsigned long size)
                {
                    ...
                    do {
                        ...
                        /* Round 1 */
                        BOOST_UUID_DETAIL_MD5_STEP(
                            BOOST_UUID_DETAIL_MD5_F,
                            a,
                            b,
                            c,
                            d,
                            BOOST_UUID_DETAIL_MD5_SET(0),
                            0xd76aa478,
                            7)
                        BOOST_UUID_DETAIL_MD5_STEP(
                            BOOST_UUID_DETAIL_MD5_F,
                        ...
                        BOOST_UUID_DETAIL_MD5_STEP(
                            ...
                            d,
                            a,
                            BOOST_UUID_DETAIL_MD5_SET(15),
                            0x49b40821,
                            22)

                        /* Round 2 */
                        BOOST_UUID_DETAIL_MD5_STEP(
                            BOOST_UUID_DETAIL_MD5_G,
                            a,
                            b,
                            c,
                            d,
                            BOOST_UUID_DETAIL_MD5_GET(1),
                            0xf61e2562,
                            5)
                        BOOST_UUID_DETAIL_MD5_STEP(
                            BOOST_UUID_DETAIL_MD5_G,
                        ...
                        BOOST_UUID_DETAIL_MD5_STEP(
                            ...
                            d,
                            a,
                            BOOST_UUID_DETAIL_MD5_GET(12),
                            0x8d2a4c8a,
                            20)

                        /* Round 3 */
                        BOOST_UUID_DETAIL_MD5_STEP(
                            BOOST_UUID_DETAIL_MD5_H,
                            a,
                            b,
                            c,
                            d,
