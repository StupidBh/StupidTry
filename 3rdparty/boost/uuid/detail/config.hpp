...
#include <boost/config.hpp>
    ...
    #pragma once
        ...
        #if ((defined(__AVX512F__) && defined(__AVX512VL__) && defined(__AVX512BW__)) || defined(__AVX10_1__)) && \
        ...
        #if (defined(_M_X64) || (defined(_M_IX86) && defined(_M_IX86_FP) && _M_IX86_FP >= 2)) && \
    ...
    #if !defined(BOOST_UUID_NO_SIMD) && !defined(BOOST_UUID_USE_AVX10_1) && !defined(BOOST_UUID_USE_AVX) && \
        !defined(BOOST_UUID_USE_SSE41) && !defined(BOOST_UUID_USE_SSE3) && !defined(BOOST_UUID_USE_SSE2)
