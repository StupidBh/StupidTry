...
namespace boost {
    namespace uuids {
        ...
        public:
            ...
            using period = std::ratio<1, 10'000'000>; // 100ns
            ...
            static time_point from_sys(std::chrono::time_point<std::chrono::system_clock, Duration> const& tp) noexcept;
        ...
        template<class Duration>
        inline uuid_clock::time_point
            uuid_clock::from_sys(std::chrono::time_point<std::chrono::system_clock, Duration> const& tp) noexcept
        {
        ...
        inline std::chrono::time_point<std::chrono::system_clock, uuid_clock::duration>
            uuid_clock::to_sys(time_point const& tp) noexcept
        {
            using days = std::chrono::duration<std::int32_t, std::ratio<86400>>;
            constexpr auto epoch_diff = days(141427);
