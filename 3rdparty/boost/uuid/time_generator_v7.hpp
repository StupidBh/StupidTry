...
namespace boost {
    namespace uuids {
        ...
        inline time_generator_v7::time_generator_v7(time_generator_v7 const& rhs) :
            state_(rhs.state_)
        {
            detail::random_provider seeder;
            rng_.seed(seeder);
        ...
        inline time_generator_v7::time_generator_v7(time_generator_v7&& rhs) noexcept :
