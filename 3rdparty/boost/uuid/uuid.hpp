...
namespace boost {
    namespace uuids {
        ...
        public:
            ...
            uuid(repr_type const& r) noexcept { std::memcpy(data, r, 16); }
            ...
            timestamp_type timestamp_v1() const noexcept
            {
                ...
                return time_low | static_cast<std::uint64_t>(time_mid) << 32 |
            ...
            timestamp_type timestamp_v6() const noexcept
            {
                ...
                return time_low | static_cast<std::uint64_t>(time_mid) << 12 |
                       static_cast<std::uint64_t>(time_high) << 28;
            }
            ...
            uuid_clock::time_point time_point_v1() const noexcept { return uuid_clock::from_timestamp(timestamp_v1()); }

            uuid_clock::time_point time_point_v6() const noexcept { return uuid_clock::from_timestamp(timestamp_v6()); }
            ...
            std::chrono::time_point<std::chrono::system_clock, std::chrono::milliseconds> time_point_v7() const noexcept
            {
                return std::chrono::time_point<std::chrono::system_clock, std::chrono::milliseconds>(
                    std::chrono::milliseconds(timestamp_v7()));
            }
            ...
            clock_seq_type clock_seq() const noexcept { return detail::load_big_u16(this->data + 8) & 0x3FFF; }
...
namespace boost {
    namespace serialization {
        ...
        template<>
        struct implementation_level_impl<const uuids::uuid> : boost::integral_constant<int, 1>
        {
        };
