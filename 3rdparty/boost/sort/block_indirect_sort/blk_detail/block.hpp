    ...
    namespace sort {
        namespace blk_detail {
            ...
            public:
                ...
                //-------------------------------------------------------------------------
                block_pos(size_t position, bool side = false) { num = (position << 1) + ((side) ? 1 : 0); }
            ...
            struct block
            {
                ...
                /// @return range
                //-------------------------------------------------------------------------
                range<Iter_t> get_range(void) { return range_it(first, first + Block_size); }
            ...
            bool compare_block(
                block<Block_size, Iter_t> block1,
            ...
            struct compare_block_pos
            {
                ...
                {
                    return comp(
                        *(global_first + (block_pos1.pos() * Block_size)),
