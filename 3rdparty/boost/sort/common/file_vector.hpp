...
namespace boost {
    namespace sort {
        namespace common {
            ...
            /// @remarks
            //-----------------------------------------------------------------------------
            inline int fill_vector_uint64(const std::string& filename, std::vector<uint64_t>& V, size_t NElem)
            { //----------------------- begin ------------------------------------------
            ...
            /// @remarks
            //-----------------------------------------------------------------------------
            inline int write_file_uint64(const std::vector<uint64_t>& V, const std::string& filename)
            { //--------------------------------- begin --------------------------------
                std::ofstream ofile;
                ofile.open(filename, std::ios_base::out | std::ios_base::binary | std::ios_base::trunc);
                if (ofile.bad()) {
            ...
            /// @remarks
            //-----------------------------------------------------------------------------
            inline int fill_vector_string(const std::string& filename, std::vector<std::string>& V, size_t NElem)
            { //----------------------- begin ------------------------------------------
                std::ifstream input(filename, std::ios_base::in | std::ios_base::binary);
                if (input.fail()) {
                    throw std::ios_base::failure("could not open file \n");
            ...
            /// @remarks
            //-----------------------------------------------------------------------------
            inline int write_file_string(const std::vector<std::string>& V, const std::string& filename)
            { //--------------------------------- begin --------------------------------
                std::ofstream ofile;
                ofile.open(filename, std::ios_base::out | std::ios_base::binary | std::ios_base::trunc);
                if (ofile.bad()) {
