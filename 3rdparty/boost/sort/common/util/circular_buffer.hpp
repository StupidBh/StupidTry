    ...
    namespace sort {
        namespace common {
            namespace util {
                ...
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::pop_copy_front(iter_t it_dest, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                    }
#ifdef __BS_DEBUG
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::pop_move_front(iter_t it_dest, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::pop_copy_back(iter_t it_dest, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::pop_move_back(iter_t it_dest, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::push_copy_front(iter_t it_src, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::push_move_front(iter_t it_src, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::push_copy_back(iter_t it_src, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
                ...
                template<class Value_t, uint32_t Power2>
                template<class iter_t>
                void circular_buffer<Value_t, Power2>::push_move_back(iter_t it_src, size_t num)
                {
                    static_assert(std::is_same<value_iter<iter_t>, Value_t>::value, "Incompatible iterator");
                    if (num == 0) {
                        return;
