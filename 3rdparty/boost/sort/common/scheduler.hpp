    ...
    namespace sort {
        namespace common {
            ...
            struct scheduler
            {
                ...
                typedef std::unordered_map<key_t, deque_t, hash_t, equal_t, alloc_t<pair_t>> map_t;
                ...
                void insert_range(it_func first, it_func last)
                {
                    ...
                    static_assert(std::is_same<Func_t, value2_t>::value, "Incompatible iterators\n");
            ...
            template<typename Func_t, typename Allocator = std::allocator<Func_t>>
            std::ostream& operator<<(std::ostream& out, const scheduler<Func_t, Allocator>& sch)
            {
