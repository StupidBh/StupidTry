    ...
    namespace sort {
        namespace common {
            ...
            struct less_ptr_no_null
            {
                ...
                //-----------------------------------------------------------------------
                less_ptr_no_null(Compare C1 = Compare()) :
                    comp(C1) {};
                ...
                //-----------------------------------------------------------------------
                bool operator()(Iter_t T1, Iter_t T2) const { return comp(*T1, *T2); };
            };
            ...
            void sort_index(Iter_t global_first, std::vector<Iter_t>& index)
            {
                ...
                while (pos_in_vector < nelem) {
                    while (pos_in_vector < nelem && (size_t(index[pos_in_vector] - global_first)) == pos_in_vector) {
                        ++pos_in_vector;
                    }
                    ...
                    while ((pos_src = (size_t(index[pos_dest] - global_first))) != pos_in_vector) {
