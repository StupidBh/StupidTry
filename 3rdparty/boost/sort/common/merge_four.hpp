...
namespace boost {
    namespace sort {
        namespace common {
            ...
            inline bool less_range(Iter_t it1, uint32_t pos1, Iter_t it2, uint32_t pos2, Compare comp = Compare())
            {
                return (comp(*it1, *it2)) ? true : (pos2 < pos1) ? false : !(comp(*it2, *it1));
            }
            ...
            range<Iter1_t> full_merge4(
                const range<Iter1_t>& rdest,
                range<Iter2_t> vrange_input[4],
                uint32_t nrange_input,
                Compare comp)
            {
                using std::swap;
                ...
                if (nrange_input == 0) {
                    return range1_t(rdest.first, rdest.first);
                }
                if (nrange_input == 1) {
                    return move_forward(rdest, vrange_input[0]);
                }
                if (nrange_input == 2) {
                ...
                // sorting networks
                //-----------------------------------------------------------------------
                if (less_range(vrange_input[pos[1]].first, pos[1], vrange_input[pos[0]].first, pos[0], comp)) {
                    swap(pos[0], pos[1]);
                }
                if (npos == 4 &&
                    less_range(vrange_input[pos[3]].first, pos[3], vrange_input[pos[2]].first, pos[2], comp)) {
                    swap(pos[3], pos[2]);
                }
                if (less_range(vrange_input[pos[2]].first, pos[2], vrange_input[pos[0]].first, pos[0], comp)) {
                    swap(pos[0], pos[2]);
                };
                if (npos == 4 &&
                    less_range(vrange_input[pos[3]].first, pos[3], vrange_input[pos[1]].first, pos[1], comp)) {
                    swap(pos[1], pos[3]);
                }
                if (less_range(vrange_input[pos[2]].first, pos[2], vrange_input[pos[1]].first, pos[1], comp)) {
                    swap(pos[1], pos[2]);
                }
                    ...
                    if (vrange_input[pos[0]].size() == 0) {
                        ...
                        if (less_range(vrange_input[pos[1]].first, pos[1], vrange_input[pos[0]].first, pos[0], comp)) {
                            ...
                            if (less_range(
                                    ...
                                    pos[2],
                                    vrange_input[pos[1]].first,
                                    pos[1],
                                    comp)) {
                                swap(pos[1], pos[2]);
                                if (npos == 4 && less_range(
                                                     vrange_input[pos[3]].first,
                                                     pos[3],
                                                     vrange_input[pos[2]].first,
                                                     pos[2],
                                                     comp)) {
                ...
                if (pos[0] < pos[1]) {
                    return concat(raux1, merge(raux2, vrange_input[pos[0]], vrange_input[pos[1]], comp));
                }
                else {
                    return concat(raux1, merge(raux2, vrange_input[pos[1]], vrange_input[pos[0]], comp));
                }
            }
            ...
            range<Value_t*> uninit_full_merge4(
                ...
                Compare comp)
            {
                ...
                if (nrange_input == 0) {
                    return range<Value_t*>(dest.first, dest.first);
                }
                if (nrange_input == 1) {
                    return move_construct(dest, vrange_input[0]);
                }
                if (nrange_input == 2) {
                ...
                while (npos > 2) {
                    util::construct_object(&(*(it_dest++)), std::move(*(vrange_input[pos[0]].first++)));
                    if (vrange_input[pos[0]].size() == 0) {
                        pos[0] = pos[1];
                        pos[1] = pos[2];
                        pos[2] = pos[3];
                ...
                if (pos[0] < pos[1]) {
                    return concat(raux1, merge_construct(raux2, vrange_input[pos[0]], vrange_input[pos[1]], comp));
                }
                else {
                    return concat(raux1, merge_construct(raux2, vrange_input[pos[1]], vrange_input[pos[0]], comp));
                }
            }
