    ...
    namespace sort {
        namespace spreadsort {
            namespace detail {
                ...
                inline Cast_type cast_float_iter(const RandomAccessIter& floatiter)
                {
                ...
                inline bool is_sorted_or_find_extremes(
                    ...
                    const Div_type div_min)
                {
                    ...
                    for (RandomAccessIter current = *local_bin; current < nextbinstart; ++current) {
                        for (RandomAccessIter* target_bin =
                                 (bins +
                                  ((cast_float_iter<Div_type, RandomAccessIter>(current) >> log_divisor) - div_min));
                            ...
                            RandomAccessIter* b_bin =
                                bins + ((cast_float_iter<Div_type, RandomAccessIter>(b) >> log_divisor) - div_min);
                    ...
                    const Div_type div_min)
                {
                    ...
                    inner_float_swap_loop<RandomAccessIter, Div_type>(bins, nextbinstart, ii, log_divisor, div_min);
                }
                ...
                inline void positive_float_sort_rec(
                ...
                {
                    Div_type max, min;
                    if (is_sorted_or_find_extremes<RandomAccessIter, Div_type>(first, last, max, min)) {
                        return;
                    }
                    ...
                    // Recursing
                    size_t max_count =
                        get_min_count<float_log_mean_bin_size, float_log_min_split_count, float_log_finishing_count>(
                            log_divisor);
                ...
                template<class RandomAccessIter, class Div_type, class Size_type>
                inline void negative_float_sort_rec(
                    RandomAccessIter first,
                    RandomAccessIter last,
                    std::vector<RandomAccessIter>& bin_cache,
                    unsigned cache_offset,
                    size_t* bin_sizes)
                {
                    ...
                    size_t max_count =
                        get_min_count<float_log_mean_bin_size, float_log_min_split_count, float_log_finishing_count>(
                            log_divisor);
                    RandomAccessIter lastPos = first;
                    for (int ii = cache_end - 1; ii >= static_cast<int>(cache_offset); lastPos = bin_cache[ii], --ii) {
                    ...
                    Compare comp)
                {
                    ...
                    for (int ii = cache_end - 1; ii >= static_cast<int>(cache_offset); lastPos = bin_cache[ii], --ii) {
                        ...
                        if (count < max_count) {
                            ...
                            negative_float_sort_rec<RandomAccessIter, Div_type, Right_shift, Compare, Size_type>(
                                lastPos,
                                bin_cache[ii],
                                bin_cache,
                                cache_end,
                    ...
                    size_t* bin_sizes)
                {
                    ...
                    unsigned log_divisor = get_log_divisor<float_log_mean_bin_size>(
                        last - first,
                        rough_log_2_size(Size_type(max / 2 - min / 2)) + 1);
                    Div_type div_min = min >> log_divisor;
                    Div_type div_max = max >> log_divisor;
                    unsigned bin_count = unsigned(div_max - div_min) + 1;
                    unsigned cache_end;
                    ...
                    for (unsigned u = 0; u < bin_count; ++u) {
                        ...
                        inner_float_swap_loop<RandomAccessIter, Div_type>(bins, nextbinstart, u, log_divisor, div_min);
                    }
                    ...
                    size_t max_count =
                        get_min_count<float_log_mean_bin_size, float_log_min_split_count, float_log_finishing_count>(
                            log_divisor);
                    RandomAccessIter lastPos = first;
                    for (int ii = cache_offset + first_positive - 1; ii >= static_cast<int>(cache_offset);
                    ...
                    Compare comp)
                {
                    ...
                    // The index of the first positive bin
                    unsigned first_positive = (div_min < 0) ? static_cast<unsigned>(-div_min) : 0;
                    // Resetting if all bins are negative
                    if (cache_offset + first_positive > cache_end) {
                        first_positive = cache_end - cache_offset;
                    }
                ...
                inline typename boost::enable_if_c<
                    sizeof(boost::uint32_t) == sizeof(typename std::iterator_traits<RandomAccessIter>::value_type) &&
                        std::numeric_limits<typename std::iterator_traits<RandomAccessIter>::value_type>::is_iec559,
                    void>::type
                ...
                template<class RandomAccessIter>
                inline typename boost::enable_if_c<
                    sizeof(boost::uint64_t) == sizeof(typename std::iterator_traits<RandomAccessIter>::value_type) &&
                        std::numeric_limits<typename std::iterator_traits<RandomAccessIter>::value_type>::is_iec559,
                    void>::type
                    float_sort(RandomAccessIter first, RandomAccessIter last)
                {
                ...
                template<class RandomAccessIter, class Div_type, class Right_shift>
                inline typename boost::enable_if_c<sizeof(size_t) >= sizeof(Div_type), void>::type
                    float_sort(RandomAccessIter first, RandomAccessIter last, Div_type, Right_shift rshift)
                {
                    size_t bin_sizes[1 << max_finishing_splits];
                    std::vector<RandomAccessIter> bin_cache;
                ...
                template<class RandomAccessIter, class Div_type, class Right_shift>
                inline typename boost::enable_if_c<
                    sizeof(size_t) < sizeof(Div_type) && sizeof(boost::uintmax_t) >= sizeof(Div_type),
                    void>::type
                    float_sort(RandomAccessIter first, RandomAccessIter last, Div_type, Right_shift rshift)
                {
                    size_t bin_sizes[1 << max_finishing_splits];
                ...
                template<class RandomAccessIter, class Div_type, class Right_shift>
                inline typename boost::disable_if_c<sizeof(boost::uintmax_t) >= sizeof(Div_type), void>::type
                    float_sort(RandomAccessIter first, RandomAccessIter last, Div_type, Right_shift /* rshift */)
                {
                    boost::sort::pdqsort(first, last);
                }
                ...
                template<class RandomAccessIter, class Div_type, class Right_shift, class Compare>
                inline typename boost::enable_if_c<sizeof(size_t) >= sizeof(Div_type), void>::type float_sort(
                    RandomAccessIter first,
                    RandomAccessIter last,
                    Div_type,
                    Right_shift rshift,
                    Compare comp)
                {
                    size_t bin_sizes[1 << max_finishing_splits];
                    std::vector<RandomAccessIter> bin_cache;
                    float_sort_rec<RandomAccessIter, Div_type, Right_shift, Compare, size_t>(
                        first,
                        last,
                        bin_cache,
                        0,
                        ...
                        Compare comp)
                {
                    size_t bin_sizes[1 << max_finishing_splits];
                    std::vector<RandomAccessIter> bin_cache;
                    float_sort_rec<RandomAccessIter, Div_type, Right_shift, Compare, boost::uintmax_t>(
                        first,
                        last,
                        bin_cache,
                        0,
