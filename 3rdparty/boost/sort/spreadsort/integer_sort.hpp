    ...
    namespace sort {
        namespace spreadsort {
            ...
            */
            ...
            /*! \brief Integer sort algorithm using random access iterators with both right-shift and user-defined
            comparison operator. (All variants fall back to @c boost::sort::pdqsort if the data size is too small, < @c
            detail::min_sort_size).
            ...
            Some performance plots of runtime vs. n and log(range) are provided:\n
               ...
               \param[in] first Iterator pointer to first element.
               \param[in] last Iterator pointing to one beyond the end of data.
               \param[in] shift Functor that returns the result of shifting the value_type right a specified number of
            bits.
            ...
            */
            ...
            inline void integer_sort(RandomAccessIter first, RandomAccessIter last, Right_shift shift, Compare comp)
            {
                if (last - first < detail::min_sort_size) {
            ...
            */
            ...
            Some performance plots of runtime vs. n and log(range) are provided:\n
              ...
              * <a href="../../doc/graph/osx_integer_sort.htm"> osx_integer_sort</a>
               ...
               \param[in] first Iterator pointer to first element.
               \param[in] last Iterator pointing to one beyond the end of data.
               \param[in] shift A functor that returns the result of shifting the value_type right a specified number of
            bits.
            ...
            */
            ...
            inline void integer_sort(RandomAccessIter first, RandomAccessIter last, Right_shift shift)
            {
                if (last - first < detail::min_sort_size) {
                    boost::sort::pdqsort(first, last);
                }
