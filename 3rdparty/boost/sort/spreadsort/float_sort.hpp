    ...
    namespace sort {
        namespace spreadsort {
            ...
            */
            ...
            inline Cast_type float_mem_cast(const Data_type& data)
            {
          ...
          */
            ...
            /*!
              ...
              \param[in] first Iterator pointer to first element.
              \param[in] last Iterator pointing to one beyond the end of data.
              \param[in] rshift Functor that returns the result of shifting the value_type right a specified number of
              bits.

            */
            template<class RandomAccessIter, class Right_shift>
            inline void float_sort(RandomAccessIter first, RandomAccessIter last, Right_shift rshift)
            {
                if (last - first < detail::min_sort_size) {
                    boost::sort::pdqsort(first, last);
                }
          ...
          */
            ...
            /*!
             \brief Float sort algorithm using random access iterators with both right-shift and user-defined comparison
             operator.
            ...
            */
            ...
            inline void float_sort(RandomAccessIter first, RandomAccessIter last, Right_shift rshift, Compare comp)
            {
                if (last - first < detail::min_sort_size) {
