...
namespace boost {
    namespace sort {
        ...
        namespace pdqsort_detail {
            ...
            template<class T>
            struct is_default_compare : boost::false_type
            {
            };

            template<class T>
            struct is_default_compare<std::less<T>> : boost::true_type
            {
            };

            template<class T>
            struct is_default_compare<std::greater<T>> : boost::true_type
            {
            };
            ...
            inline void insertion_sort(Iter begin, Iter end, Compare comp)
            {
                ...
                for (Iter cur = begin + 1; cur != end; ++cur) {
                    ...
                    if (comp(*sift, *sift_1)) {
                        ...
                        do {
                            *sift-- = BOOST_PDQSORT_PREFER_MOVE(*sift_1);
                ...
                bool use_swaps)
            {
                ...
                if (use_swaps) {
                    ...
                    T tmp(BOOST_PDQSORT_PREFER_MOVE(*l));
                    *l = BOOST_PDQSORT_PREFER_MOVE(*r);
                    for (size_t i = 1; i < num; ++i) {
                        l = first + offsets_l[i];
                        *r = BOOST_PDQSORT_PREFER_MOVE(*l);
                        r = last - offsets_r[i];
                        *l = BOOST_PDQSORT_PREFER_MOVE(*r);
                    }
        ...
        href="http://en.cppreference.com/w/cpp/concept/MoveAssignable">MoveAssignable</a>
           \pre @c RandomAccessIter @c value_type is <a
        ...
        */
        ...
        inline void pdqsort(Iter first, Iter last, Compare comp)
        {
            ...
            pdqsort_detail::pdqsort_loop<
                ...
                last,
                comp,
                pdqsort_detail::log2(last - first));
        }
        ...
        */
        ...
        inline void pdqsort_branchless(Iter first, Iter last, Compare comp)
        {
            ...
            pdqsort_detail::pdqsort_loop<Iter, Compare, true>(first, last, comp, pdqsort_detail::log2(last - first));
        }
