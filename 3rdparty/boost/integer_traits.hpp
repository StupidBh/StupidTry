...
// and some may have <wchar.h> but not <cwchar> ...
    ...
    (!defined(BOOST_NO_CWCHAR) || defined(sun) || defined(__sun) || defined(__QNX__))
    #include <wchar.h>
#endif
...
namespace boost {
    ...
    class integer_traits<wchar_t> :
    ...
    #elif defined(BOOST_BORLANDC) || defined(__CYGWIN__) || defined(__MINGW32__) || \
        ...
        (defined(__OpenBSD__) && defined(__GNUC__)) || (defined(__NetBSD__) && defined(__GNUC__)) ||         \
        (defined(__FreeBSD__) && defined(__GNUC__)) || (defined(__DragonFly__) && defined(__GNUC__)) ||      \
    ...
    class integer_traits<::boost::long_long_type> :
        public std::numeric_limits<::boost::long_long_type>,
        public detail::integer_traits_base<::boost::long_long_type, LONG_LONG_MIN, LONG_LONG_MAX> {};
    ...
    class integer_traits<::boost::long_long_type> :
        ...
        public detail::integer_traits_base<
            ...
            (1LL << (sizeof(::boost::long_long_type) * CHAR_BIT - 1)),
            ~(1LL << (sizeof(::boost::long_long_type) * CHAR_BIT - 1))> {};
