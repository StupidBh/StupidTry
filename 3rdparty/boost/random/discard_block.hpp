...
namespace boost {
    namespace random {
        ...
        class discard_block_engine {
            typedef typename detail::seed_type<typename UniformRandomNumberGenerator::result_type>::type seed_type;
        ...
        public:
             ...
             */
            static BOOST_CONSTEXPR result_type min BOOST_PREVENT_MACRO_SUBSTITUTION() { return (base_type::min)(); }

            /**
             * Returns the largest value that the generator can produce.
             * This is the same as the maximum of the underlying generator.
             */
            static BOOST_CONSTEXPR result_type max BOOST_PREVENT_MACRO_SUBSTITUTION() { return (base_type::max)(); }
            ...
            friend bool operator!=(const discard_block_engine& x, const discard_block_engine& y) { return !(x == y); }
        ...
        public:
            ...
            template<class T>
            discard_block(const T& arg) :
                base_t(arg)
            {
            }

            template<class It>
            discard_block(It& first, It last) :
                base_t(first, last)
            {
            }

            result_type min BOOST_PREVENT_MACRO_SUBSTITUTION() { return (this->base().min)(); }

            result_type max BOOST_PREVENT_MACRO_SUBSTITUTION() { return (this->base().max)(); }
        };
