    ...
    namespace random {
        ...
        namespace qrng_detail {
            ...
            class gray_coded_qrng :
                public qrng_base<gray_coded_qrng<LatticeT>, LatticeT, typename LatticeT::value_type> {
            public:
            ...
            private:
                ...
                typedef typename conditional<
                    ...
                    check_bit_range,
                    check_nothing>::type check_bit_range_t;
            ...
            private:
                ...
                void update_quasi(unsigned r)
                {
                    ...
                    std::transform(
                        this->state_begin(),
                        this->state_end(),
                        this->lattice.iter_at(r * this->dimension()),
                        this->state_begin(),
                        std::bit_xor<result_type>());
                }

                void set_zero_state() { std::fill(this->state_begin(), this->state_end(), result_type /*zero*/ ()); }
            };
