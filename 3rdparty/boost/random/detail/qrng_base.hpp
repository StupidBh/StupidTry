    ...
    namespace random {
        ...
        namespace qrng_detail {
            ...
            public:
                ...
                //!
                //! Throws: range_error.
                result_type operator()() { return curr_elem != dimension() ? load_cached() : next_state(); }
    ...
    #pragma warning(pop)
                ...
                BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(qrng_base, x, y)
                {
                    ...
                    return (dimension_value == y.dimension()) &&
                           ...
                           (x.seq_count + (x.curr_elem / dimension_value) ==
                            y.seq_count + (y.curr_elem / dimension_value)) &&
            ...
            private:
                DerivedT& derived() throw() { return *static_cast<DerivedT* const>(this); }

                // Load the result from the saved state.
                result_type load_cached() { return quasi_state[curr_elem++]; }
