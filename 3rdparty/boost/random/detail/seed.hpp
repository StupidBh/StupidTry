...
namespace boost {
    ...
    #define BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(Self, Generator, gen) \
        ...
        explicit Self(                                                      \
            Generator& gen,                                                 \
            typename ::boost::random::detail::disable_constructor<Self, Generator>::type* = 0)
    ...
    #define BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(Self, T, x) explicit Self(const T& x)

    #define BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(Self, T, x) void seed(const T& x)
        }
    }
}
    ...
    #define BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(Self, T, x)  \
        ...
        {                                                           \
            boost_random_constructor_impl(x, ::boost::true_type()); \
        }                                                           \
    ...
    #define BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(Self, T, x)  \
        void seed(const T& x)                                \
        {                                                    \
            boost_random_seed_impl(x, ::boost::true_type()); \
        }                                                    \
