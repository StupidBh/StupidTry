    ...
    namespace random {
        namespace detail {
            ...
            public:
                ...
                static void add(std::size_t size, const digit_t* lhs, const digit_t* rhs, digit_t* output)
                {
                ...
                static void
                    add_shifted_inplace(std::size_t size, const digit_t* lhs, digit_t* output, std::size_t shift)
                {
                    if (shift == 0) {
                ...
                static void multiply_simple(std::size_t size, const digit_t* lhs, const digit_t* rhs, digit_t* output)
                {
                    std::size_t bits = std::numeric_limits<digit_t>::digits;
                ...
                static void
                    multiply_karatsuba(std::size_t size, const digit_t* lhs, const digit_t* rhs, digit_t* output)
                {
                    if (size < 64) {
                    ...
                    multiply_karatsuba(size - cutoff, lhs + cutoff, rhs + cutoff, output + cutoff * 2);
                    ...
                    if (size & 1) {
                        local1[cutoff] = lhs[size - 1];
                    }
                    add(cutoff, rhs + cutoff, rhs, &local2[0]);
                    if (size & 1) {
                        local2[cutoff] = rhs[size - 1];
                    }
                ...
                static void
                    multiply_add_karatsuba(std::size_t size, const digit_t* lhs, const digit_t* rhs, digit_t* output)
                {
                ...
                static void copy_bits(const digit_t* x, std::size_t low, std::size_t high, digit_t* out)
                {
