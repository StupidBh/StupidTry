    ...
    namespace random {
        ...
        public:
            ...
            public:
                ...
                friend bool operator==(const param_type& lhs, const param_type& rhs) { return lhs._n == rhs._n; }
            ...
            friend bool operator==(const chi_squared_distribution& lhs, const chi_squared_distribution& rhs)
            {
