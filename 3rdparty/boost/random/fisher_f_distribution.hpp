    ...
    namespace random {
        ...
        public:
            ...
            public:
                 ...
                 */
                explicit param_type(RealType m_arg = RealType(1.0), RealType n_arg = RealType(1.0)) :
                    _m(m_arg),
                    _n(n_arg)
                {
                }
             ...
             * Requires: m > 0 and n > 0
             */
            explicit fisher_f_distribution(RealType m_arg = RealType(1.0), RealType n_arg = RealType(1.0)) :
                _impl_m(m_arg),
                _impl_n(n_arg)
            {
            }
