...
namespace boost {
    namespace random {
        ...
        public:
            ...
            public:
                ...
                explicit param_type(RealType m_arg = RealType(0.0), RealType s_arg = RealType(1.0)) :
                    _m(m_arg),
                    _s(s_arg)
                {
                }
             ...
             */
            explicit lognormal_distribution(RealType m_arg = RealType(0.0), RealType s_arg = RealType(1.0)) :
                _normal(m_arg, s_arg)
            {
            }
    ...
    public:
        ...
        lognormal_distribution(RealType mean_arg = RealType(1.0), RealType sigma_arg = RealType(1.0)) :
            _mean(mean_arg),
            _sigma(sigma_arg)
        {
            init();
