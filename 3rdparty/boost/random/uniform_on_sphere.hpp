    ...
    namespace random {
        ...
        public:
            ...
            public:
                 ...
                 */
                explicit param_type(int dim_arg = 2) :
                    _dim(dim_arg)
                {
                    BOOST_ASSERT(_dim >= 0);
                }
                ...
                BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._dim == rhs._dim; }
            ...
            const result_type& operator()(Engine& eng)
            {
                ...
                default: {
                    ...
                    do {
                        sqsum = 0;
                        for (typename Cont::iterator it = _container.begin(); it != _container.end(); ++it) {
             ...
             */
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(uniform_on_sphere, lhs, rhs) { return lhs._dim == rhs._dim; }
