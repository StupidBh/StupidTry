...
namespace boost {
    namespace random {
        ...
        public:
            ...
            template<class CharT, class Traits>
            friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, new_uniform_01&)
            {
                return is;
            }
    #endif
        ...
        namespace detail {
            ...
            public:
                ...
                result_type operator()(Engine& eng)
                {
                    for (;;) {
                        ...
                        result_type factor =
                            result_type(1) / (result_type(base_result((eng.max)() - (eng.min)())) +
            ...
            public:
                ...
                explicit backward_compatible_uniform_01(typename traits::rvalue_type rng) :
                    _rng(rng),
                    _factor(
                        result_type(1) / (result_type((base().max)() - (base().min)()) +
                                          result_type(std::numeric_limits<base_result>::is_integer ? 1 : 0)))
                {
                }
            ...
            template<
                ...
                bool is_number = std::numeric_limits<UniformRandomNumberGenerator>::is_specialized>
        ...
        class uniform_01 :
            public detail::select_uniform_01<UniformRandomNumberGenerator>::BOOST_NESTED_TEMPLATE
                apply<RealType>::type {
            typedef typename detail::select_uniform_01<UniformRandomNumberGenerator>::BOOST_NESTED_TEMPLATE
                apply<RealType>::type impl_type;
            typedef boost::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
        ...
        public:
            ...
            template<class CharT, class Traits>
            friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, uniform_01& u)
            {
