    ...
    namespace random {
        ...
        public:
            ...
            public:
                ...
                explicit param_type(RealType median_arg = RealType(0.0), RealType sigma_arg = RealType(1.0)) :
                    _median(median_arg),
                    _sigma(sigma_arg)
                {
                }
             ...
             * and @c sigma.
             */
            explicit cauchy_distribution(RealType median_arg = RealType(0.0), RealType sigma_arg = RealType(1.0)) :
                _median(median_arg),
                _sigma(sigma_arg)
            {
            }
