    ...
    namespace random {
        ...
        public:
            ...
            public:
                 ...
                 * of the distribution.
                 */
                explicit param_type(RealType mean_arg = RealType(0.0), RealType beta_arg = RealType(1.0)) :
                    _mean(mean_arg),
                    _beta(beta_arg)
                {
                }
                ...
                {
                    is >> parm._mean >> std::ws >> parm._beta;
                    return is;
                }
             ...
             */
            explicit laplace_distribution(RealType mean_arg = RealType(0.0), RealType beta_arg = RealType(1.0)) :
                _mean(mean_arg),
                _beta(beta_arg)
            {
            }
