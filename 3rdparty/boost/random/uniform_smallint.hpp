    ...
    namespace random {
        ...
        private:
            ...
            result_type generate(Engine& eng, boost::true_type) const
            {
                ...
                base_unsigned base_range = random::detail::subtract<base_result>()((eng.max)(), (eng.min)());
                base_unsigned val = random::detail::subtract<base_result>()(eng(), (eng.min)());
                if (range >= base_range) {
                    return boost::random::detail::add<range_type, result_type>()(static_cast<range_type>(val), _min);
                }
                else {
                    ...
                    return boost::random::detail::add<range_type, result_type>()(
                        static_cast<mixed_range_type>(val) % modulus,
                        _min);
                }
            }
