    ...
    namespace random {
        ...
        public:
            ...
            public:
                 ...
                 */
                explicit param_type(RealType alpha_arg = RealType(1.0), RealType beta_arg = RealType(1.0)) :
                    _alpha(alpha_arg),
                    _beta(beta_arg)
                {
             ...
             * Requires: alpha > 0, beta > 0
             */
            explicit beta_distribution(RealType alpha_arg = RealType(1.0), RealType beta_arg = RealType(1.0)) :
                _alpha(alpha_arg),
                _beta(beta_arg)
            {
                BOOST_ASSERT(alpha_arg > 0);
            ...
            RealType max BOOST_PREVENT_MACRO_SUBSTITUTION() const { return RealType(1.0); }
