    ...
    namespace random {
        namespace detail {
            ...
            inline T generate_uniform_real(Engine& eng, T min_value, T max_value)
            {
                ...
                typedef typename Engine::result_type base_result;
                return generate_uniform_real(eng, min_value, max_value, boost::is_integral<base_result>());
            }
        ...
        public:
            ...
            public:
                 ...
                 * Requires min < max
                 */
                explicit param_type(RealType min_arg = RealType(0.0), RealType max_arg = RealType(1.0)) :
                    _min(min_arg),
                    _max(max_arg)
                {
             ...
             * Requires: min < max
             */
            explicit uniform_real_distribution(RealType min_arg = RealType(0.0), RealType max_arg = RealType(1.0)) :
                _min(min_arg),
                _max(max_arg)
            {
