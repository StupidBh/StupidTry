    ...
    namespace random {
        ...
        public:
            ...
            public:
                ...
                BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(param_type, lhs, rhs) { return lhs._p == rhs._p; }
            ...
            bool min BOOST_PREVENT_MACRO_SUBSTITUTION() const { return false; }

            /** Returns the largest value that the distribution can produce. */
            bool max BOOST_PREVENT_MACRO_SUBSTITUTION() const { return true; }
             ...
             */
            BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(bernoulli_distribution, lhs, rhs) { return lhs._p == rhs._p; }
