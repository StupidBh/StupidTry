...
namespace boost {
    namespace random {
        ...
        public:
             ...
             */
            BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(mersenne_twister_engine, UIntType, value) { seed(value); }
             ...
             * @endxmlnote
             */
            BOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR(mersenne_twister_engine, SeedSeq, seq) { seed(seq); }
    ...
    #define BOOST_RANDOM_MERSENNE_TWISTER_DISCARD_THRESHOLD 10'000'000
#endif
             ...
             */
            friend bool operator==(const mersenne_twister_engine& x_, const mersenne_twister_engine& y_)
            {
                if (x_.i < y_.i) {
                    return x_.equal_imp(y_);
                }
                else {
                    return y_.equal_imp(x_);
                }
            }
        ...
        private:
             ...
             */
            UIntType rewind_find(UIntType* last, std::size_t size, std::size_t j) const
            {
    ...
    #undef BOOST_RANDOM_MT_DEFINE_CONSTANT
        ...
        template<
            ...
            std::size_t l,
            UIntType f>
        void mersenne_twister_engine<UIntType, w, n, m, r, a, u, d, s, b, t, c, l, f>::twist()
        {
            const UIntType upper_mask = (~static_cast<UIntType>(0)) << r;
            const UIntType lower_mask = ~upper_mask;
        ...
        typedef mersenne_twister_engine<
            ...
            43,
            UINT64_C(6'364'136'223'846'793'005)>
            mt19937_64;
#endif
        ...
        class mersenne_twister :
            public mersenne_twister_engine<UIntType, w, n, m, r, a, u, ~(UIntType)0, s, b, t, c, l, 1'812'433'253> {
            typedef mersenne_twister_engine<UIntType, w, n, m, r, a, u, ~(UIntType)0, s, b, t, c, l, 1'812'433'253>
                base_type;

        public:
            mersenne_twister() {}

            BOOST_RANDOM_DETAIL_GENERATOR_CONSTRUCTOR(mersenne_twister, Gen, gen) { seed(gen); }

            BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(mersenne_twister, UIntType, val) { seed(val); }
            ...
            BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(mersenne_twister, UIntType, val) { base_type::seed(val); }
