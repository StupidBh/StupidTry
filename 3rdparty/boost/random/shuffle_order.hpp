    ...
    namespace random {
        ...
        public:
            ...
            result_type operator()()
            {
                ...
                const base_unsigned brange = detail::subtract<result_type>()((max)(), (min)());
                const base_unsigned off = detail::subtract<result_type>()(y, (min)());
                ...
                if (k == 1) {
                    ...
                    j = static_cast<base_unsigned>(
                        static_cast<uintmax_t>(off) * k / (static_cast<uintmax_t>(brange) + 1));
                }
                else {
                    boost::uintmax_t divisor = static_cast<boost::uintmax_t>(brange) + 1;
