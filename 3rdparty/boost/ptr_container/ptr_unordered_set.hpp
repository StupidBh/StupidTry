...
namespace boost {
    ...
    public:
        ...
        BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE(ptr_unordered_set, base_type, this_type)
    ...
    public:
        ...
        BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE(ptr_unordered_multiset, base_type, this_type)

        BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS(ptr_unordered_multiset, base_type)
    };
    ...
    inline ptr_unordered_set<K, H, P, CA, A>* new_clone(const ptr_unordered_set<K, H, P, CA, A>& r)
    {
        return r.clone().release();
    }

    template<typename K, typename H, typename P, typename CA, typename A>
    inline ptr_unordered_multiset<K, H, P, CA, A>* new_clone(const ptr_unordered_multiset<K, H, P, CA, A>& r)
    {
        return r.clone().release();
    }
    ...
    template<typename K, typename H, typename P, typename CA, typename A>
    inline void swap(ptr_unordered_set<K, H, P, CA, A>& l, ptr_unordered_set<K, H, P, CA, A>& r)
    {
        l.swap(r);
    }

    template<typename K, typename H, typename P, typename CA, typename A>
    inline void swap(ptr_unordered_multiset<K, H, P, CA, A>& l, ptr_unordered_multiset<K, H, P, CA, A>& r)
    {
        l.swap(r);
    }
