...
namespace boost {
    ...
    template<class T, class CloneAllocator = heap_clone_allocator, class Allocator = void>
    class ptr_vector :
        public ptr_sequence_adapter<
            ...
            std::vector<
                ...
                typename boost::mpl::if_<
                    boost::is_same<Allocator, void>,
                    std::allocator<typename ptr_container_detail::void_ptr<T>::type>,
                    Allocator>::type>,
            CloneAllocator> {
        typedef
    ...
    public:
        ...
        explicit ptr_vector(size_type n, const allocator_type& alloc = allocator_type()) :
            base_class(alloc)
        {
            this->base().reserve(n);
        }
