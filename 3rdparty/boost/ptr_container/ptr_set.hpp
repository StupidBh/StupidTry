...
namespace boost {
    ...
    class ptr_set :
        public ptr_set_adapter<
            Key,
            std::
                set<typename ptr_container_detail::void_ptr<Key>::type, void_ptr_indirect_fun<Compare, Key>, Allocator>,
            CloneAllocator,
            true> {
    ...
    public:
        ...
        explicit ptr_set(const Compare& comp, const Allocator& a = Allocator()) :
            base_type(comp, a)
        {
        }
        ...
        BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE(ptr_set, base_type, this_type)
    ...
    public:
        ...
        explicit ptr_multiset(const Compare& comp, const Allocator& a = Allocator()) :
            base_type(comp, a)
        {
        }
        ...
        template<typename InputIterator>
        ptr_multiset(InputIterator first, InputIterator last, const Compare& comp, const Allocator& a = Allocator()) :
            base_type(first, last, comp, a)
        {
        }

        BOOST_PTR_CONTAINER_DEFINE_RELEASE_AND_CLONE(ptr_multiset, base_type, this_type)

        BOOST_PTR_CONTAINER_DEFINE_COPY_CONSTRUCTORS(ptr_multiset, base_type)
    };
