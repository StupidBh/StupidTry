...
namespace boost {
    ...
    public:
        ...
        Result
#else
        typename boost::result_of<const Fun(typename pointee<T>::type&, typename pointee<U>::type&)>::type
#endif
    ...
    public:
        ...
        Result
#else
        typename ptr_container_detail::make_lazy<boost::result_of<const Fun(const Arg1&)>, Void>::type
#endif
        ...
        Result
#else
        typename ptr_container_detail::make_lazy<boost::result_of<const Fun(const Arg1&, const Arg2&)>, Void>::type
#endif
