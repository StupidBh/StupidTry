...
namespace boost {
    ...
    namespace ptr_container_detail {
        ...
        void load_helper(
            Archive& ar,
            ptr_container_detail::reversible_ptr_container<Config, CloneAllocator>& c,
    ...
    namespace serialization {
        ...
        void save(
            Archive& ar,
            const ptr_container_detail::reversible_ptr_container<Config, CloneAllocator>& c,
