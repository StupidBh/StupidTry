...
namespace boost {
    namespace ptr_container_detail {
        ...
        struct ref_pair
        {
            ...
            const ref_pair* operator->() const { return this; }

            friend inline bool operator==(ref_pair l, ref_pair r)
            {
                return l.first == r.first && boost::equal_pointees(l.second, r.second);
            }

            friend inline bool operator!=(ref_pair l, ref_pair r) { return !(l == r); }
            ...
            friend inline bool operator>(ref_pair l, ref_pair r) { return r < l; }
    ...
    public:
        ...
        explicit ptr_map_iterator(const I& i) :
            base_type(i)
        {
        }
