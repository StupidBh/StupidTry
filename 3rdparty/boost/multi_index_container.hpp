...
#include <boost/utility/base_from_member.hpp>
    ...
    #include <boost/throw_exception.hpp>
        ...
        #define BOOST_MULTI_INDEX_BLOCK_BOOSTDEP_HEADER <boost/serialization/collection_size_type.hpp>
    ...
    #define BOOST_MULTI_INDEX_CHECK_INVARIANT BOOST_MULTI_INDEX_CHECK_INVARIANT_OF(*this)
#else
    #define BOOST_MULTI_INDEX_CHECK_INVARIANT_OF(x)
...
namespace boost {
    ...
    #pragma warning(disable: 4522) /* spurious warning on multiple operator=()'s */
        ...
        class multi_index_container :
            private ::boost::base_from_member<typename detail::rebind_alloc_for<
                Allocator,
                typename detail::multi_index_node_type<Value, IndexSpecifierList, Allocator>::type>::type>,
            BOOST_MULTI_INDEX_PRIVATE_IF_MEMBER_TEMPLATE_FRIENDS detail::header_holder<
                typename detail::allocator_traits<typename detail::rebind_alloc_for<
                    Allocator,
...
#if defined(BOOST_MULTI_INDEX_ENABLE_INVARIANT_CHECKING) && BOOST_WORKAROUND(__MWERKS__, <= 0x3003)
    ...
    #pragma parse_mfunc_templ off
        ...
        private:
            ...
            typedef typename detail::rebind_alloc_for<Allocator, typename super::index_node_type>::type node_allocator;
            ...
            typedef detail::header_holder<node_pointer, multi_index_container> bfm_header;
        ...
        public:
            ...
            explicit multi_index_container(
                ...
                const allocator_type& al = typename mpl::identity<multi_index_container>::type::allocator_type()) :
#else
            ...
            multi_index_container(
                ...
                const ctor_args_list& args_list = typename mpl::identity<multi_index_container>::type::ctor_args_list(),
                const allocator_type& al = typename mpl::identity<multi_index_container>::type::allocator_type()) :
#else
                ...
                node_count(0)
            {
                ...
                BOOST_TRY
                {
                    ...
                    for (; first != last; ++first) {
                        hint = super::make_iterator(insert_ref_(*first, hint.get_node()).first);
                        ++hint;
                    }
                }
                BOOST_CATCH(...)
                ...
                node_count(0)
            {
                ...
                BOOST_TRY
                {
                    ...
                    iterator hint = super::end();
                    for (init_iterator first = list.begin(), last = list.end(); first != last; ++first) {
            ...
            multi_index_container(const multi_index_container<Value, IndexSpecifierList, Allocator>& x) :
                bfm_allocator(node_alloc_traits::select_on_container_copy_construction(x.bfm_allocator::member)),
                bfm_header(),
                super(x),
                node_count(0)
            {
            ...
            multi_index_container(BOOST_RV_REF(multi_index_container) x, const allocator_type& al) :
                bfm_allocator(al),
                bfm_header(),
                super(x, detail::do_not_copy_elements_tag()),
                node_count(0)
            ...
            ~multi_index_container() { delete_all_nodes_(); }
            ...
            multi_index_container<Value, IndexSpecifierList, Allocator>&
                operator=(const multi_index_container<Value, IndexSpecifierList, Allocator>& x)
            {
                multi_index_container y(
                    x,
                    node_alloc_traits::propagate_on_container_copy_assignment::value ? x.get_allocator()
                                                                                     : this->get_allocator());
            ...
            multi_index_container<Value, IndexSpecifierList, Allocator>&
                operator=(BOOST_COPY_ASSIGN_REF(multi_index_container) x)
            {
                multi_index_container y(
                    x,
                    node_alloc_traits::propagate_on_container_copy_assignment::value ? x.get_allocator()
            ...
            multi_index_container<Value, IndexSpecifierList, Allocator>& operator=(BOOST_RV_REF(multi_index_container)
                                                                                       x)
            {
#include <boost/multi_index/detail/define_if_constexpr_macro.hpp>

                BOOST_MULTI_INDEX_IF_CONSTEXPR(node_alloc_traits::propagate_on_container_move_assignment::value)
                {
...
#include <boost/multi_index/detail/undef_if_constexpr_macro.hpp>
            ...
            allocator_type get_allocator() const BOOST_NOEXCEPT { return allocator_type(bfm_allocator::member); }
            ...
            typename nth_index_iterator<N>::type project(IteratorType it)
            {
                ...
                return index_type::make_iterator(static_cast<final_node_type*>(it.get_node()));
            }
            ...
            void copy_construct_from(const multi_index_container<Value, IndexSpecifierList, Allocator>& x)
            {
                copy_map_type map(bfm_allocator::member, x.size(), x.header(), header());
                for (const_iterator it = x.begin(), it_end = x.end(); it != it_end; ++it) {
            ...
            final_node_type* header() const { return &*bfm_header::member; }

            final_node_type* allocate_node() { return &*node_alloc_traits::allocate(bfm_allocator::member, 1); }
            ...
            {
                node_alloc_traits::construct(bfm_allocator::member, boost::addressof(x->value()), v);
            }

            void construct_value(final_node_type* x, BOOST_RV_REF(Value) v)
            {
                node_alloc_traits::construct(bfm_allocator::member, boost::addressof(x->value()), boost::move(v));
            }

            BOOST_MULTI_INDEX_OVERLOADS_TO_VARTEMPL_EXTRA_ARG(
                void,
                construct_value,
                vartempl_construct_value_impl,
                final_node_type*,
                x)

            void destroy_value(final_node_type* x)
            {
                node_alloc_traits::destroy(bfm_allocator::member, boost::addressof(x->value()));
            }

            bool empty_() const { return node_count == 0; }

            size_type size_() const { return node_count; }

            size_type max_size_() const { return static_cast<size_type>(-1); }
            ...
            std::pair<final_node_type*, bool> insert_(const Value& v) { return insert_(v, detail::lvalue_tag()); }

            std::pair<final_node_type*, bool> insert_rv_(const Value& v) { return insert_(v, detail::rvalue_tag()); }
            ...
            std::pair<final_node_type*, bool> insert_ref_(T& t)
            {
                ...
                BOOST_TRY
                {
                    ...
                    BOOST_TRY
                    {
                        final_node_type* res = super::insert_(x->value(), x, detail::emplaced_tag());
                        if (res == x) {
                            ++node_count;
                            return std::pair<final_node_type*, bool>(res, true);
                        }
            ...
            std::pair<final_node_type*, bool> insert_ref_(const value_type& x) { return insert_(x); }

            std::pair<final_node_type*, bool> insert_ref_(value_type& x) { return insert_(x); }
            ...
            std::pair<final_node_type*, bool> emplace_(BOOST_MULTI_INDEX_FUNCTION_PARAM_PACK)
            {
                final_node_type* x = allocate_node();
                BOOST_TRY
                {
            ...
            template<typename Variant>
            std::pair<final_node_type*, bool> insert_(const Value& v, final_node_type* position, Variant variant)
            {
                final_node_type* x = 0;
            ...
            std::pair<final_node_type*, bool> insert_(const Value& v, final_node_type* position)
            {
                return insert_(v, position, detail::lvalue_tag());
            }

            std::pair<final_node_type*, bool> insert_rv_(const Value& v, final_node_type* position)
            {
                return insert_(v, position, detail::rvalue_tag());
            }

            template<typename T>
            std::pair<final_node_type*, bool> insert_ref_(T& t, final_node_type* position)
            {
                final_node_type* x = allocate_node();
                BOOST_TRY
                {
                    ...
                    BOOST_TRY
                    {
                        final_node_type* res = super::insert_(x->value(), position, x, detail::emplaced_tag());
                        if (res == x) {
                            ++node_count;
                            return std::pair<final_node_type*, bool>(res, true);
                        }
            ...
            std::pair<final_node_type*, bool> insert_ref_(const value_type& x, final_node_type* position)
            {
                return insert_(x, position);
            }

            std::pair<final_node_type*, bool> insert_ref_(value_type& x, final_node_type* position)
            {
                return insert_(x, position);
            }

            std::pair<final_node_type*, bool> insert_nh_(final_node_handle_type& nh, final_node_type* position)
            {
                if (!nh) {
                    return std::pair<final_node_type*, bool>(header(), false);
                }
            ...
            std::pair<final_node_type*, bool>
                emplace_hint_(final_node_type* position, BOOST_MULTI_INDEX_FUNCTION_PARAM_PACK)
            {
                final_node_type* x = allocate_node();
                BOOST_TRY
                {
            ...
            void delete_all_nodes_() { super::delete_all_nodes_(); }
            ...
            {
                swap_(x, boost::integral_constant<bool, node_alloc_traits::propagate_on_container_swap::value>());
            }

            void swap_(multi_index_container<Value, IndexSpecifierList, Allocator>& x, boost::true_type swap_allocators)
            {
            ...
            void
                swap_(multi_index_container<Value, IndexSpecifierList, Allocator>& x, boost::false_type swap_allocators)
            {
                std::swap(bfm_header::member, x.bfm_header::member);
                super::swap_(x, swap_allocators);
                std::swap(node_count, x.node_count);
            ...
            bool replace_(const Value& k, final_node_type* x) { return super::replace_(k, x, detail::lvalue_tag()); }

            bool replace_rv_(const Value& k, final_node_type* x) { return super::replace_(k, x, detail::rvalue_tag()); }
            ...
            bool modify_(Modifier& mod, Rollback& back_, final_node_type* x)
            {
                ...
                BOOST_CATCH(...) { BOOST_TRY { back_(const_cast<value_type&>(x->value()));
                if (!super::check_rollback_(x)) {
                    this->erase_(x);
                }
                BOOST_RETHROW;
            }
    ...
    void save(Archive& ar, const unsigned int version) const
    {
        ...
        for (iterator it = super::begin(), it_end = super::end(); it != it_end; ++it) {
            core::save_construct_data_adl(ar, boost::addressof(*it), value_version);
    ...
    void load(Archive& ar, const unsigned int version)
    {
        ...
        for (std::size_t n = 0; n < s; ++n) {
            ...
            std::pair<final_node_type*, bool> p = insert_rv_(value.get(), super::end().get_node());
            if (!p.second) {
                throw_exception(detail::bad_archive_exception());
            }
            ar.reset_object_address(boost::addressof(p.first->value()), boost::addressof(value.get()));
...
private:
    template<BOOST_MULTI_INDEX_TEMPLATE_PARAM_PACK>
    void vartempl_construct_value_impl(final_node_type* x, BOOST_MULTI_INDEX_FUNCTION_PARAM_PACK)
    {
...
typename nth_index<multi_index_container<Value, IndexSpecifierList, Allocator>, N>::type&
    get(multi_index_container<Value, IndexSpecifierList, Allocator>& m) BOOST_NOEXCEPT
{
    ...
    typedef typename nth_index<multi_index_container<Value, IndexSpecifierList, Allocator>, N>::type index_type;

    BOOST_STATIC_ASSERT(N >= 0 && N < mpl::size<BOOST_DEDUCED_TYPENAME multi_index_type::index_type_list>::type::value);

    return detail::converter<multi_index_type, index_type>::index(m);
}

template<int N, typename Value, typename IndexSpecifierList, typename Allocator>
const typename nth_index<multi_index_container<Value, IndexSpecifierList, Allocator>, N>::type&
...
typename ::boost::multi_index::index<multi_index_container<Value, IndexSpecifierList, Allocator>, Tag>::type&
    get(multi_index_container<Value, IndexSpecifierList, Allocator>& m) BOOST_NOEXCEPT
{
    typedef multi_index_container<Value, IndexSpecifierList, Allocator> multi_index_type;
    typedef typename ::boost::multi_index::index<multi_index_container<Value, IndexSpecifierList, Allocator>, Tag>::type
        index_type;
...
template<typename Tag, typename Value, typename IndexSpecifierList, typename Allocator>
const typename ::boost::multi_index::index<multi_index_container<Value, IndexSpecifierList, Allocator>, Tag>::type&
    get(const multi_index_container<Value, IndexSpecifierList, Allocator>& m) BOOST_NOEXCEPT
{
    typedef multi_index_container<Value, IndexSpecifierList, Allocator> multi_index_type;
    typedef typename ::boost::multi_index::index<multi_index_container<Value, IndexSpecifierList, Allocator>, Tag>::type
...
typename nth_index_iterator<multi_index_container<Value, IndexSpecifierList, Allocator>, N>::type
    project(multi_index_container<Value, IndexSpecifierList, Allocator>& m, IteratorType it)
{
    ...
    BOOST_STATIC_ASSERT(
        (mpl::contains<BOOST_DEDUCED_TYPENAME multi_index_type::iterator_type_list, IteratorType>::value));
#endif
    ...
    return detail::converter<multi_index_type, index_type>::iterator(
        m,
        static_cast<typename multi_index_type::final_node_type*>(it.get_node()));
}

template<int N, typename IteratorType, typename Value, typename IndexSpecifierList, typename Allocator>
typename nth_index_const_iterator<multi_index_container<Value, IndexSpecifierList, Allocator>, N>::type
    project(const multi_index_container<Value, IndexSpecifierList, Allocator>& m, IteratorType it)
{
    ...
    BOOST_STATIC_ASSERT(
        (mpl::contains<BOOST_DEDUCED_TYPENAME multi_index_type::iterator_type_list, IteratorType>::value ||
         mpl::contains<BOOST_DEDUCED_TYPENAME multi_index_type::const_iterator_type_list, IteratorType>::value));
#endif
...
typename index_iterator<multi_index_container<Value, IndexSpecifierList, Allocator>, Tag>::type
    project(multi_index_container<Value, IndexSpecifierList, Allocator>& m, IteratorType it)
{
    typedef multi_index_container<Value, IndexSpecifierList, Allocator> multi_index_type;
    typedef typename ::boost::multi_index::index<multi_index_type, Tag>::type index_type;
...
template<typename Tag, typename IteratorType, typename Value, typename IndexSpecifierList, typename Allocator>
typename index_const_iterator<multi_index_container<Value, IndexSpecifierList, Allocator>, Tag>::type
    project(const multi_index_container<Value, IndexSpecifierList, Allocator>& m, IteratorType it)
{
    typedef multi_index_container<Value, IndexSpecifierList, Allocator> multi_index_type;
    typedef typename ::boost::multi_index::index<multi_index_type, Tag>::type index_type;
