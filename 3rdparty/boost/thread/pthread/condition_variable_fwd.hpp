...
namespace boost {
    ...
    public:
        ...
        bool do_wait_until(unique_lock<mutex>& lock, detail::internal_platform_timepoint const& timeout);
    ...
    public:
        ...
        condition_variable()
        {
            ...
            if (res) {
                ...
                boost::throw_exception(thread_resource_error(
                    res,
                    "boost::condition_variable::condition_variable() constructor failed in pthread_cond_init"));
            }
        }
...
#define BOOST_THREAD_DEFINES_CONDITION_VARIABLE_NATIVE_HANDLE
        ...
        native_handle_type native_handle() { return &cond; }
