...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
        ...
        native_handle_type* native_handle() BOOST_NOEXCEPT { return &val_; }

        const native_handle_type* native_handle() const BOOST_NOEXCEPT { return &val_; }
    ...
    namespace detail {
        ...
        public:
            ...
            ~interruption_checker() BOOST_NOEXCEPT_IF(false) { unlock_if_locked(); }
        };
#endif
    }
