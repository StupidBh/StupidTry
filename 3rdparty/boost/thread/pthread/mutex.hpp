...
namespace boost {
    ...
    public:
        ...
        void unlock() BOOST_THREAD_RELEASE() { BOOST_VERIFY(!posix::pthread_mutex_unlock(&m)); }
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if (res2) {
                ...
                boost::throw_exception(
                    thread_resource_error(res2, "boost:: timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked = false;
#endif
        }
