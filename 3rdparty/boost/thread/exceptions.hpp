...
namespace boost {
    ...
    public:
        ...
        int native_error() const { return code().value(); }
    };
    ...
    class BOOST_SYMBOL_VISIBLE lock_error : public thread_exception {
    ...
    class BOOST_SYMBOL_VISIBLE thread_resource_error : public thread_exception {
        typedef thread_exception base_type;
    ...
    class BOOST_SYMBOL_VISIBLE unsupported_thread_option : public thread_exception {
        typedef thread_exception base_type;
    ...
    class BOOST_SYMBOL_VISIBLE invalid_thread_argument : public thread_exception {
        typedef thread_exception base_type;
    ...
    class BOOST_SYMBOL_VISIBLE thread_permission_error : public thread_exception {
        typedef thread_exception base_type;
