...
namespace boost {
    ...
    public:
         ...
         *
         * \b Synchronization: The completion of all the closures happen before the completion of the \c user_scheduler
         * destructor.
         */
        ~user_scheduler()
        {
        ...
        bool closed() { return work_queue.closed(); }
             ...
             * If invoked closure throws an exception the \c user_scheduler will call \c std::terminate, as is the case
             * with threads.
             *
