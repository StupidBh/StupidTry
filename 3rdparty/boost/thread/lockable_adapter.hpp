...
namespace boost {
    ...
    public:
        ...
        bool try_lock() const { return this->lockable().try_lock(); }
    };
    ...
    public:
        ...
        void lock_shared() const { this->lockable().lock_shared(); }

        bool try_lock_shared() const { return this->lockable().try_lock_shared(); }

        void unlock_shared() const { this->lockable().unlock_shared(); }
    ...
    public:
        ...
        void lock_upgrade() const { this->lockable().lock_upgrade(); }

        bool try_lock_upgrade() const { return this->lockable().try_lock_upgrade(); }

        void unlock_upgrade() const { this->lockable().unlock_upgrade(); }
        ...
        bool try_unlock_shared_and_lock() const { return this->lockable().try_unlock_shared_and_lock(); }
        ...
        void unlock_and_lock_shared() const { this->lockable().unlock_and_lock_shared(); }
        ...
        void unlock_and_lock_upgrade() const { this->lockable().unlock_and_lock_upgrade(); }

        void unlock_upgrade_and_lock() const { this->lockable().unlock_upgrade_and_lock(); }

        bool try_unlock_upgrade_and_lock() const { return this->lockable().try_unlock_upgrade_and_lock(); }
        ...
        void unlock_upgrade_and_lock_shared() const { this->lockable().unlock_upgrade_and_lock_shared(); }
    };
