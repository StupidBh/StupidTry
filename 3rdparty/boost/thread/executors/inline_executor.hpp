...
namespace boost {
    namespace executors {
        ...
        public:
             ...
             */
            bool closed(lock_guard<mutex>&) { return closed_; }
            ...
            bool closed()
            {
                 ...
                 * If invoked closure throws an exception the \c inline_executor will call \c std::terminate, as is the
                 * case with threads.
                 *
