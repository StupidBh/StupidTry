...
namespace boost {
    namespace executors {
        ...
        public:
             ...
             */
            bool try_executing_one() { return execute_one(/*wait:*/ false); }
        ...
        private:
            ...
            bool execute_one(bool wait)
            {
                work task;
                try {
                    queue_op_status status = wait ? work_queue.wait_pull(task) : work_queue.try_pull(task);
        ...
        public:
             ...
             *
             * \b Synchronization: The completion of all the closures happen before the completion of the \c
             * loop_executor destructor.
             */
            ~loop_executor()
            {
            ...
            /**
             * \b Requires: \c Closure is a model of \c Callable(void()) and a model of \c
             * CopyConstructible/MoveConstructible.
             *
             * \b Effects: The specified \c closure will be scheduled for execution at some point in the future.
             * If invoked closure throws an exception the \c loop_executor will call \c std::terminate, as is the case
             * with threads.
             *
             * \b Synchronization: completion of \c closure on a particular thread happens before destruction of
             * thread's thread local variables.
             *
             * \b Throws: \c sync_queue_is_closed if the thread pool is closed.
             * Whatever exception that can be throw while storing the closure.
             */
            void submit(BOOST_THREAD_RV_REF(work) closure) { work_queue.push(boost::move(closure)); }
            ...
            void submit(void (*closure)()) { submit(work(closure)); }
