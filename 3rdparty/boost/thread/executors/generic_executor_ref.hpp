...
namespace boost {
    namespace executors {
        ...
        public:
             ...
             *
             * \par Synchronization
             * Ccompletion of closure on a particular thread happens before destruction of thread's thread local
             * variables.
             *
             * \par Throws
             ...
             */
            void submit(BOOST_THREAD_RV_REF(work) closure) { ex.submit(boost::move(closure)); }
        ...
        public:
             ...
             * \par Effects
             * The specified closure will be scheduled for execution at some point in the future.
             * If invoked closure throws an exception the thread pool will call std::terminate, as is the case with
             * threads.
             *
             * \par Synchronization
             * Completion of closure on a particular thread happens before destruction of thread's thread local
             * variables.
             *
             * \par Throws
             * \c sync_queue_is_closed if the thread pool is closed.
