...
namespace boost {
    namespace executors {
        /// Wraps the reference to an executor and a function to make a work that submit the function using the
        /// executor.
        ...
        public:
            ...
            Scheduler& underlying_scheduler() { return sch; }

            void close() { is_closed = true; }

            bool closed() { return is_closed || sch.closed() || ex.closed(); }
        ...
        /// into an new @c Executor that submit the work using the referenced @c Executor at/after a specific
        /// time/duration respectively, using the referenced @Scheduler.
        template<class Scheduler, class Executor>
        ...
        public:
            ...
            bool closed() { return is_closed || sch.closed(); }
