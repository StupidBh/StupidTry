...
namespace boost {
    namespace executors {
        ...
        private:
            ...
            bool closed(lock_guard<mutex>&) const { return closed_; }
        ...
        public:
             ...
             * serial_executor_cont destructor.
             */
             ...
             * Throws: No.
             * Remark: A serial executor can not execute one of its pending tasks as the tasks depends on the other
             * tasks.
             */
            bool try_executing_one() { return false; }
                 ...
                 *
                 * \b Effects: The specified \c closure will be scheduled for execution after the last submitted closure
                 * finish. If the invoked closure throws an exception the \c serial_executor_cont will call \c
