    ...
    namespace executors {
        ...
        public:
            ...
            serial_executor(Executor& ex) :
                ex(ex),
                thr(&serial_executor::worker_thread, this)
            {
            }
             ...
             * If invoked closure throws an exception the \c serial_executor will call \c std::terminate, as is the case
             * with threads.
             *
