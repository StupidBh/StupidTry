...
namespace boost {
    namespace detail {
        ...
        inline T* heap_new(A1&& a1, A2&& a2, A3&& a3)
        {
            ...
            {
                T* const data =
                    new (heap_memory) T(static_cast<A1&&>(a1), static_cast<A2&&>(a2), static_cast<A3&&>(a3));
                return data;
            }
            BOOST_CATCH(...)
            {
        ...
        inline T* heap_new(A1&& a1, A2&& a2, A3&& a3, A4&& a4)
        {
            ...
            BOOST_TRY
            {
                T* const data = new (heap_memory)
                    T(static_cast<A1&&>(a1), static_cast<A2&&>(a2), static_cast<A3&&>(a3), static_cast<A4&&>(a4));
                return data;
            }
            BOOST_CATCH(...)
            {
        ...
        {
            void operator()(T* data) const { detail::heap_delete(data); }
        };
    }
}
