...
namespace boost {
    ...
    public:
        ...
        std::size_t get_stack_size() const BOOST_NOEXCEPT { return val_.stack_size; }
    ...
    namespace detail {
        ...
        struct BOOST_THREAD_DECL thread_data_base
        {
            ...
            thread_data_base() :
                ...
                ,
                interruption_handle(
                    create_anonymous_event(detail::win32::manual_reset_event, detail::win32::event_initially_reset)),
...
#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            void interrupt() { BOOST_VERIFY(winapi::SetEvent(interruption_handle) != 0); }
#endif
            ...
            // #ifndef BOOST_NO_EXCEPTIONS
            void make_ready_at_thread_exit(shared_ptr<shared_state_base> as) { async_states_.push_back(as); }
    ...
    namespace this_thread {
        ...
        bool BOOST_THREAD_DECL interruptible_wait(
            detail::win32::handle handle_to_wait_for,
        ...
        BOOST_SYMBOL_VISIBLE void sleep(TimeDuration const& rel_time)
        {
            interruptible_wait(
                ...
                detail::internal_platform_clock::now() + detail::platform_duration(rel_time));
        }
        ...
        void sleep_for(const chrono::duration<Rep, Period>& d)
        {
            interruptible_wait(
                detail::win32::invalid_handle_value,
                detail::internal_platform_clock::now() + detail::platform_duration(d));
        }
        ...
        namespace no_interruption_point {
            bool BOOST_THREAD_DECL non_interruptible_wait(
                detail::win32::handle handle_to_wait_for,
                detail::internal_platform_timepoint const& timeout);
            ...
            inline BOOST_SYMBOL_VISIBLE void sleep(system_time const& abs_time)
            {
                ...
                while (d > detail::platform_duration::zero()) {
                    ...
                    non_interruptible_wait(
                        detail::win32::invalid_handle_value,
                        detail::internal_platform_clock::now() + d);
                    d = ts - detail::real_platform_clock::now();
                }
            }
#endif
