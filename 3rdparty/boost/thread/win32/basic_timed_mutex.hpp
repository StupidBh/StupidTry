        ...
        public:
            ...
            bool timed_lock(Duration const& timeout)
            {
                const detail::mono_platform_timepoint t(
                    detail::mono_platform_clock::now() + detail::platform_duration(timeout));
            ...
            bool timed_lock(boost::xtime const& timeout) { return timed_lock(boost::system_time(timeout)); }
#endif
#ifdef BOOST_THREAD_USES_CHRONO
            ...
            void* get_event()
            {
                ...
                if (!current_event) {
                    void* const new_event =
                        win32::create_anonymous_event(win32::auto_reset_event, win32::event_initially_reset);
#ifdef BOOST_MSVC
    #pragma warning(push)
