...
namespace boost {
    namespace detail {
        namespace win32 {
            namespace detail {
                typedef ticks_type(BOOST_WINAPI_WINAPI_CC* gettickcount64_t)();
            }
    ...
    #else
                handle const res =
                    ::boost::winapi::CreateSemaphoreExW(0, initial_count, max_count, 0, 0, semaphore_all_access);
    #endif
#endif
                return res;
            }
            ...
            inline handle duplicate_handle(handle source)
            {
                ...
                handle new_handle = 0;
                bool const success = ::boost::winapi::DuplicateHandle(
                                         current_process,
                                         source,
                                         current_process,
                                         &new_handle,
            ...
            public:
                ...
                void swap(handle_manager& other) { std::swap(handle_to_manage, other.handle_to_manage); }
