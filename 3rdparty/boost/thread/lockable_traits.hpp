...
namespace boost {
...
#if defined(BOOST_NO_SFINAE) || BOOST_WORKAROUND(__IBMCPP__, BOOST_TESTED_AT(600)) || \
    BOOST_WORKAROUND(__SUNPRO_CC, BOOST_TESTED_AT(0x590))
        ...
        #define BOOST_THREAD_DEFINE_HAS_MEMBER_CALLED(member_name)                                        \
            ...
            struct has_member_lock<T, true>
            {
                ...
                BOOST_STATIC_CONSTANT(
                    bool,
                    value = sizeof(has_member_lock<T>::has_member(&T::lock)) == sizeof(true_type));
            };
            ...
            struct has_member_unlock<T, true>
            {
                ...
                BOOST_STATIC_CONSTANT(
                    bool,
                    value = sizeof(has_member_unlock<T>::has_member(&T::unlock)) == sizeof(true_type));
            };
            ...
            struct has_member_try_lock<T, true>
            {
                ...
                BOOST_STATIC_CONSTANT(
                    bool,
                    value = sizeof(has_member_try_lock<T>::has_member(&T::try_lock)) == sizeof(true_type));
            };
    #else
            ...
            template<typename T>
            struct has_member_lock<T, decltype(void(boost::declval<T&>().lock()))> : true_type
            {
            };
            ...
            template<typename T>
            struct has_member_unlock<T, decltype(void(boost::declval<T&>().unlock()))> : true_type
            {
            };
            ...
            template<typename T>
            struct has_member_try_lock<T, decltype(bool(boost::declval<T&>().try_lock()))> : true_type
            {
            };
    #endif
        ...
        struct is_basic_lockable
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = detail::has_member_lock<T>::value && detail::has_member_unlock<T>::value);
        };

        template<typename T>
        struct is_lockable
        {
            BOOST_STATIC_CONSTANT(bool, value = is_basic_lockable<T>::value && detail::has_member_try_lock<T>::value);
        };
        ...
        struct is_recursive_basic_lockable
        {
            BOOST_STATIC_CONSTANT(
                bool,
                value = is_basic_lockable<T>::value && is_recursive_mutex_sur_parolle<T>::value);
        };

        template<typename T>
        struct is_recursive_lockable
        {
            BOOST_STATIC_CONSTANT(bool, value = is_lockable<T>::value && is_recursive_mutex_sur_parolle<T>::value);
        };
    }
