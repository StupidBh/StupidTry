...
namespace boost {
    namespace thread_detail {
        ...
        struct default_barrier_reseter
        {
            ...
            default_barrier_reseter(default_barrier_reseter const& other) BOOST_NOEXCEPT : size_(other.size_) {}
            ...
            unsigned int operator()() { return size_; }
        };
        ...
        struct void_functor_barrier_reseter
        {
            ...
            void_functor_barrier_reseter(BOOST_THREAD_RV_REF(void_functor_barrier_reseter) other) BOOST_NOEXCEPT :
                size_(BOOST_THREAD_RV(other).size_),
                fct_(BOOST_THREAD_RV(other).fct_)
    ...
    public:
        ...
        explicit barrier(unsigned int count) :
            ...
            m_generation(0),
            fct_(BOOST_THREAD_MAKE_RV_REF(thread_detail::default_barrier_reseter(count)))
        {
        }
        ...
        barrier(
            ...
            m_count(check_counter(count)),
            m_generation(0),
            fct_(BOOST_THREAD_MAKE_RV_REF(thread_detail::void_functor_barrier_reseter(count, boost::move(funct))))
        {
        }
        ...
        barrier(
            ...
            m_count(check_counter(count)),
            m_generation(0),
            fct_(BOOST_THREAD_MAKE_RV_REF(thread_detail::void_functor_barrier_reseter(count, funct)))
        {
        }
        ...
        barrier(unsigned int count, void (*funct)()) :
            ...
            m_generation(0),
            fct_(
                funct ? BOOST_THREAD_MAKE_RV_REF(
                            thread_detail::size_completion_function(
                                BOOST_THREAD_MAKE_RV_REF(thread_detail::void_fct_ptr_barrier_reseter(count, funct))))
                      : BOOST_THREAD_MAKE_RV_REF(
                            thread_detail::size_completion_function(
                                BOOST_THREAD_MAKE_RV_REF(thread_detail::default_barrier_reseter(count)))))
        {
        }
        ...
        barrier(unsigned int count, unsigned int (*funct)()) :
            ...
            m_generation(0),
            fct_(
                funct ? BOOST_THREAD_MAKE_RV_REF(thread_detail::size_completion_function(funct))
                      : BOOST_THREAD_MAKE_RV_REF(
                            thread_detail::size_completion_function(
                                BOOST_THREAD_MAKE_RV_REF(thread_detail::default_barrier_reseter(count)))))
        {
