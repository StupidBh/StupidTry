...
namespace boost {
    namespace detail {
        struct counter
        {
            ...
            operator std::size_t&() { return value_; }
        ...
        {
            counter_is_not_zero(counter const& count) :
                count_(count)
            {
            }
        ...
        {
            counter_is_zero(counter const& count) :
                count_(count)
            {
            }
        ...
        struct not_equal
        {
            not_equal(std::size_t& x, std::size_t& y) :
                x_(x),
                y_(y)
            {
            }
