...
//  file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
    ...
    // to alleviate optimizer issues with regard to violation of the strict aliasing rules.
    ...
    #elif !defined(BOOST_THREAD_CHRONO_WINDOWS_API) && !defined(BOOST_THREAD_CHRONO_MAC_API) && \
        !defined(BOOST_THREAD_CHRONO_POSIX_API)
        ...
        #define BOOST_THREAD_VERIFY_PRECONDITION(EXPR, EX) \
            if (EXPR) {                                    \
                ...
                boost::throw_exception(EX)
        #define BOOST_THREAD_THROW_ELSE_RETURN(EX, RET) boost::throw_exception(EX)
    #else
        #define BOOST_THREAD_ASSERT_PRECONDITION(EXPR, EX)
        #define BOOST_THREAD_VERIFY_PRECONDITION(EXPR, EX) (void)(EXPR)
        #define BOOST_THREAD_THROW_ELSE_RETURN(EX, RET)    return (RET)
    #endif
    ...
    #if !defined BOOST_THREAD_DONT_USE_ATOMIC && !defined BOOST_THREAD_USES_ATOMIC
    ...
    // #define BOOST_THREAD_DONT_USE_ATOMIC
    ...
    #else
        // #elif ! defined BOOST_NO_CXX11_THREAD_LOCAL && ! defined BOOST_NO_THREAD_LOCAL && ! defined
        // BOOST_THREAD_NO_UINT32_PSEUDO_ATOMIC
        ...
        // PROVIDE_THREAD_EQ
        #if !defined BOOST_THREAD_DONT_PROVIDE_THREAD_EQ && !defined BOOST_THREAD_PROVIDES_THREAD_EQ
        ...
        #if !defined BOOST_THREAD_DONT_PROVIDE_ONCE_CXX11 && !defined BOOST_THREAD_PROVIDES_ONCE_CXX11
        ...
        // PROVIDE_FUTURE
        #if !defined BOOST_THREAD_DONT_PROVIDE_FUTURE && !defined BOOST_THREAD_PROVIDES_FUTURE
        ...
        // USE_MOVE
        #if !defined BOOST_THREAD_DONT_USE_MOVE && !defined BOOST_THREAD_USES_MOVE
    ...
    // deprecated since version 4
        ...
        // NESTED_LOCKS
        #if !defined BOOST_THREAD_PROVIDES_NESTED_LOCKS && !defined BOOST_THREAD_DONT_PROVIDE_NESTED_LOCKS
            #define BOOST_THREAD_PROVIDES_NESTED_LOCKS
        #endif

        // CONDITION
        #if !defined BOOST_THREAD_PROVIDES_CONDITION && !defined BOOST_THREAD_DONT_PROVIDE_CONDITION
            #define BOOST_THREAD_PROVIDES_CONDITION
        #endif

        // USE_DATETIME
        #if !defined BOOST_THREAD_DONT_USE_DATETIME && !defined BOOST_THREAD_USES_DATETIME
            #define BOOST_THREAD_USES_DATETIME
        #endif
    #endif
        ...
        // VARIADIC_THREAD
        #if !defined BOOST_THREAD_PROVIDES_VARIADIC_THREAD && !defined BOOST_THREAD_DONT_PROVIDE_VARIADIC_THREAD

            #if !defined(BOOST_NO_SFINAE_EXPR) && !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) &&                \
                !defined(BOOST_NO_CXX11_DECLTYPE) && !defined(BOOST_NO_CXX11_DECLTYPE_N3276) &&                 \
                !defined(BOOST_NO_CXX11_TRAILING_RESULT_TYPES) && !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) && \
        ...
        // FUTURE_CONTINUATION
        #if !defined BOOST_THREAD_PROVIDES_FUTURE_CONTINUATION && !defined BOOST_THREAD_DONT_PROVIDE_FUTURE_CONTINUATION
            #define BOOST_THREAD_PROVIDES_FUTURE_CONTINUATION
        #endif

        #if !defined BOOST_THREAD_PROVIDES_FUTURE_UNWRAP && !defined BOOST_THREAD_DONT_PROVIDE_FUTURE_UNWRAP
    ...
    // #define BOOST_THREAD_FUTURE_BLOCKING
        ...
        #if !defined BOOST_THREAD_PROVIDES_EXECUTORS && !defined BOOST_THREAD_DONT_PROVIDE_EXECUTORS
    ...
    // INTERRUPTIONS
    #if !defined BOOST_THREAD_PROVIDES_INTERRUPTIONS && !defined BOOST_THREAD_DONT_PROVIDE_INTERRUPTIONS
    ...
    // BOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN is defined if
    ...
    #else                                 // Use default
        #if defined(BOOST_THREAD_PLATFORM_WIN32)
            #if defined(BOOST_MSVC) || defined(BOOST_INTEL_WIN) || defined(__MINGW32__) || defined(MINGW32) || \
                defined(BOOST_MINGW32) || (defined(_MSC_VER) && defined(__clang__))
    ...
    //
        ...
        !defined(BOOST_THREAD_BUILD_LIB)
        //
