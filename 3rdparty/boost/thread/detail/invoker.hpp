...
namespace boost {
    ...
    !defined(BOOST_NO_CXX11_HDR_TUPLE)
        ...
        public:
            ...
            BOOST_SYMBOL_VISIBLE explicit invoker(BOOST_THREAD_FWD_REF(F) f, BOOST_THREAD_FWD_REF(As)... args) :
        ...
        private:
            ...
            result_type execute(tuple_indices<Indices...>)
            {
        ...
        public:
            ...
            template<class F, class... As>
            BOOST_SYMBOL_VISIBLE explicit invoker_ret(BOOST_THREAD_FWD_REF(F) f, BOOST_THREAD_FWD_REF(As)... args) :
                f_(boost::forward<F>(f), boost::forward<As>(args)...)
            {
            }

            BOOST_SYMBOL_VISIBLE
            invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) :
                f_(boost::move(BOOST_THREAD_RV(f).f_))
            {
            }
        ...
        template<
            class Fp,
            class Arg = tuples::null_type BOOST_PP_REPEAT(BOOST_THREAD_MAX_ARGS, BOOST_THREAD_ARG_DEF, ~)>
        class invoker;
        ...
        #define BOOST_THREAD_ASYNC_FUNCT(z, n, unused)                                                        \
            ...
            public:                                                                                           \
                ...
                BOOST_SYMBOL_VISIBLE explicit invoker(BOOST_THREAD_FWD_REF(F)                                 \
                                                          f BOOST_PP_REPEAT(n, BOOST_THREAD_FWD_REF_A, ~)) :  \
                    fp_(boost::forward<F>(f)) BOOST_PP_REPEAT(n, BOOST_THREAD_FORWARD_PARAM_A, ~)             \
                {                                                                                             \
                }                                                                                             \
                                                                                                              \
                BOOST_SYMBOL_VISIBLE                                                                          \
                invoker(BOOST_THREAD_RV_REF(invoker) x) :                                                     \
                    fp_(boost::move(x.fp_)) BOOST_PP_REPEAT(n, BOOST_THREAD_MOVE_RHS_PARAM, ~)                \
                {                                                                                             \
                }                                                                                             \
                                                                                                              \
                result_type operator()()                                                                      \
                {                                                                                             \
                    return detail::invoke(boost::move(fp_) BOOST_PP_REPEAT(n, BOOST_THREAD_MOVE_DCL, ~));     \
                }                                                                                             \
            };                                                                                                \
                                                                                                              \
            template<class R BOOST_PP_COMMA_IF(n) BOOST_PP_ENUM_PARAMS(n, class Arg)>                         \
            class invoker<R (*)(BOOST_PP_REPEAT(n, BOOST_THREAD_RV_REF_ARG_T, ~)) BOOST_PP_COMMA_IF(n)        \
            ...
            public:                                                                                           \
                ...
                BOOST_SYMBOL_VISIBLE explicit invoker(R2 (*f)(BOOST_PP_REPEAT(n, BOOST_THREAD_RV_REF_A_T, ~)) \
                                                          BOOST_PP_REPEAT(n, BOOST_THREAD_FWD_REF_A, ~)) :    \
                    fp_(f) BOOST_PP_REPEAT(n, BOOST_THREAD_FORWARD_PARAM_A, ~)                                \
                {                                                                                             \
                }                                                                                             \
                                                                                                              \
                BOOST_SYMBOL_VISIBLE                                                                          \
                invoker(BOOST_THREAD_RV_REF(invoker) x) :                                                     \
                    fp_(x.fp_) BOOST_PP_REPEAT(n, BOOST_THREAD_MOVE_RHS_PARAM, ~)                             \
                {                                                                                             \
                }                                                                                             \
                                                                                                              \
                result_type operator()() { return fp_(BOOST_PP_REPEAT(n, BOOST_THREAD_MOVE_DCL_T, ~)); }      \
            };
        ...
        template<
            class Fp,
            class T0 = tuples::null_type,
            class T1 = tuples::null_type,
            class T2 = tuples::null_type,
            class T3 = tuples::null_type,
            class T4 = tuples::null_type,
            class T5 = tuples::null_type,
            class T6 = tuples::null_type,
            class T7 = tuples::null_type,
            class T8 = tuples::null_type,
            class T9 = tuples::null_type>
        class invoker;

        template<class Fp, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8>
        ...
        public:
            ...
            result_type operator()()
            {
                return detail::invoke(boost::move(fp_), boost::move(v0_), boost::move(v1_), boost::move(v2_));
            }
        };
        ...
        public:
            ...
            BOOST_SYMBOL_VISIBLE
            explicit invoker(BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(T0) a0, BOOST_THREAD_RV_REF(T1) a1) :
                fp_(boost::move(f)),
                v0_(boost::move(a0)),
                v1_(boost::move(a1))
            {
            ...
            result_type operator()() { return detail::invoke(boost::move(fp_), boost::move(v0_), boost::move(v1_)); }
        };
        ...
        public:
            ...
            BOOST_SYMBOL_VISIBLE
            explicit invoker(BOOST_THREAD_FWD_REF(Fp) f, BOOST_THREAD_RV_REF(T0) a0) :
                fp_(boost::move(f)),
                v0_(boost::move(a0))
            {
            }
            ...
            result_type operator()() { return detail::invoke(boost::move(fp_), boost::move(v0_)); }
        };
        ...
        public:
            ...
            result_type operator()() { return fp_(); }
        };
