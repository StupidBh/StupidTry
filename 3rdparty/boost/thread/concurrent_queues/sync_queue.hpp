...
namespace boost {
    namespace concurrent {
        ...
        class sync_queue : public detail::sync_queue_base<ValueType, Container> {
        ...
        template<class ValueType, class Container>
        queue_op_status
            sync_queue<ValueType, Container>::try_push(BOOST_THREAD_RV_REF(ValueType) elem, unique_lock<mutex>& lk)
        {
            if (super::closed(lk)) {
                return queue_op_status::closed;
            }
        ...
        template<class ValueType, class Container>
        queue_op_status
            sync_queue<ValueType, Container>::wait_push(BOOST_THREAD_RV_REF(ValueType) elem, unique_lock<mutex>& lk)
        {
            if (super::closed(lk)) {
                return queue_op_status::closed;
            }
        ...
        template<class ValueType, class Container>
        sync_queue<ValueType, Container>&
            operator<<(sync_queue<ValueType, Container>& sbq, BOOST_THREAD_RV_REF(ValueType) elem)
        {
