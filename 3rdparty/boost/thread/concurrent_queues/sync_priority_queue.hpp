...
namespace boost {
    namespace detail {
        ...
        template<class Type, class Container = csbl::vector<Type>, class Compare = std::less<Type>>
        ...
        public:
            ...
            Type const& top() const { return _elements.front(); }
        };
    }
    ...
    namespace concurrent {
        ...
        class sync_priority_queue :
            ...
            typedef detail::sync_queue_base<ValueType, boost::detail::priority_queue<ValueType, Container, Compare>>
                super;
        ...
        template<class T, class Cont, class Cmp>
        template<class Rep, class Period>
        queue_op_status sync_priority_queue<T, Cont, Cmp>::pull_for(const chrono::duration<Rep, Period>& dura, T& elem)
        {
        ...
        //////////////////////
        template<class T, class Container, class Cmp>
        queue_op_status sync_priority_queue<T, Container, Cmp>::try_pull(unique_lock<mutex>& lk, T& elem)
        {
            if (super::empty(lk)) {
                if (super::closed(lk)) {
                    return queue_op_status::closed;
        ...
        template<class T, class Container, class Cmp>
        queue_op_status sync_priority_queue<T, Container, Cmp>::try_pull(lock_guard<mutex>& lk, T& elem)
        {
            if (super::empty(lk)) {
                if (super::closed(lk)) {
                    return queue_op_status::closed;
        ...
        template<class T, class Container, class Cmp>
        queue_op_status sync_priority_queue<T, Container, Cmp>::try_pull(T& elem)
        {
            lock_guard<mutex> lk(super::mtx_);
