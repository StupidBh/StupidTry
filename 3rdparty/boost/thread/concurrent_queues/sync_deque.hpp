...
namespace boost {
    namespace concurrent {
        ...
        class sync_deque : public detail::sync_queue_base<ValueType, Container> {
        ...
        template<class ValueType, class Container>
        queue_op_status
            sync_deque<ValueType, Container>::try_push_back(BOOST_THREAD_RV_REF(ValueType) elem, unique_lock<mutex>& lk)
        {
            if (super::closed(lk)) {
                return queue_op_status::closed;
            }
        ...
        template<class ValueType, class Container>
        queue_op_status sync_deque<ValueType, Container>::wait_push_back(
        ...
        template<class ValueType, class Container>
        sync_deque<ValueType, Container>&
            operator<<(sync_deque<ValueType, Container>& sbq, BOOST_THREAD_RV_REF(ValueType) elem)
        {
