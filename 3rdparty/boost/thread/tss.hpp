...
namespace boost {
    namespace detail {
        ...
        BOOST_THREAD_DECL void set_tss_data(
            void const* key,
            detail::thread::cleanup_caller_t caller,
            detail::thread::cleanup_func_t func,
            void* tss_data,
    ...
    private:
        ...
        static void default_deleter(T* data) { delete data; }
    ...
    public:
        ...
        ~thread_specific_ptr() { detail::set_tss_data(this, 0, 0, 0, true); }

        T* get() const { return static_cast<T*>(detail::get_tss_data(this)); }
