...
namespace boost {
    ...
    public:
        ...
        void lock_shared() { this->mtx().lock_shared(); }

        bool try_lock_shared() { return this->mtx().try_lock_shared(); }

        void unlock_shared() { this->mtx().unlock_shared(); }
    ...
    public:
        ...
        void lock_upgrade() { this->mtx().lock_upgrade(); }

        bool try_lock_upgrade() { return this->mtx().try_lock_upgrade(); }

        void unlock_upgrade() { this->mtx().unlock_upgrade(); }
        ...
        bool try_unlock_shared_and_lock() { return this->mtx().try_unlock_shared_and_lock(); }
        ...
        void unlock_and_lock_shared() { this->mtx().unlock_and_lock_shared(); }

        bool try_unlock_shared_and_lock_upgrade() { return this->mtx().try_unlock_shared_and_lock_upgrade(); }
        ...
        void unlock_and_lock_upgrade() { this->mtx().unlock_and_lock_upgrade(); }

        void unlock_upgrade_and_lock() { this->mtx().unlock_upgrade_and_lock(); }

        bool try_unlock_upgrade_and_lock() { return this->mtx().try_unlock_upgrade_and_lock(); }
        ...
        void unlock_upgrade_and_lock_shared() { this->mtx().unlock_upgrade_and_lock_shared(); }
    };
