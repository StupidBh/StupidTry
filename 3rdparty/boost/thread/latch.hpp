...
namespace boost {
    ...
    public:
        ...
        cv_status wait_for(const chrono::duration<Rep, Period>& rel_time)
        {
            ...
            std::size_t generation(generation_);
            return cond_.wait_for(lk, rel_time, detail::not_equal(generation, generation_)) ? cv_status::no_timeout
                                                                                            : cv_status::timeout;
        }
        ...
        cv_status wait_until(const chrono::time_point<Clock, Duration>& abs_time)
        {
            ...
            std::size_t generation(generation_);
            return cond_.wait_until(lk, abs_time, detail::not_equal(generation, generation_)) ? cv_status::no_timeout
                                                                                              : cv_status::timeout;
        }
