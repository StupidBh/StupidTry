...
namespace boost {
    namespace typeindex {
        ...
        private:
            /// @cond
            BOOST_CXX14_CONSTEXPR const Derived& derived() const noexcept { return *static_cast<Derived const*>(this); }
        ...
        public:
            ...
            inline const char* name() const noexcept { return derived().raw_name(); }
            ...
            inline std::string pretty_name() const { return derived().name(); }
            ...
            /// \note Derived class header \b must include <boost/container_hash/hash.hpp>, \b unless this function is
            /// redefined in Derived class to not use boost::hash_range().
        ...
        protected:
            ...
            /// boost::typeindex::type_id() will call this method, if Derived has same type as
            /// boost::typeindex::type_index.
            ///
            /// \b Override: This function \b may be redefined and made public in Derived class. Overrides \b must not
            /// throw. Overrides \b must remove const, volatile && and & modifiers from T.
            ...
            /// This is a factory method that is used to create instances of Derived classes.
            /// boost::typeindex::type_id_with_cvr() will call this method, if Derived has same type as
            /// boost::typeindex::type_index.
            ///
            /// \b Override: This function \b may be redefined and made public in Derived class. Overrides \b must not
            /// throw. Overrides \b must \b not remove const, volatile && and & modifiers from T.
            /// \tparam T Type for which type_index must be created.
            /// \return type_index for type T.
            template<class T>
            ...
            /// This is a factory method that is used to create instances of Derived classes.
            /// boost::typeindex::type_id_runtime(const T&) will call this method, if Derived has same type as
            /// boost::typeindex::type_index.
            ///
        ...
        /// @cond
        template<class Derived, class TypeInfo>
        BOOST_CXX14_CONSTEXPR inline bool operator==(
            const type_index_facade<Derived, TypeInfo>& lhs,
            const type_index_facade<Derived, TypeInfo>& rhs) noexcept
        {
        ...
        inline std::basic_ostream<CharT, TriatT>&
