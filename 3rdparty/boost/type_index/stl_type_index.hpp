...
namespace boost {
    ...
    #undef BOOST_TYPE_INDEX_IMPL_HAS_CXXABI
        ...
        inline std::string stl_type_index::pretty_name() const
        {
            ...
            // In case of GCC and Clang (on non-Windows systems) name() returns mangled name and demangle() undecorates
            // it.
            ...
            if (len > cvr_saver_name_len) {
                ...
                if (b) {
                    ...
                    // Trim everything till '<'. In modules the name could be
                    // boost::typeindex::detail::cvr_saver@boost.type_index<
    ...
    #if (defined(__GNUC__) && (__GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ < 5))) || defined(_AIX) || \
