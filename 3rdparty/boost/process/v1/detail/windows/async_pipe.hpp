                ...
                namespace windows {
                    ...
                    public:
                        ...
                        async_pipe(boost::asio::io_context& ios) :
                            async_pipe(ios, ios, make_pipe_name(), true)
                        {
                        }
                        ...
                        {
                            return const_cast<boost::asio::windows::stream_handle&>(_source).native_handle();
                        }

                        native_handle_type native_sink() const
                        {
                            return const_cast<boost::asio::windows::stream_handle&>(_sink).native_handle();
                        }
                        ...
                        _sink(ios_sink)
                    {
                        ...
                        ::boost::winapi::HANDLE_ source = ::boost::winapi::create_named_pipe(
                            ...
                            0,
                            private_ ? 1 : ::boost::winapi::PIPE_UNLIMITED_INSTANCES_,
                            8192,
                            8192,
                            0,
                            nullptr);
