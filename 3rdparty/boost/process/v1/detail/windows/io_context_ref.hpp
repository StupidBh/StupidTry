                    ...
                    struct io_context_ref : boost::process::v1::detail::handler_base
                    {
                        ...
                        void on_success(Executor& exec) const
                        {
                            ...
                            if (!::boost::winapi::DuplicateHandle(
                                ...
                                exec.set_error(::boost::process::v1::detail::get_last_error(), "Duplicate Pipe Failed");
                            }
                            ...
                            if (::boost::winapi::GetExitCodeProcess(process_handle, &code) && code != still_active) {
                        ...
                        struct wait_handler
                        {
                            ...
                            wait_handler(
                                ...
                                handle(new boost::asio::windows::object_handle(
                                    asio::prefer(ios.get_executor(), asio::execution::outstanding_work.tracked),
                                    handle)),
