            ...
            namespace detail {
                namespace windows {
                    ...
                    inline void wait(child_handle& p, int& exit_code, std::error_code& ec) noexcept
                    {
                        ...
                        if (::boost::winapi::WaitForSingleObject(p.process_handle(), ::boost::winapi::infinite) ==
                            ::boost::winapi::wait_failed) {
                        ...
                        std::error_code& ec) noexcept
                    {
                        ...
                        wait_code = ::boost::winapi::WaitForSingleObject(
                            p.process_handle(),
                    ...
                    template<class Rep, class Period>
                    inline bool
                        wait_for(child_handle& p, int& exit_code, const std::chrono::duration<Rep, Period>& rel_time)
                    {
                        std::error_code ec;
