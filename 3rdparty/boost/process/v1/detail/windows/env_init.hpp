            ...
            namespace detail {
                namespace windows {
                    ...
                    struct env_init : public ::boost::process::v1::detail::handler_base
                    {
                        ...
                        env_init(boost::process::v1::basic_environment<Char>&& env) :
                            env(std::move(env)) {};
                        env_init(const boost::process::v1::basic_environment<Char>& env) :
                            env(env) {};
                        ...
                        void on_setup(WindowsExecutor& exec) const
                        {
                            ...
                            if (*e == null_char<char>()) {
                                exec.set_error(
                                    std::error_code(::boost::winapi::ERROR_BAD_ENVIRONMENT_, std::system_category()),
                                    "Empty Environment");
                            }
