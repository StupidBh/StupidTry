            ...
            namespace detail {
                namespace windows {
                    namespace workaround {
                        ...
                        constexpr static OBJECT_INFORMATION_CLASS_ ObjectTypeInformation =
                        ...
                        extern "C"
                        {
                            ...
                            constexpr static SYSTEM_INFORMATION_CLASS_ SystemHandleInformation_ =
                                static_cast<SYSTEM_INFORMATION_CLASS_>(16);
                        ...
                        // this import workaround is to keep it a header-only library. and enums cannot be imported from
                        // the winapi.
                            ...
                            ::boost::winapi::PULONG_ ReturnLength)
                        {
                            ...
                            static nt_system_query_information_p f = reinterpret_cast<nt_system_query_information_p>(
                                ::boost::winapi::get_proc_address(h, "NtQuerySystemInformation"));

                            return (
                                *f)(SystemInformationClass, SystemInformation, SystemInformationLength, ReturnLength);
                        }
                        ...
                        {
                            static ::boost::winapi::HMODULE_ h = ::boost::winapi::get_module_handle(L"Ntdll.dll");
                            static nt_query_object_p f = reinterpret_cast<nt_query_object_p>(
                                ::boost::winapi::get_proc_address(h, "NtQueryObject"));
