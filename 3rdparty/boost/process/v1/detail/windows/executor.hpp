        ...
        BOOST_PROCESS_V1_INLINE namespace v1
        {
            namespace detail {
                namespace windows {
                    ...
                    template<typename CharType>
                    struct startup_info_ex;

    #if !defined(BOOST_NO_ANSI_APIS)
                    template<>
                    struct startup_info_ex<char>
                    {
                    ...
                    template<>
                    struct startup_info_ex<wchar_t>
                    {
                    ...
                    struct startup_info_impl
                    {
                        ...
                        startup_info_ex_t startup_info_ex { startup_info_t { sizeof(startup_info_t),
                                                                             nullptr,
                                                                             nullptr,
                                                                             nullptr,
                                                                             0,
                    ...
                    struct startup_info_impl
                    {
                        ...
                        ::boost::winapi::DWORD_ creation_flags = 0;
                        startup_info_t startup_info { sizeof(startup_info_t),
                                                      nullptr,
                                                      nullptr,
                                                      nullptr,
                                                      0,
                    ...
                    public:
                        ...
                        child operator()()
                        {
                            ...
                            // NOTE: The non-cast cmd-line string can only be modified by the wchar_t variant which is
                            // currently disabled.
                            ...
                            if (err_code != 0) {
                                ...
                                set_error(::boost::process::v1::detail::get_last_error(), " CreateProcess failed");
                            }
