            ...
            namespace detail {
                namespace windows {
                    ...
                    inline bool break_away_enabled(::boost::winapi::HANDLE_ h)
                    {
                        ...
                        return (info.BasicLimitInformation.LimitFlags & workaround::JOB_OBJECT_LIMIT_BREAKAWAY_OK_) !=
                               0;
                    }
                    ...
                    inline void
                        associate_completion_port(::boost::winapi::HANDLE_ job, ::boost::winapi::HANDLE_ io_port)
                    {
                    ...
                    struct group_handle
                    {
                        ...
                        group_handle() :
                            group_handle(::boost::winapi::CreateJobObjectW(nullptr, nullptr))
                        {
                        }
                        ...
                        bool valid() const { return _job_object != nullptr; }
                    };
