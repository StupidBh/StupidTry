            ...
            namespace detail {
                namespace posix {
                        ...
                        std::error_code& ec) noexcept
                    {
                        ...
                        // I need to set the signal, because it might be ignore / default, in which case sigwait might
                        // not work.
                        ...
                        auto get_timespec = [](const Duration& dur) {
                            ...
                            ts.tv_nsec =
                                std::chrono::duration_cast<std::chrono::nanoseconds>(dur).count() % 1'000'000'000;
                            return ts;
                        };
                        ...
                        do {
                            ...
                            if ((sig_ == SIGCHLD) && (old_sig.sa_handler != SIG_DFL) &&
                                (old_sig.sa_handler != SIG_IGN)) {
                                old_sig.sa_handler(ret);
                            }
