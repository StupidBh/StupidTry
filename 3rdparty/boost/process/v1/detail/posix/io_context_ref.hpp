            ...
            namespace detail {
                namespace posix {
                    ...
                    struct on_exit_handler_transformer
                    {
                        ...
                        on_exit_handler_transformer(Executor& exec) :
                            exec(exec)
                        {
                        }
                    ...
                    struct io_context_ref : handler_base_ext
                    {
                        ...
                        void on_success(Executor& exec)
                        {
                            ...
                            auto asyncs = boost::fusion::filter_if<
                                is_async_handler<typename std::remove_reference<boost::mpl::_>::type>>(exec.seq);
                        ...
                        { /*ios.notify_fork(boost::asio::io_context::fork_prepare);*/
                        }

                        template<typename Executor>
                        void on_exec_setup(Executor&) const
                        { /*ios.notify_fork(boost::asio::io_context::fork_child);*/
                        }
                    ...
                    private:
                        ...
                        boost::process::v1::detail::posix::sigchld_service& sigchld_service =
                            boost::asio::use_service<boost::process::v1::detail::posix::sigchld_service>(ios);
                    };
