            ...
            namespace detail {
                namespace posix {
                        ...
                        std::error_code& ec) noexcept
                    {
                        ...
                        sleep_interval.tv_nsec = 100'000'000;
                        ...
                        while (!(timed_out = (Clock::now() > time_out))) {
                            ...
                            // we can wait, because unlike in the wait_for_exit, we have no race condition regarding eh
                            // exit code.
                    ...
                    template<class Rep, class Period>
                    inline bool
                        wait_for(const group_handle& p, const std::chrono::duration<Rep, Period>& rel_time) noexcept
                    {
                        std::error_code ec;
