...
namespace boost {
    namespace this_process {
        ...
        /**
         * Get a snapshot of all handles of the process (i.e. file descriptors on posix and handles on windows) of the
         * current process.
         *
         * \note This function might not work on certain posix systems.
         *
         * \note On Windows version older than windows 8 this function will iterate all the system handles, meaning it
         * might be quite slow.
         *
         * \warning This functionality is utterly prone to race conditions, since other threads might open or close
         * handles.
         *
        ...
        /** Determines if a given handle is a a stream-handle, i.e. any handle that can be used with read and write
         * functions. Stream handles include pipes, regular files and sockets.
         *
    ...
    namespace process {
        ...
        namespace v1 {
            ...
            /**
             * The limit_handles property sets all properties to be inherited only explicitly. It closes all unused
             * file-descriptors on posix after the fork and removes the inherit flags on windows.
             *
             ...
             * \endcode
             *
             * Since limit also closes the standard handles unless they are explicitly redirected they can be ignored by
             * `limit_handles` in the following way.
             *
             * \code{.cpp}
