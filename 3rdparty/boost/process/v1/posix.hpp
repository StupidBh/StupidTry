 ...
 *  \endxmlonly
 *   \warning Only available on posix. See the documentation of
    ...
    namespace process {
        BOOST_PROCESS_V1_INLINE namespace v1
        {
            ...
            namespace posix {
                 ...
                 *
                 * It provides the functions `bind`, which implements
                 * [dup2](http://pubs.opengroup.org/onlinepubs/9699919799/functions/dup.html) and
                ...
                assigned a custom handler. A custom handler must have the type `sighandler_t`and can be assigned with
                ...
                \warning @ref spawn will automatically use `sig.ign()`, which will override if you pass a custom
                handler.
                 */
                constexpr ::boost::process::v1::detail::posix::sig_ sig;
                /** This property will replace the usage of
                 [fork](http://pubs.opengroup.org/onlinepubs/9699919799/functions/fork.html) by
                 [vfork](http://pubs.opengroup.org/onlinepubs/009695399/functions/vfork.html).
