        ...
        BOOST_PROCESS_V1_INLINE namespace v1
        {
            namespace detail {
                ...
                struct set_on_error : ::boost::process::v1::detail::api::handler_base_ext
                {
                    ...
                    explicit set_on_error(std::error_code& ec) :
                        ec_(ec)
                    {
                    }
                ...
                template<>
                struct is_error_handler<set_on_error> : std::true_type
                {
                };

                template<>
                struct is_error_handler<throw_on_error_> : std::true_type
                {
                };

                template<>
                struct is_error_handler<ignore_error_> : std::true_type
                {
                };
                ...
                struct has_error_handler
                {
                    ...
                    typedef typename has_error_handler_impl<
                        ...
                        typename boost::fusion::result_of::end<vector_type>::type>::type type;
                };
