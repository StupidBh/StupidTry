        ...
        BOOST_PROCESS_V1_INLINE namespace v1
        {
            namespace detail {
                ...
                struct async_system_handler : ::boost::process::v1::detail::api::async_handler
                {
                    ...
                    async_system_handler(boost::asio::io_context& ios, ExitHandler_&& exit_handler) :
                        ios(ios),
                        handler(std::forward<ExitHandler_>(exit_handler))
                    {
                    }
                    ...
                    void on_error(Exec&, const std::error_code& ec)
                    {
                        ...
                        boost::asio::post(ios.get_executor(), [h, ec]() mutable {
...
but is similar to the asynchronous functions in
[boost.asio](http://www.boost.org/doc/libs/release/doc/html/boost_asio.html)

It uses [asio::async_result](http://www.boost.org/doc/libs/release/doc/html/boost_asio/reference/async_result.html) to
determine the return value (from the second parameter, `exit_handler`).
...
*/
            ...
            inline boost::process::v1::detail::dummy async_system(
                boost::asio::io_context & ios,
            ...
            namespace detail {
                struct async_system_init_op
                {
                    ...
                    {
                        detail::async_system_handler<typename std::decay<Handler>::type> async_h {
                            ios,
