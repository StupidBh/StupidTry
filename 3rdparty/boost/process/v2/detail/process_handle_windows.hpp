...
namespace detail {
    ...
    struct basic_process_handle_win
    {
        ...
        native_handle_type native_handle() { return handle_.native_handle(); }

        pid_type id() const { return pid_; }

        void terminate_if_running(error_code&) { detail::terminate_if_running_(handle_.native_handle()); }

        void terminate_if_running() { detail::terminate_if_running_(handle_.native_handle()); }
        ...
        void suspend(error_code& ec) { detail::suspend_(handle_.native_handle(), ec); }
        ...
        void resume(error_code& ec) { detail::resume_(handle_.native_handle(), ec); }
    ...
    private:
        ...
        struct async_wait_op_
        {
            ...
            void operator()(Self&& self)
            {
                ...
                auto& h = handle;
                if (sl.is_connected()) {
                    sl.assign([&h](asio::cancellation_type ct) {
                        error_code ec;
                        h.cancel(ec);
                    });
                }
    ...
    public:
        ...
        auto async_wait(
            ...
            -> decltype(net::async_compose<WaitHandler, void(error_code)>(
                async_wait_op_ { handle_, exit_code },
                handler,
                handle_))
        {
