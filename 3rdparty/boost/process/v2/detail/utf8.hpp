...
namespace detail {
    ...
    BOOST_PROCESS_V2_DECL std::size_t
        convert_to_utf8(const wchar_t* in, std::size_t size, char* out, std::size_t max_size, error_code& ec);
    BOOST_PROCESS_V2_DECL std::size_t
        convert_to_wide(const char* in, std::size_t size, wchar_t* out, std::size_t max_size, error_code& ec);
    ...
    std::basic_string<CharOut, Traits, Allocator>
        conv_string(const CharIn* data, std::size_t size, const Allocator allocator = Allocator {})
    {
    ...
    std::basic_string<CharOut, Traits, Allocator>
        conv_string(const wchar_t* data, std::size_t size, const Allocator allocator = Allocator {})
    {
        error_code ec;
    ...
    std::basic_string<CharOut, Traits, Allocator>
        conv_string(const char* data, std::size_t size, const Allocator allocator = Allocator {})
    {
        error_code ec;
