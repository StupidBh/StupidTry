...
namespace environment {
    ...
    struct key_view
    {
        ...
        void swap(key_view& other) noexcept { std::swap(value_, other.value_); }
        ...
        std::basic_string<CharT, Traits, Alloc> basic_string(const Alloc& alloc = Alloc()) const
        {
        ...
        string_type native_string() const { return basic_string<char_type, key_char_traits<char_type>>(); }
        ...
        friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& os, const key_view& p)
        {
        ...
        template<class CharT, class Traits>
        friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, key_view& p)
        {
    ...
    struct value_view
    {
        ...
        void swap(value_view& other) noexcept { std::swap(value_, other.value_); }
        ...
        string_type native_string() const { return basic_string<char_type, value_char_traits<char_type>>(); }
        ...
        template<class CharT, class Traits>
        friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& os, const value_view& p)
        {
            os << BOOST_PROCESS_V2_NAMESPACE::quoted(p.basic_string<CharT, Traits>());
            return os;
        }
        ...
        template<class CharT, class Traits>
        friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, value_view& p)
        {
            std::basic_string<CharT, Traits> t;
            is >> BOOST_PROCESS_V2_NAMESPACE::quoted(t);
            p = t;
    ...
    struct key_value_pair_view
    {
        ...
        void swap(key_value_pair_view& other) noexcept { std::swap(value_, other.value_); }
        ...
        int compare(const string_type& str) const { return compare(key_value_pair_view(str)); }
        ...
        int compare(const value_type* s) const { return compare(key_value_pair_view(s)); }
        ...
        string_type native_string() const { return basic_string<char_type>(); }
        ...
        inline auto get() const -> typename conditional<
            Idx == 0u,
            BOOST_PROCESS_V2_NAMESPACE::environment::key_view,
            BOOST_PROCESS_V2_NAMESPACE::environment::value_view>::type;

        const value_type* c_str() const noexcept { return value_.data(); }
    ...
    struct key
    {
        ...
        key(const Source& source,
            ...
            value_(
                BOOST_PROCESS_V2_NAMESPACE::detail::conv_string<char_type, traits_type>(source.data(), source.size()))
        {
        }
        ...
        key(InputIt first, InputIt last) :
            key(std::basic_string<typename std::iterator_traits<typename std::decay<InputIt>::type>::value_type>(
                first,
                last))
        {
        }
        ...
        {
            return assign(
                std::basic_string<typename std::iterator_traits<typename std::decay<InputIt>::type>::value_type>(
                    first,
                    last));
        }
        ...
        void swap(key& other) noexcept { std::swap(value_, other.value_); }
        ...
        const string_type& native_string() const { return value_; }
        ...
        template<class CharT, class Traits>
        friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& os, const key& p)
        {
            os << BOOST_PROCESS_V2_NAMESPACE::quoted(p.basic_string<CharT, Traits>());
            return os;
        }
        ...
        template<class CharT, class Traits>
        friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, key& p)
        {
            std::basic_string<CharT, Traits> t;
            is >> BOOST_PROCESS_V2_NAMESPACE::quoted(t);
            p = t;
    ...
    typename std::enable_if<
        ...
        bool>::type operator==(const T& l, const U& r)
    {
        return key_view(l) == key_view(r);
    }
    ...
    struct value
    {
        ...
        void push_back(const value& sv) { (value_ += delimiter) += sv; }
        ...
        template<class CharT, class Traits>
        friend std::basic_ostream<CharT, Traits>& operator<<(std::basic_ostream<CharT, Traits>& os, const value& p)
        {
            os << BOOST_PROCESS_V2_NAMESPACE::quoted(p.basic_string<CharT, Traits>());
            return os;
        }
        ...
        template<class CharT, class Traits>
        friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, value& p)
        {
            std::basic_string<CharT, Traits> t;
            is >> BOOST_PROCESS_V2_NAMESPACE::quoted(t);
            p = t;
    ...
    typename std::enable_if<
        ...
        bool>::type operator==(const T& l, const U& r)
    {
        return value_view(l) == value_view(r);
    }
    ...
    struct key_value_pair
    {
        ...
        key_value_pair(key_view key, value_view value) :
            value_(
                key.basic_string<char_type, traits_type>() + equality_sign +
        ...
        {
            const auto sz = std::accumulate(
                values.begin(),
                values.end(),
                key.size(),
                [](std::size_t sz, const basic_string_view<char_type>& str) { return sz + str.size() + 1; });
    ...
    key_value_pair(
        ...
        void swap(key_value_pair& other) noexcept { std::swap(value_, other.value_); }
        ...
        int compare(const string_type& str) const { return key_value_pair_view(*this).compare(str); }

        int compare(string_view_type str) const { return key_value_pair_view(*this).compare(str); }

        int compare(const value_type* s) const { return key_value_pair_view(*this).compare(s); }
        ...
        template<class CharT, class Traits>
        friend std::basic_istream<CharT, Traits>& operator>>(std::basic_istream<CharT, Traits>& is, key_value_pair& p)
        {
    ...
    typename std::enable_if<
        ...
        bool>::type operator==(const T& l, const U& r)
    {
        return key_value_pair_view(l) == key_value_pair_view(r);
    }
...
namespace std {
    ...
    template<>
    class tuple_size<BOOST_PROCESS_V2_NAMESPACE::environment::key_value_pair_view> :
...
namespace environment {
    ...
    struct current_view
    {
        ...
        struct iterator
        {
            ...
            key_value_pair_view operator*() const { return detail::dereference(iterator_); }
    ...
    private:
        std::unique_ptr<typename remove_pointer<native_handle_type>::type, detail::native_handle_deleter> handle_ {
            environment::detail::load_native_handle()
        };
    };

    /// Obtain a handle to the current environment
    inline current_view current()
    {
        return current_view();
    }
    ...
    namespace detail {
        ...
        auto find_key(Environment& env, key_view ky) -> typename std::
            enable_if<std::is_convertible<decltype(*std::begin(env)), key_value_pair_view>::value, value_view>::type
        {
            const auto itr = std::find_if(std::begin(env), std::end(env), [&](key_value_pair_view vp) {
        ...
        template<typename Environment>
        auto find_key(Environment& env, key_view ky) -> typename std::enable_if<
            ...
            value>::type
        {
            const auto itr = std::find_if(std::begin(env), std::end(env), [&](key_value_pair vp) {
                auto tmp = std::get<0>(vp) == ky;
                if (tmp) {
                    return true;
                }
    ...
    {
#if defined(BOOST_PROCESS_V2_WINDOWS)
        return detail::find_key(env, L"HOMEDRIVE").native_string() + detail::find_key(env, L"HOMEPATH").native_string();
#else
     ...
     */
    template<typename Environment = current_view>
    inline BOOST_PROCESS_V2_NAMESPACE::filesystem::path
        find_executable(BOOST_PROCESS_V2_NAMESPACE::filesystem::path name, Environment&& env = current())
    {
#if defined(BOOST_PROCESS_V2_WINDOWS)
    ...
    inline value get(const key& k, error_code& ec)
    {
        return detail::get(k.c_str(), ec);
    }
    ...
    /// Disambiguating @overload value get(const key & k, error_code & ec)
    inline value get(const char_type* c, error_code& ec)
    {
        return detail::get(c, ec);
    }
    ...
    inline void set(const key& k, value_view vw, error_code& ec)
    {
        detail::set(k, vw, ec);
    }
    ...
    inline void set(basic_cstring_ref<char_type, key_char_traits<char_type>> k, value_view vw, error_code& ec)
    {
        detail::set(k, vw, ec);
    }
    ...
    /// Disambiguating @overload void set(const key & k, value_view vw, error_code & ec)
    inline void set(const char_type* k, value_view vw, error_code& ec)
    {
        detail::set(k, vw, ec);
    }
    ...
    inline void unset(const key& k, error_code& ec)
    {
        detail::unset(k, ec);
    }
    ...
    /// Disambiguating @overload void unset(const key & k, error_code & ec)
    inline void unset(const char_type* c, error_code& ec)
    {
        detail::unset(c, ec);
    }
...
struct process_environment
{
    ...
    static std::vector<wchar_t> build_env(
        Args&& args,
        typename std::enable_if<
            std::is_convertible<decltype(*std::begin(std::declval<Args>())), wcstring_ref>::value>::type* = nullptr)
    {
    ...
    process_environment(std::initializer_list<string_view> sv) :
        unicode_env { build_env(sv) }
    {
    }

    process_environment(std::initializer_list<wstring_view> sv) :
        unicode_env { build_env(sv) }
    {
    }
    ...
    process_environment(Args&& args) :
        unicode_env { build_env(std::forward<Args>(args)) }
    {
    }
    ...
    template<typename Args>
    static std::vector<const char*> build_env(
        Args&& args,
        typename std::enable_if<
            std::is_convertible<decltype(*std::begin(std::declval<Args>())), cstring_ref>::value>::type* = nullptr)
    {
    ...
    template<typename Args>
    std::vector<const char*> build_env(
        Args&& args,
        typename std::enable_if<
            !std::is_convertible<decltype(*std::begin(std::declval<Args>())), cstring_ref>::value>::type* = nullptr)
    {
    ...
    template<typename Args>
    process_environment(Args&& args) :
        env(build_env(std::forward<Args>(args)))
    {
    }
