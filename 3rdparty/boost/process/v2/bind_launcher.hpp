...
struct bound_launcher
{
    ...
    bound_launcher(Launcher_&& l, Init_&&... init) :
        launcher_(std::forward<Launcher_>(l)),
        init_(std::forward<Init_>(init)...)
    {
    }
    ...
    {
        return invoke(
            detail::make_index_sequence_t<sizeof...(Init)> {},
            context,
            executable,
...
auto bind_launcher(Launcher&& launcher, Init&&... init)
    -> bound_launcher<typename std::decay<Launcher>::type, typename std::decay<Init>::type...>
{
    return bound_launcher<typename std::decay<Launcher>::type, typename std::decay<Init>::type...>(
...
auto bind_default_launcher(Init&&... init)
    -> bound_launcher<default_process_launcher, typename std::decay<Init>::type...>
{
    return bound_launcher<default_process_launcher, typename std::decay<Init>::type...>(
