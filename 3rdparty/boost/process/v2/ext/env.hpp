...
namespace ext {
    ...
    struct env_view
    {
        ...
        struct iterator
        {
            ...
            iterator(const detail::ext::native_env_iterator& native_handle) :
            ...
            environment::key_value_pair_view operator*() const { return detail::ext::dereference(iterator_); }
    ...
    private:
        ...
        std::unique_ptr<
            typename remove_pointer<detail::ext::native_env_handle_type>::type,
            detail::ext::native_env_handle_deleter>
            handle_;
    };
