...
namespace boost {
    namespace unordered {
        ...
        private:
            ...
            bool friend
                operator==(concurrent_flat_set<K, H, KE, A> const& lhs, concurrent_flat_set<K, H, KE, A> const& rhs);

            template<class K, class H, class KE, class A, class Predicate>
            friend typename concurrent_flat_set<K, H, KE, A>::size_type
                erase_if(concurrent_flat_set<K, H, KE, A>& set, Predicate pred);
        ...
        void swap(
            concurrent_flat_set<Key, Hash, Pred, Alloc>& x,
        ...
        typename concurrent_flat_set<K, H, P, A>::size_type erase_if(concurrent_flat_set<K, H, P, A>& c, Predicate pred)
        {
        ...
        concurrent_flat_set(
            ...
            Pred = Pred(),
            Allocator = Allocator())
            -> concurrent_flat_set<typename std::iterator_traits<InputIterator>::value_type, Hash, Pred, Allocator>;
        ...
        concurrent_flat_set(
            ...
            Hash = Hash(),
            Pred = Pred(),
            Allocator = Allocator()) -> concurrent_flat_set<T, Hash, Pred, Allocator>;
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_input_iterator_v<InputIterator>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_flat_set(InputIterator, InputIterator, std::size_t, Allocator) -> concurrent_flat_set<
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_input_iterator_v<InputIterator>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_flat_set(InputIterator, InputIterator, Allocator) -> concurrent_flat_set<
            typename std::iterator_traits<InputIterator>::value_type,
            boost::hash<typename std::iterator_traits<InputIterator>::value_type>,
            std::equal_to<typename std::iterator_traits<InputIterator>::value_type>,
            Allocator>;
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_input_iterator_v<InputIterator>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_flat_set(InputIterator, InputIterator, std::size_t, Hash, Allocator) -> concurrent_flat_set<
            typename std::iterator_traits<InputIterator>::value_type,
            Hash,
            std::equal_to<typename std::iterator_traits<InputIterator>::value_type>,
            Allocator>;
