...
namespace boost {
    namespace unordered {
        namespace detail {
            ...
            template<class Node>
            using node_value_type = typename node_value_type_impl<Node>::type;

            template<class Node>
            struct node_pointer_impl;

            template<class ValueType, class VoidPtr>
            struct node_pointer_impl<node<ValueType, VoidPtr>>
            {
                typedef
                    typename boost::pointer_traits<VoidPtr>::template rebind_to<node<ValueType, VoidPtr>>::type type;
            };

            template<class Node>
            using node_pointer = typename node_pointer_impl<Node>::type;
            ...
            struct node
            {
                ...
                value_type* value_ptr() noexcept { return buf.address(); }

                value_type& value() noexcept { return *buf.address(); }
            };

            template<class Node, class VoidPtr>
            struct bucket
            {
                typedef typename boost::pointer_traits<VoidPtr>::template rebind_to<Node>::type node_pointer;

                typedef typename boost::pointer_traits<VoidPtr>::template rebind_to<bucket>::type bucket_pointer;
            ...
            struct bucket_group
            {
                ...
                typedef typename boost::pointer_traits<bucket_pointer>::template rebind_to<bucket_group>::type
            ...
            public:
                typedef typename Bucket::bucket_pointer bucket_pointer;
                typedef typename boost::pointer_traits<bucket_pointer>::template rebind_to<bucket_group<Bucket>>::type
                    bucket_group_pointer;

                typedef Bucket value_type;
                typedef typename boost::pointer_traits<bucket_pointer>::difference_type difference_type;
            ...
            public:
                ...
                bool operator==(grouped_bucket_iterator const& other) const noexcept { return equal(other); }
            ...
            private:
                ...
                void increment() noexcept
                {
                    ...
                    std::size_t n = std::size_t(boost::core::countr_zero(pbg->bitmask & reset_first_bits(offset + 1)));
                ...
                friend void serialization_track(Archive& ar, grouped_bucket_iterator const& x)
                {
            ...
            public:
                ...
                pointer operator->() const noexcept { return std::addressof(dereference()); }
                ...
                bool operator==(grouped_local_bucket_iterator const& other) const noexcept { return equal(other); }
            ...
            private:
                ...
                template<class>
                friend struct const_grouped_local_bucket_iterator;

                grouped_local_bucket_iterator(node_pointer p_) :
                    p(p_)
                {
                }
                ...
                bool equal(const grouped_local_bucket_iterator& x) const noexcept { return p == x.p; }
            ...
            public:
                ...
                const_grouped_local_bucket_iterator(grouped_local_bucket_iterator<Node> it) :
                    p(it.p)
                {
                }
                ...
                bool operator==(const_grouped_local_bucket_iterator const& other) const noexcept
                {
                    return equal(other);
                }
            ...
            private:
                ...
                const_grouped_local_bucket_iterator(node_pointer p_) :
                    p(p_)
                {
                }
                ...
                bool equal(const const_grouped_local_bucket_iterator& x) const noexcept { return p == x.p; }
            ...
            class grouped_bucket_array :
                boost::empty_value<typename boost::allocator_rebind<
                    Allocator,
                    node<
                        typename boost::allocator_value_type<Allocator>::type,
                        typename boost::allocator_void_pointer<Allocator>::type>>::type> {
                typedef typename boost::allocator_value_type<Allocator>::type allocator_value_type;
                typedef typename boost::allocator_void_pointer<Allocator>::type void_pointer;
                typedef typename boost::allocator_difference_type<Allocator>::type difference_type;

            public:
                typedef typename boost::allocator_rebind<Allocator, node<allocator_value_type, void_pointer>>::type
                    node_allocator_type;
            ...
            private:
                typedef typename boost::allocator_rebind<Allocator, Bucket>::type bucket_allocator_type;
                typedef typename boost::allocator_pointer<bucket_allocator_type>::type bucket_pointer;
                typedef boost::pointer_traits<bucket_pointer> bucket_pointer_traits;

                typedef bucket_group<Bucket> group;
                typedef typename boost::allocator_rebind<Allocator, group>::type group_allocator_type;
                typedef typename boost::allocator_pointer<group_allocator_type>::type group_pointer;
                typedef typename boost::pointer_traits<group_pointer> group_pointer_traits;
            ...
            public:
                ...
                typedef const_grouped_local_bucket_iterator<node_type> const_local_iterator;
            ...
            public:
                ...
                grouped_bucket_array() :
                    empty_value<node_allocator_type>(empty_init_t(), node_allocator_type()),
                    size_index_(0),
                    size_(0),
                    buckets(),
                    groups()
                ...
                grouped_bucket_array(size_type n, const Allocator& al) :
                    empty_value<node_allocator_type>(empty_init_t(), node_allocator_type(al)),
                    size_index_(0),
                    size_(0),
                    buckets(),
                    groups()
                {
                    ...
                    group_pointer pbg = groups + static_cast<difference_type>(num_groups - 1);

                    pbg->buckets = buckets + static_cast<difference_type>(N * (size_ / N));
                ...
                grouped_bucket_array(grouped_bucket_array&& other) noexcept :
                    empty_value<node_allocator_type>(empty_init_t(), other.get_node_allocator()),
    ...
    #pragma warning(pop)
                ...
                node_allocator_type& get_node_allocator() { return empty_value<node_allocator_type>::get(); }
                ...
                Allocator get_allocator() const { return Allocator(this->get_node_allocator()); }
                ...
                iterator end() const
                {
                    ...
                    iterator pbg;
                    pbg.p = buckets + static_cast<difference_type>(this->buckets_len() - 1);
                    return pbg;
                }
                ...
                local_iterator begin(size_type n) const
                {
                    ...
                    return local_iterator((buckets + static_cast<difference_type>(n))->next);
                }
                ...
                iterator at(size_type n) const
                {
                    if (size_ > 0) {
                        ...
                        iterator pbg(
                            buckets + static_cast<difference_type>(n),
                ...
                size_type position(std::size_t hash) const { return size_policy::position(hash, size_index_); }
                ...
                void append_bucket_group(iterator itb) noexcept
                {
                    ...
                    if (is_empty_bucket) {
                        ...
                        std::size_t n = static_cast<std::size_t>(boost::to_address(pb) - &buckets[0]);

                        bool const is_empty_group = (!pbg->bitmask);
                        if (is_empty_group) {
                            size_type const num_groups = this->groups_len();
                            group_pointer last_group = groups + static_cast<difference_type>(num_groups - 1);

                            pbg->buckets = buckets + static_cast<difference_type>(N * (n / N));
                ...
                void insert_node_hint(iterator itb, node_pointer p, node_pointer hint) noexcept
                {
                    this->append_bucket_group(itb);
                ...
                void unlink_empty_buckets() noexcept
                {
                    ...
                    group_pointer pbg = groups, last = groups + static_cast<difference_type>(this->groups_len() - 1);
                ...
                void unlink_bucket(iterator itb)
                {
                    ...
                    if (!(pbg->bitmask &= reset_bit(static_cast<std::size_t>(p - pbg->buckets)))) {
                        unlink_group(pbg);
                    }
                }
            ...
            private:
                ...
                {
                    using allocator_pocs = typename boost::allocator_propagate_on_container_swap<allocator_type>::type;
                    swap_allocator_if_pocs(other, std::integral_constant<bool, allocator_pocs::value>());
                }

                void swap_allocator_if_pocs(grouped_bucket_array& other, std::true_type /* propagate */)
                {
                    boost::core::invoke_swap(get_node_allocator(), other.get_node_allocator());
                }

                void swap_allocator_if_pocs(grouped_bucket_array&, std::false_type /* don't propagate */) {}
            };
        } // namespace detail
    } // namespace unordered
} // namespace boost
