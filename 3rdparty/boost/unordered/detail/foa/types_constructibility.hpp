    ...
    namespace unordered {
        namespace detail {
            namespace foa {
                ...
                {
                    static_assert(
                        std::is_constructible<Key, Args...>::value,
                ...
                {
                    static_assert(std::is_constructible<Key, const Key&>::value, "key_type must be copy constructible");
                };
                ...
                {
                    static_assert(
                        std::is_constructible<Mapped, Args...>::value,
                ...
                {
                    static_assert(std::is_constructible<Mapped>::value, "mapped_type must be default constructible");
                };
                ...
                {
                    static_assert(
                        std::is_constructible<Mapped, const Mapped&>::value,
                ...
                {
                    static_assert(
                        std::is_constructible<Mapped, Mapped&&>::value,
