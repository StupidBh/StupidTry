        ...
        namespace detail {
            namespace foa {
                ...
                private:
                    ...
                    {
                        move_assign_allocator_if(std::integral_constant<bool, B> {}, std::move(nh));
                    }
                ...
                protected:
                    node_value_type& data() noexcept { return *(p_.p); }

                    node_value_type const& data() const noexcept { return *(p_.p); }
                ...
                public:
                    ...
                    friend void swap(node_handle_base& lhs, node_handle_base& rhs) noexcept(noexcept(lhs.swap(rhs)))
                    {
                        return lhs.swap(rhs);
                    }
                };
                ...
                struct node_handle_access
                {
                    ...
                    template<class TypePolicy, class Allocator>
                    static element_type<TypePolicy, Allocator>& element(node_type<TypePolicy, Allocator>& nh) noexcept
                    {
                        return nh.element();
                    }

                    template<class TypePolicy, class Allocator>
                    static element_type<TypePolicy, Allocator> const&
                        element(node_type<TypePolicy, Allocator> const& nh) noexcept
                    {
                        return nh.element();
                    }
                    ...
                    static void emplace(
                        ...
                        element_type<TypePolicy, Allocator>&& x,
                        Allocator a)
                    {
                ...
                public:
                    node_handle_emplacer_class(node_type& nh_) :
                        nh(nh_)
                    {
                    }

                    void operator()(element_type&& x, Allocator a) { access::emplace(nh, std::move(x), a); }
                };
