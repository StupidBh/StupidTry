    ...
    namespace unordered {
        namespace detail {
            ...
            struct set
            {
                ...
                typedef boost::unordered::node_handle_set<node<value_type, void_pointer>, T, A> node_type;

                typedef typename table::c_iterator iterator;
                typedef boost::unordered::insert_return_type_set<iterator, node_type> insert_return_type;
            };
        }
    }
}
