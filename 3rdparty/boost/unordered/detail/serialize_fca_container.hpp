...
#include <boost/unordered/detail/serialize_container.hpp>
    ...
    #define BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER <boost/serialization/archive_input_unordered_map.hpp>
    #include BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #undef BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #define BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER <boost/serialization/archive_input_unordered_set.hpp>
    #include BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #undef BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #define BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER <boost/serialization/unordered_collections_load_imp.hpp>
    #include BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #undef BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #define BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER <boost/serialization/utility.hpp>
    #include BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
    #undef BOOST_UNORDERED_BLOCK_BOOSTDEP_HEADER
...
namespace boost {
    namespace unordered {
        namespace detail {
            ...
            template<typename Archive, typename K, typename T, typename H, typename P, typename A>
            struct archive_input<Archive, boost::unordered_map<K, T, H, P, A>> :
                boost::serialization::stl::archive_input_unordered_map<Archive, boost::unordered_map<K, T, H, P, A>>
            {
            };
            ...
            struct archive_input<Archive, boost::unordered_multimap<K, T, H, P, A>> :
                boost::serialization::stl::
                    archive_input_unordered_multimap<Archive, boost::unordered_multimap<K, T, H, P, A>>
            {
            };

            template<typename Archive, typename K, typename H, typename P, typename A>
            struct archive_input<Archive, boost::unordered_set<K, H, P, A>> :
                boost::serialization::stl::archive_input_unordered_set<Archive, boost::unordered_set<K, H, P, A>>
            {
            };
            ...
            struct archive_input<Archive, boost::unordered_multiset<K, H, P, A>> :
                boost::serialization::stl::
                    archive_input_unordered_multiset<Archive, boost::unordered_multiset<K, H, P, A>>
            {
            };
...
#if defined(BOOST_UNORDERED_ENABLE_SERIALIZATION_COMPATIBILITY_V0)
                        boost::serialization::stl::
                            load_unordered_collection<Archive, Container, archive_input<Archive, Container>>(ar, x);
#else
            ...
            {
                load_or_save_fca_container<Container, Archive::is_saving::value>()(ar, x, version);
            }
