    ...
    namespace unordered {
        namespace detail {
            ...
            using is_complete_and_move_constructible =
                typename std::conditional<is_complete<T>::value, std::is_move_constructible<T>, std::false_type>::type;
            ...
            struct is_trivially_copy_assignable :
                public std::
                    integral_constant<bool, std::is_copy_assignable<T>::value && std::has_trivial_copy_assign<T>::value>
            {
            };
#else
            ...
            namespace type_traits_detail {
                ...
                template<class T>
                struct is_nothrow_swappable_helper<T, void_t<decltype(swap(std::declval<T&>(), std::declval<T&>()))>>
                {
            ...
            struct is_nothrow_swappable :
                public std::integral_constant<bool, type_traits_detail::is_nothrow_swappable_helper<T>::value>
            {
            };
            ...
            struct is_similar_to_any<T, U, Us...> :
                std::conditional<is_similar<T, U>::value, is_similar<T, U>, is_similar_to_any<T, Us...>>::type
            {
            };
            ...
            struct is_allocator<
                ...
                boost::unordered::detail::
                    void_t<typename A::value_type, decltype(std::declval<A&>().allocate(std::size_t {}))>>
            {
