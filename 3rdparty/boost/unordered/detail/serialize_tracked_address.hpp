        ...
        namespace detail {
                ...
                if (p) {
                    ar& core::make_nvp(
                        ...
                        *reinterpret_cast<serialization_tracker<element_type>*>(
                            const_cast<element_type*>(boost::to_address(p))));
                }
            }
            ...
            void serialize_tracked_address(Archive& ar, Ptr& p, std::true_type /* save */)
            {
                ...
                tracker* pt = const_cast<tracker*>(
                    reinterpret_cast<const tracker*>(const_cast<const element_type*>(boost::to_address(p))));
            ...
            void serialize_tracked_address(Archive& ar, Ptr& p, std::false_type /* load */)
            {
                ...
                ar >> core::make_nvp("pointer", pt);
                element_type* pn =
                    const_cast<element_type*>(reinterpret_cast<const element_type*>(const_cast<const tracker*>(pt)));
