...
#if defined(__has_cpp_attribute) && (!defined(__cplusplus) || __cplusplus >= 201402)
...
namespace boost {
    namespace unordered {
        ...
        namespace detail {
            ...
            template<typename I>
            struct is_forward :
                std::is_base_of<std::forward_iterator_tag, typename std::iterator_traits<I>::iterator_category>
            {
            };

            template<typename I, typename ReturnType>
            struct enable_if_forward : std::enable_if<boost::unordered::detail::is_forward<I>::value, ReturnType>
            {
            };

            template<typename I, typename ReturnType>
            struct disable_if_forward : std::enable_if<!boost::unordered::detail::is_forward<I>::value, ReturnType>
            {
            };
        } // namespace detail
    } // namespace unordered
...
namespace boost {
    namespace unordered {
        namespace detail {
            ...
            template<class I>
            inline typename boost::unordered::detail::enable_if_forward<I, std::size_t>::type insert_size(I i, I j)
            {
                return static_cast<std::size_t>(std::distance(i, j));
            }

            template<class I>
            inline typename boost::unordered::detail::disable_if_forward<I, std::size_t>::type insert_size(I, I)
            {
                return 1;
            }
            ...
            template<class I>
            inline std::size_t
                initial_size(I i, I j, std::size_t num_buckets = boost::unordered::detail::default_bucket_count)
            {
                return (std::max)(boost::unordered::detail::insert_size(i, j), num_buckets);
            }
            ...
            {
                compressed_base(T const& x) :
                    empty_value<T>(boost::empty_init_t(), x)
                {
                }
                ...
                private boost::unordered::detail::generate_base<T2, 2>::type
            {
                ...
                first_type const& first() const { return static_cast<base1 const*>(this)->get(); }

                second_type& second() { return static_cast<base2*>(this)->get(); }

                second_type const& second() const { return static_cast<base2 const*>(this)->get(); }
...
// will be default-initialized.
            ...
            template<typename T>
            typename std::add_lvalue_reference<T>::type make();
...
namespace boost {
    ...
    #pragma warning(pop)
            ...
            public:
                ...
                {
                    return has_value_ ? x.has_value_ && value_.value() == x.value_.value() : !x.has_value_;
                }
        ...
        namespace detail {
            namespace func {
                ...
                struct use_piecewise
                {
                    ...
                    enum
                    {
                        value = sizeof(choice1::type) == sizeof(test(choose(), boost::unordered::detail::make<A0>()))
                    };
                };
                ...
                inline void construct_from_args(Alloc& alloc, T* address, Args&&... args)
                {
                    boost::allocator_construct(alloc, address, std::forward<Args>(args)...);
                }
                ...
                template<template<class...> class Tuple, class... Args, std::size_t... Is, class... TupleArgs>
                std::tuple<typename std::add_lvalue_reference<Args>::type...> to_std_tuple_impl(
                    boost::mp11::mp_list<Args...>,
                    Tuple<TupleArgs...>& tuple,
                    boost::mp11::index_sequence<Is...>)
                {
                    (void)tuple;
                    using std::get;
                    return std::tuple<typename std::add_lvalue_reference<Args>::type...>(get<Is>(tuple)...);
                }
                ...
                boost::mp11::mp_transform<
                    ...
                    boost::mp11::mp_remove<std::tuple<Args...>, boost::tuples::null_type>>
                    to_std_tuple(Tuple<Args...>& tuple)
                {
                    using list = boost::mp11::mp_remove<boost::mp11::mp_list<Args...>, boost::tuples::null_type>;
                ...
                template<typename Alloc, typename A, typename B, typename A0, typename A1, typename A2>
                inline typename std::enable_if<
                    use_piecewise<A0>::value && !detect_std_tuple<A1>::value && !detect_std_tuple<A2>::value,
                    void>::type
                    construct_from_args(Alloc& alloc, std::pair<A, B>* address, A0&&, A1&& a1, A2&& a2)
                {
    ...
    namespace unordered {
        namespace detail {
            ...
            struct node_tmp
            {
                ...
                typedef typename node::value_type value_type;
                typedef typename boost::allocator_rebind<NodeAlloc, value_type>::type value_allocator;
        ...
        namespace detail {
            namespace func {
                    ...
                    construct_node_from_args(Alloc& alloc, Args&&... args)
                {
                    ...
                    typedef typename node::value_type value_type;
                    typedef typename boost::allocator_rebind<Alloc, value_type>::type value_allocator;

                    value_allocator val_alloc(alloc);

                    node_constructor<Alloc> a(alloc);
                    a.create_node();
                    construct_from_args(val_alloc, a.node_->value_ptr(), std::forward<Args>(args)...);
                    return a.release();
                }

                template<typename Alloc, typename U>
                inline typename boost::allocator_pointer<Alloc>::type construct_node(Alloc& alloc, U&& x)
                {
                    node_constructor<Alloc> a(alloc);
                    a.create_node();
                    ...
                    boost::allocator_construct(val_alloc, a.node_->value_ptr(), std::forward<U>(x));
                    return a.release();
                }

                template<typename Alloc, typename Key>
                inline typename boost::allocator_pointer<Alloc>::type construct_node_pair(Alloc& alloc, Key&& k)
                {
                    node_constructor<Alloc> a(alloc);
                    a.create_node();
                ...
                inline typename boost::allocator_pointer<Alloc>::type construct_node_from_key(T*, Alloc& alloc, Key&& k)
                {
...
namespace boost {
        ...
        namespace detail {
            ...
            public:
                static const bool nothrow_move_assignable =
                    std::is_nothrow_move_assignable<H>::value && std::is_nothrow_move_assignable<P>::value;
                static const bool nothrow_move_constructible =
                    std::is_nothrow_move_constructible<H>::value && std::is_nothrow_move_constructible<P>::value;
                static const bool nothrow_swappable = boost::unordered::detail::is_nothrow_swappable<H>::value &&
            ...
            public:
                ...
                function_pair const& current_functions() const
                {
                    return *::boost::unordered::detail::launder(
                        static_cast<function_pair const*>(static_cast<void const*>(funcs_[current_ & 1].address())));
                }

                function_pair& current_functions()
                {
                    return *::boost::unordered::detail::launder(
                        static_cast<function_pair*>(static_cast<void*>(funcs_[current_ & 1].address())));
                }
            ...
            private:
                ...
                void construct_functions(unsigned char which, function_pair const& f, std::false_type = {})
                {
                    BOOST_ASSERT(!(which & 2));
                    new ((void*)&funcs_[which]) function_pair(f);
                }

                void construct_functions(unsigned char which, function_pair& f, std::true_type)
                {
                    BOOST_ASSERT(!(which & 2));
                    new ((void*)&funcs_[which]) function_pair(f, boost::unordered::detail::move_tag());
                }
    ...
    #pragma warning(disable: 4127) // conditional expression is constant
            ...
            namespace iterator_detail {
                ...
                public:
                    ...
                    bool operator==(iterator const& other) const noexcept { return equal(other); }

                    bool operator!=(iterator const& other) const noexcept { return !equal(other); }

                    bool operator==(
                        boost::unordered::detail::iterator_detail::c_iterator<Node, Bucket> const& other) const noexcept
                    {
                        return equal(other);
                    }
                ...
                private:
                    ...
                    bool equal(
                        const boost::unordered::detail::iterator_detail::c_iterator<Node, Bucket>& x) const noexcept
                    {
                        return (p == x.p);
                    }
                ...
                public:
                    ...
                    c_iterator(iterator<Node, Bucket> it) :
                        p(it.p),
                        itb(it.itb)
                    {
                    }
                    ...
                    bool operator==(c_iterator const& other) const noexcept { return equal(other); }

                    bool operator!=(c_iterator const& other) const noexcept { return !equal(other); }

                    bool operator==(
                        boost::unordered::detail::iterator_detail::iterator<Node, Bucket> const& other) const noexcept
                    {
                        return equal(other);
                    }
            ...
            public:
                ...
                typedef boost::unordered::detail::functions<typename Types::hasher, typename Types::key_equal>
                    functions;
                ...
                typedef boost::unordered::detail::
                    grouped_bucket_array<bucket<node_type, void_pointer>, value_allocator, prime_fmod_size<>>
                        bucket_array_type;

                typedef typename bucket_array_type::node_allocator_type node_allocator_type;
                typedef typename boost::allocator_pointer<node_allocator_type>::type node_pointer;

                typedef boost::unordered::detail::node_constructor<node_allocator_type> node_constructor;
            ...
            public:
                ...
                template<class Key>
                std::size_t group_count(Key const& k) const
                {
                    if (size_ == 0) {
                        return 0;
                    }
                ...
                node_allocator_type const& node_alloc() const { return buckets_.get_node_allocator(); }

                node_allocator_type& node_alloc() { return buckets_.get_node_allocator(); }

                std::size_t max_bucket_count() const
                {
                    typedef typename bucket_array_type::size_policy size_policy;
                    return size_policy::size(size_policy::size_index(boost::allocator_max_size(this->node_alloc())));
                }
                ...
                l_iterator begin(std::size_t bucket_index) const { return buckets_.begin(bucket_index); }

                std::size_t hash_to_bucket(std::size_t hash_value) const { return buckets_.position(hash_value); }
                ...
                table(std::size_t num_buckets, hasher const& hf, key_equal const& eq, value_allocator const& a) :
                    functions(hf, eq),
                    size_(0),
                    mlf_(1.0f),
                    max_load_(0),
                ...
                table(table& x, boost::unordered::detail::move_tag m) :
                    ...
                    buckets_(std::move(x.buckets_))
                {
                    x.size_ = 0;
                    x.max_load_ = 0;
                }

                table(table& x, value_allocator const& a, boost::unordered::detail::move_tag m) :
                    functions(x, m),
                    size_(0),
                    mlf_(x.mlf_),
                    max_load_(0),
                ...
                {
                    BOOST_ASSERT(
                        boost::allocator_propagate_on_container_swap<node_allocator_type>::type::value ||
                ...
                void move_construct_buckets(table& src)
                {
                    ...
                    for (iterator pos = src.begin(); pos != src.end(); ++pos) {
                        node_tmp b(
                            detail::func::construct_node(this->node_alloc(), std::move(pos.p->value())),
                            this->node_alloc());
                ...
                {
                    typedef typename boost::allocator_propagate_on_container_copy_assignment<node_allocator_type>::type
                        pocca;
                ...
                const_key_type& get_key(node_pointer n) const { return extractor::extract(n->value()); }
                ...
                template<class Key>
                node_pointer find_node(Key const& k) const
                {
                    std::size_t const key_hash = this->hash(k);
                    return find_node_impl(k, buckets_.at(buckets_.position(key_hash)));
                }

                node_pointer find_node(const_key_type& k, bucket_iterator itb) const { return find_node_impl(k, itb); }
                ...
                inline iterator transparent_find(Key const& k, Hash const& h, Pred const& pred) const
                {
                    if (size_ > 0) {
                ...
                node_pointer* find_prev(Key const& key, bucket_iterator itb)
                {
                    if (size_ > 0) {
                        ...
                        for (node_pointer* pp = std::addressof(itb->next); *pp; pp = std::addressof((*pp)->next)) {
                ...
                template<class Key>
                node_pointer extract_by_key_impl(Key const& k)
                {
                ...
                // Reserve and rehash
                void transfer_node(node_pointer p, bucket_type&, bucket_array_type& new_buckets)
                {
                ...
                static std::size_t min_buckets(std::size_t num_elements, float mlf)
                {
                    std::size_t num_buckets =
                        static_cast<std::size_t>(std::ceil(static_cast<float>(num_elements) / mlf));
                ...
                iterator emplace_hint_unique(c_iterator hint, const_key_type& k, Args&&... args)
                {
                ...
                {
                    using alloc_cted = allocator_constructed<node_allocator_type, typename Types::key_type>;
                    alloc_cted key(this->node_alloc(), std::forward<K>(k));
                    return emplace_unique(key.value(), std::move(key.value()), std::forward<V>(v));
                }

                template<typename Key>
                emplace_return try_emplace_unique(Key&& k)
                {
                    std::size_t key_hash = this->hash(k);
                    bucket_iterator itb = buckets_.at(buckets_.position(key_hash));
                    ...
                    if (pos) {
                        ...
                        node_tmp tmp(
                            detail::func::construct_node_from_key(dispatch, alloc, std::forward<Key>(k)),
                            alloc);
                ...
                template<typename Key, typename... Args>
                iterator try_emplace_hint_unique(c_iterator hint, Key&& k, Args&&... args)
                {
                ...
                iterator move_insert_node_type_with_hint_unique(c_iterator hint, NodeType& np)
                {
                    if (!np) {
                        return this->end();
                    }
                ...
                void merge_unique(boost::unordered::detail::table<Types2>& other)
                {
                    ...
                    BOOST_UNORDERED_STATIC_ASSERT((std::is_same<node_type, typename other_table::node_type>::value));
                ...
                template<class Key>
                std::size_t erase_key_unique_impl(Key const& k)
                {
                ...
                void move_assign_buckets(table& src, std::true_type)
                {
                    ...
                    for (iterator pos = src.begin(); pos != last; ++pos) {
                        ...
                        node_tmp tmp(detail::func::construct_node(alloc, std::move(value)), alloc);
                ...
                static std::size_t count_equal_equiv(iterator n, iterator last, value_type const& v)
                {
                    std::size_t count = 0;
                    for (; n != last; ++n) {
                        if (*n == v) {
                ...
                template<typename NodeType>
                iterator move_insert_node_type_with_hint_equiv(c_iterator hint, NodeType& np)
                {
                    iterator result;
                    if (np) {
                        bucket_iterator itb = hint.itb;
                ...
                // safety. Strong otherwise
                template<class I>
                typename boost::unordered::detail::enable_if_forward<I, void>::type insert_range_equiv(I i, I j)
                {
                    if (i == j) {
                        return;
                    }
                    ...
                    if (distance == 1) {
                        emplace_equiv(boost::unordered::detail::func::construct_node(this->node_alloc(), *i));
                    }
                    else {
                ...
                template<class I>
                typename boost::unordered::detail::disable_if_forward<I, void>::type insert_range_equiv(I i, I j)
                {
                    for (; i != j; ++i) {
                        emplace_equiv(boost::unordered::detail::func::construct_node(this->node_alloc(), *i));
                    }
                ...
                std::size_t erase_key_equiv(const_key_type& k) { return this->erase_key_equiv_impl(k); }
            ...
            template<typename Types>
            inline void table<Types>::clear_impl()
            {
            ...
            {
                num_buckets = buckets_.bucket_count_for((std::max)(min_buckets(size_, mlf_), num_buckets));
            ...
            {
                bucket_array_type new_buckets(num_buckets, buckets_.get_allocator());
                ...
                BOOST_CATCH(...)
                {
                    for (bucket_iterator pos = new_buckets.begin(); pos != new_buckets.end(); ++pos) {
                        bucket_type& b = *pos;
                        for (node_pointer p = b.next; p;) {
                            node_pointer next_p = p->next;
                            delete_node(p);
    ...
    #pragma warning(pop)
            ...
            struct is_key
            {
                ...
                enum
                {
                    value = sizeof(test(boost::unordered::detail::make<T>())) == sizeof(choice2::type)
                };
            ...
            struct map_extractor
            {
                ...
                typedef typename std::remove_const<
                    typename boost::unordered::detail::pair_traits<ValueType>::first_type>::type key_type;
                ...
                static typename std::conditional<
                    (is_similar<Arg1, key_type>::value || is_complete_and_move_constructible<key_type>::value),
                    converting_key,
                    no_key>::type
                ...
                template<template<typename...> class Tuple, typename T, typename T2, typename... Args>
                static auto extract(std::piecewise_construct_t, Tuple<T, Args...> const& k, T2 const&) ->
