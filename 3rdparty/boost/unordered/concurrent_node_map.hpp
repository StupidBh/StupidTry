    ...
    namespace unordered {
        ...
        private:
            ...
            bool friend operator==(
                concurrent_node_map<K, V, H, KE, A> const& lhs,
                concurrent_node_map<K, V, H, KE, A> const& rhs);

            template<class K, class V, class H, class KE, class A, class Predicate>
            friend typename concurrent_node_map<K, V, H, KE, A>::size_type
                erase_if(concurrent_node_map<K, V, H, KE, A>& set, Predicate pred);

            template<class Archive, class K, class V, class H, class KE, class A>
            friend void serialize(Archive& ar, concurrent_node_map<K, V, H, KE, A>& c, unsigned int version);
        ...
        public:
            ...
            using node_type = detail::foa::node_map_handle<
                type_policy,
                typename boost::allocator_rebind<Allocator, typename type_policy::value_type>::type>;
            using insert_return_type = detail::foa::iteratorless_insert_return_type<node_type>;
            ...
            concurrent_node_map(concurrent_node_map const& rhs) :
                table_(rhs.table_, boost::allocator_select_on_container_copy_construction(rhs.get_allocator()))
            {
            }
            ...
            template<class InputIterator>
            concurrent_node_map(InputIterator f, InputIterator l, allocator_type const& a) :
            ...
            concurrent_node_map(concurrent_node_map const& rhs, allocator_type const& a) :
                table_(rhs.table_, a)
            {
            }
            ...
            concurrent_node_map(std::initializer_list<value_type> il, const allocator_type& a) :
                concurrent_node_map(il, detail::foa::default_bucket_count, hasher(), key_equal(), a)
            {
            }
            ...
            BOOST_ATTRIBUTE_NODISCARD bool empty() const noexcept { return size() == 0; }
            ...
            {
                return table_.try_emplace_or_visit(k, std::forward<M>(obj), [&](value_type& m) {
                    m.second = std::forward<M>(obj);
                });
            }
            ...
            {
                return table_.try_emplace_or_visit(std::move(k), std::forward<M>(obj), [&](value_type& m) {
                    m.second = std::forward<M>(obj);
                });
            }

            template<class K, class M>
            BOOST_FORCEINLINE typename std::enable_if<detail::are_transparent<K, hasher, key_equal>::value, bool>::type
                insert_or_assign(K&& k, M&& obj)
            {
                return table_.try_emplace_or_visit(std::forward<K>(k), std::forward<M>(obj), [&](value_type& m) {
                    m.second = std::forward<M>(obj);
                });
            }
            ...
            {
                BOOST_UNORDERED_STATIC_ASSERT_LAST_ARG_INVOCABLE(Arg, Args...)
                return table_.try_emplace_or_visit(std::move(k), std::forward<Arg>(arg), std::forward<Args>(args)...);
            }
            ...
            {
                BOOST_UNORDERED_STATIC_ASSERT_LAST_ARG_CONST_INVOCABLE(Arg, Args...)
                return table_.try_emplace_or_cvisit(std::move(k), std::forward<Arg>(arg), std::forward<Args>(args)...);
            }
            ...
            template<class Arg1, class Arg2, class... Args>
            BOOST_FORCEINLINE bool try_emplace_and_visit(key_type const& k, Arg1&& arg1, Arg2&& arg2, Args&&... args)
            {
                BOOST_UNORDERED_STATIC_ASSERT_PENULTIMATE_ARG_INVOCABLE(Arg1, Arg2, Args...)
                BOOST_UNORDERED_STATIC_ASSERT_LAST_ARG_INVOCABLE(Arg2, Args...)
            ...
            template<class Arg1, class Arg2, class... Args>
            BOOST_FORCEINLINE bool try_emplace_and_cvisit(key_type const& k, Arg1&& arg1, Arg2&& arg2, Args&&... args)
            {
                BOOST_UNORDERED_STATIC_ASSERT_PENULTIMATE_ARG_INVOCABLE(Arg1, Arg2, Args...)
                BOOST_UNORDERED_STATIC_ASSERT_LAST_ARG_CONST_INVOCABLE(Arg2, Args...)
            ...
            template<class Arg1, class Arg2, class... Args>
            BOOST_FORCEINLINE bool try_emplace_and_visit(key_type&& k, Arg1&& arg1, Arg2&& arg2, Args&&... args)
            {
                BOOST_UNORDERED_STATIC_ASSERT_PENULTIMATE_ARG_INVOCABLE(Arg1, Arg2, Args...)
                BOOST_UNORDERED_STATIC_ASSERT_LAST_ARG_INVOCABLE(Arg2, Args...)
                return table_.try_emplace_and_visit(
            ...
            template<class Arg1, class Arg2, class... Args>
            BOOST_FORCEINLINE bool try_emplace_and_cvisit(key_type&& k, Arg1&& arg1, Arg2&& arg2, Args&&... args)
            {
                BOOST_UNORDERED_STATIC_ASSERT_PENULTIMATE_ARG_INVOCABLE(Arg1, Arg2, Args...)
                BOOST_UNORDERED_STATIC_ASSERT_LAST_ARG_CONST_INVOCABLE(Arg2, Args...)
                return table_.try_emplace_and_cvisit(
            ...
            BOOST_FORCEINLINE typename std::enable_if<
                detail::are_transparent<K, hasher, key_equal>::value && !detail::is_execution_policy<K>::value,
                size_type>::type
                erase_if(K&& k, F f)
            {
            ...
            template<class K>
            typename std::enable_if<detail::are_transparent<K, hasher, key_equal>::value, node_type>::type
                extract(K const& key)
            {
                node_type nh;
                table_.extract(key, detail::foa::node_handle_emplacer(nh));
        ...
        template<class Archive, class K, class V, class H, class KE, class A>
        void serialize(Archive& ar, concurrent_node_map<K, V, H, KE, A>& c, unsigned int)
        {
        ...
        concurrent_node_map(
            ...
            Hash = Hash(),
            Pred = Pred(),
            Allocator = Allocator()) -> concurrent_node_map<std::remove_const_t<Key>, T, Hash, Pred, Allocator>;
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_input_iterator_v<InputIterator>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_node_map(InputIterator, InputIterator, std::size_t, Allocator) -> concurrent_node_map<
            boost::unordered::detail::iter_key_t<InputIterator>,
            boost::unordered::detail::iter_val_t<InputIterator>,
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_input_iterator_v<InputIterator>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_node_map(InputIterator, InputIterator, Allocator) -> concurrent_node_map<
            boost::unordered::detail::iter_key_t<InputIterator>,
            boost::unordered::detail::iter_val_t<InputIterator>,
            boost::hash<boost::unordered::detail::iter_key_t<InputIterator>>,
            std::equal_to<boost::unordered::detail::iter_key_t<InputIterator>>,
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_input_iterator_v<InputIterator>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_node_map(InputIterator, InputIterator, std::size_t, Hash, Allocator) -> concurrent_node_map<
            boost::unordered::detail::iter_key_t<InputIterator>,
            boost::unordered::detail::iter_val_t<InputIterator>,
            Hash,
            std::equal_to<boost::unordered::detail::iter_key_t<InputIterator>>,
        ...
        concurrent_node_map(std::initializer_list<std::pair<Key, T>>, std::size_t, Allocator) -> concurrent_node_map<
        ...
        template<class Key, class T, class Allocator, class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_node_map(std::initializer_list<std::pair<Key, T>>, Allocator) -> concurrent_node_map<
            std::remove_const_t<Key>,
            T,
            boost::hash<std::remove_const_t<Key>>,
            std::equal_to<std::remove_const_t<Key>>,
        ...
        template<
            ...
            class = std::enable_if_t<detail::is_hash_v<Hash>>,
            class = std::enable_if_t<detail::is_allocator_v<Allocator>>>
        concurrent_node_map(std::initializer_list<std::pair<Key, T>>, std::size_t, Hash, Allocator)
            -> concurrent_node_map<
                std::remove_const_t<Key>,
                T,
                Hash,
