...
namespace boost {
    namespace static_strings {
        ...
        namespace detail {
            ...
            struct is_nothrow_convertible<
                From,
                To,
                typename std::enable_if<is_nothrow_convertible_msvc_helper<From, To>::value>::type> : std::true_type
            {
            };
            ...
            struct is_string_like<
                ...
                void_t<
                    ...
                    decltype(std::declval<std::size_t&>() = std::declval<T>().size())>> : std::true_type
            {
            };
    ...
    // can use the data() and size() member functions.
            ...
            struct common_string_view_type_impl<
                ...
                CharT,
                Traits,
                typename std::enable_if<std::is_convertible<const T&, core::basic_string_view<CharT>>::value>::type>
            {
            ...
            struct is_iterator<
                T,
                typename std::enable_if<std::is_class<T>::value, void_t<typename T::iterator_category>>::type> :
                std::true_type
            {
            };
            ...
            struct is_forward_iterator<
                T,
                typename std::enable_if<
                    is_iterator<T>::value && std::is_convertible<
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR std::size_t distance(ForwardIt first, ForwardIt last)
            {
                std::size_t dist = 0;
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR std::size_t distance(RandomIt first, RandomIt last)
            {
                return last - first;
            }
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR void copy_with_traits(InputIt first, InputIt last, CharT* out)
            {
            ...
            public:
                ...
                pointer data_impl() noexcept { return data_; }

                BOOST_STATIC_STRING_CPP14_CONSTEXPR
                const_pointer data_impl() const noexcept { return data_; }

                BOOST_STATIC_STRING_CPP11_CONSTEXPR
                std::size_t size_impl() const noexcept { return size_; }

                BOOST_STATIC_STRING_CPP14_CONSTEXPR
                std::size_t set_size(std::size_t n) noexcept
                {
                ...
                BOOST_STATIC_STRING_CPP14_CONSTEXPR
                void term_impl() noexcept { Traits::assign(data_[size_], value_type()); }
            ...
            public:
                ...
                BOOST_STATIC_STRING_CPP11_CONSTEXPR
                std::size_t size_impl() const noexcept { return 0; }

                BOOST_STATIC_STRING_CPP11_CONSTEXPR
                std::size_t set_size(std::size_t) const noexcept { return 0; }
    ...
    // see http://eel.is/c++draft/depr.static.constexpr
            ...
            template<typename CharT, typename Traits>
            constexpr const typename static_string_base<0, CharT, Traits>::value_type
                static_string_base<0, CharT, Traits>::null_;
    #endif

            template<typename CharT, typename Traits>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR inline int
                lexicographical_compare(const CharT* s1, std::size_t n1, const CharT* s2, std::size_t n2) noexcept
            {
                if (n1 < n2) {
            ...
            inline static_string<N> to_static_string_int_impl(Integer value) noexcept
            {
                using size_type = typename static_string<N>::size_type;
                static_string<N> result;
                result.resize_and_overwrite(N, [&](char* buffer, size_type) -> size_type {
            ...
            inline static_wstring<N> to_static_wstring_int_impl(Integer value) noexcept
            {
                ...
                result.resize_and_overwrite(N, [&](wchar_t* buffer, size_type) -> size_type {
            ...
            BOOST_STATIC_STRING_CPP11_CONSTEXPR
            inline int count_digits(std::size_t value)
            {
    ...
    // not need to be extremely precise.
        ...
        #pragma GCC diagnostic ignored "-Wformat-truncation"
            ...
            inline static_string<N> cpp26_to_static_string(FloatingPoint value) noexcept
            {
                using size_type = typename static_string<N>::size_type;
                static_string<N> result;
                result.resize_and_overwrite(N, [&](char* buffer, size_type) -> size_type {
            ...
            template<std::size_t N>
            inline static_string<N> to_static_string_float_impl(double value) noexcept
            {
    #if defined(BOOST_STATIC_STRING_USE_STD_FORMAT)
            ...
            template<std::size_t N>
            inline static_string<N> to_static_string_float_impl(float value) noexcept
            {
    #if defined(BOOST_STATIC_STRING_USE_STD_FORMAT)
                return cpp26_to_static_string<N>(value);
    #else
        ...
        #if defined(BOOST_STATIC_STRING_USE_STD_FORMAT)
            template<std::size_t N, typename FloatingPoint>
            inline static_wstring<N> cpp26_to_static_wstring(FloatingPoint value) noexcept
            {
                using size_type = typename static_wstring<N>::size_type;
                static_wstring<N> result;
                result.resize_and_overwrite(N, [&](wchar_t* buffer, size_type) -> size_type {
            ...
            template<std::size_t N>
            inline static_wstring<N> to_static_wstring_float_impl(double value) noexcept
            {
        #if defined(BOOST_STATIC_STRING_USE_STD_FORMAT)
                ...
                result.resize_and_overwrite(N, [&](wchar_t* buffer, size_type) -> size_type {
                    ...
                    // implementations.
                    int num_written = std::swprintf(buffer, N + 1, L"%f", value);
            ...
            template<std::size_t N>
            inline static_wstring<N> to_static_wstring_float_impl(float value) noexcept
            {
        #if defined(BOOST_STATIC_STRING_USE_STD_FORMAT)
                return cpp26_to_static_wstring<N>(value);
        #else
            ...
            inline static_wstring<N> to_static_wstring_float_impl(long double value) noexcept
            {
                ...
                result.resize_and_overwrite(N, [&](wchar_t* buffer, size_type) -> size_type {
                    ...
                    // second operand is not evaluated on conforming
                    // implementations.
                    int num_written = std::swprintf(buffer, N + 1, L"%Lf", value);
                    if (num_written < 0 || num_written > narrow) {
                        // the + 4 is for the decimal, 'e',
                        // its sign, and the sign of the integral portion
                        const int reserved_count =
        ...
        #pragma GCC diagnostic pop
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR inline ForwardIterator
                find_not_of(ForwardIterator first, ForwardIterator last, const CharT* str, std::size_t n) noexcept
            {
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR inline ForwardIt1
                search(ForwardIt1 first, ForwardIt1 last, ForwardIt2 s_first, ForwardIt2 s_last, BinaryPredicate p)
            {
                for (;; ++first) {
                    ForwardIt1 it = first;
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR inline InputIt
                find_first_of(InputIt first, InputIt last, ForwardIt s_first, ForwardIt s_last, BinaryPredicate p)
            {
                for (; first != last; ++first) {
            ...
            template<typename T>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR inline bool
                ptr_in_range(const T* src_first, const T* src_last, const T* ptr)
            {
    #if defined(BOOST_STATIC_STRING_CPP14) && defined(BOOST_STATIC_STRING_IS_CONST_EVAL)
    ...
    // constructors.
            ...
            struct throw_exception
            {
                ...
                BOOST_STATIC_STRING_CPP14_CONSTEXPR
                throw_exception(const char* msg) { BOOST_STATIC_STRING_THROW(Exception(msg)); }
            };
    #else
            template<typename Exception>
            BOOST_STATIC_STRING_NORETURN inline void throw_exception(const char* msg)
            {
        ...
        */
        ...
        public:
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string(size_type count, value_type ch) { assign(count, ch); }
            ...
            */
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
                basic_static_string(const basic_static_string<M, CharT, Traits>& other, size_type pos)
            {
                assign(other, pos);
            }
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
                basic_static_string(const basic_static_string<M, CharT, Traits>& other, size_type pos, size_type count)
            {
            ...
            /** Constructor.
              ...
              */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string(const_pointer s, size_type count) { assign(s, count); }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string(const_pointer s) { assign(s); }
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string(InputIterator first, InputIterator last)
            {
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string(const basic_static_string<M, CharT, Traits>& other)
            {
                assign(other);
            }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string(std::initializer_list<value_type> init) { assign(init.begin(), init.size()); }
...
#endif
                >
            explicit BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string(const T& t)
            {
                assign(t);
            }
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string(const T& t, size_type pos, size_type n)
            {
                assign(t, pos, n);
            }
            ...
            */
            basic_static_string& operator=(const basic_static_string& s) = default;
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& operator=(const_pointer s) { return assign(s); }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& operator=(std::initializer_list<value_type> ilist) { return assign(ilist); }
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& operator=(const T& t)
            {
                return assign(t);
            }
...
#ifndef BOOST_STATIC_STRING_DOCS
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& assign(const basic_static_string& s) noexcept
            {
                if (data() == s.data()) {
                    return *this;
                }
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string&
                assign(const basic_static_string<M, CharT, Traits>& s, size_type pos, size_type count = npos)
            {
            ...
            /** Assign to the string.
              ...
              */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& assign(const_pointer s, size_type count);
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& assign(const_pointer s) { return assign(s, traits_type::length(s)); }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& assign(std::initializer_list<value_type> ilist)
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& assign(const T& t)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            pointer data() noexcept { return this->data_impl(); }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            const_pointer data() const noexcept { return this->data_impl(); }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& insert(size_type index, size_type count, value_type ch)
            {
                if (index > size()) {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& insert(size_type index, const_pointer s)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& insert(size_type index, const_pointer s, size_type count)
            {
                if (index > size()) {
                    detail::throw_exception<std::out_of_range>("index > size()");
                }
...
#ifndef BOOST_STATIC_STRING_DOCS
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& insert(size_type index, const basic_static_string& str)
            {
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& insert(
                size_type index,
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string&
                insert(size_type index, const basic_static_string& str, size_type index_str, size_type count = npos)
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& insert(size_type index, const T& t)
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& erase(size_type index = 0, size_type count = npos)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& append(size_type count, value_type ch);
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string&
                append(const basic_static_string<M, CharT, Traits>& s, size_type pos, size_type count = npos)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& append(const_pointer s, size_type count);
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& append(const_pointer s) { return append(s, traits_type::length(s)); }
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& append(const T& t)
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& operator+=(const_pointer s) { return append(s); }
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& operator+=(std::initializer_list<value_type> ilist) { return append(ilist); }
            ...
            */
            ...
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR int
                compare(size_type pos1, size_type count1, const basic_static_string<M, CharT, Traits>& s) const
            {
                return detail::lexicographical_compare<CharT, Traits>(
                    data() + pos1,
                    capped_length(pos1, count1),
                    s.data(),
                    s.size());
            }
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR int compare(
                size_type pos1,
                size_type count1,
            ...
            */
            ...
            {
                return detail::lexicographical_compare<CharT, Traits>(data(), size(), s, traits_type::length(s));
            }
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR int compare(const T& t) const noexcept
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR int compare(size_type pos1, size_type count1, const T& t) const
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
                return detail::lexicographical_compare<CharT, Traits>(
                    data() + pos1,
            ...
            */
            template<
                ...
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR int
                compare(size_type pos1, size_type count1, const T& t, size_type pos2, size_type count2 = npos) const
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
                if (pos2 > sv.size()) {
                    detail::throw_exception<std::out_of_range>("pos2 > sv.size()");
                }
                return compare(pos1, count1, sv.data() + pos2, (std::min)(sv.size() - pos2, count2));
            }
            ...
            */
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
#endif
            basic_static_string substr(size_type pos = 0, size_type count = npos) const
            {
            ...
            */
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR void resize_and_overwrite(size_type n, Operation op);
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            void swap(basic_static_string& s) noexcept;
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR void swap(basic_static_string<M, CharT, Traits>& s);
            ...
            */
            template<size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string&
                replace(size_type pos1, size_type n1, const basic_static_string<M, CharT, Traits>& str)
            {
...
#ifndef BOOST_STATIC_STRING_DOCS
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(size_type pos1, size_type n1, const basic_static_string& str)
            {
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& replace(
                size_type pos1,
                size_type n1,
                const basic_static_string<M, CharT, Traits>& str,
                size_type pos2,
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string& replace(size_type pos1, size_type n1, const T& t)
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(size_type pos, size_type n1, const_pointer s, size_type n2)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(size_type pos, size_type n1, const_pointer s)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(size_type pos, size_type n1, size_type n2, value_type c)
            {
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR basic_static_string&
                replace(const_iterator i1, const_iterator i2, const basic_static_string<M, CharT, Traits>& str)
            {
...
#ifndef BOOST_STATIC_STRING_DOCS
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(const_iterator i1, const_iterator i2, const basic_static_string& str)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(const_iterator i1, const_iterator i2, const_pointer s, size_type n)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(const_iterator i1, const_iterator i2, const_pointer s)
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(const_iterator i1, const_iterator i2, size_type n, value_type c);
...
#ifndef BOOST_STATIC_STRING_DOCS
            template<typename ForwardIterator>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR typename std::enable_if<
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace(const_iterator i1, const_iterator i2, std::initializer_list<value_type> il)
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type find(const T& t, size_type pos = 0) const
#ifdef BOOST_STATIC_STRING_DOCS
                noexcept(detail::is_nothrow_convertible<const T&, string_view_type>::value)
#else
                noexcept(
                    detail::is_nothrow_convertible<const T&, detail::common_string_view_type<T, CharT, Traits>>::value)
#endif
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
          ...
          */
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                find(const basic_static_string<M, CharT, Traits>& str, size_type pos = 0) const noexcept
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type rfind(const T& t, size_type pos = npos) const
#ifdef BOOST_STATIC_STRING_DOCS
                noexcept(detail::is_nothrow_convertible<const T&, string_view_type>::value)
#else
                noexcept(
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                rfind(const basic_static_string<M, CharT, Traits>& str, size_type pos = npos) const noexcept
            {
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            size_type rfind(value_type c, size_type pos = npos) const noexcept { return rfind(&c, pos, 1); }
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type find_first_of(const T& t, size_type pos = 0) const
#ifdef BOOST_STATIC_STRING_DOCS
                noexcept(detail::is_nothrow_convertible<const T&, string_view_type>::value)
#else
                noexcept(
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                find_first_of(const basic_static_string<M, CharT, Traits>& str, size_type pos = 0) const noexcept
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type find_last_of(const T& t, size_type pos = npos) const
#ifdef BOOST_STATIC_STRING_DOCS
                noexcept(detail::is_nothrow_convertible<const T&, string_view_type>::value)
#else
                noexcept(
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                find_last_of(const basic_static_string<M, CharT, Traits>& str, size_type pos = npos) const noexcept
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type find_first_not_of(const T& t, size_type pos = 0) const
#ifdef BOOST_STATIC_STRING_DOCS
                noexcept(detail::is_nothrow_convertible<const T&, string_view_type>::value)
#else
                noexcept(
            ...
            */
            template<std::size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                find_first_not_of(const basic_static_string<M, CharT, Traits>& str, size_type pos = 0) const noexcept
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type find_last_not_of(const T& t, size_type pos = npos) const
#ifdef BOOST_STATIC_STRING_DOCS
                noexcept(detail::is_nothrow_convertible<const T&, string_view_type>::value)
#else
                noexcept(
            ...
            */
            template<size_t M>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                find_last_not_of(const basic_static_string<M, CharT, Traits>& str, size_type pos = npos) const noexcept
            {
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR bool starts_with(T const& t) const noexcept
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
...
#endif
                >
            BOOST_STATIC_STRING_CPP14_CONSTEXPR bool ends_with(T const& t) const noexcept
            {
                detail::common_string_view_type<T, CharT, Traits> sv = t;
                const size_type len = sv.size();
            ...
            */
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            bool ends_with(value_type c) const noexcept { return !empty() && traits_type::eq(back(), c); }
        ...
        private:
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& term() noexcept
            {
                this->term_impl();
                return *this;
            }
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& assign_char(value_type ch, std::true_type) noexcept
            {
                this->set_size(1);
            ...
            template<typename InputIterator>
            BOOST_STATIC_STRING_CPP14_CONSTEXPR size_type
                read_back(bool overwrite_null, InputIterator first, InputIterator last);

            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace_unchecked(size_type pos, size_type n1, const_pointer s, size_type n2)
            {
                if (pos > size()) {
                    detail::throw_exception<std::out_of_range>("pos > size()");
                }
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& replace_unchecked(const_iterator i1, const_iterator i2, const_pointer s, size_type n2);

            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& insert_unchecked(size_type index, const_pointer s, size_type count)
            {
                if (index > size()) {
                    detail::throw_exception<std::out_of_range>("index > size()");
                }
            ...
            BOOST_STATIC_STRING_CPP14_CONSTEXPR
            basic_static_string& assign_unchecked(const_pointer s, size_type count) noexcept
            {
                this->set_size(count);
        ...
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline bool operator==(
        ...
        {
            return detail::lexicographical_compare<CharT, Traits>(lhs, Traits::length(lhs), rhs.data(), rhs.size()) ==
                   0;
        }
        ...
        {
            return detail::lexicographical_compare<CharT, Traits>(lhs.data(), lhs.size(), rhs, Traits::length(rhs)) ==
                   0;
        }
        ...
        template<
            ...
            >
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline bool
            operator==(const T& lhs, const basic_static_string<N, CharT, Traits>& rhs)
        {
            detail::common_string_view_type<T, CharT, Traits> lhsv = lhs;
            return detail::lexicographical_compare<CharT, Traits>(lhsv.data(), lhsv.size(), rhs.data(), rhs.size()) ==
                   0;
        }
        ...
        template<
            ...
            >
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline bool
            operator==(const basic_static_string<N, CharT, Traits>& lhs, const T& rhs)
        {
            detail::common_string_view_type<T, CharT, Traits> rhsv = rhs;
            return detail::lexicographical_compare<CharT, Traits>(lhs.data(), lhs.size(), rhsv.data(), rhsv.size()) ==
                   0;
        }
        ...
        {
            detail::common_string_view_type<T, CharT, Traits> lhsv = lhs;
            return detail::lexicographical_compare<CharT, Traits>(lhsv.data(), lhsv.size(), rhs.data(), rhs.size()) < 0;
        }
        ...
        {
            detail::common_string_view_type<T, CharT, Traits> rhsv = rhs;
            return detail::lexicographical_compare<CharT, Traits>(lhs.data(), lhs.size(), rhsv.data(), rhsv.size()) < 0;
        }
        ...
        template<std::size_t N, std::size_t M, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline basic_static_string<N + M, CharT, Traits> operator+(
            const basic_static_string<N, CharT, Traits>& lhs,
            const basic_static_string<M, CharT, Traits>& rhs)
        {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline basic_static_string<N + 1, CharT, Traits>
            operator+(const basic_static_string<N, CharT, Traits>& lhs, CharT rhs)
        {
        ...
        template<std::size_t N, std::size_t M, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline basic_static_string<N + M, CharT, Traits>
        ...
        BOOST_STATIC_STRING_CPP14_CONSTEXPR typename basic_static_string<N, CharT, Traits>::size_type
            erase_if(basic_static_string<N, CharT, Traits>& str, UnaryPredicate pred)
        {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline void
            swap(basic_static_string<N, CharT, Traits>& lhs, basic_static_string<N, CharT, Traits>& rhs)
        {
            lhs.swap(rhs);
        }
        ...
        template<std::size_t N, std::size_t M, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR inline void
            swap(basic_static_string<N, CharT, Traits>& lhs, basic_static_string<M, CharT, Traits>& rhs)
        {
            lhs.swap(rhs);
        }
        ...
        /// Converts `value` to a `static_string`
        static_string<std::numeric_limits<long>::digits10 + 2> inline to_static_string(long value) noexcept
        {
            return detail::to_static_string_int_impl<std::numeric_limits<long>::digits10 + 2>(value);
        }

        /// Converts `value` to a `static_string`
        static_string<std::numeric_limits<long long>::digits10 + 2> inline to_static_string(long long value) noexcept
        {
        ...
        /// Converts `value` to a `static_string`
        static_string<std::numeric_limits<float>::max_digits10 + 8> inline to_static_string(float value) noexcept
        {
            return detail::to_static_string_float_impl<std::numeric_limits<float>::max_digits10 + 8>(value);
        }

        /// Converts `value` to a `static_string`
        static_string<std::numeric_limits<double>::max_digits10 + 8> inline to_static_string(double value) noexcept
        {
            return detail::to_static_string_float_impl<std::numeric_limits<double>::max_digits10 + 8>(value);
        }

        /// Converts `value` to a `static_string`
        static_string<std::numeric_limits<long double>::max_digits10 + 10> inline to_static_string(
            long double value) noexcept
        {
            return detail::to_static_string_float_impl<std::numeric_limits<long double>::max_digits10 + 10>(value);
        }

#ifdef BOOST_STATIC_STRING_HAS_WCHAR
        /// Converts `value` to a `static_wstring`
        static_wstring<std::numeric_limits<int>::digits10 + 2> inline to_static_wstring(int value) noexcept
        {
            return detail::to_static_wstring_int_impl<std::numeric_limits<int>::digits10 + 2>(value);
        }

        /// Converts `value` to a `static_wstring`
        static_wstring<std::numeric_limits<long>::digits10 + 2> inline to_static_wstring(long value) noexcept
        {
            return detail::to_static_wstring_int_impl<std::numeric_limits<long>::digits10 + 2>(value);
        }

        /// Converts `value` to a `static_wstring`
        static_wstring<std::numeric_limits<long long>::digits10 + 2> inline to_static_wstring(long long value) noexcept
        {
        ...
        /// Converts `value` to a `static_wstring`
        static_wstring<std::numeric_limits<float>::max_digits10 + 8> inline to_static_wstring(float value) noexcept
        {
            return detail::to_static_wstring_float_impl<std::numeric_limits<float>::max_digits10 + 8>(value);
        }

        /// Converts `value` to a `static_wstring`
        static_wstring<std::numeric_limits<double>::max_digits10 + 8> inline to_static_wstring(double value) noexcept
        {
            return detail::to_static_wstring_float_impl<std::numeric_limits<double>::max_digits10 + 8>(value);
        }

        /// Converts `value` to a `static_wstring`
        static_wstring<std::numeric_limits<long double>::max_digits10 + 10> inline to_static_wstring(
            long double value) noexcept
        {
            return detail::to_static_wstring_float_impl<std::numeric_limits<long double>::max_digits10 + 10>(value);
        }
#endif
        ...
        template<std::size_t N, typename CharT, typename Traits>
        std::size_t hash_value(const basic_static_string<N, CharT, Traits>& str)
        {
...
namespace std {
    ...
    struct hash<
        ...
        >
    {
        std::size_t operator()(const boost::static_strings::basic_static_string<N, CharT, Traits>& str) const noexcept
        {
#if !defined(BOOST_STATIC_STRING_STANDALONE)
            return boost::hash_range(str.begin(), str.end());
#elif defined(BOOST_STATIC_STRING_HAS_ANY_STRING_VIEW)
            using view_type = typename boost::static_strings::basic_string_view<CharT, Traits>;
...
namespace boost {
    namespace static_strings {
        ...
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::assign(size_type count, value_type ch) -> basic_static_string&
        {
            if (count > max_size()) {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::assign(const_pointer s, size_type count) -> basic_static_string&
        {
            if (count > max_size()) {
                detail::throw_exception<std::length_error>("count > max_size()");
            }
        ...
        template<typename InputIterator>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::assign(InputIterator first, InputIterator last) ->
            typename std::enable_if<detail::is_input_iterator<InputIterator>::value, basic_static_string&>::type
        {
            auto ptr = data();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::insert(const_iterator pos, size_type count, value_type ch)
                -> iterator
        {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        template<typename ForwardIterator>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto basic_static_string<N, CharT, Traits>::insert(
            const_iterator pos,
        ...
        template<typename InputIterator>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::insert(const_iterator pos, InputIterator first, InputIterator last)
                ->
            typename std::enable_if<
                detail::is_input_iterator<InputIterator>::value && !detail::is_forward_iterator<InputIterator>::value,
                iterator>::type
        {
            const auto curr_size = size();
            const auto curr_data = data();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::erase(const_iterator first, const_iterator last) -> iterator
        {
            const auto curr_data = data();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR void basic_static_string<N, CharT, Traits>::push_back(value_type ch)
        {
            const auto curr_size = size();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::append(size_type count, value_type ch) -> basic_static_string&
        {
            const auto curr_size = size();
            if (count > max_size() - curr_size) {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::append(const_pointer s, size_type count) -> basic_static_string&
        {
            const auto curr_size = size();
            if (count > max_size() - curr_size) {
                detail::throw_exception<std::length_error>("count > max_size() - size()");
        ...
        BOOST_STATIC_STRING_CPP14_CONSTEXPR void
            basic_static_string<N, CharT, Traits>::resize(size_type n, value_type c)
        {
            if (n > max_size()) {
                detail::throw_exception<std::length_error>("n > max_size()");
            }
        ...
        template<typename Operation>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR void
            basic_static_string<N, CharT, Traits>::resize_and_overwrite(size_type n, Operation op)
        {
            if (n > max_size()) {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto basic_static_string<N, CharT, Traits>::replace(
            const_iterator i1,
            const_iterator i2,
            size_type n,
            value_type c) -> basic_static_string<N, CharT, Traits>&
        {
            const auto curr_size = size();
            const auto curr_data = data();
        ...
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto basic_static_string<N, CharT, Traits>::replace(
            ...
            const_iterator i2,
            ForwardIterator j1,
            ForwardIterator j2) -> typename std::
            enable_if<detail::is_forward_iterator<ForwardIterator>::value, basic_static_string<N, CharT, Traits>&>::type
        {
            const auto curr_size = size();
            const auto curr_data = data();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::find(const_pointer s, size_type pos, size_type n) const noexcept
            -> size_type
        {
            const auto curr_size = size();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::rfind(const_pointer s, size_type pos, size_type n) const noexcept
            -> size_type
        {
            const auto curr_size = size();
            const auto curr_data = data();
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::find_first_of(const_pointer s, size_type pos, size_type n)
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::find_last_of(const_pointer s, size_type pos, size_type n)
                const noexcept -> size_type
        {
            const auto curr_size = size();
            if (!n) {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::find_first_not_of(const_pointer s, size_type pos, size_type n)
                const noexcept -> size_type
        {
            if (pos >= size()) {
                return npos;
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto
            basic_static_string<N, CharT, Traits>::find_last_not_of(const_pointer s, size_type pos, size_type n)
                const noexcept -> size_type
        {
            const auto curr_size = size();
            if (pos >= curr_size) {
        ...
        template<std::size_t N, typename CharT, typename Traits>
        template<typename InputIterator>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto basic_static_string<N, CharT, Traits>::read_back(
            bool overwrite_null,
            InputIterator first,
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto basic_static_string<N, CharT, Traits>::replace_unchecked(
            const_iterator i1,
            const_iterator i2,
            const_pointer s,
        ...
        template<std::size_t N, typename CharT, typename Traits>
        BOOST_STATIC_STRING_CPP14_CONSTEXPR auto basic_static_string<N, CharT, Traits>::insert_unchecked(
            const_iterator pos,
            const_pointer s,
