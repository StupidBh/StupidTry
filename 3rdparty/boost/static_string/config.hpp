...
// Boost and non-Boost versions of utilities
    ...
    #if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW) || defined(BOOST_STATIC_STRING_CXX17_STRING_VIEW)
        #include <string_view>
    ...
    #if !defined(BOOST_STATIC_STRING_NO_CXX17_HDR_STRING_VIEW) || defined(BOOST_STATIC_STRING_CXX17_STRING_VIEW)
        #include <string_view>
        #define BOOST_STATIC_STRING_HAS_STD_STRING_VIEW
    #endif
#endif
...
#if (BOOST_STATIC_STRING_STANDARD_VERSION >= 201402L && BOOST_STATIC_STRING_STANDARD_VERSION < 201703L) && \
    defined(__clang__) && ((__clang_major__ == 4) || (__clang_major__ == 5))
...
#if defined(__GNUC__) && (__GNUC__ == 5) && defined(BOOST_STATIC_STRING_CPP14)
...
// are still defined.
#if !defined(BOOST_STATIC_STRING_STANDALONE) || defined(BOOST_STATIC_STRING_HAS_STD_STRING_VIEW)
...
namespace boost {
    ...
    __cpp_lib_to_string >= 202306L // std::to_[w]string() redefined in terms of std::format()
