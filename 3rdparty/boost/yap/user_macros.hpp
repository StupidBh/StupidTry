...
/** Defines operator overloads for unary operator \a op_name that each take an
    ...
    ExpressionTemplate.
*/
#define BOOST_YAP_USER_UNARY_OPERATOR(op_name, expr_template, result_expr_template)                                \
    template<::boost::yap::expr_kind Kind, typename Tuple>                                                         \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(expr_template<Kind, Tuple> const& x)                  \
    {                                                                                                              \
        using lhs_type =                                                                                           \
            ::boost::yap::detail::operand_type_t<result_expr_template, expr_template<Kind, Tuple> const&>;         \
        using tuple_type = ::boost::hana::tuple<lhs_type>;                                                         \
        return result_expr_template<::boost::yap::expr_kind::op_name, tuple_type> { tuple_type {                   \
            ::boost::yap::detail::make_operand<lhs_type> {}(x) } };                                                \
    }                                                                                                              \
    template<::boost::yap::expr_kind Kind, typename Tuple>                                                         \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(expr_template<Kind, Tuple> & x)                       \
    {                                                                                                              \
        using lhs_type = ::boost::yap::detail::operand_type_t<result_expr_template, expr_template<Kind, Tuple>&>;  \
        using tuple_type = ::boost::hana::tuple<lhs_type>;                                                         \
        return result_expr_template<::boost::yap::expr_kind::op_name, tuple_type> { tuple_type {                   \
            ::boost::yap::detail::make_operand<lhs_type> {}(x) } };                                                \
    }                                                                                                              \
    ...
    {                                                                                                              \
        ...
        return result_expr_template<::boost::yap::expr_kind::op_name, tuple_type> { tuple_type { std::move(x) } }; \
    }
...
/** Defines operator overloads for binary operator \a op_name that each
    ...
    ExpressionTemplate.
*/
#define BOOST_YAP_USER_BINARY_OPERATOR(op_name, expr_template, result_expr_template)                                 \
    template<::boost::yap::expr_kind Kind, typename Tuple, typename Expr>                                            \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(expr_template<Kind, Tuple> const& lhs, Expr&& rhs)      \
    {                                                                                                                \
        using lhs_type =                                                                                             \
            ::boost::yap::detail::operand_type_t<result_expr_template, expr_template<Kind, Tuple> const&>;           \
        using rhs_type = ::boost::yap::detail::operand_type_t<result_expr_template, Expr>;                           \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                 \
        return result_expr_template<::boost::yap::expr_kind::op_name, tuple_type> { tuple_type {                     \
            ::boost::yap::detail::make_operand<lhs_type> {}(lhs),                                                    \
            ::boost::yap::detail::make_operand<rhs_type> {}(static_cast<Expr&&>(rhs)) } };                           \
    }                                                                                                                \
    template<::boost::yap::expr_kind Kind, typename Tuple, typename Expr>                                            \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(expr_template<Kind, Tuple> & lhs, Expr && rhs)          \
    {                                                                                                                \
        using lhs_type = ::boost::yap::detail::operand_type_t<result_expr_template, expr_template<Kind, Tuple>&>;    \
        using rhs_type = ::boost::yap::detail::operand_type_t<result_expr_template, Expr>;                           \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                 \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(expr_template<Kind, Tuple> && lhs, Expr && rhs)         \
    {                                                                                                                \
        using lhs_type = ::boost::yap::detail::remove_cv_ref_t<expr_template<Kind, Tuple>&&>;                        \
        using rhs_type = ::boost::yap::detail::operand_type_t<result_expr_template, Expr>;                           \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                 \
        return result_expr_template<::boost::yap::expr_kind::op_name, tuple_type> {                                  \
            tuple_type { std::move(lhs), ::boost::yap::detail::make_operand<rhs_type> {}(static_cast<Expr&&>(rhs)) } \
        };                                                                                                           \
    }                                                                                                                \
    template<typename T, ::boost::yap::expr_kind Kind, typename Tuple>                                               \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && lhs, expr_template<Kind, Tuple> && rhs)            \
    ...
    template<typename T, ::boost::yap::expr_kind Kind, typename Tuple>                                               \
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && lhs, expr_template<Kind, Tuple> const& rhs)        \
        ->::boost::yap::detail::free_binary_op_result_t<                                                             \
            result_expr_template,                                                                                    \
            ::boost::yap::expr_kind::op_name,                                                                        \
            T,                                                                                                       \
...
#define BOOST_YAP_USER_ASSIGN_OPERATOR(this_type, expr_template)                                                       \
    template<                                                                                                          \
        typename Expr,                                                                                                 \
        typename = std::enable_if_t<!::boost::yap::detail::copy_or_move<this_type, Expr&&>::value>>                    \
    ...
    {                                                                                                                  \
        ...
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                   \
        return expr_template<::boost::yap::expr_kind::assign, tuple_type> { tuple_type {                               \
    ...
    {                                                                                                                  \
        ...
        return expr_template<::boost::yap::expr_kind::assign, tuple_type> {                                            \
            tuple_type { std::move(*this), ::boost::yap::detail::make_operand<rhs_type> {}(static_cast<Expr&&>(rhs)) } \
        };                                                                                                             \
    }
...
#define BOOST_YAP_USER_SUBSCRIPT_OPERATOR(expr_template)                                                               \
    ...
    {                                                                                                                  \
        ...
        using rhs_type = ::boost::yap::detail::operand_type_t<expr_template, Expr>;                                    \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                   \
        return expr_template<::boost::yap::expr_kind::subscript, tuple_type> { tuple_type {                            \
            ::boost::yap::detail::make_operand<lhs_type> {}(*this),                                                    \
            ::boost::yap::detail::make_operand<rhs_type> {}(static_cast<Expr&&>(rhs)) } };                             \
    }                                                                                                                  \
    template<typename Expr>                                                                                            \
    ...
    constexpr auto operator[](Expr&& rhs) &&                                                                           \
    {                                                                                                                  \
        using lhs_type = ::boost::yap::detail::remove_cv_ref_t<decltype(*this)>;                                       \
        using rhs_type = ::boost::yap::detail::operand_type_t<expr_template, Expr>;                                    \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                   \
...
#define BOOST_YAP_USER_CALL_OPERATOR(expr_template)                                                                    \
    ...
    {                                                                                                                  \
        using lhs_type = ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;                         \
        using tuple_type = ::boost::hana::tuple<lhs_type, ::boost::yap::detail::operand_type_t<expr_template, U>...>;  \
        return expr_template<::boost::yap::expr_kind::call, tuple_type> { tuple_type {                                 \
            ::boost::yap::detail::make_operand<lhs_type> {}(*this),                                                    \
            ::boost::yap::detail::make_operand<::boost::yap::detail::operand_type_t<expr_template, U>> {}(             \
                static_cast<U&&>(u))... } };                                                                           \
    }                                                                                                                  \
    template<typename... U>                                                                                            \
    ...
    {                                                                                                                  \
        ...
        using tuple_type = ::boost::hana::tuple<this_type, ::boost::yap::detail::operand_type_t<expr_template, U>...>; \
        return expr_template<::boost::yap::expr_kind::call, tuple_type> { tuple_type {                                 \
            std::move(*this),                                                                                          \
            ::boost::yap::detail::make_operand<::boost::yap::detail::operand_type_t<expr_template, U>> {}(             \
                static_cast<U&&>(u))... } };                                                                           \
...
#define BOOST_YAP_USER_CALL_OPERATOR_N(expr_template, n)                                                              \
    ...
    {                                                                                                                 \
        using lhs_type = ::boost::yap::detail::operand_type_t<expr_template, decltype(*this)>;                        \
        using tuple_type =                                                                                            \
            ::boost::hana::tuple<lhs_type, BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_OPERAND_T, expr_template)>;  \
        return expr_template<::boost::yap::expr_kind::call, tuple_type> { tuple_type {                                \
            ::boost::yap::detail::make_operand<lhs_type> {}(*this),                                                   \
            BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_MAKE_OPERAND, expr_template) } };                           \
    }                                                                                                                 \
    template<BOOST_PP_ENUM_PARAMS(n, typename U)>                                                                     \
    ...
    {                                                                                                                 \
        using this_type = ::boost::yap::detail::remove_cv_ref_t<decltype(*this)>;                                     \
        using tuple_type =                                                                                            \
            ::boost::hana::tuple<this_type, BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_OPERAND_T, expr_template)>; \
        return expr_template<::boost::yap::expr_kind::call, tuple_type> { tuple_type {                                \
            std::move(*this),                                                                                         \
            BOOST_PP_ENUM(n, BOOST_YAP_USER_CALL_OPERATOR_MAKE_OPERAND, expr_template) } };                           \
    }
...
#define BOOST_YAP_USER_EXPR_IF_ELSE(expr_template)                                                               \
    ...
    constexpr auto if_else(Expr1&& expr1, Expr2&& expr2, Expr3&& expr3)                                          \
        -> ::boost::yap::detail::ternary_op_result_t<expr_template, Expr1, Expr2, Expr3>                         \
    {                                                                                                            \
        using result_types = ::boost::yap::detail::ternary_op_result<expr_template, Expr1, Expr2, Expr3>;        \
        ...
        return { tuple_type { ::boost::yap::detail::make_operand<cond_type> {}(static_cast<Expr1&&>(expr1)),     \
...
#define BOOST_YAP_USER_UDT_ANY_IF_ELSE(expr_template, udt_trait)                                                 \
    template<typename Expr1, typename Expr2, typename Expr3>                                                     \
    constexpr auto if_else(Expr1&& expr1, Expr2&& expr2, Expr3&& expr3)                                          \
        -> ::boost::yap::detail::udt_any_ternary_op_result_t<expr_template, Expr1, Expr2, Expr3, udt_trait>      \
    {                                                                                                            \
        using result_types =                                                                                     \
            ::boost::yap::detail::udt_any_ternary_op_result<expr_template, Expr1, Expr2, Expr3, udt_trait>;      \
        using cond_type = typename result_types::cond_type;                                                      \
        using then_type = typename result_types::then_type;                                                      \
        using else_type = typename result_types::else_type;                                                      \
        using tuple_type = ::boost::hana::tuple<cond_type, then_type, else_type>;                                \
...
#define BOOST_YAP_USER_UDT_UNARY_OPERATOR(op_name, expr_template, udt_trait)                                          \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && x)                                                  \
        ->::boost::yap::detail::udt_unary_op_result_t<expr_template, ::boost::yap::expr_kind::op_name, T, udt_trait>  \
    {                                                                                                                 \
        using result_types =                                                                                          \
            ::boost::yap::detail::udt_unary_op_result<expr_template, ::boost::yap::expr_kind::op_name, T, udt_trait>; \
...
#define BOOST_YAP_USER_UDT_UDT_BINARY_OPERATOR(op_name, expr_template, t_udt_trait, u_udt_trait)                       \
    ...
    {                                                                                                                  \
        using result_types = ::boost::yap::detail::                                                                    \
            udt_udt_binary_op_result<expr_template, ::boost::yap::expr_kind::op_name, T, U, t_udt_trait, u_udt_trait>; \
        using lhs_type = typename result_types::lhs_type;                                                              \
        using rhs_type = typename result_types::rhs_type;                                                              \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                                   \
        return { tuple_type {                                                                                          \
...
#define BOOST_YAP_USER_UDT_ANY_BINARY_OPERATOR(op_name, expr_template, udt_trait)                         \
    ...
    constexpr auto operator BOOST_YAP_INDIRECT_CALL(op_name)(T && lhs, U && rhs)                          \
        ->::boost::yap::detail::                                                                          \
            udt_any_binary_op_result_t<expr_template, ::boost::yap::expr_kind::op_name, T, U, udt_trait>  \
    {                                                                                                     \
        using result_types = ::boost::yap::detail::                                                       \
            udt_any_binary_op_result<expr_template, ::boost::yap::expr_kind::op_name, T, U, udt_trait>;   \
        using lhs_type = typename result_types::lhs_type;                                                 \
        using rhs_type = typename result_types::rhs_type;                                                 \
        using tuple_type = ::boost::hana::tuple<lhs_type, rhs_type>;                                      \
        return { tuple_type { lhs_type { static_cast<T&&>(lhs) }, rhs_type { static_cast<U&&>(rhs) } } }; \
    }
