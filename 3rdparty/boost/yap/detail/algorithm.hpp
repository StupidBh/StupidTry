...
namespace boost {
    namespace yap {
        namespace detail {
            ...
            {
                constexpr auto operator()(ExprTemplate<expr_kind::expr_ref, Tuple> expr) { return expr; }
            ...
            template<template<expr_kind, class> class ExprTemplate, expr_kind OpKind, typename T, typename U>
            ...
            template<template<expr_kind, class> class ExprTemplate, expr_kind OpKind, typename T, typename U>
            using free_binary_op_result_t = typename free_binary_op_result<ExprTemplate, OpKind, T, U>::type;
            ...
            template<template<expr_kind, class> class ExprTemplate, typename T, typename U, typename V>
            struct ternary_op_result<ExprTemplate, T, U, V, true>
            {
                ...
                using type = ExprTemplate<expr_kind::if_else, hana::tuple<cond_type, then_type, else_type>>;
            };
            ...
            using udt_any_ternary_op_result_t =
                typename udt_any_ternary_op_result<ExprTemplate, T, U, V, UdtTrait>::type;
            ...
            template<
                ...
                typename T,
                template<class> class UdtTrait>
            using udt_unary_op_result_t = typename udt_unary_op_result<ExprTemplate, OpKind, T, UdtTrait>::type;
            ...
            template<
                ...
                template<class> class TUdtTrait,
                template<class> class UUdtTrait>
            using udt_udt_binary_op_result_t =
                typename udt_udt_binary_op_result<ExprTemplate, OpKind, T, U, TUdtTrait, UUdtTrait>::type;
            ...
            template<
                ...
                typename U,
                template<class> class UdtTrait>
            using udt_any_binary_op_result_t =
                typename udt_any_binary_op_result<ExprTemplate, OpKind, T, U, UdtTrait>::type;
