...
namespace boost {
    namespace type_erasure {
        ...
        namespace detail {
            ...
            {
                typedef typename ::boost::remove_cv<typename ::boost::remove_reference<Tag>::type>::type tag_type;
                return ::boost::type_erasure::detail::access::table(arg).template find<typeid_<tag_type>>()() ==
                       typeid(T);
            }
            ...
            bool check_any_cast(const any<Concept, Tag>& arg)
            {
                return ::boost::type_erasure::detail::check_any_cast<T>(
                    arg,
                    ::boost::is_void<typename ::boost::remove_reference<T>::type>());
            }
        ...
        T any_cast(any<Concept, Tag>& arg)
        {
            if (::boost::type_erasure::detail::check_any_cast<T>(arg)) {
                return *static_cast<typename ::boost::remove_reference<typename ::boost::add_const<T>::type>::type*>(
        ...
        T any_cast(any<Concept, Tag>* arg)
        {
            ...
            if (::boost::type_erasure::detail::check_any_cast<typename ::boost::remove_pointer<T>::type>(*arg)) {
                return static_cast<typename ::boost::remove_pointer<T>::type*>(
                    ::boost::type_erasure::detail::get_pointer(*arg));
            }
            else {
                return 0;
