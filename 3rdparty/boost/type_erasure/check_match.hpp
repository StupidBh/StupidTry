...
namespace boost {
    namespace type_erasure {
        ...
        namespace detail {
            ...
            struct should_check :
                boost::mpl::and_<::boost::type_erasure::is_placeholder<T>, ::boost::type_erasure::is_relaxed<Concept>>
            {
            };
        ...
        namespace detail {
            ...
            bool check_table(
                ...
                const U&... arg)
            {
                typedef typename ::boost::remove_cv<typename ::boost::remove_reference<T0>::type>::type t0;
        ...
        {
            const ::boost::type_erasure::binding<typename ::boost::type_erasure::detail::extract_concept<
...
namespace detail {
    ...
    #define BOOST_TYPE_ERASURE_CHECK_TABLE(z, n, data)                                                          \
        typedef typename ::boost::remove_cv<typename ::boost::remove_reference<BOOST_PP_CAT(T, n)>::type>::type \
            BOOST_PP_CAT(t, n);                                                                                 \
    ...
    template<class Concept, class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T) BOOST_PP_ENUM_TRAILING_PARAMS(N, class U)>
    bool BOOST_PP_CAT(check_table, N)(
        const ::boost::type_erasure::binding<Concept>* t,
        R (*)(BOOST_PP_ENUM_PARAMS(N, T)) BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, const U, &arg))
    {
    ...
    struct BOOST_PP_CAT(do_extract_concept, N)<R(BOOST_PP_ENUM_PARAMS(N, T)) BOOST_PP_ENUM_TRAILING_PARAMS(N, U)> :
        ::boost::type_erasure::detail::BOOST_PP_CAT(
            extract_concept,
            N)<BOOST_PP_ENUM_PARAMS(N, T) BOOST_PP_ENUM_TRAILING_PARAMS(N, U)>
    {
    };
    ...
    const Op& BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    return ::boost::type_erasure::detail::BOOST_PP_CAT(check_table, N)(
        &table,
        (typename ::boost::type_erasure::detail::get_signature<Op>::type*)0 BOOST_PP_ENUM_TRAILING_PARAMS(N, arg));
}

    #if N != 0

template<class Op BOOST_PP_ENUM_TRAILING_PARAMS(N, class U)>
bool check_match(const Op& BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
