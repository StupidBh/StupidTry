...
namespace boost {
    namespace type_erasure {
        ...
        struct destructible
        {
            ...
            /** INTERNAL ONLY */
            static void value(detail::storage& arg) { delete static_cast<T*>(arg.data); }

            /** INTERNAL ONLY */
            static void apply(detail::storage& arg) { delete static_cast<T*>(arg.data); }
        };
         ...
         */
        template<class T = _self>
        struct copy_constructible : ::boost::mpl::vector<constructible<T(const T&)>, destructible<T>>
        {
        };
         ...
         */
        template<class T = _self, class U = const T&>
        struct assignable : ::boost::mpl::vector<assignable<T, const U&>>
        {
        };
            ...
            typename ::boost::enable_if_c<::boost::is_reference<U>::value>::type> : Base
        {
            ...
            assignable<T, U>* _boost_type_erasure_deduce_assign(typename ::boost::type_erasure::as_param<Base, U>::type)
            {
                return 0;
            }
        };
        ...
        struct typeid_
        {
            ...
            /** INTERNAL ONLY */
            static const std::type_info& value() { return typeid(T); }

            /** INTERNAL ONLY */
            static const std::type_info& apply() { return typeid(T); }
        };
