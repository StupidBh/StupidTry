...
#include <boost/type_erasure/concept_interface.hpp>
    ...
    defined(BOOST_TYPE_ERASURE_DOXYGEN) || BOOST_WORKAROUND(BOOST_MSVC, == 1800)
...
namespace boost {
        ...
        namespace detail {
            ...
            struct first_placeholder
            {
                typedef typename ::boost::mpl::eval_if<
                    ...
                    first_placeholder<BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_TYPE_ERASURE_MAX_ARITY, T)>>::type type;
            };
            ...
            struct first_placeholder_index :
                ::boost::mpl::eval_if<
                    ...
                    ::boost::mpl::int_<0>,
                    ::boost::mpl::next<
                        first_placeholder_index<BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_TYPE_ERASURE_MAX_ARITY, T)>>>::type
            {
            };
    ...
    #define BOOST_TYPE_ERASURE_FREE_PARAM_TYPE(z, n, data)                                   \
        typename ::boost::mpl::eval_if_c<                                                    \
            (_boost_type_erasure_free_p_idx::value == n),                                    \
            ::boost::type_erasure::detail::maybe_const_this_param<BOOST_PP_CAT(T, n), Base>, \
            ::boost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>>::type                 \
            BOOST_PP_CAT(t, n)
        ...
        #define BOOST_TYPE_ERASURE_FREE_FORWARD_PARAM_I(z, n, data)                              \
            ::std::forward<typename ::boost::mpl::eval_if_c<                                     \
                (_boost_type_erasure_free_p_idx::value == n),                                    \
                ::boost::type_erasure::detail::maybe_const_this_param<BOOST_PP_CAT(T, n), Base>, \
                ::boost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>>::type>(BOOST_PP_CAT(t, n))
            ...
            namespace type_erasure {                                                                       \
                ...
                struct concept_interface<                                                                  \
                    ...
                    typename ::boost::type_erasure::detail::first_placeholder<                             \
                        BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE, ~)>::type> : Base \
                {                                                                                          \
                    ...
                    friend typename ::boost::type_erasure::rebind_any<Base, R>::type                       \
                        function_name(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_PARAM_TYPE, ~))             \
                    {                                                                                      \
...
namespace boost {
        ...
        namespace detail {
            ...
            struct first_placeholder<T0, T...>
            {
                typedef typename ::boost::mpl::
                    eval_if<is_placeholder<T0>, ::boost::mpl::identity<T0>, first_placeholder<T...>>::type type;
            };
            ...
            struct first_placeholder_index<T0, T...> :
                ::boost::mpl::eval_if<
                    is_placeholder<T0>,
                    ::boost::mpl::int_<0>,
                    ::boost::mpl::next<first_placeholder_index<T...>>>::type
            {
            };
            ...
            {
                typedef typename push_back_index<typename make_index_list<N - 1>::type, N - 1>::type type;
            };
    ...
    #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES) && !defined(BOOST_NO_CXX11_DECLTYPE)
            ...
            template<class... T>
            using first_placeholder_index_t = typename ::boost::type_erasure::detail::first_placeholder_index<
                ::boost::remove_cv_t<::boost::remove_reference_t<T>>...>::type;

        #endif

            template<class Base, class Tn, int I, class... T>
            using free_param_t = typename ::boost::mpl::eval_if_c<
                (::boost::type_erasure::detail::first_placeholder_index_t<T...>::value == I),
                ::boost::type_erasure::detail::maybe_const_this_param<Tn, Base>,
                ::boost::type_erasure::as_param<Base, Tn>>::type;
            ...
            {
                template<class Base, template<class> class C, template<class...> class F>
                using apply = F<R(A...), Base, ::boost::type_erasure::detail::make_index_list_t<sizeof...(A)>>;
            };
            ...
            namespace boost_type_erasure_impl {                                                                     \
                ...
                {                                                                                                   \
                    friend ::boost::type_erasure::rebind_any_t<Base, R>                                             \
                        function_name(::boost::type_erasure::detail::free_param_t<Base, T, I, T...>... t)           \
                    {                                                                                               \
                        return ::boost::type_erasure::call(                                                         \
                            concept_name<R(T...)>(),                                                                \
                ...
                {                                                                                                   \
                    static R apply(T... t) { return function_name(std::forward<T>(t)...); }                         \
                };                                                                                                  \
                                                                                                                    \
                template<class... T>                                                                                \
                struct concept_name##free<void(T...)>                                                               \
                {                                                                                                   \
                    static void apply(T... t) { function_name(std::forward<T>(t)...); }                             \
                };                                                                                                  \
            }                                                                                                       \
                                                                                                                    \
            template<class Sig>                                                                                     \
            struct concept_name : boost_type_erasure_impl::concept_name##free<Sig>                                  \
            {                                                                                                       \
            };                                                                                                      \
                                                                                                                    \
            template<class Sig>                                                                                     \
            ::boost::type_erasure::detail::                                                                         \
                free_choose_interface<Sig, concept_name, boost_type_erasure_impl::concept_name##_free_interface>    \
                    boost_type_erasure_find_interface(concept_name<Sig>);

        #define BOOST_TYPE_ERASURE_FREE_SIMPLE(name, ...) BOOST_TYPE_ERASURE_FREE_I(has_##name, name)

        #define BOOST_TYPE_ERASURE_FREE_NS_I(concept_name, name) BOOST_TYPE_ERASURE_FREE_I(concept_name, name)

        #define BOOST_TYPE_ERASURE_FREE_NS(concept_name, name)                                  \
            BOOST_TYPE_ERASURE_OPEN_NAMESPACE(concept_name)                                     \
            BOOST_TYPE_ERASURE_FREE_NS_I(                                                       \
                BOOST_PP_SEQ_ELEM(BOOST_PP_DEC(BOOST_PP_SEQ_SIZE(concept_name)), concept_name), \
                name)                                                                           \
            BOOST_TYPE_ERASURE_CLOSE_NAMESPACE(concept_name)

        #define BOOST_TYPE_ERASURE_FREE_NAMED(concept_name, name, ...)                                                 \
            BOOST_PP_IF(BOOST_PP_IS_BEGIN_PARENS(concept_name), BOOST_TYPE_ERASURE_FREE_NS, BOOST_TYPE_ERASURE_FREE_I) \
            (concept_name, name)
                ...
                namespace type_erasure {                                                                             \
                    ...
                    {                                                                                                \
                        ...
                        friend typename ::boost::type_erasure::rebind_any<Base, R>::type function_name(              \
                            typename ::boost::mpl::eval_if_c<                                                        \
                                (_boost_type_erasure_free_p_idx::value == I),                                        \
                                ::boost::type_erasure::detail::maybe_const_this_param<T, Base>,                      \
                                ::boost::type_erasure::as_param<Base, T>>::type... t)                                \
                        {                                                                                            \
                            return ::boost::type_erasure::call(                                                      \
                    ...
                    struct concept_interface<BOOST_TYPE_ERASURE_QUALIFIED_NAME(qual_name) < R(T...)>, Base,          \
                        typename ::boost::type_erasure::detail::first_placeholder<typename ::boost::remove_cv<       \
                            typename ::boost::remove_reference<T>::type>::type...>::type > :                         \
                        inject##concept_name<                                                                        \
                            R(T...),                                                                                 \
                            Base,                                                                                    \
                            typename ::boost::type_erasure::detail::make_index_list<sizeof...(T)>::type>             \
                    {                                                                                                \
                    };                                                                                               \
                }                                                                                                    \
            }
