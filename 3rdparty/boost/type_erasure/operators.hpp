...
#define BOOST_TYPE_ERASURE_UNARY_INPLACE_OPERATOR(name, op)                                                           \
    ...
    struct concept_interface<                                                                                         \
        ...
        Base,                                                                                                         \
        T,                                                                                                            \
        typename ::boost::enable_if<detail::should_be_non_const<T, Base>>::type> : Base                               \
    {                                                                                                                 \
        ...
        {                                                                                                             \
            typename ::boost::type_erasure::rebind_any<Base, T>::type result(static_cast<_derived&>(*this));          \
            ::boost::type_erasure::call(name<T>(), *this);                                                            \
            return result;                                                                                            \
        }                                                                                                             \
    };                                                                                                                \
                                                                                                                      \
    template<class T, class Base>                                                                                     \
    struct concept_interface<name<T>, Base, T, typename ::boost::enable_if<detail::should_be_const<T, Base>>::type> : \
        Base                                                                                                          \
    {                                                                                                                 \
        typedef typename ::boost::type_erasure::derived<Base>::type _derived;                                         \
        ...
        {                                                                                                             \
            typename ::boost::type_erasure::rebind_any<Base, T>::type result(static_cast<const _derived&>(*this));    \
            ::boost::type_erasure::call(name<T>(), *this);                                                            \
            return result;                                                                                            \
        }                                                                                                             \
    };
...
#define BOOST_TYPE_ERASURE_BINARY_OPERATOR(name, op)                                                                 \
    ...
    {                                                                                                                \
        friend typename rebind_any<Base, R>::type                                                                    \
            operator op(const typename derived<Base>::type& lhs, typename as_param<Base, const U&>::type rhs)        \
        {                                                                                                            \
    ...
    struct concept_interface<                                                                                        \
        ...
        Base,                                                                                                        \
        U,                                                                                                           \
        typename ::boost::disable_if<::boost::type_erasure::is_placeholder<T>>::type> : Base                         \
    {                                                                                                                \
        friend typename rebind_any<Base, R>::type operator op(const T& lhs, const typename derived<Base>::type& rhs) \
        {                                                                                                            \
            return ::boost::type_erasure::call(name<T, U, R>(), lhs, rhs);                                           \
        }                                                                                                            \
    };
...
#define BOOST_TYPE_ERASURE_ASSIGNMENT_OPERATOR(name, op)                                                          \
    ...
    struct concept_interface<                                                                                     \
        ...
        typename ::boost::disable_if<                                                                             \
            ::boost::is_same<typename ::boost::type_erasure::placeholder_of<Base>::type, const T&>>::type> : Base \
    {                                                                                                             \
        friend typename detail::non_const_this_param<Base>::type& operator op(                                    \
            typename detail::non_const_this_param<Base>::type& lhs,                                               \
    ...
    struct concept_interface<                                                                                     \
        ...
        typename ::boost::disable_if<::boost::type_erasure::is_placeholder<T>>::type> : Base                      \
    {                                                                                                             \
        friend T& operator op(T& lhs, const typename derived<Base>::type& rhs)                                    \
        {                                                                                                         \
            ::boost::type_erasure::call(name<T, U>(), lhs, rhs);                                                  \
            return lhs;                                                                                           \
        }                                                                                                         \
...
#undef BOOST_TYPE_ERASURE_ASSIGNMENT_OPERATOR
        ...
        {
            friend bool operator==(const typename derived<Base>::type& lhs, typename as_param<Base, const U&>::type rhs)
            {
            ...
            typename ::boost::disable_if<::boost::type_erasure::is_placeholder<T>>::type> : Base
        {
            ...
            friend bool operator!=(const T& lhs, const typename derived<Base>::type& rhs) { return !(lhs == rhs); }
        };
        ...
        namespace detail {
            ...
            bool less_impl(const F& f, const T& lhs, const U& rhs, ::boost::mpl::true_)
            {
                if (::boost::type_erasure::check_match(f, lhs, rhs)) {
                    ...
                    return ::boost::type_erasure::typeid_of(static_cast<const typename derived<T>::type&>(lhs))
                               .before(
                                   ::boost::type_erasure::typeid_of(
                                       static_cast<const typename derived<U>::type&>(rhs))) != false;
                }
            }
        ...
        {
            friend bool operator<(const typename derived<Base>::type& lhs, typename as_param<Base, const T&>::type rhs)
            {
                return ::boost::type_erasure::detail::less_impl(
                    less_than_comparable<T, T>(),
                    lhs,
                    rhs,
                    ::boost::type_erasure::is_relaxed<typename ::boost::type_erasure::concept_of<Base>::type>());
            }
            ...
            friend bool operator>(typename as_param<Base, const T&>::type lhs, const typename derived<Base>::type& rhs)
            {
                return rhs < lhs;
            }
        ...
        struct concept_interface<less_than_comparable<T, U>, Base, T> : Base
        {
            ...
            friend bool operator>(typename as_param<Base, const U&>::type lhs, const typename derived<Base>::type& rhs)
            {
                return rhs < lhs;
            }
            ...
            typename ::boost::disable_if<::boost::type_erasure::is_placeholder<T>>::type> : Base
        {
            ...
            friend bool operator>(const typename derived<Base>::type& lhs, const T& rhs) { return rhs < lhs; }
        ...
        struct concept_interface<
            ...
            typename ::boost::enable_if<::boost::type_erasure::detail::should_be_non_const<T, Base>>::type> : Base
        {
            typename ::boost::type_erasure::rebind_any<Base, R>::type
                operator[](typename ::boost::type_erasure::as_param<Base, const N&>::type index)
            {
        ...
        struct concept_interface<
            ...
            Base,
            typename ::boost::remove_const<T>::type,
            typename ::boost::enable_if<::boost::type_erasure::detail::should_be_const<T, Base>>::type> : Base
        {
            typename ::boost::type_erasure::rebind_any<Base, R>::type
                operator[](typename ::boost::type_erasure::as_param<Base, const N&>::type index) const
            {
        ...
        {
            friend typename detail::non_const_this_param<Base>::type& operator<<(
                typename detail::non_const_this_param<Base>::type& lhs,
        ...
        struct concept_interface<
            ...
            Base,
            T,
            typename ::boost::disable_if<::boost::type_erasure::is_placeholder<Os>>::type> : Base
        {
            friend Os& operator<<(Os& lhs, const typename ::boost::type_erasure::derived<Base>::type& rhs)
            {
                ::boost::type_erasure::call(ostreamable<Os, T>(), lhs, rhs);
                return lhs;
            }
        ...
        struct concept_interface<
            ...
            Base,
            T,
            typename ::boost::disable_if<::boost::type_erasure::is_placeholder<Is>>::type> : Base
        {
            friend Is& operator>>(Is& lhs, typename ::boost::type_erasure::derived<Base>::type& rhs)
            {
                ::boost::type_erasure::call(istreamable<Is, T>(), lhs, rhs);
                return lhs;
            }
