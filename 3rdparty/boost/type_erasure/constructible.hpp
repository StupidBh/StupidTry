...
namespace boost {
    namespace type_erasure {
        ...
        {
            static ::boost::type_erasure::detail::storage apply(T... arg)
            {
        ...
        struct concept_interface<::boost::type_erasure::constructible<Tag(T...)>, Base, Tag> : Base
        {
            using Base::_boost_type_erasure_deduce_constructor;

            ::boost::type_erasure::constructible<Tag(T...)>*
                _boost_type_erasure_deduce_constructor(typename ::boost::type_erasure::as_param<Base, T>::type...) const
            {
                return 0;
            }
        };
        ...
        namespace detail {
            ...
            {
                static ::boost::type_erasure::detail::storage value(T...)
                {
                    ::boost::type_erasure::detail::storage result;
                    result.data = 0;
                    return result;
    ...
    #define BOOST_TYPE_ERASURE_ARG_DECL(z, n, data) \
        typename ::boost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>::type
...
{
    static ::boost::type_erasure::detail::storage apply(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        ::boost::type_erasure::detail::storage result;
...
struct concept_interface<::boost::type_erasure::constructible<Tag(BOOST_PP_ENUM_PARAMS(N, T))>, Base, Tag> : Base
{
    using Base::_boost_type_erasure_deduce_constructor;

    ::boost::type_erasure::constructible<Tag(BOOST_PP_ENUM_PARAMS(N, T))>*
        _boost_type_erasure_deduce_constructor(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_ARG_DECL, ~)) const
    {
        return 0;
    }
};
...
namespace detail {
    ...
    {
        static ::boost::type_erasure::detail::storage value(BOOST_PP_ENUM_PARAMS(N, T))
        {
            ::boost::type_erasure::detail::storage result;
            result.data = 0;
            return result;
