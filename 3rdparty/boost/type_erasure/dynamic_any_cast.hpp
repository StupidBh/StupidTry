...
namespace boost {
    namespace type_erasure {
        ...
        namespace detail {
            ...
            {
                typedef ::boost::mpl::map<::boost::mpl::pair<
                    typename ::boost::remove_const<typename ::boost::remove_reference<
                        typename ::boost::type_erasure::placeholder_of<R>::type>::type>::type,
                    typename ::boost::remove_const<typename ::boost::remove_reference<Tag>::type>::type>>
                    type;
            };
...
#endif
            {
                ...
                typedef typename ::boost::type_erasure::detail::normalize_concept<
                    typename ::boost::type_erasure::concept_of<src_type>::type>::type normalized;
                ...
                typedef typename ::boost::remove_const<typename ::boost::remove_reference<
                    typename ::boost::type_erasure::placeholder_of<R>::type>::type>::type result_placeholder;
        ...
        {
            return ::boost::type_erasure::detail::dynamic_any_cast_impl<R>(
                arg,
                ::boost::type_erasure::make_binding<
                    typename ::boost::type_erasure::detail::make_result_placeholder_map<R, Tag>::type>());
        }
