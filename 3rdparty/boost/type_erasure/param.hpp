...
namespace boost {
    namespace type_erasure {
        ...
        public:
            ...
            template<class U>
            param(
                const any<Concept, U>& a
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
                ,
                typename boost::enable_if<
                    ::boost::type_erasure::detail::placeholder_conversion<typename ::boost::add_const<U>::type, T>>::
                    type* = 0
#endif
                ) :
                _impl(a)
            ...
            /** INTERNAL ONLY */
            param(
                const ::boost::type_erasure::detail::storage& data,
        ...
        public:
            ...
            template<class U>
            param(U& u, typename boost::enable_if<::boost::is_same<U, const any<Concept, T>>>::type* = 0) :
                _impl(u)
            {
            }
        ...
        protected:
            ...
            {
                _impl_t(
                    const ::boost::type_erasure::detail::storage& data_,
