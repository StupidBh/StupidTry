...
namespace boost {
    namespace type_erasure {
        ...
        typename ::boost::type_erasure::detail::call_impl<Sig, U...>::type call(const Op&, U&&... args);
        ...
        namespace detail {
            ...
            struct call_result :
                call_impl<typename ::boost::type_erasure::detail::get_signature<Op>::type, Args, Concept>
            {
            };
        ...
        namespace detail {
            ...
            {
                const ::boost::type_erasure::binding<
                    typename ::boost::type_erasure::detail::extract_concept<void(T...), U...>::type>* result = 0;
            ...
            template<class R, class... T, class... U>
            const ::boost::type_erasure::binding<::boost::type_erasure::detail::extract_concept_t<
                ::boost::mp11::mp_list<T...>,
                ::boost::mp11::mp_list<U...>>>* extract_table(R (*)(T...), const U&... arg)
            {
                const ::boost::type_erasure::binding<::boost::type_erasure::detail::extract_concept_t<
                    ::boost::mp11::mp_list<T...>,
                    ::boost::mp11::mp_list<U...>>>* result = 0;
            ...
            struct call_impl_dispatch<R(T...), void(U...), Concept, false>
            {
                ...
                {
                    return table->template find<F>()(::boost::type_erasure::detail::convert_arg(
                        ::std::forward<U>(arg),
                        ::boost::type_erasure::detail::is_placeholder_arg<T>())...);
                }
            };
            ...
            struct call_impl_dispatch<R(T...), void(U...), Concept, true>
            {
                ...
                {
                    return type(
                        table->template find<F>()(::boost::type_erasure::detail::convert_arg(
                            ::std::forward<U>(arg),
                            ::boost::type_erasure::detail::is_placeholder_arg<T>())...),
                        *table);
                }
            ...
            struct call_impl<R(T...), void(U...), void, true> :
                ::boost::type_erasure::detail::call_impl_dispatch<
                    R(T...),
                    void(U...),
                    typename ::boost::type_erasure::detail::
                        extract_concept<void(T...), typename ::boost::remove_reference<U>::type...>::type,
                    ::boost::type_erasure::detail::is_placeholder_arg<R>::value>
            {
            };
        ...
        template<class Concept, class Op, class... U>
        typename ::boost::type_erasure::detail::call_result<Op, void(U&&...), Concept>::type
            unchecked_call(const ::boost::type_erasure::binding<Concept>& table, const Op&, U&&... arg)
        {
            return ::boost::type_erasure::detail::
                call_impl<typename ::boost::type_erasure::detail::get_signature<Op>::type, void(U && ...), Concept>::
                    template apply<typename ::boost::type_erasure::detail::adapt_to_vtable<Op>::type>(
                        &table,
                        std::forward<U>(arg)...);
        }
        ...
        template<class Op, class... U>
        typename ::boost::type_erasure::detail::call_result<Op, void(U&&...)>::type
            unchecked_call(const Op&, U&&... arg)
        {
            return ::boost::type_erasure::detail::
                call_impl<typename ::boost::type_erasure::detail::get_signature<Op>::type, void(U && ...)>::
                    template apply<typename ::boost::type_erasure::detail::adapt_to_vtable<Op>::type>(
...
namespace detail {
    ...
    template<class R, BOOST_PP_ENUM_PARAMS(N, class T), BOOST_PP_ENUM_PARAMS(N, class U)>
        const ::boost::type_erasure::binding<
            typename ::boost::type_erasure::detail::BOOST_PP_CAT(extract_concept, N) < BOOST_PP_ENUM_PARAMS(N, T),
            BOOST_PP_ENUM_PARAMS(N, U)>::type >
        *BOOST_PP_CAT(extract_table, N)(
            R (*)(BOOST_PP_ENUM_PARAMS(N, T)),
            BOOST_PP_ENUM_BINARY_PARAMS(N, const U, &arg))
    {
        const ::boost::type_erasure::binding<
            typename ::boost::type_erasure::detail::BOOST_PP_CAT(extract_concept, N) < BOOST_PP_ENUM_PARAMS(N, T),
    ...
    template<
        class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T) BOOST_PP_ENUM_TRAILING_PARAMS(N, class U),
        class Concept
    #if N != 0
        = typename ::boost::type_erasure::detail::BOOST_PP_CAT(extract_concept, N) < BOOST_PP_ENUM_PARAMS(N, T),
    ...
    template<class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T) BOOST_PP_ENUM_TRAILING_PARAMS(N, class U), class Concept>
    struct BOOST_PP_CAT(
        call_impl,
        N)<R BOOST_PP_ENUM_TRAILING_PARAMS(N, T) BOOST_PP_ENUM_TRAILING_PARAMS(N, U), Concept, false>
    {
        typedef R type;

        template<class F>
        static R
            apply(const ::boost::type_erasure::binding<Concept>* table BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, arg))
        {
            return table->template find<F>()(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_CONVERT_ARG, ~));
        }
    };
    ...
    struct BOOST_PP_CAT(
        call_impl,
        N)<R BOOST_PP_ENUM_TRAILING_PARAMS(N, T) BOOST_PP_ENUM_TRAILING_PARAMS(N, U), Concept, true>
    {
        typedef ::boost::type_erasure::any<Concept, R> type;
        ...
        static type
            apply(const ::boost::type_erasure::binding<Concept>* table BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, arg))
        {
            return type(table->template find<F>()(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_CONVERT_ARG, ~)), *table);
        }
    };
    ...
    template<class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T) BOOST_PP_ENUM_TRAILING_PARAMS(N, class U)>
    ...
    #else
        #define RREF &&
        #define BOOST_TYPE_ERASURE_FORWARD_ARGS_I(z, n, data)               \
            std::forward<BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 0, data), n)>( \
                BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 1, data), n))
        #define BOOST_TYPE_ERASURE_FORWARD_ARGS(N, X, x) \
            BOOST_PP_ENUM_TRAILING(N, BOOST_TYPE_ERASURE_FORWARD_ARGS_I, (X, x))
    #endif

template<class Concept, class Op BOOST_PP_ENUM_TRAILING_PARAMS(N, class U)>
typename ::boost::type_erasure::detail::call_result<Op, void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, RREF u)), Concept>::type
    unchecked_call(
        const ::boost::type_erasure::binding<Concept>& table,
        const Op& BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
...
typename ::boost::type_erasure::detail::call_result<Op, void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, RREF u)), Concept>::type
    call(
        const ::boost::type_erasure::binding<Concept>& table,
        const Op& f BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
...
template<class Op BOOST_PP_ENUM_TRAILING_PARAMS(N, class U)>
typename ::boost::type_erasure::detail::call_result<Op, void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, RREF u))>::type
    unchecked_call(const Op& BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    return ::boost::type_erasure::detail::call_impl<
        typename ::boost::type_erasure::detail::get_signature<Op>::type,
        void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, RREF u))>::
        template apply<typename ::boost::type_erasure::detail::adapt_to_vtable<Op>::type>(
            ::boost::type_erasure::detail::BOOST_PP_CAT(extract_table, N)(
                ...
                BOOST_PP_ENUM_PARAMS(N, arg)) BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}

template<class Op BOOST_PP_ENUM_TRAILING_PARAMS(N, class U)>
typename ::boost::type_erasure::detail::call_result<Op, void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, RREF u))>::type
    call(const Op& f BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
