...
#include <boost/type_erasure/detail/member11.hpp>
    ...
    #define BOOST_TYPE_ERASURE_MEMBER_ARG(z, n, data) \
        ...
        #define BOOST_TYPE_ERASURE_MEMBER_ENUM_PARAMS(N, X) BOOST_PP_ENUM_PARAMS(N, X)
            ...
            /** INTERNAL ONLY */
            #define BOOST_TYPE_ERASURE_MEMBER_FORWARD(z, n, data)                 \
                ::std::forward<BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 0, data), n)>( \
                    BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 1, data), n))
            /** INTERNAL ONLY */
            #define BOOST_TYPE_ERASURE_MEMBER_FORWARD_PARAMS(N, X, x) \
                BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_MEMBER_FORWARD, (X, x))
            /** INTERNAL ONLY*/
            #define BOOST_TYPE_ERASURE_FORWARD_REBIND1(z, n, data)                                        \
                ::std::forward<typename ::boost::type_erasure::as_param<Base, BOOST_PP_CAT(A, n)>::type>( \
                    BOOST_PP_CAT(a, n))
            /** INTERNAL ONLY*/
            #define BOOST_TYPE_ERASURE_MEMBER_FORWARD_REBIND(N) \
                BOOST_PP_ENUM_TRAILING(N, BOOST_TYPE_ERASURE_FORWARD_REBIND1, ~)
        ...
        /** INTERNAL ONLY */
        #define BOOST_TYPE_ERASURE_MEMBER_ENUM_TRAILING_BINARY_PARAMS(N, X, x) \
            BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, X, x)
        /** INTERNAL ONLY */
        ...
        #define BOOST_TYPE_ERASURE_MEMBER_ENUM_PARAMS(N, X)  X...
            ...
            #define BOOST_TYPE_ERASURE_MEMBER_FORWARD_REBIND(N) \
                , ::std::forward<typename ::boost::type_erasure::as_param<Base, A>::type>(a)...
        #else
            ...
            namespace type_erasure {                                                                        \
                ...
                struct concept_interface<                                                                   \
                    ...
                    typename ::boost::enable_if<                                                            \
                        ...
                        typename ::boost::remove_const<T>::type>::type,                                     \
                    Enable> : Base                                                                          \
                {                                                                                           \
                    typedef void BOOST_PP_CAT(_boost_type_erasure_has_member, member);                      \
                    typename rebind_any<Base, R>::type member(BOOST_TYPE_ERASURE_MEMBER_ENUM_ARGS(N))       \
                    {                                                                                       \
                ...
                {                                                                                           \
                    typedef void BOOST_PP_CAT(_boost_type_erasure_has_member, member);                      \
                    typename rebind_any<Base, R>::type member(BOOST_TYPE_ERASURE_MEMBER_ENUM_ARGS(N)) const \
                    {                                                                                       \
                        return ::boost::type_erasure::call(                                                 \
                            BOOST_TYPE_ERASURE_MEMBER_QUALIFIED_ID(qual_name, N)(),                         \
                            *this BOOST_TYPE_ERASURE_MEMBER_FORWARD_REBIND(N));                             \
