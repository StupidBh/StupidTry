...
namespace boost {
    namespace type_erasure {
        ...
        {
            static R apply(F& f, T... arg) { return f(std::forward<T>(arg)...); }
        };

        template<class... T, class F>
        struct callable<void(T...), F>
        {
            static void apply(F& f, T... arg) { f(std::forward<T>(arg)...); }
        };

        template<class R, class F, class Base, class Enable, class... T>
        struct concept_interface<callable<R(T...), F>, Base, F, Enable> : Base
        {
            template<class Sig>
            struct result : ::boost::type_erasure::detail::result_of_callable<Sig>
            {
            };
            ...
            _boost_type_erasure_callable_size
                _boost_type_erasure_deduce_callable(typename ::boost::type_erasure::as_param<Base, T>::type...);
        ...
        struct concept_interface<callable<R(T...), const F>, Base, F, Enable> : Base
        {
            ...
            typedef char (&_boost_type_erasure_callable_size)[1];
            _boost_type_erasure_callable_size
                _boost_type_erasure_deduce_callable(typename ::boost::type_erasure::as_param<Base, T>::type...) const;
        ...
        struct concept_interface<callable<R(T...), F>, Base, F, typename Base::_boost_type_erasure_is_callable> : Base
        {
            typedef typename ::boost::mpl::push_back<typename Base::_boost_type_erasure_callable_results, R>::type
                _boost_type_erasure_callable_results;
            typedef char (
                &_boost_type_erasure_callable_size)[::boost::mpl::size<_boost_type_erasure_callable_results>::value];
        ...
        namespace detail {
            ...
            struct result_of_callable<This(T...)>
            {
                typedef typename ::boost::mpl::at_c<
                    ...
                    sizeof(::boost::declval<This>()._boost_type_erasure_deduce_callable(::boost::declval<T>()...)) -
                        1>::type type;
            };
    ...
    #else
        #define BOOST_TYPE_ERASURE_FORWARD(z, n, data)                        \
            ::std::forward<BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 0, data), n)>( \
                BOOST_PP_CAT(BOOST_PP_TUPLE_ELEM(2, 1, data), n))
        #define BOOST_TYPE_ERASURE_FORWARD_REBIND(z, n, data)                                         \
            ::std::forward<typename ::boost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>::type>( \
                BOOST_PP_CAT(arg, n))
    #endif
...
struct concept_interface<callable<R(BOOST_PP_ENUM_PARAMS(N, T)), F>, Base, F, Enable> : Base
{
    template<class Sig>
    struct result : ::boost::type_erasure::detail::result_of_callable<Sig>
    {
    ...
    typedef char (&_boost_type_erasure_callable_size)[1];
    _boost_type_erasure_callable_size
        _boost_type_erasure_deduce_callable(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_REBIND, ~));

    typename ::boost::type_erasure::rebind_any<Base, R>::type operator()(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_REBIND, ~))
    {
        return ::boost::type_erasure::call(
...
template<class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T), class F, class Base, class Enable>
struct concept_interface<callable<R(BOOST_PP_ENUM_PARAMS(N, T)), const F>, Base, F, Enable> : Base
{
    template<class Sig>
    struct result : ::boost::type_erasure::detail::result_of_callable<Sig>
    {
    ...
    typedef char (&_boost_type_erasure_callable_size)[1];
    _boost_type_erasure_callable_size
        _boost_type_erasure_deduce_callable(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_REBIND, ~)) const;
...
struct concept_interface<
    ...
    Base,
    F,
    typename Base::_boost_type_erasure_is_callable> : Base
{
    typedef typename ::boost::mpl::push_back<typename Base::_boost_type_erasure_callable_results, R>::type
        _boost_type_erasure_callable_results;
...
namespace detail {
    ...
    struct result_of_callable<This(BOOST_PP_ENUM_PARAMS(N, T))>
    {
        typedef typename ::boost::mpl::at_c<
            typename This::_boost_type_erasure_callable_results,
            sizeof(::boost::declval<This>()._boost_type_erasure_deduce_callable(
                BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_DECLVAL, ~))) -
                1>::type type;
    };
