...
namespace boost {
    namespace type_erasure {
        namespace detail {
            ...
            struct qualified_placeholder<T&, typename T::_boost_type_erasure_is_any>
            {
                ...
                typedef typename ::boost::mpl::if_<::boost::is_const<T>, const unref, unref>::type add_const;
                typedef
                    typename ::boost::mpl::if_<::boost::is_reference<placeholder>, placeholder, add_const&>::type type;
            };
            ...
            struct check_placeholder_arg :
                check_placeholder_arg_impl<
                    P,
                    typename ::boost::type_erasure::detail::qualified_placeholder<Arg>::type>::type
            {
            };

        #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) &&                                       \
            ((defined(__GNUC__) && !(__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ > 6))) || \
             defined(__MINGW32__) || defined(__MINGW64__) || BOOST_WORKAROUND(BOOST_MSVC, <= 1700))
            ...
            template<class P, class Arg>
            using check_placeholder_arg_t = typename ::boost::type_erasure::detail::check_placeholder_arg_impl<
                P,
                typename ::boost::type_erasure::detail::qualified_placeholder<Arg>::type>::type;
            ...
            using check_arg_t = ::boost::type_erasure::detail::eval_if<
                ::boost::type_erasure::is_placeholder<
                    ::boost::remove_cv_t<::boost::remove_reference_t<FormalArg>>>::value,
            ...
            {
                typedef ::boost::mp11::mp_all<typename ::boost::type_erasure::detail::check_arg<T, U>::type...> type;
            };
            ...
            struct check_arg
            {
                typedef typename ::boost::mpl::eval_if<
                    is_placeholder<
                        typename ::boost::remove_cv<typename ::boost::remove_reference<FormalArg>::type>::type>,
            ...
            struct check_call<R(T...), void(U...)>
            {
                typedef typename ::boost::type_erasure::detail::and_<
                    ::boost::type_erasure::detail::check_arg<T, U>...>::type type;
            };
    ...
    #define BOOST_TYPE_ERASURE_CHECK_ARG(z, n, data)                                                            \
        typedef typename ::boost::type_erasure::detail::check_arg<BOOST_PP_CAT(T, n), BOOST_PP_CAT(U, n)>::type \
            BOOST_PP_CAT(check, n);                                                                             \
        typedef typename ::boost::mpl::and_<BOOST_PP_CAT(type, n), BOOST_PP_CAT(check, n)>::type BOOST_PP_CAT(  \
            type,                                                                                               \
            BOOST_PP_INC(n));
