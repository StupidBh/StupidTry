        ...
        namespace detail {
            ...
            struct get_null_vtable_entry
            {
                typedef ::boost::type_erasure::detail::null_throw<
                    typename ::boost::remove_pointer<typename Concept::type>::type>
                    type;
            };
            ...
            {
                static R value(T...) { BOOST_THROW_EXCEPTION(::boost::type_erasure::bad_function_call()); }
            };
...
{
    static R value(BOOST_PP_ENUM_PARAMS(N, T)) { BOOST_THROW_EXCEPTION(::boost::type_erasure::bad_function_call()); }
};
