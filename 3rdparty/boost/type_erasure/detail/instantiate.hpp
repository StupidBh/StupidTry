...
namespace boost {
    namespace type_erasure {
        namespace detail {
            ...
            {
                template<class T>
                using apply = typename ::boost::type_erasure::detail::rebind_placeholders<T, Map>::type;
            };

            template<class Concept, class Map>
            using make_instantiate_concept =
                ::boost::type_erasure::detail::make_instantiate_concept_impl<::boost::mp11::mp_transform<
                    ::boost::type_erasure::detail::instantiate_concept_rebind_f<
                        typename ::boost::type_erasure::detail::add_deductions<
                            ...
                            typename ::boost::type_erasure::detail::get_placeholder_normalization_map<Concept>::type>::
                            type>::template apply,
            ...
            #define BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, P0, T0)                                            \
                ((void)(typename ::boost::type_erasure::detail::                                                \
                            make_instantiate_concept<Concept, ::boost::mpl::map1<::boost::mpl::pair<P0, T0>>>:: \
                                template apply<::boost::type_erasure::detail::instantiate_concept_impl>*)0)
            ...
            struct make_instantiate_concept
            {
                ...
                typedef typename ::boost::type_erasure::detail::make_instantiate_concept_impl<(
                    ::boost::mpl::size<normalized>::value)>::type type;
            };

            #define BOOST_TYPE_ERASURE_INSTANTIATE(Concept, Map) \
                (::boost::type_erasure::detail::make_instantiate_concept<Concept>::type::apply((Concept*)0, (Map*)0))

            #define BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, P0, T0)                            \
                (::boost::type_erasure::detail::make_instantiate_concept<Concept>::type::apply( \
                    (Concept*)0,                                                                \
    ...
    #define BOOST_TYPE_ERASURE_INSTANTIATE_IMPL(z, n, data) (void)&::boost::mpl::at_c<data, n>::type::apply;
...
struct BOOST_PP_CAT(instantiate_concept, N)
{
    ...
    static void apply(Concept*, Map*)
    {
        ...
        typedef typename ::boost::type_erasure::detail::normalize_concept<Concept>::type normalized;
        typedef
            typename ::boost::type_erasure::detail::get_placeholder_normalization_map<Concept>::type placeholder_subs;

        typedef typename ::boost::mpl::transform<
            normalized,
            ::boost::type_erasure::detail::rebind_placeholders<
                ::boost::mpl::_1,
                typename ::boost::type_erasure::detail::add_deductions<Map, placeholder_subs>::type>>::type
            concept_sequence;
    #endif
