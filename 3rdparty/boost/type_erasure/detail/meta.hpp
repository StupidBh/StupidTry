...
#include <boost/config.hpp>
    ...
    !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES) && /* MSVC 14.0 breaks down in the template alias quagmire. */ \
        ...
        namespace detail {
            ...
            struct make_mp_list_impl
            {
                typedef typename ::boost::mpl::
                    fold<T, ::boost::mp11::mp_list<>, ::boost::type_erasure::detail::mp11_list_inserter>::type type;
            };
