...
namespace boost {
    namespace type_erasure {
        ...
        namespace detail {
            ...
            template<class T, class Bindings>
            using rebind_placeholders_in_argument_t =
                typename ::boost::type_erasure::detail::rebind_placeholders_in_argument_impl<T>::template apply<
                    Bindings>;

            template<class T, class Bindings>
            using rebind_placeholders_in_argument =
                ::boost::mpl::identity<::boost::type_erasure::detail::rebind_placeholders_in_argument_t<T, Bindings>>;
            ...
            using rebind_placeholders_in_deduced = typename ::boost::type_erasure::deduced<
                ::boost::type_erasure::detail::rebind_placeholders_t<F, Bindings>>::type;

            template<class F, class Bindings>
            using rebind_deduced_placeholder =
                ::boost::mp11::mp_second<::boost::mp11::mp_map_find<Bindings, ::boost::type_erasure::deduced<F>>>;

            template<class F>
            struct rebind_placeholders_in_argument_impl<::boost::type_erasure::deduced<F>>
            {
                template<class Bindings>
                using apply = ::boost::type_erasure::detail::eval_if<
            ...
            struct rebind_placeholders_in_argument_impl<R(T...)>
            {
                template<class Bindings>
                using apply =
                    rebind_placeholders_in_argument_t<R, Bindings>(rebind_placeholders_in_argument_t<T, Bindings>...);
            };
            ...
            struct rebind_placeholders_in_argument_impl<R (C::*)(T...)>
            {
                template<class Bindings>
                using apply =
                    rebind_placeholders_in_argument_t<R, Bindings> (rebind_placeholders_in_argument_t<C, Bindings>::*)(
            ...
            struct rebind_placeholders_in_argument
            {
                ...
                typedef typename ::boost::mpl::eval_if<
                    ...
                    ::boost::type_erasure::detail::identity<T>>::type type;
            };
            ...
            {
                typedef
                    typename ::boost::type_erasure::detail::rebind_placeholders_in_argument<T, Bindings>::type& type;
            };
            ...
            {
                typedef const typename ::boost::type_erasure::detail::rebind_placeholders_in_argument<T, Bindings>::type
                    type;
            };
            ...
            struct rebind_placeholders_in_deduced
            {
                typedef typename ::boost::type_erasure::deduced<
                    typename ::boost::type_erasure::detail::rebind_placeholders<F, Bindings>::type>::type type;
            };

            template<class F, class Bindings>
            struct rebind_placeholders_in_argument<::boost::type_erasure::deduced<F>, Bindings>
            {
                typedef typename ::boost::mpl::eval_if<
                    ::boost::mpl::has_key<Bindings, ::boost::type_erasure::deduced<F>>,
                    ::boost::mpl::at<Bindings, ::boost::type_erasure::deduced<F>>,
                    ::boost::type_erasure::detail::rebind_placeholders_in_deduced<F, Bindings>>::type type;
            };
            ...
            {
                typedef typename ::boost::type_erasure::detail::rebind_placeholders_in_argument<R, Bindings>::type
                    type(typename rebind_placeholders_in_argument<T, Bindings>::type...);
            };
            ...
            {
                typedef typename ::boost::type_erasure::detail::rebind_placeholders_in_argument<R, Bindings>::type (
                    rebind_placeholders_in_argument<C, Bindings>::type::*type)(
...
template<template<BOOST_PP_ENUM_PARAMS(N, class T)> class T, BOOST_PP_ENUM_PARAMS(N, class T), class Bindings>
...
template<class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T), class Bindings>
struct rebind_placeholders_in_argument<R(BOOST_PP_ENUM_PARAMS(N, T)), Bindings>
{
    typedef typename ::boost::type_erasure::detail::rebind_placeholders_in_argument<R, Bindings>::type
        type(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_REBIND, T));
};
