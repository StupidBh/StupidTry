...
#include <boost/config/workaround.hpp>
    ...
    !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) && !defined(BOOST_NO_CXX11_DECLTYPE) &&          \
...
namespace boost {
        ...
        namespace detail {
            ...
            using choose_member_interface = typename ::boost::mpl::if_c<
                ...
                typename ::boost::mpl::if_c<
                    ...
                    Base>::type,
                Interface<Sig, Concept, Base, ID>>::type;
            ...
            using choose_member_impl_t = typename ::boost::type_erasure::detail::choose_member_impl<Sig(
                ::boost::type_erasure::detail::dummy::*)>::template apply<P, M, Self>;
            ...
            struct member_choose_interface
            {
                ...
                using apply = typename ::boost::type_erasure::detail::member_interface_chooser<Sig, T, ID>::
                    template apply<Base, C, M>;
            };
    ...
    #define BOOST_TYPE_ERASURE_MEMBER_I(concept_name, function_name)                                                \
        ...
        namespace boost_type_erasure_impl {                                                                         \
            ...
            {                                                                                                       \
                ...
                ::boost::type_erasure::rebind_any_t<Base, R>                                                        \
                    function_name(::boost::type_erasure::as_param_t<Base, A>... a)                                  \
                {                                                                                                   \
            ...
            {                                                                                                       \
                typedef void _boost_type_erasure_has_member##function_name;                                         \
                ::boost::type_erasure::rebind_any_t<Base, R>                                                        \
                    function_name(::boost::type_erasure::as_param_t<Base, A>... a) const                            \
                {                                                                                                   \
                    return ::boost::type_erasure::call(Concept(), *this, std::forward<A>(a)...);                    \
                }                                                                                                   \
            };                                                                                                      \
            ...
            {                                                                                                       \
                static R apply(T0 t0, T... t) { return t0.function_name(std::forward<T>(t)...); }                   \
            };                                                                                                      \
                                                                                                                    \
            template<class T0, class... T>                                                                          \
            struct concept_name##member<void(T0, T...)>                                                             \
            {                                                                                                       \
                static void apply(T0 t0, T... t) { t0.function_name(std::forward<T>(t)...); }                       \
            };                                                                                                      \
        }                                                                                                           \
                                                                                                                    \
        template<class Sig, class T>                                                                                \
        ...
        ::boost::type_erasure::detail::                                                                             \
            member_choose_interface<Sig, T, concept_name, boost_type_erasure_impl::concept_name##_member_interface> \
                boost_type_erasure_find_interface(concept_name<Sig, T>);

    #define BOOST_TYPE_ERASURE_MEMBER_SIMPLE(name, ...) BOOST_TYPE_ERASURE_MEMBER_I(has_##name, name)

    #define BOOST_TYPE_ERASURE_MEMBER_NS_I(concept_name, name) BOOST_TYPE_ERASURE_MEMBER_I(concept_name, name)

    #define BOOST_TYPE_ERASURE_MEMBER_NS(concept_name, name)                                \
        BOOST_TYPE_ERASURE_OPEN_NAMESPACE(concept_name)                                     \
        BOOST_TYPE_ERASURE_MEMBER_NS_I(                                                     \
    ...
    #define BOOST_TYPE_ERASURE_MEMBER_NAMED(concept_name, name, ...)                                                   \
        BOOST_PP_IF(BOOST_PP_IS_BEGIN_PARENS(concept_name), BOOST_TYPE_ERASURE_MEMBER_NS, BOOST_TYPE_ERASURE_MEMBER_I) \
        (concept_name, name)
