...
#include <boost/type_erasure/detail/any_base.hpp>
    ...
    !defined(BOOST_NO_CXX11_FUNCTION_TEMPLATE_DEFAULT_ARGS) && !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES) &&         \
    !BOOST_WORKAROUND(BOOST_MSVC, == 1800) && !BOOST_WORKAROUND(BOOST_GCC, < 40800) && /* Inherited constructors */ \
    ...
    namespace type_erasure {
        ...
        namespace detail {
            ...
            struct access
            {
                ...
                static const typename Derived::table_type& table(const ::boost::type_erasure::any_base<Derived>& arg)
                {
                ...
                template<
                    class Concept,
                    class T,
                    class = typename ::boost::enable_if_c<!::boost::is_reference<T>::value>::type>
                ...
                {
                    return std::move(
                        static_cast<::boost::type_erasure::any<Concept, T>&&>(arg)._boost_type_erasure_data);
                }
#endif
                template<class Derived>
                static ::boost::type_erasure::detail::storage& data(::boost::type_erasure::any_base<Derived>& arg)
                {
                ...
                static ::boost::type_erasure::detail::storage&
                    data(::boost::type_erasure::any_base<::boost::type_erasure::any<Concept, T&>>& arg)
                {
                    return const_cast<::boost::type_erasure::detail::storage&>(
                        static_cast<::boost::type_erasure::any<Concept, T&>&>(arg).data);
                }
                ...
                {
                    return const_cast<::boost::type_erasure::detail::storage&>(
                        static_cast<const ::boost::type_erasure::any<Concept, T&>&>(arg).data);
                }
                ...
                template<class Concept, class T>
                static ::boost::type_erasure::detail::storage& data(::boost::type_erasure::param<Concept, T>& arg)
                {
                ...
                {
                    return std::move(
                        const_cast<::boost::type_erasure::detail::storage&>(
                            static_cast<const ::boost::type_erasure::any<Concept, T&&>&>(arg).data));
                }
