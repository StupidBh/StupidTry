...
namespace boost {
    namespace type_erasure {
        ...
        namespace detail {
            ...
            template<class T>
            struct is_internal_concept : ::boost::type_erasure::detail::has_type<T>
            {
            };
            ...
            struct adapt_to_vtable
            {
                typedef ::boost::type_erasure::detail::vtable_adapter<
                    ...
                    typename ::boost::type_erasure::detail::get_vtable_signature<
                        typename ::boost::type_erasure::detail::get_signature<PrimitiveConcept>::type>::type>
                    type;
            };
            ...
            struct maybe_adapt_to_vtable
            {
                typedef typename ::boost::mpl::eval_if<
                    ...
                    ::boost::type_erasure::detail::adapt_to_vtable<Concept>>::type type;
            };
            ...
            struct vtable_adapter_impl<PrimitiveConcept, R(T...), R2(U...)>
            {
                ...
                {
                    return PrimitiveConcept::apply(::boost::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
                }
            };
            ...
            struct vtable_adapter_impl<PrimitiveConcept, ::boost::type_erasure::detail::storage&(T...), R2(U...)>
            {
                ...
                static ::boost::type_erasure::detail::storage value(T... arg)
                {
                    ...
                    typename ::boost::remove_reference<R2>::type* p = ::boost::addressof(
                        PrimitiveConcept::apply(::boost::type_erasure::detail::extract<U>(std::forward<T>(arg))...));
            ...
            struct vtable_adapter :
                vtable_adapter_impl<
                    PrimitiveConcept,
                    Sig,
                    typename ::boost::type_erasure::detail::get_signature<PrimitiveConcept>::type>
            {
            };
            ...
            struct get_vtable_signature<R(T...)>
            {
                typedef typename ::boost::type_erasure::detail::replace_result_for_vtable<R>::type
                    type(typename ::boost::type_erasure::detail::replace_param_for_vtable<T>::type...);
            };
    ...
    #define N BOOST_PP_ITERATION()
        ...
        #define BOOST_TYPE_ERASURE_EXTRACT(z, n, data)                                     \
            ::boost::type_erasure::detail::extract<                                        \
                typename traits::BOOST_PP_CAT(BOOST_PP_CAT(arg, BOOST_PP_INC(n)), _type)>( \
        ...
        #define BOOST_TYPE_ERASURE_EXTRACT(z, n, data) \
            ::boost::type_erasure::detail::extract<    \
                typename traits::BOOST_PP_CAT(BOOST_PP_CAT(arg, BOOST_PP_INC(n)), _type)>(BOOST_PP_CAT(arg, n))

    #endif

    #define BOOST_TYPE_ERASURE_REPLACE_PARAM(z, n, data) \
        typename ::boost::type_erasure::detail::replace_param_for_vtable<BOOST_PP_CAT(T, n)>::type

template<class PrimitiveConcept, class R BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
struct vtable_adapter<PrimitiveConcept, R(BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    static R value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        ...
        typedef typename ::boost::function_traits<
            ...
            traits;
    #endif
        return PrimitiveConcept::apply(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_EXTRACT, ~));
    }
};

template<class PrimitiveConcept BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
...
struct vtable_adapter<PrimitiveConcept, ::boost::type_erasure::detail::storage&(BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    static ::boost::type_erasure::detail::storage value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        ...
        typename ::boost::remove_reference<typename traits::result_type>::type* p =
            ::boost::addressof(PrimitiveConcept::apply(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_EXTRACT, ~)));
        result.data = const_cast<void*>(static_cast<const void*>(p));
        return result;
    }
};
...
struct vtable_adapter<PrimitiveConcept, ::boost::type_erasure::detail::storage && (BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    static ::boost::type_erasure::detail::storage value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        typedef typename ::boost::function_traits<
            ...
            traits;
        ::boost::type_erasure::detail::storage result;
        typename traits::result_type tmp = PrimitiveConcept::apply(BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_EXTRACT, ~));
        typename ::boost::remove_reference<typename traits::result_type>::type* p = ::boost::addressof(tmp);
        result.data = const_cast<void*>(static_cast<const void*>(p));
        return result;
    }
};
