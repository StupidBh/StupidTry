...
namespace boost {
    ...
    !defined(BOOST_NO_CXX11_DEFAULTED_FUNCTIONS)
            ...
            struct dynamic_binding_impl
            {
                ...
                constexpr dynamic_binding_impl(const std::type_info* t) :
                    type(t)
                {
                }
            };
            ...
            struct dynamic_vtable : dynamic_binding_impl<P>...
            {
                ...
                constexpr dynamic_vtable(typename dynamic_binding_element<P>::type... t) :
                    dynamic_binding_impl<P>(t)...
                {
                }
                ...
                {
    #ifndef BOOST_TYPE_ERASURE_USE_MP11
                    *this = dynamic_vtable((&src.lookup(
                        (::boost::type_erasure::typeid_<typename ::boost::mpl::at<Bindings, P>::type>*)0)())...);
    #else
                    *this = dynamic_vtable(
                        (&src.lookup((::boost::type_erasure::typeid_<
                                      ::boost::mp11::mp_second<::boost::mp11::mp_map_find<Bindings, P>>>*)0)())...);
    #endif
                }
            };
            ...
            struct make_dynamic_vtable : make_dynamic_vtable_impl<typename make_arg_pack<PlaceholderList>::type>
            {
            };
            ...
            {
                dynamic_vtable_initializer(const std::type_info**& ptr) :
                    types(&ptr)
                {
                }
            ...
            struct dynamic_vtable
            {
                ...
                struct append_to_key
                {
                    append_to_key(const std::type_info* const* t, key_type* k) :
                        types(t),
                        key(k)
                    {
                    }
                ...
                struct converter
                {
                    converter(const std::type_info**& t, const Src& s) :
                        types(&t),
                        src(&s)
                    {
                    }
