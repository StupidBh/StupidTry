...
namespace boost {
    namespace type_erasure {
        namespace detail {
            ...
            template<class T, class U>
            using extract_concept_or_void = ::boost::mp11::mp_eval_if_c<
                !::boost::type_erasure::is_placeholder<::boost::remove_cv_t<::boost::remove_reference_t<T>>>::value,
                void,
                ::boost::type_erasure::concept_of_t,
                U>;

            template<class L1, class L2>
            using extract_concept_t = ::boost::mp11::mp_fold<
            ...
            struct extract_concept<R(T0, T...), U0, U...>
            {
                typedef typename ::boost::type_erasure::detail::combine_concepts<
                    typename ::boost::type_erasure::detail::maybe_extract_concept<T0, U0>::type,
                    typename ::boost::type_erasure::detail::extract_concept<void(T...), U...>::type>::type type;
            };
    ...
    #define BOOST_TYPE_ERASURE_EXTRACT_CONCEPT(z, n, data)                                                          \
        typedef typename ::boost::type_erasure::detail::combine_concepts<                                           \
            typename ::boost::type_erasure::detail::maybe_extract_concept<BOOST_PP_CAT(T, n), BOOST_PP_CAT(U, n)>:: \
                type,                                                                                               \
            BOOST_PP_CAT(concept, n)>::type BOOST_PP_CAT(concept, BOOST_PP_INC(n));

template<BOOST_PP_ENUM_PARAMS(N, class T), BOOST_PP_ENUM_PARAMS(N, class U)>
