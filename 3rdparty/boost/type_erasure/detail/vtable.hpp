...
namespace boost {
        ...
        namespace detail {
            ...
            struct make_arg_pack_impl
            {
                typedef typename make_arg_pack_impl<
                    ...
                    End,
                    T...,
                    typename ::boost::mpl::deref<It>::type>::type type;
            };
            ...
            struct make_arg_pack
            {
                typedef typename make_arg_pack_impl<
                    ...
                    typename ::boost::mpl::end<Seq>::type>::type type;
            };
            ...
            struct make_vtable
            {
                typedef typename ::boost::type_erasure::detail::make_vtable_impl<
                    typename ::boost::type_erasure::detail::make_arg_pack<Seq>::type>::type type;
            };
            ...
            struct vtable_entry
            {
                ...
                constexpr vtable_entry(typename T::type arg) :
                    value(arg)
                {
                }
            };
            ...
            struct vtable_storage : vtable_entry<T>...
            {
                ...
                {
                    *this = vtable_storage(src.lookup(
                        (typename ::boost::type_erasure::detail::rebind_placeholders<T, Bindings>::type*)0)...);
                }

                bool operator==(const vtable_storage& other) const { return compare_vtable<T...>::apply(*this, other); }
            ...
            struct vtable_storage<>
            {
                ...
                bool operator==(const vtable_storage& /*other*/) const { return true; }
            };
            ...
            struct make_vtable
            {
                typedef typename make_vtable_impl<(::boost::mpl::size<Seq>::value)>::template apply<Seq>::type type;
            };
            ...
            {
                typedef
                    typename make_vtable_init_impl<(::boost::mpl::size<Seq>::value)>::template apply<Seq, Table>::type
                        type;
            };
    ...
    #define BOOST_TYPE_ERASURE_VTABLE_COMPARE(z, n, data) &&BOOST_PP_CAT(t, n) == other.BOOST_PP_CAT(t, n)

    #define BOOST_TYPE_ERASURE_VTABLE_INIT(z, n, data) BOOST_PP_CAT(data, n)::value

    #define BOOST_TYPE_ERASURE_AT(z, n, data) typename ::boost::mpl::at_c<data, n>::type

    #define BOOST_TYPE_ERASURE_CONVERT_ELEMENT(z, n, data) \
        BOOST_PP_CAT(t, n) = src.lookup(                   \
            (typename ::boost::type_erasure::detail::rebind_placeholders<BOOST_PP_CAT(T, n), Bindings>::type*)0);
...
struct make_vtable_impl<N>
{
    ...
    struct apply
    {
        typedef ::boost::type_erasure::detail::BOOST_PP_CAT(
            vtable_storage,
            N)<BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_AT, Seq)> type;
    };
};
...
template<class Table BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
const Table BOOST_PP_CAT(vtable_init, N)<Table BOOST_PP_ENUM_TRAILING_PARAMS(N, T)>::value = {
...
struct make_vtable_init_impl<N>
{
    ...
    struct apply
    {
        typedef ::boost::type_erasure::detail::BOOST_PP_CAT(
            vtable_init,
            N)<Table BOOST_PP_ENUM_TRAILING(N, BOOST_TYPE_ERASURE_AT, Seq)> type;
    };
};
