        ...
        namespace detail {
            ...
            struct should_be_non_const :
                ::boost::mpl::and_<
                    ...
                    ::boost::mpl::not_<
                        ::boost::is_reference<typename ::boost::type_erasure::placeholder_of<Base>::type>>>
            {
            };
            ...
            struct non_const_this_param
            {
                ...
                typedef typename ::boost::mpl::if_<
                    ::boost::is_same<
                        placeholder,
                        typename ::boost::remove_cv<typename ::boost::remove_reference<placeholder>::type>::type&>,
                    const plain_type,
                    plain_type>::type type;
            };
            ...
            struct maybe_const_this_param
            {
                ...
                typedef typename ::boost::mpl::if_<
                    ::boost::is_reference<Placeholder>,
                    typename ::boost::mpl::if_<
                        ...
                        typename ::boost::mpl::if_<
                            ...
                            const plain_type&,
                            uncallable<plain_type>>::type>::type,
                    plain_type>::type type;
            };
            ...
            struct maybe_const_this_param<Placeholder&&, Base>
            {
                ...
                typedef typename ::boost::mpl::if_<
                    ::boost::is_lvalue_reference<self_placeholder>,
                    ::boost::type_erasure::detail::uncallable<plain_type>,
                    typename ::boost::mpl::
                        if_<::boost::is_rvalue_reference<self_placeholder>, const plain_type&, plain_type&&>::type>::
                    type type;
            };
