...
namespace boost {
    ...
    #define BOOST_TYPE_ERASURE_NORMALIZE_PLACEHOLDER(z, n, data) \
        typename ::boost::type_erasure::detail::normalize_placeholder<M, BOOST_PP_CAT(U, n)>::type
...
{
    typedef
        typename ::boost::type_erasure::deduced<T<BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_NORMALIZE_PLACEHOLDER, ~)>>::type
            type;
};
