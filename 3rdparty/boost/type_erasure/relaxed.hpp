    ...
    namespace type_erasure {
        ...
        namespace detail {
            ...
            struct is_relaxed_impl :
                ::boost::mpl::not_<typename ::boost::is_same<
                    typename ::boost::mpl::find_if<T, ::boost::type_erasure::is_relaxed<::boost::mpl::_1>>::type,
                    typename ::boost::mpl::end<T>::type>::type>::type
            {
            };
        ...
        /** INTERNAL ONLY */
        template<>
        struct is_relaxed<::boost::type_erasure::relaxed> : ::boost::mpl::true_
        {
        };
