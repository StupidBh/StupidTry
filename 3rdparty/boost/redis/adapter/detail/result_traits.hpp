...
namespace boost::redis::adapter::detail {
    ...
    private:
        using adapters_array_type = std::
            array<mp11::mp_rename<mp11::mp_transform<adapter_t, Tuple>, std::variant>, std::tuple_size<Tuple>::value>;
    ...
    public:
        ...
        void on_init()
        {
            ...
            for (auto& adapter : adapters_) {
                visit([&](auto& arg) { arg.on_init(); }, adapter);
            }
        }
        ...
        void on_done()
        {
            using std::visit;
            for (auto& adapter : adapters_) {
                visit([&](auto& arg) { arg.on_done(); }, adapter);
            }
        }
