...
namespace boost::redis {
    ...
    public:
        ...
        static auto create_impl(T& resp) -> impl_t
        {
            ...
            return
                [adapter2 = boost_redis_adapt(
                     resp)](any_adapter::parse_event ev, resp3::node_view const& nd, system::error_code& ec) mutable {
                    switch (ev) {
        ...
        void on_node(resp3::node_view const& nd, system::error_code& ec) { impl_(parse_event::node, nd, ec); };
