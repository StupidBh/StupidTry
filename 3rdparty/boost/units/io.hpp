...
namespace boost {
    ...
    namespace units {
        ...
        struct base_unit_info
        {
            ...
            static std::string name() { return (BaseUnit::name()); }
        ...
        namespace detail {
            ...
            struct symbol_string_impl<1>
            {
                ...
                struct apply
                {
                    static void value(std::string& str) { str += base_unit_symbol_string(typename Begin::item()); }
                };
            };
            ...
            struct name_string_impl<1>
            {
                ...
                struct apply
                {
                    static void value(std::string& str) { str += base_unit_name_string(typename Begin::item()); }
                };
            };
            ...
            struct name_string_impl<0>
            {
                ...
                struct apply
                {
                    static void value(std::string& str) { str += "dimensionless"; }
                };
            };
        ...
        namespace detail {
            ...
            inline std::string to_string_impl(const unit<Dimension, System>&, SubFormatter f)
            {
            ...
            inline std::string to_string_impl(
                const unit<
                    Dimension,
                    heterogeneous_system<heterogeneous_system_impl<Units, Dimension, dimensionless_type>>>&,
                Subformatter f)
            {
                std::string str;
            ...
            inline std::string to_string_impl(
                const unit<
                    ...
                    heterogeneous_system<
                        heterogeneous_system_impl<dimensionless_type, dimensionless_type, dimensionless_type>>>&,
                Subformatter)
            {
            ...
            inline std::string to_string_impl(
                const unit<
                    dimensionless_type,
                    heterogeneous_system<heterogeneous_system_impl<dimensionless_type, dimensionless_type, Scale>>>&,
                Subformatter f)
            {
                std::string str;
            ...
            inline std::string to_string_impl(
                const unit<Dimension, heterogeneous_system<heterogeneous_system_impl<Units, Dimension, Scale>>>&,
                Subformatter f)
            {
                std::string str;
                ...
                std::string without_scale =
                    f(unit<
                        Dimension,
                        heterogeneous_system<heterogeneous_system_impl<Units, Dimension, dimensionless_type>>>());

                if (f.is_default_string(
                        without_scale,
                        unit<
                            Dimension,
                            heterogeneous_system<heterogeneous_system_impl<Units, Dimension, dimensionless_type>>>())) {
            ...
            inline std::string to_string_impl(
                const unit<
                    Dimension,
                    heterogeneous_system<heterogeneous_system_impl<
            ...
            {
                std::string str;
                f.template append_units_to<
                    list<heterogeneous_system_dim<Unit, static_rational<1>>, dimensionless_type>>(str);
                return (str);
            }
            ...
            inline std::string to_string_impl(
                const unit<
                    ...
                    heterogeneous_system<heterogeneous_system_impl<
                        list<
                            heterogeneous_system_dim<scaled_base_unit<Unit, UnitScale>, static_rational<1>>,
                            dimensionless_type>,
                        Dimension,
                        Scale>>>&,
                Subformatter f,
                ...
                return (
                    f(unit<
                        ...
                        heterogeneous_system<heterogeneous_system_impl<
                            list<heterogeneous_system_dim<Unit, static_rational<1>>, dimensionless_type>,
                            Dimension,
                            typename mpl::times<Scale, list<scale_list_dim<UnitScale>, dimensionless_type>>::
                                type>>>()));
            }
            ...
            {
                std::string str;
                f.template append_units_to<list<
                    heterogeneous_system_dim<scaled_base_unit<Unit, UnitScale>, static_rational<1>>,
                    dimensionless_type>>(str);
                return (str);
            }
        ...
        template<class T>
        BOOST_CONSTEXPR typename autoprefix_norm_impl<T>::type autoprefix_norm(const T& arg)
        {
        ...
        namespace detail {
            ...
            BOOST_CONSTEXPR bool find_matching_scale_impl(End, End, Prev, T, double, F)
            {
                return false;
            }

            template<class Begin, class End, class Prev, class T, class F>
            BOOST_CXX14_CONSTEXPR bool find_matching_scale_impl(Begin, End end, Prev prev, T t, double x, F f)
            {
            ...
            BOOST_CONSTEXPR bool find_matching_scale_i(End, End, T, double, F)
            {
                return false;
            }

            template<class Begin, class End, class T, class F>
            BOOST_CXX14_CONSTEXPR bool find_matching_scale_i(Begin, End end, T t, double x, F f)
            {
                if (Begin::item::value() > x) {
                    return false;
                }
            ...
            BOOST_CXX14_CONSTEXPR bool find_matching_scale(T t, double x, F f)
            {
                return detail::find_matching_scale_i(Scales(), dimensionless_type(), t, x, f);
            }

            typedef list<
                scale<10, static_rational<-24>>,
                list<
                    scale<10, static_rational<-21>>,
                    list<
                        scale<10, static_rational<-18>>,
                        list<
                            ...
                            list<
                                ...
                                list<
                                    ...
                                    list<
                                        scale<10, static_rational<-6>>,
                                        list<
                                            scale<10, static_rational<-3>>,
                                            list<
                                                scale<10, static_rational<0>>,
                                                list<
                                                    scale<10, static_rational<3>>,
                                                    list<
                                                        scale<10, static_rational<6>>,
                                                                    ...
                                                                    list<
                                                                        ...
                                                                        list<
                                                                            ...
                                                                            list<
                                                                                scale<10, static_rational<24>>,
                                                                                list<
                                                                                    scale<10, static_rational<27>>,
                                                                                    dimensionless_type>>>>>>>>>>>>>>>>>>
                engineering_prefixes;

            typedef list<
                scale<2, static_rational<10>>,
                list<
                    scale<2, static_rational<20>>,
                    list<
                        scale<2, static_rational<30>>,
                        list<
                            scale<2, static_rational<40>>,
                            list<
                                scale<2, static_rational<50>>,
                                list<
                                    scale<2, static_rational<60>>,
                                    list<
                                        scale<2, static_rational<70>>,
                                        list<
                                            scale<2, static_rational<80>>,
                                            list<scale<2, static_rational<90>>, dimensionless_type>>>>>>>>>
                binary_prefixes;
            ...
            struct print_default_t
            {
                ...
                void operator()() const { *os << q->value() << ' ' << typename Quantity::unit_type(); }
            ...
            struct print_scale_t
            {
                ...
                void operator()(Prefix, const T& t) const
                {
                    ...
                    *os << t / Prefix::value() << ' ';
                    ...
                    case typename_fmt:
                        do_print(*os, units::simplify_typename(Prefix()));
                        *os << ' ';
                        break;
                    }
                }
            ...
            /// INTERNAL ONLY
            template<class Dimension, class Units, class Scale, class Subformatter>
            inline std::string maybe_parenthesize(
                const unit<Dimension, heterogeneous_system<heterogeneous_system_impl<Units, Dimension, Scale>>>&,
                Subformatter f)
            {
                std::string str;
            ...
            {
                bool prefixed;
                if (detail::find_matching_scale<Prefixes>(
                        q.value(),
                        autoprefix_norm(q.value()),
                        detail::print_scale(os, prefixed))) {
                    if (prefixed) {
                        switch (units::get_format(os)) {
            ...
            template<
                ...
                class Scale,
                class T>
            typename base_unit_info<scaled_base_unit<BaseUnit, Scale>>::base_unit_info_primary_template
                do_print_prefixed(
                    ...
                    const quantity<
                        unit<
                            ...
                            heterogeneous_system<heterogeneous_system_impl<
                                list<
                                    heterogeneous_system_dim<scaled_base_unit<BaseUnit, BaseScale>, static_rational<1>>,
                                    dimensionless_type>,
                                Dimension,
                                Scale>>>,
                        T>& q)
            {
                quantity<
                    unit<
                        Dimension,
                        heterogeneous_system<heterogeneous_system_impl<
                            list<heterogeneous_system_dim<BaseUnit, static_rational<1>>, dimensionless_type>,
                            Dimension,
                            dimensionless_type>>>,
                    T>
                    unscaled(q);
            ...
            void do_print_prefixed(
                std::basic_ostream<CharT, Traits>& os,
                const quantity<
                    unit<Dimension, heterogeneous_system<heterogeneous_system_impl<L, Dimension, Scale>>>,
                    T>& q)
            {
                quantity<
                    unit<Dimension, heterogeneous_system<heterogeneous_system_impl<L, Dimension, dimensionless_type>>>,
                    T>
                    unscaled(q);
                detail::do_print_prefixed_impl<Prefixes>(os, unscaled, detail::print_default(os, q));
            }
            ...
            {
                detail::do_print_prefixed<Prefixes>(
                    os,
                    quantity<unit<Dimension, typename make_heterogeneous_system<Dimension, System>::type>, T>(q));
            }
            ...
            inline BOOST_CONSTEXPR mpl::true_ test_norm(double)
            {
                return mpl::true_();
            }

            inline BOOST_CONSTEXPR mpl::false_ test_norm(one)
            {
                return mpl::false_();
            }
        ...
        inline std::string typename_string(const unit<Dimension, System>&)
        {
            return simplify_typename(typename reduce_unit<unit<Dimension, System>>::type());
        }

        template<class Dimension, class System>
        inline std::string symbol_string(const unit<Dimension, System>&)
        {
            return detail::to_string_impl(unit<Dimension, System>(), detail::format_symbol_impl());
        }

        template<class Dimension, class System>
        inline std::string name_string(const unit<Dimension, System>&)
        {
            ...
            operator<<(std::basic_ostream<Char, Traits>& os, const unit<Dimension, System>& u)
        {
            if (units::get_format(os) == typename_fmt) {
                ...
                BOOST_ASSERT_MSG(
                    false,
                    "The format mode must be one of: typename_format, raw_format, name_format, symbol_format");
            }
            ...
            operator<<(std::basic_ostream<Char, Traits>& os, const quantity<Unit, T>& q)
        {
            if (units::get_autoprefix(os) == autoprefix_none) {
                ...
                detail::maybe_print_prefixed<detail::engineering_prefixes>(
                    os,
                    q,
                    detail::test_norm(autoprefix_norm(q.value())));
            }
            else if (units::get_autoprefix(os) == autoprefix_binary) {
                detail::maybe_print_prefixed<detail::binary_prefixes>(
                    os,
                    q,
                    detail::test_norm(autoprefix_norm(q.value())));
            }
