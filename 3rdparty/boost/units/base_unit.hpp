...
namespace boost {
    ...
    namespace units {
        ...
        struct check_base_unit
        {
            enum
            {
                value = sizeof(boost_units_unit_is_registered(units::base_unit_ordinal<N>())) == sizeof(detail::yes) &&
        ...
        template<
            ...
            ,
            class = typename detail::ordinal_has_already_been_defined<check_base_unit<Derived, N>::value>::type
#endif
            >
        ...
        public:
            ...
            typedef unit<
                ...
                heterogeneous_system<heterogeneous_system_impl<
                    list<heterogeneous_system_dim<Derived, static_rational<1>>, dimensionless_type>,
                    Dim,
                    no_scale>>>
                unit_type;
#else
        ...
        private:
            ...
            /// INTERNAL ONLY
            friend BOOST_CONSTEXPR Derived* check_double_register(const units::base_unit_ordinal<N>&) { return (0); }

            /// Register this ordinal
            /// INTERNAL ONLY
            friend BOOST_CONSTEXPR detail::yes boost_units_unit_is_registered(const units::base_unit_ordinal<N>&)
            {
                return (detail::yes());
            }
            ...
            /// INTERNAL ONLY
            friend BOOST_CONSTEXPR detail::yes boost_units_unit_is_registered(const units::base_unit_pair<Derived, N>&)
            {
                return (detail::yes());
            }
        };
