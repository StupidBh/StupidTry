...
namespace boost {
    ...
    namespace units {
        ...
        struct is_unit_of_dimension : public mpl::false_
        {
        };

        template<class Dim, class System>
        struct is_unit_of_dimension<unit<Dim, System>, Dim> : public mpl::true_
        {
        };

        template<class Dim, class System>
        struct is_unit_of_dimension<absolute<unit<Dim, System>>, Dim> : public mpl::true_
        {
        };
