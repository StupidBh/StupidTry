...
*/
        ...
        public:
            ...
            typedef typename make_integral_c<(::boost::integer::static_gcd<
                                              ::boost::units::static_abs<N>::value,
                                              ::boost::units::static_abs<D>::value>::value)>::type gcd_type;
            typedef typename boost::mpl::eval_if<
                boost::mpl::less<D_type, boost::mpl::integral_c<integer_type, 0>>,
                boost::mpl::negate<gcd_type>,
                gcd_type>::type den_type;

        public:
            // for mpl arithmetic support
            typedef detail::static_rational_tag tag;

            BOOST_STATIC_CONSTANT(integer_type, Numerator = (::boost::mpl::divides<N_type, den_type>::value));
            BOOST_STATIC_CONSTANT(integer_type, Denominator = (::boost::mpl::divides<D_type, den_type>::value));
        ...
        class static_rational {
        private:
            BOOST_STATIC_CONSTEXPR integer_type nabs = static_abs<N>::value, dabs = static_abs<D>::value;
...
namespace boost {
    ...
    namespace units {
        ...
        inline BOOST_CONSTEXPR typename divide_typeof_helper<T, T>::type value(const static_rational<N, D>&)
        {
            return T(N) / T(D);
        }
    ...
    namespace mpl {
            ...
            struct apply
            {
                typedef typename boost::units::static_rational<
                    ::boost::mpl::plus<
                        ...
                        boost::mpl::times<typename T1::N_type, typename T0::D_type>>::value,
                    ::boost::mpl::times<typename T0::D_type, typename T1::D_type>::value>::type type;
            };
        };
        ...
        struct divides_impl<boost::units::detail::static_rational_tag, boost::units::detail::static_rational_tag>
        {
            ...
            struct apply
            {
                typedef typename boost::units::static_rational<
                    ...
                    ::boost::mpl::times<typename T0::D_type, typename T1::N_type>::value>::type type;
            };
        };
        ...
        struct negate_impl<boost::units::detail::static_rational_tag>
        {
            ...
            struct apply
            {
                typedef typename boost::units::static_rational<
                    ...
                    ::boost::mpl::identity<T0>::type::Denominator>::type type;
            };
        };
        ...
        struct plus_impl<boost::units::detail::static_rational_tag, boost::units::detail::static_rational_tag>
        {
            ...
            struct apply
            {
                typedef typename boost::units::static_rational<
                    ...
                    T0::Denominator * T1::Denominator>::type type;
            };
        };
        ...
        struct times_impl<boost::units::detail::static_rational_tag, boost::units::detail::static_rational_tag>
        {
            ...
            struct apply
            {
                typedef typename boost::units::
                    static_rational<T0::Numerator * T1::Numerator, T0::Denominator * T1::Denominator>::type type;
            };
        };
        ...
        struct divides_impl<boost::units::detail::static_rational_tag, boost::units::detail::static_rational_tag>
        {
            ...
            {
                typedef typename boost::units::
                    static_rational<T0::Numerator * T1::Denominator, T0::Denominator * T1::Numerator>::type type;
            };
        };
