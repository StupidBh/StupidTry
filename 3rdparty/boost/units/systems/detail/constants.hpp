...
#define BOOST_UNITS_DEFINE_HELPER(name, symbol, template_name)                                               \
    ...
    {                                                                                                        \
        typedef typename name##_typeof_helper<template_name<Arg1, Arg2>, typename T::value_type>::type type; \
                                                                                                             ...
                                                                                                             \
    template<class T, class Arg1, class Arg2>                                                                \
    BOOST_CONSTEXPR typename name##_typeof_helper<typename T::value_type, template_name<Arg1, Arg2>>::type   \
    ...
    {                                                                                                        \
        return (t.value() symbol u);                                                                         \
                                                                                                             ...
                                                                                                             \
    template<class T, class Arg1, class Arg2>                                                                \
    BOOST_CONSTEXPR typename name##_typeof_helper<template_name<Arg1, Arg2>, typename T::value_type>::type   \
...
#define BOOST_UNITS_DEFINE_HELPER(name, symbol)                                                             \
    ...
    {                                                                                                       \
        typedef typename name##_typeof_helper<typename T1::value_type, typename T2::value_type>::type type; \
                                                                                                            ...
                                                                                                            \
    template<class T1, class T2>                                                                            \
    BOOST_CONSTEXPR typename name##_typeof_helper<typename T1::value_type, typename T2::value_type>::type   \
    ...
    {                                                                                                       \
        typedef typename name##_typeof_helper<T1, typename T2::value_type>::type type;                      \
                                                                                                            ...
                                                                                                            \
    template<class T1, class T2>                                                                            \
    BOOST_CONSTEXPR typename name##_typeof_helper<typename T1::value_type, T2>::type operator symbol(       \
        const constant<T1>& t,                                                                              \
        const T2& u)                                                                                        \
    {                                                                                                       \
        return (t.value() symbol u);                                                                        \
                                                                                                            ...
                                                                                                            \
    template<class T1, class T2>                                                                            \
    BOOST_CONSTEXPR typename name##_typeof_helper<T1, typename T2::value_type>::type operator symbol(       \
        const T1& t,                                                                                        \
        const constant<T2>& u)                                                                              \
    {                                                                                                       \
...
#define BOOST_UNITS_DEFINE_HELPER(name, symbol)                                                        \
    ...
    {                                                                                                  \
        typedef typename name##_typeof_helper<one, typename T2::value_type>::type type;                \
                                                                                                       ...
                                                                                                       \
    template<class T1>                                                                                 \
    BOOST_CONSTEXPR typename name##_typeof_helper<typename T1::value_type, one>::type operator symbol( \
        const constant<T1>& t,                                                                         \
        const one& u)                                                                                  \
    {                                                                                                  \
        return (t.value() symbol u);                                                                   \
                                                                                                       ...
                                                                                                       \
    template<class T2>                                                                                 \
    BOOST_CONSTEXPR typename name##_typeof_helper<one, typename T2::value_type>::type operator symbol( \
        const one& t,                                                                                  \
        const constant<T2>& u)                                                                         \
    {                                                                                                  \
        return (t symbol u.value());                                                                   \
...
#undef BOOST_UNITS_DEFINE_HELPER
        ...
        struct power_typeof_helper<constant<T1>, static_rational<N, D>>
        {
            ...
            static BOOST_CONSTEXPR type value(const constant<T1>& arg) { return base::value(arg.value()); }
        };
...
#define BOOST_UNITS_PHYSICAL_CONSTANT(name, type, value_, uncertainty_)                  \
    ...
    BOOST_UNITS_STATIC_CONSTANT(name, boost::units::constant<boost::units::physical_constant<name##_t>>) = {}
        ...
        inline std::basic_ostream<Char, Traits>&
            operator<<(std::basic_ostream<Char, Traits>& os, const physical_constant<Y>& val)
        {
            ...
            if (val.uncertainty() > value_type()) {
                ...
                os << " (rel. unc. = "
                   << std::setprecision(1)
                   //<< std::setw(7)
                   << std::scientific << relative_uncertainty << ")";
            }
            else {
                os << val.value() << " (exact)";
            }
        ...
        // stream output
        template<class Char, class Traits, class Y>
        inline std::basic_ostream<Char, Traits>& operator<<(std::basic_ostream<Char, Traits>& os, const constant<Y>&)
        {
            os << Y();
            return os;
        }
