        ...
        namespace detail {
            ...
            struct insertion_sort_dims_comparison_impl<true>
            {
                ...
                struct apply
                {
                    typedef list<
                        typename Begin::item,
                        typename insertion_sort_dims_insert<N - 1>::template apply<typename Begin::next, T>::type>
                        type;
                };
            };
            ...
            struct insertion_sort_dims_insert
            {
                ...
                struct apply
                {
                    typedef typename insertion_sort_dims_comparison_impl<
                        mpl::less<typename Begin::item, T>::value>::template apply<Begin, N, T>::type type;
                };
            };
            ...
            struct insertion_sort_dims_mpl_sequence
            {
                ...
                struct apply
                {
                    typedef typename insertion_sort_dims_mpl_sequence<N - 1>::template apply<
                        typename mpl::next<Begin>::type>::type next;
                    typedef typename insertion_sort_dims_insert<(
                        next::size::value)>::template apply<next, typename mpl::deref<Begin>::type>::type type;
                };
            };
            ...
            struct insertion_sort_dims_impl
            {
                ...
                struct apply
                {
                    ...
                    typedef typename insertion_sort_dims_insert<(
                        next::size::value)>::template apply<next, typename Begin::item>::type type;
                };
            };
            ...
            struct sort_dims
            {
                typedef typename insertion_sort_dims_mpl_sequence<mpl::size<T>::value>::template apply<
                    typename mpl::begin<T>::type>::type type;
            };
            ...
            {
                typedef
                    typename insertion_sort_dims_impl<list<T, Next>::size::value>::template apply<list<T, Next>>::type
                        type;
            };
            ...
            struct merge_dimensions_func<true, false>
            {
                ...
                struct apply
                {
                    typedef list<
                        ...
                        typename merge_dimensions_impl<N1 - 1, N2>::template apply<typename Begin1::next, Begin2>::type>
                        type;
                };
            };
            ...
            struct merge_dimensions_func<false, true>
            {
                ...
                struct apply
                {
                    typedef list<
                        ...
                        typename merge_dimensions_impl<N2 - 1, N1>::template apply<typename Begin2::next, Begin1>::type>
                        type;
                };
            };
            ...
            struct merge_dimensions_func<false, false>
            {
                ...
                struct apply
                {
                    ...
                    typedef typename push_front_if<!is_empty_dim<combined>::value>::template apply<
                        typename merge_dimensions_impl<N1 - 1, N2 - 1>::
                            template apply<typename Begin1::next, typename Begin2::next>::type,
                        combined>::type type;
                };
            };
            ...
            struct merge_dimensions_impl
            {
                ...
                struct apply
                {
                    ...
                    typedef typename merge_dimensions_func<
                        (mpl::less<dim1, dim2>::value == true),
                        (mpl::less<dim2, dim1>::value == true)>::template apply<Begin1, Begin2, N1, N2>::type type;
                };
            };
            ...
            {
                typedef typename detail::merge_dimensions_impl<Sequence1::size::value, Sequence2::size::value>::
                    template apply<Sequence1, Sequence2>::type type;
            };
            ...
            struct iterator_to_list
            {
                ...
                struct apply
                {
                    typedef list<
                        typename Begin::item,
                        typename iterator_to_list<N - 1>::template apply<typename Begin::next>::type>
                        type;
                };
            };
            ...
            struct static_inverse_impl
            {
                ...
                struct apply
                {
                    typedef list<
                        ...
                        typename static_inverse_impl<N - 1>::template apply<typename Begin::next>::type>
                        type;
                };
            };
