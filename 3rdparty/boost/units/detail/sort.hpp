        ...
        namespace detail {
            ...
            struct insertion_sort_comparison_impl<true>
            {
                ...
                struct apply
                {
                    typedef list<
                        typename Begin::item,
                        typename insertion_sort_insert<N - 1>::template apply<typename Begin::next, T>::type>
                        type;
                };
            };
            ...
            struct insertion_sort_insert
            {
                ...
                struct apply
                {
                    typedef typename insertion_sort_comparison_impl<
            ...
            struct insertion_sort_impl
            {
                ...
                struct apply
                {
                    ...
                    typedef typename insertion_sort_insert<(
