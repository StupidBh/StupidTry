...
namespace boost {
    ...
    namespace units {
        ...
        struct get_scale_list<scaled_base_unit<S, Scale>>
        {
            typedef typename mpl::
                times<list<scale_list_dim<Scale>, dimensionless_type>, typename get_scale_list<S>::type>::type type;
        };
            ...
            struct eval_scale_list_impl
            {
                ...
                struct apply
                {
                    ...
                    typedef typename multiply_typeof_helper<
                        typename next_iteration::type,
                        typename Begin::item::value_type>::type type;

                    static BOOST_CONSTEXPR type value() { return (next_iteration::value() * Begin::item::value()); }
                };
            };
    ...
    namespace mpl {
        ...
        struct plus_impl<boost::units::scale_dim_tag, boost::units::scale_dim_tag>
        {
            ...
            struct apply
            {
                typedef boost::units::scale_list_dim<boost::units::scale<
                    (T0::base),
        ...
        struct negate_impl<boost::units::scale_dim_tag>
        {
            ...
            struct apply
            {
                typedef boost::units::scale_list_dim<
                    boost::units::scale<(T0::base), typename mpl::negate<typename T0::exponent>::type>>
                    type;
            };
        };
        ...
        struct times_impl<boost::units::scale_dim_tag, boost::units::detail::static_rational_tag>
        {
            ...
            {
                typedef boost::units::scale_list_dim<
                    boost::units::scale<(T0::base), typename mpl::times<typename T0::exponent, T1>::type>>
                    type;
            };
        };
        ...
        struct divides_impl<boost::units::scale_dim_tag, boost::units::detail::static_rational_tag>
        {
            ...
            {
                typedef boost::units::scale_list_dim<
                    boost::units::scale<(T0::base), typename mpl::divides<typename T0::exponent, T1>::type>>
                    type;
            };
        };
