...
namespace boost {
    namespace units {
        ...
        typedef boost::units::heterogeneous_system<boost::units::heterogeneous_system_impl<
...
#define BOOST_UNITS_DIMENSIONLESS_UNIT(T) \
    boost::units::                        \
        unit<boost::units::dimensionless_type, T, typename ::boost::units::detail::void_if_dimensionless<T>::type>

#define BOOST_UNITS_HETEROGENEOUS_DIMENSIONLESS_UNIT(T) \
    boost::units::                                      \
        unit<boost::units::dimensionless_type, T, typename ::boost::units::detail::void_if_heterogeneous<T>::type>
