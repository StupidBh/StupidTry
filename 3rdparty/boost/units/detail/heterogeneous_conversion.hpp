    ...
    namespace units {
        ...
        namespace detail {
                ...
                struct apply
                {
                    ...
                    typedef list<
                        typename mpl::minus<
                            ...
                            typename mpl::times<X2, typename Begin::item>::type>::type,
            ...
            struct solve_leading_zeroes
            {
                ...
                struct apply
                {
                    typedef list<typename Begin::item, typename Next::template apply<typename Begin::next>::type> type;
                };
            ...
            struct solve_first_non_zero
            {
                ...
                struct apply
                {
                    typedef typename Next::template apply<typename Begin::next, typename Begin::item>::type type;
                };
            };
            ...
            struct solve_internal_zero
            {
                ...
                struct apply
                {
                    typedef list<typename Begin::item, typename Next::template apply<typename Begin::next, Y>::type>
                        type;
                };
            };
            ...
            struct make_solve_list_normal
            {
                ...
                struct apply
                {
                    typedef typename make_solve_list_internal_zero<typename Begin::item>::template apply<
            ...
            struct make_solve_list_first_non_zero
            {
                ...
                struct apply
                {
                    typedef solve_first_non_zero<typename make_solve_list_normal<
                        N - 1>::template apply<typename Begin::next, typename Begin::item>::type>
                        type;
                };
            };
            ...
            struct make_solve_list_first_non_zero<static_rational<0>>
            {
                ...
                struct apply
                {
                    typedef typename solve_leading_zeroes<typename make_solve_list_leading_zeroes<
                        N - 1>::template apply<typename Begin::next>::type>::type type;
                };
            };
            ...
            struct make_solve_list_leading_zeroes
            {
                ...
                {
                    typedef
                        typename make_solve_list_first_non_zero<typename Begin::item>::template apply<Begin, N>::type
                            type;
                };
            };
            ...
            struct make_homogeneous_system_func<no_solution, false>
            {
                ...
                struct apply
                {
                    typedef typename make_homogeneous_system_impl<
                        N - 1>::template apply<typename Begin::next, Current, Units, Dimensions>::type type;
                };
            };
            ...
            struct make_homogeneous_system_impl
            {
                ...
                struct apply
                {
                    typedef typename expand_dimensions<Dimensions::size::value>::
                        template apply<Dimensions, typename Begin::item::dimension_type>::type dimensions;
                    typedef typename try_add_unit_impl<Current::size::value>::template apply<Current, dimensions>::type
                        new_element;
                    typedef typename make_solve_list_leading_zeroes<new_element::size::value>::template apply<
                        new_element>::type new_func;
                    typedef typename make_homogeneous_system_func<
                        new_func,
                        ((Current::size::value) + 1) ==
                            (Dimensions::size::value)>::template apply<Begin, Current, Units, Dimensions, N>::type type;
                };
            };
            ...
            struct make_homogeneous_system
            {
                ...
                typedef homogeneous_system<typename insertion_sort<
                    typename make_homogeneous_system_impl<Units::size::value>::
                        template apply<Units, dimensionless_type, dimensionless_type, base_dimensions>::type>::type>
                    type;
            };
