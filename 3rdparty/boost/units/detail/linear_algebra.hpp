    ...
    namespace units {
        ...
        namespace detail {
            ...
            struct divide_equation
            {
                ...
                {
                    typedef list<
                        typename mpl::divides<typename Begin::item, Divisor>::type,
                        typename divide_equation<N - 1>::template apply<typename Begin::next, Divisor>::type>
                        type;
                };
            };
                ...
                struct apply
                {
                    typedef list<
                        typename mpl::minus<
                            ...
                            typename mpl::times<typename Begin2::item, X1>::type>::type,
                        typename eliminate_from_pair_of_equations_impl<
                            N - 1>::template apply<typename Begin1::next, typename Begin2::next, X1, X2>::type>
                        type;
                };
            };
            ...
            struct eliminate_from_pair_of_equations
            {
                ...
                typedef typename eliminate_from_pair_of_equations_impl<(E1::size::value - 1)>::template apply<
                    ...
                    typename begin2::item>::type type;
            };
            ...
            {
                typedef list<static_rational<0>, typename create_row_of_identity<Column - 1, TotalColumns - 1>::type>
                    type;
            };
            ...
            struct determine_extra_equations_skip_zeros_impl<false, false>
            {
                ...
                struct apply
                {
                    ...
                    typedef typename determine_extra_equations_impl<RemainingRows - 1>::
                        template apply<typename RowsBegin::next, typename RowsBegin::item>::type next_equations;
            ...
            struct determine_extra_equations_skip_zeros_impl<true, false>
            {
                ...
                struct apply
                {
                    ...
                    typedef typename determine_extra_equations_skip_zeros_impl<
                        ...
                        >::
                        template apply<typename RowsBegin::next, RemainingRows - 1, CurrentColumn, TotalColumns, Result>
                            next;
            ...
            struct determine_extra_equations_impl
            {
                ...
                struct apply
                {
                    typedef list<
                        ...
                        typename determine_extra_equations_impl<
                            RemainingRows - 1>::template apply<typename RowsBegin::next, EliminateAgainst>::type>
                        type;
                };
            };
            ...
            struct determine_extra_equations
            {
                ...
                struct apply
                {
                    ...
                    typedef typename determine_extra_equations<
                        ...
                        template apply<typename column_info::next_equations, TotalColumns, typename column_info::type>::
                            type type;
                };
            };
            ...
            struct determine_extra_equations<RemainingColumns, true>
            {
                ...
                struct apply
                {
                    typedef typename determine_extra_equations<RemainingColumns - 1, true>::template apply<
                        ...
                        TotalColumns,
                        list<
                            typename create_row_of_identity<TotalColumns - RemainingColumns, TotalColumns>::type,
                            Result>>::type type;
                };
            };
            ...
            struct invert_handle_inital_rows
            {
                ...
                struct apply
                {
                    typedef typename invert_handle_inital_rows<
                        N - 1>::template apply<typename RowsBegin::next, typename IdentityBegin::next>
                        next;
                    ...
                    typedef list<
                        ...
                        new_matrix;
                    typedef list<
                        typename eliminate_from_pair_of_equations_impl<(current_identity_row::size::value)>::
                            template apply<
            ...
            struct invert_handle_inital_rows<0>
            {
                ...
                struct apply
                {
                    ...
                    typedef typename invert_strip_leading_zeroes<
                        ...
                        (RowsBegin::size::value == 1)>::template apply<RowsBegin, IdentityBegin>
                        next;
                    // results
            ...
            struct invert_strip_leading_zeroes<false, false>
            {
                ...
                struct apply
                {
                    ...
                    typedef typename divide_equation<(current_row::size::value - 1)>::
                        template apply<typename current_row::next, current_value>::type new_equation;
                    typedef typename divide_equation<(IdentityBegin::item::size::value)>::
                        template apply<typename IdentityBegin::item, current_value>::type transformed_identity_equation;
            ...
            struct invert_strip_leading_zeroes<true, false>
            {
                ...
                struct apply
                {
                    ...
                    typedef typename invert_strip_leading_zeroes<
                        next_row::item::Numerator == 0,
                        RowsBegin::size::value ==
                            2>::template apply<typename RowsBegin::next, typename IdentityBegin::next>
                        next;
                    typedef typename IdentityBegin::item current_identity_row;
            ...
            struct invert_impl
            {
                ...
                {
                    typedef typename invert_handle_inital_rows<
                        RowsBegin::size::value - N>::template apply<RowsBegin, IdentityBegin>
                        process_column;
                    typedef typename invert_impl<N - 1>::template apply<
                        typename process_column::new_matrix,
                        typename process_column::identity_result>::type type;
                };
            };
            ...
            struct make_identity
            {
                ...
                {
                    typedef list<
                        typename create_row_of_identity<Size - N, Size>::type,
                        typename make_identity<N - 1>::template apply<Size>::type>
                        type;
                };
            };
            ...
            struct find_base_dimensions_impl_impl
            {
                ...
                {
                    typedef
                        typename find_base_dimensions_impl_impl<N - 1>::template apply<typename Begin::next, S>::type
                            next;

                    typedef typename set_insert<(has_key<next, typename Begin::item::tag_type>::value)>::
                        template apply<next, typename Begin::item::tag_type>::type type;
                };
            };
            ...
            struct find_base_dimensions_impl
            {
                ...
                struct apply
                {
                    typedef typename find_base_dimensions_impl_impl<(Begin::item::dimension_type::size::value)>::
                        template apply<
                            typename Begin::item::dimension_type,
                            typename find_base_dimensions_impl<N - 1>::template apply<typename Begin::next>::type>::type
                            type;
                };
            };
            ...
            struct find_base_dimensions
            {
                typedef typename insertion_sort<
                    typename find_base_dimensions_impl<(T::size::value)>::template apply<T>::type>::type type;
            };
            ...
            {
                template<class Dim>
                struct apply : boost::is_same<Dim, typename Iterator::item::tag_type>
                {
                };
            };
            ...
            struct calculate_base_dimension_coefficients_impl
            {
                ...
                struct apply
                {
                    typedef typename calculate_base_dimension_coefficients_func<
                        begins_with_dimension<typename BaseUnitDimensions::item>::template apply<Dim>::value>::
                        template apply<typename BaseUnitDimensions::item>
                            result;
                    typedef typename calculate_base_dimension_coefficients_impl<
                        N - 1>::template apply<typename BaseUnitDimensions::next, Dim, list<typename result::type, T>>
                        next_;
            ...
            struct add_zeroes_impl
            {
                ...
                struct apply
                {
                    typedef list<static_rational<0>, typename add_zeroes_impl<N - 1>::template apply<T>::type> type;
                };
            };
            ...
            struct expand_dimensions
            {
                ...
                struct apply
                {
                    typedef typename calculate_base_dimension_coefficients_func<
                        ...
                        template apply<DimensionIterator>
                            result;
                    typedef list<
                        typename result::type,
                        typename expand_dimensions<
                            N - 1>::template apply<typename Begin::next, typename result::next>::type>
                        type;
                };
            };
            ...
            struct create_unit_matrix
            {
                ...
                {
                    typedef
                        typename create_unit_matrix<N - 1>::template apply<typename Begin::next, Dimensions>::type next;
                    typedef list<
                        typename expand_dimensions<Dimensions::size::value>::
                            template apply<Dimensions, typename Begin::item::dimension_type>::type,
                        next>
                        type;
                };
            };
            ...
            struct normalize_units
            {
                ...
                typedef typename create_unit_matrix<(T::size::value)>::template apply<T, dimensions>::type matrix;
            ...
            struct multiply_add_units_impl
            {
                ...
                {
                    typedef list<
                        typename mpl::plus<typename mpl::times<typename Begin2::item, X>::type, typename Begin1::item>::
                            type,
                        typename multiply_add_units_impl<
                            N - 1>::template apply<typename Begin1::next, typename Begin2::next, X>::type>
                        type;
                };
            };
            ...
            struct multiply_add_units
            {
                ...
                struct apply
                {
                    typedef typename multiply_add_units_impl<(Begin2::item::size::value)>::template apply<
                        typename multiply_add_units<
                            N - 1>::template apply<typename Begin1::next, typename Begin2::next>::type,
                        typename Begin2::item,
                        typename Begin1::item>::type type;
                };
            };
            ...
            struct multiply_add_units<1>
            {
                ...
                {
                    typedef
                        typename add_zeroes_impl<(Begin2::item::size::value)>::template apply<dimensionless_type>::type
                            type1;
                    typedef typename multiply_add_units_impl<(Begin2::item::size::value)>::
                        template apply<type1, typename Begin2::item, typename Begin1::item>::type type;
                };
            };
                ...
                struct apply
                {
                    ...
                    typedef mpl::and_<
                        ...
                        typename is_simple_system_impl<
                            N - 1>::template apply<typename Begin::next, typename test::base_dimension_type>>
                        type;
            ...
            struct is_simple_system
            {
                ...
                typedef typename mpl::and_<
                    typename test::type,
                    typename is_simple_system_impl<T::size::value - 1>::
                        template apply<typename Begin::next::type, typename test::base_dimension_type>>::type type;
                BOOST_STATIC_CONSTEXPR bool value = type::value;
            };
            ...
            struct calculate_base_unit_exponents_impl<true>
            {
                ...
                struct apply
                {
                    typedef typename expand_dimensions<(
                        T::size::value)>::template apply<typename find_base_dimensions<T>::type, Dimensions>::type type;
                };
            };
            ...
            struct calculate_base_unit_exponents_impl<false>
            {
                ...
                struct apply
                {
                    ...
                    // yield list<0,1,-2>
                    typedef typename expand_dimensions<(base_solutions::dimensions::size::value)>::
                        template apply<typename base_solutions::dimensions, Dimensions>::type dimensions;
                    ...
                    typedef typename multiply_add_units<
                        dimensions::size::value>::template apply<dimensions, typename base_solutions::type>::type units;
            ...
            {
                typedef typename calculate_base_unit_exponents_impl<
                    is_simple_system<T>::value>::template apply<T, Dimensions>::type type;
            };
