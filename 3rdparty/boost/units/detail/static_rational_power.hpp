    ...
    namespace units {
        ...
        namespace detail {
            ...
            struct static_rational_power_impl<R, one>
            {
                ...
                static BOOST_CONSTEXPR one call(const one&) { return (one()); }
            };
            ...
            struct static_int_power_impl<1, false>
            {
                ...
                struct apply
                {
                    ...
                    static BOOST_CONSTEXPR type call(const Y& y, const R& r) { return (y * r); }
                };
            };
            ...
            struct static_int_power_impl<0, true>
            {
                ...
                struct apply
                {
                    ...
                    static BOOST_CONSTEXPR R call(const Y&, const R& r) { return (r); }
                };
            };
            ...
            struct static_int_power_sign_impl<N, false>
            {
                ...
                struct apply
                {
                    ...
                    static BOOST_CONSTEXPR type call(const Y& y) { return (impl::call(y, one())); }
                };
            };
            ...
            struct static_int_power_sign_impl<N, true>
            {
                ...
                struct apply
                {
                    ...
                    static BOOST_CONSTEXPR type call(const Y& y) { return (one() / impl::call(y, one())); }
                };
            };
            ...
            struct static_rational_power_impl<static_rational<N, 1>, Y>
            {
                ...
                static BOOST_CONSTEXPR type call(const Y& y) { return (impl::call(y)); }
            };

            template<class R, class Y>
            BOOST_CONSTEXPR typename detail::static_rational_power_impl<R, Y>::type static_rational_power(const Y& y)
            {
