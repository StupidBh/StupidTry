...
#define BOOST_UNITS_MAKE_HETEROGENEOUS_UNIT(BaseUnit, Dimensions)                                   \
    boost::units::unit<                                                                             \
        Dimensions,                                                                                 \
        boost::units::heterogeneous_system<boost::units::heterogeneous_system_impl<                 \
            boost::units::list<                                                                     \
                boost::units::heterogeneous_system_dim<BaseUnit, boost::units::static_rational<1>>, \
...
namespace boost {
    ...
    namespace mpl {
        ...
        struct negate_impl<boost::units::heterogeneous_system_dim_tag>
        {
            ...
            {
                typedef boost::units::
                    heterogeneous_system_dim<typename T::tag_type, typename mpl::negate<typename T::value_type>::type>
                        type;
            };
        };
    ...
    namespace units {
        ...
        namespace detail {
            ...
            struct make_heterogeneous_system_impl
            {
                ...
                struct apply
                {
                    typedef typename push_front_if<!(is_zero<typename ExponentsBegin::item>::value)>::template apply<
                        typename make_heterogeneous_system_impl<
                            N - 1>::template apply<typename UnitsBegin::next, typename ExponentsBegin::next>::type,
                        heterogeneous_system_dim<typename UnitsBegin::item, typename ExponentsBegin::item>>::type type;
                };
            };
            ...
            struct make_heterogeneous_system
            {
                ...
                BOOST_MPL_ASSERT_MSG(
                    (!boost::is_same<exponents, inconsistent>::value),
                    the_specified_dimension_is_not_representible_in_the_given_system,
                    (types<Dimensions, System>));
                typedef typename make_heterogeneous_system_impl<
                    System::type::size::value>::template apply<typename System::type, exponents>::type unit_list;
            ...
            {
                typedef heterogeneous_system<heterogeneous_system_impl<
            ...
            struct unscale_heterogeneous_system_impl
            {
                ...
                struct apply
                {
                    typedef typename push_front_or_add<
                        typename unscale_heterogeneous_system_impl<N - 1>::template apply<typename Begin::next>::type,
                        typename unscale<typename Begin::item>::type>::type type;
                };
            };
        ...
        {
            typedef heterogeneous_system<heterogeneous_system_impl<
                typename detail::unscale_heterogeneous_system_impl<T::type::size::value>::template apply<
            ...
            struct get_scale_list_of_heterogeneous_system_impl
            {
                ...
                struct apply
                {
                    typedef typename mpl::times<
                        ...
                        typename get_scale_list<typename Begin::item>::type>::type type;
                };
            };
        ...
        {
            typedef typename mpl::times<
                typename detail::get_scale_list_of_heterogeneous_system_impl<T::type::size::value>::template apply<
                    typename T::type>::type,
                typename T::scale>::type type;
        };
