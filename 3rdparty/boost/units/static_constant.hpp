...
#else
    #define BOOST_UNITS_STATIC_CONSTANT(name, type) BOOST_STATIC_CONSTEXPR type name
#endif
...
/// type deduction.
        ...
        #define BOOST_UNITS_AUTO_STATIC_CONSTANT(name, value) BOOST_UNITS_STATIC_CONSTANT(name, typeof(value)) = (value)
