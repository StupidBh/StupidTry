...
namespace boost {
    ...
    namespace units {
        ...
        struct is_dimension_list : public mpl::false_
        {
        };

        template<typename Item, typename Next>
        struct is_dimension_list<list<Item, Next>> : public mpl::true_
        {
        };

        template<>
        struct is_dimension_list<dimensionless_type> : public mpl::true_
        {
        };
