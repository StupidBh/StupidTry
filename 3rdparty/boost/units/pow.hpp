...
namespace boost {
    ...
    namespace units {
        ...
        BOOST_CONSTEXPR inline typename power_typeof_helper<Y, Rat>::type pow(const Y& x)
        {
        ...
        BOOST_CONSTEXPR inline typename power_typeof_helper<Y, static_rational<N>>::type pow(const Y& x)
        {
        ...
        struct power_typeof_helper<T, static_rational<N, D>>
        {
            ...
            static BOOST_CONSTEXPR type value(const T& x) { return impl::call(x); }
        };
        ...
        struct power_typeof_helper<float, static_rational<N, D>>
        {
            ...
            static BOOST_CONSTEXPR type value(const double& x) { return base::value(x); }
        };
        ...
        template<class Rat, class Y>
        BOOST_CONSTEXPR typename root_typeof_helper<Y, Rat>::type root(const Y& x)
        {
        ...
        template<long N, class Y>
        BOOST_CONSTEXPR typename root_typeof_helper<Y, static_rational<N>>::type root(const Y& x)
        {
        ...
        struct root_typeof_helper<T, static_rational<N, D>>
        {
            ...
            static BOOST_CONSTEXPR type value(const T& x) { return (base::value(x)); }
        };
