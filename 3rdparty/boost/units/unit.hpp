...
namespace boost {
    ...
    namespace units {
        ...
        {
            typedef unit<Dim, typename detail::make_heterogeneous_system<Dim, System>::type> type;
        };
        ...
        /// INTERNAL ONLY
        template<class Dim1, class Dim2, class System>
        ...
        struct multiply_typeof_helper<unit<Dim1, homogeneous_system<System1>>, unit<Dim2, homogeneous_system<System2>>>
        {
            typedef unit<
                ...
                typename detail::multiply_systems<
                    ...
                    typename detail::make_heterogeneous_system<Dim2, System2>::type>::type>
                type;
        };
        ...
        struct multiply_typeof_helper<
            unit<Dim1, heterogeneous_system<System1>>,
        ...
        template<class Dim1, class Dim2, class System1, class System2>
        struct multiply_typeof_helper<
            unit<Dim1, homogeneous_system<System1>>,
            unit<Dim2, heterogeneous_system<System2>>>
        {
            typedef unit<
                ...
                typename detail::multiply_systems<
                    typename detail::make_heterogeneous_system<Dim1, System1>::type,
                    heterogeneous_system<System2>>::type>
                type;
        };
            ...
            unit<Dim2, heterogeneous_system<System2>>>
        {
            typedef unit<
                typename mpl::times<Dim1, Dim2>::type,
                typename detail::multiply_systems<heterogeneous_system<System1>, heterogeneous_system<System2>>::type>
                type;
        };
            ...
            unit<Dim2, heterogeneous_system<System2>>>
        {
            typedef unit<
                typename mpl::divides<Dim1, Dim2>::type,
                typename detail::divide_systems<heterogeneous_system<System1>, heterogeneous_system<System2>>::type>
                type;
        };
        ...
        {
            typedef unit<
                typename static_power<Dim, static_rational<N, D>>::type,
                typename static_power<System, static_rational<N, D>>::type>
                type;

            static BOOST_CONSTEXPR type value(const unit<Dim, System>&) { return type(); }
        };
        ...
        {
            typedef unit<
                typename static_root<Dim, static_rational<N, D>>::type,
                typename static_root<System, static_rational<N, D>>::type>
                type;
        ...
        template<class Dim, class System>
        BOOST_CONSTEXPR typename unary_plus_typeof_helper<unit<Dim, System>>::type operator+(const unit<Dim, System>&)
        {
        ...
        template<class Dim, class System>
        BOOST_CONSTEXPR typename unary_minus_typeof_helper<unit<Dim, System>>::type operator-(const unit<Dim, System>&)
        {
        ...
        template<class Dim1, class Dim2, class System1, class System2>
        BOOST_CONSTEXPR typename add_typeof_helper<unit<Dim1, System1>, unit<Dim2, System2>>::type
            operator+(const unit<Dim1, System1>&, const unit<Dim2, System2>&)
        {
            ...
            typedef typename add_typeof_helper<unit<Dim1, system_type>, unit<Dim2, system_type>>::type type;
        ...
        template<class Dim1, class Dim2, class System1, class System2>
        BOOST_CONSTEXPR typename subtract_typeof_helper<unit<Dim1, System1>, unit<Dim2, System2>>::type
            operator-(const unit<Dim1, System1>&, const unit<Dim2, System2>&)
        {
            BOOST_STATIC_ASSERT((boost::is_same<System1, System2>::value == true));

            typedef System1 system_type;
            typedef typename subtract_typeof_helper<unit<Dim1, system_type>, unit<Dim2, system_type>>::type type;
        ...
        template<class Dim1, class Dim2, class System1, class System2>
        BOOST_CONSTEXPR typename multiply_typeof_helper<unit<Dim1, System1>, unit<Dim2, System2>>::type
            operator*(const unit<Dim1, System1>&, const unit<Dim2, System2>&)
        {
            typedef typename multiply_typeof_helper<unit<Dim1, System1>, unit<Dim2, System2>>::type type;
        ...
        template<class Dim1, class Dim2, class System1, class System2>
        BOOST_CONSTEXPR typename divide_typeof_helper<unit<Dim1, System1>, unit<Dim2, System2>>::type
            operator/(const unit<Dim1, System1>&, const unit<Dim2, System2>&)
        {
            typedef typename divide_typeof_helper<unit<Dim1, System1>, unit<Dim2, System2>>::type type;
        ...
        template<class Dim1, class Dim2, class System1, class System2>
        inline BOOST_CONSTEXPR bool operator==(const unit<Dim1, System1>&, const unit<Dim2, System2>&)
        {
            return boost::is_same<
                typename reduce_unit<unit<Dim1, System1>>::type,
