...
namespace boost {
    ...
    namespace units {
        ...
        inline BOOST_CONSTEXPR bool isfinite BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isinf BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isnan BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isnormal BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isgreater
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isgreaterequal
            BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isless
            BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool islessequal
            BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool islessgreater
            BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR bool isunordered
            BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> abs BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
            using std::abs;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> ceil BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
            using std::ceil;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y>
            copysign BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> fabs BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
            using std::fabs;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> floor BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
            using std::floor;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y>
            fdim BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
                                      ...
                                      const quantity<Unit3,Y>& q3)
{
    ...
    return quantity_type::from_value(fma BOOST_PREVENT_MACRO_SUBSTITUTION (q1.value(),q2.value(),q3.value()));
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y>
            fmax BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y>
            fmin BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR int fpclassify BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR typename root_typeof_helper<
            typename add_typeof_helper<
                typename power_typeof_helper<quantity<Unit, Y>, static_rational<2>>::type,
                typename power_typeof_helper<quantity<Unit, Y>, static_rational<2>>::type>::type,
            static_rational<2>>::type hypot
            BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
...
nearbyint BOOST_PREVENT_MACRO_SUBSTITUTION (const quantity<Unit,Y>& q)
{
    ...
    return quantity_type::from_value(nearbyint BOOST_PREVENT_MACRO_SUBSTITUTION (q.value()));
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y>
            nextafter BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y>
            nexttoward BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
...
rint BOOST_PREVENT_MACRO_SUBSTITUTION (const quantity<Unit,Y>& q)
{
    ...
    return quantity_type::from_value(rint BOOST_PREVENT_MACRO_SUBSTITUTION (q.value()));
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> round BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR int signbit BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> trunc BOOST_PREVENT_MACRO_SUBSTITUTION(const quantity<Unit, Y>& q)
        {
            using namespace detail;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> fmod(const quantity<Unit, Y>& q1, const quantity<Unit, Y>& q2)
        {
            using std::fmod;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR quantity<Unit, Y> modf(const quantity<Unit, Y>& q1, quantity<Unit, Y>* q2)
        {
            using std::modf;
        ...
        inline BOOST_CONSTEXPR quantity<Unit, Y> frexp(const quantity<Unit, Y>& q, Int* ex)
        {
            using std::frexp;
        ...
        inline BOOST_CONSTEXPR quantity<BOOST_UNITS_DIMENSIONLESS_UNIT(S), Y>
        ...
        template<class Unit, class Y, class Int>
        inline BOOST_CONSTEXPR quantity<Unit, Y> ldexp(const quantity<Unit, Y>& q, const Int& ex)
        {
            using std::ldexp;
        ...
        template<class Unit, class Y>
        inline BOOST_CONSTEXPR typename root_typeof_helper<quantity<Unit, Y>, static_rational<2>>::type
            sqrt(const quantity<Unit, Y>& q)
        {
            using std::sqrt;

            typedef typename root_typeof_helper<quantity<Unit, Y>, static_rational<2>>::type quantity_type;
...
namespace boost {
    ...
    namespace units {
        ...
        template<class Y>
        BOOST_CONSTEXPR typename dimensionless_quantity<si::system, Y>::type
        ...
        BOOST_CONSTEXPR typename dimensionless_quantity<System, Y>::type
        ...
        {
            using std::acos;
            return quantity<unit<plane_angle_dimension, homogeneous_system<System>>, Y>(
                acos(val.value()) * si::radians);
        }

        /// acos of dimensionless quantity returning angle in radians
        template<class Y>
        BOOST_CONSTEXPR quantity<angle::radian_base_unit::unit_type, Y>
        ...
        BOOST_CONSTEXPR quantity<unit<plane_angle_dimension, homogeneous_system<System>>, Y> atan2(
            const quantity<unit<Dimension, homogeneous_system<System>>, Y>& y,
            const quantity<unit<Dimension, homogeneous_system<System>>, Y>& x)
        {
            using std::atan2;
            return quantity<unit<plane_angle_dimension, homogeneous_system<System>>, Y>(
                atan2(y.value(), x.value()) * si::radians);
        }

        /// atan2 of @c value_type returning angle in radians
        template<class Y, class Dimension, class System>
        BOOST_CONSTEXPR quantity<angle::radian_base_unit::unit_type, Y> atan2(
