...
namespace boost {
    ...
    namespace units {
        ...
        struct check_base_dimension
        {
            enum
            {
                value = sizeof(boost_units_is_registered(units::base_dimension_ordinal<N>())) == sizeof(detail::yes) &&
        ...
        template<
            ...
            ,
            class = typename detail::ordinal_has_already_been_defined<check_base_dimension<Derived, N>::value>::type
#endif
            >
        ...
        private:
            ...
            /// INTERNAL ONLY
            friend BOOST_CONSTEXPR Derived* check_double_register(const units::base_dimension_ordinal<N>&)
            {
                return (0);
            }
            ...
            /// INTERNAL ONLY
            friend BOOST_CONSTEXPR detail::yes boost_units_is_registered(const units::base_dimension_ordinal<N>&)
            {
                return (detail::yes());
            }
            ...
            /// INTERNAL ONLY
            friend BOOST_CONSTEXPR detail::yes boost_units_is_registered(const units::base_dimension_pair<Derived, N>&)
            {
                return (detail::yes());
            }
        };
