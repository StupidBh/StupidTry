...
namespace boost {
    ...
    namespace mpl {
        ...
        struct times_impl<boost::units::detail::dim_tag, boost::units::detail::static_rational_tag>
        {
            ...
            struct apply
            {
                typedef boost::units::dim<typename T0::tag_type, typename mpl::times<typename T0::value_type, T1>::type>
                    type;
            };
        };
        ...
        struct times_impl<boost::units::detail::static_rational_tag, boost::units::detail::dim_tag>
        {
            ...
            struct apply
            {
                typedef boost::units::dim<typename T1::tag_type, typename mpl::times<T0, typename T1::value_type>::type>
                    type;
            };
        };
        ...
        struct divides_impl<boost::units::detail::dim_tag, boost::units::detail::static_rational_tag>
        {
            ...
            {
                typedef boost::units::
                    dim<typename T0::tag_type, typename mpl::divides<typename T0::value_type, T1>::type>
                        type;
            };
        };
        ...
        struct divides_impl<boost::units::detail::static_rational_tag, boost::units::detail::dim_tag>
        {
            ...
            {
                typedef boost::units::
                    dim<typename T1::tag_type, typename mpl::divides<T0, typename T1::value_type>::type>
                        type;
            };
        };
        ...
        struct negate_impl<boost::units::detail::dim_tag>
        {
            ...
            struct apply
            {
                typedef boost::units::dim<typename T0::tag_type, typename mpl::negate<typename T0::value_type>::type>
                    type;
            };
        };
