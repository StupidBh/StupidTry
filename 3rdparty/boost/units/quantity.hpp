...
namespace boost {
    ...
    namespace units {
            ...
            struct is_non_narrowing_conversion :
                mpl::and_<
                    ...
                    mpl::not_<mpl::and_<
                        ...
                        mpl::or_<
                            mpl::and_<is_integral<Destination>, mpl::not_<is_integral<Source>>>,
        ...
        class quantity {
            ...
            enum
            {
                force_instantiation_of_unit = sizeof(Unit)
            };
        ...
        public:
            ...
            BOOST_CONSTEXPR quantity(unspecified_null_pointer_constant_type) :
                val_()
            {
                BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            }

            BOOST_CONSTEXPR quantity(const this_type& source) :
                val_(source.val_)
            {
                BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            }
...
// on sun.
#ifdef __SUNPRO_CC
            ~quantity() { unit_type force_unit_instantiation; }
#endif
            ...
            explicit BOOST_CONSTEXPR quantity(
                ...
                typename boost::disable_if<
                    ...
                    typename detail::disable_if_is_same<Unit, Unit2>::type>::type* = 0) :
            ...
            /// implicit conversion between different unit systems is allowed if each fundamental dimension is
            ...
            /// implicit assignment between different unit systems is allowed if each fundamental dimension is
            /// implicitly convertible
            template<class Unit2, class YY>
            ...
            ///< can add a quantity of the same type if add_typeof_helper<value_type,value_type>::type is convertible to
            ///< value_type
            template<class Unit2, class YY>
            BOOST_CXX14_CONSTEXPR this_type& operator+=(const quantity<Unit2, YY>& source)
            {
            ...
            ///< can subtract a quantity of the same type if subtract_typeof_helper<value_type,value_type>::type is
            ...
            ///< can multiply a quantity by a scalar value_type if multiply_typeof_helper<value_type,value_type>::type
            ...
            ///< can divide a quantity by a scalar value_type if divide_typeof_helper<value_type,value_type>::type is
            ///< convertible to value_type
            BOOST_CXX14_CONSTEXPR this_type& operator/=(const value_type& source)
            {
                val_ /= source;
        ...
        protected:
            explicit BOOST_CONSTEXPR quantity(const value_type& val, int) :
                val_(val)
            {
            }
        ...
        public:
            ...
            BOOST_CONSTEXPR quantity(value_type val) :
                val_(val)
            {
                BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            }
            ...
            template<class YY>
            BOOST_CONSTEXPR quantity(
                const quantity<unit<dimension_type, system_type>, YY>& source,
                typename boost::enable_if<detail::is_non_narrowing_conversion<YY, Y>>::type* = 0) :
                val_(source.value())
            {
                BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            ...
            BOOST_CONSTEXPR quantity(
                ...
                typename boost::enable_if<boost::mpl::and_<
                    ...
                    detail::is_dimensionless_system<System2>>>::type* = 0
    #else
            ...
            explicit BOOST_CONSTEXPR quantity(
                ...
                val_(
                    conversion_helper<quantity<unit<dimensionless_type, System2>, Y2>, this_type>::convert(source)
                        .value())
            {
                BOOST_UNITS_CHECK_LAYOUT_COMPATIBILITY(this_type, Y);
            }
            ...
            BOOST_CXX14_CONSTEXPR this_type&
                operator=(const quantity<BOOST_UNITS_DIMENSIONLESS_UNIT(System2), Y>& source)
            {
                *this = this_type(source);
    ...
    namespace units {
        ...
        namespace detail {
            ...
            struct quantity_cast_helper<Y, quantity<Unit, X>>
            {
                ...
                BOOST_CONSTEXPR type operator()(quantity<Unit, X>& source) const
                {
                    return const_cast<X&>(source.value());
                }
            };
        ...
        template<class X, class Y>
        inline BOOST_CONSTEXPR X quantity_cast(Y& source)
        {
            return detail::quantity_cast_helper<X, Y>()(source);
        }

        template<class X, class Y>
        inline BOOST_CONSTEXPR X quantity_cast(const Y& source)
        {
        ...
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<unit<Dim, System>, Y>::type
        ...
        template<class System, class Dim, class Y>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<unit<Dim, System>, Y>::type
            operator/(const unit<Dim, System>&, const Y& rhs)
        {
        ...
        template<class System, class Dim, class Y>
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<Y, unit<Dim, System>>::type
        ...
        template<class System, class Dim, class Y>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<Y, unit<Dim, System>>::type
            operator/(const Y& lhs, const unit<Dim, System>&)
        {
        ...
        /// runtime quantity times scalar
        template<class Unit, class X>
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<quantity<Unit, X>, X>::type
        ...
        /// runtime scalar times quantity
        template<class Unit, class X>
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<X, quantity<Unit, X>>::type
        ...
        /// runtime quantity divided by scalar
        template<class Unit, class X>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<quantity<Unit, X>, X>::type
            operator/(const quantity<Unit, X>& lhs, const X& rhs)
        {
        ...
        /// runtime scalar divided by quantity
        template<class Unit, class X>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<X, quantity<Unit, X>>::type
            operator/(const X& lhs, const quantity<Unit, X>& rhs)
        {
        ...
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<unit<Dim1, System1>, quantity<Unit2, Y>>::type
        ...
        template<class System1, class Dim1, class Unit2, class Y>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<unit<Dim1, System1>, quantity<Unit2, Y>>::type
            operator/(const unit<Dim1, System1>&, const quantity<Unit2, Y>& rhs)
        {
        ...
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<quantity<Unit1, Y>, unit<Dim2, System2>>::type
        ...
        template<class Unit1, class System2, class Dim2, class Y>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<quantity<Unit1, Y>, unit<Dim2, System2>>::type
            operator/(const quantity<Unit1, Y>& lhs, const unit<Dim2, System2>&)
        {
        ...
        template<class Unit, class Y>
        BOOST_CONSTEXPR typename unary_plus_typeof_helper<quantity<Unit, Y>>::type
        ...
        template<class Unit, class Y>
        BOOST_CONSTEXPR typename unary_minus_typeof_helper<quantity<Unit, Y>>::type
            operator-(const quantity<Unit, Y>& val)
        {
        ...
        template<class Unit1, class Unit2, class X, class Y>
        inline BOOST_CONSTEXPR typename add_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
        ...
        template<class Unit1, class Unit2, class X, class Y>
        inline BOOST_CONSTEXPR typename subtract_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
            operator-(const quantity<Unit1, X>& lhs, const quantity<Unit2, Y>& rhs)
        {
        ...
        template<class Unit1, class Unit2, class X, class Y>
        inline BOOST_CONSTEXPR typename multiply_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
            operator*(const quantity<Unit1, X>& lhs, const quantity<Unit2, Y>& rhs)
        {
            typedef typename multiply_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type type;
        ...
        template<class Unit1, class Unit2, class X, class Y>
        inline BOOST_CONSTEXPR typename divide_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type
            operator/(const quantity<Unit1, X>& lhs, const quantity<Unit2, Y>& rhs)
        {
            typedef typename divide_typeof_helper<quantity<Unit1, X>, quantity<Unit2, Y>>::type type;
        ...
        /// runtime operator==
        template<class Unit, class X, class Y>
        inline BOOST_CONSTEXPR bool operator==(const quantity<Unit, X>& val1, const quantity<Unit, Y>& val2)
        {
