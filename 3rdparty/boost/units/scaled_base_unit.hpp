        ...
        struct scaled_base_unit
        {
            ...
            typedef unit<
                ...
                heterogeneous_system<heterogeneous_system_impl<
                    list<heterogeneous_system_dim<scaled_base_unit, static_rational<1>>, dimensionless_type>,
                    dimension_type,
                    dimensionless_type>>>
                unit_type;
            ...
            static std::string symbol() { return (Scale::symbol() + base_unit_info<S>::symbol()); }

            static std::string name() { return (Scale::name() + base_unit_info<S>::name()); }
        };
        ...
        struct less_impl<boost::units::scaled_base_unit_tag, Tag>
        {
            ...
            struct apply :
                mpl::bool_<
                    ...
                    (boost::is_same<typename T0::system_type, T1>::value &&
                     ((T0::scale_type::exponent::Numerator) < 0))>
            {
            };
        };
        ...
        struct less_impl<Tag, boost::units::scaled_base_unit_tag>
        {
            ...
            struct apply :
                mpl::bool_<
                    ...
                    (boost::is_same<T0, typename T1::system_type>::value &&
                     ((T1::scale_type::exponent::Numerator) > 0))>
            {
            };
        };
