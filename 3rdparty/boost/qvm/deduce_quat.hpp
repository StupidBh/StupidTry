...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            template<class Q, class S, class QS = typename quat_traits<Q>::scalar_type>
            struct deduce_q_default
            {
        ...
        namespace qvm_detail {
            ...
            struct deduce_q2_default
            {
                typedef quat<S> type;
            };

            template<class Q, class S>
            struct deduce_q2_default<Q, Q, S, false, false>
            {
                BOOST_QVM_STATIC_ASSERT(is_quat<Q>::value);
                typedef Q type;
            };
            ...
            struct deduce_q2_default<A, B, S, false, true>
            {
            ...
            template<class A, class B, class S>
            struct deduce_q2_default<A, B, S, true, false>
            {
        ...
        template<
            class A,
            class B,
            class S = typename deduce_scalar<typename scalar<A>::type, typename scalar<B>::type>::type>
        struct deduce_quat2
        {
