...
namespace boost {
    namespace qvm {
        ...
        {
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL Scalar value(int v) { return Scalar(v); }
        };
        ...
        namespace qvm_detail {
            ...
            template<class A>
            struct scalar_impl<A, false, false, false, true>
            {
                typedef A type;
            };

            template<class A>
            struct scalar_impl<A, false, false, true, false>
            {
                typedef typename mat_traits<A>::scalar_type type;
            };

            template<class A>
            struct scalar_impl<A, false, true, false, false>
            {
                typedef typename vec_traits<A>::scalar_type type;
            };

            template<class A>
            struct scalar_impl<A, true, false, false, false>
            {
