...
namespace boost {
    namespace qvm {
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            mat_traits<A>::rows == 2 && mat_traits<B>::rows == 2 && mat_traits<A>::cols == 2 &&
                mat_traits<B>::cols == 2,
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            mat_traits<A>::rows == 2 && mat_traits<B>::rows == 2 && mat_traits<A>::cols == 1 &&
                mat_traits<B>::cols == 1,
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            mat_traits<A>::rows == 1 && mat_traits<B>::rows == 1 && mat_traits<A>::cols == 2 &&
                mat_traits<B>::cols == 2,
        ...
        namespace qvm_detail {
            ...
            template<>
            struct minus_eq_mm_defined<2, 2>
            {
                static bool const value = true;
            };
        }
        ...
        namespace qvm_detail {
            ...
            template<>
            struct minus_eq_mm_defined<2, 1>
            {
                static bool const value = true;
            };
        }
        ...
        namespace qvm_detail {
            ...
            template<>
            struct minus_eq_mm_defined<1, 2>
            {
                static bool const value = true;
            };
        }
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename enable_if_c<mat_traits<A>::rows == 2 && mat_traits<A>::cols == 2 && is_scalar<B>::value, A&>::type
            operator*=(A& a, B b)
        {
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename enable_if_c<mat_traits<A>::rows == 2 && mat_traits<A>::cols == 1 && is_scalar<B>::value, A&>::type
            operator*=(A& a, B b)
        {
            write_mat_element<0, 0>(a, mat_traits<A>::template read_element<0, 0>(a) * b);
            write_mat_element<1, 0>(a, mat_traits<A>::template read_element<1, 0>(a) * b);
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename enable_if_c<mat_traits<A>::rows == 1 && mat_traits<A>::cols == 2 && is_scalar<B>::value, A&>::type
            operator*=(A& a, B b)
        {
            write_mat_element<0, 0>(a, mat_traits<A>::template read_element<0, 0>(a) * b);
            write_mat_element<0, 1>(a, mat_traits<A>::template read_element<0, 1>(a) * b);
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            mat_traits<R>::rows == 2 && mat_traits<A>::rows == 2 && mat_traits<R>::cols == 2 &&
                mat_traits<A>::cols == 2,
            R>::type
        ...
        namespace qvm_detail {
            ...
            template<>
            struct convert_to_m_defined<2, 2>
            {
                static bool const value = true;
            };
        }
        ...
        template<class R, class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            mat_traits<R>::rows == 2 && mat_traits<A>::rows == 2 && mat_traits<R>::cols == 1 &&
                mat_traits<A>::cols == 1,
            R>::type
            convert_to(A const& a)
        {
        ...
        namespace qvm_detail {
            ...
            template<>
            struct convert_to_m_defined<2, 1>
            {
                static bool const value = true;
            };
        }
        ...
        template<class R, class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            mat_traits<R>::rows == 1 && mat_traits<A>::rows == 1 && mat_traits<R>::cols == 2 &&
                mat_traits<A>::cols == 2,
            R>::type
            convert_to(A const& a)
        {
        ...
        namespace qvm_detail {
            ...
            template<>
            struct convert_to_m_defined<1, 2>
            {
                static bool const value = true;
            };
        }
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename lazy_enable_if_c<mat_traits<A>::rows == 2 && mat_traits<A>::cols == 2, deduce_mat<A>>::type
            operator-(A const& a)
        {
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename lazy_enable_if_c<mat_traits<A>::rows == 2 && mat_traits<A>::cols == 1, deduce_mat<A>>::type
            operator-(A const& a)
        {
            typedef typename deduce_mat<A>::type R;
            R r;
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename lazy_enable_if_c<mat_traits<A>::rows == 1 && mat_traits<A>::cols == 2, deduce_mat<A>>::type
            operator-(A const& a)
        {
            typedef typename deduce_mat<A>::type R;
            R r;
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            mat_traits<A>::rows == 1 && mat_traits<B>::rows == 2 && mat_traits<A>::cols == 2 &&
                mat_traits<B>::cols == 2,
            deduce_mat2<A, B, 1, 2>>::type
            operator*(A const& a, B const& b)
        {
