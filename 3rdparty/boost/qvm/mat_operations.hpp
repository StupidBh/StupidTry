...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            ...
            void const* get_valid_ptr_mat_operations()
            {
        ...
        namespace qvm_detail {
            ...
            struct to_string_m_defined
            {
                static bool const value = false;
            };

            template<int I, int SizeMinusOne>
            struct to_string_matrix_elements
            {
                template<class A>
                static std::string f(A const& a)
                {
                    using namespace qvm_to_string_detail;
                    return ((I % mat_traits<A>::cols) == 0 ? '(' : ',') +
                           to_string(
                               mat_traits<A>::template read_element<I / mat_traits<A>::cols, I % mat_traits<A>::cols>(
                                   a)) +
            ...
            struct to_string_matrix_elements<SizeMinusOne, SizeMinusOne>
            {
                template<class A>
                static std::string f(A const& a)
                {
                    using namespace qvm_to_string_detail;
                    return ((SizeMinusOne % mat_traits<A>::cols) == 0 ? '(' : ',') +
                           to_string(
                               mat_traits<A>::template read_element<
                                   SizeMinusOne / mat_traits<A>::cols,
                                   SizeMinusOne % mat_traits<A>::cols>(a)) +
                           ')';
                }
            };
        }
        ...
        inline typename enable_if_c<
            is_mat<A>::value && !qvm_detail::to_string_m_defined<mat_traits<A>::rows, mat_traits<A>::cols>::value,
            std::string>::type
            to_string(A const& a)
        {
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_mat<A>::value && is_mat<B>::value && mat_traits<A>::rows == mat_traits<B>::rows &&
            ...
            cmp(A const& a, B const& b, Cmp f)
        {
            for (int i = 0; i != mat_traits<A>::rows; ++i) {
                for (int j = 0; j != mat_traits<A>::cols; ++j) {
                    if (!f(mat_traits<A>::read_element_idx(i, j, a), mat_traits<B>::read_element_idx(i, j, b))) {
                        return false;
                    }
                }
            }
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL typename enable_if_c<
            is_mat<R>::value && is_mat<A>::value && mat_traits<R>::rows == mat_traits<A>::rows &&
...
#endif
                    >
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL operator R() const
                {
                    R r;
                    assign(r, *this);
                    return r;
        ...
        template<class T, int Dim>
        struct mat_traits<qvm_detail::identity_mat_<T, Dim>>
        {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_matrix const& /*x*/)
            {
        ...
        template<class T, int Dim>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::identity_mat_<T, Dim> const& identity_mat()
        {
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename enable_if_c<is_mat<A>::value && mat_traits<A>::rows == mat_traits<A>::cols, void>::type
            set_identity(A& a)
        {
        ...
        namespace qvm_detail {
            ...
            struct projection_
            {
                ...
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL projection_(T _00, T _11, T _22, T _23, T _32) :
                    _00(_00),
                    _11(_11),
                    _22(_22),
                    _23(_23),
            ...
            template<int Row, int Col>
            struct projection_get
            {
                template<class T>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const&)
                {
            ...
            template<>
            struct projection_get<0, 0>
            {
                template<class T>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL T get(projection_<T> const& m)
                {
                    return m._00;
                }
            };
        ...
        template<class T>
        struct mat_traits<qvm_detail::projection_<T>>
        {
        ...
        qvm_detail::projection_<T>
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS perspective_lh(T fov_y, T aspect_ratio, T z_near, T z_far)
        {
        ...
        template<class T>
        qvm_detail::projection_<T>
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS perspective_rh(T fov_y, T aspect_ratio, T z_near, T z_far)
        {
            T const one = scalar_traits<T>::value(1);
            T const ys = one / tan(fov_y / scalar_traits<T>::value(2));
            T const xs = ys / aspect_ratio;
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL matrix_scalar_cast_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<bool>
            struct scalar_cast_matrix_filter
            {
            };

            template<>
            struct scalar_cast_matrix_filter<true>
            {
                typedef int type;
            };
        }
        ...
        template<class OriginalType, class Scalar>
        struct mat_traits<qvm_detail::matrix_scalar_cast_<OriginalType, Scalar>>
        {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_matrix const& x)
            {
                ...
                BOOST_QVM_STATIC_ASSERT(Col < cols);
                return scalar_type(
                    mat_traits<OriginalType>::template read_element<Row, Col>(
                ...
                read_element_idx(int row, int col, this_matrix const& x)
            {
                ...
                return scalar_type(
                    mat_traits<OriginalType>::read_element_idx(col, row, reinterpret_cast<OriginalType const&>(x)));
            }
        };

        template<class OriginalType, class Scalar, int R, int C>
        struct deduce_mat<qvm_detail::matrix_scalar_cast_<OriginalType, Scalar>, R, C>
        {
            typedef mat<Scalar, R, C> type;
        };

        template<class Scalar, class T>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::matrix_scalar_cast_<T, Scalar> const&
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_mat<A>::value && is_scalar<B>::value &&
            ...
            operator-=(A& a, B const& b)
        {
            for (int i = 0; i != mat_traits<A>::rows; ++i) {
                for (int j = 0; j != mat_traits<A>::cols; ++j) {
                    write_mat_element_idx(
                        i,
                        j,
                        a,
                        mat_traits<A>::read_element_idx(i, j, a) - mat_traits<B>::read_element_idx(i, j, b));
                }
            }
            return a;
        }
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_mat<A>::value && !qvm_detail::minus_m_defined<mat_traits<A>::rows, mat_traits<A>::cols>::value,
            deduce_mat<A>>::type
            operator-(A const& a)
        {
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_mat<A>::value && is_mat<B>::value && mat_traits<A>::rows == mat_traits<A>::cols &&
                mat_traits<A>::rows == mat_traits<B>::rows && mat_traits<A>::cols == mat_traits<B>::cols &&
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_mat<A>::value && is_mat<B>::value && mat_traits<A>::cols == mat_traits<B>::rows &&
        ...
        namespace qvm_detail {
            ...
            public:
                template<class R>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL mref_& operator=(R const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class M>
            struct mref_write_traits<M, true>
            {
                ...
                template<int Row, int Col>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type& write_element(this_matrix& x)
                {
                    BOOST_QVM_STATIC_ASSERT(Row >= 0);
                    BOOST_QVM_STATIC_ASSERT(Row < rows);
                    BOOST_QVM_STATIC_ASSERT(Col >= 0);
            ...
            template<class M>
            struct mref_write_traits<M, false>
            {
                typedef typename mat_traits<M>::scalar_type scalar_type;
                typedef qvm_detail::mref_<M> this_matrix;
                static int const rows = mat_traits<M>::rows;
                ...
                template<int Row, int Col>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL void write_element(this_matrix& x, scalar_type s)
                {
                    BOOST_QVM_STATIC_ASSERT(Row >= 0);
                    BOOST_QVM_STATIC_ASSERT(Row < rows);
                    BOOST_QVM_STATIC_ASSERT(Col >= 0);
                ...
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL void
        ...
        template<class M>
        struct mat_traits<qvm_detail::mref_<M>> : qvm_detail::mref_write_traits<M>
        {
            typedef typename mat_traits<M>::scalar_type scalar_type;
            typedef qvm_detail::mref_<M> this_matrix;
            static int const rows = mat_traits<M>::rows;
        ...
        struct deduce_mat<qvm_detail::mref_<M>, R, C>
        {
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            typename enable_if_c<is_mat<M>::value, qvm_detail::mref_<M> const&>::type
            mref(M const& a)
        {
        ...
        template<class M>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL typename enable_if_c<is_mat<M>::value, qvm_detail::mref_<M>&>::type
            mref(M& a)
        {
        ...
        template<class T, int Rows, int Cols>
        struct mat_traits<qvm_detail::zero_mat_<T, Rows, Cols>>
        {
            ...
            template<int Row, int Col>
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_matrix const&)
            {
                BOOST_QVM_STATIC_ASSERT(Row >= 0);
                BOOST_QVM_STATIC_ASSERT(Row < rows);
                BOOST_QVM_STATIC_ASSERT(Col >= 0);
        ...
        struct deduce_mat<qvm_detail::zero_mat_<T, Rows, Cols>, R, C>
        {
            typedef mat<T, R, C> type;
        };

        template<class T, int Rows, int Cols>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::zero_mat_<T, Rows, Cols> const& zero_mat()
        {
            return *(qvm_detail::zero_mat_<T, Rows, Cols> const*)qvm_detail::get_valid_ptr_mat_operations();
        }

        template<class T, int Dim>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::zero_mat_<T, Dim, Dim> const& zero_mat()
        {
            return *(qvm_detail::zero_mat_<T, Dim, Dim> const*)qvm_detail::get_valid_ptr_mat_operations();
        }

        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<is_mat<A>::value, void>::type
            set_zero(A& a)
        {
        ...
        namespace qvm_detail {
            ...
            struct rot_mat_
            {
                ...
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE rot_mat_(
                    scalar_type a00,
                    scalar_type a01,
                    scalar_type a02,
                    scalar_type a10,
            ...
            {
                template<class T>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL T get(T const (&)[3][3])
                {
            ...
            template<>
            struct rot_m_get<0, 0>
            {
                template<class T>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL T get(T const (&a)[3][3])
                {
                    return a[0][0];
                }
            };
        ...
        template<int D, class S>
        struct mat_traits<qvm_detail::rot_mat_<D, S>>
        {
                ...
                read_element_idx(int row, int col, this_matrix const& x)
            {
                ...
                return row < 3 && col < 3 ? x.a[row][col] : scalar_traits<scalar_type>::value(row == col);
            }
        };

        template<int Dim, class V, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE
            typename enable_if_c<is_vec<V>::value && vec_traits<V>::dim == 3, qvm_detail::rot_mat_<Dim, Angle>>::type
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_xzy(Angle x1, Angle z2, Angle y3)
        {
            typedef Angle scalar_type;
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_xyz(Angle x1, Angle y2, Angle z3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(x1);
            scalar_type const s1 = sin(x1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_yxz(Angle y1, Angle x2, Angle z3)
        {
            typedef Angle scalar_type;
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_yzx(Angle y1, Angle z2, Angle x3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(y1);
            scalar_type const s1 = sin(y1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_zyx(Angle z1, Angle y2, Angle x3)
        {
            typedef Angle scalar_type;
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_zxy(Angle z1, Angle x2, Angle y3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(z1);
            scalar_type const s1 = sin(z1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_xzx(Angle x1, Angle z2, Angle x3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(x1);
            scalar_type const s1 = sin(x1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_xyx(Angle x1, Angle y2, Angle x3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(x1);
            scalar_type const s1 = sin(x1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_yxy(Angle y1, Angle x2, Angle y3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(y1);
            scalar_type const s1 = sin(y1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_yzy(Angle y1, Angle z2, Angle y3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(y1);
            scalar_type const s1 = sin(y1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_zyz(Angle z1, Angle y2, Angle z3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(z1);
            scalar_type const s1 = sin(z1);
        ...
        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE qvm_detail::rot_mat_<Dim, Angle> rot_mat_zxz(Angle z1, Angle x2, Angle z3)
        {
            typedef Angle scalar_type;
            scalar_type const c1 = cos(z1);
            scalar_type const s1 = sin(z1);
        ...
        namespace qvm_detail {
            ...
            struct rotx_mat_
            {
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL rotx_mat_() {}
            ...
            {
                template<class T>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL T get(T const&)
                {
                    return scalar_traits<T>::value(Row == Col);
                }
            };
            ...
            template<>
            struct rotx_m_get<1, 1>
            {
                template<class T>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL T get(T const& angle)
                {
                    return cos(angle);
                }
            };
        ...
        template<int Dim, class Angle>
        struct mat_traits<qvm_detail::rotx_mat_<Dim, Angle>>
        {
        ...
        template<int Dim, class Angle>
        struct deduce_mat<qvm_detail::rotx_mat_<Dim, Angle>, Dim, Dim>
        {
            typedef mat<Angle, Dim, Dim> type;
        };

        template<int Dim, class Angle>
        struct deduce_mat2<qvm_detail::rotx_mat_<Dim, Angle>, qvm_detail::rotx_mat_<Dim, Angle>, Dim, Dim>
        {
            typedef mat<Angle, Dim, Dim> type;
        };

        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::rotx_mat_<Dim, Angle> const&
        ...
        template<class A, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_mat<A>::value && mat_traits<A>::rows >= 3 && mat_traits<A>::rows == mat_traits<A>::cols,
            void>::type
        ...
        namespace qvm_detail {
            ...
            struct roty_mat_
            {
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL roty_mat_() {}
        ...
        template<int Dim, class Angle>
        struct mat_traits<qvm_detail::roty_mat_<Dim, Angle>>
        {
        ...
        template<int Dim, class Angle>
        struct deduce_mat<qvm_detail::roty_mat_<Dim, Angle>, Dim, Dim>
        {
            typedef mat<Angle, Dim, Dim> type;
        };

        template<int Dim, class Angle>
        struct deduce_mat2<qvm_detail::roty_mat_<Dim, Angle>, qvm_detail::roty_mat_<Dim, Angle>, Dim, Dim>
        {
            typedef mat<Angle, Dim, Dim> type;
        };

        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::roty_mat_<Dim, Angle> const&
        ...
        template<class A, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_mat<A>::value && mat_traits<A>::rows >= 2 && mat_traits<A>::rows == mat_traits<A>::cols,
            void>::type
        ...
        namespace qvm_detail {
            ...
            struct rotz_mat_
            {
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL rotz_mat_() {}
        ...
        template<int Dim, class Angle>
        struct mat_traits<qvm_detail::rotz_mat_<Dim, Angle>>
        {
        ...
        template<int Dim, class Angle>
        struct deduce_mat<qvm_detail::rotz_mat_<Dim, Angle>, Dim, Dim>
        {
            typedef mat<Angle, Dim, Dim> type;
        };

        template<int Dim, class Angle, int R, int C>
        struct deduce_mat2<qvm_detail::rotz_mat_<Dim, Angle>, qvm_detail::rotz_mat_<Dim, Angle>, R, C>
        {
            typedef mat<Angle, R, C> type;
        };

        template<int Dim, class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::rotz_mat_<Dim, Angle> const&
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL typename lazy_enable_if_c<
            is_mat<A>::value && is_scalar<B>::value && mat_traits<A>::rows == mat_traits<A>::cols &&
