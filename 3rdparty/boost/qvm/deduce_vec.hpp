...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            ...
            struct deduce_v_default<V, D, S, D, S>
            {
                BOOST_QVM_STATIC_ASSERT(is_vec<V>::value);
                typedef V type;
            };
        ...
        namespace qvm_detail {
            ...
            struct deduce_v2_default
            {
                typedef vec<S, D> type;
            };

            template<class V, int D, class S>
            struct deduce_v2_default<V, V, D, S, false, false>
            {
                BOOST_QVM_STATIC_ASSERT(is_vec<V>::value);
                typedef V type;
            };
            ...
            struct deduce_v2_default<A, B, D, S, false, true>
            {
            ...
            template<class A, class B, int D, class S>
            struct deduce_v2_default<A, B, D, S, true, false>
            {
