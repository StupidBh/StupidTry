...
namespace boost {
    namespace qvm {
        ...
        template<class A>
        inline typename enable_if_c<is_quat<A>::value, std::string>::type to_string(A const& a)
        {
            ...
            cmp(A const& a, B const& b, Cmp f)
        {
            ...
            U q2[4] = { quat_traits<B>::template read_element<0>(b),
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_quat<R>::value && is_mat<A>::value && mat_traits<A>::rows == 3 && mat_traits<A>::cols == 3,
            R>::type
            convert_to(A const& a)
        {
        ...
        template<class T>
        struct quat_traits<qvm_detail::identity_quat_<T>>
        {
            typedef qvm_detail::identity_quat_<T> this_quaternion;
            typedef T scalar_type;

            template<int I>
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_quaternion const&)
            {
        ...
        template<class T>
        struct deduce_quat<qvm_detail::identity_quat_<T>>
        {
            typedef quat<T> type;
        };

        template<class T>
        struct deduce_quat2<qvm_detail::identity_quat_<T>, qvm_detail::identity_quat_<T>>
        {
            typedef quat<T> type;
        };

        template<class T>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::identity_quat_<T> const& identity_quat()
        {
            return *(qvm_detail::identity_quat_<T> const*)qvm_detail::get_valid_ptr_quat_operations();
        }

        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<is_quat<A>::value, void>::type
            set_identity(A& a)
        {
            typedef typename quat_traits<A>::scalar_type T;
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL quaternion_scalar_cast_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<bool>
            struct scalar_cast_quaternion_filter
            {
            };

            template<>
            struct scalar_cast_quaternion_filter<true>
            {
                typedef int type;
            };
        }
        ...
        struct quat_traits<qvm_detail::quaternion_scalar_cast_<OriginalType, Scalar>>
        {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_quaternion const& x)
            {
                ...
                BOOST_QVM_STATIC_ASSERT(I < 4);
                return scalar_type(
                    quat_traits<OriginalType>::template read_element<I>(reinterpret_cast<OriginalType const&>(x)));
            }
                ...
                read_element_idx(int i, this_quaternion const& x)
            {
                ...
                BOOST_QVM_ASSERT(i < 4);
                return scalar_type(
                    quat_traits<OriginalType>::read_element_idx(i, reinterpret_cast<OriginalType const&>(x)));
            }
        };

        template<class Scalar, class T>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::quaternion_scalar_cast_<T, Scalar> const&
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename lazy_enable_if_c<is_quat<A>::value && is_scalar<B>::value, deduce_quat2<A, B>>::type
        ...
        {
            return quat_traits<A>::template read_element<0>(a) == quat_traits<B>::template read_element<0>(b) &&
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename enable_if_c<is_quat<A>::value, typename quat_traits<A>::scalar_type>::type
            mag_sqr(A const& a)
        {
            typedef typename quat_traits<A>::scalar_type T;
        ...
        {
            write_quat_element<0>(
                a,
                quat_traits<A>::template read_element<0>(a) - quat_traits<B>::template read_element<0>(b));
            write_quat_element<1>(
                a,
                quat_traits<A>::template read_element<1>(a) - quat_traits<B>::template read_element<1>(b));
            write_quat_element<2>(
                a,
                quat_traits<A>::template read_element<2>(a) - quat_traits<B>::template read_element<2>(b));
            write_quat_element<3>(
                a,
                quat_traits<A>::template read_element<3>(a) - quat_traits<B>::template read_element<3>(b));
            return a;
        }
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename lazy_enable_if_c<is_quat<A>::value && is_quat<B>::value, deduce_quat2<A, B>>::type
            operator-(A const& a, B const& b)
        {
            typedef typename deduce_quat2<A, B>::type R;
            R r;
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename lazy_enable_if_c2<is_quat<A>::value && is_scalar<B>::value, deduce_quat2<A, B>>::type
            operator*(A const& a, B b)
        {
            typedef typename deduce_quat2<A, B>::type R;
            R r;
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_quat<A>::value && is_quat<B>::value && is_scalar<C>::value,
            deduce_quat2<A, B>>::type slerp(A const& a, B const& b, C t)
        {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class R>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qref_& operator=(R const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class Q>
            struct qref_write_traits<Q, true>
            {
            ...
            template<class Q>
            struct qref_write_traits<Q, false>
            {
                typedef typename quat_traits<Q>::scalar_type scalar_type;
                typedef qvm_detail::qref_<Q> this_quaternion;
        ...
        template<class Q>
        struct quat_traits<qvm_detail::qref_<Q>> : qvm_detail::qref_write_traits<Q>
        {
            typedef typename quat_traits<Q>::scalar_type scalar_type;
            typedef qvm_detail::qref_<Q> this_quaternion;
        ...
        template<class Q>
        struct deduce_quat<qvm_detail::qref_<Q>>
        {
        ...
        template<class T>
        struct quat_traits<qvm_detail::zero_q_<T>>
        {
        ...
        template<class T>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::zero_q_<T> const& zero_quat()
        {
        ...
        namespace qvm_detail {
            ...
            struct rot_quat_
            {
                ...
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE rot_quat_(V const& axis, Angle angle)
                {
        ...
        template<class V>
        struct quat_traits<qvm_detail::rot_quat_<V>>
        {
        ...
        template<class V>
        struct deduce_quat<qvm_detail::rot_quat_<V>>
        {
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE
            typename enable_if_c<is_vec<A>::value && vec_traits<A>::dim == 3, qvm_detail::rot_quat_<A>>::type
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS
            typename enable_if_c<is_quat<A>::value && is_vec<B>::value && vec_traits<B>::dim == 3, void>::type
        ...
        namespace qvm_detail {
            ...
            struct rotx_quat_
            {
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL rotx_quat_() {}
        ...
        template<class Angle>
        struct quat_traits<qvm_detail::rotx_quat_<Angle>>
        {
        ...
        template<class Angle>
        struct deduce_quat<qvm_detail::rotx_quat_<Angle>>
        {
            typedef quat<Angle> type;
        };

        template<class Angle>
        struct deduce_quat2<qvm_detail::rotx_quat_<Angle>, qvm_detail::rotx_quat_<Angle>>
        {
            typedef quat<Angle> type;
        };

        template<class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::rotx_quat_<Angle> const& rotx_quat(Angle const& angle)
        {
        ...
        namespace qvm_detail {
            ...
            struct roty_quat_
            {
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL roty_quat_() {}
        ...
        template<class Angle>
        struct quat_traits<qvm_detail::roty_quat_<Angle>>
        {
        ...
        template<class Angle>
        struct deduce_quat<qvm_detail::roty_quat_<Angle>>
        {
            typedef quat<Angle> type;
        };

        template<class Angle>
        struct deduce_quat2<qvm_detail::roty_quat_<Angle>, qvm_detail::roty_quat_<Angle>>
        {
            typedef quat<Angle> type;
        };

        template<class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::roty_quat_<Angle> const& roty_quat(Angle const& angle)
        {
        ...
        namespace qvm_detail {
            ...
            struct rotz_quat_
            {
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL rotz_quat_() {}
        ...
        template<class Angle>
        struct quat_traits<qvm_detail::rotz_quat_<Angle>>
        {
        ...
        template<class Angle>
        struct deduce_quat<qvm_detail::rotz_quat_<Angle>>
        {
            typedef quat<Angle> type;
        };

        template<class Angle>
        struct deduce_quat2<qvm_detail::rotz_quat_<Angle>, qvm_detail::rotz_quat_<Angle>>
        {
            typedef quat<Angle> type;
        };

        template<class Angle>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::rotz_quat_<Angle> const& rotz_quat(Angle const& angle)
        {
