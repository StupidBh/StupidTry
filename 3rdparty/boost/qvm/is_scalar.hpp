...
namespace boost {
    namespace qvm {
        ...
        template<class T>
        struct is_scalar<T const> : is_scalar<T>
        {
        };

        template<>
        struct is_scalar<signed char>
        {
        ...
        template<>
        struct is_scalar<signed long long>
        {
            static bool const value = true;
        };
