...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            template<int D>
            struct to_string_v_defined
            {
                static bool const value = false;
            };

            template<int I, int DimMinusOne>
            struct to_string_vector_elements
            {
                template<class A>
        ...
        inline typename enable_if_c<
            is_vec<A>::value && !qvm_detail::to_string_v_defined<vec_traits<A>::dim>::value,
            std::string>::type
            to_string(A const& a)
        {
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL typename enable_if_c<
            is_vec<R>::value && is_vec<A>::value && vec_traits<R>::dim == vec_traits<A>::dim &&
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_vec<A>::value && is_vec<B>::value && vec_traits<A>::dim == 3 && vec_traits<B>::dim == 3,
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_vec<A>::value && is_vec<B>::value && vec_traits<A>::dim == 2 && vec_traits<B>::dim == 2,
            deduce_scalar<typename vec_traits<A>::scalar_type, typename vec_traits<B>::scalar_type>>::type
            cross(A const& a, B const& b)
        {
            typedef
                typename deduce_scalar<typename vec_traits<A>::scalar_type, typename vec_traits<B>::scalar_type>::type
                    R;
            R const r = vec_traits<A>::template read_element<0>(a) * vec_traits<B>::template read_element<1>(b) -
                        vec_traits<A>::template read_element<1>(a) * vec_traits<B>::template read_element<0>(b);
            return r;
        }
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_vec<A>::value && is_vec<B>::value && vec_traits<A>::dim == vec_traits<B>::dim,
            bool>::type
            cmp(A const& a, B const& b, Cmp f)
        {
            for (int i = 0; i != vec_traits<A>::dim; ++i) {
                if (!f(vec_traits<A>::read_element_idx(i, a), vec_traits<B>::read_element_idx(i, b))) {
                    return false;
                }
            }
            return true;
        ...
        template<class T, int Dim>
        struct vec_traits<qvm_detail::zero_vec_<T, Dim>>
        {
            ...
            template<int I>
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_vector const&)
            {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element_idx(int i, this_vector const&)
            {
        ...
        template<class T, int Dim>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::zero_vec_<T, Dim> const& zero_vec()
        {
            return *(qvm_detail::zero_vec_<T, Dim> const*)qvm_detail::get_valid_ptr_vec_operations();
        }

        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<is_vec<A>::value, void>::type
            set_zero(A& a)
        {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL vector_scalar_cast_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<bool>
            struct scalar_cast_vector_filter
            {
            };

            template<>
            struct scalar_cast_vector_filter<true>
            {
                typedef int type;
            };
        }
        ...
        struct vec_traits<qvm_detail::vector_scalar_cast_<OriginalType, Scalar>>
        {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_vector const& x)
            {
                ...
                BOOST_QVM_STATIC_ASSERT(I < dim);
                return scalar_type(
                    vec_traits<OriginalType>::template read_element<I>(reinterpret_cast<OriginalType const&>(x)));
            }
                ...
                read_element_idx(int i, this_vector const& x)
            {
                ...
                BOOST_QVM_ASSERT(i < dim);
                return scalar_type(
                    vec_traits<OriginalType>::read_element_idx(i, reinterpret_cast<OriginalType const&>(x)));
            }
        };
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL qvm_detail::vector_scalar_cast_<T, Scalar> const&
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_vec<A>::value && is_scalar<B>::value && !qvm_detail::div_eq_vs_defined<vec_traits<A>::dim>::value,
            A&>::type
            operator/=(A& a, B b)
        {
            for (int i = 0; i != vec_traits<A>::dim; ++i) {
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_vec<A>::value && is_scalar<B>::value && !qvm_detail::div_vs_defined<vec_traits<A>::dim>::value,
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_vec<A>::value && !qvm_detail::mag_sqr_v_defined<vec_traits<A>::dim>::value,
        ...
        {
            for (int i = 0; i != vec_traits<A>::dim; ++i) {
                write_vec_element_idx(
                    i,
                    a,
                    vec_traits<A>::read_element_idx(i, a) - vec_traits<B>::read_element_idx(i, b));
            }
            return a;
        }
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename enable_if_c<
            is_vec<A>::value && is_scalar<B>::value && !qvm_detail::mul_eq_vs_defined<vec_traits<A>::dim>::value,
            A&>::type
            operator*=(A& a, B b)
        {
            for (int i = 0; i != vec_traits<A>::dim; ++i) {
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_vec<A>::value && is_scalar<B>::value && !qvm_detail::mul_vs_defined<vec_traits<A>::dim>::value,
            deduce_vec2<A, B, vec_traits<A>::dim>>::type
            operator*(A const& a, B b)
        {
            typedef typename deduce_vec2<A, B, vec_traits<A>::dim>::type R;
        ...
        template<class A, class B>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_scalar<A>::value && is_vec<B>::value && !qvm_detail::mul_sv_defined<vec_traits<B>::dim>::value,
        ...
        template<class A>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_OPERATIONS typename lazy_enable_if_c<
            is_vec<A>::value && !qvm_detail::normalize_v_defined<vec_traits<A>::dim>::value,
            deduce_vec<A>>::type
        ...
        namespace qvm_detail {
            ...
            public:
                template<class R>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL vref_& operator=(R const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class V>
            struct vref_write_traits<V, true>
            {
            ...
            template<class V>
            struct vref_write_traits<V, false>
            {
                typedef typename vec_traits<V>::scalar_type scalar_type;
                typedef qvm_detail::vref_<V> this_vector;
                static int const dim = vec_traits<V>::dim;
                ...
                template<int I>
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL void write_element(this_vector& x, scalar_type s)
                {
                    BOOST_QVM_STATIC_ASSERT(I >= 0);
                    BOOST_QVM_STATIC_ASSERT(I < dim);
        ...
        template<class V>
        struct vec_traits<qvm_detail::vref_<V>> : qvm_detail::vref_write_traits<V>
        {
            typedef typename vec_traits<V>::scalar_type scalar_type;
            typedef qvm_detail::vref_<V> this_vector;
            static int const dim = vec_traits<V>::dim;
        ...
        struct deduce_vec<qvm_detail::vref_<V>, D>
        {
        ...
        template<class V>
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL typename enable_if_c<is_vec<V>::value, qvm_detail::vref_<V>&>::type
            vref(V& a)
        {
