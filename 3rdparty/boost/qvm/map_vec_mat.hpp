...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL col_mat_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class OriginalVector>
            struct col_mat_write_traits<OriginalVector, true>
            {
            ...
            template<class OriginalVector>
            struct col_mat_write_traits<OriginalVector, false>
            {
                typedef qvm_detail::col_mat_<OriginalVector> this_matrix;
                typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
                static int const rows = vec_traits<OriginalVector>::dim;
        ...
        template<class OriginalVector>
        struct mat_traits<qvm_detail::col_mat_<OriginalVector>> : qvm_detail::col_mat_write_traits<OriginalVector>
        {
            typedef qvm_detail::col_mat_<OriginalVector> this_matrix;
            typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
            static int const rows = vec_traits<OriginalVector>::dim;
        ...
        template<class OriginalVector, int R, int C>
        struct deduce_mat2<qvm_detail::col_mat_<OriginalVector>, qvm_detail::col_mat_<OriginalVector>, R, C>
        {
            typedef mat<typename vec_traits<OriginalVector>::scalar_type, R, C> type;
        };

        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::col_mat_<A> const&>::type
        ...
        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::col_mat_<A>&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            col_mat(A& a)
        {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL row_mat_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class OriginalVector>
            struct row_mat_write_traits<OriginalVector, true>
            {
            ...
            template<class OriginalVector>
            struct row_mat_write_traits<OriginalVector, false>
            {
                typedef qvm_detail::row_mat_<OriginalVector> this_matrix;
                typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
                static int const rows = 1;
        ...
        template<class OriginalVector>
        struct mat_traits<qvm_detail::row_mat_<OriginalVector>> : qvm_detail::row_mat_write_traits<OriginalVector>
        {
            typedef qvm_detail::row_mat_<OriginalVector> this_matrix;
            typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
            static int const rows = 1;
        ...
        template<class OriginalVector, int R, int C>
        struct deduce_mat2<qvm_detail::row_mat_<OriginalVector>, qvm_detail::row_mat_<OriginalVector>, R, C>
        {
            typedef mat<typename vec_traits<OriginalVector>::scalar_type, R, C> type;
        };

        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::row_mat_<A> const&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            row_mat(A const& a)
        {
        ...
        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::row_mat_<A>&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            row_mat(A& a)
        {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL translation_mat_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            struct read_translation_matat<translation_mat_<OriginalVector>, Row, Col, TransCol>
            {
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL
            ...
            struct read_translation_matat<translation_mat_<OriginalVector>, Row, Col, true>
            {
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL
                    typename mat_traits<translation_mat_<OriginalVector>>::scalar_type
            ...
            template<class OriginalVector>
            struct translation_mat_write_traits<OriginalVector, true>
            {
            ...
            template<class OriginalVector>
            struct translation_mat_write_traits<OriginalVector, false>
            {
                typedef qvm_detail::translation_mat_<OriginalVector> this_matrix;
                typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
                static int const rows = vec_traits<OriginalVector>::dim + 1;
            ...
            qvm_detail::translation_mat_write_traits<OriginalVector>
        {
                ...
                read_element_idx(int row, int col, this_matrix const& x)
            {
                ...
                BOOST_QVM_ASSERT(col >= 0);
                BOOST_QVM_ASSERT(col < cols);
                return row == col ? scalar_traits<scalar_type>::value(1)
                                  : (col == cols - 1 ? vec_traits<OriginalVector>::read_element_idx(
                                                           row,
                                                           reinterpret_cast<OriginalVector const&>(x))
        ...
        template<class OriginalVector, int R, int C>
        struct deduce_mat2<
            qvm_detail::translation_mat_<OriginalVector>,
            qvm_detail::translation_mat_<OriginalVector>,
            R,
            C>
        {
        ...
        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::translation_mat_<A> const&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
        ...
        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::translation_mat_<A>&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            translation_mat(A& a)
        {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL diag_mat_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class OriginalVector>
            struct diag_mat_write_traits<OriginalVector, true>
            {
            ...
            template<class OriginalVector>
            struct diag_mat_write_traits<OriginalVector, false>
            {
                typedef qvm_detail::diag_mat_<OriginalVector> this_matrix;
                typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
                static int const rows = vec_traits<OriginalVector>::dim;
        ...
        template<class OriginalVector>
        struct mat_traits<qvm_detail::diag_mat_<OriginalVector>> : qvm_detail::diag_mat_write_traits<OriginalVector>
        {
            typedef qvm_detail::diag_mat_<OriginalVector> this_matrix;
            typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
            static int const rows = vec_traits<OriginalVector>::dim;
        ...
        template<class OriginalVector, int R, int C>
        struct deduce_mat2<qvm_detail::diag_mat_<OriginalVector>, qvm_detail::diag_mat_<OriginalVector>, R, C>
        {
            typedef mat<typename vec_traits<OriginalVector>::scalar_type, R, C> type;
        };

        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::diag_mat_<A> const&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            diag_mat(A const& a)
        {
        ...
        template<class A>
        typename enable_if_c<is_vec<A>::value, qvm_detail::diag_mat_<A>&>::type
            BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL
            diag_mat(A& a)
        {
