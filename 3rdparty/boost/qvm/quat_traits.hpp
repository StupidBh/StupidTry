...
namespace boost {
    namespace qvm {
        ...
        template<class T>
        class quat_write_element_ref {
            template<class U>
            static qvm_detail::qtr_dispatch_yes<
                typename quat_traits<U>::scalar_type& (*)(U&),
                &quat_traits<U>::template write_element<0>>
                check(int);
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL typename enable_if_c<quat_write_element_ref<Q>::value, void>::type
        ...
        BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL
            typename enable_if_c<!quat_write_element_ref<Q>::value, void>::type
            write_quat_element(Q& q, typename quat_traits<Q>::scalar_type s)
        {
            quat_traits<Q>::template write_element<I>(q, s);
        }
