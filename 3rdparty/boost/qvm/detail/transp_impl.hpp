...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL transposed_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<class OriginalMatrix>
            struct transposed_write_traits<OriginalMatrix, true>
            {
                ...
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type& write_element(this_matrix& x)
                {
                    ...
                    return mat_traits<OriginalMatrix>::template write_element<Col, Row>(
            ...
            template<class OriginalMatrix>
            struct transposed_write_traits<OriginalMatrix, false>
            {
                typedef typename mat_traits<OriginalMatrix>::scalar_type scalar_type;
                typedef transposed_<OriginalMatrix> this_matrix;
                static int const rows = mat_traits<OriginalMatrix>::cols;
                ...
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL void write_element(this_matrix& x, scalar_type s)
                {
                    ...
                    BOOST_QVM_STATIC_ASSERT(Col >= 0);
                    BOOST_QVM_STATIC_ASSERT(Col < cols);
                    mat_traits<OriginalMatrix>::template write_element<Col, Row>(
                        reinterpret_cast<OriginalMatrix&>(x),
                        s);
                }
        ...
        template<class OriginalMatrix>
        struct mat_traits<qvm_detail::transposed_<OriginalMatrix>> : qvm_detail::transposed_write_traits<OriginalMatrix>
        {
            typedef typename mat_traits<OriginalMatrix>::scalar_type scalar_type;
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_matrix const& x)
            {
                ...
                BOOST_QVM_STATIC_ASSERT(Col >= 0);
                BOOST_QVM_STATIC_ASSERT(Col < cols);
                return mat_traits<OriginalMatrix>::template read_element<Col, Row>(
        ...
        struct deduce_mat<qvm_detail::transposed_<OriginalMatrix>, R, C>
        {
            typedef mat<typename mat_traits<OriginalMatrix>::scalar_type, R, C> type;
        };

        template<class OriginalMatrix, int R, int C>
        struct deduce_mat2<qvm_detail::transposed_<OriginalMatrix>, qvm_detail::transposed_<OriginalMatrix>, R, C>
        {
            typedef mat<typename mat_traits<OriginalMatrix>::scalar_type, R, C> type;
        };
