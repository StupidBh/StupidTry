...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            ...
            template<int A, class Next = void>
            struct swizzle_idx
            {
            ...
            struct const_value
            {
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL typename vec_traits<V>::scalar_type value()
                {
                    BOOST_QVM_ASSERT(0);
            ...
            template<int Index>
            struct neg_zero<Index, true>
            {
                static int const value = 0;
            };

            template<int Index>
            struct neg_zero<Index, false>
            {
            ...
            struct swizzle<SwizzleList, Match, Match>
            {
            ...
            struct swizzle_list_length
            {
                static int const value = swizzle_list_length<typename SwizzleList::next, C + 1>::value;
            };

            template<int C>
            struct swizzle_list_length<void, C>
            {
                static int const value = C;
            };

            template<class SwizzleList, int D>
            struct validate_swizzle_list
            {
                static bool const value = ((SwizzleList::value) < D) && // don't touch extra (), MSVC parsing bug.
                                          validate_swizzle_list<typename SwizzleList::next, D>::value;
            };

            template<int D>
            struct validate_swizzle_list<void, D>
            {
            ...
            public:
                template<class T>
                BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_TRIVIAL sw_& operator=(T const& x)
                {
                    assign(*this, x);
                    return *this;
                }
            ...
            template<
                ...
                class SwizzleList,
                bool WriteElementRef = vec_write_element_ref<OriginalVector>::value>
            struct sw_write_traits;

            template<class OriginalVector, class SwizzleList>
            struct sw_write_traits<OriginalVector, SwizzleList, true>
            {
                ...
                static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type& write_element(this_vector& x)
                {
                    ...
                    return vec_traits<OriginalVector>::template write_element<idx>(
                        reinterpret_cast<OriginalVector&>(x));
                }
            };

            template<class OriginalVector, class SwizzleList>
            struct sw_write_traits<OriginalVector, SwizzleList, false>
            {
                typedef qvm_detail::sw_<OriginalVector, SwizzleList> this_vector;
                typedef typename vec_traits<OriginalVector>::scalar_type scalar_type;
                static int const dim = qvm_detail::swizzle_list_length<SwizzleList>::value;
        ...
        template<class OriginalVector, class SwizzleList>
        struct vec_traits<qvm_detail::sw_<OriginalVector, SwizzleList>> :
            qvm_detail::sw_write_traits<OriginalVector, SwizzleList>
        {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_vector const& x)
            {
                ...
                int const idx = qvm_detail::swizzle<SwizzleList, I>::value;
                BOOST_QVM_STATIC_ASSERT(idx < vec_traits<OriginalVector>::dim);
                return idx >= 0 ? vec_traits<OriginalVector>::template read_element<qvm_detail::neg_zero<idx>::value>(
        ...
        template<class SwizzleList>
        struct vec_traits<qvm_detail::sw01_<SwizzleList>>
        {
        ...
        struct vec_traits<qvm_detail::sws_<OriginalScalar, SwizzleList>>
        {
            ...
            static BOOST_QVM_CONSTEXPR BOOST_QVM_INLINE_CRITICAL scalar_type read_element(this_vector const& x)
            {
                ...
                return idx == 0 ? reinterpret_cast<OriginalScalar const&>(x)
                                : qvm_detail::const_value<this_vector, idx>::value();
            }
        ...
        struct deduce_vec<qvm_detail::sw_<OriginalVector, SwizzleList>, D>
        {
        ...
        template<class OriginalVector, class SwizzleList, int D>
        struct deduce_vec2<
            qvm_detail::sw_<OriginalVector, SwizzleList>,
            qvm_detail::sw_<OriginalVector, SwizzleList>,
            D>
        {
            typedef vec<typename vec_traits<OriginalVector>::scalar_type, D> type;
        ...
        struct deduce_vec<qvm_detail::sws_<Scalar, SwizzleList>, D>
        {
            typedef vec<Scalar, D> type;
        };

        template<class Scalar, class SwizzleList, int D>
        struct deduce_vec2<qvm_detail::sws_<Scalar, SwizzleList>, qvm_detail::sws_<Scalar, SwizzleList>, D>
        {
            typedef vec<Scalar, D> type;
        };
