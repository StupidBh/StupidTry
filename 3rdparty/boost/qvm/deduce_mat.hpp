...
namespace boost {
    namespace qvm {
        ...
        namespace qvm_detail {
            ...
            struct deduce_m_default<M, R, C, S, R, C, S>
            {
                BOOST_QVM_STATIC_ASSERT(is_mat<M>::value);
                typedef M type;
            };
        ...
        template<
            class M,
            int R = mat_traits<M>::rows,
            int C = mat_traits<M>::cols,
        ...
        namespace qvm_detail {
            ...
            struct deduce_m2_default
            {
                typedef mat<S, R, C> type;
            };

            template<class M, int R, int C, class S>
            struct deduce_m2_default<M, M, R, C, S, false, false>
            {
                BOOST_QVM_STATIC_ASSERT(is_mat<M>::value);
                typedef M type;
            };
            ...
            struct deduce_m2_default<A, B, R, C, S, false, true>
            {
            ...
            template<class A, class B, int R, int C, class S>
            struct deduce_m2_default<A, B, R, C, S, true, false>
            {
