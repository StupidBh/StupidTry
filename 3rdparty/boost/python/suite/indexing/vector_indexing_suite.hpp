    ...
    namespace python {
        ...
        namespace detail {
            ...
            class final_vector_derived_policies :
                public vector_indexing_suite<Container, NoProxy, final_vector_derived_policies<Container, NoProxy>> {};
        }
        ...
        class vector_indexing_suite : public indexing_suite<Container, DerivedPolicies, NoProxy> {
        public:
            ...
            {
                cl.def("append", &base_append).def("extend", &base_extend);
            }
            ...
            static void set_item(Container& container, index_type i, data_type const& v) { container[i] = v; }
            ...
            static void delete_item(Container& container, index_type i) { container.erase(container.begin() + i); }
            ...
            static index_type get_max_index(Container& container) { return container.size(); }
            ...
            static void append(Container& container, data_type const& v) { container.push_back(v); }
            ...
            static void base_append(Container& container, object v)
            {
                ...
                if (elem.check()) {
                    ...
                    if (elem.check()) {
                        ...
                        PyErr_SetString(PyExc_TypeError, "Attempting to append an invalid type");
                        throw_error_already_set();
                    }
                }
            }
