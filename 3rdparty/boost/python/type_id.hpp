...
#if defined(__GNUC__) || defined(_AIX) || (defined(__sgi) && defined(__host_mips)) || \
...
#define BOOST_PYTHON_EXPLICIT_TT_DEF(T)
        ...
        {
            return type_info(
#if !defined(_MSC_VER) || !BOOST_WORKAROUND(BOOST_INTEL_CXX_VERSION, <= 700)
                typeid(T)
    ...
    #undef BOOST_PYTHON_SIGNED_INTEGRAL_TYPE_ID
        ...
        {
            char const* raw_name = m_base_type
