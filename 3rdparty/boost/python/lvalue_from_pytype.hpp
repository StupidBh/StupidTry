        ...
        namespace detail {
            ...
            struct normalized_extractor
            {
                static inline void* execute(PyObject* op)
                {
                    ...
                    return &Extractor::execute(boost::python::detail::void_ptr_to_reference(op, (param (*)())0));
                }
            };
            ...
            inline normalized_extractor<Extractor, U> normalize(T (*)(U), Extractor* = 0)
            {
        ...
        private:
            static void* extract(PyObject* op)
            {
                return PyObject_TypeCheck(op, const_cast<PyTypeObject*>(python_type))
                           ? const_cast<void*>(static_cast<void const volatile*>(
