...
namespace boost {
    namespace python {
        ...
        object BOOST_PYTHON_DECL eval(char const* string, object global = object(), object local = object());
        ...
        object BOOST_PYTHON_DECL exec_statement(char const* string, object global = object(), object local = object());
        ...
        object BOOST_PYTHON_DECL exec(char const* string, object global = object(), object local = object());
        ...
        object BOOST_PYTHON_DECL exec_file(char const* filename, object global = object(), object local = object());
