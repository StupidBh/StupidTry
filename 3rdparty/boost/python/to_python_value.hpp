    ...
    namespace python {
        ...
        namespace detail {
            ...
            struct object_manager_to_python_value
            {
                ...
                PyTypeObject const* get_pytype() const { return get_pytype_aux((is_t_handle*)0); }
            ...
            private:
                ...
                template<class U>
                PyTypeObject const* get_pytype(boost::type<const std::shared_ptr<U>&>*) const
                {
                    return converter::registered<U>::converters.to_python_target_type();
                }
    #endif
        ...
        struct to_python_value :
            mpl::if_<
                ...
                typename mpl::if_<
                    mpl::or_<converter::is_object_manager<T>, converter::is_reference_to_object_manager<T>>,
        ...
        namespace detail {
            ...
            {
                return python::upcast<PyObject>(python::xincref(get_managed_object(x, tag)));
            }
