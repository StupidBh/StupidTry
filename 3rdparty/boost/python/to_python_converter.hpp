...
namespace detail
{
    ...
    struct test_get_pytype : boost::mpl::bool_<test_get_pytype_base<T>::value> 
    {
        ...
        struct to_python_converter
        {
            ...
            static PyTypeObject const* get_pytype_1(boost::mpl::true_*) { return Conversion::get_pytype(); }

            static PyTypeObject const* get_pytype_1(boost::mpl::false_*) { return 0; }

            static PyTypeObject const* get_pytype_impl() { return get_pytype_1((HasGetPytype*)0); }
#endif
        ...
        {
            typedef converter::as_to_python_function<T, Conversion> normalized;
