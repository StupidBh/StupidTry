...
namespace boost {
    namespace python {
        ...
        #define _BOOST_PYTHON_MODULE_INIT(name)                                                         \
            ...
            {                                                                                           \
                static PyModuleDef_Base initial_m_base = { PyObject_HEAD_INIT(NULL) 0, /* m_init */     \
                                                           0,                          /* m_index */    \
                                                           0 /* m_copy */ };                            \
                ...
                static struct PyModuleDef moduledef = {                                                 \
                    ...
                    BOOST_PP_STRINGIZE(name),                                                                          \
                        ...
                        0,  /* m_free */                                                                \
                                                                                                        ...
                                                                                                        \
                return boost::python::detail::init_module(moduledef, BOOST_PP_CAT(init_module_, name)); \
            }                                                                                           \
        ...
        #define _BOOST_PYTHON_MODULE_INIT(name)                                                                  \
            ...
            {                                                                                                    \
                boost::python::detail::init_module(BOOST_PP_STRINGIZE(name), &BOOST_PP_CAT(init_module_, name)); \
            }                                                                                                    \
            void BOOST_PP_CAT(init_module_, name)()
