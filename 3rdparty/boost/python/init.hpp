...
#define BOOST_PYTHON_OVERLOAD_TYPES_WITH_DEFAULT \
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(BOOST_PYTHON_MAX_ARITY, class T, mpl::void_)

#define BOOST_PYTHON_OVERLOAD_TYPES BOOST_PP_ENUM_PARAMS_Z(1, BOOST_PYTHON_MAX_ARITY, class T)

#define BOOST_PYTHON_OVERLOAD_ARGS BOOST_PP_ENUM_PARAMS_Z(1, BOOST_PYTHON_MAX_ARITY, T)
...
namespace boost {
    namespace python {
        ...
        namespace detail {
            ...
            struct is_optional<optional<BOOST_PYTHON_OVERLOAD_ARGS>> : mpl::true_
            {
            };
        ...
        struct init_base : def_visitor<DerivedT>
        {
            ...
            static default_call_policies call_policies() { return default_call_policies(); }
        ...
        public:
            ...
            CallPoliciesT const& call_policies() const { return this->m_policies; }
        ...
        namespace detail {
            template<class S>
            struct drop1 :
                mpl::iterator_range<typename mpl::begin<S>::type, typename mpl::prior<typename mpl::end<S>::type>::type>
            {
            };
        }
        ...
        public:
            ...
            init(char const* doc_, detail::keywords<N> const& kw) :
                base(doc_, kw.range())
            {
                typedef typename detail::error::more_keywords_than_init_arguments<N, n_arguments::value + 1>::
            ...
            {
                return init_with_call_policies<CallPoliciesT, self_t>(policies, this->doc_string(), this->keywords());
            }

            typedef detail::type_list<BOOST_PYTHON_OVERLOAD_ARGS> signature_;

            typedef detail::is_optional<
                typename mpl::eval_if<mpl::empty<signature_>, mpl::false_, mpl::back<signature_>>::type>
                back_is_optional;

            typedef typename mpl::eval_if<back_is_optional, mpl::back<signature_>, mpl::vector0<>>::type optional_args;
            ...
            typedef typename mpl::eval_if<
                ...
                mpl::if_<
                    ...
                    mpl::joint_view<detail::drop1<signature_>, optional_args>>,
        ...
        ///////////////////////////////////////////////////////////////////////////////
        template<BOOST_PYTHON_OVERLOAD_TYPES>
        struct optional : detail::type_list<BOOST_PYTHON_OVERLOAD_ARGS>
        {
        };
