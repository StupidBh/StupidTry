...
namespace boost {
    namespace python {
        ...
        namespace detail {
            ...
            struct replace_front2
            {
                ...
                typedef typename mpl::push_front<
                    typename mpl::push_front<typename mpl::pop_front<typename mpl::pop_front<S>::type>::type, T2>::type,
                    T1>::type type;
            };
            ...
            typename replace_front2<S, void, C&>::type error_signature(S)
            {
            ...
            struct pure_virtual_visitor : def_visitor<pure_virtual_visitor<PointerToMemberFunction>>
            {
            ...
            private:
                ...
                void visit(C_& c, char const* name, Options& options) const
                {
                    ...
                    c.def(name, m_pmf, options.doc(), options.keywords(), options.policies());
        ...
        //
        template<class PointerToMemberFunction>
        detail::pure_virtual_visitor<PointerToMemberFunction> pure_virtual(PointerToMemberFunction pmf)
        {
