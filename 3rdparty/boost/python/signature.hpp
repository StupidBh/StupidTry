...
///////////////////////////////////////////////////////////////////////////////
        ...
        #define BOOST_PYTHON_LIST_INC(n) BOOST_PP_CAT(mpl::vector, BOOST_PP_INC(n))
...
namespace boost {
    namespace python {
        namespace detail {
            ...
            struct most_derived
            {
                typedef typename mpl::if_<detail::is_convertible<C1*, C2*>, C1, C2>::type type;
            };
        ...
        #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / signature.hpp>))
...
inline BOOST_PYTHON_LIST_INC(N)<RT BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, T)> get_signature(
    RT(BOOST_PYTHON_FN_CC*)(BOOST_PP_ENUM_PARAMS_Z(1, N, T)),
    void* = 0)
{
    return BOOST_PYTHON_LIST_INC(N)<RT BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, T)>();
}
        ...
        #define BOOST_PP_ITERATION_PARAMS_2 (3, (0, 3, <boost / python / signature.hpp>))
        #include BOOST_PP_ITERATE()
...
inline BOOST_PYTHON_LIST_INC(BOOST_PP_INC(N))<RT, ClassT & BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, T)> get_signature(
    RT (BOOST_PYTHON_FN_CC ClassT::*)(BOOST_PP_ENUM_PARAMS_Z(1, N, T)) Q)
{
    return BOOST_PYTHON_LIST_INC(BOOST_PP_INC(N))<RT, ClassT & BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, T)>();
}

template<class Target, class RT, class ClassT BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, class T)>
inline BOOST_PYTHON_LIST_INC(BOOST_PP_INC(N))<
    ...
    typename most_derived<Target, ClassT>::type &
        BOOST_PP_ENUM_TRAILING_PARAMS_Z(
            1,
            N,
            T)> get_signature(RT (BOOST_PYTHON_FN_CC ClassT::*)(BOOST_PP_ENUM_PARAMS_Z(1, N, T)) Q, Target*)
{
    return BOOST_PYTHON_LIST_INC(BOOST_PP_INC(
        N))<RT, BOOST_DEDUCED_TYPENAME most_derived<Target, ClassT>::type & BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, T)>();
}
