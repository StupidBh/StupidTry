...
namespace boost {
    namespace python {
        ...
        namespace detail {
            ...
            struct overloads_proxy : public overloads_base
            {
                typedef typename OverloadsT::non_void_return_type non_void_return_type;
                typedef typename OverloadsT::void_return_type void_return_type;

                overloads_proxy(CallPoliciesT const& policies_, char const* doc, keyword_range const& kw) :
                    overloads_base(doc, kw),
                    policies(policies_)
                {
                }

                CallPoliciesT call_policies() const { return policies; }
            ...
            struct overloads_common : public overloads_base
            {
                ...
                default_call_policies call_policies() const { return default_call_policies(); }

                template<class CallPoliciesT>
                overloads_proxy<CallPoliciesT, DerivedT> operator[](CallPoliciesT const& policies) const
                {
                    return overloads_proxy<CallPoliciesT, DerivedT>(policies, this->doc_string(), this->keywords());
                }
            };
...
#define BOOST_PYTHON_TYPEDEF_GEN(z, index, data)                                                                  \
    typedef typename ::boost::mpl::next<BOOST_PP_CAT(iter, index)>::type BOOST_PP_CAT(iter, BOOST_PP_INC(index)); \
    typedef typename ::boost::mpl::deref<BOOST_PP_CAT(iter, index)>::type BOOST_PP_CAT(T, index);

#define BOOST_PYTHON_FUNC_WRAPPER_GEN(z, index, data)                                         \
    static RT BOOST_PP_CAT(func_, BOOST_PP_SUB_D(1, index, BOOST_PP_TUPLE_ELEM(3, 1, data)))( \
        BOOST_PP_ENUM_BINARY_PARAMS_Z(1, index, T, arg))                                      \
    {                                                                                         \
        BOOST_PP_TUPLE_ELEM(3, 2, data)                                                       \
        BOOST_PP_TUPLE_ELEM(3, 0, data)(BOOST_PP_ENUM_PARAMS(index, arg));                    \
    }
    ...
    {                                                                       \
        ...
        {                                                                   \
            ...
            typedef typename ::boost::mpl::next<rt_iter>::type iter0;       \
                                                                            \
            BOOST_PP_REPEAT_2ND(n_args, BOOST_PYTHON_TYPEDEF_GEN, 0)        \
                                                                            \
...
#define BOOST_PYTHON_MEM_FUNC_WRAPPER_GEN(z, index, data)                                                      \
    static RT BOOST_PP_CAT(func_, BOOST_PP_SUB_D(1, index, BOOST_PP_TUPLE_ELEM(3, 1, data)))(                  \
        ClassT obj BOOST_PP_COMMA_IF(index) BOOST_PP_ENUM_BINARY_PARAMS_Z(1, index, T, arg))                   \
    {                                                                                                          \
        BOOST_PP_TUPLE_ELEM(3, 2, data) obj.BOOST_PP_TUPLE_ELEM(3, 0, data)(BOOST_PP_ENUM_PARAMS(index, arg)); \
    }
...
#define BOOST_PYTHON_OVERLOAD_CONSTRUCTORS(fstubs_name, n_args, n_dflts)                                    \
    ...
    fstubs_name(char const* doc, ::boost::python::detail::keywords<N> const& keywords) :                    \
        ::boost::python::detail::overloads_common<fstubs_name>(doc, keywords.range())                       \
    {                                                                                                       \
        typedef typename ::boost::python::detail::error::more_keywords_than_function_arguments<N, n_args>:: \
    ...
    #define BOOST_PYTHON_GEN_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)             \
        struct fstubs_name : public ::boost::python::detail::overloads_common<fstubs_name>  \
        {                                                                                   \
            BOOST_PYTHON_GEN_FUNCTION(fname, non_void_return_type, n_args, n_dflts, return) \
            BOOST_PYTHON_GEN_FUNCTION(fname, void_return_type, n_args, n_dflts, ;)          \
                                                                                            \
    ...
    #define BOOST_PYTHON_GEN_MEM_FUNCTION_STUB(fname, fstubs_name, n_args, n_dflts)             \
        struct fstubs_name : public ::boost::python::detail::overloads_common<fstubs_name>      \
        {                                                                                       \
            BOOST_PYTHON_GEN_MEM_FUNCTION(fname, non_void_return_type, n_args, n_dflts, return) \
            BOOST_PYTHON_GEN_MEM_FUNCTION(fname, void_return_type, n_args, n_dflts, ;)          \
                                                                                                \
...
#define BOOST_PYTHON_FUNCTION_OVERLOADS(generator_name, fname, min_args, max_args) \
    BOOST_PYTHON_GEN_FUNCTION_STUB(fname, generator_name, max_args, BOOST_PP_SUB_D(1, max_args, min_args))

#define BOOST_PYTHON_MEMBER_FUNCTION_OVERLOADS(generator_name, fname, min_args, max_args) \
    BOOST_PYTHON_GEN_MEM_FUNCTION_STUB(fname, generator_name, max_args, BOOST_PP_SUB_D(1, max_args, min_args))
