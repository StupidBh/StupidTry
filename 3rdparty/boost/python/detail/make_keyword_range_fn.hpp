...
namespace boost {
    namespace python {
        namespace detail {
            ...
            {
                return detail::make_function_aux(f, policies, detail::get_signature(f), kw, mpl::int_<0>());
            }
            ...
            object make_keyword_range_function(
                ...
                Signature const& sig)
            {
                return detail::make_function_aux(f, policies, sig, kw, mpl::int_<0>());
            }
                ...
                Arity* = 0)
            {
                ...
                return detail::make_keyword_range_function(
                    objects::make_holder<Arity::value>::template apply<Holder, ArgList>::execute,
                    policies,
                    kw);
            }
