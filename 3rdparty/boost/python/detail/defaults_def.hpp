...
namespace boost {
    namespace python {
        ...
        namespace detail {
                ...
                objects::class_base*)
            {
                ...
                objects::add_to_namespace(
                    name_space,
                    name,
                    detail::make_keyword_range_function(f, policies, kw, get_signature(f, (wrapped_type*)0)),
                    doc);
            }
                ...
                ...)
            {
                ...
                detail::scope_setattr_doc(name, detail::make_keyword_range_function(f, policies, kw), doc);
            }
        ...
        #include BOOST_PP_ITERATE()
            ...
            inline void
                define_with_defaults(char const* name, OverloadsT const& overloads, NameSpaceT& name_space, SigT const&)
            {
                ...
                typedef
                    typename mpl::if_c<is_same<void, return_type>::value, void_return_type, non_void_return_type>::type
                        stubs_type;
