...
namespace boost {
    namespace python {
        namespace detail {
            ...
            struct invoke_tag : invoke_tag_<is_same<R, void>::value, is_member_function_pointer<F>::value>
            {
            };

        #define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / detail / invoke.hpp>))
...
template<class RC, class F, class TC BOOST_PP_ENUM_TRAILING_PARAMS_Z(1, N, class AC)>
inline PyObject*
    invoke(invoke_tag_<true, true>, RC const&, F& f, TC& tc BOOST_PP_ENUM_TRAILING_BINARY_PARAMS_Z(1, N, AC, &ac))
{
