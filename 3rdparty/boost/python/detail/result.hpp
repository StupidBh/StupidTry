...
namespace boost {
    namespace python {
        ...
        #include BOOST_PP_ITERATE()
            ...
            {
                typedef typename mpl::if_c<is_class<T>::value, get_result_type<T>, void_type>::type t1;

                typedef typename t1::type* type;
            };

            template<class X>
            typename result_result<X>::type result(X const&, short)
            {
                return 0;
            }
