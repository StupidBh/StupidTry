...
namespace boost {
    namespace python {
        namespace detail {
            ...
            template<class T>
            static typeinfo typeid_nonref(T const volatile*)
            {
                return typeid(T);
            }
        ...
        #define BOOST_PYTT_DECL /**/
            ...
            template<typename T>
            T& (*is_ref_tester1(type<T>))(type<T>)
            {
                return 0;
            }

            inline char BOOST_PYTT_DECL is_ref_tester1(...)
            {
                return 0;
            }
            ...
            {
                return detail::typeid_ref((boost::type<T>*)0, detail::is_ref_tester1(type<T>()));
            }
            ...
            {
                return msvc_typeid((boost::type<char const[3]>*)0), msvc_typeid((boost::type<char[3]>*)0);
            }
    #endif
