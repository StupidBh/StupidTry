    ...
    namespace python {
        ...
        namespace detail {
            ...
            )
            {
                ...
                return objects::function_object(detail::caller<F, CallPolicies, Sig>(f, p), kw);
            }
            ...
            {
                return detail::make_function_aux(f, policies, sig);
            }
        ...
        {
            return detail::make_function_aux(f, default_call_policies(), detail::get_signature(f));
        }

        template<class F, class CallPolicies>
        object make_function(F f, CallPolicies const& policies)
        {
            return detail::make_function_aux(f, policies, detail::get_signature(f));
        }
        ...
        object make_function(F f, CallPolicies const& policies, KeywordsOrSignature const& keywords_or_signature)
        {
            ...
            return detail::make_function_dispatch(f, policies, keywords_or_signature, is_kw());
        }
        ...
        {
            return detail::make_function_aux(f, policies, sig, kw.range(), mpl::int_<Keywords::size>());
        }
