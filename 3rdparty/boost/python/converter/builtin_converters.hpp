...
// Specialize converters for signed and unsigned T to Python Int
    ...
    #define BOOST_PYTHON_TO_INT(T)                                                                         \
        ...
        BOOST_PYTHON_TO_PYTHON_BY_VALUE(                                                                   \
            unsigned T,                                                                                    \
            static_cast<unsigned long>(x) > static_cast<unsigned long>((std::numeric_limits<long>::max)()) \
...
// Bool is not signed.
        ...
        BOOST_PYTHON_TO_PYTHON_BY_VALUE(
            ...
            (x < static_cast<signed BOOST_PYTHON_LONG_LONG>((std::numeric_limits<long>::min)()) ||
             x > static_cast<signed BOOST_PYTHON_LONG_LONG>((std::numeric_limits<long>::max)()))
                ? ::PyLong_FromLongLong(x)
                : ::PyInt_FromLong(static_cast<long>(x)),
            &PyInt_Type)
        BOOST_PYTHON_TO_PYTHON_BY_VALUE(
            unsigned BOOST_PYTHON_LONG_LONG,
            x > static_cast<unsigned BOOST_PYTHON_LONG_LONG>((std::numeric_limits<long>::max)())
...
#undef BOOST_TO_PYTHON_INT
        ...
        BOOST_PYTHON_TO_PYTHON_BY_VALUE(
            std::string,
            ::PyUnicode_FromStringAndSize(x.data(), implicit_cast<ssize_t>(x.size())),
            &PyUnicode_Type)
#else
        ...
        BOOST_PYTHON_TO_PYTHON_BY_VALUE(
            std::string,
            ::PyString_FromStringAndSize(x.data(), implicit_cast<ssize_t>(x.size())),
            &PyString_Type)
#endif
