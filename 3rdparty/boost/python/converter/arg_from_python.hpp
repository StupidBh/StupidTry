...
namespace boost {
    namespace python {
        namespace converter {
            ...
            {
                typedef typename boost::python::detail::add_lvalue_reference<T
                                                                             // We can't add_const here, or it would be
                                                                             // impossible to pass auto_ptr<U> args from
                                                                             // Python to C++
                                                                             >::type result_type;
            ...
            template<class T>
            struct back_reference_arg_from_python : boost::python::arg_from_python<typename T::type>
            {
                typedef T result_type;
                            ...
                            if_2<
                                ...
                                if_2<
                                    ...
                                    mpl::if_<
                                        ...
                                        arg_rvalue_from_python<T>>>>>>>::type type;
            };
            ...
            template<class T>
            inline typename arg_rvalue_from_python<T>::result_type arg_rvalue_from_python<T>::operator()()
            {
            ...
            template<class T>
            inline T back_reference_arg_from_python<T>::operator()()
            {
