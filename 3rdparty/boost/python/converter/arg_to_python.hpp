    ...
    namespace python {
        namespace converter {
            ...
            namespace detail {
                ...
                {
                    object_manager_arg_to_python(T const& x) :
                        m_src(x)
                    {
                    }

                    PyObject* get() const { return python::upcast<PyObject>(get_managed_object(m_src, tag)); }
                                    ...
                                    typename mpl::if_<
                                        ...
                                        typename mpl::if_<
                                            ...
                                            typename mpl::if_<
                                                ...
                                                value_arg_to_python<T>>::type>::type>::type>::type>::type>::type>::type
            ...
            template<class T>
            struct arg_to_python : detail::select_arg_to_python<T>::type
            {
            ...
            namespace detail {
                ...
                inline void reject_raw_object_ptr(T*)
                {
                    ...
                    reject_raw_object_helper<T, no_convertible>::error(
                        python::detail::convertible<unspecialized*>::check((base_type_traits<value_type>*)0));
                }
