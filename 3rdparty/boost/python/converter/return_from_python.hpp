        ...
        namespace converter {
                ...
                struct select_return_from_python
                {
                    ...
                    typedef typename mpl::if_c<
                        ...
                        typename mpl::if_c<
                            ...
                            typename mpl::if_c<ref, return_reference_from_python<T>, return_rvalue_from_python<T>>::
                                type>::type>::type type;
                };
            }

            template<class T>
            struct return_from_python : detail::select_return_from_python<T>::type
            {
            };
            ...
            namespace detail {
                    ...
                    return_rvalue_from_python<T>::operator()(PyObject* obj)
                {
                    ...
                    return *(T*)(rvalue_result_from_python)(obj, m_data.stage1);
                }
                ...
                {
                    return T((pointer_result_from_python)(obj, registered_pointee<T>::converters));
                }

                template<class T>
                inline T return_object_manager_from_python<T>::operator()(PyObject* obj) const
                {
                    return T(object_manager_traits<T>::adopt(expect_non_null(obj)));
                }
            }
