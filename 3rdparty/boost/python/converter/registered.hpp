...
namespace boost {
    ...
    namespace python {
        namespace converter {
            ...
            template<class T>
            struct registered :
                detail::registered_base<typename boost::python::detail::add_lvalue_reference<
            ...
            namespace detail {
                ...
                template<class T>
                inline void register_shared_ptr0(shared_ptr<T>*)
                {
                ...
                template<class T>
                inline void register_shared_ptr0(std::shared_ptr<T>*)
                {
                ...
                template<class T>
                inline void register_shared_ptr1(T const volatile*)
                {
                    detail::register_shared_ptr0((T*)0);
                }

                template<class T>
                inline registration const& registry_lookup2(T& (*)())
                {
                ...
                template<class T>
                inline registration const& registry_lookup1(type<T>)
                {
