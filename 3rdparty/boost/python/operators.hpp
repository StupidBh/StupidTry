...
namespace boost {
    namespace python {
        ...
        namespace detail {
            ...
            struct operator_l_inner : operator_l<id>::template apply<L, R>
            {
            };

            template<operator_id id, class L, class R>
            struct operator_r_inner : operator_r<id>::template apply<L, R>
            {
            };

            template<operator_id id, class T>
            struct operator_1_inner : operator_1<id>::template apply<T>
            {
            };
            ...
            struct operator_ : def_visitor<operator_<id, L, R>>
            {
            private:
                ...
                void visit(ClassT& cl) const
                {
                    typedef typename mpl::eval_if<
                        ...
                        mpl::if_<
                            is_same<R, self_t>,
                            binary_op<id>,
                            binary_op_l<id, BOOST_DEDUCED_TYPENAME unwrap_other<R>::type>>,
                        mpl::if_<
                            is_same<L, not_specified>,
                            unary_op<id>,
                            binary_op_r<id, BOOST_DEDUCED_TYPENAME unwrap_other<L>::type>>>::type generator;

                    cl.def(
                        generator::name(),
                        &generator::template apply<BOOST_DEDUCED_TYPENAME ClassT::wrapped_type>::execute);
                }
    ...
    namespace detail {                                                                                  \
        ...
        {                                                                                               \
            ...
            {                                                                                           \
                ...
                static PyObject* execute(lhs& l, rhs const& r) { return detail::convert_result(expr); } \
            };                                                                                          \
        ...
        {                                                                                               \
            ...
            {                                                                                           \
                typedef typename unwrap_wrapper_<L>::type lhs;                                          \
                typedef typename unwrap_wrapper_<R>::type rhs;                                          \
                static PyObject* execute(rhs& r, lhs const& l) { return detail::convert_result(expr); } \
            };                                                                                          \
...
#define BOOST_PYTHON_BINARY_OPERATOR(id, rid, op)                                       \
    ...
    namespace self_ns {                                                                 \
        template<class L, class R>                                                      \
        inline detail::operator_<detail::op_##id, L, R> operator op(L const&, R const&) \
        {                                                                               \
...
#undef BOOST_PYTHON_BINARY_OPERATION
        ...
        namespace self_ns {
            ...
            template<class L, class R>
            inline detail::operator_<detail::op_pow, L, R> pow(L const&, R const&)
            {
            ...
            inline detail::operator_<detail::op_pow, self_t, self_t> pow(self_t, self_t)
            {
                return detail::operator_<detail::op_pow, self_t, self_t>();
            }

            template<class R>
            inline detail::operator_<detail::op_pow, self_t, R> pow(self_t const&, R const&)
            {
                return detail::operator_<detail::op_pow, self_t, R>();
            }

            template<class L>
            inline detail::operator_<detail::op_pow, L, self_t> pow(L const&, self_t const&)
            {
...
#define BOOST_PYTHON_INPLACE_OPERATOR(id, op)                                                     \
    namespace detail {                                                                            \
        ...
        {                                                                                         \
            ...
            {                                                                                     \
                typedef typename unwrap_wrapper_<L>::type lhs;                                    \
                typedef typename unwrap_wrapper_<R>::type rhs;                                    \
                static PyObject* execute(back_reference<lhs&> l, rhs const& r)                    \
                {                                                                                 \
                    l.get() op r;                                                                 \
    ...
    namespace self_ns {                                                                           \
        template<class R>                                                                         \
        inline detail::operator_<detail::op_##id, self_t, R> operator op(self_t const&, R const&) \
        {                                                                                         \
    ...
    namespace detail {                                                                        \
        ...
        {                                                                                     \
            ...
            {                                                                                 \
                ...
                static PyObject* execute(self_t& x) { return detail::convert_result(op(x)); } \
            };                                                                                \
            static char const* name() { return "__" #id "__"; }                               \
        };                                                                                    \
    }                                                                                         \
    namespace self_ns {                                                                       \
        inline detail::operator_<detail::op_##id> func_name(self_t const&)                    \
        {                                                                                     \
