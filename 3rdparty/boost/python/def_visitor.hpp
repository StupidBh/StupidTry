...
namespace boost {
    namespace python {
        ...
        public:
            ...
            static void visit(V const& v, classT& c, char const* name, OptionalArgs const& options)
            {
        ...
        protected:
            DerivedVisitor const& derived_visitor() const { return static_cast<DerivedVisitor const&>(*this); }
        };
