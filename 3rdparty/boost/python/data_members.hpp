...
namespace boost {
    namespace python {
        ...
        namespace detail {
            ...
            {
            public:
                member(Data Class::* which) :
                    m_which(which)
                {
                }

                Data& operator()(Class& c) const { return c.*m_which; }

                void operator()(Class& c, typename value_arg<Data>::type d) const { c.*m_which = d; }
            ...
            public:
                ...
                Data& operator()() const { return *m_which; }

                void operator()(typename value_arg<Data>::type d) const { *m_which = d; }
            ...
            struct default_getter_by_ref :
                mpl::and_<
                    mpl::bool_<to_python_value<typename value_arg<T>::type>::uses_registry>,
                    indirect_traits::is_reference_to_class<typename value_arg<T>::type>>
            {
            };
            ...
            struct default_member_getter_policy :
                mpl::if_<default_getter_by_ref<T>, return_internal_reference<>, return_value_policy<return_by_value>>
            {
            };
            ...
            {
                return python::make_function(detail::datum<D>(d), policies, mpl::vector1<D&>());
            }
            ...
            inline object make_getter(D C::* pm, Policies const& policies, detail::true_, int)
            {
                ...
                typedef C Class;
#endif
                return python::make_function(detail::member<D, Class>(pm), policies, mpl::vector2<D&, Class&>());
            }
            ...
            {
                return python::make_function(detail::datum<D>(p), policies, mpl::vector2<void, D const&>());
            }
            ...
            {
                return python::make_function(detail::member<D, C>(pm), policies, mpl::vector3<void, C&, D const&>());
            }
        ...
        {
            detail::not_specified policy = detail::not_specified(); // suppress a SunPro warning
