    ...
    namespace python {
        ...
        namespace detail {
            ...
            struct pickle_suite_registration
            {
                ...
                {
                    typedef typename error_messages::missing_pickle_suite_function_or_incorrect_signature<
                        Class_>::error_type error_type BOOST_ATTRIBUTE_UNUSED;
                }
            };

            template<typename PickleSuiteType>
            struct pickle_suite_finalize : PickleSuiteType, pickle_suite_registration
            {
            };
