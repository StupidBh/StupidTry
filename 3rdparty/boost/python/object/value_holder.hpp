...
namespace boost {
    namespace python {
        ...
        #define BOOST_PP_ITERATION_PARAMS_1 \
            (4, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / object / value_holder.hpp>, 1))
        #include BOOST_PP_ITERATE()
            ...
            struct value_holder_back_reference : instance_holder
            {
                ...
                typedef Value value_type;
                    ...
                    // Forward construction to the held object
        #define BOOST_PP_ITERATION_PARAMS_1 \
            (4, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / object / value_holder.hpp>, 2))
        #include BOOST_PP_ITERATE()
        ...
        #undef BOOST_PYTHON_UNFORWARD_LOCAL
            ...
            template<class Value, class Held>
            void* value_holder_back_reference<Value, Held>::holds(type_info dst_t, bool /*null_ptr_only*/)
            {
                type_info src_t = python::type_id<Value>();
                Value* x = &m_held;
...
template<BOOST_PP_ENUM_PARAMS_Z(1, N, class A)>
        #endif
value_holder(PyObject* self BOOST_PP_COMMA_IF(N) BOOST_PP_ENUM_BINARY_PARAMS_Z(1, N, A, a)) :
    m_held(BOOST_PP_REPEAT_1ST(N, BOOST_PYTHON_UNFORWARD_LOCAL, nil))
{
...
template<BOOST_PP_ENUM_PARAMS_Z(1, N, class A)>
        #endif
value_holder_back_reference(PyObject* p BOOST_PP_COMMA_IF(N) BOOST_PP_ENUM_BINARY_PARAMS_Z(1, N, A, a)) :
    m_held(p BOOST_PP_COMMA_IF(N) BOOST_PP_REPEAT_1ST(N, BOOST_PYTHON_UNFORWARD_LOCAL, nil))
{
}
