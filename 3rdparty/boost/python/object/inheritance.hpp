...
namespace boost {
    namespace python {
        namespace objects {
            ...
            {
                static dynamic_id_t execute(void* p_) { return std::make_pair(p_, python::type_id<T>()); }
            };
            ...
            void register_dynamic_id(T* = 0)
            {
                ...
                register_dynamic_id_aux(python::type_id<T>(), &generator::execute);
            }
            ...
            {
                static void* execute(void* source) { return dynamic_cast<Target*>(static_cast<Source*>(source)); }
            };
                ...
                Target* = 0)
            {
                ...
                add_cast(python::type_id<Source>(), python::type_id<Target>(), &generator::execute, is_downcast);
            }
