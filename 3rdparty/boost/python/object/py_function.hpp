    ...
    namespace python {
        namespace objects {
            ...
            struct caller_py_function_impl : py_function_impl_base
            {
                ...
                PyObject* operator()(PyObject* args, PyObject* kw) { return m_caller(args, kw); }

                virtual unsigned min_arity() const { return m_caller.min_arity(); }

                virtual python::detail::py_func_sig_info signature() const { return m_caller.signature(); }
            ...
            struct signature_py_function_impl : py_function_impl_base
            {
                ...
                virtual unsigned min_arity() const { return mpl::size<Sig>::value - 1; }
            ...
            struct full_py_function_impl : py_function_impl_base
            {
                ...
                virtual unsigned min_arity() const { return m_min_arity; }

                virtual unsigned max_arity() const { return m_max_arity; }
            ...
            struct py_function
            {
                ...
                PyObject* operator()(PyObject* args, PyObject* kw) const { return (*m_impl)(args, kw); }

                unsigned min_arity() const { return m_impl->min_arity(); }

                unsigned max_arity() const { return m_impl->max_arity(); }

                python::detail::signature_element const* signature() const { return m_impl->signature().signature; }

                python::detail::signature_element const& get_return_type() const { return *m_impl->signature().ret; }
