        ...
        namespace objects {
            ...
            struct iterator_range
            {
                ...
                struct next
                {
                    typedef typename mpl::if_<
                        is_reference<typename traits_t::reference>,
                        typename traits_t::reference,
                        typename traits_t::value_type>::type result_type;
            ...
            namespace detail {
                    ...
                    NextPolicies const& policies = NextPolicies())
                {
                    ...
                    handle<> class_obj(objects::registered_class_object(python::type_id<range_>()));
                ...
                struct py_iter_
                {
                    ...
                    iterator_range<NextPolicies, Iterator> operator()(back_reference<Target&> x) const
                    {
