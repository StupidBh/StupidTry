    ...
    namespace python {
        namespace objects {
            ...
            struct select_held_type :
                mpl::if_<
                    mpl::or_<python::detail::specifies_bases<T>, boost::python::detail::is_same<T, noncopyable>>,
                    Prev,
                    T>
            {
            };
            ...
            struct class_metadata
            {
                ...
                typedef typename select_held_type<
                    X1,
                    typename select_held_type<X2, typename select_held_type<X3, python::detail::not_specified>::type>::
                        type>::type held_type_arg;

                // bases
                typedef typename python::detail::select_bases<
                    X1,
                    typename python::detail::
                        select_bases<X2, typename python::detail::select_bases<X3, python::bases<>>::type>::type>::type
                    bases;
                ...
                typedef typename mpl::if_<
                    boost::python::detail::is_same<held_type_arg, python::detail::not_specified>,
                    T,
                    held_type_arg>::type held_type;
                ...
                typedef
                    typename mpl::eval_if<use_value_holder, mpl::identity<held_type>, pointee<held_type>>::type wrapped;

                // Determine whether to use a "back-reference holder"
                typedef mpl::bool_<mpl::or_<
                    has_back_reference<T>,
                    boost::python::detail::is_same<held_type_arg, T>,
                    is_base_and_derived<T, wrapped>>::value>
                    use_back_reference;
                ...
                typedef typename mpl::eval_if<
                    ...
                    mpl::if_<use_value_holder, value_holder<T>, pointer_holder<held_type, wrapped>>>::type holder;
            ...
            private:
                ...
                inline static void maybe_register_pointer_to_python(T2*, mpl::false_*, mpl::false_*)
                {
                    python::detail::force_instantiate(
                        objects::
                            class_value_wrapper<held_type, make_ptr_instance<T2, pointer_holder<held_type, T2>>>());
#ifndef BOOST_PYTHON_NO_PY_SIGNATURES
                ...
                {
                    objects::register_shared_ptr_from_python_and_casts((wrapped*)0, mpl::single_view<T2>());
                    // explicit qualification of type_id makes msvc6 happy
