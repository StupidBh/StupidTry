...
namespace boost {
    namespace python {
        ...
        #define BOOST_PP_ITERATION_PARAMS_1 \
            (4, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / object / pointer_holder.hpp>, 1))
        #include BOOST_PP_ITERATE()
            ...
            public:
                ...
                pointer_holder_back_reference(Pointer);
                    ...
                    // Forward construction to the held object
        #define BOOST_PP_ITERATION_PARAMS_1 \
            (4, (0, BOOST_PYTHON_MAX_ARITY, <boost / python / object / pointer_holder.hpp>, 2))
        #include BOOST_PP_ITERATE()
        ...
        #undef BOOST_PYTHON_UNFORWARD_LOCAL
            ...
            void* pointer_holder<Pointer, Value>::holds(type_info dst_t, bool null_ptr_only)
            {
                ...
                if (dst_t == python::type_id<Pointer>() && !(null_ptr_only && get_pointer(this->m_p))) {
                    return &this->m_p;
                }
...
pointer_holder(PyObject* self BOOST_PP_COMMA_IF(N) BOOST_PP_ENUM_BINARY_PARAMS_Z(1, N, A, a)) :
    m_p(new Value(BOOST_PP_REPEAT_1ST(N, BOOST_PYTHON_UNFORWARD_LOCAL, nil)))
{
...
template<BOOST_PP_ENUM_PARAMS_Z(1, N, class A)>
        #endif
pointer_holder_back_reference(PyObject* p BOOST_PP_COMMA_IF(N) BOOST_PP_ENUM_BINARY_PARAMS_Z(1, N, A, a)) :
    m_p(new held_type(p BOOST_PP_COMMA_IF(N) BOOST_PP_REPEAT_1ST(N, BOOST_PYTHON_UNFORWARD_LOCAL, nil)))
{
}
