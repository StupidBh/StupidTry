    ...
    struct apply
    {
        ...
        typedef typename mpl::begin<ArgList>::type iter0;
            ...
            #define BOOST_PP_LOCAL_MACRO(n)                      \
                ...
                typedef typename mpl::next<iter##n>::type BOOST_PP_CAT(iter, BOOST_PP_INC(n)); // Next iterator type
                ...
                BOOST_PP_ENUM_TRAILING_BINARY_PARAMS_Z(1, N, t, a))
        {
            ...
            try {
                (new (memory) Holder(p BOOST_PP_REPEAT_1ST(N, BOOST_PYTHON_DO_FORWARD_ARG, nil)))->install(p);
            }
            catch (...) {
