...
namespace boost {
    namespace serialization {
        ...
        template<class Archive, class... Types>
        void load(Archive& ar, variant2::variant<Types...>& v, const unsigned int version)
        {
            std::size_t which;
            ar >> BOOST_SERIALIZATION_NVP(which);
        ...
        template<class Archive, class... Types>
        inline void serialize(Archive& ar, variant2::variant<Types...>& v, const unsigned int file_version)
        {
...
namespace boost {
    namespace serialization {
        ...
        struct tracking_level<variant2::variant<Types...>>
        {
