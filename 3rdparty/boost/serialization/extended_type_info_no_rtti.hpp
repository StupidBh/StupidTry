...
namespace boost {
    namespace serialization {
        ...
        namespace no_rtti_system {
            ...
            class BOOST_SYMBOL_VISIBLE extended_type_info_no_rtti_0 : public extended_type_info {
            protected:
        ...
        class extended_type_info_no_rtti :
            ...
            struct action
            {
                struct defined
                {
                    static const char* invoke() { return guid<T>(); }
                };
                ...
                static const char* invoke()
                {
                    typedef typename boost::mpl::if_c<tf, defined, undefined>::type type;
                    return type::invoke();
                }
            };
        ...
        public:
            extended_type_info_no_rtti() :
                no_rtti_system::extended_type_info_no_rtti_0(action<guid_defined<T>::value>::invoke())
            {
                key_register();
            }

            ~extended_type_info_no_rtti() BOOST_OVERRIDE { key_unregister(); }

            const extended_type_info* get_derived_extended_type_info(const T& t) const
            {
            ...
            const char* get_key() const { return action<guid_defined<T>::value>::invoke(); }

            const char* get_debug_info() const BOOST_OVERRIDE { return action<guid_defined<T>::value>::invoke(); }
            ...
            void* construct(unsigned int count, ...) const BOOST_OVERRIDE
            {
                ...
                va_start(ap, count);
                switch (count) {
                case 0: return factory<typename boost::remove_const<T>::type, 0>(ap);
                case 1: return factory<typename boost::remove_const<T>::type, 1>(ap);
                case 2: return factory<typename boost::remove_const<T>::type, 2>(ap);
                case 3: return factory<typename boost::remove_const<T>::type, 3>(ap);
                case 4: return factory<typename boost::remove_const<T>::type, 4>(ap);
                default:
            ...
            {
                boost::serialization::access::destroy(static_cast<T const*>(p));
...
namespace boost {
    namespace serialization {
        ...
        {
            typedef typename boost::serialization::extended_type_info_no_rtti<T> type;
        };
    } // namespace serialization
} // namespace boost
#endif
