...
namespace boost {
    ...
    #pragma warning(disable: 4244 4267)
        ...
        public:
            ...
            explicit library_version_type(const unsigned int& t_) :
                t(t_)
            {
            ...
            operator base_type() const { return t; }

            // used for text input
            operator base_type&() { return t; }

            bool operator==(const library_version_type& rhs) const { return t == rhs.t; }
