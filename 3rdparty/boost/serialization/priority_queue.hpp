...
namespace boost {
    namespace serialization {
        ...
        inline void
            serialize(Archive& ar, std::priority_queue<T, Container, Compare>& t, const unsigned int file_version)
        {
            typedef typename mpl::eval_if<
                typename Archive::is_saving,
                mpl::identity<detail::priority_queue_save<T, Container, Compare>>,
                mpl::identity<detail::priority_queue_load<T, Container, Compare>>>::type typex;
