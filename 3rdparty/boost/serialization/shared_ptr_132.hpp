...
namespace boost {
    namespace serialization {
        ...
        )
        {
            ...
            boost::serialization::
                void_cast_register<boost_132::detail::sp_counted_base_impl<P, D>, boost_132::detail::sp_counted_base>(
        ...
        )
        {
            ...
            // new system as well.
            ::new (t) boost_132::detail::sp_counted_base_impl<P, boost_132::serialization::detail::null_deleter>(
                ptr_,
                boost_132::serialization::detail::null_deleter()); // placement new
...
namespace boost {
    namespace serialization {
        ...
        )
        {
            ...
            ar.register_type(
                static_cast<boost_132::detail::sp_counted_base_impl<T*, boost::checked_deleter<T>>*>(NULL));
...
#define BOOST_SHARED_POINTER_EXPORT_GUID(T, K)                                                       \
    typedef boost_132::detail::sp_counted_base_impl<T*, boost::checked_deleter<T>> __shared_ptr_##T; \
    BOOST_CLASS_EXPORT_GUID(__shared_ptr_##T, "__shared_ptr_" K)                                     \
    BOOST_CLASS_EXPORT_GUID(T, K)                                                                    \
    /**/

#define BOOST_SHARED_POINTER_EXPORT(T)                          \
    BOOST_SHARED_POINTER_EXPORT_GUID(T, BOOST_PP_STRINGIZE(T) ) \
    /**/
