    ...
    namespace serialization {
        ...
        inline void load_map_collection(Archive& ar, Container& s)
        {
            ...
            while (count-- > 0) {
                ...
                typename Container::iterator result = s.insert(hint, boost::move(t.reference()));
        ...
        {
            boost::serialization::stl::save_collection<Archive, std::map<Key, Type, Compare, Allocator>>(ar, t);
        }
        ...
        {
            boost::serialization::stl::save_collection<Archive, std::multimap<Key, Type, Compare, Allocator>>(ar, t);
        }
        ...
        template<class Archive, class Type, class Key, class Compare, class Allocator>
        inline void
            serialize(Archive& ar, std::multimap<Key, Type, Compare, Allocator>& t, const unsigned int file_version)
        {
            boost::serialization::split_free(ar, t, file_version);
        }
