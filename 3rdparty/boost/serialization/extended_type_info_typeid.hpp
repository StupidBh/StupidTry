...
namespace boost {
    namespace serialization {
        namespace typeid_system {
            ...
            class BOOST_SYMBOL_VISIBLE extended_type_info_typeid_0 : public extended_type_info {
            ...
            public:
                BOOST_SERIALIZATION_DECL bool is_less_than(const extended_type_info& rhs) const BOOST_OVERRIDE;
                BOOST_SERIALIZATION_DECL bool is_equal(const extended_type_info& rhs) const BOOST_OVERRIDE;

                const std::type_info& get_typeid() const { return *m_ti; }
            };
        ...
        public:
            extended_type_info_typeid() :
                typeid_system::extended_type_info_typeid_0(boost::serialization::guid<T>())
            {
            ...
            const char* get_key() const { return boost::serialization::guid<T>(); }
...
namespace boost {
    namespace serialization {
        ...
        {
            typedef typename boost::serialization::extended_type_info_typeid<T> type;
        };
    } // namespace serialization
} // namespace boost
#endif
