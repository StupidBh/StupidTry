...
namespace boost {
    namespace serialization {
        ...
        {
            return const_cast<void*>(void_upcast(derived, base, const_cast<void const*>(t)));
        }
        ...
        {
            return const_cast<void*>(void_downcast(derived, base, const_cast<void const*>(t)));
        }

        namespace void_cast_detail {

            class BOOST_SYMBOL_VISIBLE void_caster : private boost::noncopyable {
                friend BOOST_SERIALIZATION_DECL void const* boost::serialization::void_upcast(
                    extended_type_info const& derived,
                    extended_type_info const& base,
                    void const* const);
                friend BOOST_SERIALIZATION_DECL void const* boost::serialization::void_downcast(
                    extended_type_info const& derived,
                    extended_type_info const& base,
                    void const* const);
            ...
            public:
                ...
                const void_caster& operator*() { return *this; }
    ...
    #pragma warning(disable: 4251 4231 4660 4275 4511 4512)
            ...
            class BOOST_SYMBOL_VISIBLE void_caster_primitive : public void_caster {
                void const* downcast(void const* const t) const BOOST_OVERRIDE
                {
                    const Derived* d =
                        boost::serialization::smart_cast<const Derived*, const Base*>(static_cast<const Base*>(t));
                    return d;
                }
                ...
                {
                    const Base* b =
                        boost::serialization::smart_cast<const Base*, const Derived*>(static_cast<const Derived*>(t));
                    return b;
                }

                bool has_virtual_base() const BOOST_OVERRIDE { return false; }
            ...
            private:
                static std::ptrdiff_t base_offset()
                {
                    ...
                    return reinterpret_cast<char*>(&data) -
                           reinterpret_cast<char*>(static_cast<Base*>(reinterpret_cast<Derived*>(&data)));
                }
            };
            ...
            template<class Derived, class Base>
            class BOOST_SYMBOL_VISIBLE void_caster_virtual_base : public void_caster {
                bool has_virtual_base() const BOOST_OVERRIDE { return true; }
    ...
    #pragma warning(pop)
            ...
            template<class Derived, class Base>
            struct BOOST_SYMBOL_VISIBLE void_caster_base : public void_caster
            {
                typedef typename mpl::eval_if<
                    boost::is_virtual_base_of<Base, Derived>,
                    mpl::identity<void_cast_detail::void_caster_virtual_base<Derived, Base>>, // else
                    mpl::identity<void_cast_detail::void_caster_primitive<Derived, Base>>>::type type;
            };

        } // namespace void_cast_detail

        template<class Derived, class Base>
        BOOST_DLLEXPORT inline const void_cast_detail::void_caster& void_cast_register(
        ...
        )
        {
            typedef typename mpl::eval_if<
                boost::is_virtual_base_of<Base, Derived>,
                mpl::identity<void_cast_detail::void_caster_virtual_base<Derived, Base>>, // else
                mpl::identity<void_cast_detail::void_caster_primitive<Derived, Base>>>::type typex;
            return singleton<typex>::get_const_instance();
        }

        template<class Derived, class Base>
        class BOOST_SYMBOL_VISIBLE void_caster : public void_cast_detail::void_caster_base<Derived, Base>::type {};
