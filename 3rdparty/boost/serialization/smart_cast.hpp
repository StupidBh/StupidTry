...
// if we're in debug mode
                        ...
                        typedef typename mpl::eval_if<
                            typename mpl::and_<
                                mpl::not_<is_base_and_derived<typename remove_reference<T>::type, U>>,
                                mpl::not_<is_base_and_derived<U, typename remove_reference<T>::type>>>,
                            // borland chokes w/o full qualification here
                            mpl::identity<cross>,
                            mpl::identity<linear>>::type typex;
                ...
                static T cast(U& u)
                {
                    typedef typename mpl::eval_if<
                        ...
                        mpl::identity<non_polymorphic>>::type typex;
                    return typex::cast(u);
                }
            };
            ...
            typedef typename mpl::eval_if<
                ...
                typename mpl::eval_if<
                    ...
                    typename mpl::eval_if<
                        ...
                        // else
                        mpl::identity<smart_cast_impl::error<T>>>>>::type typex;
            return typex::cast(u);
        }
