    ...
    namespace serialization {
...
#if defined(BOOST_NO_MEMBER_TEMPLATE_FRIENDS) || defined(BOOST_MSVC) || defined(__SUNPRO_CC)
        public:
#else
            template<class Archive, class U>
            friend void boost::serialization::load(Archive& ar, SPT<U>& t, const unsigned int file_version);
#endif
            ...
            {
                template<class U>
                static const boost::serialization::extended_type_info* get_object_type(U&)
                {
                    return &boost::serialization::singleton<
                        typename boost::serialization::type_info_implementation<U>::type>::get_const_instance();
                }
            };
            ...
            {
                template<class U>
                static const boost::serialization::extended_type_info* get_object_type(U& u)
                {
                    return boost::serialization::singleton<
                               typename boost::serialization::type_info_implementation<U>::type>::get_const_instance()
                        .get_derived_extended_type_info(u);
                }
            };
        ...
        public:
            ...
            void reset(SPT<T>& s, T* t)
            {
                ...
                const boost::serialization::extended_type_info* true_type = type::get_object_type(*t);
