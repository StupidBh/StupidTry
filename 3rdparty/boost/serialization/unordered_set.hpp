    ...
    namespace serialization {
        ...
        )
        {
            boost::serialization::stl::
                save_unordered_collection<Archive, std::unordered_set<Key, HashFcn, EqualKey, Allocator>>(ar, t);
        }
        ...
        )
        {
            boost::serialization::stl::load_unordered_collection<
                ...
                stl::archive_input_unordered_set<Archive, std::unordered_set<Key, HashFcn, EqualKey, Allocator>>>(
                ar,
                t);
        }
        ...
        {
            stl::save_unordered_collection<Archive, std::unordered_multiset<Key, HashFcn, EqualKey, Allocator>>(ar, t);
        }
        ...
        )
        {
            boost::serialization::stl::load_unordered_collection<
                ...
                boost::serialization::stl::archive_input_unordered_multiset<
                    Archive,
                    std::unordered_multiset<Key, HashFcn, EqualKey, Allocator>>>(ar, t);
        }
