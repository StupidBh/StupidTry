    ...
    namespace serialization {
        ...
        )
        {
            boost::serialization::stl::
                save_unordered_collection<Archive, std::unordered_map<Key, T, HashFcn, EqualKey, Allocator>>(ar, t);
        }
        ...
        )
        {
            boost::serialization::stl::load_unordered_collection<
                ...
                boost::serialization::stl::
                    archive_input_unordered_map<Archive, std::unordered_map<Key, T, HashFcn, EqualKey, Allocator>>>(
                ar,
                t);
        }
        ...
        )
        {
            boost::serialization::stl::save_unordered_collection<
                Archive,
                std::unordered_multimap<Key, T, HashFcn, EqualKey, Allocator>>(ar, t);
        }
