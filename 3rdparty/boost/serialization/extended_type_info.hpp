...
namespace boost {
    namespace serialization {
        ...
        class BOOST_SYMBOL_VISIBLE extended_type_info : private boost::noncopyable {
        private:
        ...
        protected:
            ...
            BOOST_SERIALIZATION_DECL extended_type_info(const unsigned int type_info_key, const char* key);
        ...
        public:
            ...
            bool operator!=(const extended_type_info& rhs) const { return !(operator==(rhs)); }

            // note explicit "export" of static function to work around
            // gcc 4.5 mingw error
            static BOOST_SERIALIZATION_DECL const extended_type_info* find(const char* key);
            // for plugins
        ...
        namespace ext {
            ...
            struct guid_impl
            {
                static inline const char* call() { return NULL; }
            };
        }
