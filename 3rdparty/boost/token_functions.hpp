...
namespace boost {
    ...
    private:
        ...
        struct char_eq
        {
            ...
            bool operator()(Char c) { return Traits::eq(e_, c); }
        };
    ...
    namespace tokenizer_detail {
        ...
        struct traits_extension_details : public traits
        {
            ...
            static bool isspace(char_type c) { return std::iswspace(c) != 0; }

            static bool ispunct(char_type c) { return std::iswpunct(c) != 0; }
        };
        ...
        struct traits_extension_details<traits, 1> : public traits
        {
            ...
            static bool isspace(char_type c) { return std::isspace(c) != 0; }

            static bool ispunct(char_type c) { return std::ispunct(c) != 0; }
        };
#endif
    ...
    public:
        ...
        bool operator()(InputIterator& next, InputIterator end, Token& tok)
        {
            typedef tokenizer_detail::assign_or_plus_equal<
                BOOST_DEDUCED_TYPENAME tokenizer_detail::get_iterator_category<InputIterator>::iterator_category>
                assigner;
