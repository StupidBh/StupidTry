...
#include <boost/predef/detail/test.h>
    ...
    */ // end::reference[]
     ...
     */ // end::reference[]
    #define BOOST_PREDEF_MAKE_0X_VRRPPPP(V) \
        BOOST_VERSION_NUMBER((V & 0xF000000) >> 24, (V & 0xFF0000) >> 16, (V & 0xFFFF))
    /* tag::reference[]
     ...
     */ // end::reference[]
    #define BOOST_PREDEF_MAKE_0X_VRRPP000(V) \
        BOOST_VERSION_NUMBER((V & 0xF0000000) >> 28, (V & 0xFF00000) >> 20, (V & 0xFF000) >> 12)
    /* tag::reference[]
     ...
     */ // end::reference[]
    #define BOOST_PREDEF_MAKE_10_VRP000(V) \
        BOOST_VERSION_NUMBER(((V) / 100000) % 10, ((V) / 10000) % 10, ((V) / 1000) % 10)
    /* tag::reference[]
    ...
    /* tag::reference[]
     * `BOOST_PREDEF_MAKE_10_VVR_0PPPPP(V, P)`, the second parameter specifies a year-month patch level with the first
     * digit discarded
     */ // end::reference[]
     ...
     */ // end::reference[]
    #define BOOST_PREDEF_MAKE_10_VVRR0PP00(V) \
        BOOST_VERSION_NUMBER(((V) / 10'000'000) % 100, ((V) / 100000) % 100, ((V) / 100) % 100)
    /* tag::reference[]
     * `BOOST_PREDEF_MAKE_10_VVRR0PPPP(V)`
     */ // end::reference[]
    #define BOOST_PREDEF_MAKE_10_VVRR0PPPP(V) \
        BOOST_VERSION_NUMBER(((V) / 10'000'000) % 100, ((V) / 100000) % 100, (V) % 10000)
    /* tag::reference[]
     * `BOOST_PREDEF_MAKE_10_VVRR00PP00(V)`
     */ // end::reference[]
    #define BOOST_PREDEF_MAKE_10_VVRR00PP00(V) \
        BOOST_VERSION_NUMBER(((V) / 100'000'000) % 100, ((V) / 1'000'000) % 100, ((V) / 100) % 100)
