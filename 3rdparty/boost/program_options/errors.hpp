...
#include <map>
    ...
    #pragma warning(push)
    #pragma warning(disable: 4275) // non dll-interface class 'std::logic_error' used as base for dll-interface class
                                   // 'boost::program_options::error'
    #pragma warning(disable: 4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of
...
namespace boost {
    namespace program_options {
        ...
        */
         ...
         *
         *   */
        class BOOST_PROGRAM_OPTIONS_DECL BOOST_SYMBOL_VISIBLE error_with_no_option_name :
        ...
        class BOOST_PROGRAM_OPTIONS_DECL BOOST_SYMBOL_VISIBLE invalid_option_value : public validation_error {
        public:
        ...
        class BOOST_PROGRAM_OPTIONS_DECL BOOST_SYMBOL_VISIBLE invalid_bool_value : public validation_error {
        public:
