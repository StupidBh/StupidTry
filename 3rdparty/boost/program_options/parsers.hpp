...
namespace boost {
    namespace program_options {
        ...
        */
         ...
         */
        template<class charT>
        basic_parsed_options<charT> parse_command_line(
            int argc,
        ...
        */
        ...
        std::vector<std::basic_string<charT>>
            collect_unrecognized(const std::vector<basic_option<charT>>& options, enum collect_unrecognized_mode mode);
        ...
        */
        BOOST_PROGRAM_OPTIONS_DECL parsed_options
            parse_environment(const options_description&, const function1<std::string, std::string>& name_mapper);
        ...
        */
        BOOST_PROGRAM_OPTIONS_DECL std::vector<std::string> split_unix(
        ...
        /** @overload */
        BOOST_PROGRAM_OPTIONS_DECL std::vector<std::wstring> split_unix(
