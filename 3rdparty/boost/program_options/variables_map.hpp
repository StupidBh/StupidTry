...
#include <set>
    ...
    #pragma warning(push)
    #pragma warning( \
        disable: 4251) // 'boost::program_options::variable_value::v' : class 'boost::any' needs to have dll-interface
                       // to be used by clients of class 'boost::program_options::variable_value
#endif
    ...
    namespace program_options {
        ...
        */
        ...
        private:
            ...
            friend BOOST_PROGRAM_OPTIONS_DECL void
                store(const basic_parsed_options<char>& options, variables_map& xm, bool utf8);
