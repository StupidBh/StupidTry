...
#include <iosfwd>
    ...
    #pragma warning(push)
    #pragma warning(disable: 4251) // class 'boost::shared_ptr<T>' needs to have dll-interface to be used by clients of
    ...
    namespace program_options {
        ...
        */
        ...
        public:
            ...
            */
            match_result
                match(const std::string& option, bool approx, bool long_ignore_case, bool short_ignore_case) const;
        ...
        */
        ...
        public:
            ...
            */
            ...
            const option_description& find(
                const std::string& name,
                bool approx,
                bool long_ignore_case = false,
                bool short_ignore_case = false) const;

            const option_description* find_nothrow(
                const std::string& name,
                bool approx,
                bool long_ignore_case = false,
                bool short_ignore_case = false) const;
