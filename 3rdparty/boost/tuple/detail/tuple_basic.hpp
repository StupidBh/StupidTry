    ...
    namespace tuples {
        ...
        namespace detail {
            ...
            struct drop_front
            {
                ...
                struct apply
                {
                    typedef BOOST_DEDUCED_TYPENAME drop_front<N - 1>::BOOST_NESTED_TEMPLATE apply<Tuple> next;
                    typedef BOOST_DEDUCED_TYPENAME next::type::tail_type type;

                    static const type& call(const Tuple& tup) { return next::call(tup).tail; }
                };
            };
            ...
            struct drop_front<0>
            {
                ...
                struct apply
                {
                    ...
                    static const type& call(const Tuple& tup) { return tup; }
                };
            };
        ...
        struct element
        {
            typedef BOOST_DEDUCED_TYPENAME detail::drop_front<N>::BOOST_NESTED_TEMPLATE apply<T>::type::head_type type;
        };
        ...
        {
        private:
            typedef BOOST_DEDUCED_TYPENAME detail::drop_front<N>::BOOST_NESTED_TEMPLATE apply<T>::type::head_type
                unqualified_type;
        ...
        template<std::size_t N, class T>
        struct element : public detail::element_impl<N, T, ::boost::is_const<T>::value>
        {
        };
        ...
        {
            typedef BOOST_DEDUCED_TYPENAME detail::drop_front<N>::BOOST_NESTED_TEMPLATE apply<cons<HT, TT>> impl;
        ...
        struct cons
        {
            ...
            typename access_traits<stored_head_type>::non_const_type get_head() { return head; }

            typename access_traits<tail_type>::non_const_type get_tail() { return tail; }

            typename access_traits<stored_head_type>::const_type get_head() const { return head; }

            typename access_traits<tail_type>::const_type get_tail() const { return tail; }
            ...
            cons(const null_type& /*t1*/, T2& t2, T3& t3, T4& t4, T5& t5, T6& t6, T7& t7, T8& t8, T9& t9, T10& t10) :
                head(),
                tail(t2, t3, t4, t5, t6, t7, t8, t9, t10, detail::cnull())
            {
            }
        ...
        struct cons<HT, null_type>
        {
            ...
            cons(typename access_traits<stored_head_type>::parameter_type h, const null_type& = null_type()) :
                head(h)
            {
            }
        ...
        public:
            ...
            tuple(
                ...
                inherited(t0, t1, t2, t3, t4, t5, detail::cnull(), detail::cnull(), detail::cnull(), detail::cnull())
            {
            }
            ...
            tuple(
                ...
                inherited(t0, t1, t2, t3, t4, t5, t6, detail::cnull(), detail::cnull(), detail::cnull())
            {
            }
            ...
            tuple(
                ...
                inherited(t0, t1, t2, t3, t4, t5, t6, t7, detail::cnull(), detail::cnull())
            {
            }
        ...
        inline detail::ignore_t ignore(detail::ignore_t)
        {
            return 0;
        }
        ...
        template<class T0>
        inline typename detail::tie_mapper<T0>::type tie(T0& t0)
        {
        ...
        template<class T0, class T1>
        inline typename detail::tie_mapper<T0, T1>::type tie(T0& t0, T1& t1)
        {
        ...
        template<class T0, class T1, class T2>
        inline typename detail::tie_mapper<T0, T1, T2>::type tie(T0& t0, T1& t1, T2& t2)
        {
        ...
        template<class T0, class T1, class T2, class T3>
        inline typename detail::tie_mapper<T0, T1, T2, T3>::type tie(T0& t0, T1& t1, T2& t2, T3& t3)
        {
        ...
        template<class T0, class T1, class T2, class T3, class T4>
        inline typename detail::tie_mapper<T0, T1, T2, T3, T4>::type tie(T0& t0, T1& t1, T2& t2, T3& t3, T4& t4)
        {
        ...
        {
            typedef typename detail::tie_mapper<T0, T1, T2, T3, T4, T5, T6>::type t;
            return t(t0, t1, t2, t3, t4, t5, t6);
        }
        ...
        {
            typedef typename detail::tie_mapper<T0, T1, T2, T3, T4, T5, T6, T7>::type t;
            return t(t0, t1, t2, t3, t4, t5, t6, t7);
        }

        template<class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8>
        inline typename detail::tie_mapper<T0, T1, T2, T3, T4, T5, T6, T7, T8>::type
            tie(T0& t0, T1& t1, T2& t2, T3& t3, T4& t4, T5& t5, T6& t6, T7& t7, T8& t8)
        {
            typedef typename detail::tie_mapper<T0, T1, T2, T3, T4, T5, T6, T7, T8>::type t;
            return t(t0, t1, t2, t3, t4, t5, t6, t7, t8);
        }

        template<class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9>
        inline typename detail::tie_mapper<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>::type
            tie(T0& t0, T1& t1, T2& t2, T3& t3, T4& t4, T5& t5, T6& t6, T7& t7, T8& t8, T9& t9)
        {
            typedef typename detail::tie_mapper<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>::type t;
            return t(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9);
        }
        ...
        template<class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9>
        inline void
            swap(tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>& lhs, tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>& rhs)
        {
