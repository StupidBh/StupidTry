    ...
    namespace tuples {
        ...
        namespace detail {
            ...
            private:
                ...
                {
                    static const int stream_index[number_of_manipulators] = { std::ios::xalloc(),
                                                                              std::ios::xalloc(),
                                                                              std::ios::xalloc() };
        ...
        public:
            explicit tuple_manipulator(detail::format_info::manipulator_type m, CharType c = CharType()) :
                mt(m),
                f_c(c)
            {
            }
            ...
            operator<<(std::basic_ostream<CharType, CharTrait>& o, const null_type& t)
        {
            ...
            const CharType l = detail::format_info::get_manipulator(o, detail::format_info::open);
            const CharType r = detail::format_info::get_manipulator(o, detail::format_info::close);
        ...
        namespace detail {
            ...
            template<class CharType, class CharTrait>
            inline std::basic_istream<CharType, CharTrait>& extract_and_check_delimiter(
                ...
                format_info::manipulator_type del)
            {
                ...
                const bool is_delimiter =
                    !std::use_facet<std::ctype<CharType>>(is.getloc()).is(std::ctype_base::space, d);
#else
