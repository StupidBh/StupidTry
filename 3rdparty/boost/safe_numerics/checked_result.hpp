    ...
    namespace safe_numerics {
        ...
        struct checked_result
        {
            ...
            union contents
            {
                ...
                constexpr contents(const R& r) noexcept :
                    m_r(r)
                {
                }

                constexpr contents(char const* msg) noexcept :
                    m_msg(msg)
                {
                }
            ...
            constexpr /*explicit*/ checked_result(const safe_numerics_error& e, const char* msg = "") noexcept :
                m_e(e),
                m_contents { msg }
            {
            ...
            constexpr bool exception() const { return m_e != safe_numerics_error::success; }
