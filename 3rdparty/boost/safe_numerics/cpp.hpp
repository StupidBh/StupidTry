...
namespace boost {
    namespace safe_numerics {
        ...
        template<int CharBits, int ShortBits, int IntBits, int LongBits, int LongLongBits>
        struct cpp
        {
        public:
            ...
            template<class T>
            using rank = typename std::conditional<
            ...
            using higher_ranked_type = typename std::conditional<(rank<T>::value < rank<U>::value), U, T>::type;
            ...
            template<class T>
            using integral_promotion = copy_sign<higher_ranked_type<local_int_type, T>, T>;

            // note presumption that T & U don't have he same sign
            // if that's not true, these won't work
            template<class T, class U>
            using select_signed = typename std::conditional<std::numeric_limits<T>::is_signed, T, U>::type;

            template<class T, class U>
            using select_unsigned = typename std::conditional<std::numeric_limits<T>::is_signed, U, T>::type;
            ...
            using usual_arithmetic_conversions =
                ...
                typename std::conditional<
                    ...
                    typename std::conditional<
                        ...
                        typename std::conditional<
                            rank<select_unsigned<T, U>>::value >= rank<select_signed<T, U>>::value,
                            // use unsigned type
                            select_unsigned<T, U>,
