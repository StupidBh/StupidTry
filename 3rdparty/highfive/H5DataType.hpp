...
namespace HighFive {
    ...
    public:
        bool isSigned() { return detail::h5t_get_sign(getId()) != H5T_SGN_NONE; }
    ...
    public:
        ...
        inline const std::vector<member_def>& getMembers() const noexcept { return members; }
    ...
    public:
            ...
            members(t_members)
        {
            ...
            if (members.empty()) {
                HDF5ErrMapper::ToException<DataTypeException>("Could not create an enum without members");
            }
            create();
        }
