...
namespace json {
    ...
    inline std::optional<typename parser5<string_t>::u8char> parser5<string_t>::escape()
    {
        ...
        case '7':
        case '8':
        case '9': throw InvalidChar(_current_char, exceptionDetailInfo());
        default:
            if (c == 0) {
                throw InvalidChar(_current_char, exceptionDetailInfo());
            }
    ...
    inline std::optional<typename parser5<string_t>::Token> parser5<string_t>::lex_default()
    {
        ...
        case 0xFEFF:
        case 0x2028:
        case 0x2029: read(); return std::nullopt;
        case '/':
            read();
            _lex_state = LexState::comment;
            return std::nullopt;
        case 0: read(); return newToken(TokenType::eof, value());
        }
    ...
    inline std::optional<typename parser5<string_t>::Token> parser5<string_t>::lex_value()
    {
        switch (_current_char) {
        case '{':
        case '[': return newToken(TokenType::punctuator, value(StringFromCharCode(read())));
        case 'n':
            read();
            literal("ull");
    ...
    inline std::optional<typename parser5<string_t>::Token> parser5<string_t>::lex_identifierName()
    {
        ...
        case '_':
        case 0x200C:
        case 0x200D: _buffer += StringFromCharCode(read()); return std::nullopt;
        case '\\':
            read();
    ...
    inline std::optional<typename parser5<string_t>::Token> parser5<string_t>::lex_string()
    {
        ...
        case '\'':
            ...
            return std::nullopt;
        case '\n':
        case '\r': throw InvalidChar(_current_char, exceptionDetailInfo());
        case 0x2028:
        case 0x2029:
    ...
    inline std::optional<typename parser5<string_t>::Token> parser5<string_t>::lex_start()
    {
        switch (_current_char) {
        case '{':
        case '[': return newToken(TokenType::punctuator, StringFromCharCode(read()));
        }
    ...
    {
        switch (state) {
        case LexState::default_                 : return lex_default();
        case LexState::comment                  : return lex_comment();
        case LexState::multiLineComment         : return lex_multiLineComment();
        case LexState::multiLineCommentAsterisk : return lex_multiLineCommentAsterisk();
        case LexState::singleLineComment        : return lex_singleLineComment();
        case LexState::value                    : return lex_value();
        case LexState::identifierNameStartEscape: return lex_identifierNameStartEscape();
        case LexState::identifierName           : return lex_identifierName();
        case LexState::identifierNameEscape     : return lex_identifierNameEscape();
        case LexState::sign                     : return lex_sign();
        case LexState::zero                     : return lex_zero();
        case LexState::decimalInteger           : return lex_decimalInteger();
        case LexState::decimalPointLeading      : return lex_decimalPointLeading();
        case LexState::decimalPoint             : return lex_decimalPoint();
        case LexState::decimalFraction          : return lex_decimalFraction();
        case LexState::decimalExponent          : return lex_decimalExponent();
        case LexState::decimalExponentSign      : return lex_decimalExponentSign();
        case LexState::decimalExponentInteger   : return lex_decimalExponentInteger();
        case LexState::hexadecimal              : return lex_hexadecimal();
        case LexState::hexadecimalInteger       : return lex_hexdecimalInteger();
        case LexState::string                   : return lex_string();
        case LexState::start                    : return lex_start();
        case LexState::beforePropertyName       : return lex_beforePropertyName();
        case LexState::afterPropertyName        : return lex_afterPropertyName();
        case LexState::beforePropertyValue      : return lex_beforePropertyValue();
        case LexState::afterPropertyValue       : return lex_afterPropertyValue();
        case LexState::beforeArrayValue         : return lex_beforeArrayValue();
        case LexState::afterArrayValue          : return lex_afterArrayValue();
        case LexState::end                      : return lex_end();
        }
    ...
    inline void parser5<string_t>::parse_beforePropertyName()
    {
        ...
        case TokenType::string:
            ...
            break;
        case TokenType::punctuator: pop(); break;
        case TokenType::eof       : throw InvalidEOF("EOF", exceptionDetailInfo()); break;
        default                   : break;
        }
    }
    ...
    inline void parser5<string_t>::parse_afterPropertyValue()
    {
        ...
        case ',': _parse_state = ParseState::beforePropertyName; break;
        case '}': pop(); break;
        }
    }
    ...
    inline void parser5<string_t>::parse_afterArrayValue()
    {
        ...
        switch (_token->_value.as_string()[0]) {
        case ',': _parse_state = ParseState::beforeArrayValue; break;
        case ']': pop(); break;
        }
    }
    ...
    {
        switch (state) {
        case ParseState::start              : parse_start(); break;
        case ParseState::beforePropertyName : parse_beforePropertyName(); break;
        case ParseState::afterPropertyName  : parse_afterPropertyName(); break;
        case ParseState::beforePropertyValue: parse_beforePropertyValue(); break;
        case ParseState::beforeArrayValue   : parse_beforeArrayValue(); break;
        case ParseState::afterPropertyValue : parse_afterPropertyValue(); break;
        case ParseState::afterArrayValue    : parse_afterArrayValue(); break;
        default                             : break;
        }
    }
    ...
    inline void parser5<string_t>::push()
    {
        ...
        case TokenType::string : std::swap(v, _token->_value); break;
        default                : break;
        }
