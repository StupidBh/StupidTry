...
namespace HighFive {
    namespace detail {
        ...
        inline ssize_t h5a_get_name(hid_t attr_id, size_t buf_size, char* buf)
        {
            ...
            if (name_length < 0) {
                HDF5ErrMapper::ToException<AttributeException>(std::string("Unable to get name of attribute"));
            }
        ...
        inline hid_t h5a_get_space(hid_t attr_id)
        {
            ...
            if (attr < 0) {
                HDF5ErrMapper::ToException<AttributeException>(std::string("Unable to get dataspace of attribute"));
            }
        ...
        inline hid_t h5a_get_type(hid_t attr_id)
        {
            ...
            if (type_id == H5I_INVALID_HID) {
                HDF5ErrMapper::ToException<AttributeException>(std::string("Unable to get datatype of attribute"));
            }
