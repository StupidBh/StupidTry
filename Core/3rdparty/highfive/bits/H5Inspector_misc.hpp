...
namespace HighFive {
    namespace details {
        ...
        inline bool checkDimensions(const std::vector<size_t>& dims, size_t min_dim_requested, size_t max_dim_requested)
        {
    ...
    *****/
    ...
    namespace details {
        ...
        struct type_helper
        {
            ...
            static size_t getRank(const type& /* val */) { return ndim; }

            static std::vector<size_t> getDimensions(const type& /* val */) { return {}; }
        ...
        struct inspector<bool> : type_helper<bool>
        {
            ...
            static hdf5_type* data(type& /* val */) { throw DataSpaceException("A boolean cannot be read directly."); }
        ...
        struct inspector<std::vector<T>>
        {
            ...
            static constexpr bool is_trivially_copyable =
                std::is_trivially_copyable<value_type>::value && inspector<value_type>::is_trivially_nestable;
            static constexpr bool is_trivially_nestable = false;
            ...
            static hdf5_type* data(type& val) { return val.empty() ? nullptr : inspector<value_type>::data(val[0]); }
        ...
        struct inspector<std::array<T, N>>
        {
            ...
            static constexpr bool is_trivially_copyable =
                std::is_trivially_copyable<value_type>::value && inspector<value_type>::is_trivially_nestable;
            static constexpr bool is_trivially_nestable = (sizeof(type) == N * sizeof(T)) && is_trivially_copyable;

            static size_t getRank(const type& val) { return ndim + inspector<value_type>::getRank(val[0]); }
        ...
        struct inspector<T*>
        {
            ...
            static const hdf5_type* data(const type& val) { return reinterpret_cast<const hdf5_type*>(val); }
