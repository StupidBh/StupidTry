...
namespace HighFive {
    namespace details {
        ...
        struct xtensor_inspector_base
        {
            ...
            static_assert(
                std::is_same<value_type, base_type>::value,
            ...
            static const value_type& getAnyElement(const type& val) { return val.unchecked(0); }

            static value_type& getAnyElement(type& val) { return val.unchecked(0); }
        ...
        struct xtensor_inspector : public xtensor_inspector_base<xtensor_inspector<XTensorType, L>, XTensorType, L>
        {
        private:
        ...
        struct xarray_inspector : public xtensor_inspector_base<xarray_inspector<XArrayType, L>, XArrayType, L>
        {
        private:
        ...
        public:
            ...
            static const std::vector<size_t>& shapeFromDims(const std::vector<size_t>& dims) { return dims; }
        };
        ...
        struct inspector<xt::xview<CT, S...>> : public xarray_inspector<xt::xview<CT, S...>, xt::layout_type::any>
        {
        private:
