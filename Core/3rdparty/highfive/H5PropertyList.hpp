...
namespace HighFive {
    ...
    public:
        ...
        constexpr PropertyType getType() const noexcept { return T; }
    ...
    public:
        ...
        explicit PageBufferSize(size_t page_buffer_size, unsigned min_meta_percent = 0, unsigned min_raw_percent = 0);
    ...
    public:
        ...
        /// details.
        Caching(size_t numSlots, size_t cacheSize, double w0 = static_cast<double>(H5D_CHUNK_CACHE_W0_DEFAULT));
