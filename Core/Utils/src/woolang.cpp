...
#define wo_macro_is_args_empty(...)                                                           \
    wo_macro_boolean_and(                                                                     \
        wo_macro_boolean_and(                                                                 \
            wo_macro_boolean_not(wo_macro_has_comma(__VA_ARGS__)),                            \
            wo_macro_boolean_not(wo_macro_has_comma(__VA_ARGS__()))),                         \
        wo_macro_boolean_and(                                                                 \
            wo_macro_boolean_not(wo_macro_has_comma(wo_macro_eat_args_to_comma __VA_ARGS__)), \
...
#define wo_macro_va_num(...) \
    wo_macro_get_args_8(__VA_ARGS__ wo_macro_va_opt_comma(__VA_ARGS__) 8, 7, 6, 5, 4, 3, 2, 1, 0)
...
#define wo_macro_overload(FUNC_NAME, ...) \
    wo_macro_invoke(wo_macro_concat(wo_macro_concat(FUNC_NAME, _), wo_macro_va_num(__VA_ARGS__)), __VA_ARGS__)
