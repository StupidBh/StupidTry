...
This is a CMake-based C++ project with two production targets:
...
- `ctest --test-dir build/Debug -C Debug`: run the Debug test suite integrated on `main`.
- `ctest --test-dir build/Debug -C Release`: run the Release test suite integrated on `main`.
